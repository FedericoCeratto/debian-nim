...
N_NIMCALL(tnode224816*, totreeset_283753)(tbitset282012* s, ttype224852* settype, tlineinfo194539 info);
		...
		res_284118 = 0;
		{
			while (1) {
				...
				i_284022 = res_284118;
				{
					...
					LOC9 = 0;
					LOC9 = getordvalue_262187((*(*s).kindU.S6.Sons->data[i_284022]).kindU.S6.Sons->data[1]);
					LOC10 = 0;
					LOC10 = getordvalue_262187((*(*s).kindU.S6.Sons->data[i_284022]).kindU.S6.Sons->data[0]);
