...
N_NIMCALL(void, addpackage_207126)(Stringtableobj145212* packages, NimStringDesc* p);
...
N_NIMCALL(void, addpath_207012)(NimStringDesc* path, Tlineinfo190352 info) {
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = contains_140219((&searchpaths_167136), path);
		if (!!(LOC3)) goto LA4;
		prependstr_140419((&searchpaths_167136), path);
	}
	LA4: ;
}
...
{	result = 0;
	{
		if (!eqStrings(a, ((NimStringDesc*) &TMP1764))) goto LA3;
		result = NIM_FALSE;
		goto BeforeRet;
	}
	LA3: ;
...
N_NIMCALL(void, addpackage_207126)(Stringtableobj145212* packages, NimStringDesc* p) {
	...
	LA3: ;
	{
		nstPut(packages, name, ((NimStringDesc*) &TMP1764));
	}
	LA1: ;
}
...
N_NIMCALL(void, addnimblepath_207175)(NimStringDesc* p, Tlineinfo190352 info) {
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = contains_140219((&searchpaths_167136), p);
		if (!!(LOC3)) goto LA4;
		message_196161(info, ((NU16) 280), p);
		prependstr_140419((&lazypaths_167137), p);
	}
	LA4: ;
}
				...
				while (1) {
					{
						...
						y_207312 = cstrToNimstr(((NCSTRING) ((*x_207310).d_name)));
						{
							...
							NU8 k_207316;
							LOC19 = 0;
							LOC19 = !(eqStrings(y_207312, ((NimStringDesc*) &TMP1762)));
							if (!(LOC19)) goto LA20;
							LOC19 = !(eqStrings(y_207312, ((NimStringDesc*) &TMP1763)));
							LA20: ;
							if (!LOC19) goto LA21;
							memset((void*)(&s_207314), 0, sizeof(s_207314));
							{
								if (!NIM_TRUE) goto LA25;
								y_207312 = HEX2F_123481(dir, y_207312);
							}
							LA25: ;
							k_207316 = ((NU8) 0);
							{
								...
								LA33: ;
								{
									if (!((*x_207310).d_type == ((NI8) 10))) goto LA37;
									{
										NIM_BOOL LOC41;
										LOC41 = 0;
										LOC41 = direxists_127020(y_207312);
										if (!LOC41) goto LA42;
										k_207316 = ((NU8) 3);
									}
									goto LA39;
				...
				res_207330 = ((NI) 0);
				{
					while (1) {
						...
						h_207326 = res_207330;
						{
							...
							{
								if (!eqStrings(val_207324, ((NimStringDesc*) &TMP1764))) goto LA84;
