...
typedef NIM_CHAR TY82635[60];
struct  Tinstantiation190833  {
Tsym190843* sym;
Ttypeseq190845* concretetypes;
TY190933* usedby;
};
typedef Tinstantiation190833* TY412582[1];
...
N_NIMCALL(void, init_46655)(Tcellseq46563* s, NI cap);
...
N_NIMCALL(void, init_46676)(Tcellset46559* s);
...
N_NIMCALL(void, excl_47295)(Tcellset46559* s, Tcell46547* cell);
N_NIMCALL(Tpagedesc46555*, cellsetget_46723)(Tcellset46559 t, NI key);
static N_INLINE(NI, nexttry_46715)(NI h, NI maxhash);
N_NIMCALL(void, preparedealloc_50608)(Tcell46547* cell);
static N_INLINE(void*, celltousr_50025)(Tcell46547* cell);
...
N_NIMCALL(void, cellsetrawinsert_46752)(Tcellset46559 t, Tpagedesc46555** data, Tpagedesc46555* desc);
...
N_NIMCALL(void, deinit_46687)(Tcellset46559* s);
...
N_NIMCALL(void, objectinitaux_81494)(void* dest, TNimNode* n);
...
N_NIMCALL(NimStringDesc*, readallfile_79321)(FILE* file, NI len);
...
static N_INLINE(void*, seqtoptr_412864)(Tsymseq190815* x);
...
N_NIMCALL(NIM_BOOL, HEX3DHEX3D_290899)(TY290209 x, TY290209 y);
...
NIM_CONST TY79811 Formatopen_79810 = {((NimStringDesc*) &TMP971),
...
STRING_LITERAL(TMP4987, "EOF reached", 11);
STRING_LITERAL(TMP5010, "[GC] total memory: ", 19);
STRING_LITERAL(TMP5011, "\012[GC] occupied memory: ", 23);
STRING_LITERAL(TMP5012, "\012[GC] stack scans: ", 19);
STRING_LITERAL(TMP5013, "\012[GC] stack cells: ", 19);
STRING_LITERAL(TMP5014, "\012[GC] cycle collections: ", 25);
STRING_LITERAL(TMP5015, "\012[GC] max threshold: ", 21);
STRING_LITERAL(TMP5016, "\012[GC] zct capacity: ", 20);
STRING_LITERAL(TMP5017, "\012[GC] max cycle table size: ", 28);
STRING_LITERAL(TMP5018, "\012[GC] max stack size: ", 22);
STRING_LITERAL(TMP5019, "\012[GC] max pause time [ms]: ", 27);
...
TNimType NTI27620; /* array[0..15, int] */
...
TNimType NTI86601; /* ref AssertionError */
...
N_NIMCALL(NIM_BOOL, contains_29959)(Tintset27617* s, NI key) {
	...
	Ttrunk27613* t;
	result = 0;
	t = intsetget_29898(s, (NI)((NU32)(key) >> (NU32)(((NI) 9))));
	{
		NI u;
...
static N_INLINE(void, updateprevsize_31283)(Tmemregion28410* a, Tbigchunk27642* c, NI prevsize) {
	Tbasechunk27638* ri;
	ri = ((Tbasechunk27638*) ((NI)((NU32)(((NI) (c))) + (NU32)((*c).Sup.size))));
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
...
N_NIMCALL(void, incl_29983)(Tmemregion28410* a, Tintset27617* s, NI key) {
	Ttrunk27613* t;
	NI u;
	t = intsetput_29929(a, s, (NI)((NU32)(key) >> (NU32)(((NI) 9))));
	u = (NI)(key & ((NI) 511));
...
N_NIMCALL(void, splitchunk_34215)(Tmemregion28410* a, Tbigchunk27642* c, NI size) {
	...
	NI LOC2;
	rest = ((Tbigchunk27642*) ((NI)((NU32)(((NI) (c))) + (NU32)(size))));
...
N_NIMCALL(void*, rawalloc_35901)(Tmemregion28410* a, NI requestedsize) {
	...
	LA3: ;
	{
		...
		LA22: ;
		add_29601(a, &(*a).root, ((NI) (result)), (NI)((NU32)(((NI) (result))) + (NU32)(size)));
	}
	LA1: ;
	return result;
}
...
N_NIMCALL(void*, alloc_45031)(Tmemregion28410* allocator, NI size) {
	...
	result = ((void*) ((NI)((NU32)(((NI) (result))) + (NU32)(((NI)sizeof(Tfreecell27630))))));
	return result;
}
...
N_NIMCALL(void, initgc_9801)(void) {
	...
	init_46655((&gch_48444.zct), ((NI) 1024));
	init_46655((&gch_48444.tempstack), ((NI) 1024));
	init_46676((&gch_48444.cycleroots));
	init_46655((&gch_48444.decstack), ((NI) 1024));
}
	...
	result = 0;
	{
		...
		c_43894 = pageaddr_30455(p);
		{
			...
			if (!!(LOC8)) goto LA9;
			{
				...
				offset = (NI)((NU32)(((NI) ((NI)(((NI) (p)) & ((NI) 4095))))) - (NU32)((NI)(((NI)sizeof(Tsmallchunk27640)) - ((NI) 8))));
				{
					Tfreecell27630* d;
					if (!((NU32)(offset) < (NU32)((*c).acc))) goto LA18;
					d = ((Tfreecell27630*) ((NI)((NU32)((NI)((NU32)(((NI) ((&(*c).data)))) + (NU32)(offset))) - (NU32)((NI)((NU32)(offset) % (NU32)((*c).Sup.size))))));
					{
			...
			LA14: ;
			{
				...
				d = (&(*c).data);
				{
					...
					LOC27 = (((void*) (d)) <= p);
					if (!(LOC27)) goto LA28;
					LOC27 = ((NU32)(((NI) 1)) < (NU32)((*((Tfreecell27630*) (d))).zerofield));
					LA28: ;
					if (!LOC27) goto LA29;
					result = ((void*) (d));
				}
	...
	LA4: ;
	{
		...
		q = ((NI) (p));
		{
			...
			avlnode = inrange_29514((*a).root, q);
			{
				...
				{
					if (!((NU32)(((NI) 1)) < (NU32)((*((Tfreecell27630*) (k))).zerofield))) goto LA45;
					result = k;
				}
				LA45: ;
			}
...
N_NIMCALL(void, freebigchunk_31406)(Tmemregion28410* a, Tbigchunk27642* c_31410) {
	...
	LA5: ;
	{
		...
		le = ((Tbasechunk27638*) ((NI)((NU32)(((NI) (c))) - (NU32)((*c).Sup.prevsize))));
		{
			NIM_BOOL LOC19;
			LOC19 = 0;
...
N_NIMCALL(void, dealloc_45228)(Tmemregion28410* allocator, void* p) {
	void* x;
	x = ((void*) ((NI)((NU32)(((NI) (p))) - (NU32)(((NI)sizeof(Tfreecell27630))))));
...
N_NIMCALL(void, excl_47295)(Tcellset46559* s, Tcell46547* cell) {
	...
	Tpagedesc46555* t;
	u = ((NI) (cell));
	t = cellsetget_46723((*s), (NI)((NU32)(u) >> (NU32)(((NI) 12))));
	{
		if (!!((t == NIM_NIL))) goto LA3;
...
static N_INLINE(void*, celltousr_50025)(Tcell46547* cell) {
	void* result;
	result = 0;
	result = ((void*) ((NI)((NU32)(((NI) (cell))) + (NU32)(((NI)sizeof(Tcell46547))))));
	return result;
}
		...
		res_47047 = ((NI) 0);
		{
			while (1) {
				...
				i_47029 = res_47047;
				{
					...
					cellsetrawinsert_46752((*t), n, (*t).data[(i_47029)- 0]);
				}
				LA7: ;
				res_47047 += ((NI) 1);
			} LA4: ;
...
N_NOINLINE(void, incl_47265)(Tcellset46559* s, Tcell46547* cell) {
	...
	Tpagedesc46555* t;
	u = ((NI) (cell));
	t = cellsetput_47063(s, (NI)((NU32)(u) >> (NU32)(((NI) 12))));
	u = (NI)((NU32)((NI)((NU32)(u) % (NU32)(((NI) 4096)))) / (NU32)(((NI) 8)));
	...
	result = 0;
	{
		...
		c_43816 = pageaddr_30455(p);
		{
			...
			if (!!(LOC8)) goto LA9;
			{
				...
				LOC16 = LOC17;
				if (!(LOC16)) goto LA19;
				LOC16 = ((NU32)(((NI) 1)) < (NU32)((*((Tfreecell27630*) (p))).zerofield));
				LA19: ;
				result = LOC16;
			}
			goto LA11;
			LA14: ;
			{
				...
				LOC21 = (p == ((void*) ((&(*c).data))));
				if (!(LOC21)) goto LA22;
				LOC21 = ((NU32)(((NI) 1)) < (NU32)((*((Tfreecell27630*) (p))).zerofield));
				LA22: ;
				result = LOC21;
			}
			LA11: ;
...
N_NIMCALL(void, forallslotsaux_54608)(void* dest, TNimNode* n, NU8 op) {
	...
	case ((NU8) 1):
	{
		forallchildrenaux_50425(((void*) ((NI)((NU32)(d) + (NU32)((*n).offset)))), (*n).typ, op);
	}
	break;
	case ((NU8) 2):
	{
			...
			res_54809 = ((NI) 0);
			{
				while (1) {
					...
					i_54634 = res_54809;
					{
						...
						{
							if (!((*(*(*n).sons[(i_54634)- 0]).typ).kind == ((NU8) 22) || (*(*(*n).sons[(i_54634)- 0]).typ).kind == ((NU8) 28) || (*(*(*n).sons[(i_54634)- 0]).typ).kind == ((NU8) 24))) goto LA12;
							dooperation_50421((*((void**) ((NI)((NU32)(d) + (NU32)((*(*n).sons[(i_54634)- 0]).offset))))), op);
						}
						goto LA10;
						LA12: ;
						{
							forallchildrenaux_50425(((void*) ((NI)((NU32)(d) + (NU32)((*(*n).sons[(i_54634)- 0]).offset)))), (*(*n).sons[(i_54634)- 0]).typ, op);
						}
						LA10: ;
					}
					goto LA6;
		...
		{
			{
				...
				res_54877 = ((NI) 0);
				{
					while (1) {
						...
						i_54851 = res_54877;
						forallchildrenaux_50425(((void*) ((NI)((NU32)(d) + (NU32)((NI)((NU32)(i_54851) * (NU32)((*(*mt).base).size)))))), (*mt).base, op);
						res_54877 += ((NI) 1);
					} LA14: ;
				}
			}
				...
				if (!!((s == NIM_NIL))) goto LA13;
				{
					...
					res_55671 = ((NI) 0);
					{
						while (1) {
							...
							i_55635 = res_55671;
							forallchildrenaux_50425(((void*) ((NI)((NU32)((NI)((NU32)(d) + (NU32)((NI)((NU32)(i_55635) * (NU32)((*(*(*cell).typ).base).size))))) + (NU32)(((NI) 8))))), (*(*cell).typ).base, op);
							res_55671 += ((NI) 1);
						} LA17: ;
					}
				}
...
N_NIMCALL(void, markroots_66405)(Tgcheap48416* gch) {
	...
	{
		Tcell46547* s_66410;
		Tcellset46559 HEX3Atmp_66437;
		Tpagedesc46555* r_66442;
		s_66410 = 0;
						...
						j_66448 = ((NI) 0);
						{
							while (1) {
								if (!!((w_66446 == ((NI) 0)))) goto LA7;
								{
									...
									s_66410 = ((Tcell46547*) ((NI)((NI)((NU32)((*r_66442).key) << (NU32)(((NI) 12))) | (NI)((NU32)((NI)((NU32)((NI)((NU32)(i_66444) << (NU32)(((NI) 5)))) + (NU32)(j_66448))) * (NU32)(((NI) 8))))));
									tabsize += ((NI) 1);
									{
										NIM_BOOL LOC14;
										LOC14 = 0;
										...
										if (!(LOC14)) goto LA15;
										LOC14 = ((NU32)(((NI) 8)) <= (NU32)((*s_66410).refcount));
										LA15: ;
										if (!LOC14) goto LA16;
								...
								LA10: ;
								j_66448 += ((NI) 1);
								w_66446 = (NI)((NU32)(w_66446) >> (NU32)(((NI) 1)));
							} LA7: ;
						}
						i_66444 += ((NI) 1);
					} LA5: ;
						...
						j_68818 = ((NI) 0);
						{
							while (1) {
								if (!!((w_68816 == ((NI) 0)))) goto LA7;
								{
									...
									s_68805 = ((Tcell46547*) ((NI)((NI)((NU32)((*r_68812).key) << (NU32)(((NI) 12))) | (NI)((NU32)((NI)((NU32)((NI)((NU32)(i_68814) << (NU32)(((NI) 5)))) + (NU32)(j_68818))) * (NU32)(((NI) 8))))));
									collectwhite_66204(s_68805);
								}
								LA10: ;
								j_68818 += ((NI) 1);
								w_68816 = (NI)((NU32)(w_68816) >> (NU32)(((NI) 1)));
							} LA7: ;
						}
						i_68814 += ((NI) 1);
					} LA5: ;
						...
						j_69214 = ((NI) 0);
						{
							while (1) {
								if (!!((w_69212 == ((NI) 0)))) goto LA10;
								{
									...
									s_69001 = ((Tcell46547*) ((NI)((NI)((NU32)((*r_69208).key) << (NU32)(((NI) 12))) | (NI)((NU32)((NI)((NU32)((NI)((NU32)(i_69210) << (NU32)(((NI) 5)))) + (NU32)(j_69214))) * (NU32)(((NI) 8))))));
									scan_66004(s_69001);
								}
								LA13: ;
								j_69214 += ((NI) 1);
								w_69212 = (NI)((NU32)(w_69212) >> (NU32)(((NI) 1)));
							} LA10: ;
						}
						i_69210 += ((NI) 1);
					} LA8: ;
...
N_NOINLINE(void, raiseOverflow)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_23166).Sup.Sup.message; (*e_23166).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP50));
...
N_NOINLINE(void, chckNil)(void* p) {
	{
		...
		(*e_22419).Sup.Sup.m_type = (&NTI3449);
		LOC5 = 0;
		LOC5 = (*e_22419).Sup.message; (*e_22419).Sup.message = copyStringRC1(((NimStringDesc*) &TMP129));
	...
	{
		{
			...
			res_82240 = ((NI) 0);
			{
				while (1) {
					...
					i_82213 = res_82240;
					genericReset(((void*) ((NI)((NU32)(d) + (NU32)((NI)((NU32)(i_82213) * (NU32)((*(*mt).base).size)))))), (*mt).base);
					res_82240 += ((NI) 1);
				} LA7: ;
			}
		}
...
N_NIMCALL(void*, growobj_62006)(void* old, NI newsize, Tgcheap48416* gch) {
	...
	zeroMem(((void*) ((NI)((NU32)((NI)((NU32)(((NI) (res))) + (NU32)(oldsize))) + (NU32)(((NI)sizeof(Tcell46547)))))), ((NI) ((NI)(newsize - oldsize))));
	{
...
N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen) {
	...
	LA3: ;
	{
		...
		void* LOC7;
		LOC6 = 0;
		LOC6 = resize_76201(((NI) ((NI)((*dest).Sup.reserved & ((NI) 2147483647)))));
...
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c) {
	...
	result = s;
	{
		...
		(*result).Sup.reserved = resize_76201(((NI) ((NI)((*result).Sup.reserved & ((NI) 2147483647)))));
		LOC5 = 0;
...
N_NIMCALL(TGenericSeq*, incrSeq)(TGenericSeq* seq, NI elemsize) {
	...
	result = seq;
	{
		...
		(*result).reserved = resize_76201(((NI) ((NI)((*result).reserved & ((NI) 2147483647)))));
		LOC5 = 0;
		LOC5 = growobj_64818(((void*) (result)), (NI)((NI)(elemsize * (*result).reserved) + ((NI) 8)));
		...
		dst = ((NI) ((*((void**) (dest)))));
		{
			...
			res_81146 = ((NI) 0);
			{
				while (1) {
					...
					i_81012 = res_81146;
					genericassignaux_80406(((void*) ((NI)((NU32)((NI)((NU32)(dst) + (NU32)((NI)((NU32)(i_81012) * (NU32)((*(*mt).base).size))))) + (NU32)(((NI) 8))))), ((void*) ((NI)((NU32)((NI)((NU32)(((NI) (s2))) + (NU32)((NI)((NU32)(i_81012) * (NU32)((*(*mt).base).size))))) + (NU32)(((NI) 8))))), (*mt).base, shallow);
					res_81146 += ((NI) 1);
				} LA24: ;
			}
		}
	...
	{
		{
			...
			res_81157 = ((NI) 0);
			{
				while (1) {
					...
					i_81091 = res_81157;
					genericassignaux_80406(((void*) ((NI)((NU32)(d) + (NU32)((NI)((NU32)(i_81091) * (NU32)((*(*mt).base).size)))))), ((void*) ((NI)((NU32)(s) + (NU32)((NI)((NU32)(i_81091) * (NU32)((*(*mt).base).size)))))), (*mt).base, shallow);
					res_81157 += ((NI) 1);
				} LA34: ;
			}
		}
...
N_NOINLINE(void, raiseeio_78405)(NimStringDesc* msg) {
	...
	NimStringDesc* LOC1;
	e_78410 = 0;
	e_78410 = (Ioerror3431*) newObj((&NTI78601), sizeof(Ioerror3431));
...
N_NIMCALL(void, write_13657)(FILE* f, NimStringDesc* s) {
	{
		...
		raiseeio_78405(((NimStringDesc*) &TMP143));
	}
	LA4: ;
}
...
N_NIMCALL(TGenericSeq*, setLengthSeq)(TGenericSeq* seq, NI elemsize, NI newlen) {
	...
	result = seq;
	{
		...
		LOC5 = 0;
		LOC5 = resize_76201(((NI) ((NI)((*result).reserved & ((NI) 2147483647)))));
		(*result).reserved = ((LOC5 >= newlen) ? LOC5 : newlen);
		LOC6 = 0;
		LOC6 = growobj_64818(((void*) (result)), (NI)((NI)(elemsize * (*result).reserved) + ((NI) 8)));
		...
		if (!(newlen < (*result).len)) goto LA8;
		{
			...
			res_77291 = newlen;
			{
				while (1) {
					...
					forallchildrenaux_50425(((void*) ((NI)((NU32)((NI)((NU32)(((NI) (result))) + (NU32)(((NI) 8)))) + (NU32)((NI)((NU32)(i_77211) * (NU32)(elemsize)))))), (*LOC13).base, ((NU8) 2));
					res_77291 += ((NI) 1);
				} LA12: ;
			}
		}
...
N_NIMCALL(FILE*, open_13417)(NimStringDesc* filename, NU8 mode, NI bufsize) {
	...
	result = 0;
	{
		...
		if (!!(LOC3)) goto LA4;
		e_13426 = 0;
		e_13426 = (Ioerror3431*) newObj((&NTI78601), sizeof(Ioerror3431));
...
N_NIMCALL(void, reraiseException)(void) {
	{
		Reraiseerror3463* e_19020;
		NimStringDesc* LOC5;
		if (!(currexception_17245 == NIM_NIL)) goto LA3;
		e_19020 = 0;
		e_19020 = (Reraiseerror3463*) newObj((&NTI19201), sizeof(Reraiseerror3463));
		(*e_19020).Sup.Sup.m_type = (&NTI3463);
		LOC5 = 0;
		LOC5 = (*e_19020).Sup.message; (*e_19020).Sup.message = copyStringRC1(((NimStringDesc*) &TMP978));
		if (LOC5) nimGCunrefNoCycle(LOC5);
		raiseException((Exception*)e_19020, "ReraiseError");
	}
	goto LA1;
	LA3: ;
	{
...
{	result = 0;
	{
		...
		e = ((NI) ((NI)(e_82729 & ((NI) 255))));
	}
	goto LA1;
	LA3: ;
	{
		if (!((*typ).size == ((NI) 2))) goto LA6;
		e = ((NI) ((NI)(e_82729 & ((NI) 65535))));
	}
	goto LA1;
	LA6: ;
	{
	...
	LA11: ;
	{
		...
		s = (*n).sons;
		{
			...
			i_82768 = 0;
			HEX3Atmp_82770 = 0;
			HEX3Atmp_82770 = (NI)((*n).len - ((NI) 1));
			res_82773 = ((NI) 0);
			{
				while (1) {
					if (!(res_82773 <= HEX3Atmp_82770)) goto LA20;
					i_82768 = res_82773;
					{
						if (!((*s[(i_82768)- 0]).offset == e)) goto LA23;
						result = cstrToNimstr((*s[(i_82768)- 0]).name);
						goto BeforeRet;
					}
					LA23: ;
					res_82773 += ((NI) 1);
	...
	{
		{
			...
			i_81620 = 0;
			HEX3Atmp_81637 = 0;
			HEX3Atmp_81637 = (NI)((*n).len - ((NI) 1));
			res_81640 = ((NI) 0);
			{
				while (1) {
					if (!(res_81640 <= HEX3Atmp_81637)) goto LA6;
					i_81620 = res_81640;
					objectinitaux_81494(dest, (*n).sons[(i_81620)- 0]);
					res_81640 += ((NI) 1);
				} LA6: ;
			}
		}
...
N_NIMCALL(void, objectInit)(void* dest, TNimType* typ) {
	...
	case ((NU8) 17):
	{
		...
		pint = ((TNimType**) (dest));
		(*pint) = typ;
		objectinitaux_81494(dest, (*typ).node);
	}
	break;
	case ((NU8) 18):
	{
	...
	{
		{
			...
			i_81673 = 0;
			HEX3Atmp_81687 = 0;
			HEX3Atmp_81687 = (NI)((NI)((*typ).size / (*(*typ).base).size) - ((NI) 1));
			res_81690 = ((NI) 0);
			{
				while (1) {
					if (!(res_81690 <= HEX3Atmp_81687)) goto LA6;
					i_81673 = res_81690;
					objectInit(((void*) ((NI)((NU32)(d) + (NU32)((NI)(i_81673 * (*(*typ).base).size))))), (*typ).base);
					res_81690 += ((NI) 1);
				} LA6: ;
			}
		}
...
N_NIMCALL(NI, ptrsize_44816)(void* p) {
	...
	x = ((void*) ((NI)((NU32)(((NI) (p))) - (NU32)(((NI)sizeof(Tfreecell27630))))));
	c = pageaddr_30455(p);
	result = (NI)((NU32)((*c).size) - (NU32)(((NI)sizeof(Tfreecell27630))));
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
...
N_NIMCALL(NimStringDesc*, nimInt64ToStr)(NI64 x) {
	...
	result = setLengthStr(result, ((NI) (i)));
	{
		...
		j_77827 = 0;
		HEX3Atmp_77840 = 0;
		HEX3Atmp_77840 = (NI)((NI)(i / ((NI) 2)) - ((NI) 1));
		res_77843 = ((NI) 0);
		{
			while (1) {
				NIM_CHAR LOC14;
				if (!(res_77843 <= HEX3Atmp_77840)) goto LA13;
				j_77827 = res_77843;
				LOC14 = 0;
...
{	result = 0;
	{
		...
		void* LOC4;
		LOC3 = 0;
		LOC3 = seqtoptr_522194(x);
		LOC4 = 0;
		LOC4 = seqtoptr_522194(y);
	...
	LA5: ;
	{
		...
		LOC8 = 0;
		LOC9 = 0;
		LOC9 = seqtoptr_522194(x);
		LOC8 = (LOC9 == NIM_NIL);
		if (LOC8) goto LA10;
		LOC11 = 0;
		LOC11 = seqtoptr_522194(y);
		LOC8 = (LOC11 == NIM_NIL);
		LA10: ;
		if (!LOC8) goto LA12;
		result = NIM_FALSE;
	...
	LA12: ;
	{
		if (!((x ? x->Sup.len : 0) == (y ? y->Sup.len : 0))) goto LA15;
		{
			...
			i_522263 = 0;
			HEX3Atmp_522265 = 0;
			HEX3Atmp_522265 = (NI)((x ? x->Sup.len : 0) - ((NI) 1));
			res_522268 = ((NI) 0);
			{
				while (1) {
					if (!(res_522268 <= HEX3Atmp_522265)) goto LA19;
					i_522263 = res_522268;
					{
						if (!!((x->data[i_522263] == y->data[i_522263]))) goto LA22;
						result = NIM_FALSE;
						goto BeforeRet;
					}
					LA22: ;
...
N_NIMCALL(void, safeadd_522172)(TY190933** x, NI32 y) {
	{
		...
		TY522284 LOC6;
		LOC3 = 0;
		LOC3 = HEX3DHEX3D_522183((*x), NIM_NIL);
		if (!LOC3) goto LA4;
...
N_NIMCALL(NI, hashString)(NimStringDesc* s) {
	...
	h = ((NI) 0);
	{
		...
		i_76624 = 0;
		HEX3Atmp_76671 = 0;
		HEX3Atmp_76671 = (NI)((s ? s->Sup.len : 0) - ((NI) 1));
		res_76674 = ((NI) 0);
		{
			while (1) {
				if (!(res_76674 <= HEX3Atmp_76671)) goto LA3;
				i_76624 = res_76674;
				h = (NI)((NU32)(h) + (NU32)(((NI) (((NU8)(s->data[i_76624]))))));
...
N_NIMCALL(void, Gcdisablemarkandsweep_8819)(void) {
	gch_48444.cyclethreshold = ((NI) 2147483646);
}
N_NIMCALL(void, TMP1533)(void* p, NI op) {
	Indexerror3455* a;
	a = (Indexerror3455*)p;
...
N_NOINLINE(void, raiseassert_86557)(NimStringDesc* msg) {
	Assertionerror3447* e_86562;
	NimStringDesc* LOC1;
	e_86562 = 0;
	e_86562 = (Assertionerror3447*) newObj((&NTI86601), sizeof(Assertionerror3447));
	(*e_86562).Sup.Sup.m_type = (&NTI3447);
	LOC1 = 0;
	LOC1 = (*e_86562).Sup.message; (*e_86562).Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_86562, "AssertionError");
}
...
N_NIMCALL(NimStringDesc*, readallfile_79321)(FILE* file, NI len) {
	...
	result = mnewString(((NI) (len)));
	{
		...
		raiseeio_78405(((NimStringDesc*) &TMP2602));
	}
	LA4: ;
	return result;
}
...
N_NIMCALL(NimStringDesc*, readall_13631)(FILE* file) {
	...
	LA1: ;
	{
		...
		result = readallfile_79321(file, len);
	}
	goto LA6;
	LA8: ;
	{
...
N_NIMCALL(void, setfilepos_13742)(FILE* f, NI64 pos) {
	{
		...
		raiseeio_78405(((NimStringDesc*) &TMP2681));
	}
	LA4: ;
}
...
N_NIMCALL(NI64, getfilepos_13746)(FILE* f) {
	...
	result = ((NI64) (LOC1));
	{
		...
		raiseeio_78405(((NimStringDesc*) &TMP2682));
	}
	LA4: ;
	return result;
}
...
N_NIMCALL(NIM_BOOL, open_13411)(FILE** f, int filehandle, NU8 mode) {
	NIM_BOOL result;
	result = 0;
	(*f) = fdopen(filehandle, Formatopen_79810[(mode)- 0]->data);
	result = !(((*f) == NIM_NIL));
	return result;
}
...
N_NIMCALL(Tnodeseq190807*, HEX5BHEX5D_431717)(Tnodeseq190807* s, Slice85970 x) {
	...
	result = (Tnodeseq190807*) newSeq((&NTI190807), ((NI) (L)));
	{
		...
		{
			while (1) {
				if (!(res_431763 <= HEX3Atmp_431760)) goto LA3;
				i_431758 = res_431763;
				asgnRefNoCycle((void**) (&result->data[i_431758]), s->data[(NI)(i_431758 + a)]);
				res_431763 += ((NI) 1);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		void* LOC4;
		LOC3 = 0;
		LOC3 = seqtoptr_412864(x);
		LOC4 = 0;
		LOC4 = seqtoptr_412864(y);
		if (!(LOC3 == LOC4)) goto LA5;
		result = NIM_TRUE;
	}
	goto LA1;
	LA5: ;
	{
		...
		LOC8 = 0;
		LOC9 = 0;
		LOC9 = seqtoptr_412864(x);
		LOC8 = (LOC9 == NIM_NIL);
		if (LOC8) goto LA10;
		LOC11 = 0;
		LOC11 = seqtoptr_412864(y);
		LOC8 = (LOC11 == NIM_NIL);
		LA10: ;
		if (!LOC8) goto LA12;
		result = NIM_FALSE;
	...
	LA12: ;
	{
		if (!((x ? x->Sup.len : 0) == (y ? y->Sup.len : 0))) goto LA15;
		{
			...
			i_412933 = 0;
			HEX3Atmp_412946 = 0;
			HEX3Atmp_412946 = (NI)((x ? x->Sup.len : 0) - ((NI) 1));
			res_412949 = ((NI) 0);
			{
				while (1) {
					if (!(res_412949 <= HEX3Atmp_412946)) goto LA19;
					i_412933 = res_412949;
					{
						if (!!((x->data[i_412933] == y->data[i_412933]))) goto LA22;
						result = NIM_FALSE;
						goto BeforeRet;
					}
					LA22: ;
...
N_NIMCALL(void, safeadd_412966)(Tsymseq190815** x, Tsym190843* y) {
	{
		...
		TY244432 LOC6;
		LOC3 = 0;
		LOC3 = HEX3DHEX3D_412853((*x), NIM_NIL);
		if (!LOC3) goto LA4;
...
N_NIMCALL(void, delete_413490)(Tnodeseq190807** x, NI i) {
	...
	xl = ((*x) ? (*x)->Sup.len : 0);
	{
		...
		j_413518 = 0;
		HEX3Atmp_413530 = 0;
		HEX3Atmp_413530 = (NI)(xl - ((NI) 2));
		res_413533 = ((NI) (i));
		{
			while (1) {
				if (!(res_413533 <= HEX3Atmp_413530)) goto LA3;
				j_413518 = res_413533;
				asgnRefNoCycle((void**) (&(*x)->data[j_413518]), (*x)->data[(NI)(j_413518 + ((NI) 1))]);
				res_413533 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NIMCALL(void, HEX5BHEX5DHEX3D_413619)(Tnodeseq190807** s, Slice85970 x, Tnode190813** b, NI bLen0) {
	...
	L = (NI)((NI)(x.b - a) + ((NI) 1));
	{
		if (!(L == bLen0)) goto LA3;
		{
			...
			{
				while (1) {
					if (!(res_413774 <= HEX3Atmp_413771)) goto LA7;
					i_413671 = res_413774;
					asgnRefNoCycle((void**) (&(*s)->data[(NI)(i_413671 + a)]), b[i_413671]);
					res_413774 += ((NI) 1);
				} LA7: ;
			}
		}
	...
	LA3: ;
	{
		...
		NI shift_413635;
		NI newlen_413637;
		slen_413633 = ((*s) ? (*s)->Sup.len : 0);
		shift_413635 = (NI)(bLen0 - L);
		newlen_413637 = (NI)(slen_413633 + shift_413635);
		{
			if (!(((NI) 0) < shift_413635)) goto LA11;
			(*s) = (Tnodeseq190807*) setLengthSeq(&((*s))->Sup, sizeof(Tnode190813*), ((NI) (newlen_413637)));
			{
				NI i_413639;
				NI HEX3Atmp_413779;
				NI HEX3Atmp_413780;
				...
				HEX3Atmp_413779 = 0;
				HEX3Atmp_413780 = 0;
				HEX3Atmp_413779 = (NI)(newlen_413637 - ((NI) 1));
				HEX3Atmp_413780 = (NI)((NI)(a + shift_413635) + ((NI) 1));
				res_413783 = HEX3Atmp_413779;
				{
					while (1) {
						if (!(HEX3Atmp_413780 <= res_413783)) goto LA15;
						i_413639 = res_413783;
						asgnRefNoCycle((void**) (&(*s)->data[i_413639]), (*s)->data[(NI)(i_413639 - shift_413635)]);
						res_413783 -= ((NI) 1);
					} LA15: ;
				}
			}
		...
		{
			{
				...
				HEX3Atmp_413788 = 0;
				HEX3Atmp_413789 = 0;
				HEX3Atmp_413788 = (NI)(a + bLen0);
				HEX3Atmp_413789 = (NI)((NI)(((*s) ? (*s)->Sup.len : 0) - ((NI) 1)) + shift_413635);
				res_413792 = HEX3Atmp_413788;
				{
					while (1) {
						if (!(res_413792 <= HEX3Atmp_413789)) goto LA19;
						i_413641 = res_413792;
						asgnRefNoCycle((void**) (&(*s)->data[i_413641]), (*s)->data[(NI)(i_413641 - shift_413635)]);
						res_413792 += ((NI) 1);
					} LA19: ;
				}
			}
		...
		LA9: ;
		{
			...
			i_413643 = 0;
			HEX3Atmp_413797 = 0;
			HEX3Atmp_413797 = (bLen0 - 1);
			res_413800 = ((NI) 0);
			{
				while (1) {
					if (!(res_413800 <= HEX3Atmp_413797)) goto LA22;
					i_413643 = res_413800;
					asgnRefNoCycle((void**) (&(*s)->data[(NI)(i_413643 + a)]), b[i_413643]);
					res_413800 += ((NI) 1);
				} LA22: ;
			}
		}
...
N_NIMCALL(void, Gcfullcollect_8805)(void) {
	NI oldthreshold;
	oldthreshold = gch_48444.cyclethreshold;
...
N_NIMCALL(NimStringDesc*, readline_13678)(FILE* f) {
	...
	result = rawNewString(((NI) 80));
	{
		...
		if (!!(LOC3)) goto LA4;
		raiseeio_78405(((NimStringDesc*) &TMP4987));
	}
	LA4: ;
	return result;
}
...
appendString(LOC1, ((NimStringDesc*) &TMP5010));
...
NTI78601.size = sizeof(Ioerror3431*);
NTI78601.kind = 22;
NTI78601.base = (&NTI3431);
NTI78601.marker = TMP142;
...
NTI19201.marker = TMP977;
NTI27620.size = sizeof(TY27620);
NTI27620.kind = 16;
NTI27620.base = (&NTI108);
NTI27620.flags = 3;
...
NTI86601.size = sizeof(Assertionerror3447*);
NTI86601.kind = 22;
NTI86601.base = (&NTI3447);
NTI86601.marker = TMP2156;
