...
N_NIMCALL(NI, hashtree_287027)(tnode225816* n);
...
N_NIMCALL(NI, nodetablerawget_287509)(tnodetable225876 t, NI k, tnode225816* key);
N_NIMCALL(NIM_BOOL, treesequivalent_287243)(tnode225816* a, tnode225816* b);
...
N_NIMCALL(void, nodetablerawinsert_287562)(tnodepairseq225874** data, NI k, tnode225816* key, NI val);
...
extern TNimType NTI225874; /* TNodePairSeq */
...
N_NIMCALL(NI, nodetabletestorset_288121)(tnodetable225876* t, tnode225816* key, NI val) {
	...
	LA3: ;
	{
		{
			NIM_BOOL LOC8;
			tnodepairseq225874* LOC18;
			LOC8 = 0;
			LOC8 = mustrehash_235249((*t).Data->Sup.len, (*t).Counter);
			if (!LOC8) goto LA9;
			n = (tnodepairseq225874*) newSeq((&NTI225874), (NI64)((*t).Data->Sup.len * 2));
			{
				NI i_288251;
				NI HEX3Atmp_288301;
				NI res_288304;
