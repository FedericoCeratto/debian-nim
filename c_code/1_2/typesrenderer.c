...
N_NIMCALL(void, renderparamtypes_400467)(TY120608** found, tnode226816* n);
...
STRING_LITERAL(TMP4663, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP4670, "ref.", 4);
STRING_LITERAL(TMP4671, "ptr.", 4);
STRING_LITERAL(TMP4672, "proc(", 5);
STRING_LITERAL(TMP4673, "tuple[", 6);
STRING_LITERAL(TMP4674, "renderParamTypes(found,n) with ", 31);
...
N_NIMCALL(NimStringDesc*, renderplainsymbolname_398013)(tnode226816* n) {
	...
	{
		{
			if (!!(eqStrings((*(*n).kindU.S5.Ident).S, ((NimStringDesc*) &TMP4662)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP4663));
...
appendString(LOC6, ((NimStringDesc*) &TMP4670));
...
appendString(LOC10, ((NimStringDesc*) &TMP4671));
appendString(LOC10, LOC12);
	...
	case ((NU8) 146):
	{
		...
		result = copyString(((NimStringDesc*) &TMP4672));
		{
			NI i_399422;
			NI HEX3Atmp_400402;
			NI LOC15;
		...
		LA15: ;
		{
			...
			res_400836 = 0;
			{
				while (1) {
					...
					i_400646 = res_400836;
					(*found) = (TY120608*) incrSeq(&((*found))->Sup, sizeof(NimStringDesc*));
					LOC29 = 0;
...
appendString(LOC31, ((NimStringDesc*) &TMP4674));
...
N_NIMCALL(NimStringDesc*, renderparamtypes_400862)(tnode226816* n, NimStringDesc* sep) {
	...
	result = 0;
	result = copyString(((NimStringDesc*) &TMP4661));
	found = (TY120608*) newSeq((&NTI120608), 0);
