...
101}
;
STRING_LITERAL(TMP4875, "GB", 2);
STRING_LITERAL(TMP4876, "MB", 2);
STRING_LITERAL(TMP4877, "KB", 2);
STRING_LITERAL(TMP4878, "B", 1);
...
appendString(LOC7, ((NimStringDesc*) &TMP1064));
appendString(LOC7, s);
...
appendString(LOC7, ((NimStringDesc*) &TMP1070));
appendString(LOC7, s);
	...
	result = mnewString(len);
	{
		...
		res_95595 = HEX3Atmp_95592;
		{
			while (1) {
				...
				j_95588 = res_95595;
				result->data[j_95588] = ((NimStringDesc*) &TMP1217)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(x) >> (NU64)(shift)))) & ((NI32) 15))];
...
N_NIMCALL(NimStringDesc*, quoteifcontainswhite_97234)(NimStringDesc* s) {
	...
	result = 0;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = nsuFindCharSet(s, TMP1566, 0);
		LOC3 = (0 <= LOC4);
		if (!(LOC3)) goto LA5;
...
N_NIMCALL(TY118808*, nsuSplitChar)(NimStringDesc* s, NIM_CHAR sep) {
	TY118808* result;
	result = 0;
	result = (TY118808*) newSeq((&NTI118808), 0);
	{
		...
		last_95472 = 0;
		{
			if (!(0 < s->Sup.len)) goto LA4;
			{
				while (1) {
					...
					result = (TY118808*) incrSeq(&(result)->Sup, sizeof(NimStringDesc*));
					LOC12 = 0;
...
appendString(LOC5, ((NimStringDesc*) &TMP4875));
		result = LOC5;
	}
	goto LA1;
	LA3: ;
...
appendString(LOC12, ((NimStringDesc*) &TMP4876));
		result = LOC12;
	}
	goto LA1;
	LA10: ;
...
appendString(LOC19, ((NimStringDesc*) &TMP4877));
		result = LOC19;
	}
	goto LA1;
	LA17: ;
...
appendString(LOC24, ((NimStringDesc*) &TMP4878));
		result = LOC24;
	}
	LA1: ;
	return result;
