...
stringtableobj130012* gcookies_395172;
...
N_NIMCALL(NimStringDesc*, encodeurl_394004)(NimStringDesc* s) {
	...
	result = rawNewString((NI64)(s->Sup.len + (NI)((NU64)(s->Sup.len) >> (NU64)(2))));
	{
		...
		i_394018 = 0;
		HEX3Atmp_394028 = 0;
		HEX3Atmp_394028 = (NI64)(s->Sup.len - 1);
		res_394031 = 0;
		{
			while (1) {
				if (!(res_394031 <= HEX3Atmp_394028)) goto LA3;
				i_394018 = res_394031;
				switch (((NU8)(s->data[i_394018]))) {
				case 97 ... 122:
				case 65 ... 90:
				case 48 ... 57:
				case 95:
				{
					result = addChar(result, s->data[i_394018]);
				}
				break;
				case 32:
				{
				...
				default:
				{
					...
					LOC7 = 0;
					LOC7 = nsuToHex(((NI64) (((NU8)(s->data[i_394018])))), 2);
