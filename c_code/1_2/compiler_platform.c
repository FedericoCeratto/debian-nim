...
NIM_CONST TY176514 Cpu_176500 = {{((NimStringDesc*) &TMP63),
((NI) 32),
((NU8) 0),
((NI) 64),
((NI) 32)}
...
NIM_CONST TY176084 Os_176070 = {{((NimStringDesc*) &TMP81),
((NimStringDesc*) &TMP82),
((NimStringDesc*) &TMP83),
((NimStringDesc*) &TMP84),
((NimStringDesc*) &TMP85),
...
{	result = 0;
	{
		...
		{
			while (1) {
				if (!(res_177428 <= ((NI) 18))) goto LA3;
				i_177423 = ((NU8) (res_177428));
				{
					NI LOC6;
					LOC6 = 0;
					LOC6 = nsuCmpIgnoreStyle(name, Cpu_176500[(i_177423)- 1].Field0);
...
{	result = 0;
	{
		...
		{
			while (1) {
				if (!(res_177228 <= ((NI) 24))) goto LA3;
				i_177223 = ((NU8) (res_177228));
				{
					NI LOC6;
					LOC6 = 0;
					LOC6 = nsuCmpIgnoreStyle(name, Os_176070[(i_177223)- 1].Field0);
					if (!(LOC6 == ((NI) 0))) goto LA7;
					result = i_177223;
					goto BeforeRet;
				}
...
N_NIMCALL(void, settarget_176662)(NU8 o, NU8 c) {
	...
	targetcpu_176628 = c;
	targetos_176630 = o;
	intsize_176651 = (NI)(Cpu_176500[(c)- 1].Field1 / ((NI) 8));
	floatsize_176652 = (NI)(Cpu_176500[(c)- 1].Field3 / ((NI) 8));
	ptrsize_176653 = (NI)(Cpu_176500[(c)- 1].Field4 / ((NI) 8));
	LOC1 = 0;
	LOC1 = tnl_176654; tnl_176654 = copyStringRC1(Os_176070[(o)- 1].Field5);
	if (LOC1) nimGCunrefNoCycle(LOC1);
}
NIM_EXTERNC N_NOINLINE(void, compiler_platformInit000)(void) {
	hostcpu_176629 = nametocpu_176645(((NimStringDesc*) &TMP72));
	hostos_176631 = nametoos_176639(((NimStringDesc*) &TMP131));
	settarget_176662(hostos_176631, hostcpu_176629);
}
