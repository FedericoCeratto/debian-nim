...
N_NIMCALL(void, strtableenlarge_239628)(tstrtable224820* t) {
	...
	tsymseq224818* LOC8;
	n = 0;
	n = (tsymseq224818*) newSeq((&NTI224818), (NI32)((*t).Data->Sup.len * 2));
	{
		NI i_239672;
		NI HEX3Atmp_239708;
		NI res_239711;
	...
	{
		{
			...
			LOC8 = mustrehash_234249((*t).Data->Sup.len, (*t).Counter);
			if (!LOC8) goto LA9;
			n = (tidpairseq224862*) newSeq((&NTI224862), (NI32)((*t).Data->Sup.len * 2));
			{
				NI i_241251;
				NI HEX3Atmp_241432;
				NI res_241435;
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = 0;
			n = (tidnodepairseq224868*) newSeq((&NTI224868), (NI32)((*t).Data->Sup.len * 2));
			{
				NI i_242052;
				NI HEX3Atmp_242101;
				NI res_242104;
