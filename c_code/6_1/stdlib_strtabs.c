...
STRING_LITERAL(TMP1713, "key not found: ", 15);
STRING_LITERAL(TMP1962, "", 0);
STRING_LITERAL(TMP2207, "format string: key not found: ", 30);
...
appendString(LOC6, ((NimStringDesc*) &TMP1713));
...
appendString(LOC1, ((NimStringDesc*) &TMP2207));
