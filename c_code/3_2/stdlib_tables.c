...
N_NIMCALL(void, enlarge_359019)(table358052* t_359028) {
	...
	n = 0;
	n = (keyvaluepairseq358055*) newSeq((&NTI358055), (NI64)((*t_359028).Data->Sup.len * 2));
	{
		NI i_359074;
		NI HEX3Atmp_359153;
		NI res_359156;
...
N_NIMCALL(void, enlarge_362346)(table359277* t_362355) {
	...
	n = 0;
	n = (keyvaluepairseq359280*) newSeq((&NTI359280), (NI64)((*t_362355).Data->Sup.len * 2));
	{
		NI i_362401;
		NI HEX3Atmp_362480;
		NI res_362483;
...
TMP53[15].len = 2; TMP53[15].kind = 2; TMP53[15].sons = &TMP4626[0];
