...
static NIM_CONST TY210607 TMP1568 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY210607 TMP1569 = {
...
N_NIMCALL(void, initoptparser_206030)(NimStringDesc* cmdline, optparser206011* Result) {
	...
	LA3: ;
	{
		unsureAsgnRef((void**) (&(*Result).Cmd), copyString(((NimStringDesc*) &TMP1565)));
		{
			...
			i_206046 = 0;
			HEX3Atmp_206049 = 0;
			HEX3Atmp_206049 = paramcount_122639();
			res_206052 = 1;
			{
				while (1) {
					NimStringDesc* LOC9;
					...
					LOC9 = 0;
					LOC10 = 0;
					LOC10 = paramstr_122609(i_206046);
					LOC11 = 0;
...
N_NIMCALL(void, handleshortoption_206309)(optparser206011* p) {
	...
	}
	{
		...
		i = parseword_206204((*p).Cmd, i, (&(*p).Val), TMP1568);
	}
	LA5: ;
	{
...
N_NIMCALL(void, nponext)(optparser206011* p) {
	...
	case 45:
	{
		i += 1;
		{
			...
			(*p).Kind = ((NU8) 2);
			i += 1;
			i = parseword_206204((*p).Cmd, i, (&(*p).Key), TMP1569);
			{
				while (1) {
			...
			}
			{
				...
				(*p).Pos = parseword_206204((*p).Cmd, i, (&(*p).Val), TMP1568);
			}
			goto LA15;
			LA17: ;
			{
	...
	{
		(*p).Kind = ((NU8) 1);
		(*p).Pos = parseword_206204((*p).Cmd, i, (&(*p).Key), TMP1568);
	}
	break;
	}
	BeforeRet: ;
...
TMP1561[0] = &TMP706[1];
TMP706[1].kind = 1;
TMP706[1].offset = offsetof(optparser206011, Cmd);
TMP706[1].typ = (&NTI149);
TMP706[1].name = "cmd";
TMP1561[1] = &TMP706[2];
TMP706[2].kind = 1;
TMP706[2].offset = offsetof(optparser206011, Pos);
TMP706[2].typ = (&NTI108);
TMP706[2].name = "pos";
TMP1561[2] = &TMP706[3];
TMP706[3].kind = 1;
TMP706[3].offset = offsetof(optparser206011, Inshortstate);
TMP706[3].typ = (&NTI138);
...
NTI206009.node = &TMP706[9];
TMP706[4].kind = 1;
TMP706[4].offset = offsetof(optparser206011, Kind);
TMP706[4].typ = (&NTI206009);
TMP706[4].name = "kind";
TMP1561[4] = &TMP706[10];
TMP706[10].kind = 1;
TMP706[10].offset = offsetof(optparser206011, Key);
TMP706[10].typ = (&NTI149);
TMP706[10].name = "key";
TMP1561[5] = &TMP706[11];
TMP706[11].kind = 1;
TMP706[11].offset = offsetof(optparser206011, Val);
TMP706[11].typ = (&NTI149);
TMP706[11].name = "val";
TMP706[0].len = 6; TMP706[0].kind = 2; TMP706[0].sons = &TMP1561[0];
NTI206011.node = &TMP706[0];
}
