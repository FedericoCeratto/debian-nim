...
N_NIMCALL(tnode226816*, extractrange_263440)(NU8 k, tnode226816* n, NI a, NI b) {
	tnode226816* result;
	result = 0;
	result = newnodei_229007(k, (*n).Info, (NI32)((NI32)(b - a) + 1));
	{
		NI i_263457;
		NI HEX3Atmp_263487;
		NI res_263490;
		i_263457 = 0;
		HEX3Atmp_263487 = 0;
		HEX3Atmp_263487 = (NI32)(b - a);
		res_263490 = 0;
		{
			while (1) {
				if (!(res_263490 <= HEX3Atmp_263487)) goto LA3;
				i_263457 = res_263490;
				asgnRefNoCycle((void**) (&(*result).kindU.S6.Sons->data[i_263457]), (*n).kindU.S6.Sons->data[(NI32)(i_263457 + a)]);
				res_263490 += 1;
			} LA3: ;
		}
	}
