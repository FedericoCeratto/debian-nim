...
{	result0 = (NimStringDesc*)0;
	...
	case ((Tnodekind263020) 22):
	{
		...
		if (TMP3797.status == 0) {
			...
			LOC3 = tofullpath_186270_155036129((*n0).info.fileindex);
...
N_NIMCALL(NI32, checkmodulename_318051_2178338529)(Tnode263794* n0) {
	...
	LOC1 = tofullpath_186270_155036129((*n0).info.fileindex);
	...
	LA4: ;
	{
		result0 = fileinfoidx_186016_155036129(fullpath0);
	}
	LA2: ;
	return result0;
}
...
N_NIMCALL(void, rawimportsymbol_318058_2178338529)(Tcontext314020* c0, Tsym263826* s0) {
	...
	LA13: ;
	{
		...
		LA42: ;
		{
			NIM_BOOL LOC46;
			LOC46 = (NIM_BOOL)0;
			LOC46 = haspattern_268411_850551059(s0);
			if (!LOC46) goto LA47;
			addpattern_314429_893308950(c0, s0);
		}
		LA47: ;
	}
	LA11: ;
