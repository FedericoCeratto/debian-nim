...
N_NIMCALL(Socketimpl554404*, newsocket_554821_170061329)(Domain548604 domain0, Socktype548606 socktype0, Protocol548608 protocol0, NIM_BOOL buffered0) {
	...
	fd0 = newnativesocket_549001_466562973(domain0, socktype0, protocol0);
	{
		...
		raiseoserror_127203_2125978480(LOC5, ((NimStringDesc*) &TMP5526));
	}
	LA3: ;
...
N_NIMCALL(void, bindaddr_555608_170061329)(Socketimpl554404* socket0, NU16 port0, NimStringDesc* address0) {
	{
		...
		name0.sin_addr.s_addr = ntohl_549806_466562973(INADDR_ANY);
		{
			...
			raiseoserror_127203_2125978480(LOC10, ((NimStringDesc*) &TMP5526));
		}
		LA8: ;
	}
	goto LA1;
	LA3: ;
	{
		...
		ailist0 = getaddrinfo_549402_466562973(address0, port0, (*socket0).domain, ((Socktype548606) 1), ((Protocol548608) 6));
		{
			...
			LOC17 = (NI32)0;
			LOC17 = oslasterror_127219_2125978480();
			raiseoserror_127203_2125978480(LOC17, ((NimStringDesc*) &TMP5526));
		}
		LA15: ;
		dealloc_549802_466562973(ailist0);
	}
...
N_NIMCALL(void, listen_555604_170061329)(Socketimpl554404* socket0, int backlog0) {
	{
		...
		raiseoserror_127203_2125978480(LOC6, ((NimStringDesc*) &TMP5526));
	}
	LA4: ;
}
...
N_NIMCALL(NI32, getsocketerror_555001_170061329)(Socketimpl554404* socket0) {
	NI32 result0;
	result0 = (NI32)0;
	result0 = oslasterror_127219_2125978480();
	{
	...
	LA3: ;
	{
		...
		raiseoserror_127203_2125978480(result0, ((NimStringDesc*) &TMP5529));
	}
	LA7: ;
	return result0;
}
...
{	{
		...
		LA7: ;
		{
			...
			LA20: ;
			{
				raiseoserror_127203_2125978480(laste0, ((NimStringDesc*) &TMP5526));
			}
			LA16: ;
		}
		goto LA12;
...
N_NIMCALL(void, send_559602_170061329)(Socketimpl554404* socket0, NimStringDesc* data0, Socketflag554414Set flags0) {
	NI sent0;
{	sent0 = send_559282_170061329(socket0, ((void*) (data0->data)), (data0 ? data0->Sup.len : 0));
	{
		NI32 lasterror0;
		if (!(sent0 < ((NI) 0))) goto LA3;
		lasterror0 = oslasterror_127219_2125978480();
		{
			NIM_BOOL LOC7;
			LOC7 = (NIM_BOOL)0;
	...
	LA3: ;
	{
		...
		raiseoserror_127203_2125978480(LOC14, ((NimStringDesc*) &TMP5530));
	}
	LA12: ;
	}BeforeRet: ;
}
...
N_NIMCALL(void, acceptaddr_555809_170061329)(Socketimpl554404* server0, Socketimpl554404** client0, NimStringDesc** address0, Socketflag554414Set flags0) {
	...
	sock0 = accept((*server0).fd, ((struct sockaddr*) ((&sockaddress0))), (&addrlen0));
	{
		...
		LA8: ;
		raiseoserror_127203_2125978480(err0, ((NimStringDesc*) &TMP5526));
	}
	goto LA1;
	LA3: ;
	{
...
appendString(LOC22, ((NimStringDesc*) &TMP5534));
		...
		selret0 = select_557801_170061329(socket0, (NI)(timeout0 - ((NI) (((NF)((*waited0)) * (NF)(1.0000000000000000e+03))))));
		{
			...
			LOC27 = (NI32)0;
			LOC27 = oslasterror_127219_2125978480();
			raiseoserror_127203_2125978480(LOC27, ((NimStringDesc*) &TMP5526));
		}
		LA25: ;
		{
...
{	result0 = (NI)0;
	...
	result0 = recv((*socket0).fd, ((void*) ((*socket0).isbufferedU.S1.buffer)), ((NI) 4000), flags0);
	{
		...
		(*socket0).lasterror = oslasterror_127219_2125978480();
	}
	LA3: ;
	{
...
{	waited0 = 0.0;
	(*line0) = setLengthStr((*line0), ((NI) 0));
	{
		while (1) {
			...
			c0 = (NIM_CHAR)0;
			LOC3 = (NI)0;
			LOC3 = waitfor_558407_170061329(socket0, (&waited0), timeout0, ((NI) 1), ((NimStringDesc*) &TMP5536));
			...
			LA4: ;
			{
				...
				LOC20 = (NI)0;
				LOC20 = waitfor_558407_170061329(socket0, (&waited0), timeout0, ((NI) 1), ((NimStringDesc*) &TMP5536));
...
TMP1340[3].len = 3; TMP1340[3].kind = 2; TMP1340[3].sons = &TMP5510[0];
