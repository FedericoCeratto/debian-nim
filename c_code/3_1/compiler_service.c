...
appendString(LOC1, ((NimStringDesc*) &TMP5531));
	send_559602_170061329((*HEX3Aenvp_562424_3526807654).stdoutsocket562408, LOC1, 2);
}
	...
	LA2: ;
	{
		...
		writelnhook_187117_155036129.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				...
				action0();
				gerrorcounter_187081_155036129 = ((NI) 0);
				send_559602_170061329((*HEX3Aenv_562426_3526807654).stdoutsocket562408, ((NimStringDesc*) &TMP5531), 2);
