...
STRING_LITERAL(TMP5209, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP5210, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP5211, "", 0);
STRING_LITERAL(TMP5212, "dot", 3);
...
N_NIMCALL(void, adddependencyaux_559028)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	addf_177635(&gdotgraph_559023, ((NimStringDesc*) &TMP5209), LOC1, 2);
}
...
N_NIMCALL(void, generatedot_559009)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP5211));
	LOC1[0] = rope_176322(LOC3);
	LOC1[1] = gdotgraph_559023;
	LOC4 = 0;
	LOC4 = HEX25_177236(((NimStringDesc*) &TMP5210), LOC1, 2);
	LOC5 = 0;
	LOC5 = noschangeFileExt(project, ((NimStringDesc*) &TMP5212));
...
TMP1146[0].kind = 1;
TMP1146[0].offset = offsetof(Tgen559016, module);
TMP1146[0].typ = (&NTI225807);
TMP1146[0].name = "module";
NTI559016.node = &TMP1146[0];
NTI559018.size = sizeof(Tgen559016*);
NTI559018.kind = 22;
NTI559018.base = (&NTI559016);
NTI559018.marker = TMP5208;
}
