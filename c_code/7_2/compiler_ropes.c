...
typedef N_CLOSURE_PTR(void, TMP4771) (Ropeserror173010 err0, NimStringDesc* msg0, NIM_BOOL usewarning0);
			...
			if (!(i0 < length0)) goto LA2;
			{
				...
				case 48 ... 57:
				{
					...
					num0 = j0;
					{
						...
						errorhandler_173024_2381377266.ClEnv? errorhandler_173024_2381377266.ClPrc(((Ropeserror173010) 1), LOC20, NIM_FALSE, errorhandler_173024_2381377266.ClEnv):((TMP3934)(errorhandler_173024_2381377266.ClPrc))(((Ropeserror173010) 1), LOC20, NIM_FALSE);
					}
					goto LA16;
					LA18: ;
					{
				...
				case 123:
				{
					...
					LA27: ;
					{
						...
						errorhandler_173024_2381377266.ClEnv? errorhandler_173024_2381377266.ClPrc(((Ropeserror173010) 1), LOC30, NIM_FALSE, errorhandler_173024_2381377266.ClEnv):((TMP3935)(errorhandler_173024_2381377266.ClPrc))(((Ropeserror173010) 1), LOC30, NIM_FALSE);
					}
					LA25: ;
					{
						NimStringDesc* LOC35;
						...
						errorhandler_173024_2381377266.ClEnv? errorhandler_173024_2381377266.ClPrc(((Ropeserror173010) 1), LOC35, NIM_FALSE, errorhandler_173024_2381377266.ClEnv):((TMP3936)(errorhandler_173024_2381377266.ClPrc))(((Ropeserror173010) 1), LOC35, NIM_FALSE);
					}
					goto LA31;
					LA33: ;
					{
				...
				default:
				{
					...
					errorhandler_173024_2381377266.ClEnv? errorhandler_173024_2381377266.ClPrc(((Ropeserror173010) 1), LOC40, NIM_FALSE, errorhandler_173024_2381377266.ClEnv):((TMP3937)(errorhandler_173024_2381377266.ClPrc))(((Ropeserror173010) 1), LOC40, NIM_FALSE);
				}
				break;
				}
			}
...
N_NIMCALL(void, writerope_173836_2381377266)(Ropeobj173006* head0, NimStringDesc* filename0, NIM_BOOL usewarning0) {
	...
	LA4: ;
	{
		errorhandler_173024_2381377266.ClEnv? errorhandler_173024_2381377266.ClPrc(((Ropeserror173010) 0), filename0, usewarning0, errorhandler_173024_2381377266.ClEnv):((TMP4771)(errorhandler_173024_2381377266.ClPrc))(((Ropeserror173010) 0), filename0, usewarning0);
	}
	LA1: ;
}
