...
N_NIMCALL(void, initoptparser_207030)(NimStringDesc* cmdline, optparser207011* Result) {
	...
	LA3: ;
	{
		unsureAsgnRef((void**) (&(*Result).Cmd), copyString(((NimStringDesc*) &TMP1561)));
		{
			NI i_207046;
			NI HEX3Atmp_207049;
			NI res_207052;
			i_207046 = 0;
			HEX3Atmp_207049 = 0;
			HEX3Atmp_207049 = paramcount_123839();
			res_207052 = 1;
			{
				while (1) {
					NimStringDesc* LOC9;
					...
					LOC9 = 0;
					LOC10 = 0;
					LOC10 = paramstr_123809(i_207046);
					LOC11 = 0;
...
appendChar(LOC9, 32);
	...
	LA1: ;
	(*Result).Kind = ((NU8) 0);
	unsureAsgnRef((void**) (&(*Result).Key), copyString(((NimStringDesc*) &TMP1565)));
	unsureAsgnRef((void**) (&(*Result).Val), copyString(((NimStringDesc*) &TMP1565)));
}
...
N_NIMCALL(void, handleshortoption_207309)(optparser207011* p) {
	...
	}
	{
		...
		i = parseword_207204((*p).Cmd, i, (&(*p).Val), TMP1566);
	}
	LA5: ;
	{
...
N_NIMCALL(void, nponext)(optparser207011* p) {
	...
	case 45:
	{
		i += 1;
		{
			...
			(*p).Kind = ((NU8) 2);
			i += 1;
			i = parseword_207204((*p).Cmd, i, (&(*p).Key), TMP1567);
			{
				while (1) {
			...
			}
			{
				...
				(*p).Pos = parseword_207204((*p).Cmd, i, (&(*p).Val), TMP1566);
			}
			goto LA15;
			LA17: ;
			{
	...
	{
		(*p).Kind = ((NU8) 1);
		(*p).Pos = parseword_207204((*p).Cmd, i, (&(*p).Key), TMP1566);
	}
	break;
	}
	BeforeRet: ;
...
static TNimNode* TMP1557[6];
static TNimNode* TMP1558[4];
NI TMP1560;
static char* NIM_CONST TMP1559[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongOption", 
"cmdShortOption"};
...
NTI207009.base = 0;
NTI207009.flags = 3;
for (TMP1560 = 0; TMP1560 < 4; TMP1560++) {
TMP706[TMP1560+5].kind = 1;
TMP706[TMP1560+5].offset = TMP1560;
TMP706[TMP1560+5].name = TMP1559[TMP1560];
TMP1558[TMP1560] = &TMP706[TMP1560+5];
}
TMP706[9].len = 4; TMP706[9].kind = 2; TMP706[9].sons = &TMP1558[0];
...
TMP706[11].name = "val";
TMP706[0].len = 6; TMP706[0].kind = 2; TMP706[0].sons = &TMP1557[0];
