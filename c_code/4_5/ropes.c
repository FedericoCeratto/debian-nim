	...
	num = 0;
	{
		while (1) {
			...
			if (!(i <= (NI32)(length - 1))) goto LA2;
			{
				...
				case 36:
				{
					app_177060(&result, ((NimStringDesc*) &TMP3355));
					i += 1;
				}
				break;
				case 35:
				...
				case 48 ... 57:
				{
					...
					num = j;
					{
						...
						LOC22 = 0;
						LOC22 = nimIntToStr(j);
						errorhandler_177143.ClEnv? errorhandler_177143.ClPrc(((NU8) 1), LOC22, NIM_FALSE, errorhandler_177143.ClEnv):((TMP3356)(errorhandler_177143.ClPrc))(((NU8) 1), LOC22, NIM_FALSE);
					}
					goto LA18;
					LA20: ;
					{
				...
				default:
				{
					...
					errorhandler_177143.ClEnv? errorhandler_177143.ClPrc(((NU8) 1), LOC27, NIM_FALSE, errorhandler_177143.ClEnv):((TMP3357)(errorhandler_177143.ClPrc))(((NU8) 1), LOC27, NIM_FALSE);
				}
				break;
				}
			}
...
N_NIMCALL(void, writerope_178423)(trope177009* head, NimStringDesc* filename, NIM_BOOL usewarning) {
	...
	LA4: ;
	{
		errorhandler_177143.ClEnv? errorhandler_177143.ClPrc(((NU8) 0), filename, usewarning, errorhandler_177143.ClEnv):((TMP4192)(errorhandler_177143.ClPrc))(((NU8) 0), filename, usewarning);
	}
	LA1: ;
}
