...
N_NIMCALL(Socketimpl514407*, newsocket_514708)(NI fd, NIM_BOOL isbuff);
...
N_NIMCALL(void, acceptaddr_515812)(Socketimpl514407* server, Socketimpl514407** client, NimStringDesc** address, NU8 flags);
...
N_NIMCALL(void, TMP4997)(void* p, NI op);
...
STRING_LITERAL(TMP4993, "No valid socket error code available", 36);
STRING_LITERAL(TMP4994, "Could not send all data.", 24);
STRING_LITERAL(TMP4996, "", 0);
STRING_LITERAL(TMP4998, "Call to \'", 9);
STRING_LITERAL(TMP4999, "\' timed out.", 12);
STRING_LITERAL(TMP5001, "readLine", 8);
STRING_LITERAL(TMP5002, "\015\012", 2);
...
extern NI osinvalidsocket_509651;
...
N_NIMCALL(void, bindaddr_515619)(Socketimpl514407* socket, NU16 port, NimStringDesc* address) {
	{
		...
		LOC5 = 0;
		LOC5 = toint_509829(((NU8) 2));
		name.sin_family = ((NI16) (LOC5));
		name.sin_port = htons_511017(((NI16) (port)));
		name.sin_addr.s_addr = htonl_511007(((NI32) 0));
		{
			int LOC8;
			NI32 LOC11;
			LOC8 = 0;
			LOC8 = bindaddr_510207((*socket).fd, ((SOCKADDR*) ((&name))), ((unsigned int) (((NI)sizeof(SOCKADDR_IN)))));
	...
	LA3: ;
	{
		...
		ailist = getaddrinfo_510408(address, port, ((NU8) 2), ((NU8) 1), ((NU8) 6));
		{
			...
			NI32 LOC18;
			LOC15 = 0;
			LOC15 = bindaddr_510207((*socket).fd, (*ailist).aiaddr, ((unsigned int) ((*ailist).aiaddrlen)));
			if (!(LOC15 < ((NI32) 0))) goto LA16;
			dealloc_510608(ailist);
			LOC18 = 0;
...
N_NIMCALL(void, listen_515609)(Socketimpl514407* socket, int backlog) {
	{
		...
		NI32 LOC6;
		LOC3 = 0;
		LOC3 = listen_510220((*socket).fd, backlog);
...
N_NIMCALL(NI32, getsocketerror_515001)(Socketimpl514407* socket) {
	...
	LA3: ;
	{
		...
		e_515008 = 0;
		e_515008 = (Oserror3433*) newObj((&NTI114433), sizeof(Oserror3433));
		(*e_515008).Sup.Sup.Sup.m_type = (&NTI3433);
		LOC9 = 0;
		LOC9 = (*e_515008).Sup.Sup.message; (*e_515008).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4993));
...
{	sent = send_518715(socket, ((void*) (data->data)), (data ? data->Sup.len : 0));
	...
	LA3: ;
	{
		...
		e_519018 = 0;
		e_519018 = (Oserror3433*) newObj((&NTI114433), sizeof(Oserror3433));
		(*e_519018).Sup.Sup.Sup.m_type = (&NTI3433);
		LOC14 = 0;
		LOC14 = (*e_519018).Sup.Sup.message; (*e_519018).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4994));
...
N_NIMCALL(void, acceptaddr_515812)(Socketimpl514407* server, Socketimpl514407** client, NimStringDesc** address, NU8 flags) {
	...
	sock = Dl_106037((*server).fd, ((SOCKADDR*) ((&sockaddress))), (&addrlen));
	{
		...
		err = oslasterror_114454();
		{
			...
			if (!LOC7) goto LA8;
			acceptaddr_515812(server, client, address, flags);
		}
		LA8: ;
...
N_NIMCALL(void, accept_516401)(Socketimpl514407* server, Socketimpl514407** client, NU8 flags) {
	...
	addrdummy = copyString(((NimStringDesc*) &TMP4996));
	acceptaddr_515812(server, client, (&addrdummy), flags);
}
N_NIMCALL(void, TMP4997)(void* p, NI op) {
...
{	result = 0;
	...
	LOC6[0] = (*readfd).fd;
	fds->data[0] = LOC6[0];
	result = select_512896((&fds), timeout);
	}BeforeRet: ;
	return result;
}
...
appendString(LOC22, ((NimStringDesc*) &TMP4999));
		...
		selret = select_517207(socket, (NI)(timeout - ((NI) (((NF)((*waited)) * (NF)(1.0000000000000000e+003))))));
		{
			NI32 LOC27;
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_517818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5001));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_517818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5001));
...
appendString((*line), ((NimStringDesc*) &TMP5002));
				}
				LA38: ;
				goto BeforeRet;
			}
...
N_NIMCALL(void, close_516417)(Socketimpl514407* socket) {
	TSafePoint TMP5003;
	pushSafePoint(&TMP5003);
	TMP5003.status = setjmp(TMP5003.context);
	if (TMP5003.status == 0) {
		popSafePoint();
	}
	else {
	...
	if (TMP5003.status != 0) reraiseException();
}
...
TMP4982[0] = &TMP1074[1];
TMP1074[1].kind = 1;
TMP1074[1].offset = offsetof(Socketimpl514407, fd);
TMP1074[1].typ = (&NTI108);
TMP1074[1].name = "fd";
TMP4982[1] = &TMP1074[2];
TMP1074[2].kind = 3;
TMP1074[2].offset = offsetof(Socketimpl514407, isbuffered);
TMP1074[2].typ = (&NTI138);
TMP1074[2].name = "isBuffered";
TMP1074[2].sons = &NimDT_514407_isbuffered[0];
TMP1074[2].len = 2;
TMP4983[0] = &TMP1074[4];
...
NTI514420.flags = 3;
TMP1074[4].kind = 1;
TMP1074[4].offset = offsetof(Socketimpl514407, isbufferedU.S1.buffer);
TMP1074[4].typ = (&NTI514420);
TMP1074[4].name = "buffer";
TMP4983[1] = &TMP1074[5];
TMP1074[5].kind = 1;
TMP1074[5].offset = offsetof(Socketimpl514407, isbufferedU.S1.currpos);
TMP1074[5].typ = (&NTI108);
TMP1074[5].name = "currPos";
TMP4983[2] = &TMP1074[6];
TMP1074[6].kind = 1;
TMP1074[6].offset = offsetof(Socketimpl514407, isbufferedU.S1.buflen);
TMP1074[6].typ = (&NTI108);
TMP1074[6].name = "bufLen";
TMP1074[3].len = 3; TMP1074[3].kind = 2; TMP1074[3].sons = &TMP4983[0];
NimDT_514407_isbuffered[1] = &TMP1074[3];
TMP1074[7].len = 0; TMP1074[7].kind = 2;
NimDT_514407_isbuffered[0] = &TMP1074[7];
TMP4982[2] = &TMP1074[8];
TMP1074[8].kind = 1;
TMP1074[8].offset = offsetof(Socketimpl514407, lasterror);
TMP1074[8].typ = (&NTI114);
TMP1074[8].name = "lastError";
TMP1074[0].len = 3; TMP1074[0].kind = 2; TMP1074[0].sons = &TMP4982[0];
NTI514407.node = &TMP1074[0];
NTI514409.size = sizeof(Socketimpl514407*);
NTI514409.kind = 22;
NTI514409.base = (&NTI514407);
NTI514409.flags = 2;
NTI514409.marker = TMP4984;
NTI514415.size = sizeof(Timeouterror514415);
NTI514415.kind = 17;
NTI514415.base = (&NTI3427);
TMP1074[9].len = 0; TMP1074[9].kind = 2;
NTI514415.node = &TMP1074[9];
NTI518014.size = sizeof(Timeouterror514415*);
NTI518014.kind = 22;
NTI518014.base = (&NTI514415);
NTI518014.marker = TMP4997;
}
