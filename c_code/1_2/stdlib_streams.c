...
N_NIMCALL(Filestreamobj155477*, newfilestream_155531_1780494535)(FILE* f0);
...
N_NIMCALL(NI, fsreaddata_155513_1780494535)(Streamobj154418* s0, void* buffer0, NI buflen0);
N_NIMCALL(NI, readbuffer_15754_1689653243)(FILE* f0, void* buffer0, NI len0);
N_NIMCALL(NI, fspeekdata_155519_1780494535)(Streamobj154418* s0, void* buffer0, NI buflen0);
static N_INLINE(void, pushSafePoint)(TSafePoint* s0);
static N_INLINE(void, popSafePoint)(void);
N_NIMCALL(void, reraiseException)(void);
N_NIMCALL(void, fswritedata_155526_1780494535)(Streamobj154418* s0, void* buffer0, NI buflen0);
...
N_NIMCALL(Filestreamobj155477*, newfilestream_155531_1780494535)(FILE* f0) {
	...
	(*result0).Sup.readdataimpl = fsreaddata_155513_1780494535;
	(*result0).Sup.peekdataimpl = fspeekdata_155519_1780494535;
	(*result0).Sup.writedataimpl = fswritedata_155526_1780494535;
...
N_NIMCALL(Filestreamobj155477*, newfilestream_155543_1780494535)(NimStringDesc* filename0, Filemode12409 mode0) {
	...
	f0 = (FILE*)0;
	{
		...
		if (!LOC3) goto LA4;
		result0 = newfilestream_155531_1780494535(f0);
	}
	LA4: ;
	return result0;
}
