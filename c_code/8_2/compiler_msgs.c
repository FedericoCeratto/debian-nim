...
typedef struct Erecoverableerror188358 Erecoverableerror188358;
...
typedef struct Esuggestdone188360 Esuggestdone188360;
...
typedef NimStringDesc* TY188303[291];
...
struct  Erecoverableerror188358  {
  Valueerror4049 Sup;
};
...
typedef N_CLOSURE_PTR(void, TMP2063) (NimStringDesc* output);
struct  Esuggestdone188360  {
  Exception Sup;
};
...
N_NIMCALL(void, newfileinfo_188694)(NimStringDesc* fullpath, NimStringDesc* projpath, Tfileinfo188350* Result);
...
N_NIMCALL(void, HEX3Aanonymous_194653)(NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
N_NIMCALL(void, internalerror_194191)(NimStringDesc* errmsg);
N_NIMCALL(void, writecontext_191266)(Tlineinfo188352 lastinfo);
...
N_NIMCALL(NimStringDesc*, tomsgfilename_189829)(Tlineinfo188352 info);
N_NIMCALL(NimStringDesc*, coordtostr_190396)(NI coord);
N_NIMCALL(NimStringDesc*, nimIntToStr)(NI x);
N_NIMCALL(NimStringDesc*, getmessagestr_190416)(NU16 msg, NimStringDesc* arg);
...
N_NIMCALL(void, setstyle_185604)(FILE* f, NU8 style);
N_NIMCALL(void, resetattributes_185209)(FILE* f);
...
N_NIMCALL(NIM_BOOL, ignoremsgbecauseofidetools_191637)(NU16 msg);
N_NIMCALL(NimStringDesc*, nsuFormatSingleElem)(NimStringDesc* formatstr, NimStringDesc* a);
N_NIMCALL(void, setforegroundcolor_186057)(FILE* f, NU8 fg, NIM_BOOL bright);
N_NIMCALL(void, handleerror_190437)(NU16 msg, NU8 eh, NimStringDesc* s_190441);
N_NIMCALL(NIM_BOOL, stacktraceavailable_21730)(void);
N_NIMCALL(void, writestacktrace_20207)(void);
N_NOINLINE(void, raiserecoverableerror_189366)(NimStringDesc* msg) __attribute__((noreturn));
...
N_NIMCALL(NIM_BOOL, isatty_186426)(FILE* f);
N_NIMCALL(void, limessage_192706)(Tlineinfo188352 info, NU16 msg, NimStringDesc* arg, NU8 eh);
static N_INLINE(NIM_BOOL, contains_194021)(Slice194011 s, NU16 value);
static N_INLINE(Slice194011, HEX2EHEX2E_194002)(NU16 a, NU16 b);
N_NIMCALL(void, writesurroundingsrc_192681)(Tlineinfo188352 info);
...
N_NIMCALL(NI32, fileinfoidx_188732)(NimStringDesc* filename, NIM_BOOL* isknownfile);
...
N_NIMCALL(NimStringDesc*, shortendir_165607)(NimStringDesc* dir);
N_NIMCALL(void, HEX5BHEX5DHEX3D_189038)(Table188452* t, NimStringDesc* key, NI32 val);
N_NIMCALL(TGenericSeq*, setLengthSeq)(TGenericSeq* seq, NI elemsize, NI newlen);
N_NIMCALL(void, TMP2773)(void* p, NI op);
...
NIM_CONST TY188303 Msgkindtostr_188300 = {((NimStringDesc*) &TMP156),
...
NIM_CONST TY188311 Warningstostr_188309 = {((NimStringDesc*) &TMP437),
...
NIM_CONST TY188317 Hintstostr_188314 = {((NimStringDesc*) &TMP469),
...
((NI) 1008)}
;
STRING_LITERAL(TMP1899, "Warnings:", 9);
STRING_LITERAL(TMP1900, "  [$1] $2", 9);
STRING_LITERAL(TMP1901, "x", 1);
STRING_LITERAL(TMP1902, " ", 1);
STRING_LITERAL(TMP1961, "Hints:", 6);
NIM_CONST TY188379 Notesverbosity_188377 = {IL64(9130889969139711),
IL64(9412918996631551),
IL64(15762598695796735),
IL64(18014398509481983)}
;
STRING_LITERAL(TMP2774, "suggest done", 12);
STRING_LITERAL(TMP3236, "(", 1);
STRING_LITERAL(TMP3237, ",", 1);
STRING_LITERAL(TMP3238, ")", 1);
NIM_CONST TY90959 TMP4002 = {((NimStringDesc*) &TMP1066),
((NI) 1015)}
;
Table188452 filenametoindextbl_188614;
extern TNimType NTI188452; /* Table */
TY188615* fileinfos_188632;
TNimType NTI188350; /* TFileInfo */
extern TNimType NTI149; /* string */
extern TNimType NTI174007; /* Rope */
TNimType NTI188365; /* seq[Rope] */
TNimType NTI188615; /* seq[TFileInfo] */
extern Gcheap51018 gch_51059;
NI32 systemfileidx_188633;
extern NimStringDesc* tnl_172654;
extern NU32 gglobaloptions_165132;
Tlineinfo188352 gcmdlineinfo_189321;
Tlineinfo188352 gcodegenlineinfo_189359;
NU64 gnotes_189395;
NI gerrorcounter_189396;
NI ghintcounter_189397;
NI gwarncounter_189398;
NI gerrormax_189399;
TY189417* msgcontext_189434;
TNimType NTI188352; /* TLineInfo */
extern TNimType NTI112; /* int16 */
extern TNimType NTI114; /* int32 */
TNimType NTI189417; /* seq[TLineInfo] */
Tlineinfo188352 lasterror_189435;
NU8 erroroutputs_189437;
TY189438 writelnhook_189441;
Tlineinfo188352 gtrackpos_189901;
extern TY174023 errorhandler_174028;
...
extern NI8 gexitcode_165133;
extern TNimType NTI4049; /* ValueError */
TNimType NTI188358; /* ERecoverableError */
TNimType NTI189373; /* ref ERecoverableError */
extern TSafePoint* exchandler_20843;
extern TNimType NTI4031; /* IOError */
extern Exception* currexception_20845;
TNimType NTI188005; /* TMsgKind */
TNimType NTI188346; /* TNoteKind */
TNimType NTI188348; /* TNoteKinds */
extern TNimType NTI4027; /* Exception */
TNimType NTI188360; /* ESuggestDone */
TNimType NTI189512; /* ref ESuggestDone */
N_NIMCALL(void, TMP144)(void* p, NI op) {
	TY188365* a;
	NI LOC1;
	a = (TY188365*)p;
...
appendString(res, ((NimStringDesc*) &TMP148));
	{
		...
		i_188667 = 0;
		HEX3Atmp_188672 = 0;
		HEX3Atmp_188672 = (NI)((s ? s->Sup.len : 0) - ((NI) 1));
		res_188675 = ((NI) 0);
		{
			while (1) {
				NimStringDesc* LOC8;
				if (!(res_188675 <= HEX3Atmp_188672)) goto LA3;
				i_188667 = res_188675;
				{
					if (!(((NI) ((NI)((NI)(i_188667 + ((NI) 1)) % ((NI) 64)))) == ((NI) 0))) goto LA6;
					res = addChar(res, 34);
...
appendString(res, tnl_172654);
				...
				LA6: ;
				LOC8 = 0;
				LOC8 = tocchar_188639(s->data[i_188667]);
...
N_NIMCALL(void, newfileinfo_188694)(NimStringDesc* fullpath, NimStringDesc* projpath, Tfileinfo188350* Result) {
	...
	unsureAsgnRef((void**) (&(*Result).quotedname), makecstring_188649(filename));
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = ((gglobaloptions_165132 &(1<<((((NU8) 28))&31)))!=0);
		if (LOC3) goto LA4;
		LOC3 = NIM_TRUE;
		LA4: ;
		if (!LOC3) goto LA5;
		unsureAsgnRef((void**) (&(*Result).lines), (TY188365*) newSeq((&NTI188365), 0));
	}
	LA5: ;
}
...
N_NIMCALL(NimStringDesc*, tomsgfilename_189829)(Tlineinfo188352 info) {
	...
	LA3: ;
	{
		if (!glistfullpaths_165146) goto LA6;
		result = copyString(fileinfos_188632->data[info.fileindex].fullpath);
	}
	goto LA1;
	LA6: ;
	{
		result = copyString(fileinfos_188632->data[info.fileindex].projpath);
	}
	LA1: ;
	return result;
}
...
N_NIMCALL(NimStringDesc*, msgkindtostring_190406)(NU16 kind) {
	NimStringDesc* result;
	result = 0;
	result = copyString(Msgkindtostr_188300[(kind)- 0]);
	return result;
}
...
N_NIMCALL(NimStringDesc*, getmessagestr_190416)(NU16 msg, NimStringDesc* arg) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = msgkindtostring_190406(msg);
...
N_NIMCALL(void, writecontext_191266)(Tlineinfo188352 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_191290 = 0;
		HEX3Atmp_191606 = 0;
		HEX3Atmp_191606 = (NI)((msgcontext_189434 ? msgcontext_189434->Sup.len : 0) - ((NI) 1));
		res_191609 = ((NI) 0);
		{
			while (1) {
				if (!(res_191609 <= HEX3Atmp_191606)) goto LA3;
				i_191290 = res_191609;
				{
					NIM_BOOL LOC6;
					NIM_BOOL LOC7;
					...
					LOC6 = 0;
					LOC7 = 0;
					LOC7 = HEX3DHEX3D_191255(msgcontext_189434->data[i_191290], lastinfo);
					LOC6 = !(LOC7);
					if (!(LOC6)) goto LA8;
					LOC9 = 0;
					LOC9 = HEX3DHEX3D_191255(msgcontext_189434->data[i_191290], info);
					LOC6 = !(LOC9);
					LA8: ;
					if (!LOC6) goto LA10;
					{
						NimStringDesc* s_191309;
						if (!!(writelnhook_189441.ClPrc == 0)) goto LA14;
						s_191309 = copyString(((NimStringDesc*) &TMP147));
						{
							NimStringDesc* arg_191311;
							NI i_191605;
							arg_191311 = 0;
							i_191605 = ((NI) 0);
							{
								while (1) {
									TY191306 LOC19;
									TY191293 LOC20;
									if (!(i_191605 < ((NI) 2))) goto LA18;
									memset((void*)LOC19, 0, sizeof(LOC19));
									memset((void*)LOC20, 0, sizeof(LOC20));
									LOC20[0] = tomsgfilename_189829(msgcontext_189434->data[i_191290]);
									LOC20[1] = coordtostr_190396(((NI) (msgcontext_189434->data[i_191290].line)));
									LOC20[2] = coordtostr_190396(((NI) ((NI16)(msgcontext_189434->data[i_191290].col + ((NI16) 1)))));
									LOC19[0] = nsuFormatOpenArray(((NimStringDesc*) &TMP154), LOC20, 3);
									LOC19[1] = getmessagestr_190416(((NU16) 189), ((NimStringDesc*) &TMP147));
									arg_191311 = LOC19[(i_191605)- 0];
									s_191309 = resizeString(s_191309, arg_191311->Sup.len + 0);
appendString(s_191309, arg_191311);
									i_191605 += ((NI) 1);
								} LA18: ;
							}
						}
						writelnhook_189441.ClEnv? writelnhook_189441.ClPrc(s_191309, writelnhook_189441.ClEnv):((TMP429)(writelnhook_189441.ClPrc))(s_191309);
					}
					goto LA12;
					LA14: ;
					{
						if (!((gglobaloptions_165132 &(1<<((((NU8) 23))&31)))!=0)) goto LA22;
						{
							TY191306 LOC28;
							TY191293 LOC29;
							if (!((erroroutputs_189437 &(1<<((((NU8) 0))&7)))!=0)) goto LA26;
							memset((void*)LOC28, 0, sizeof(LOC28));
							memset((void*)LOC29, 0, sizeof(LOC29));
							LOC29[0] = tomsgfilename_189829(msgcontext_189434->data[i_191290]);
							LOC29[1] = coordtostr_190396(((NI) (msgcontext_189434->data[i_191290].line)));
							LOC29[2] = coordtostr_190396(((NI) ((NI16)(msgcontext_189434->data[i_191290].col + ((NI16) 1)))));
							LOC28[0] = nsuFormatOpenArray(((NimStringDesc*) &TMP154), LOC29, 3);
							LOC28[1] = getmessagestr_190416(((NU16) 189), ((NimStringDesc*) &TMP147));
							writeline_166405(stdout, LOC28, 2);
							fflush(stdout);
						}
						LA26: ;
					}
					...
					{
						{
							if (!((erroroutputs_189437 &(1<<((((NU8) 1))&7)))!=0)) goto LA33;
							{
								TY191293 LOC39;
								NimStringDesc* LOC40;
								NimStringDesc* LOC41;
								if (!((gglobaloptions_165132 &(1<<((((NU8) 21))&31)))!=0)) goto LA37;
								setstyle_185604(stderr, 1);
								memset((void*)LOC39, 0, sizeof(LOC39));
								LOC39[0] = tomsgfilename_189829(msgcontext_189434->data[i_191290]);
								LOC39[1] = coordtostr_190396(((NI) (msgcontext_189434->data[i_191290].line)));
								LOC39[2] = coordtostr_190396(((NI) ((NI16)(msgcontext_189434->data[i_191290].col + ((NI16) 1)))));
								LOC40 = 0;
								LOC40 = nsuFormatOpenArray(((NimStringDesc*) &TMP154), LOC39, 3);
								write_16895(stderr, LOC40);
								resetattributes_185209(stderr);
								LOC41 = 0;
								LOC41 = getmessagestr_190416(((NU16) 189), ((NimStringDesc*) &TMP147));
							...
							LA37: ;
							{
								...
								LOC44[0] = tomsgfilename_189829(msgcontext_189434->data[i_191290]);
								LOC44[1] = coordtostr_190396(((NI) (msgcontext_189434->data[i_191290].line)));
								LOC44[2] = coordtostr_190396(((NI) ((NI16)(msgcontext_189434->data[i_191290].col + ((NI16) 1)))));
								LOC43[0] = nsuFormatOpenArray(((NimStringDesc*) &TMP154), LOC44, 3);
								LOC43[1] = getmessagestr_190416(((NU16) 189), ((NimStringDesc*) &TMP147));
								writeline_166405(stderr, LOC43, 2);
							}
							LA35: ;
						}
						LA33: ;
				...
				LA10: ;
				info = msgcontext_189434->data[i_191290];
				res_191609 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NIMCALL(NIM_BOOL, ignoremsgbecauseofidetools_191637)(NU16 msg) {
	...
	LOC2 = (((NU16) 4) <= msg);
	if (!(LOC2)) goto LA3;
	LOC2 = (gcmd_165134 == ((NU8) 14));
	LA3: ;
	LOC1 = LOC2;
	if (!(LOC1)) goto LA4;
	LOC1 = !(((gglobaloptions_165132 &(1<<((((NU8) 29))&31)))!=0));
	LA4: ;
	result = LOC1;
	return result;
}
N_NIMCALL(void, TMP499)(void* p, NI op) {
	Erecoverableerror188358* a;
	a = (Erecoverableerror188358*)p;
	nimGCvisit((void*)(*a).Sup.Sup.parent, op);
	nimGCvisit((void*)(*a).Sup.Sup.message, op);
	nimGCvisit((void*)(*a).Sup.Sup.trace, op);
}

N_NOINLINE(void, raiserecoverableerror_189366)(NimStringDesc* msg) {
	Erecoverableerror188358* e_189372;
	NimStringDesc* LOC1;
	e_189372 = 0;
	e_189372 = (Erecoverableerror188358*) newObj((&NTI189373), sizeof(Erecoverableerror188358));
	(*e_189372).Sup.Sup.Sup.m_type = (&NTI188358);
	LOC1 = 0;
	LOC1 = (*e_189372).Sup.Sup.message; (*e_189372).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_189372, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_190437)(NU16 msg, NU8 eh, NimStringDesc* s_190441) {
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			LOC9 = LOC10;
			if (LOC9) goto LA12;
			LOC9 = ((gnotes_189395 &(IL64(1)<<(((((NU16) 288)- 237))&IL64(63))))!=0);
			LA12: ;
			if (!LOC9) goto LA13;
			{
				NIM_BOOL LOC17;
				...
				if (!(LOC17)) goto LA18;
				LOC17 = writelnhook_189441.ClPrc == 0;
				LA18: ;
				if (!LOC17) goto LA19;
			...
			{
				{
					NimStringDesc* s_190512;
					if (!!(writelnhook_189441.ClPrc == 0)) goto LA24;
					s_190512 = copyString(((NimStringDesc*) &TMP147));
					{
						NimStringDesc* arg_190514;
						NI i_191213;
						arg_190514 = 0;
						i_191213 = ((NI) 0);
						{
							while (1) {
								TY190421 LOC29;
								NimStringDesc* LOC30;
								if (!(i_191213 < ((NI) 1))) goto LA28;
								memset((void*)LOC29, 0, sizeof(LOC29));
								LOC30 = 0;
								LOC30 = rawNewString(command_165240->Sup.len + 95);
appendString(LOC30, ((NimStringDesc*) &TMP494));
appendString(LOC30, command_165240);
appendString(LOC30, ((NimStringDesc*) &TMP495));
								LOC29[0] = LOC30;
								arg_190514 = LOC29[(i_191213)- 0];
								s_190512 = resizeString(s_190512, arg_190514->Sup.len + 0);
appendString(s_190512, arg_190514);
								i_191213 += ((NI) 1);
							} LA28: ;
						}
					}
					writelnhook_189441.ClEnv? writelnhook_189441.ClPrc(s_190512, writelnhook_189441.ClEnv):((TMP496)(writelnhook_189441.ClPrc))(s_190512);
				}
				goto LA22;
				LA24: ;
				{
					if (!((gglobaloptions_165132 &(1<<((((NU8) 23))&31)))!=0)) goto LA32;
					{
						TY190421 LOC38;
						NimStringDesc* LOC39;
						if (!((erroroutputs_189437 &(1<<((((NU8) 0))&7)))!=0)) goto LA36;
						memset((void*)LOC38, 0, sizeof(LOC38));
						LOC39 = 0;
						LOC39 = rawNewString(command_165240->Sup.len + 95);
appendString(LOC39, ((NimStringDesc*) &TMP494));
appendString(LOC39, command_165240);
appendString(LOC39, ((NimStringDesc*) &TMP495));
						LOC38[0] = LOC39;
						writeline_166405(stdout, LOC38, 1);
						fflush(stdout);
					}
					LA36: ;
				}
				...
				{
					{
						if (!((erroroutputs_189437 &(1<<((((NU8) 1))&7)))!=0)) goto LA43;
						{
							NimStringDesc* LOC49;
							if (!((gglobaloptions_165132 &(1<<((((NU8) 21))&31)))!=0)) goto LA47;
							setforegroundcolor_186057(stderr, ((NU8) 31), NIM_FALSE);
							LOC49 = 0;
							LOC49 = rawNewString(command_165240->Sup.len + 95);
appendString(LOC49, ((NimStringDesc*) &TMP494));
appendString(LOC49, command_165240);
appendString(LOC49, ((NimStringDesc*) &TMP495));
						...
						LA47: ;
						{
							...
							LOC52 = 0;
							LOC52 = rawNewString(command_165240->Sup.len + 95);
appendString(LOC52, ((NimStringDesc*) &TMP494));
appendString(LOC52, command_165240);
appendString(LOC52, ((NimStringDesc*) &TMP495));
							LOC51[0] = LOC52;
							writeline_166405(stderr, LOC51, 1);
						}
						LA45: ;
					}
					LA43: ;
	...
	LA5: ;
	{
		...
		LA56: ;
		if (!LOC55) goto LA57;
		gerrorcounter_189396 += ((NI) 1);
		gexitcode_165133 = ((NI8) 1);
		{
			if (!(gerrormax_189399 <= gerrorcounter_189396)) goto LA61;
			{
				NIM_BOOL LOC65;
				NIM_BOOL LOC66;
				LOC65 = 0;
				...
				LOC65 = LOC66;
				if (LOC65) goto LA68;
				LOC65 = ((gnotes_189395 &(IL64(1)<<(((((NU16) 288)- 237))&IL64(63))))!=0);
				LA68: ;
				if (!LOC65) goto LA69;
				{
					NIM_BOOL LOC73;
					...
					if (!(LOC73)) goto LA74;
					LOC73 = writelnhook_189441.ClPrc == 0;
					LA74: ;
					if (!LOC73) goto LA75;
					writestacktrace_20207();
				}
				...
				{
					{
						NimStringDesc* s_190869;
						if (!!(writelnhook_189441.ClPrc == 0)) goto LA80;
						s_190869 = copyString(((NimStringDesc*) &TMP147));
						{
							NimStringDesc* arg_190871;
							NI i_191217;
							arg_190871 = 0;
							i_191217 = ((NI) 0);
							{
								while (1) {
									TY190421 LOC85;
									NimStringDesc* LOC86;
									if (!(i_191217 < ((NI) 1))) goto LA84;
									memset((void*)LOC85, 0, sizeof(LOC85));
									LOC86 = 0;
									LOC86 = rawNewString(command_165240->Sup.len + 95);
appendString(LOC86, ((NimStringDesc*) &TMP494));
appendString(LOC86, command_165240);
appendString(LOC86, ((NimStringDesc*) &TMP495));
									LOC85[0] = LOC86;
									arg_190871 = LOC85[(i_191217)- 0];
									s_190869 = resizeString(s_190869, arg_190871->Sup.len + 0);
appendString(s_190869, arg_190871);
									i_191217 += ((NI) 1);
								} LA84: ;
							}
						}
						writelnhook_189441.ClEnv? writelnhook_189441.ClPrc(s_190869, writelnhook_189441.ClEnv):((TMP497)(writelnhook_189441.ClPrc))(s_190869);
					}
					goto LA78;
					LA80: ;
					{
						if (!((gglobaloptions_165132 &(1<<((((NU8) 23))&31)))!=0)) goto LA88;
						{
							TY190421 LOC94;
							NimStringDesc* LOC95;
							if (!((erroroutputs_189437 &(1<<((((NU8) 0))&7)))!=0)) goto LA92;
							memset((void*)LOC94, 0, sizeof(LOC94));
							LOC95 = 0;
							LOC95 = rawNewString(command_165240->Sup.len + 95);
appendString(LOC95, ((NimStringDesc*) &TMP494));
appendString(LOC95, command_165240);
appendString(LOC95, ((NimStringDesc*) &TMP495));
							LOC94[0] = LOC95;
							writeline_166405(stdout, LOC94, 1);
							fflush(stdout);
						}
						LA92: ;
					}
					...
					{
						{
							if (!((erroroutputs_189437 &(1<<((((NU8) 1))&7)))!=0)) goto LA99;
							{
								NimStringDesc* LOC105;
								if (!((gglobaloptions_165132 &(1<<((((NU8) 21))&31)))!=0)) goto LA103;
								setforegroundcolor_186057(stderr, ((NU8) 31), NIM_FALSE);
								LOC105 = 0;
								LOC105 = rawNewString(command_165240->Sup.len + 95);
appendString(LOC105, ((NimStringDesc*) &TMP494));
appendString(LOC105, command_165240);
appendString(LOC105, ((NimStringDesc*) &TMP495));
							...
							LA103: ;
							{
								...
								LOC108 = 0;
								LOC108 = rawNewString(command_165240->Sup.len + 95);
appendString(LOC108, ((NimStringDesc*) &TMP494));
appendString(LOC108, command_165240);
appendString(LOC108, ((NimStringDesc*) &TMP495));
								LOC107[0] = LOC108;
								writeline_166405(stderr, LOC107, 1);
							}
							LA101: ;
						}
						LA99: ;
		...
		LA61: ;
		{
			...
			if (!LOC110) goto LA112;
			{
				...
				LOC116 = ((gnotes_189395 &(IL64(1)<<(((((NU16) 288)- 237))&IL64(63))))!=0);
				LA119: ;
				if (!LOC116) goto LA120;
				{
					...
					LOC124 = writelnhook_189441.ClPrc == 0;
					LA125: ;
				...
				{
					{
						NimStringDesc* s_191060;
						if (!!(writelnhook_189441.ClPrc == 0)) goto LA131;
						s_191060 = copyString(((NimStringDesc*) &TMP147));
						{
							NimStringDesc* arg_191062;
							NI i_191221;
							arg_191062 = 0;
							i_191221 = ((NI) 0);
							{
								while (1) {
									...
									if (!(i_191221 < ((NI) 1))) goto LA135;
									memset((void*)LOC136, 0, sizeof(LOC136));
									LOC137 = 0;
									LOC137 = rawNewString(command_165240->Sup.len + 95);
appendString(LOC137, ((NimStringDesc*) &TMP494));
appendString(LOC137, command_165240);
appendString(LOC137, ((NimStringDesc*) &TMP495));
									LOC136[0] = LOC137;
									arg_191062 = LOC136[(i_191221)- 0];
									s_191060 = resizeString(s_191060, arg_191062->Sup.len + 0);
appendString(s_191060, arg_191062);
									i_191221 += ((NI) 1);
								} LA135: ;
							}
						}
						writelnhook_189441.ClEnv? writelnhook_189441.ClPrc(s_191060, writelnhook_189441.ClEnv):((TMP498)(writelnhook_189441.ClPrc))(s_191060);
					}
					goto LA129;
					LA131: ;
					{
						if (!((gglobaloptions_165132 &(1<<((((NU8) 23))&31)))!=0)) goto LA139;
						{
							TY190421 LOC145;
							NimStringDesc* LOC146;
							if (!((erroroutputs_189437 &(1<<((((NU8) 0))&7)))!=0)) goto LA143;
							memset((void*)LOC145, 0, sizeof(LOC145));
							LOC146 = 0;
							LOC146 = rawNewString(command_165240->Sup.len + 95);
appendString(LOC146, ((NimStringDesc*) &TMP494));
appendString(LOC146, command_165240);
appendString(LOC146, ((NimStringDesc*) &TMP495));
							LOC145[0] = LOC146;
							writeline_166405(stdout, LOC145, 1);
							fflush(stdout);
						}
						LA143: ;
					}
					...
					{
						{
							if (!((erroroutputs_189437 &(1<<((((NU8) 1))&7)))!=0)) goto LA150;
							{
								NimStringDesc* LOC156;
								if (!((gglobaloptions_165132 &(1<<((((NU8) 21))&31)))!=0)) goto LA154;
								setforegroundcolor_186057(stderr, ((NU8) 31), NIM_FALSE);
								LOC156 = 0;
								LOC156 = rawNewString(command_165240->Sup.len + 95);
appendString(LOC156, ((NimStringDesc*) &TMP494));
appendString(LOC156, command_165240);
appendString(LOC156, ((NimStringDesc*) &TMP495));
							...
							LA154: ;
							{
								...
								LOC159 = 0;
								LOC159 = rawNewString(command_165240->Sup.len + 95);
appendString(LOC159, ((NimStringDesc*) &TMP494));
appendString(LOC159, command_165240);
appendString(LOC159, ((NimStringDesc*) &TMP495));
								LOC158[0] = LOC159;
								writeline_166405(stderr, LOC158, 1);
							}
							LA152: ;
						}
						LA150: ;
		...
		LA112: ;
		{
			...
			raiserecoverableerror_189366(s_190441);
		}
		goto LA59;
		LA161: ;
		LA59: ;
...
{	title = 0;
	...
	case ((NU16) 237) ... ((NU16) 267):
	{
		...
		{
			if (!!(((goptions_165130 &(1<<((((NU8) 11))&31)))!=0))) goto LA6;
			goto BeforeRet;
		}
		LA6: ;
		{
			if (!!(((gnotes_189395 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
		LOC12 = unknownlineinfo_189408();
		writecontext_191266(LOC12);
		title = copyString(((NimStringDesc*) &TMP436));
		color = ((NU8) 33);
		kind = copyString(Warningstostr_188309[((NI)(((NI) (msg)) - ((NI) 237)))- 0]);
		gwarncounter_189398 += ((NI) 1);
	}
	break;
	case ((NU16) 268) ... ((NU16) 290):
	{
		{
			if (!!(((goptions_165130 &(1<<((((NU8) 12))&31)))!=0))) goto LA16;
			goto BeforeRet;
		}
		LA16: ;
		{
			if (!!(((gnotes_189395 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
		title = copyString(((NimStringDesc*) &TMP468));
		color = ((NU8) 32);
		kind = copyString(Hintstostr_188314[((NI)(((NI) (msg)) - ((NI) 268)))- 0]);
		ghintcounter_189397 += ((NI) 1);
	}
	break;
	}
	LOC22 = 0;
	LOC22 = msgkindtostring_190406(msg);
	s_191777 = nsuFormatOpenArray(LOC22, args, argsLen0);
	{
		NIM_BOOL LOC25;
		LOC25 = 0;
		LOC25 = ignoremsgbecauseofidetools_191637(msg);
		if (!!(LOC25)) goto LA26;
		{
			if (!!((kind == NIM_NIL))) goto LA30;
			{
				NimStringDesc* s_191795;
				if (!!(writelnhook_189441.ClPrc == 0)) goto LA34;
				s_191795 = copyString(((NimStringDesc*) &TMP147));
				{
					NimStringDesc* arg_191797;
					NI i_192607;
					arg_191797 = 0;
					i_192607 = ((NI) 0);
					{
						while (1) {
							TY191293 LOC39;
							if (!(i_192607 < ((NI) 3))) goto LA38;
							memset((void*)LOC39, 0, sizeof(LOC39));
							LOC39[0] = copyString(title);
							LOC39[1] = copyString(s_191777);
							LOC39[2] = nsuFormatSingleElem(((NimStringDesc*) &TMP491), kind);
							arg_191797 = LOC39[(i_192607)- 0];
							s_191795 = resizeString(s_191795, arg_191797->Sup.len + 0);
appendString(s_191795, arg_191797);
							i_192607 += ((NI) 1);
						} LA38: ;
					}
				}
				writelnhook_189441.ClEnv? writelnhook_189441.ClPrc(s_191795, writelnhook_189441.ClEnv):((TMP492)(writelnhook_189441.ClPrc))(s_191795);
			}
			goto LA32;
			LA34: ;
			{
				if (!((gglobaloptions_165132 &(1<<((((NU8) 23))&31)))!=0)) goto LA41;
				{
					TY191293 LOC47;
					if (!((erroroutputs_189437 &(1<<((((NU8) 0))&7)))!=0)) goto LA45;
					memset((void*)LOC47, 0, sizeof(LOC47));
					LOC47[0] = copyString(title);
					LOC47[1] = copyString(s_191777);
					LOC47[2] = nsuFormatSingleElem(((NimStringDesc*) &TMP491), kind);
					writeline_166405(stdout, LOC47, 3);
					fflush(stdout);
				}
				LA45: ;
			}
			...
			{
				{
					if (!((erroroutputs_189437 &(1<<((((NU8) 1))&7)))!=0)) goto LA51;
					{
						NimStringDesc* LOC57;
						if (!((gglobaloptions_165132 &(1<<((((NU8) 21))&31)))!=0)) goto LA55;
						setforegroundcolor_186057(stderr, color, NIM_FALSE);
						write_16895(stderr, title);
						resetattributes_185209(stderr);
						write_16895(stderr, s_191777);
						setforegroundcolor_186057(stderr, ((NU8) 36), NIM_FALSE);
						LOC57 = 0;
					...
					LA55: ;
					{
						...
						LOC59[1] = copyString(s_191777);
						LOC59[2] = nsuFormatSingleElem(((NimStringDesc*) &TMP491), kind);
						writeline_166405(stderr, LOC59, 3);
					}
					LA53: ;
				}
				LA51: ;
		...
		{
			{
				NimStringDesc* s_192217;
				if (!!(writelnhook_189441.ClPrc == 0)) goto LA63;
				s_192217 = copyString(((NimStringDesc*) &TMP147));
				{
					NimStringDesc* arg_192219;
					NI i_192611;
					arg_192219 = 0;
					i_192611 = ((NI) 0);
					{
						while (1) {
							TY191306 LOC68;
							if (!(i_192611 < ((NI) 2))) goto LA67;
							memset((void*)LOC68, 0, sizeof(LOC68));
							LOC68[0] = copyString(title);
							LOC68[1] = copyString(s_191777);
							arg_192219 = LOC68[(i_192611)- 0];
							s_192217 = resizeString(s_192217, arg_192219->Sup.len + 0);
appendString(s_192217, arg_192219);
							i_192611 += ((NI) 1);
						} LA67: ;
					}
				}
				writelnhook_189441.ClEnv? writelnhook_189441.ClPrc(s_192217, writelnhook_189441.ClEnv):((TMP493)(writelnhook_189441.ClPrc))(s_192217);
			}
			goto LA61;
			LA63: ;
			{
				if (!((gglobaloptions_165132 &(1<<((((NU8) 23))&31)))!=0)) goto LA70;
				{
					TY191306 LOC76;
					if (!((erroroutputs_189437 &(1<<((((NU8) 0))&7)))!=0)) goto LA74;
					memset((void*)LOC76, 0, sizeof(LOC76));
					LOC76[0] = copyString(title);
					LOC76[1] = copyString(s_191777);
					writeline_166405(stdout, LOC76, 2);
					fflush(stdout);
				}
				LA74: ;
			}
			...
			{
				{
					if (!((erroroutputs_189437 &(1<<((((NU8) 1))&7)))!=0)) goto LA80;
					{
						if (!((gglobaloptions_165132 &(1<<((((NU8) 21))&31)))!=0)) goto LA84;
						setforegroundcolor_186057(stderr, color, NIM_FALSE);
						write_16895(stderr, title);
						resetattributes_185209(stderr);
						write_16895(stderr, s_191777);
					...
					LA84: ;
					{
						...
						LOC87[1] = copyString(s_191777);
						writeline_166405(stderr, LOC87, 2);
					}
					LA82: ;
				}
				LA80: ;
	...
	LA26: ;
	handleerror_190437(msg, ((NU8) 1), s_191777);
	}BeforeRet: ;
}
...
N_NIMCALL(void, rawmessage_192636)(NU16 msg, NimStringDesc* arg) {
	...
	rawmessage_191675(msg, LOC1, 1);
}

N_NIMCALL(void, internalerror_194191)(NimStringDesc* errmsg) {
	Tlineinfo188352 LOC5;
{	{
		if (!(gcmd_165134 == ((NU8) 14))) goto LA3;
		goto BeforeRet;
	}
	LA3: ;
	LOC5 = unknownlineinfo_189408();
	writecontext_191266(LOC5);
	rawmessage_192636(((NU16) 2), errmsg);
	}BeforeRet: ;
}
...
N_NIMCALL(void, msgwriteln_189915)(NimStringDesc* s, NU8 flags) {
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = !(writelnhook_189441.ClPrc == 0);
		if (!(LOC3)) goto LA4;
		LOC3 = !(((flags &(1<<((((NU8) 1))&7)))!=0));
		LA4: ;
		if (!LOC3) goto LA5;
		writelnhook_189441.ClEnv? writelnhook_189441.ClPrc(s, writelnhook_189441.ClEnv):((TMP1047)(writelnhook_189441.ClPrc))(s);
	}
	goto LA1;
	LA5: ;
	{
		NIM_BOOL LOC8;
		LOC8 = 0;
		LOC8 = ((gglobaloptions_165132 &(1<<((((NU8) 23))&31)))!=0);
		if (LOC8) goto LA9;
		...
		{
			TY190421 LOC16;
			if (!((erroroutputs_189437 &(1<<((((NU8) 0))&7)))!=0)) goto LA14;
			memset((void*)LOC16, 0, sizeof(LOC16));
			LOC16[0] = copyString(s);
			writeline_166405(stdout, LOC16, 1);
			fflush(stdout);
		}
		LA14: ;
	}
	...
	LA10: ;
	{
		{
			TY190421 LOC22;
			if (!((erroroutputs_189437 &(1<<((((NU8) 1))&7)))!=0)) goto LA20;
			memset((void*)LOC22, 0, sizeof(LOC22));
			LOC22[0] = copyString(s);
			writeline_166405(stderr, LOC22, 1);
		}
		LA20: ;
	}
	LA1: ;
...
N_NIMCALL(NimStringDesc*, tofullpath_189662)(NI32 fileidx) {
	...
	LA3: ;
	{
		result = copyString(fileinfos_188632->data[fileidx].fullpath);
	}
	LA1: ;
	return result;
}
...
N_NIMCALL(void, addsourceline_194227)(NI32 fileidx, NimStringDesc* line) {
	Ropeobj174009* LOC1;
	LOC1 = 0;
	LOC1 = rope_174322(line);
	fileinfos_188632->data[fileidx].lines = (TY188365*) incrSeqV2(&(fileinfos_188632->data[fileidx].lines)->Sup, sizeof(Ropeobj174009*));
	asgnRefNoCycle((void**) (&fileinfos_188632->data[fileidx].lines->data[fileinfos_188632->data[fileidx].lines->Sup.len]), LOC1);
	++fileinfos_188632->data[fileidx].lines->Sup.len;
}
...
{	result = 0;
	...
	LA3: ;
	{
		...
		TSafePoint TMP1049;
		LOC7 = 0;
		LOC7 = !(((gglobaloptions_165132 &(1<<((((NU8) 28))&31)))!=0));
		if (!(LOC7)) goto LA8;
		LOC7 = ((fileinfos_188632->data[i.fileindex].lines ? fileinfos_188632->data[i.fileindex].lines->Sup.len : 0) == ((NI) 0));
		LA8: ;
		if (!LOC7) goto LA9;
		pushSafePoint(&TMP1049);
		TMP1049.status = setjmp(TMP1049.context);
		if (TMP1049.status == 0) {
			{
				NimStringDesc* line_194269;
				NimStringDesc* HEX3Atmp_194614;
				FILE* f_194617;
				NimStringDesc* res_194619;
				line_194269 = 0;
				HEX3Atmp_194614 = 0;
				HEX3Atmp_194614 = tofullpath_189662(i.fileindex);
				f_194617 = open_16817(HEX3Atmp_194614, ((NU8) 0), ((NI) 8000));
				res_194619 = rawNewString(((NI) 80));
				{
					while (1) {
						NIM_BOOL LOC15;
						LOC15 = 0;
						LOC15 = readline_16919(f_194617, (&res_194619));
						if (!LOC15) goto LA14;
						line_194269 = res_194619;
						addsourceline_194227(i.fileindex, line_194269);
					} LA14: ;
				}
				fclose(f_194617);
			}
	...
	{
		NimStringDesc* LOC22;
		if (!!((((NI) (i.fileindex)) < (fileinfos_188632 ? fileinfos_188632->Sup.len : 0)))) goto LA20;
		LOC22 = 0;
		LOC22 = HEX24_194279(TMP1065);
		internalerror_194191(LOC22);
	}
	LA20: ;
	{
		if (!((fileinfos_188632->data[i.fileindex].lines ? fileinfos_188632->data[i.fileindex].lines->Sup.len : 0) < ((NI) (i.line)))) goto LA25;
		result = NIM_NIL;
		goto BeforeRet;
	}
	LA25: ;
	result = fileinfos_188632->data[i.fileindex].lines->data[(NI16)(i.line - ((NI16) 1))];
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, writesurroundingsrc_192681)(Tlineinfo188352 info) {
	...
	LOC1 = 0;
	LOC2 = 0;
	LOC2 = sourceline_189389(info);
	LOC3 = 0;
	LOC3 = HEX24_175132(LOC2);
...
N_NIMCALL(void, limessage_192706)(Tlineinfo188352 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 0) ... ((NU16) 236):
	{
		writecontext_191266(info);
		title = copyString(((NimStringDesc*) &TMP435));
		color = ((NU8) 31);
		lasterror_189435 = info;
	}
	break;
	case ((NU16) 237) ... ((NU16) 267):
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = !(((goptions_165130 &(1<<((((NU8) 11))&31)))!=0));
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_189395 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 268) ... ((NU16) 290):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_189395 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0));
		LA11: ;
		ignoremsg = LOC10;
		title = copyString(((NimStringDesc*) &TMP468));
		color = ((NU8) 32);
	...
	LOC12[0] = tomsgfilename_189829(info);
	LOC12[1] = coordtostr_190396(((NI) (info.line)));
	LOC12[2] = coordtostr_190396(((NI) ((NI16)(info.col + ((NI16) 1)))));
	x = nsuFormatOpenArray(((NimStringDesc*) &TMP154), LOC12, 3);
	s_192813 = getmessagestr_190416(msg, arg);
	{
		NIM_BOOL LOC15;
		NIM_BOOL LOC17;
		LOC15 = 0;
		...
		if (!(LOC15)) goto LA16;
		LOC17 = 0;
		LOC17 = ignoremsgbecauseofidetools_191637(msg);
		LOC15 = !(LOC17);
		LA16: ;
		if (!LOC15) goto LA18;
		{
			...
			{
				NimStringDesc* s_192832;
				if (!!(writelnhook_189441.ClPrc == 0)) goto LA26;
				s_192832 = copyString(((NimStringDesc*) &TMP147));
				{
					NimStringDesc* arg_192834;
					NI i_194067;
					arg_192834 = 0;
					i_194067 = ((NI) 0);
					{
						while (1) {
							TY192829 LOC31;
							if (!(i_194067 < ((NI) 4))) goto LA30;
							memset((void*)LOC31, 0, sizeof(LOC31));
							LOC31[0] = copyString(x);
							LOC31[1] = copyString(title);
							LOC31[2] = copyString(s_192813);
							LOC31[3] = nsuFormatSingleElem(((NimStringDesc*) &TMP491), kind);
							arg_192834 = LOC31[(i_194067)- 0];
							s_192832 = resizeString(s_192832, arg_192834->Sup.len + 0);
appendString(s_192832, arg_192834);
							i_194067 += ((NI) 1);
						} LA30: ;
					}
				}
				writelnhook_189441.ClEnv? writelnhook_189441.ClPrc(s_192832, writelnhook_189441.ClEnv):((TMP1045)(writelnhook_189441.ClPrc))(s_192832);
			}
			goto LA24;
			LA26: ;
			{
				if (!((gglobaloptions_165132 &(1<<((((NU8) 23))&31)))!=0)) goto LA33;
				{
					TY192829 LOC39;
					if (!((erroroutputs_189437 &(1<<((((NU8) 0))&7)))!=0)) goto LA37;
					memset((void*)LOC39, 0, sizeof(LOC39));
					LOC39[0] = copyString(x);
					LOC39[1] = copyString(title);
					LOC39[2] = copyString(s_192813);
					LOC39[3] = nsuFormatSingleElem(((NimStringDesc*) &TMP491), kind);
					writeline_166405(stdout, LOC39, 4);
					fflush(stdout);
				}
				LA37: ;
			}
			...
			{
				{
					...
					LA47: ;
					{
						...
						LOC51[2] = copyString(s_192813);
						LOC51[3] = nsuFormatSingleElem(((NimStringDesc*) &TMP491), kind);
						writeline_166405(stderr, LOC51, 4);
					}
					LA45: ;
				}
				LA43: ;
		...
		{
			{
				NimStringDesc* s_193418;
				if (!!(writelnhook_189441.ClPrc == 0)) goto LA55;
				s_193418 = copyString(((NimStringDesc*) &TMP147));
				{
					NimStringDesc* arg_193420;
					NI i_194071;
					arg_193420 = 0;
					i_194071 = ((NI) 0);
					{
						while (1) {
							TY191293 LOC60;
							if (!(i_194071 < ((NI) 3))) goto LA59;
							memset((void*)LOC60, 0, sizeof(LOC60));
							LOC60[0] = copyString(x);
							LOC60[1] = copyString(title);
							LOC60[2] = copyString(s_192813);
							arg_193420 = LOC60[(i_194071)- 0];
							s_193418 = resizeString(s_193418, arg_193420->Sup.len + 0);
appendString(s_193418, arg_193420);
							i_194071 += ((NI) 1);
						} LA59: ;
					}
				}
				writelnhook_189441.ClEnv? writelnhook_189441.ClPrc(s_193418, writelnhook_189441.ClEnv):((TMP1046)(writelnhook_189441.ClPrc))(s_193418);
			}
			goto LA53;
			LA55: ;
			{
				if (!((gglobaloptions_165132 &(1<<((((NU8) 23))&31)))!=0)) goto LA62;
				{
					TY191293 LOC68;
					if (!((erroroutputs_189437 &(1<<((((NU8) 0))&7)))!=0)) goto LA66;
					memset((void*)LOC68, 0, sizeof(LOC68));
					LOC68[0] = copyString(x);
					LOC68[1] = copyString(title);
					LOC68[2] = copyString(s_192813);
					writeline_166405(stdout, LOC68, 3);
					fflush(stdout);
				}
				LA66: ;
			}
			...
			{
				{
					if (!((erroroutputs_189437 &(1<<((((NU8) 1))&7)))!=0)) goto LA72;
					{
						if (!((gglobaloptions_165132 &(1<<((((NU8) 21))&31)))!=0)) goto LA76;
						setstyle_185604(stderr, 1);
						write_16895(stderr, x);
						resetattributes_185209(stderr);
						setforegroundcolor_186057(stderr, color, NIM_FALSE);
					...
					LA76: ;
					{
						...
						LOC79[2] = copyString(s_192813);
						writeline_166405(stderr, LOC79, 3);
					}
					LA74: ;
				}
				LA72: ;
		...
		LA20: ;
		{
			...
			Slice194011 LOC83;
			LOC82 = 0;
			LOC83 = HEX2EHEX2E_194002(((NU16) 0), ((NU16) 236));
			LOC82 = contains_194021(LOC83, msg);
			if (!(LOC82)) goto LA84;
			LOC82 = ((gnotes_189395 &(IL64(1)<<(((((NU16) 287)- 237))&IL64(63))))!=0);
			LA84: ;
			if (!LOC82) goto LA85;
			writesurroundingsrc_192681(info);
		}
		LA85: ;
	}
	LA18: ;
	handleerror_190437(msg, eh, s_192813);
}
...
{	{
	...
	LA3: ;
	writecontext_191266(info);
	limessage_192706(info, ((NU16) 2), errmsg, ((NU8) 1));
	}BeforeRet: ;
}
...
N_NIMCALL(NimStringDesc*, tofullpathconsiderdirty_189807)(NI32 fileidx) {
	...
	LA3: ;
	{
		if (!!(fileinfos_188632->data[fileidx].dirtyfile == 0)) goto LA6;
		result = copyString(fileinfos_188632->data[fileidx].dirtyfile);
	}
	goto LA1;
	LA6: ;
	{
...
N_NIMCALL(void, message_194161)(Tlineinfo188352 info, NU16 msg, NimStringDesc* arg) {
	limessage_192706(info, msg, arg, ((NU8) 0));
}
...
N_NIMCALL(NI32, fileinfoidx_188732)(NimStringDesc* filename, NIM_BOOL* isknownfile) {
	...
	if (TMP1188.status == 0) {
		canon = canonicalizepath_165409(filename);
		shallow_91624((&canon));
		popSafePoint();
	}
	else {
	...
	if (TMP1188.status != 0) reraiseException();
	{
		...
		NI32* LOC9;
		LOC6 = 0;
		LOC6 = haskey_188742(filenametoindextbl_188614, canon);
		if (!LOC6) goto LA7;
		LOC9 = 0;
		LOC9 = HEX5BHEX5D_188786((&filenametoindextbl_188614), canon);
		result = (*LOC9);
	}
	goto LA4;
	LA7: ;
	{
		NimStringDesc* LOC11;
		Tfileinfo188350 LOC17;
		(*isknownfile) = NIM_FALSE;
		result = ((NI32) ((fileinfos_188632 ? fileinfos_188632->Sup.len : 0)));
		LOC11 = 0;
		{
		...
		LA14: ;
		{
			LOC11 = shortendir_165607(canon);
		}
		LA12: ;
		memset((void*)(&LOC17), 0, sizeof(LOC17));
		newfileinfo_188694(canon, LOC11, (&LOC17));
		fileinfos_188632 = (TY188615*) incrSeqV2(&(fileinfos_188632)->Sup, sizeof(Tfileinfo188350));
		genericAssign((void*)(&fileinfos_188632->data[fileinfos_188632->Sup.len]), (void*)(&LOC17), (&NTI188350));
		++fileinfos_188632->Sup.len;
		HEX5BHEX5DHEX3D_189038((&filenametoindextbl_188614), canon, result);
	}
	LA4: ;
	return result;
}
...
N_NIMCALL(NI32, fileinfoidx_189253)(NimStringDesc* filename) {
	...
	result = 0;
	dummy = 0;
	result = fileinfoidx_188732(filename, (&dummy));
	return result;
}
...
N_NIMCALL(NimStringDesc*, tofilename_189652)(NI32 fileidx) {
	...
	LA3: ;
	{
		result = copyString(fileinfos_188632->data[fileidx].projpath);
	}
	LA1: ;
	return result;
}
...
N_NIMCALL(void, listwarnings_194769)(void) {
	msgwriteln_189915(((NimStringDesc*) &TMP1899), 0);
	{
		NU16 warn_194823;
		NI res_194857;
		warn_194823 = 0;
		res_194857 = ((NI) 237);
		{
			while (1) {
				TY191306 LOC4;
				NimStringDesc* LOC10;
				if (!(res_194857 <= ((NI) 267))) goto LA3;
				warn_194823 = ((NU16) (res_194857));
				memset((void*)LOC4, 0, sizeof(LOC4));
				{
					if (!((gnotes_189395 &(IL64(1)<<(((((NU16) (warn_194823))- 237))&IL64(63))))!=0)) goto LA7;
					LOC4[0] = copyString(((NimStringDesc*) &TMP1901));
				}
				goto LA5;
				LA7: ;
				{
				...
				LA5: ;
				LOC4[1] = copyString(Warningstostr_188309[((NI)(((NI) (warn_194823)) - ((NI) 237)))- 0]);
				LOC10 = 0;
				LOC10 = nsuFormatOpenArray(((NimStringDesc*) &TMP1900), LOC4, 2);
				msgwriteln_189915(LOC10, 0);
				res_194857 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NIMCALL(void, localerror_194139)(Tlineinfo188352 info, NimStringDesc* arg) {
	limessage_192706(info, ((NU16) 4), arg, ((NU8) 0));
}

N_NIMCALL(void, listhints_194875)(void) {
	msgwriteln_189915(((NimStringDesc*) &TMP1961), 0);
	{
		NU16 hint_194887;
		NI res_194921;
		hint_194887 = 0;
		res_194921 = ((NI) 268);
		{
			while (1) {
				TY191306 LOC4;
				NimStringDesc* LOC10;
				if (!(res_194921 <= ((NI) 290))) goto LA3;
				hint_194887 = ((NU16) (res_194921));
				memset((void*)LOC4, 0, sizeof(LOC4));
				{
					if (!((gnotes_189395 &(IL64(1)<<(((((NU16) (hint_194887))- 237))&IL64(63))))!=0)) goto LA7;
					LOC4[0] = copyString(((NimStringDesc*) &TMP1901));
				}
				goto LA5;
				LA7: ;
				...
				LA5: ;
				LOC4[1] = copyString(Hintstostr_188314[((NI)(((NI) (hint_194887)) - ((NI) 268)))- 0]);
				LOC10 = 0;
				LOC10 = nsuFormatOpenArray(((NimStringDesc*) &TMP1900), LOC4, 2);
				msgwriteln_189915(LOC10, 0);
				res_194921 += ((NI) 1);
...
N_NIMCALL(void, setdirtyfile_189672)(NI32 fileidx, NimStringDesc* filename) {
	NimStringDesc* LOC1;
	LOC1 = 0;
	LOC1 = fileinfos_188632->data[fileidx].dirtyfile; fileinfos_188632->data[fileidx].dirtyfile = copyStringRC1(filename);
	if (LOC1) nimGCunrefNoCycle(LOC1);
}

N_NIMCALL(void, suggestwriteln_189450)(NimStringDesc* s) {
	{
		if (!((erroroutputs_189437 &(1<<((((NU8) 0))&7)))!=0)) goto LA3;
		{
			TY190421 LOC9;
			if (!writelnhook_189441.ClPrc == 0) goto LA7;
			memset((void*)LOC9, 0, sizeof(LOC9));
			LOC9[0] = copyString(s);
			writeline_166405(stdout, LOC9, 1);
			fflush(stdout);
		}
		goto LA5;
		LA7: ;
		{
			writelnhook_189441.ClEnv? writelnhook_189441.ClPrc(s, writelnhook_189441.ClEnv):((TMP2063)(writelnhook_189441.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, globalerror_194107)(Tlineinfo188352 info, NU16 msg, NimStringDesc* arg) {
	limessage_192706(info, msg, arg, ((NU8) 2));
}

N_NIMCALL(void, pushinfocontext_189578)(Tlineinfo188352 info) {
	msgcontext_189434 = (TY189417*) incrSeqV2(&(msgcontext_189434)->Sup, sizeof(Tlineinfo188352));
	msgcontext_189434->data[msgcontext_189434->Sup.len] = info;
	++msgcontext_189434->Sup.len;
}

N_NIMCALL(void, popinfocontext_189597)(void) {
	msgcontext_189434 = (TY189417*) setLengthSeq(&(msgcontext_189434)->Sup, sizeof(Tlineinfo188352), ((NI) ((NI)((msgcontext_189434 ? msgcontext_189434->Sup.len : 0) - ((NI) 1)))));
}
N_NIMCALL(void, TMP2773)(void* p, NI op) {
	Esuggestdone188360* a;
	a = (Esuggestdone188360*)p;
...
N_NIMCALL(void, suggestquit_189506)(void) {
	Esuggestdone188360* e_189511;
	NimStringDesc* LOC1;
	e_189511 = 0;
	e_189511 = (Esuggestdone188360*) newObj((&NTI189512), sizeof(Esuggestdone188360));
	(*e_189511).Sup.Sup.m_type = (&NTI188360);
	LOC1 = 0;
	LOC1 = (*e_189511).Sup.message; (*e_189511).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2774));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_189511, "ESuggestDone");
}

N_NIMCALL(void, globalerror_194118)(Tlineinfo188352 info, NimStringDesc* arg) {
	limessage_192706(info, ((NU16) 4), arg, ((NU8) 2));
}
...
N_NIMCALL(NimStringDesc*, formatmsg_192691)(Tlineinfo188352 info, NU16 msg, NimStringDesc* arg) {
	...
	LOC5[0] = tomsgfilename_189829(info);
	LOC5[1] = coordtostr_190396(((NI) (info.line)));
	LOC5[2] = coordtostr_190396(((NI) ((NI16)(info.col + ((NI16) 1)))));
	LOC6 = 0;
	LOC6 = nsuFormatOpenArray(((NimStringDesc*) &TMP154), LOC5, 3);
	LOC7 = 0;
	LOC7 = getmessagestr_190416(msg, arg);
...
N_NIMCALL(void, fatal_194096)(Tlineinfo188352 info, NU16 msg, NimStringDesc* arg) {
	limessage_192706(info, msg, arg, ((NU8) 1));
}
...
N_NIMCALL(Tlineinfo188352, getinfocontext_189623)(NI index) {
	...
	NI i;
	memset((void*)(&result), 0, sizeof(result));
	L = (msgcontext_189434 ? msgcontext_189434->Sup.len : 0);
	{
	...
	LA1: ;
	{
		...
		result = unknownlineinfo_189408();
	}
	goto LA6;
	LA8: ;
	{
		result = msgcontext_189434->data[i];
	}
	LA6: ;
	return result;
}
...
appendString(LOC1, ((NimStringDesc*) &TMP3236));
appendString(LOC1, LOC3);
...
N_NIMCALL(NimStringDesc*, HEX24_189879)(Tlineinfo188352 info) {
	NimStringDesc* result;
	result = 0;
	result = tofilelinecol_189869(info);
	return result;
}
...
N_NIMCALL(NI, getinfocontextlen_189542)(void) {
	NI result;
{	result = 0;
	result = (msgcontext_189434 ? msgcontext_189434->Sup.len : 0);
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setinfocontextlen_189559)(NI L) {
	msgcontext_189434 = (TY189417*) setLengthSeq(&(msgcontext_189434)->Sup, sizeof(Tlineinfo188352), ((NI) (L)));
}
...
N_NIMCALL(Ropeobj174009*, quotedfilename_194636)(Tlineinfo188352 i) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = HEX24_194279(TMP4002);
		internalerror_194191(LOC5);
	}
	LA3: ;
	result = fileinfos_188632->data[i.fileindex].quotedname;
	return result;
}

N_NIMCALL(void, resetattributes_192648)(void) {
	{
		if (!((10485760 & gglobaloptions_165132) == 2097152)) goto LA3;
		resetattributes_185209(stderr);
	}
	LA3: ;
}
NIM_EXTERNC N_NOINLINE(void, compiler_msgsInit000)(void) {
	Tfileinfo188350 LOC1;
	Tfileinfo188350 LOC2;
	NI LOC3;
	NI LOC4;
	NI LOC5;
	TY174023 LOC6;
	chckNil((void*)(&filenametoindextbl_188614));
	genericReset((void*)(&filenametoindextbl_188614), (&NTI188452));
	inittable_188444(((NI) 64), (&filenametoindextbl_188614));
	if (fileinfos_188632) nimGCunrefNoCycle(fileinfos_188632);
	fileinfos_188632 = (TY188615*) newSeqRC1((&NTI188615), 0);
	memset((void*)(&LOC1), 0, sizeof(LOC1));
	newfileinfo_188694(((NimStringDesc*) &TMP147), ((NimStringDesc*) &TMP149), (&LOC1));
	fileinfos_188632 = (TY188615*) incrSeqV2(&(fileinfos_188632)->Sup, sizeof(Tfileinfo188350));
	genericAssign((void*)(&fileinfos_188632->data[fileinfos_188632->Sup.len]), (void*)(&LOC1), (&NTI188350));
	++fileinfos_188632->Sup.len;
	gcmdlineinfo_189321 = newlineinfo_189266(((NI32) 0), ((NI) 1), ((NI) 1));
	memset((void*)(&LOC2), 0, sizeof(LOC2));
	newfileinfo_188694(((NimStringDesc*) &TMP147), ((NimStringDesc*) &TMP150), (&LOC2));
	fileinfos_188632 = (TY188615*) incrSeqV2(&(fileinfos_188632)->Sup, sizeof(Tfileinfo188350));
	genericAssign((void*)(&fileinfos_188632->data[fileinfos_188632->Sup.len]), (void*)(&LOC2), (&NTI188350));
	++fileinfos_188632->Sup.len;
	gcodegenlineinfo_189359 = newlineinfo_189266(((NI32) 1), ((NI) 1), ((NI) 1));
	gnotes_189395 = 0;
	LOC3 = 0;
	for (LOC3 = (((NU16) 237)- 237); LOC3 <= (((NU16) 255)- 237); LOC3++) 
gnotes_189395 |=((NU64)(1)<<((LOC3)%(sizeof(NU64)*8)));
	gnotes_189395 |=((NU64)(1)<<(((((NU16) 257)- 237))%(sizeof(NU64)*8)));
	gnotes_189395 |=((NU64)(1)<<(((((NU16) 261)- 237))%(sizeof(NU64)*8)));
	LOC4 = 0;
	for (LOC4 = (((NU16) 263)- 237); LOC4 <= (((NU16) 276)- 237); LOC4++) 
gnotes_189395 |=((NU64)(1)<<((LOC4)%(sizeof(NU64)*8)));
	LOC5 = 0;
	for (LOC5 = (((NU16) 281)- 237); LOC5 <= (((NU16) 283)- 237); LOC5++) 
gnotes_189395 |=((NU64)(1)<<((LOC5)%(sizeof(NU64)*8)));
	gnotes_189395 |=((NU64)(1)<<(((((NU16) 285)- 237))%(sizeof(NU64)*8)));
	gnotes_189395 |=((NU64)(1)<<(((((NU16) 290)- 237))%(sizeof(NU64)*8)));
	gerrorcounter_189396 = ((NI) 0);
	ghintcounter_189397 = ((NI) 0);
	gwarncounter_189398 = ((NI) 0);
	gerrormax_189399 = ((NI) 1);
	if (msgcontext_189434) nimGCunrefNoCycle(msgcontext_189434);
	msgcontext_189434 = (TY189417*) newSeqRC1((&NTI189417), 0);
	lasterror_189435 = unknownlineinfo_189408();
	erroroutputs_189437 = 3;
	memset((void*)(&LOC6), 0, sizeof(LOC6));
	LOC6.ClPrc = ((TMP501) (HEX3Aanonymous_194653)); LOC6.ClEnv = NIM_NIL;
	asgnRef((void**) (&errorhandler_174028.ClEnv), LOC6.ClEnv);
	errorhandler_174028.ClPrc = LOC6.ClPrc;
	{
		NIM_BOOL LOC9;
		LOC9 = 0;
		LOC9 = isatty_186426(stderr);
		if (!LOC9) goto LA10;
		gglobaloptions_165132 |= ((NU32)1)<<((((NU8) 21))%(sizeof(NU32)*8));
	}
	LA10: ;
}
...
static TNimNode* TMP2056[291];
NI TMP2058;
static char* NIM_CONST TMP2057[291] = {
"errUnknown", 
"errIllFormedAstX", 
"errInternal", 
"errCannotOpenFile", 
...
NTI188350.size = sizeof(Tfileinfo188350);
NTI188350.kind = 18;
NTI188350.base = 0;
NTI188350.flags = 2;
TMP143[0] = &TMP19[1];
TMP19[1].kind = 1;
TMP19[1].offset = offsetof(Tfileinfo188350, fullpath);
TMP19[1].typ = (&NTI149);
TMP19[1].name = "fullPath";
TMP143[1] = &TMP19[2];
TMP19[2].kind = 1;
TMP19[2].offset = offsetof(Tfileinfo188350, projpath);
TMP19[2].typ = (&NTI149);
TMP19[2].name = "projPath";
TMP143[2] = &TMP19[3];
TMP19[3].kind = 1;
TMP19[3].offset = offsetof(Tfileinfo188350, shortname);
TMP19[3].typ = (&NTI149);
TMP19[3].name = "shortName";
TMP143[3] = &TMP19[4];
TMP19[4].kind = 1;
TMP19[4].offset = offsetof(Tfileinfo188350, quotedname);
TMP19[4].typ = (&NTI174007);
TMP19[4].name = "quotedName";
TMP143[4] = &TMP19[5];
NTI188365.size = sizeof(TY188365*);
NTI188365.kind = 24;
NTI188365.base = (&NTI174007);
NTI188365.flags = 2;
NTI188365.marker = TMP144;
TMP19[5].kind = 1;
TMP19[5].offset = offsetof(Tfileinfo188350, lines);
TMP19[5].typ = (&NTI188365);
TMP19[5].name = "lines";
TMP143[5] = &TMP19[6];
TMP19[6].kind = 1;
TMP19[6].offset = offsetof(Tfileinfo188350, dirtyfile);
TMP19[6].typ = (&NTI149);
TMP19[6].name = "dirtyfile";
TMP19[0].len = 6; TMP19[0].kind = 2; TMP19[0].sons = &TMP143[0];
NTI188350.node = &TMP19[0];
NTI188615.size = sizeof(TY188615*);
NTI188615.kind = 24;
NTI188615.base = (&NTI188350);
NTI188615.flags = 2;
NTI188615.marker = TMP145;
NTI188352.size = sizeof(Tlineinfo188352);
NTI188352.kind = 18;
NTI188352.base = 0;
NTI188352.flags = 3;
TMP151[0] = &TMP19[8];
TMP19[8].kind = 1;
TMP19[8].offset = offsetof(Tlineinfo188352, line);
TMP19[8].typ = (&NTI112);
TMP19[8].name = "line";
TMP151[1] = &TMP19[9];
TMP19[9].kind = 1;
TMP19[9].offset = offsetof(Tlineinfo188352, col);
TMP19[9].typ = (&NTI112);
TMP19[9].name = "col";
TMP151[2] = &TMP19[10];
TMP19[10].kind = 1;
TMP19[10].offset = offsetof(Tlineinfo188352, fileindex);
TMP19[10].typ = (&NTI114);
TMP19[10].name = "fileIndex";
TMP19[7].len = 3; TMP19[7].kind = 2; TMP19[7].sons = &TMP151[0];
NTI188352.node = &TMP19[7];
NTI189417.size = sizeof(TY189417*);
NTI189417.kind = 24;
NTI189417.base = (&NTI188352);
NTI189417.flags = 2;
NTI189417.marker = TMP152;
NTI188358.size = sizeof(Erecoverableerror188358);
NTI188358.kind = 17;
NTI188358.base = (&NTI4049);
TMP19[11].len = 0; TMP19[11].kind = 2;
NTI188358.node = &TMP19[11];
NTI189373.size = sizeof(Erecoverableerror188358*);
NTI189373.kind = 22;
NTI189373.base = (&NTI188358);
NTI189373.marker = TMP499;
NTI188005.size = sizeof(NU16);
NTI188005.kind = 14;
NTI188005.base = 0;
NTI188005.flags = 3;
for (TMP2058 = 0; TMP2058 < 291; TMP2058++) {
TMP19[TMP2058+12].kind = 1;
TMP19[TMP2058+12].offset = TMP2058;
TMP19[TMP2058+12].name = TMP2057[TMP2058];
TMP2056[TMP2058] = &TMP19[TMP2058+12];
}
TMP19[303].len = 291; TMP19[303].kind = 2; TMP19[303].sons = &TMP2056[0];
NTI188005.node = &TMP19[303];
NTI188346.size = sizeof(NU16);
NTI188346.kind = 20;
NTI188346.base = (&NTI188005);
NTI188346.flags = 3;
NTI188348.size = sizeof(NU64);
NTI188348.kind = 19;
NTI188348.base = (&NTI188346);
NTI188348.flags = 3;
TMP19[304].len = 237; TMP19[304].kind = 0;
NTI188348.node = &TMP19[304];
NTI188360.size = sizeof(Esuggestdone188360);
NTI188360.kind = 17;
NTI188360.base = (&NTI4027);
TMP19[305].len = 0; TMP19[305].kind = 2;
NTI188360.node = &TMP19[305];
NTI189512.size = sizeof(Esuggestdone188360*);
NTI189512.kind = 22;
NTI189512.base = (&NTI188360);
NTI189512.marker = TMP2773;
}
