...
STRING_LITERAL(TMP1320, "none", 4);
STRING_LITERAL(TMP1321, "stdtmpl", 7);
STRING_LITERAL(TMP1322, "replace", 7);
STRING_LITERAL(TMP1323, "strip", 5);
NIM_CONST TY260026 filternames_260025 = {((NimStringDesc*) &TMP1320),
((NimStringDesc*) &TMP1321),
((NimStringDesc*) &TMP1322),
((NimStringDesc*) &TMP1323)}
;
STRING_LITERAL(TMP1324, "standard", 8);
STRING_LITERAL(TMP1325, "strongspaces", 12);
STRING_LITERAL(TMP1326, "braces", 6);
STRING_LITERAL(TMP1327, "endx", 4);
NIM_CONST TY260020 parsernames_260019 = {((NimStringDesc*) &TMP1324),
((NimStringDesc*) &TMP1325),
((NimStringDesc*) &TMP1326),
((NimStringDesc*) &TMP1327)}
;
STRING_LITERAL(TMP1358, "parser to implement", 19);
...
N_NIMCALL(tllstream211204*, evalpipe_260546)(tparsers260035* p, tnode225816* n, NimStringDesc* filename, tllstream211204* start) {
	...
	LA3: ;
	{
		...
		LOC7 = LOC8;
		if (!(LOC7)) goto LA10;
		LOC7 = identeq_200493((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP1210));
		LA10: ;
		if (!LOC7) goto LA11;
		{
			NI i_260635;
...
N_NIMCALL(tnode225816*, parseall_260063)(tparsers260035* p) {
	...
	case ((NU8) 3):
	{
		internalerror_198006(((NimStringDesc*) &TMP1358));
		result = emptynode_226738;
	}
	break;
	}
