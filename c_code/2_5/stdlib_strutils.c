...
STRING_LITERAL(TMP1219, "0123456789ABCDEF", 16);
STRING_LITERAL(TMP1221, "", 0);
static NIM_CONST TY212607 TMP1568 = {
0x00, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2107, "\\x", 2);
...
101}
;
STRING_LITERAL(TMP4877, "GB", 2);
STRING_LITERAL(TMP4878, "MB", 2);
STRING_LITERAL(TMP4879, "KB", 2);
STRING_LITERAL(TMP4880, "B", 1);
	...
	result = mnewString(len);
	{
		...
		res_95595 = HEX3Atmp_95592;
		{
			while (1) {
				...
				j_95588 = res_95595;
				result->data[j_95588] = ((NimStringDesc*) &TMP1219)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(x) >> (NU64)(shift)))) & ((NI32) 15))];
...
appendString(LOC5, ((NimStringDesc*) &TMP4877));
		result = LOC5;
	}
	goto LA1;
	LA3: ;
...
appendString(LOC12, ((NimStringDesc*) &TMP4878));
		result = LOC12;
	}
	goto LA1;
	LA10: ;
...
appendString(LOC19, ((NimStringDesc*) &TMP4879));
		result = LOC19;
	}
	goto LA1;
	LA17: ;
...
appendString(LOC24, ((NimStringDesc*) &TMP4880));
		result = LOC24;
	}
	LA1: ;
	return result;
