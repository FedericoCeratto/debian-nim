...
N_NIMCALL(void, tmtotimeinfo_111447_2726502234)(struct tm* tm0, NIM_BOOL local0, Timeinfo110603* Result) {
	...
	LA4: ;
	{
		LOC1.tzname = copyString(((NimStringDesc*) &TMP3568));
	}
	LA2: ;
	{
		if (!local0) goto LA16;
...
static TNimNode* TMP3561[11];
static TNimNode* TMP3562[12];
NI TMP3564;
static char* NIM_CONST TMP3563[12] = {
"mJan", 
"mFeb", 
"mMar", 
"mApr", 
...
"mNov", 
"mDec"};
static TNimNode* TMP3565[7];
NI TMP3567;
static char* NIM_CONST TMP3566[7] = {
"dMon", 
"dTue", 
"dWed", 
"dThu", 
...
NTI110203.base = 0;
NTI110203.flags = 3;
for (TMP3564 = 0; TMP3564 < 12; TMP3564++) {
TMP19[TMP3564+6].kind = 1;
TMP19[TMP3564+6].offset = TMP3564;
TMP19[TMP3564+6].name = TMP3563[TMP3564];
TMP3562[TMP3564] = &TMP19[TMP3564+6];
}
TMP19[18].len = 12; TMP19[18].kind = 2; TMP19[18].sons = &TMP3562[0];
...
NTI110205.base = 0;
NTI110205.flags = 3;
for (TMP3567 = 0; TMP3567 < 7; TMP3567++) {
TMP19[TMP3567+21].kind = 1;
TMP19[TMP3567+21].offset = TMP3567;
TMP19[TMP3567+21].name = TMP3566[TMP3567];
TMP3565[TMP3567] = &TMP19[TMP3567+21];
}
TMP19[28].len = 7; TMP19[28].kind = 2; TMP19[28].sons = &TMP3565[0];
...
TMP19[0].len = 11; TMP19[0].kind = 2; TMP19[0].sons = &TMP3561[0];
