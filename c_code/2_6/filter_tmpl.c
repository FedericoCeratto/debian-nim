...
N_NIMCALL(NIM_BOOL, contains_97267)(NimStringDesc* s, TY212607 chars);
...
STRING_LITERAL(TMP1329, "", 0);
STRING_LITERAL(TMP1330, "subschar", 8);
STRING_LITERAL(TMP1331, "metachar", 8);
STRING_LITERAL(TMP1332, "emit", 4);
STRING_LITERAL(TMP1333, "result.add", 10);
STRING_LITERAL(TMP1334, "conc", 4);
STRING_LITERAL(TMP1335, " & ", 3);
STRING_LITERAL(TMP1336, "tostring", 8);
STRING_LITERAL(TMP1337, "$", 1);
STRING_LITERAL(TMP1338, "\012", 1);
STRING_LITERAL(TMP1340, "end", 3);
STRING_LITERAL(TMP1341, "#end", 4);
static NIM_CONST TY212607 TMP1342 = {
...
N_NIMCALL(void, parseline_260174)(ttmplparser260020* p) {
	...
	LA7: ;
	{
		...
		d = j;
		keyw = copyString(((NimStringDesc*) &TMP1329));
		{
			while (1) {
		...
		case ((NU8) 21):
		{
			...
			{
				(*p).Info.Col = ((NI16) (j));
				localerror_198955((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP1340));
			}
			LA20: ;
			LOC25 = 0;
			LOC25 = nsuRepeatChar((*p).Indent, 32);
			llstreamwrite_212278((*p).Outp, LOC25);
			llstreamwrite_212278((*p).Outp, ((NimStringDesc*) &TMP1341));
		}
		break;
		case ((NU8) 30):
		case ((NU8) 64):
		...
		case ((NU8) 61):
		{
			...
			llstreamwrite_212278((*p).Outp, LOC34);
			{
				NIM_BOOL LOC37;
				LOC37 = 0;
				LOC37 = contains_97267((*p).X, TMP1342);
				if (!!(LOC37)) goto LA38;
				(*p).Indent += 2;
			}
			LA38: ;
	...
	LA10: ;
	{
		...
		case ((NU8) 1):
		{
			...
			llstreamwrite_212278((*p).Outp, ((NimStringDesc*) &TMP1343));
		}
		break;
		case ((NU8) 0):
		{
		...
		(*p).State = ((NU8) 1);
		{
			while (1) {
				...
				{
					NimStringDesc* LOC52;
					llstreamwrite_212278((*p).Outp, ((NimStringDesc*) &TMP1345));
					LOC52 = 0;
				...
				case 92:
				{
					llstreamwrite_212278((*p).Outp, ((NimStringDesc*) &TMP1346));
					j += 1;
				}
				break;
				case 39:
				...
				case 34:
				{
					llstreamwrite_212278((*p).Outp, ((NimStringDesc*) &TMP1348));
					j += 1;
				}
				break;
				default:
				{
					{
						...
						case 123:
						{
							...
							curly = 0;
							{
								while (1) {
									...
									case 0:
									{
										localerror_198955((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP1349));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).Info.Col = ((NI16) (j));
								localerror_198955((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP1337));
							}
							LA80: ;
						}
						break;
...
N_NIMCALL(tllstream212204*, filtertmpl_260009)(tllstream212204* stdin_260011, NimStringDesc* filename, tnode226816* call) {
	...
	p.Outp = llstreamopen_212220(((NimStringDesc*) &TMP1329));
	p.Inp = stdin_260011;
	p.Subschar = chararg_259020(call, ((NimStringDesc*) &TMP1330), 1, 36);
	p.Nimdirective = chararg_259020(call, ((NimStringDesc*) &TMP1331), 2, 35);
	p.Emit = strarg_259029(call, ((NimStringDesc*) &TMP1332), 3, ((NimStringDesc*) &TMP1333));
	p.Conc = strarg_259029(call, ((NimStringDesc*) &TMP1334), 4, ((NimStringDesc*) &TMP1335));
	p.Tostr = strarg_259029(call, ((NimStringDesc*) &TMP1336), 5, ((NimStringDesc*) &TMP1337));
