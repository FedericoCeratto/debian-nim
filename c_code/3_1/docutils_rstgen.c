...
typedef N_CLOSURE_PTR(NI, TMP5177) (NimStringDesc* x_352094, NimStringDesc* y_352096, void* ClEnv);
...
typedef N_CLOSURE_PTR(NI, TMP5181) (Indexentry348397 x_351330, Indexentry348397 y_351332, void* ClEnv);
typedef N_CLOSURE_PTR(NI, TMP5191) (Indexentry348397 x_350016, Indexentry348397 y_350018, void* ClEnv);
struct TY349075 {
NI Field0;
NimStringDesc* Field1;
};
...
N_NIMCALL(void, buildlineshtmltable_355035)(Rstgenerator347016* d, Codeblockparams347020 params, NimStringDesc* code, Keyvaluepair146208* Result);
...
N_NIMCALL(NimStringDesc*, generatemodulejumps_351436)(TY131608* modules);
...
STRING_LITERAL(TMP2203, "\012<h$1><a class=\"toc-backref\" id=\"$2\" href=\"#$2\">$3</a></h$1>", 60);
STRING_LITERAL(TMP2204, "\\rsth$4{$3}\\label{$2}\012", 22);
STRING_LITERAL(TMP2205, "\012<h$1 id=\"$2\">$3</h$1>", 22);
STRING_LITERAL(TMP2206, "html", 4);
STRING_LITERAL(TMP2207, "\\", 1);
STRING_LITERAL(TMP2208, "\\\\", 2);
STRING_LITERAL(TMP2209, "\012", 1);
STRING_LITERAL(TMP2210, "\\n", 2);
STRING_LITERAL(TMP2211, "\011", 1);
STRING_LITERAL(TMP2212, "\\t", 2);
STRING_LITERAL(TMP2213, "<h$1 id=\"$2\"><center>$3</center></h$1>", 38);
STRING_LITERAL(TMP2214, "\\rstov$4{$3}\\label{$2}\012", 23);
STRING_LITERAL(TMP2215, "<hr />\012", 7);
STRING_LITERAL(TMP2216, "\\hrule\012", 7);
STRING_LITERAL(TMP2217, "<p>$1</p>\012", 10);
STRING_LITERAL(TMP2218, "$1\012\012", 4);
STRING_LITERAL(TMP2219, "<ul class=\"simple\">$1</ul>\012", 27);
STRING_LITERAL(TMP2220, "\\begin{itemize}$1\\end{itemize}\012", 31);
STRING_LITERAL(TMP2221, "<li>$1</li>\012", 12);
STRING_LITERAL(TMP2222, "\\item $1\012", 9);
STRING_LITERAL(TMP2223, "<ol class=\"simple\">$1</ol>\012", 27);
STRING_LITERAL(TMP2224, "\\begin{enumerate}$1\\end{enumerate}\012", 35);
STRING_LITERAL(TMP2225, "<dl class=\"docutils\">$1</dl>\012", 29);
STRING_LITERAL(TMP2226, "\\begin{description}$1\\end{description}\012", 39);
STRING_LITERAL(TMP2227, "<dt>$1</dt>\012", 12);
STRING_LITERAL(TMP2228, "\\item[$1] ", 10);
STRING_LITERAL(TMP2229, "<dd>$1</dd>\012", 12);
STRING_LITERAL(TMP2230, "$1\012", 3);
STRING_LITERAL(TMP2231, "<table class=\"docinfo\" frame=\"void\" rules=\"none\"><col class=\"do"
"cinfo-name\" /><col class=\"docinfo-content\" /><tbody valign=\"top\""
">$1</tbody></table>", 146);
STRING_LITERAL(TMP2232, " ", 1);
STRING_LITERAL(TMP2233, "&amp;", 5);
STRING_LITERAL(TMP2234, "&lt;", 4);
STRING_LITERAL(TMP2235, "&gt;", 4);
STRING_LITERAL(TMP2236, "&quot;", 6);
STRING_LITERAL(TMP2237, "\\_", 2);
STRING_LITERAL(TMP2238, "\\symbol{123}", 12);
STRING_LITERAL(TMP2239, "\\symbol{125}", 12);
STRING_LITERAL(TMP2240, "\\symbol{91}", 11);
STRING_LITERAL(TMP2241, "\\symbol{93}", 11);
STRING_LITERAL(TMP2242, "\\symbol{92}", 11);
STRING_LITERAL(TMP2243, "\\$", 2);
STRING_LITERAL(TMP2244, "\\&", 2);
STRING_LITERAL(TMP2245, "\\#", 2);
STRING_LITERAL(TMP2246, "\\%", 2);
STRING_LITERAL(TMP2247, "\\symbol{126}", 12);
STRING_LITERAL(TMP2248, "\\symbol{64}", 11);
STRING_LITERAL(TMP2249, "\\symbol{94}", 11);
STRING_LITERAL(TMP2250, "\\symbol{96}", 11);
static NIM_CONST TY213407 TMP2251 = {
0x00, 0x3E, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2252, "author", 6);
STRING_LITERAL(TMP2253, "authors", 7);
STRING_LITERAL(TMP2254, "version", 7);
STRING_LITERAL(TMP2255, "<tr>$1</tr>\012", 12);
STRING_LITERAL(TMP2256, "$1", 2);
STRING_LITERAL(TMP2257, "<th class=\"docinfo-name\">$1:</th>", 33);
STRING_LITERAL(TMP2258, "\\item[$1:]", 10);
STRING_LITERAL(TMP2259, "<td>$1</td>", 11);
STRING_LITERAL(TMP2260, " $1\012", 4);
STRING_LITERAL(TMP2261, "<table frame=\"void\">$1</table>", 30);
STRING_LITERAL(TMP2262, "\\begin{description}\012$1\\end{description}\012", 40);
STRING_LITERAL(TMP2263, "<th align=\"left\">$1</th>", 24);
STRING_LITERAL(TMP2264, "\\item[$1]", 9);
STRING_LITERAL(TMP2265, "<td align=\"left\">$1</td>\012", 25);
STRING_LITERAL(TMP2267, "false renderRstToOut", 20);
STRING_LITERAL(TMP2268, "<pre>$1</pre>\012", 14);
STRING_LITERAL(TMP2269, "\\begin{rstpre}\012$1\012\\end{rstpre}\012", 31);
STRING_LITERAL(TMP2270, "<p>$1</p>", 9);
STRING_LITERAL(TMP2271, "$1<br />", 8);
STRING_LITERAL(TMP2272, "$1\\\\\012", 5);
STRING_LITERAL(TMP2273, "<blockquote><p>$1</p></blockquote>\012", 35);
STRING_LITERAL(TMP2274, "\\begin{quote}$1\\end{quote}\012", 27);
STRING_LITERAL(TMP2275, "<table border=\"1\" class=\"docutils\">$1</table>", 45);
STRING_LITERAL(TMP2276, "\\begin{table}\\begin{rsttab}{", 28);
STRING_LITERAL(TMP2277, "|X", 2);
STRING_LITERAL(TMP2278, "|}\012\\hline\012$1\\end{rsttab}\\end{table}", 35);
STRING_LITERAL(TMP2279, " & ", 3);
STRING_LITERAL(TMP2280, "\\\\\012\\hline\012", 10);
STRING_LITERAL(TMP2281, "<tr>", 4);
STRING_LITERAL(TMP2282, "</tr>\012", 6);
STRING_LITERAL(TMP2283, "<th>$1</th>", 11);
STRING_LITERAL(TMP2284, "\\textbf{$1}", 11);
STRING_LITERAL(TMP2285, "<a class=\"reference external\" href=\"#$2\">$1</a>", 47);
STRING_LITERAL(TMP2286, "$1\\ref{$2}", 10);
STRING_LITERAL(TMP2287, "<a class=\"reference external\" href=\"$1\">$1</a>", 46);
STRING_LITERAL(TMP2288, "\\href{$1}{$1}", 13);
STRING_LITERAL(TMP2289, "<a class=\"reference external\" href=\"$2\">$1</a>", 46);
STRING_LITERAL(TMP2290, "\\href{$2}{$1}", 13);
STRING_LITERAL(TMP2292, "scale", 5);
static NIM_CONST TY213407 TMP2293 = {
0x00, 0x3E, 0x00, 0x00, 0x21, 0xC0, 0xFF, 0x07,
0xFE, 0xFF, 0xFF, 0x97, 0xFE, 0xFF, 0xFF, 0x07,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP2294, " scale=\"$1\"", 11);
STRING_LITERAL(TMP2295, " scale=$1", 9);
STRING_LITERAL(TMP2296, "height", 6);
STRING_LITERAL(TMP2297, " height=\"$1\"", 12);
STRING_LITERAL(TMP2298, " height=$1", 10);
STRING_LITERAL(TMP2299, "width", 5);
STRING_LITERAL(TMP2300, " width=\"$1\"", 11);
STRING_LITERAL(TMP2301, " width=$1", 9);
STRING_LITERAL(TMP2302, "alt", 3);
STRING_LITERAL(TMP2303, " alt=\"$1\"", 9);
STRING_LITERAL(TMP2304, "align", 5);
STRING_LITERAL(TMP2305, " align=\"$1\"", 11);
STRING_LITERAL(TMP2306, "[$1]", 4);
STRING_LITERAL(TMP2307, "<img src=\"$1\"$2 />", 18);
STRING_LITERAL(TMP2308, "\\includegraphics$2{$1}", 22);
STRING_LITERAL(TMP2309, "number-lines", 12);
STRING_LITERAL(TMP2310, "file", 4);
STRING_LITERAL(TMP2311, "default-language", 16);
STRING_LITERAL(TMP2320, "doc.listing_start", 17);
STRING_LITERAL(TMP2321, "doc.listing_end", 15);
STRING_LITERAL(TMP2322, "<table class=\"line-nums-table\"><tbody><tr><td class=\"blob-line-"
"nums\"><pre class=\"line-nums\">", 92);
STRING_LITERAL(TMP2323, "</pre></td><td>", 15);
STRING_LITERAL(TMP2324, "</td></tr></tbody></table>", 26);
STRING_LITERAL(TMP2325, "doc.listing_button", 18);
STRING_LITERAL(TMP2326, "\\begin{rstpre}\012", 15);
STRING_LITERAL(TMP2488, "<span class=\"$2\">$1</span>", 26);
STRING_LITERAL(TMP2489, "\\span$2{$1}", 11);
extern NIM_CONST TY341090 tokenclasstostr_341087;
STRING_LITERAL(TMP2523, "\012\\end{rstpre}\012", 14);
STRING_LITERAL(TMP2524, "<div>$1</div>", 13);
STRING_LITERAL(TMP2525, "<div class=\"$1\">$2</div>", 24);
STRING_LITERAL(TMP2526, "$2", 2);
STRING_LITERAL(TMP2527, "|$1|", 4);
STRING_LITERAL(TMP2528, "<sub>$1</sub>", 13);
STRING_LITERAL(TMP2529, "\\rstsub{$1}", 11);
STRING_LITERAL(TMP2530, "<sup>$1</sup>", 13);
STRING_LITERAL(TMP2531, "\\rstsup{$1}", 11);
STRING_LITERAL(TMP2532, "<em>$1</em>", 11);
STRING_LITERAL(TMP2533, "\\emph{$1}", 9);
STRING_LITERAL(TMP2534, "<strong>$1</strong>", 19);
STRING_LITERAL(TMP2535, "<strong><em>$1</em></strong>", 28);
STRING_LITERAL(TMP2536, "\\textbf{emph{$1}}", 17);
STRING_LITERAL(TMP2537, "<cite>$1</cite>", 15);
STRING_LITERAL(TMP2540, "<span id=\"$1\">$2</span>", 23);
STRING_LITERAL(TMP2541, "$2\\label{$1}", 12);
STRING_LITERAL(TMP2542, "<tt class=\"docutils literal\"><span class=\"pre\">$1</span></tt>", 61);
STRING_LITERAL(TMP2543, "\\texttt{$1}", 11);
STRING_LITERAL(TMP2544, "<img src=\"$1\" width=\"15\"\012        height=\"17\" hspace=\"2\" vspace="
"\"2\" class=\"smiley\" />", 84);
STRING_LITERAL(TMP2545, "\\includegraphics{$1}", 20);
STRING_LITERAL(TMP2546, "doc.smiley_format", 17);
STRING_LITERAL(TMP5016, ".nim", 4);
STRING_LITERAL(TMP5017, "Module ", 7);
STRING_LITERAL(TMP5018, "split.item.toc", 14);
STRING_LITERAL(TMP5097, "<li><a class=\"reference\" id=\"$1_toc\" href=\"#$1\">$2</a></li>\012", 60);
STRING_LITERAL(TMP5098, "\\item\\label{$1_toc} $2\\ref{$1}\012", 31);
STRING_LITERAL(TMP5099, "<ul class=\"simple\">$1</ul>", 26);
STRING_LITERAL(TMP5100, "\\begin{enumerate}$1\\end{enumerate}", 34);
STRING_LITERAL(TMP5171, ".", 1);
STRING_LITERAL(TMP5172, "..", 2);
STRING_LITERAL(TMP5173, ".idx", 4);
STRING_LITERAL(TMP5174, "doc_toc_", 8);
STRING_LITERAL(TMP5178, "Documents: ", 11);
STRING_LITERAL(TMP5182, "<a href=\"", 9);
STRING_LITERAL(TMP5183, "\">", 2);
STRING_LITERAL(TMP5184, "</a>", 4);
STRING_LITERAL(TMP5185, ", ", 2);
STRING_LITERAL(TMP5186, ".<br>", 5);
STRING_LITERAL(TMP5187, "<p />", 5);
STRING_LITERAL(TMP5188, "Modules: ", 9);
STRING_LITERAL(TMP5189, ".html\">", 7);
STRING_LITERAL(TMP5190, "<h2>Documentation files</h2>\012", 29);
STRING_LITERAL(TMP5194, "<ul>\012", 5);
STRING_LITERAL(TMP5195, "<ul>", 4);
STRING_LITERAL(TMP5196, "</ul>", 5);
STRING_LITERAL(TMP5197, "<li><a href=\"", 13);
STRING_LITERAL(TMP5198, "</a>\012", 5);
STRING_LITERAL(TMP5199, "</ul>\012", 6);
STRING_LITERAL(TMP5200, "<ul><li><a href=\"", 17);
STRING_LITERAL(TMP5201, "<h2>API symbols</h2>\012", 21);
STRING_LITERAL(TMP5202, "<dt><a name=\"$2\" href=\"#$2\"><span>$1:</span></a></dt><ul class="
"\"simple\"><dd>\012", 77);
STRING_LITERAL(TMP5203, "<li><a class=\"reference external\"\012          title=\"$3\" href=\"$1"
"\">$2</a></li>\012          ", 87);
STRING_LITERAL(TMP5204, "<li><a class=\"reference external\" href=\"$1\">$2</a></li>\012       "
"   ", 66);
STRING_LITERAL(TMP5205, "</ul></dd>\012", 11);
...
N_NIMCALL(NimStringDesc*, quoteindexcolumn_347835)(NimStringDesc* text) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = nsuReplaceStr(text, ((NimStringDesc*) &TMP2207), ((NimStringDesc*) &TMP2208));
	LOC2 = 0;
	LOC2 = nsuReplaceStr(LOC1, ((NimStringDesc*) &TMP2209), ((NimStringDesc*) &TMP2210));
	result = nsuReplaceStr(LOC2, ((NimStringDesc*) &TMP2211), ((NimStringDesc*) &TMP2212));
	return result;
}
...
N_NIMCALL(void, setindexterm_347855)(Rstgenerator347016* d, NimStringDesc* id, NimStringDesc* term, NimStringDesc* linktitle, NimStringDesc* linkdesc) {
	...
	htmlfile = noschangeFileExt(LOC1, ((NimStringDesc*) &TMP2206));
...
appendString(entry, ((NimStringDesc*) &TMP2209));
	{
...
N_NIMCALL(void, renderheadline_353861)(Rstgenerator347016* d, Rstnode332011* n, NimStringDesc** result) {
	...
	NimStringDesc* LOC26;
	NimStringDesc* LOC27;
	tmp = copyString(((NimStringDesc*) &TMP2200));
	{
		NI i_353880;
		NI HEX3Atmp_354006;
		NI LOC2;
	...
	sectionprefix = copyString(((NimStringDesc*) &TMP2200));
	{
		NI i_353894;
		NI HEX3Atmp_354014;
		NI res_354017;
...
appendString(LOC12, ((NimStringDesc*) &TMP2202));
					sectionprefix = LOC12;
					goto LA5;
				}
				LA10: ;
...
appendString(LOC14, LOC15);
	refname = LOC14;
	{
		...
		dispa_347689((*d).target, result, ((NimStringDesc*) &TMP2203), ((NimStringDesc*) &TMP2204), LOC22, 4);
	}
	goto LA16;
	LA18: ;
	{
		...
		dispa_347689((*d).target, result, ((NimStringDesc*) &TMP2205), ((NimStringDesc*) &TMP2204), LOC24, 4);
	}
	LA16: ;
	LOC25 = 0;
...
appendString(LOC26, tmp);
	setindexterm_347855(d, refname, LOC25, LOC26, ((NimStringDesc*) &TMP2200));
}
...
N_NIMCALL(void, renderoverline_354045)(Rstgenerator347016* d, Rstnode332011* n, NimStringDesc** result) {
	...
	LA10: ;
	{
		...
		dispa_347689((*d).target, result, ((NimStringDesc*) &TMP2213), ((NimStringDesc*) &TMP2214), LOC21, 4);
	}
	LA1: ;
}
...
appendString((*dest), ((NimStringDesc*) &TMP2233));
	}
	break;
	case 60:
	{
		(*dest) = resizeString((*dest), 4);
appendString((*dest), ((NimStringDesc*) &TMP2234));
	}
	break;
	case 62:
	{
		...
		j = ((NI) 0);
		{
			while (1) {
				...
				k = nextsplitpoint_347506(s, j);
				{
					NIM_BOOL LOC9;
					LOC9 = 0;
					LOC9 = !(eqStrings(splitter_347489, ((NimStringDesc*) &TMP2232)));
					if (LOC9) goto LA10;
...
N_NIMCALL(void, renderfield_355717)(Rstgenerator347016* d, Rstnode332011* n, NimStringDesc** result) {
	...
	b = NIM_FALSE;
	{
		...
		LOC6 = 0;
		LOC6 = nsuStrip(LOC5, NIM_TRUE, NIM_TRUE, TMP2251);
		fieldval = esc_347553((*d).target, LOC6, ((NI) -1));
		{
			...
			LOC9 = 0;
			LOC10 = 0;
			LOC10 = nsuCmpIgnoreStyle(fieldname, ((NimStringDesc*) &TMP2252));
			LOC9 = (LOC10 == ((NI) 0));
			if (LOC9) goto LA11;
			LOC12 = 0;
			LOC12 = nsuCmpIgnoreStyle(fieldname, ((NimStringDesc*) &TMP2253));
			LOC9 = (LOC12 == ((NI) 0));
			LA11: ;
			if (!LOC9) goto LA13;
			{
		...
		LA13: ;
		{
			NI LOC20;
			LOC20 = 0;
			LOC20 = nsuCmpIgnoreStyle(fieldname, ((NimStringDesc*) &TMP2254));
	...
	{
		if (!!(b)) goto LA29;
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2255), ((NimStringDesc*) &TMP2256), result);
	}
	LA29: ;
}
...
appendString(result, ((NimStringDesc*) &TMP2277));
				res_355698 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NIMCALL(void, renderimage_354213)(Rstgenerator347016* d, Rstnode332011* n, NimStringDesc** result) {
	...
	NimStringDesc* s;
	NimStringDesc* arg;
	options = copyString(((NimStringDesc*) &TMP2200));
	s = getfieldvalue_333079(n, ((NimStringDesc*) &TMP2292));
	{
		NIM_BOOL LOC3;
		TY192421 LOC7;
		LOC3 = 0;
		...
		if (!(LOC3)) goto LA4;
		LOC3 = allcharsinset_104130(s, TMP2293);
		LA4: ;
		if (!LOC3) goto LA5;
		memset((void*)LOC7, 0, sizeof(LOC7));
		LOC7[0] = nsuStrip(s, NIM_TRUE, NIM_TRUE, TMP2251);
		dispa_347689((*d).target, (&options), ((NimStringDesc*) &TMP2294), ((NimStringDesc*) &TMP2295), LOC7, 1);
	}
	LA5: ;
	s = getfieldvalue_333079(n, ((NimStringDesc*) &TMP2296));
	{
		...
		if (!(LOC10)) goto LA11;
		LOC10 = allcharsinset_104130(s, TMP2293);
		LA11: ;
		if (!LOC10) goto LA12;
		memset((void*)LOC14, 0, sizeof(LOC14));
		LOC14[0] = nsuStrip(s, NIM_TRUE, NIM_TRUE, TMP2251);
		dispa_347689((*d).target, (&options), ((NimStringDesc*) &TMP2297), ((NimStringDesc*) &TMP2298), LOC14, 1);
	}
	LA12: ;
	s = getfieldvalue_333079(n, ((NimStringDesc*) &TMP2299));
	{
		NIM_BOOL LOC17;
		TY192421 LOC21;
		LOC17 = 0;
		...
		if (!(LOC17)) goto LA18;
		LOC17 = allcharsinset_104130(s, TMP2293);
		LA18: ;
		if (!LOC17) goto LA19;
		memset((void*)LOC21, 0, sizeof(LOC21));
		LOC21[0] = nsuStrip(s, NIM_TRUE, NIM_TRUE, TMP2251);
		dispa_347689((*d).target, (&options), ((NimStringDesc*) &TMP2300), ((NimStringDesc*) &TMP2301), LOC21, 1);
	}
	LA19: ;
	s = getfieldvalue_333079(n, ((NimStringDesc*) &TMP2302));
	{
		NIM_BOOL LOC24;
		TY192421 LOC28;
		LOC24 = 0;
		...
		if (!(LOC24)) goto LA25;
		LOC24 = allcharsinset_104130(s, TMP2293);
		LA25: ;
		if (!LOC24) goto LA26;
		memset((void*)LOC28, 0, sizeof(LOC28));
		LOC28[0] = nsuStrip(s, NIM_TRUE, NIM_TRUE, TMP2251);
		dispa_347689((*d).target, (&options), ((NimStringDesc*) &TMP2303), ((NimStringDesc*) &TMP2200), LOC28, 1);
	}
	LA26: ;
	s = getfieldvalue_333079(n, ((NimStringDesc*) &TMP2304));
	{
		NIM_BOOL LOC31;
		TY192421 LOC35;
		LOC31 = 0;
		...
		if (!(LOC31)) goto LA32;
		LOC31 = allcharsinset_104130(s, TMP2293);
		LA32: ;
		if (!LOC31) goto LA33;
		memset((void*)LOC35, 0, sizeof(LOC35));
		LOC35[0] = nsuStrip(s, NIM_TRUE, NIM_TRUE, TMP2251);
		dispa_347689((*d).target, (&options), ((NimStringDesc*) &TMP2305), ((NimStringDesc*) &TMP2200), LOC35, 1);
	}
	LA33: ;
	{
		TY192421 LOC40;
		...
		options = dispf_347666((*d).target, ((NimStringDesc*) &TMP2256), ((NimStringDesc*) &TMP2306), LOC40, 1);
	}
	LA38: ;
	arg = getargument_333086(n);
	{
		...
		if (!(LOC43)) goto LA44;
		LOC43 = allcharsinset_104130(arg, TMP2293);
		LA44: ;
		if (!LOC43) goto LA45;
		memset((void*)LOC47, 0, sizeof(LOC47));
		LOC47[0] = copyString(arg);
		LOC47[1] = copyString(options);
		dispa_347689((*d).target, result, ((NimStringDesc*) &TMP2307), ((NimStringDesc*) &TMP2308), LOC47, 2);
	}
	LA45: ;
	{
		NI LOC50;
...
N_NIMCALL(void, init_347086)(Codeblockparams347020* p) {
	(*p).startline = ((NI) 1);
	(*p).lang = ((NU8) 0);
	unsureAsgnRef((void**) (&(*p).langstr), copyString(((NimStringDesc*) &TMP2200)));
}
...
N_NIMCALL(void, parsecodeblockfield_354493)(Rstgenerator347016* d, Rstnode332011* n, Codeblockparams347020* params) {
	...
	if (eqStrings(LOC2, ((NimStringDesc*) &TMP2309))) goto LA3;
	if (eqStrings(LOC2, ((NimStringDesc*) &TMP2310))) goto LA4;
	if (eqStrings(LOC2, ((NimStringDesc*) &TMP2311))) goto LA5;
	goto LA6;
	LA3: ;
	{
		NI number;
	...
	LA5: ;
	{
		...
		unsureAsgnRef((void**) (&(*params).langstr), nsuStrip(LOC17, NIM_TRUE, NIM_TRUE, TMP2251));
...
{	init_347086(Result);
	...
	unsureAsgnRef((void**) (&(*Result).langstr), nsuStrip(LOC12, NIM_TRUE, NIM_TRUE, TMP2251));
	{
...
{	(*d).listingcounter += ((NI) 1);
	id = nimIntToStr((*d).listingcounter);
	{
		...
		LOC5 = 0;
		LOC5 = getordefault_147020((*d).config, ((NimStringDesc*) &TMP2320));
		unsureAsgnRef((void**) (&(*Result).Field0), nsuFormatSingleElem(LOC5, id));
		LOC6 = 0;
		LOC6 = getordefault_147020((*d).config, ((NimStringDesc*) &TMP2321));
		unsureAsgnRef((void**) (&(*Result).Field1), nsuFormatSingleElem(LOC6, id));
		goto BeforeRet;
	}
	LA3: ;
	LOC7 = 0;
	LOC7 = nsuStrip(code, NIM_TRUE, NIM_TRUE, TMP2251);
	LOC8 = 0;
	LOC8 = nsuCountLines(LOC7);
	codelines = (NI)(((NI) 1) + LOC8);
	unsureAsgnRef((void**) (&(*Result).Field0), copyString(((NimStringDesc*) &TMP2322)));
...
appendString(LOC11, ((NimStringDesc*) &TMP2209));
...
{	{
	...
	dispa_347689((*d).target, result, blockstart, ((NimStringDesc*) &TMP2326), LOC6, 0);
	{
...
appendString((*result), LOC23);
				...
				default:
				{
					...
					dispa_347689((*d).target, result, ((NimStringDesc*) &TMP2488), ((NimStringDesc*) &TMP2489), LOC25, 2);
				}
				break;
				}
			}
	...
	dispa_347689((*d).target, result, blockend, ((NimStringDesc*) &TMP2523), LOC27, 0);
	}BeforeRet: ;
}
...
N_NIMCALL(void, rendercontainer_355658)(Rstgenerator347016* d, Rstnode332011* n, NimStringDesc** result) {
	...
	LOC1 = 0;
	LOC1 = getargument_333086(n);
	arg = nsuStrip(LOC1, NIM_TRUE, NIM_TRUE, TMP2251);
	{
		TY192421 LOC6;
		if (!((arg) && (arg)->Sup.len == 0)) goto LA4;
		memset((void*)LOC6, 0, sizeof(LOC6));
		LOC6[0] = copyString(tmp);
		dispa_347689((*d).target, result, ((NimStringDesc*) &TMP2524), ((NimStringDesc*) &TMP2256), LOC6, 1);
	}
	goto LA2;
	LA4: ;
	{
		...
		dispa_347689((*d).target, result, ((NimStringDesc*) &TMP2525), ((NimStringDesc*) &TMP2526), LOC8, 2);
	}
	LA2: ;
}
...
appendString(LOC8, LOC10);
	id = LOC8;
	term = copyString(((NimStringDesc*) &TMP2200));
	renderaux_347734(d, n, (&term));
	setindexterm_347855(d, id, term, (*d).currentsection, ((NimStringDesc*) &TMP2200));
	memset((void*)LOC11, 0, sizeof(LOC11));
	LOC11[0] = copyString(id);
	LOC11[1] = copyString(term);
	dispa_347689((*d).target, result, ((NimStringDesc*) &TMP2540), ((NimStringDesc*) &TMP2541), LOC11, 2);
}
...
N_NIMCALL(void, rendersmiley_354479)(Rstgenerator347016* d, Rstnode332011* n, NimStringDesc** result) {
	...
	LOC2 = 0;
	LOC2 = getordefault_147020((*d).config, ((NimStringDesc*) &TMP2546));
	LOC1[0] = nsuFormatSingleElem(LOC2, (*n).text);
	dispa_347689((*d).target, result, ((NimStringDesc*) &TMP2544), ((NimStringDesc*) &TMP2545), LOC1, 1);
}
...
{	{
	...
	case ((NU8) 3):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2215), ((NimStringDesc*) &TMP2216), result);
	}
	break;
	case ((NU8) 4):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2217), ((NimStringDesc*) &TMP2218), result);
	}
	break;
	case ((NU8) 5):
	{
	...
	case ((NU8) 13):
	{
		...
		}
		{
			...
			dispa_347689((*d).target, result, ((NimStringDesc*) &TMP2231), ((NimStringDesc*) &TMP2226), LOC26, 1);
		}
		LA24: ;
	}
	break;
	...
	case ((NU8) 15):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2257), ((NimStringDesc*) &TMP2258), result);
	}
	break;
	case ((NU8) 16):
	{
	...
	case ((NU8) 23):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2265), ((NimStringDesc*) &TMP2260), result);
	}
	break;
	case ((NU8) 20):
	case ((NU8) 21):
	...
	{
		{
			...
			raiseassert_91171(((NimStringDesc*) &TMP2267));
		}
		LA38: ;
	}
	break;
	case ((NU8) 24):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2268), ((NimStringDesc*) &TMP2269), result);
	}
	break;
	case ((NU8) 25):
	{
	...
	case ((NU8) 26):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2270), ((NimStringDesc*) &TMP2218), result);
	}
	break;
	case ((NU8) 27):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2271), ((NimStringDesc*) &TMP2272), result);
	}
	break;
	case ((NU8) 28):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2273), ((NimStringDesc*) &TMP2274), result);
	}
	break;
	case ((NU8) 29):
	case ((NU8) 30):
...
appendString(LOC50, ((NimStringDesc*) &TMP2276));
appendString(LOC50, LOC51);
appendString(LOC50, ((NimStringDesc*) &TMP2278));
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2275), LOC50, result);
	}
	break;
	case ((NU8) 31):
	{
...
appendString((*result), ((NimStringDesc*) &TMP2282));
	...
	case ((NU8) 33):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2259), ((NimStringDesc*) &TMP2256), result);
	}
	break;
	case ((NU8) 32):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2283), ((NimStringDesc*) &TMP2284), result);
	}
	break;
	case ((NU8) 34):
	{
	...
	case ((NU8) 39):
	{
		...
		dispa_347689((*d).target, result, ((NimStringDesc*) &TMP2285), ((NimStringDesc*) &TMP2286), LOC85, 2);
	}
	break;
	case ((NU8) 37):
	{
	...
	case ((NU8) 38):
	{
		...
		NimStringDesc* tmp1;
		TY193306 LOC88;
		tmp0 = copyString(((NimStringDesc*) &TMP2200));
		tmp1 = copyString(((NimStringDesc*) &TMP2200));
		...
		dispa_347689((*d).target, result, ((NimStringDesc*) &TMP2289), ((NimStringDesc*) &TMP2290), LOC88, 2);
	}
	break;
	case ((NU8) 41):
	case ((NU8) 42):
...
appendString((*result), LOC103);
	...
	case ((NU8) 52):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2527), ((NimStringDesc*) &TMP2527), result);
	}
	break;
	case ((NU8) 40):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2200), ((NimStringDesc*) &TMP2200), result);
	}
	break;
	case ((NU8) 53):
	{
		...
		dispa_347689((*d).target, result, ((NimStringDesc*) &TMP2488), ((NimStringDesc*) &TMP2489), LOC110, 2);
	}
	break;
	case ((NU8) 54):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2528), ((NimStringDesc*) &TMP2529), result);
	}
	break;
	case ((NU8) 55):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2530), ((NimStringDesc*) &TMP2531), result);
	}
	break;
	case ((NU8) 57):
	{
	...
	case ((NU8) 58):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2534), ((NimStringDesc*) &TMP2284), result);
	}
	break;
	case ((NU8) 59):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2535), ((NimStringDesc*) &TMP2536), result);
	}
	break;
	case ((NU8) 60):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2537), ((NimStringDesc*) &TMP2533), result);
	}
	break;
	case ((NU8) 56):
	{
	...
	case ((NU8) 61):
	{
		renderaux_347776(d, n, ((NimStringDesc*) &TMP2542), ((NimStringDesc*) &TMP2543), result);
	}
	break;
	case ((NU8) 63):
	{
...
appendString((*result), LOC121);
	...
	case ((NU8) 43):
	{
		unsureAsgnRef((void**) (&(*d).meta[(((NU8) 1))- 0]), copyString(((NimStringDesc*) &TMP2200)));
...
N_NIMCALL(void, initrstgenerator_347096)(Rstgenerator347016* g, NU8 target, Stringtableobj146212* config, NimStringDesc* filename, NU8 options, Findfilehandler333023 findfile, Msghandler333021 msghandler) {
	...
	(*g).splitafter = ((NI) 20);
	unsureAsgnRef((void**) (&(*g).theindex), copyString(((NimStringDesc*) &TMP2200)));
	(*g).options = options;
	(*g).findfile = findfile;
	unsureAsgnRef((void**) (&(*g).currentsection), copyString(((NimStringDesc*) &TMP2200)));
	...
	{
		NimStringDesc* LOC5;
		if (!eqStrings(fileparts.Field2, ((NimStringDesc*) &TMP5016))) goto LA3;
		LOC5 = 0;
		LOC5 = rawNewString(fileparts.Field1->Sup.len + 7);
appendString(LOC5, ((NimStringDesc*) &TMP5017));
appendString(LOC5, fileparts.Field1);
	...
	s = getordefault_147020(config, ((NimStringDesc*) &TMP5018));
	{
	...
	LA8: ;
	{
		...
		res_347427 = ((NI) 0);
		{
			while (1) {
				...
				unsureAsgnRef((void**) (&(*g).meta[(i_347423)- 0]), copyString(((NimStringDesc*) &TMP2200)));
				res_347427 += ((NI) 1);
			} LA12: ;
		}
	}
...
N_NIMCALL(void, rendertocentry_354162)(Rstgenerator347016* d, Tocentry347012 e, NimStringDesc** result) {
	...
	dispa_347689((*d).target, result, ((NimStringDesc*) &TMP5097), ((NimStringDesc*) &TMP5098), LOC1, 2);
}
...
N_NIMCALL(void, rendertocentries_354176)(Rstgenerator347016* d, NI* j, NI lvl, NimStringDesc** result) {
	...
	} LA1: ;
	{
		...
		dispa_347689((*d).target, result, ((NimStringDesc*) &TMP5099), ((NimStringDesc*) &TMP5100), LOC15, 1);
	}
	goto LA11;
	LA13: ;
	{
...
N_NIMCALL(void, writeindexfile_347445)(Rstgenerator347016* g, NimStringDesc* outfile) {
	{
		...
		writefile_17075(outfile, (*g).theindex);
	}
	LA3: ;
}
N_NIMCALL(void, TMP5169)(void* p, NI op) {
...
N_NIMCALL(NimStringDesc*, unquoteindexcolumn_347845)(NimStringDesc* text) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = nsuReplaceStr(text, ((NimStringDesc*) &TMP2212), ((NimStringDesc*) &TMP2211));
	LOC2 = 0;
	LOC2 = nsuReplaceStr(LOC1, ((NimStringDesc*) &TMP2210), ((NimStringDesc*) &TMP2209));
	result = nsuReplaceStr(LOC2, ((NimStringDesc*) &TMP2208), ((NimStringDesc*) &TMP2207));
	return result;
}
...
N_NIMCALL(NI, hash_348447)(Indexentry348397 x) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = hash_143848(x.keyword);
	LOC2 = 0;
	LOC2 = hash_143848(x.link);
	result = HEX21HEX26_143013(LOC1, LOC2);
	LOC3 = 0;
	LOC3 = or_347713(x.linktitle, ((NimStringDesc*) &TMP2200));
	LOC4 = 0;
	LOC4 = hash_143848(LOC3);
	result = HEX21HEX26_143013(result, LOC4);
	LOC5 = 0;
	LOC5 = or_347713(x.linkdesc, ((NimStringDesc*) &TMP2200));
	LOC6 = 0;
	LOC6 = hash_143848(LOC5);
	result = HEX21HEX26_143013(result, LOC6);
	result = HEX21HEX24_143042(result);
	return result;
}
...
N_NIMCALL(void, readindexdir_351501)(NimStringDesc* dir, TY351504* Result) {
	NI L;
	TY352105 LOC169;
	unsureAsgnRef((void**) (&(*Result).Field0), (TY131608*) newSeq((&NTI131608), 0));
				...
				while (1) {
					{
						...
						y_353498 = cstrToNimstr(((NCSTRING) ((*x_353496).d_name)));
						{
							...
							NU8 k_353502;
							LOC15 = 0;
							LOC15 = !(eqStrings(y_353498, ((NimStringDesc*) &TMP5171)));
							if (!(LOC15)) goto LA16;
							LOC15 = !(eqStrings(y_353498, ((NimStringDesc*) &TMP5172)));
							LA16: ;
							if (!LOC15) goto LA17;
							memset((void*)(&s_353500), 0, sizeof(s_353500));
							{
								if (!NIM_TRUE) goto LA21;
								y_353498 = HEX2F_124681(dir, y_353498);
							}
							LA21: ;
							k_353502 = ((NU8) 0);
							{
								...
								LA29: ;
								{
									if (!((*x_353496).d_type == ((NI8) 10))) goto LA33;
									{
										NIM_BOOL LOC37;
										LOC37 = 0;
										LOC37 = direxists_128220(y_353498);
										if (!LOC37) goto LA38;
										k_353502 = ((NU8) 3);
									}
									goto LA35;
								...
								path_351637 = y_353498;
								{
									...
									if (!(LOC43)) goto LA44;
									LOC43 = nsuEndsWith(path_351637, ((NimStringDesc*) &TMP5173));
									LA44: ;
									if (!LOC43) goto LA45;
									fileentries = 0;
									...
									fileentries = (TY351507*) setLengthSeq(&(fileentries)->Sup, sizeof(Indexentry348397), ((NI) 0));
									{
										...
										line_351672 = 0;
										f_353478 = open_17017(path_351637, ((NU8) 0), ((NI) 8000));
										res_353480 = rawNewString(((NI) 80));
										{
											while (1) {
												NIM_BOOL LOC50;
												LOC50 = 0;
												LOC50 = readline_17119(f_353478, (&res_353480));
												if (!LOC50) goto LA49;
									...
									}
									{
										...
										(*Result).Field0 = (TY131608*) incrSeqV2(&((*Result).Field0)->Sup, sizeof(NimStringDesc*));
										LOC92 = 0;
...
appendString(LOC94, ((NimStringDesc*) &TMP5174));
appendString(LOC94, LOC96);
							...
							path_351637 = y_353498;
							{
								...
								LOC114 = nsuEndsWith(path_351637, ((NimStringDesc*) &TMP5173));
								LA115: ;
								...
								fileentries_353504 = (TY351507*) setLengthSeq(&(fileentries_353504)->Sup, sizeof(Indexentry348397), ((NI) 0));
								{
									...
									line_353510 = 0;
									f_353512 = open_17017(path_351637, ((NU8) 0), ((NI) 8000));
									res_353514 = rawNewString(((NI) 80));
									{
										while (1) {
											NIM_BOOL LOC121;
											LOC121 = 0;
											LOC121 = readline_17119(f_353512, (&res_353514));
...
appendString(LOC165, ((NimStringDesc*) &TMP5174));
appendString(LOC165, LOC167);
	...
	LOC169.ClPrc = ((TMP5177) (cmp_6577)); LOC169.ClEnv = NIM_NIL;
...
N_NIMCALL(NimStringDesc*, generatedocumentationjumps_350796)(Table348410 docs) {
	...
	NimStringDesc* LOC21;
	result_350799 = 0;
	result_350799 = copyString(((NimStringDesc*) &TMP5178));
	...
	memset((void*)(&LOC14), 0, sizeof(LOC14));
	LOC14.ClPrc = ((TMP5181) (cmp_348436)); LOC14.ClEnv = NIM_NIL;
	sort_350020(titles->data, titles->Sup.len, LOC14, ((NU8) 1));
	chunks = (TY131608*) newSeq((&NTI131608), 0);
	{
...
appendString(LOC18, ((NimStringDesc*) &TMP5182));
appendString(LOC18, title_351377.link);
appendString(LOC18, ((NimStringDesc*) &TMP5183));
appendString(LOC18, title_351377.keyword);
appendString(LOC18, ((NimStringDesc*) &TMP5184));
				chunks = (TY131608*) incrSeqV2(&(chunks)->Sup, sizeof(NimStringDesc*));
				LOC19 = 0;
	...
	LOC20 = 0;
	LOC21 = 0;
	LOC21 = nsuJoinSep(chunks->data, chunks->Sup.len, ((NimStringDesc*) &TMP5185));
	LOC20 = rawNewString(LOC21->Sup.len + 5);
appendString(LOC20, LOC21);
appendString(LOC20, ((NimStringDesc*) &TMP5186));
...
N_NIMCALL(NimStringDesc*, generatemodulejumps_351436)(TY131608* modules) {
	...
	NimStringDesc* LOC7;
	result = 0;
	result = copyString(((NimStringDesc*) &TMP5188));
	chunks = (TY131608*) newSeq((&NTI131608), 0);
	{
...
appendString(LOC4, ((NimStringDesc*) &TMP5182));
appendString(LOC4, name_351468);
appendString(LOC4, ((NimStringDesc*) &TMP5189));
appendString(LOC4, name_351468);
appendString(LOC4, ((NimStringDesc*) &TMP5184));
				chunks = (TY131608*) incrSeqV2(&(chunks)->Sup, sizeof(NimStringDesc*));
				LOC5 = 0;
	...
	LOC6 = 0;
	LOC7 = 0;
	LOC7 = nsuJoinSep(chunks->data, chunks->Sup.len, ((NimStringDesc*) &TMP5185));
	LOC6 = rawNewString(LOC7->Sup.len + 5);
appendString(LOC6, LOC7);
appendString(LOC6, ((NimStringDesc*) &TMP5186));
...
N_NIMCALL(void, striptoclevel_348989)(NimStringDesc* s, TY349075* Result) {
	...
	LOC8 = HEX2EHEX2E_106290((*Result).Field0, ((s ? s->Sup.len : 0) - 1));
	unsureAsgnRef((void**) (&(*Result).Field1), HEX5BHEX5D_90560(s, LOC8));
}
...
{	result = 0;
	...
	LA3: ;
	{
		...
		result = nsuRepeatStr(((NimStringDesc*) &TMP5195), ((NI) ((NI)(newlevel - (*level)))));
	}
	goto LA5;
	LA7: ;
	{
		result = nsuRepeatStr(((NimStringDesc*) &TMP5196), ((NI) ((NI)((*level) - newlevel))));
	}
	LA5: ;
	(*level) = newlevel;
	}BeforeRet: ;
...
appendString(LOC22, ((NimStringDesc*) &TMP5197));
appendString(LOC22, link);
appendString(LOC22, ((NimStringDesc*) &TMP5183));
appendString(LOC22, levels->data[L].Field1);
appendString(LOC22, ((NimStringDesc*) &TMP5198));
...
appendString(LOC23, ((NimStringDesc*) &TMP5199));
	result = resizeString(result, LOC23->Sup.len + 0);
appendString(result, LOC23);
	return result;
}
...
N_NIMCALL(NimStringDesc*, generatedocumentationindex_349431)(Table348410 docs) {
	...
	TY350027 LOC14;
	result_349434 = 0;
	result_349434 = copyString(((NimStringDesc*) &TMP2200));
	...
	memset((void*)(&LOC14), 0, sizeof(LOC14));
	LOC14.ClPrc = ((TMP5191) (cmp_348436)); LOC14.ClEnv = NIM_NIL;
	sort_350020(titles->data, titles->Sup.len, LOC14, ((NU8) 1));
	{
...
appendString(LOC19, ((NimStringDesc*) &TMP5200));
appendString(LOC19, title_350681.link);
appendString(LOC19, ((NimStringDesc*) &TMP5183));
appendString(LOC19, title_350681.keyword);
appendString(LOC19, ((NimStringDesc*) &TMP5198));
appendString(LOC19, toclist);
appendString(LOC19, ((NimStringDesc*) &TMP5199));
...
N_NIMCALL(NimStringDesc*, generatesymbolindex_348903)(TY351507* symbols) {
	...
	i = ((NI) 0);
	{
		while (1) {
			...
			LOC3 = HEX2EHEX2E_106290(((NI) 1), (NI)((keyword ? (keyword->Sup.len-1) : -1) - ((NI) 1)));
			cleanedkeyword = HEX5BHEX5D_90560(keyword, LOC3);
			memset((void*)LOC4, 0, sizeof(LOC4));
			LOC4[0] = copyString(keyword);
			LOC4[1] = copyString(cleanedkeyword);
			nsuAddf((&result), ((NimStringDesc*) &TMP5202), LOC4, 2);
			j = i;
			{
				while (1) {
					NIM_BOOL LOC7;
					...
					LA16: ;
					{
						desc = copyString(((NimStringDesc*) &TMP2200));
					}
					LA14: ;
					{
						TY193293 LOC23;
						...
						nsuAddf((&result), ((NimStringDesc*) &TMP5203), LOC23, 3);
					}
					goto LA19;
					LA21: ;
					{
						...
						nsuAddf((&result), ((NimStringDesc*) &TMP5204), LOC25, 2);
					}
					LA19: ;
					j += ((NI) 1);
				} LA6: ;
...
N_NIMCALL(NimStringDesc*, mergeindexes_353594)(NimStringDesc* dir) {
	...
	modules = 0;
	genericSeqAssign((&modules), LOC1.Field0, (&NTI131608));
	symbols = 0;
...
appendString(result, ((NimStringDesc*) &TMP5201));
		LOC23 = 0;
...
NIM_EXTERNC N_NOINLINE(void, docutils_rstgenInit000)(void) {
	NimStringDesc* LOC1;
	LOC1 = 0;
	LOC1 = splitter_347489; splitter_347489 = copyStringRC1(((NimStringDesc*) &TMP977));
	if (LOC1) nimGCunrefNoCycle(LOC1);
}

NIM_EXTERNC N_NOINLINE(void, docutils_rstgenDatInit000)(void) {
static TNimNode* TMP5007[14];
static TNimNode* TMP5008[2];
NI TMP5010;
static char* NIM_CONST TMP5009[2] = {
"outHtml", 
"outLatex"};
static TNimNode* TMP5011[3];
static TNimNode* TMP5168[4];
static TNimNode* TMP5192[2];
...
NTI347010.base = 0;
NTI347010.flags = 3;
for (TMP5010 = 0; TMP5010 < 2; TMP5010++) {
TMP969[TMP5010+2].kind = 1;
TMP969[TMP5010+2].offset = TMP5010;
TMP969[TMP5010+2].name = TMP5009[TMP5010];
TMP5008[TMP5010] = &TMP969[TMP5010+2];
}
TMP969[4].len = 2; TMP969[4].kind = 2; TMP969[4].sons = &TMP5008[0];
NTI347010.node = &TMP969[4];
TMP969[1].kind = 1;
TMP969[1].offset = offsetof(Rstgenerator347016, target);
TMP969[1].typ = (&NTI347010);
TMP969[1].name = "target";
TMP5007[1] = &TMP969[5];
TMP969[5].kind = 1;
TMP969[5].offset = offsetof(Rstgenerator347016, config);
TMP969[5].typ = (&NTI146214);
TMP969[5].name = "config";
TMP5007[2] = &TMP969[6];
TMP969[6].kind = 1;
TMP969[6].offset = offsetof(Rstgenerator347016, splitafter);
TMP969[6].typ = (&NTI108);
TMP969[6].name = "splitAfter";
TMP5007[3] = &TMP969[7];
TMP969[7].kind = 1;
TMP969[7].offset = offsetof(Rstgenerator347016, listingcounter);
TMP969[7].typ = (&NTI108);
...
TMP5011[0] = &TMP969[10];
TMP969[10].kind = 1;
TMP969[10].offset = offsetof(Tocentry347012, n);
TMP969[10].typ = (&NTI332007);
TMP969[10].name = "n";
TMP5011[1] = &TMP969[11];
TMP969[11].kind = 1;
TMP969[11].offset = offsetof(Tocentry347012, refname);
TMP969[11].typ = (&NTI149);
TMP969[11].name = "refname";
TMP5011[2] = &TMP969[12];
TMP969[12].kind = 1;
TMP969[12].offset = offsetof(Tocentry347012, header);
TMP969[12].typ = (&NTI149);
TMP969[12].name = "header";
TMP969[9].len = 3; TMP969[9].kind = 2; TMP969[9].sons = &TMP5011[0];
NTI347012.node = &TMP969[9];
NTI347035.size = sizeof(TY347035*);
NTI347035.kind = 24;
NTI347035.base = (&NTI347012);
NTI347035.flags = 2;
NTI347035.marker = TMP5012;
TMP969[8].kind = 1;
TMP969[8].offset = offsetof(Rstgenerator347016, tocpart);
TMP969[8].typ = (&NTI347035);
TMP969[8].name = "tocPart";
TMP5007[5] = &TMP969[13];
TMP969[13].kind = 1;
TMP969[13].offset = offsetof(Rstgenerator347016, hastoc);
TMP969[13].typ = (&NTI138);
TMP969[13].name = "hasToc";
TMP5007[6] = &TMP969[14];
TMP969[14].kind = 1;
TMP969[14].offset = offsetof(Rstgenerator347016, theindex);
TMP969[14].typ = (&NTI149);
TMP969[14].name = "theIndex";
TMP5007[7] = &TMP969[15];
TMP969[15].kind = 1;
TMP969[15].offset = offsetof(Rstgenerator347016, options);
TMP969[15].typ = (&NTI333015);
TMP969[15].name = "options";
TMP5007[8] = &TMP969[16];
TMP969[16].kind = 1;
TMP969[16].offset = offsetof(Rstgenerator347016, findfile);
TMP969[16].typ = (&NTI333023);
TMP969[16].name = "findFile";
TMP5007[9] = &TMP969[17];
TMP969[17].kind = 1;
TMP969[17].offset = offsetof(Rstgenerator347016, msghandler);
TMP969[17].typ = (&NTI333021);
TMP969[17].name = "msgHandler";
TMP5007[10] = &TMP969[18];
TMP969[18].kind = 1;
TMP969[18].offset = offsetof(Rstgenerator347016, filename);
TMP969[18].typ = (&NTI149);
TMP969[18].name = "filename";
TMP5007[11] = &TMP969[19];
NTI347045.size = sizeof(TY347045);
NTI347045.kind = 16;
NTI347045.base = (&NTI149);
NTI347045.flags = 2;
TMP969[19].kind = 1;
TMP969[19].offset = offsetof(Rstgenerator347016, meta);
TMP969[19].typ = (&NTI347045);
TMP969[19].name = "meta";
TMP5007[12] = &TMP969[20];
TMP969[20].kind = 1;
TMP969[20].offset = offsetof(Rstgenerator347016, currentsection);
TMP969[20].typ = (&NTI149);
TMP969[20].name = "currentSection";
TMP5007[13] = &TMP969[21];
TMP969[21].kind = 1;
TMP969[21].offset = offsetof(Rstgenerator347016, seenindexterms);
TMP969[21].typ = (&NTI347053);
TMP969[21].name = "seenIndexTerms";
TMP969[0].len = 14; TMP969[0].kind = 2; TMP969[0].sons = &TMP5007[0];
NTI347016.node = &TMP969[0];
...
TMP5168[0] = &TMP969[23];
TMP969[23].kind = 1;
TMP969[23].offset = offsetof(Indexentry348397, keyword);
TMP969[23].typ = (&NTI149);
TMP969[23].name = "keyword";
TMP5168[1] = &TMP969[24];
TMP969[24].kind = 1;
TMP969[24].offset = offsetof(Indexentry348397, link);
TMP969[24].typ = (&NTI149);
TMP969[24].name = "link";
TMP5168[2] = &TMP969[25];
TMP969[25].kind = 1;
TMP969[25].offset = offsetof(Indexentry348397, linktitle);
TMP969[25].typ = (&NTI149);
TMP969[25].name = "linkTitle";
TMP5168[3] = &TMP969[26];
TMP969[26].kind = 1;
TMP969[26].offset = offsetof(Indexentry348397, linkdesc);
TMP969[26].typ = (&NTI149);
TMP969[26].name = "linkDesc";
TMP969[22].len = 4; TMP969[22].kind = 2; TMP969[22].sons = &TMP5168[0];
NTI348397.node = &TMP969[22];
NTI351507.size = sizeof(TY351507*);
NTI351507.kind = 24;
NTI351507.base = (&NTI348397);
NTI351507.flags = 2;
NTI351507.marker = TMP5169;
...
TMP5192[0] = &TMP969[28];
TMP969[28].kind = 1;
TMP969[28].offset = offsetof(TY349075, Field0);
TMP969[28].typ = (&NTI108);
TMP969[28].name = "Field0";
TMP5192[1] = &TMP969[29];
TMP969[29].kind = 1;
TMP969[29].offset = offsetof(TY349075, Field1);
TMP969[29].typ = (&NTI149);
TMP969[29].name = "Field1";
TMP969[27].len = 2; TMP969[27].kind = 2; TMP969[27].sons = &TMP5192[0];
NTI349075.node = &TMP969[27];
NTI349074.size = sizeof(TY349074*);
NTI349074.kind = 24;
NTI349074.base = (&NTI349075);
NTI349074.flags = 2;
NTI349074.marker = TMP5193;
}
