...
STRING_LITERAL(TMP3930, "N", 1);
STRING_LITERAL(TMP3931, "HEX", 3);
STRING_LITERAL(TMP3940, "metatype not eliminated", 23);
...
N_NIMCALL(NimStringDesc*, mangle_497847_2036603609)(NimStringDesc* name0) {
	...
	case 48 ... 57:
	{
		...
		LOC3 = rawNewString(2);
appendString(LOC3, ((NimStringDesc*) &TMP3930));
...
appendString(LOC5, ((NimStringDesc*) &TMP3931));
...
appendString(LOC15, ((NimStringDesc*) &TMP3931));
	...
	{
		{
			...
			internalerror_191100_155036129((*(*key0).sym).info, ((NimStringDesc*) &TMP3940));
		}
		goto LA12;
		LA14: ;
		{
			internalerror_191113_155036129(((NimStringDesc*) &TMP3940));
		}
		LA12: ;
	}
	break;
...
N_NIMCALL(NimStringDesc*, makesinglelinecstring_497835_2036603609)(NimStringDesc* s0) {
	NimStringDesc* result0;
	result0 = (NimStringDesc*)0;
	result0 = copyString(((NimStringDesc*) &TMP4036));
	{
