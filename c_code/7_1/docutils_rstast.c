...
static TNimNode* TMP2465[4];
static TNimNode* TMP2466[65];
NI TMP2468;
static char* NIM_CONST TMP2467[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI341005.base = 0;
NTI341005.flags = 3;
for (TMP2468 = 0; TMP2468 < 65; TMP2468++) {
TMP878[TMP2468+2].kind = 1;
TMP878[TMP2468+2].offset = TMP2468;
TMP878[TMP2468+2].name = TMP2467[TMP2468];
TMP2466[TMP2468] = &TMP878[TMP2468+2];
}
TMP878[67].len = 65; TMP878[67].kind = 2; TMP878[67].sons = &TMP2466[0];
NTI341005.node = &TMP878[67];
TMP878[1].kind = 1;
TMP878[1].offset = offsetof(trstnode341011, Kind);
TMP878[1].typ = (&NTI341005);
TMP878[1].name = "kind";
TMP2465[1] = &TMP878[68];
TMP878[68].kind = 1;
TMP878[68].offset = offsetof(trstnode341011, Text);
TMP878[68].typ = (&NTI149);
TMP878[68].name = "text";
TMP2465[2] = &TMP878[69];
TMP878[69].kind = 1;
TMP878[69].offset = offsetof(trstnode341011, Level);
...
NTI341009.flags = 2;
NTI341009.marker = TMP2469;
TMP878[70].kind = 1;
TMP878[70].offset = offsetof(trstnode341011, Sons);
TMP878[70].typ = (&NTI341009);
TMP878[70].name = "sons";
TMP878[0].len = 4; TMP878[0].kind = 2; TMP878[0].sons = &TMP2465[0];
NTI341011.node = &TMP878[0];
NTI341007.size = sizeof(trstnode341011*);
NTI341007.kind = 22;
NTI341007.base = (&NTI341011);
NTI341007.flags = 2;
NTI341007.marker = TMP2470;
}
