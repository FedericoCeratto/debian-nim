...
STRING_LITERAL(TMP4857, "server.type", 11);
STRING_LITERAL(TMP4858, "stdin", 5);
STRING_LITERAL(TMP4859, "tcp", 3);
STRING_LITERAL(TMP4861, "quit", 4);
STRING_LITERAL(TMP4865, "server.port", 11);
STRING_LITERAL(TMP4866, "server.address", 14);
STRING_LITERAL(TMP4874, "\015\012", 2);
STRING_LITERAL(TMP4875, "Invalid server.type:", 20);
...
N_NIMCALL(void, serve_610259)(TY610261 action) {
	NimStringDesc* typ;
	typ = getconfigvar_169350(((NimStringDesc*) &TMP4857));
	if (eqStrings(typ, ((NimStringDesc*) &TMP4858))) goto LA1;
	if (eqStrings(typ, ((NimStringDesc*) &TMP4859))) goto LA2;
	...
	{
		{
			while (1) {
				...
				{
					if (!eqStrings(line, ((NimStringDesc*) &TMP4861))) goto LA10;
					exit(0);
				}
				LA10: ;
				LOC12 = 0;
	...
	LA2: ;
	{
		...
		LA16: ;
		p = getconfigvar_169350(((NimStringDesc*) &TMP4865));
		{
			NI LOC23;
		...
		LA19: ;
		LOC25 = 0;
		LOC25 = getconfigvar_169350(((NimStringDesc*) &TMP4866));
		...
		stdoutsocket_196315 = (tsocketimpl182607*) newObjRC1((&NTI182609), sizeof(tsocketimpl182607));
		{
			while (1) {
				...
				gdirtyoriginalidx_169135 = ((NI32) 0);
				gerrorcounter_196303 = 0;
				send_193008(stdoutsocket_196315, ((NimStringDesc*) &TMP4874));
	...
	LA3: ;
	{
		printf("%s%s\012", (((NimStringDesc*) &TMP4875))->data, (typ)->data);
		exit(1);
	}
	LA4: ;
}
