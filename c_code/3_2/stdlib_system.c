...
TNimType NTI27620; /* array[0..7, int] */
...
N_NIMCALL(void, excl_47295)(Tcellset46559* s, Tcell46547* cell) {
	...
	Tpagedesc46555* t;
	u = ((NI) (cell));
	t = cellsetget_46723((&(*s)), (NI)((NU64)(u) >> (NU64)(((NI) 12))));
	{
		if (!!((t == NIM_NIL))) goto LA3;
						...
						j_66448 = ((NI) 0);
						{
							while (1) {
								if (!!((w_66446 == ((NI) 0)))) goto LA7;
								{
									...
									s_66410 = ((Tcell46547*) ((NI)((NI)((NU64)((*r_66442).key) << (NU64)(((NI) 12))) | (NI)((NU64)((NI)((NU64)((NI)((NU64)(i_66444) << (NU64)(((NI) 6)))) + (NU64)(j_66448))) * (NU64)(((NI) 8))))));
									tabsize += ((NI) 1);
									{
										NIM_BOOL LOC14;
										LOC14 = 0;
						...
						j_69214 = ((NI) 0);
						{
							while (1) {
								if (!!((w_69212 == ((NI) 0)))) goto LA10;
								{
									...
									s_69001 = ((Tcell46547*) ((NI)((NI)((NU64)((*r_69208).key) << (NU64)(((NI) 12))) | (NI)((NU64)((NI)((NU64)((NI)((NU64)(i_69210) << (NU64)(((NI) 6)))) + (NU64)(j_69214))) * (NU64)(((NI) 8))))));
									scan_66004(s_69001);
								}
								LA13: ;
								j_69214 += ((NI) 1);
		...
		if (!(newlen < (*result).len)) goto LA8;
		{
			...
			res_77291 = newlen;
			{
				while (1) {
					...
					forallchildrenaux_50425(((void*) ((NI)((NU64)((NI)((NU64)(((NI) (result))) + (NU64)(((NI) 16)))) + (NU64)((NI)((NU64)(i_77211) * (NU64)(elemsize)))))), (*LOC13).base, ((NU8) 2));
					res_77291 += ((NI) 1);
				} LA12: ;
			}
		}
	...
	{
		{
			...
			res_81690 = ((NI) 0);
			{
				while (1) {
					...
					i_81673 = res_81690;
					objectInit(((void*) ((NI)((NU64)(d) + (NU64)((NI)(i_81673 * (*(*typ).base).size))))), (*typ).base);
					res_81690 += ((NI) 1);
				} LA6: ;
			}
		}
