...
N_NIMCALL(NIM_BOOL, readlinefromstdin_212447)(NimStringDesc* prompt, NimStringDesc** line) {
	...
	{
		if (!!(result)) goto LA3;
		write_12865(stdout, ((NimStringDesc*) &TMP1031));
		exit(0);
	}
	LA3: ;
	return result;
...
static N_INLINE(NIM_BOOL, continueline_212666)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = LOC2;
	if (LOC1) goto LA4;
	LOC1 = endswith_212604(line, TMP1034);
	LA4: ;
	result = LOC1;
	return result;
}
...
N_NIMCALL(NIM_BOOL, endswithopr_212656)(NimStringDesc* x) {
	NIM_BOOL result;
	result = 0;
	result = endswith_212604(x, TMP1339);
	return result;
}
...
N_NIMCALL(void, llstreamwriteln_212300)(tllstream212204* s, NimStringDesc* data) {
	...
	llstreamwrite_212278(s, ((NimStringDesc*) &TMP1031));
}
...
TMP715[TMP1013+2].kind = 1;
TMP715[TMP1013+2].offset = TMP1013;
TMP715[TMP1013+2].name = TMP1012[TMP1013];
TMP1011[TMP1013] = &TMP715[TMP1013+2];
}
TMP715[6].len = 4; TMP715[6].kind = 2; TMP715[6].sons = &TMP1011[0];
NTI212202.node = &TMP715[6];
TMP715[1].kind = 1;
TMP715[1].offset = offsetof(tllstream212204, Kind);
TMP715[1].typ = (&NTI212202);
TMP715[1].name = "kind";
TMP1010[1] = &TMP715[7];
TMP715[7].kind = 1;
TMP715[7].offset = offsetof(tllstream212204, F);
TMP715[7].typ = (&NTI12404);
TMP715[7].name = "f";
TMP1010[2] = &TMP715[8];
TMP715[8].kind = 1;
TMP715[8].offset = offsetof(tllstream212204, S);
TMP715[8].typ = (&NTI149);
TMP715[8].name = "s";
TMP1010[3] = &TMP715[9];
TMP715[9].kind = 1;
TMP715[9].offset = offsetof(tllstream212204, Rd);
TMP715[9].typ = (&NTI108);
TMP715[9].name = "rd";
TMP1010[4] = &TMP715[10];
TMP715[10].kind = 1;
TMP715[10].offset = offsetof(tllstream212204, Wr);
TMP715[10].typ = (&NTI108);
TMP715[10].name = "wr";
TMP1010[5] = &TMP715[11];
TMP715[11].kind = 1;
TMP715[11].offset = offsetof(tllstream212204, Lineoffset);
TMP715[11].typ = (&NTI108);
TMP715[11].name = "lineOffset";
TMP715[0].len = 6; TMP715[0].kind = 2; TMP715[0].sons = &TMP1010[0];
NTI212204.node = &TMP715[0];
NTI212206.size = sizeof(tllstream212204*);
NTI212206.kind = 22;
NTI212206.base = (&NTI212204);
NTI212206.marker = TMP1014;
}
