...
N_NIMCALL(void, listwarnings_195769)(void) {
	msgwriteln_190915(((NimStringDesc*) &TMP1899), 0);
	{
		NU16 warn_195823;
		NI res_195857;
		warn_195823 = 0;
...
N_NIMCALL(void, listhints_195875)(void) {
	msgwriteln_190915(((NimStringDesc*) &TMP1961), 0);
	{
		NU16 hint_195887;
		NI res_195921;
		hint_195887 = 0;
...
N_NIMCALL(void, suggestwriteln_190450)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_190441.ClEnv? writelnhook_190441.ClPrc(s, writelnhook_190441.ClEnv):((TMP2063)(writelnhook_190441.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, suggestquit_190506)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_190511).Sup.message; (*e_190511).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2774));
	if (LOC1) nimGCunrefNoCycle(LOC1);
