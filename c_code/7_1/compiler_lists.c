...
N_NIMCALL(void, prepend_139291)(Tlinkedlist139028* list, Tlistentry139022* entry);
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b);
N_NIMCALL(Tstrentry139024*, newstrentry_139250)(NimStringDesc* data);
...
TNimType NTI139022; /* TListEntry */
TNimType NTI139020; /* PListEntry */
TNimType NTI139028; /* TLinkedList */
extern TNimType NTI108; /* int */
extern Gcheap51018 gch_51059;
TNimType NTI139024; /* TStrEntry */
extern TNimType NTI149; /* string */
TNimType NTI139026; /* PStrEntry */
N_NIMCALL(void, TMP854)(void* p, NI op) {
	Tlistentry139022* a;
	a = (Tlistentry139022*)p;
...
N_NIMCALL(void, bringtofront_139705)(Tlinkedlist139028* list, Tlistentry139022* entry) {
	remove_139639(list, entry);
	prepend_139291(list, entry);
}
...
{	result = 0;
	it = list.head;
	{
		while (1) {
			...
			{
				if (!eqStrings((*((Tstrentry139024*) (it))).data, data)) goto LA5;
				result = NIM_TRUE;
				goto BeforeRet;
			}
			LA5: ;
...
N_NIMCALL(Tstrentry139024*, newstrentry_139250)(NimStringDesc* data) {
	Tstrentry139024* result;
	NimStringDesc* LOC1;
	result = 0;
	result = (Tstrentry139024*) newObj((&NTI139026), sizeof(Tstrentry139024));
	(*result).Sup.Sup.m_type = (&NTI139024);
	LOC1 = 0;
...
N_NIMCALL(void, prependstr_139419)(Tlinkedlist139028* list, NimStringDesc* data) {
	Tstrentry139024* LOC1;
	Tlistentry139022* LOC2;
	LOC1 = 0;
	LOC1 = newstrentry_139250(data);
	LOC2 = 0;
	LOC2 = &LOC1->Sup;
	prepend_139291(list, LOC2);
}
...
N_NIMCALL(void, excludepath_139807)(Tlinkedlist139028* list, NimStringDesc* data) {
	...
	{
		while (1) {
			Tlistentry139022* nxt;
			if (!!((it == NIM_NIL))) goto LA2;
			nxt = (*it).next;
			{
				NI LOC5;
				LOC5 = 0;
				LOC5 = noscmpPaths((*((Tstrentry139024*) (it))).data, data);
				if (!(LOC5 == ((NI) 0))) goto LA6;
				remove_139639(list, it);
			}
			LA6: ;
			it = nxt;
		} LA2: ;
...
{	result = 0;
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = contains_139219((*list), data);
		if (!LOC3) goto LA4;
		result = NIM_TRUE;
		goto BeforeRet;
	}
	LA4: ;
	appendstr_139268(list, data);
	}BeforeRet: ;
	return result;
}
...
NTI139022.size = sizeof(Tlistentry139022);
NTI139022.kind = 17;
NTI139022.base = (&NTI4011);
TMP853[0] = &TMP23[1];
NTI139020.size = sizeof(Tlistentry139022*);
NTI139020.kind = 22;
NTI139020.base = (&NTI139022);
NTI139020.marker = TMP854;
TMP23[1].kind = 1;
TMP23[1].offset = offsetof(Tlistentry139022, prev);
TMP23[1].typ = (&NTI139020);
TMP23[1].name = "prev";
TMP853[1] = &TMP23[2];
TMP23[2].kind = 1;
TMP23[2].offset = offsetof(Tlistentry139022, next);
TMP23[2].typ = (&NTI139020);
TMP23[2].name = "next";
TMP23[0].len = 2; TMP23[0].kind = 2; TMP23[0].sons = &TMP853[0];
NTI139022.node = &TMP23[0];
NTI139028.size = sizeof(Tlinkedlist139028);
NTI139028.kind = 18;
NTI139028.base = 0;
TMP1129[0] = &TMP23[4];
TMP23[4].kind = 1;
TMP23[4].offset = offsetof(Tlinkedlist139028, head);
TMP23[4].typ = (&NTI139020);
TMP23[4].name = "head";
TMP1129[1] = &TMP23[5];
TMP23[5].kind = 1;
TMP23[5].offset = offsetof(Tlinkedlist139028, tail);
TMP23[5].typ = (&NTI139020);
TMP23[5].name = "tail";
TMP1129[2] = &TMP23[6];
TMP23[6].kind = 1;
TMP23[6].offset = offsetof(Tlinkedlist139028, counter);
TMP23[6].typ = (&NTI108);
TMP23[6].name = "counter";
TMP23[3].len = 3; TMP23[3].kind = 2; TMP23[3].sons = &TMP1129[0];
NTI139028.node = &TMP23[3];
NTI139024.size = sizeof(Tstrentry139024);
NTI139024.kind = 17;
NTI139024.base = (&NTI139022);
TMP23[7].kind = 1;
TMP23[7].offset = offsetof(Tstrentry139024, data);
TMP23[7].typ = (&NTI149);
TMP23[7].name = "data";
NTI139024.node = &TMP23[7];
NTI139026.size = sizeof(Tstrentry139024*);
NTI139026.kind = 22;
NTI139026.base = (&NTI139024);
NTI139026.marker = TMP1751;
}
