...
NIM_CONST TY173514 Cpu_173500 = {{((NimStringDesc*) &TMP61),
((NI) 32),
((NU8) 0),
((NI) 64),
((NI) 32)}
...
NIM_CONST TY173084 Os_173070 = {{((NimStringDesc*) &TMP79),
((NimStringDesc*) &TMP80),
((NimStringDesc*) &TMP81),
((NimStringDesc*) &TMP82),
((NimStringDesc*) &TMP83),
...
{	result = 0;
	{
		...
		{
			while (1) {
				if (!(res_174428 <= ((NI) 18))) goto LA3;
				i_174423 = ((NU8) (res_174428));
				{
					NI LOC6;
					LOC6 = 0;
					LOC6 = nsuCmpIgnoreStyle(name, Cpu_173500[(i_174423)- 1].Field0);
...
{	result = 0;
	{
		...
		{
			while (1) {
				if (!(res_174228 <= ((NI) 24))) goto LA3;
				i_174223 = ((NU8) (res_174228));
				{
					NI LOC6;
					LOC6 = 0;
					LOC6 = nsuCmpIgnoreStyle(name, Os_173070[(i_174223)- 1].Field0);
					if (!(LOC6 == ((NI) 0))) goto LA7;
					result = i_174223;
					goto BeforeRet;
				}
...
N_NIMCALL(void, settarget_173662)(NU8 o, NU8 c) {
	...
	targetcpu_173628 = c;
	targetos_173630 = o;
	intsize_173651 = (NI)(Cpu_173500[(c)- 1].Field1 / ((NI) 8));
	floatsize_173652 = (NI)(Cpu_173500[(c)- 1].Field3 / ((NI) 8));
	ptrsize_173653 = (NI)(Cpu_173500[(c)- 1].Field4 / ((NI) 8));
	LOC1 = 0;
	LOC1 = tnl_173654; tnl_173654 = copyStringRC1(Os_173070[(o)- 1].Field5);
	if (LOC1) nimGCunrefNoCycle(LOC1);
}
NIM_EXTERNC N_NOINLINE(void, compiler_platformInit000)(void) {
	hostcpu_173629 = nametocpu_173645(((NimStringDesc*) &TMP70));
	hostos_173631 = nametoos_173639(((NimStringDesc*) &TMP129));
	settarget_173662(hostos_173631, hostcpu_173629);
}
