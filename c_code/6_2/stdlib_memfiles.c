...
N_NIMCALL(Memfile301202, open_301801_947767598)(NimStringDesc* filename0, Filemode12409 mode0, NI mappedsize0, NI offset0, NI newfilesize0) {
	...
	LA6: ;
	{
		...
		raiseoserror_127003_2125978480(LOC20, ((NimStringDesc*) &TMP1728));
	}
	LA13: ;
	{
		if (!!((newfilesize0 == ((NI) -1)))) goto LA23;
		{
			...
			raiseoserror_127003_2125978480(LOC35, ((NimStringDesc*) &TMP1728));
		}
		LA28: ;
	}
	LA23: ;
	...
	LA38: ;
	{
		...
		LA44: ;
		{
			...
			raiseoserror_127003_2125978480(LOC52, ((NimStringDesc*) &TMP1728));
		}
		LA41: ;
	}
	LA36: ;
	...
	result0.mem = mmap(NIM_NIL, result0.size, LOC53, LOC59, result0.handle, ((off_t) (offset0)));
	{
		...
		raiseoserror_127003_2125978480(LOC74, ((NimStringDesc*) &TMP1728));
	}
	LA67: ;
	return result0;
}
...
N_NIMCALL(void, close_302243_947767598)(Memfile301202* f0) {
	...
	{
		if (!error0) goto LA11;
		raiseoserror_127003_2125978480(lasterr0, ((NimStringDesc*) &TMP1728));
	}
	LA11: ;
}
