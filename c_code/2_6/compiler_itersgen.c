...
{	result0 = (Tnode264794*)0;
	...
	t0 = skiptypes_268113_850551059((*LOC19).typ, 2304);
	{
		...
		Tnode264794* LOC27;
		LOC22 = (NIM_BOOL)0;
		LOC22 = !(((*t0).kind == ((Ttypekind264244) 22) || (*t0).kind == ((Ttypekind264244) 21)));
		if (LOC22) goto LA23;
		LOC24 = (Ttype264832*)0;
	...
	LA25: ;
	LOC28 = (Tnode264794*)0;
	LOC28 = getbody_305828_1724185294((*iter0).kindU.S4.sym);
	body0 = liftitertoproc_409195_2538784801((*iter0).kindU.S4.sym, LOC28, t0);
	LOC29 = (Tnode264794*)0;
	LOC29 = HEX5BHEX5D_265238_850551059(n0, ((NI) 3));
	prc0 = newsym_265684_850551059(((Tsymkind264435) 12), (*LOC29).kindU.S5.ident, (*(*iter0).kindU.S4.sym).owner, (*(*iter0).kindU.S4.sym).info);
