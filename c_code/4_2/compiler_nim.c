...
N_NIMCALL(void, handlecmdline_581607)(void);
...
N_NIMCALL(NimStringDesc*, prependcurdir_581401)(NimStringDesc* f);
...
N_NIMCALL(NimStringDesc*, findnodejs_579009)(void);
...
STRING_LITERAL(TMP1995, "stdinfile", 9);
STRING_LITERAL(TMP2023, "nim.cfg", 7);
STRING_LITERAL(TMP2024, "nims", 4);
STRING_LITERAL(TMP3707, "config.nims", 11);
STRING_LITERAL(TMP5290, "./", 2);
STRING_LITERAL(TMP5291, "js", 2);
...
appendString(LOC7, ((NimStringDesc*) &TMP5290));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
{	{
		...
		writecommandlineusage_210020();
	}
	goto LA1;
	LA4: ;
	{
		NimStringDesc* scriptfile;
		processcmdline_574209(((NU8) 0), ((NimStringDesc*) &TMP1993));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_166234, ((NimStringDesc*) &TMP1994))) goto LA9;
			LOC11 = 0;
			LOC11 = gprojectname_166234; gprojectname_166234 = copyStringRC1(((NimStringDesc*) &TMP1995));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = 0;
			LOC12 = gprojectfull_166236; gprojectfull_166236 = copyStringRC1(((NimStringDesc*) &TMP1995));
			if (LOC12) nimGCunrefNoCycle(LOC12);
			asgnRefNoCycle((void**) (&gprojectpath_166235), nosgetCurrentDir());
			gprojectisstdin_166237 = NIM_TRUE;
		}
		goto LA7;
		LA9: ;
		{
			...
			NimStringDesc* LOC20;
			NimStringDesc* LOC21;
			if (!!(((gprojectname_166234) && (gprojectname_166234)->Sup.len == 0))) goto LA14;
			pushSafePoint(&TMP1996);
			TMP1996.status = _setjmp(TMP1996.context);
			if (TMP1996.status == 0) {
				asgnRefNoCycle((void**) (&gprojectfull_166236), canonicalizepath_166409(gprojectname_166234));
				popSafePoint();
			}
			else {
				popSafePoint();
				if (isObj(getCurrentException()->Sup.m_type, (&NTI4033))) {
					...
					TMP1996.status = 0;
					LOC19 = 0;
					LOC19 = gprojectfull_166236; gprojectfull_166236 = copyStringRC1(gprojectname_166234);
					if (LOC19) nimGCunrefNoCycle(LOC19);
					popCurrentException();
				}
			}
			if (TMP1996.status != 0) reraiseException();
			memset((void*)(&p), 0, sizeof(p));
			chckNil((void*)(&p));
			memset((void*)(&p), 0, sizeof(p));
			nossplitFile(gprojectfull_166236, (&p));
			LOC20 = 0;
			LOC20 = gprojectpath_166235; gprojectpath_166235 = copyStringRC1(p.Field0);
			if (LOC20) nimGCunrefNoCycle(LOC20);
			LOC21 = 0;
			LOC21 = gprojectname_166234; gprojectname_166234 = copyStringRC1(p.Field1);
		...
		LA7: ;
		loadconfigs_220609(((NimStringDesc*) &TMP2023));
		scriptfile = noschangeFileExt(gprojectfull_166236, ((NimStringDesc*) &TMP2024));
		{
			NIM_BOOL LOC25;
			LOC25 = 0;
			LOC25 = fileexists_127010(scriptfile);
			if (!LOC25) goto LA26;
			runnimscript_580324(scriptfile);
			{
				if (!eqStrings(scriptfile, gprojectfull_166236)) goto LA30;
				goto BeforeRet;
			}
			LA30: ;
		}
		...
		LA26: ;
		{
			...
			NimStringDesc* LOC37;
			LOC33 = 0;
			LOC33 = HEX2F_123481(gprojectpath_166235, ((NimStringDesc*) &TMP3707));
			LOC34 = 0;
			LOC34 = fileexists_127010(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = 0;
			LOC37 = HEX2F_123481(gprojectpath_166235, ((NimStringDesc*) &TMP3707));
			runnimscript_580324(LOC37);
		}
		goto LA23;
		LA35: ;
		LA23: ;
		initvars_203076();
		processcmdline_574209(((NU8) 1), ((NimStringDesc*) &TMP1993));
		{
			if (!((command_166240) && (command_166240)->Sup.len == 0)) goto LA40;
			rawmessage_193636(((NU16) 184), command_166240);
		}
		LA40: ;
		maincommand_577628();
		{
			...
			NimStringDesc* LOC48;
			LOC44 = 0;
			LOC44 = ((goptions_166130 &(1<<((((NU8) 12))&31)))!=0);
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_190395 &(IL64(1)<<(((((NU16) 289)- 237))&IL64(63))))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
			LOC48 = 0;
		...
		LA46: ;
		{
			if (!(gerrorcounter_190396 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_166132 &(1<<((((NU8) 13))&31)))!=0)) goto LA55;
				{
					NimStringDesc* ex;
					NimStringDesc* LOC70;
					NimStringDesc* LOC71;
					if (!(gcmd_166134 == ((NU8) 4))) goto LA59;
					ex = 0;
					{
						NimStringDesc* LOC65;
						if (!(((NI) 0) < (outfile_166138 ? outfile_166138->Sup.len : 0))) goto LA63;
						LOC65 = 0;
						LOC65 = prependcurdir_581401(outfile_166138);
					...
					LA63: ;
					{
						...
						NimStringDesc* LOC69;
						LOC67 = 0;
						LOC67 = noschangeFileExt(gprojectfull_166236, ((NimStringDesc*) &TMP5291));
						LOC68 = 0;
						LOC68 = prependcurdir_581401(LOC67);
						LOC69 = 0;
						LOC69 = completecfilepath_203112(LOC68, NIM_TRUE);
						ex = nospquoteShell(LOC69);
					}
					LA61: ;
					LOC70 = 0;
					LOC71 = 0;
					LOC71 = findnodejs_579009();
					LOC70 = rawNewString(LOC71->Sup.len + ex->Sup.len + arguments_211837->Sup.len + 2);
appendString(LOC70, LOC71);
appendString(LOC70, ((NimStringDesc*) &TMP5295));
appendString(LOC70, ex);
appendChar(LOC70, 32);
appendString(LOC70, arguments_211837);
					execexternalprogram_203175(LOC70, ((NU16) 284));
				}
				goto LA57;
				LA59: ;
				{
					...
					binpath = 0;
					{
						if (!(((NI) 0) < (outfile_166138 ? outfile_166138->Sup.len : 0))) goto LA75;
						binpath = prependcurdir_581401(outfile_166138);
					}
					goto LA73;
					LA75: ;
					{
						NimStringDesc* LOC78;
						LOC78 = 0;
						LOC78 = noschangeFileExt(gprojectfull_166236, ((NimStringDesc*) &TMP1993));
						binpath = prependcurdir_581401(LOC78);
					}
					LA73: ;
					ex = nospquoteShell(binpath);
					LOC79 = 0;
					LOC79 = rawNewString(ex->Sup.len + arguments_211837->Sup.len + 1);
appendString(LOC79, ex);
appendChar(LOC79, 32);
appendString(LOC79, arguments_211837);
					execexternalprogram_203175(LOC79, ((NU16) 284));
				}
				LA57: ;
			}
			LA55: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	initdefines_198254();
	handlecmdline_581607();
	msgquit_190488(((NI8) ((((NI) 0) < gerrorcounter_190396))));
}
