...
N_NIMCALL(Tnode190813*, close_507018)(Tpasscontext241005* p, Tnode190813* n) {
	...
	usewarning = !((((*(*g).module).flags &(1<<((((NU8) 12))&31)))!=0));
	{
		...
		writeoutput_343337((*g).doc, LOC7, ((NimStringDesc*) &TMP4886), usewarning);
		pushSafePoint(&TMP4887);
		TMP4887.status = _setjmp(TMP4887.context);
		if (TMP4887.status == 0) {
...
TMP1067[0].len = 2; TMP1067[0].kind = 2; TMP1067[0].sons = &TMP4884[0];
NTI507010.node = &TMP1067[0];
NTI507012.size = sizeof(Tgen507010*);
NTI507012.kind = 22;
NTI507012.base = (&NTI507010);
NTI507012.marker = TMP4885;
}
