...
STRING_LITERAL(TMP5055, "", 0);
STRING_LITERAL(TMP5056, "*", 1);
STRING_LITERAL(TMP5057, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP5064, "ref.", 4);
STRING_LITERAL(TMP5065, "ptr.", 4);
STRING_LITERAL(TMP5066, "proc(", 5);
STRING_LITERAL(TMP5067, "tuple[", 6);
STRING_LITERAL(TMP5068, "renderParamTypes(found,n) with ", 31);
...
{	result = 0;
	result = copyString(((NimStringDesc*) &TMP5055));
	switch ((*n).kind) {
	case ((NU8) 31):
	{
		{
	...
	{
		{
			if (!!(eqStrings((*(*n).kindU.S5.ident).s, ((NimStringDesc*) &TMP5056)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP5057));
...
appendString(LOC6, ((NimStringDesc*) &TMP5064));
...
appendString(LOC10, ((NimStringDesc*) &TMP5065));
appendString(LOC10, LOC12);
	...
	case ((NU8) 147):
	{
		...
		result = copyString(((NimStringDesc*) &TMP5066));
		{
			NI i_381419;
			NI HEX3Atmp_382202;
			NI LOC15;
...
appendString(LOC31, ((NimStringDesc*) &TMP5068));
