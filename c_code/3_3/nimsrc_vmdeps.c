		...
		res_380133 = ((NI) 0);
		{
			while (1) {
				...
				i_380113 = res_380133;
				{
					...
					void_380126 = atomictypex_380066(((NimStringDesc*) &TMP2838), t, info);
...
N_NIMCALL(Tnode190813*, maptypetoast_380080)(Ttype190849* t, Tlineinfo163338 info, NIM_BOOL allowrecursion) {
	...
	case ((NU8) 0):
	{
		result = atomictypex_380066(((NimStringDesc*) &TMP2828), t, info);
	}
	break;
	case ((NU8) 1):
	{
		result = atomictypex_380066(((NimStringDesc*) &TMP2829), t, info);
	}
	break;
	case ((NU8) 2):
	{
		result = atomictypex_380066(((NimStringDesc*) &TMP2830), t, info);
	}
	break;
	case ((NU8) 5):
	{
	...
	case ((NU8) 16):
	{
		...
		result = newnodeit_192807(((NU8) 42), info, t);
		LOC9 = 0;
		LOC9 = atomictypex_380066(((NimStringDesc*) &TMP2835), t, info);
	...
	{
		{
			...
			result = newnodeit_192807(((NU8) 42), info, t);
			LOC18 = 0;
			LOC18 = atomictypex_380066(((NimStringDesc*) &TMP2836), t, info);
	...
	{
		{
			...
			result = maptypetobracket_380088(((NimStringDesc*) &TMP2839), t, info);
		}
		goto LA31;
		LA33: ;
		{
	...
	case ((NU8) 18):
	{
		result = maptypetobracket_380088(((NimStringDesc*) &TMP2840), t, info);
	}
	break;
	case ((NU8) 19):
	{
		result = maptypetobracket_380088(((NimStringDesc*) &TMP2841), t, info);
	}
	break;
	case ((NU8) 21):
	{
	...
	case ((NU8) 20):
	{
		...
		result = newnodeit_192807(((NU8) 42), info, t);
		LOC61 = 0;
		LOC61 = atomictypex_380066(((NimStringDesc*) &TMP2848), t, info);
	...
	case ((NU8) 26):
	{
		result = atomictypex_380066(((NimStringDesc*) &TMP2849), t, info);
	}
	break;
	case ((NU8) 28):
	{
		result = atomictypex_380066(((NimStringDesc*) &TMP2850), t, info);
	}
	break;
	case ((NU8) 29):
	{
		result = atomictypex_380066(((NimStringDesc*) &TMP2851), t, info);
	}
	break;
	case ((NU8) 31):
	{
	...
	case ((NU8) 46):
	{
		result = maptypetobracket_380088(((NimStringDesc*) &TMP2867), t, info);
	}
	break;
	case ((NU8) 47):
	{
		result = maptypetobracket_380088(((NimStringDesc*) &TMP2868), t, info);
	}
	break;
	case ((NU8) 48):
	{
		result = maptypetobracket_380088(((NimStringDesc*) &TMP2869), t, info);
	}
	break;
	case ((NU8) 49):
	{
	...
	case ((NU8) 50):
	{
		result = atomictypex_380066(((NimStringDesc*) &TMP2871), t, info);
	}
	break;
	case ((NU8) 51):
	{
	...
	case ((NU8) 54):
	{
		result = maptypetobracket_380088(((NimStringDesc*) &TMP2874), t, info);
	}
	break;
	case ((NU8) 55):
	{
	...
	case ((NU8) 58):
	{
		result = atomictypex_380066(((NimStringDesc*) &TMP2878), t, info);
	}
	break;
	case ((NU8) 59):
	case ((NU8) 60):
	case ((NU8) 61):
	{
		...
		result = newnodeit_192807(((NU8) 42), info, t);
		LOC96 = 0;
		LOC96 = atomictypex_380066(((NimStringDesc*) &TMP2879), t, info);
