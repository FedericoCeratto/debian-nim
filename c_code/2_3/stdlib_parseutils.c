...
STRING_LITERAL(TMP1368, "overflow", 8);
	...
	LA1: ;
	{
		...
		(*b) = IL64(0);
		{
			while (1) {
				...
				TMP1067 = mulInt64((*b), IL64(10));
				TMP1068 = subInt(((NI) (((NU8)(s->data[i])))), 48);
				TMP1069 = subInt64((NI64)(TMP1067), ((NI64) ((NI64)(TMP1068))));
				(*b) = (NI64)(TMP1069);
				i = addInt(i, 1);
				{
					while (1) {
		...
		TMP1070 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP1070);
		TMP1071 = subInt(i, start);
		result = (NI64)(TMP1071);
	}
	LA10: ;
	return result;
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = npuParseBiggestInt(s, (&res), start);
	{
		...
		LOC9 = 0;
		LOC9 = (*e_92169).Sup.Sup.message; (*e_92169).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1368));
