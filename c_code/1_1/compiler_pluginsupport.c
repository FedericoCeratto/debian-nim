...
#include "nimbase.h"
typedef struct PluginHEX3Aobjecttype449010 PluginHEX3Aobjecttype449010;
...
struct  PluginHEX3Aobjecttype449010  {
Tident195012* fn;
Tident195012* module;
Tident195012* package;
Transformation449004 t;
PluginHEX3Aobjecttype449010* next;
};
...
N_NIMCALL(NIM_BOOL, pluginmatches_449028_1104897005)(PluginHEX3Aobjecttype449010* p0, Tsym265826* s0);
N_NIMCALL(Tsym265826*, skipgenericowner_270352_850551059)(Tsym265826* s0);
PluginHEX3Aobjecttype449010* head_449082_1104897005;
TNimType NTI449010; /* Plugin:ObjectType */
extern TNimType NTI195010; /* PIdent */
TNimType NTI449004; /* Transformation */
TNimType NTI449006; /* Plugin */
extern Gcheap50218 gch_50258_1689653243;
N_NIMCALL(void, TMP1169)(void* p, NI op) {
	PluginHEX3Aobjecttype449010* a;
	a = (PluginHEX3Aobjecttype449010*)p;
...
N_NIMCALL(void, TMP1170)() {
	nimGCvisit((void*)head_449082_1104897005, 0);
}
...
N_NIMCALL(void, registerplugin_449102_1104897005)(NimStringDesc* package0, NimStringDesc* module0, NimStringDesc* fn0, Transformation449004 t0) {
	PluginHEX3Aobjecttype449010* oldhead0;
	PluginHEX3Aobjecttype449010* LOC1;
	oldhead0 = head_449082_1104897005;
	LOC1 = (PluginHEX3Aobjecttype449010*)0;
	LOC1 = (PluginHEX3Aobjecttype449010*) newObj((&NTI449006), sizeof(PluginHEX3Aobjecttype449010));
	asgnRefNoCycle((void**) (&(*LOC1).fn), getident_195441_791273810(fn0));
	asgnRefNoCycle((void**) (&(*LOC1).module), getident_195441_791273810(module0));
	asgnRefNoCycle((void**) (&(*LOC1).package), getident_195441_791273810(package0));
	(*LOC1).t = t0;
	asgnRef((void**) (&(*LOC1).next), oldhead0);
	asgnRef((void**) (&head_449082_1104897005), LOC1);
}
...
{	result0 = (NIM_BOOL)0;
	...
	LA3: ;
	module0 = skipgenericowner_270352_850551059(s0);
	{
		NIM_BOOL LOC7;
		NIM_BOOL LOC8;
		LOC7 = (NIM_BOOL)0;
		...
		if (LOC8) goto LA9;
		LOC8 = !(((*module0).kind == ((Tsymkind265435) 6)));
		LA9: ;
		LOC7 = LOC8;
		if (LOC7) goto LA10;
	...
	package0 = (*module0).owner;
	{
		...
		if (LOC16) goto LA17;
		LOC16 = !(((*package0).kind == ((Tsymkind265435) 23)));
		LA17: ;
		LOC15 = LOC16;
		if (LOC15) goto LA18;
...
N_NIMCALL(Transformation449004, getplugin_449084_1104897005)(Tsym265826* fn0) {
	Transformation449004 result0;
	PluginHEX3Aobjecttype449010* it0;
{	result0 = (Transformation449004)0;
	it0 = head_449082_1104897005;
	{
		while (1) {
			if (!!((it0 == NIM_NIL))) goto LA2;
			{
				NIM_BOOL LOC5;
				LOC5 = (NIM_BOOL)0;
				LOC5 = pluginmatches_449028_1104897005(it0, fn0);
				if (!LOC5) goto LA6;
				result0 = (*it0).t;
				goto BeforeRet;
			}
...
nimRegisterGlobalMarker(TMP1170);
}

NIM_EXTERNC N_NOINLINE(void, compiler_pluginsupportDatInit000)(void) {
static TNimNode* TMP1168[5];
static TNimNode TMP1166[6];
NTI449010.size = sizeof(PluginHEX3Aobjecttype449010);
NTI449010.kind = 18;
NTI449010.base = 0;
TMP1168[0] = &TMP1166[1];
TMP1166[1].kind = 1;
TMP1166[1].offset = offsetof(PluginHEX3Aobjecttype449010, fn);
TMP1166[1].typ = (&NTI195010);
TMP1166[1].name = "fn";
TMP1168[1] = &TMP1166[2];
TMP1166[2].kind = 1;
TMP1166[2].offset = offsetof(PluginHEX3Aobjecttype449010, module);
TMP1166[2].typ = (&NTI195010);
TMP1166[2].name = "module";
TMP1168[2] = &TMP1166[3];
TMP1166[3].kind = 1;
TMP1166[3].offset = offsetof(PluginHEX3Aobjecttype449010, package);
TMP1166[3].typ = (&NTI195010);
TMP1166[3].name = "package";
TMP1168[3] = &TMP1166[4];
NTI449004.size = sizeof(Transformation449004);
NTI449004.kind = 25;
NTI449004.base = 0;
NTI449004.flags = 3;
TMP1166[4].kind = 1;
TMP1166[4].offset = offsetof(PluginHEX3Aobjecttype449010, t);
TMP1166[4].typ = (&NTI449004);
TMP1166[4].name = "t";
TMP1168[4] = &TMP1166[5];
TMP1166[5].kind = 1;
TMP1166[5].offset = offsetof(PluginHEX3Aobjecttype449010, next);
TMP1166[5].typ = (&NTI449006);
TMP1166[5].name = "next";
TMP1166[0].len = 5; TMP1166[0].kind = 2; TMP1166[0].sons = &TMP1168[0];
NTI449010.node = &TMP1166[0];
NTI449006.size = sizeof(PluginHEX3Aobjecttype449010*);
NTI449006.kind = 22;
NTI449006.base = (&NTI449010);
NTI449006.marker = TMP1169;
}
