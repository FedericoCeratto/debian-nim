...
N_NIMCALL(void, compileconstraints_269113)(Tnode191813* p, NimStringDesc** result);
N_NIMCALL(void, patternerror_269051)(Tnode191813* n);
...
STRING_LITERAL(TMP3126, "parampatterns.nim", 17);
NIM_CONST TY88145 TMP3125 = {((NimStringDesc*) &TMP3126),
((NI) 100)}
;
NIM_CONST TY88145 TMP3127 = {((NimStringDesc*) &TMP3126),
((NI) 107)}
;
				...
				res_269644 = ((NI) 0);
				{
					while (1) {
						...
						i_269423 = ((NU8) (res_269644));
						{
							...
							NI LOC76;
							LOC75 = 0;
							LOC75 = copyStr(reprEnum(i_269423, (&NTI191441)), ((NI) 2));
							LOC76 = 0;
				...
				res_269652 = ((NI) 0);
				{
					while (1) {
						...
						i_269623 = ((NU8) (res_269652));
						{
							NI LOC89;
							LOC89 = 0;
							LOC89 = nsuCmpIgnoreStyle(reprEnum(i_269623, (&NTI191029)), spec);
...
N_NIMCALL(Tnode191813*, semnodekindconstraints_269679)(Tnode191813* p) {
	...
	(*result).kindU.S3.strval = addChar((*result).kindU.S3.strval, 1);
	{
		...
		}
		{
			...
			internalerror_166199((*p).info, ((NimStringDesc*) &TMP3128));
		}
		LA12: ;
	}
	goto LA1;
