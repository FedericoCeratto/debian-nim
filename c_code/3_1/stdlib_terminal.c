...
N_NIMCALL(void, setstyle_187604)(FILE* f, NU8 style) {
	{
		...
		{
			while (1) {
				if (!(i_187861 <= ((NI) 8))) goto LA3;
				{
					NimStringDesc* LOC8;
					NimStringDesc* LOC9;
					if (!((style &(1<<(((((NU8) (i_187861))- 1))&7)))!=0)) goto LA6;
					s_187847 = ((NU8) (i_187861));
					LOC8 = 0;
					LOC9 = 0;
					LOC9 = nimIntToStr(((NI) (s_187847)));
...
N_NIMCALL(void, resetattributes_187209)(FILE* f) {
	write_17095(f, ((NimStringDesc*) &TMP434));
}
