...
N_NIMCALL(void, addescaped_374039)(NimStringDesc** result, NimStringDesc* s);
...
N_NIMCALL(void, addescaped_374039)(NimStringDesc** result, NimStringDesc* s) {
	{
		...
		c_374045 = 0;
		i_374049 = ((NI) 0);
		L_374051 = (s ? s->Sup.len : 0);
		{
			while (1) {
				if (!(i_374049 < L_374051)) goto LA3;
				c_374045 = s->data[i_374049];
				switch (((NU8)(c_374045))) {
				case 60:
				{
...
appendString((*result), ((NimStringDesc*) &TMP5055));
				...
				default:
				{
					(*result) = addChar((*result), c_374045);
				}
				break;
				}
				i_374049 += ((NI) 1);
