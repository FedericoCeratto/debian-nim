...
Stringtableobj146212* gcookies_380115;
...
N_NIMCALL(NimStringDesc*, encodeurl_379004)(NimStringDesc* s) {
	...
	result = rawNewString(((NI) ((NI)((s ? s->Sup.len : 0) + (NI)((NU32)((s ? s->Sup.len : 0)) >> (NU32)(((NI) 2)))))));
	{
		...
		i_379018 = 0;
		HEX3Atmp_379028 = 0;
		HEX3Atmp_379028 = (NI)((s ? s->Sup.len : 0) - ((NI) 1));
		res_379031 = ((NI) 0);
		{
			while (1) {
				if (!(res_379031 <= HEX3Atmp_379028)) goto LA3;
				i_379018 = res_379031;
				switch (((NU8)(s->data[i_379018]))) {
				case 97 ... 122:
				case 65 ... 90:
				case 48 ... 57:
				case 95:
				{
					result = addChar(result, s->data[i_379018]);
				}
				break;
				case 32:
				{
				...
				default:
				{
					...
					LOC7 = 0;
					LOC7 = nsuToHex(((NI64) (((NU8)(s->data[i_379018])))), ((NI) 2));
