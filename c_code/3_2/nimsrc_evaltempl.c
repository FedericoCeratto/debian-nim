...
STRING_LITERAL(TMP2818, "evaltempl.nim", 13);
NIM_CONST TY86545 TMP2817 = {((NimStringDesc*) &TMP2818),
((NI) 39)}
;
...
N_NIMCALL(Tnode190813*, evaltemplateargs_383184)(Tnode190813* n, Tsym190843* s) {
	...
	{
		if (!(f < a)) goto LA5;
		globalerror_165134((*n).info, ((NU16) 133), ((NimStringDesc*) &TMP2816));
	}
	LA5: ;
		...
		res_383237 = ((NI) 1);
		{
			while (1) {
				...
				LA10: ;
				{
					...
					LA18: ;
					if (!LOC17) goto LA19;
					localerror_165155((*n).info, ((NU16) 133), ((NimStringDesc*) &TMP2816));
				}
				LA19: ;
...
N_NIMCALL(Tnode190813*, evaltemplate_383260)(Tnode190813* n, Tsym190843* tmpl, Tsym190843* gensymowner) {
	...
	evaltemplatecounter_383256 += ((NI) 1);
	{
		...
		globalerror_165134((*n).info, ((NU16) 183), ((NimStringDesc*) &TMP2816));
		result = n;
	}
	LA3: ;
