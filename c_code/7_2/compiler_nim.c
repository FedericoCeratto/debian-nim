...
{	{
	...
	LA4: ;
	{
		...
		scriptfile = noschangeFileExt(gprojectfull_165236, ((NimStringDesc*) &TMP2023));
		{
			...
			if (!LOC25) goto LA26;
			runnimscript_579328(scriptfile);
			{
		...
		maincommand_576628();
		{
			...
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_189395 &(IL64(1)<<(((((NU16) 289)- 237))&IL64(63))))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
			LOC48 = 0;
		...
		LA46: ;
		{
			if (!(gerrorcounter_189396 == ((NI) 0))) goto LA51;
			{
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	msgquit_189488(((NI8) ((((NI) 0) < gerrorcounter_189396))));
}
