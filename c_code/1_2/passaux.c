...
STRING_LITERAL(TMP1947, "logpass: context is not nil", 27);
...
N_NIMCALL(tnode226816*, verboseprocess_608023)(tpasscontext287005* context, tnode226816* n) {
	...
	result = n;
	{
		...
		internalerror_199006(((NimStringDesc*) &TMP1947));
	}
	LA3: ;
	{
		NimStringDesc* LOC9;
		if (!(gverbosity_170127 == 3)) goto LA7;
		gnotes_197302 |= ((NI64)1)<<(((((NU16) 267)- 230))%(sizeof(NI64)*8));
		LOC9 = 0;
