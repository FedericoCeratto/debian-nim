...
typedef N_CLOSURE_PTR(NI, TMP5445) (NimStringDesc* x_356530_3792311747, NimStringDesc* y_356532_3792311747);
typedef N_CLOSURE_PTR(NI, TMP5446) (NimStringDesc* x_356530_3792311747, NimStringDesc* y_356532_3792311747);
typedef struct {
...
typedef N_CLOSURE_PTR(NI, TMP5449) (Indexentry353126 x_354630_3792311747, Indexentry353126 y_354632_3792311747);
typedef N_CLOSURE_PTR(NI, TMP5450) (Indexentry353126 x_354630_3792311747, Indexentry353126 y_354632_3792311747);
struct  TNimObject  {
TNimType* m_type;
};
struct  Tidobj194006  {
...
N_NIMCALL(void, sort_356466_3792311747)(NimStringDesc** a0, NI a0Len0, TY356473 cmp0, Sortorder351004 order0) {
	...
	n0 = a0Len0;
	b0 = (TY131602*)0;
	b0 = (TY131602*) newSeq((&NTI131602), ((NI) ((NI)(n0 / ((NI) 2)))));
	s0 = ((NI) 1);
	{
		while (1) {
			NI m0;
