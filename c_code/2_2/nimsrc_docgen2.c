...
N_NIMCALL(Tpasscontext242005*, myopen_508068)(Tsym191843* module) {
	...
	LOC1 = 0;
	LOC1 = tofilename_165263(((NI32) ((*module).position)));
...
N_NIMCALL(Tnode191813*, close_508018)(Tpasscontext242005* p, Tnode191813* n) {
	...
	usewarning = !((((*(*g).module).flags &(1<<((((NU8) 12))&31)))!=0));
	{
		...
		if (!LOC3) goto LA5;
		LOC7 = 0;
		LOC7 = tofilename_165263(((NI32) ((*(*g).module).position)));
		writeoutput_344337((*g).doc, LOC7, ((NimStringDesc*) &TMP4888), usewarning);
		pushSafePoint(&TMP4889);
		TMP4889.status = setjmp(TMP4889.context);
		if (TMP4889.status == 0) {
...
TMP1069[0].len = 2; TMP1069[0].kind = 2; TMP1069[0].sons = &TMP4886[0];
NTI508010.node = &TMP1069[0];
NTI508012.size = sizeof(Tgen508010*);
NTI508012.kind = 22;
NTI508012.base = (&NTI508010);
NTI508012.marker = TMP4887;
}
