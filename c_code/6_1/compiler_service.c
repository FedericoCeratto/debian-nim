...
STRING_LITERAL(TMP5525, "server.type", 11);
STRING_LITERAL(TMP5526, "stdin", 5);
STRING_LITERAL(TMP5527, "tcp", 3);
STRING_LITERAL(TMP5528, "quit", 4);
STRING_LITERAL(TMP5530, "server.port", 11);
STRING_LITERAL(TMP5531, "server.address", 14);
STRING_LITERAL(TMP5534, "\015\012", 2);
STRING_LITERAL(TMP5542, "Invalid server.type:", 20);
...
N_NIMCALL(void, serve_563236_3526807654)(TY563238 action0) {
	...
	typ0 = getconfigvar_164288_2607990831(((NimStringDesc*) &TMP5525));
	if (eqStrings(typ0, ((NimStringDesc*) &TMP5526))) goto LA1;
	if (eqStrings(typ0, ((NimStringDesc*) &TMP5527))) goto LA2;
	...
	{
		{
			while (1) {
				...
				{
					if (!eqStrings(line0, ((NimStringDesc*) &TMP5528))) goto LA10;
					exit(((NI) 0));
				}
				LA10: ;
	...
	LA2: ;
	{
		...
		p0 = getconfigvar_164288_2607990831(((NimStringDesc*) &TMP5530));
		{
			NI LOC18;
		...
		LOC20 = getconfigvar_164288_2607990831(((NimStringDesc*) &TMP5531));
		...
		writelnhook_187117_155036129.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				...
				action0();
				gerrorcounter_187081_155036129 = ((NI) 0);
				send_559802_170061329((*HEX3Aenv_563426_3526807654).stdoutsocket563408, ((NimStringDesc*) &TMP5534), 2);
	...
	LA3: ;
	{
		printf("%s%s\012", ((NimStringDesc*) &TMP5542)? (((NimStringDesc*) &TMP5542))->data:"nil", typ0? (typ0)->data:"nil");
		fflush(stdout);
...
TMP1338[0].len = 2; TMP1338[0].kind = 2; TMP1338[0].sons = &TMP5511[0];
NTI563421.node = &TMP1338[0];
NTI563420.size = sizeof(TY563421*);
NTI563420.kind = 22;
NTI563420.base = (&NTI563421);
NTI563420.flags = 2;
NTI563420.marker = TMP5524;
}
