...
N_NIMCALL(NU8, checkdepmem_523398)(NI32 fileidx);
		...
		gmemcachedata_523071->data[fileidx].needsrecompile = ((NU8) 3);
		{
			...
			L_523630 = (HEX3Atmp_523625 ? HEX3Atmp_523625->Sup.len : 0);
			{
				while (1) {
					...
					d = checkdepmem_523398(dep_523611);
					{
	...
	{
		{
			NU8 LOC25;
			LOC25 = 0;
			LOC25 = checkdepmem_523398(fileidx);
...
N_NIMCALL(void, wantmainmodule_523922)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_166123(gcmdlineinfo_164921, ((NU16) 186), ((NimStringDesc*) &TMP4265));
	}
	LA3: ;
	LOC5 = 0;
...
N_NIMCALL(Tsym191843*, makestdinmodule_524003)(void) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = fileinfoidx_164853(((NimStringDesc*) &TMP4977));
...
N_NIMCALL(void, resetallmodules_523350)(void) {
	{
		...
		i_523362 = 0;
		HEX3Atmp_523376 = 0;
		HEX3Atmp_523376 = (gcompiledmodules_523053 ? (gcompiledmodules_523053->Sup.len-1) : -1);
		res_523379 = ((NI) 0);
		{
			while (1) {
				if (!(res_523379 <= HEX3Atmp_523376)) goto LA3;
				i_523362 = res_523379;
				{
