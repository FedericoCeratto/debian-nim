...
STRING_LITERAL(TMP1523, "key not found: ", 15);
STRING_LITERAL(TMP1765, "", 0);
STRING_LITERAL(TMP2007, "format string: key not found: ", 30);
...
N_NIMCALL(NimStringDesc**, nstTake)(Stringtableobj145212* t, NimStringDesc* key) {
	...
	LA3: ;
	{
		...
		NimStringDesc* LOC6;
		e_145803 = 0;
		e_145803 = (Keyerror4051*) newObj((&NTI191004), sizeof(Keyerror4051));
		(*e_145803).Sup.Sup.Sup.m_type = (&NTI4051);
		LOC6 = 0;
		LOC6 = rawNewString(key->Sup.len + 15);
appendString(LOC6, ((NimStringDesc*) &TMP1523));
...
appendString(LOC1, ((NimStringDesc*) &TMP2007));
appendString(LOC1, s);
