...
typedef struct slice196873 slice196873;
...
typedef NimStringDesc* TY194486[276];
struct  TNimObject  {
TNimType* m_type;
};
struct  Exception  {
...
N_NIMCALL(void, HEX3Aanonymous_197195)(NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
...
N_NIMCALL(void, limessage_196774)(tlineinfo194539 info, NU16 msg, NimStringDesc* arg, NU8 eh);
static N_INLINE(NIM_BOOL, contains_196884)(slice196873 s_196890, NU16 value_196893);
static N_INLINE(slice196873, HEX2EHEX2E_196864)(NU16 a_196868, NU16 b_196870);
...
" instead [NilStmt]", 81);
STRING_LITERAL(TMP396, "thread analysis incomplete due to unknown call \'$1\' [AnalysisLo"
"ophole]", 70);
...
STRING_LITERAL(TMP409, "$1 [LockLevel]", 14);
STRING_LITERAL(TMP410, "$1 [User]", 9);
STRING_LITERAL(TMP411, "operation successful [Success]", 30);
STRING_LITERAL(TMP412, "operation successful ($# lines compiled; $# sec total; $#) [Suc"
"cessX]", 69);
...
NIM_CONST TY194486 msgkindtostr_194485 = {((NimStringDesc*) &TMP154),
...
STRING_LITERAL(TMP1033, "$1($2, $3) Error: $4", 20);
STRING_LITERAL(TMP1034, "$1($2, $3) Warning: $4", 22);
STRING_LITERAL(TMP1035, "$1($2, $3) Hint: $4", 19);
STRING_LITERAL(TMP1036, "  ", 2);
STRING_LITERAL(TMP1049, "compiler/msgs.nim", 17);
NIM_CONST TY84745 TMP1048 = {((NimStringDesc*) &TMP1049),
876}
;
STRING_LITERAL(TMP1982, "\015\012", 2);
STRING_LITERAL(TMP2698, "suggest done", 12);
NIM_CONST TY84745 TMP3613 = {((NimStringDesc*) &TMP1049),
883}
;
...
static N_INLINE(void, writeln_169205)(FILE* f_169209, NimStringDesc** x_169213, NI x_169213Len0) {
	...
	write_12865(f_169209, ((NimStringDesc*) &TMP150));
}
...
N_NIMCALL(NimStringDesc*, msgkindtostring_196378)(NU16 kind) {
	NimStringDesc* result;
	result = 0;
	result = copyString(msgkindtostr_194485[(kind)- 0]);
	return result;
}
...
static N_INLINE(NIM_BOOL, contains_196884)(slice196873 s_196890, NU16 value_196893) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = (s_196890.A <= value_196893);
	if (!(LOC1)) goto LA2;
	LOC1 = (value_196893 <= s_196890.B);
	LA2: ;
	result = LOC1;
	return result;
}
...
N_NIMCALL(trope176009*, sourceline_195277)(tlineinfo194539 i) {
	...
	LA3: ;
	{
		...
		LA8: ;
		if (!LOC7) goto LA9;
		pushSafePoint(&TMP1038);
		TMP1038.status = _setjmp(TMP1038.context);
		if (TMP1038.status == 0) {
			{
				NimStringDesc* line_197100;
				NimStringDesc* HEX3Atmp_197156;
				FILE* f_197159;
				NimStringDesc* res_197161;
				line_197100 = 0;
				HEX3Atmp_197156 = 0;
				HEX3Atmp_197156 = tofullpath_196037(i.Fileindex);
				f_197159 = open_12617(HEX3Atmp_197156, ((NU8) 0), 8000);
				res_197161 = rawNewString(80);
				{
					while (1) {
						NIM_BOOL LOC15;
						LOC15 = 0;
						LOC15 = readline_12889(f_197159, (&res_197161));
						if (!LOC15) goto LA14;
						line_197100 = res_197161;
						addsourceline_197042(i.Fileindex, line_197100);
					} LA14: ;
				}
				fclose(f_197159);
			}
		...
		if (TMP1038.status != 0) reraiseException();
	}
	LA9: ;
	{
		NimStringDesc* LOC22;
...
appendString(LOC1, ((NimStringDesc*) &TMP1036));
...
appendString(LOC4, ((NimStringDesc*) &TMP1036));
...
N_NIMCALL(void, limessage_196774)(tlineinfo194539 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 0) ... ((NU16) 229):
	{
		...
		frmt = copyString(((NimStringDesc*) &TMP1033));
	...
	s = nsuFormatOpenArray(frmt, LOC12, 4);
	{
		...
		msgwriteln_196236(s);
		{
			...
			if (!(LOC19)) goto LA20;
			LOC21 = HEX2EHEX2E_196864(((NU16) 0), ((NU16) 229));
			LOC19 = contains_196884(LOC21, msg);
			LA20: ;
			if (!LOC19) goto LA22;
...
N_NIMCALL(void, message_196976)(tlineinfo194539 info, NU16 msg, NimStringDesc* arg) {
	limessage_196774(info, msg, arg, ((NU8) 0));
}
...
N_NIMCALL(void, internalerror_196987)(tlineinfo194539 info, NimStringDesc* errmsg) {
	...
	LA3: ;
	writecontext_196590(info);
	limessage_196774(info, ((NU16) 2), errmsg, ((NU8) 1));
	BeforeRet: ;
}
...
N_NIMCALL(NI32, fileinfoidx_194747)(NimStringDesc* filename) {
	...
	pushSafePoint(&TMP1072);
	TMP1072.status = _setjmp(TMP1072.context);
	if (TMP1072.status == 0) {
		canon = canonicalizepath_168390(filename);
		shallow_85424((&canon));
		popSafePoint();
	}
	else {
	...
	if (TMP1072.status != 0) reraiseException();
	{
		NIM_BOOL LOC6;
		LOC6 = 0;
...
appendString(LOC12, ((NimStringDesc*) &TMP1982));
...
N_NIMCALL(void, globalerror_196934)(tlineinfo194539 info, NU16 msg, NimStringDesc* arg) {
	limessage_196774(info, msg, arg, ((NU8) 2));
}
...
N_NIMCALL(void, clearbufferedmsgs_195449)(void) {
	genericSeqAssign((&bufferedmsgs_195438), NIM_NIL, (&NTI118808));
}
N_NIMCALL(void, TMP2697)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_195846)(void) {
	...
	LA3: ;
	{
		...
		LOC8 = 0;
		LOC8 = (*e_195850).Sup.message; (*e_195850).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2698));
...
N_NIMCALL(void, globalerror_196945)(tlineinfo194539 info, NimStringDesc* arg) {
	limessage_196774(info, ((NU16) 4), arg, ((NU8) 2));
}
...
N_NIMCALL(NimStringDesc*, formatmsg_196757)(tlineinfo194539 info, NU16 msg, NimStringDesc* arg) {
	...
	LOC4[0] = tomsgfilename_196061(info);
	LOC4[1] = coordtostr_196368(((NI) (info.Line)));
	LOC4[2] = coordtostr_196368(((NI) (info.Col)));
	LOC4[3] = getmessagestr_196388(msg, arg);
	result = nsuFormatOpenArray(frmt, LOC4, 4);
	return result;
}

N_NIMCALL(void, localerror_196966)(tlineinfo194539 info, NimStringDesc* arg) {
	limessage_196774(info, ((NU16) 4), arg, ((NU8) 0));
}

N_NIMCALL(void, fatal_196923)(tlineinfo194539 info, NU16 msg, NimStringDesc* arg) {
	limessage_196774(info, msg, arg, ((NU8) 1));
}
...
NIM_EXTERNC N_NOINLINE(void, HEX00_msgsInit)(void) {
	...
	gnotes_195305 = IL64(70368695418879);
	...
	LOC3.ClPrc = ((TMP433) (HEX3Aanonymous_197195)); LOC3.ClEnv = NIM_NIL;
...
static TNimNode* TMP1974[276];
NI TMP1976;
static char* NIM_CONST TMP1975[276] = {
"errUnknown", 
"errIllFormedAstX", 
"errInternal", 
"errCannotOpenFile", 
...
NTI195253.marker = TMP430;
NTI194205.size = sizeof(NU16);
NTI194205.kind = 14;
NTI194205.base = 0;
NTI194205.flags = 3;
for (TMP1976 = 0; TMP1976 < 276; TMP1976++) {
TMP19[TMP1976+11].kind = 1;
TMP19[TMP1976+11].offset = TMP1976;
TMP19[TMP1976+11].name = TMP1975[TMP1976];
TMP1974[TMP1976] = &TMP19[TMP1976+11];
}
TMP19[287].len = 276; TMP19[287].kind = 2; TMP19[287].sons = &TMP1974[0];
NTI194205.node = &TMP19[287];
