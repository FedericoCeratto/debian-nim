...
N_NIMCALL(NI, nimParseBiggestFloat)(NimStringDesc* s, NF* number, NI start);
N_NIMCALL(NI, rawparseint_94208)(NimStringDesc* s, NI64* b, NI start);
...
STRING_LITERAL(TMP1374, "overflow", 8);
	...
	LA1: ;
	{
		...
		(*b) = IL64(0);
		{
			while (1) {
				...
				TMP1079 = mulInt64((*b), IL64(10));
				TMP1080 = subInt(((NI) (((NU8)(s->data[i])))), 48);
				TMP1081 = subInt64((NI64)(TMP1079), ((NI64) ((NI32)(TMP1080))));
				(*b) = (NI64)(TMP1081);
				i = addInt(i, 1);
				{
					while (1) {
		...
		TMP1082 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP1082);
		TMP1083 = subInt(i, start);
		result = (NI32)(TMP1083);
	}
	LA10: ;
	return result;
...
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* s, NI64* number, NI start) {
	...
	result = 0;
	res = 0;
	result = rawparseint_94208(s, (&res), start);
	(*number) = res;
	return result;
}
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = npuParseBiggestInt(s, (&res), start);
	{
		...
		if (!LOC3) goto LA7;
		e_94369 = 0;
		e_94369 = (overflowerror3243*) newObj((&NTI22201), sizeof(overflowerror3243));
		(*e_94369).Sup.Sup.Sup.m_type = (&NTI3243);
		LOC9 = 0;
		LOC9 = (*e_94369).Sup.Sup.message; (*e_94369).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1374));
		if (LOC9) nimGCunrefNoCycle(LOC9);
		raiseException((Exception*)e_94369, "OverflowError");
	}
	goto LA1;
	LA7: ;
	{
