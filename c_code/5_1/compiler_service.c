...
N_NIMCALL(void, processcmdline_563203_3526807654)(Tcmdlinepass252008 pass0, NimStringDesc* cmd0) {
	...
	argscount0 = ((NI) 0);
	{
		while (1) {
			...
			{
				{
					if (!eqStrings(p0.key, ((NimStringDesc*) &TMP1830))) goto LA7;
					p0.key = copyString(((NimStringDesc*) &TMP1831));
					{
						NIM_BOOL LOC11;
						LOC11 = (NIM_BOOL)0;
	...
	} LA1: ;
	{
		if (!(pass0 == ((Tcmdlinepass252008) 1))) goto LA23;
		{
			...
			LOC27 = !(eqStrings(LOC31, ((NimStringDesc*) &TMP2193)));
			LA30: ;
			if (!LOC27) goto LA32;
