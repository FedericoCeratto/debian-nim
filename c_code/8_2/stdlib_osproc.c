		...
		getenvvarsc_119002();
		{
			...
			res_140899 = 0;
			{
				while (1) {
					...
					key_140859 = copyStrLast(environment_118809->data[i_140895], 0, (NI64)(p_140901 - 1));
					val_140860 = copyStr(environment_118809->data[i_140895], (NI64)(p_140901 + 1));
					counter += 1;
					res_140899 += 1;
				} LA4: ;
			}
		...
		getenvvarsc_119002();
		{
			...
			res_140918 = 0;
			{
				while (1) {
					...
					key_140875 = copyStrLast(environment_118809->data[i_140914], 0, (NI64)(p_140920 - 1));
					val_140876 = copyStr(environment_118809->data[i_140914], (NI64)(p_140920 + 1));
					LOC10 = 0;
