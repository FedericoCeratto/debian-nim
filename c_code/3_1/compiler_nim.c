...
STRING_LITERAL(TMP1991, "-", 1);
STRING_LITERAL(TMP1992, "stdinfile", 9);
STRING_LITERAL(TMP2020, "nim.cfg", 7);
STRING_LITERAL(TMP2021, "nims", 4);
STRING_LITERAL(TMP3704, "config.nims", 11);
STRING_LITERAL(TMP5287, "./", 2);
STRING_LITERAL(TMP5288, "js", 2);
...
appendString(LOC7, ((NimStringDesc*) &TMP5287));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
{	{
	...
	LA4: ;
	{
		...
		processcmdline_575209(((NU8) 0), ((NimStringDesc*) &TMP1990));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_167234, ((NimStringDesc*) &TMP1991))) goto LA9;
			LOC11 = 0;
			LOC11 = gprojectname_167234; gprojectname_167234 = copyStringRC1(((NimStringDesc*) &TMP1992));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = 0;
			LOC12 = gprojectfull_167236; gprojectfull_167236 = copyStringRC1(((NimStringDesc*) &TMP1992));
		...
		LA9: ;
		{
			...
			pushSafePoint(&TMP1993);
			TMP1993.status = _setjmp(TMP1993.context);
			if (TMP1993.status == 0) {
			...
			if (TMP1993.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_221609(((NimStringDesc*) &TMP2020));
		scriptfile = noschangeFileExt(gprojectfull_167236, ((NimStringDesc*) &TMP2021));
		{
			NIM_BOOL LOC25;
			LOC25 = 0;
			LOC25 = fileexists_128210(scriptfile);
			if (!LOC25) goto LA26;
		...
		LA26: ;
		{
			...
			NimStringDesc* LOC37;
			LOC33 = 0;
			LOC33 = HEX2F_124681(gprojectpath_167235, ((NimStringDesc*) &TMP3704));
			LOC34 = 0;
			LOC34 = fileexists_128210(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = 0;
			LOC37 = HEX2F_124681(gprojectpath_167235, ((NimStringDesc*) &TMP3704));
		...
		LA23: ;
		initvars_204076();
		processcmdline_575209(((NU8) 1), ((NimStringDesc*) &TMP1990));
		{
			...
			if (!(gerrorcounter_191399 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_167132 &(1<<((((NU8) 13))&31)))!=0)) goto LA55;
				{
					...
					LA63: ;
					{
						...
						NimStringDesc* LOC69;
						LOC67 = 0;
						LOC67 = noschangeFileExt(gprojectfull_167236, ((NimStringDesc*) &TMP5288));
						LOC68 = 0;
...
appendString(LOC70, ((NimStringDesc*) &TMP5293));
...
appendString(LOC70, arguments_212837);
				...
				LA59: ;
				{
					...
					LA75: ;
					{
						NimStringDesc* LOC78;
						LOC78 = 0;
						LOC78 = noschangeFileExt(gprojectfull_167236, ((NimStringDesc*) &TMP1990));
