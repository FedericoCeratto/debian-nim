...
N_NIMCALL(NimStringDesc*, paramstr_123609)(NI i) {
	...
	LOC7 = 0;
	LOC7 = (*e_123616).Sup.message; (*e_123616).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1077));
...
N_NIMCALL(NimStringDesc*, getapplheuristic_124204)(void) {
	...
	result = paramstr_123609(0);
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			p_124403 = 0;
			HEX3Atmp_124410 = 0;
			HEX3Atmp_124410 = getenv_120442(((NimStringDesc*) &TMP1078));
			last_124415 = 0;
			{
				while (1) {
					NI first_124417;
...
N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	NimStringDesc* result;
	result = 0;
	result = getenv_120442(((NimStringDesc*) &TMP1075));
	{
...
N_NIMCALL(NimStringDesc*, nosgetHomeDir)(void) {
	...
	LOC1 = 0;
	LOC2 = 0;
	LOC2 = getenv_120442(((NimStringDesc*) &TMP1682));
