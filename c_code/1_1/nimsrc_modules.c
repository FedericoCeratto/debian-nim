...
STRING_LITERAL(TMP1518, "modules.nim", 11);
NIM_CONST TY88145 TMP1517 = {((NimStringDesc*) &TMP1518),
((NI) 41)}
;
STRING_LITERAL(TMP4265, "", 0);
STRING_LITERAL(TMP4266, "nim", 3);
STRING_LITERAL(TMP4267, "system.nim", 10);
STRING_LITERAL(TMP4977, "stdin", 5);
	...
	result = getmodule_523077(fileidx);
	{
		...
		(*result).flags = ((*result).flags | flags);
		{
			...
			rd = handlesymbolfile_234071(result);
			{
				...
				internalerror_166218(((NimStringDesc*) &TMP1513));
				goto BeforeRet;
			}
			LA15: ;
		}
...
N_NIMCALL(void, wantmainmodule_523922)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_166123(gcmdlineinfo_164922, ((NU16) 186), ((NimStringDesc*) &TMP4265));
	}
	LA3: ;
	LOC5 = 0;
	LOC5 = nosaddFileExt(gprojectfull_155236, ((NimStringDesc*) &TMP4266));
...
N_NIMCALL(void, compilesystemmodule_523901)(void) {
	{
		...
		LOC5 = 0;
		LOC5 = HEX2F_118492(libpath_155233, ((NimStringDesc*) &TMP4267));
...
N_NIMCALL(void, compileproject_523985)(NI32 projectfileidx) {
	...
	LOC1 = 0;
	LOC1 = HEX2F_118492(libpath_155233, ((NimStringDesc*) &TMP4267));
...
N_NIMCALL(Tsym191843*, makestdinmodule_524003)(void) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = fileinfoidx_164854(((NimStringDesc*) &TMP4977));
...
TMP1092[0] = &TMP1090[1];
TMP1090[1].kind = 1;
TMP1090[1].offset = offsetof(Tmoduleinmemory523017, compiledat);
TMP1090[1].typ = (&NTI128);
TMP1090[1].name = "compiledAt";
TMP1092[1] = &TMP1090[2];
TMP1090[2].kind = 1;
TMP1090[2].offset = offsetof(Tmoduleinmemory523017, crc);
TMP1090[2].typ = (&NTI170015);
TMP1090[2].name = "crc";
TMP1092[2] = &TMP1090[3];
TMP1090[3].kind = 1;
TMP1090[3].offset = offsetof(Tmoduleinmemory523017, deps);
TMP1090[3].typ = (&NTI191933);
TMP1090[3].name = "deps";
TMP1092[3] = &TMP1090[4];
...
NTI523013.node = &TMP1090[10];
TMP1090[4].kind = 1;
TMP1090[4].offset = offsetof(Tmoduleinmemory523017, needsrecompile);
TMP1090[4].typ = (&NTI523013);
...
NTI523015.node = &TMP1090[16];
TMP1090[11].kind = 1;
TMP1090[11].offset = offsetof(Tmoduleinmemory523017, crcstatus);
TMP1090[11].typ = (&NTI523015);
TMP1090[11].name = "crcStatus";
TMP1090[0].len = 5; TMP1090[0].kind = 2; TMP1090[0].sons = &TMP1092[0];
NTI523017.node = &TMP1090[0];
NTI523054.size = sizeof(TY523054*);
NTI523054.kind = 24;
NTI523054.base = (&NTI523017);
NTI523054.flags = 2;
NTI523054.marker = TMP1099;
}
