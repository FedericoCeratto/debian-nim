...
STRING_LITERAL(TMP2195, "stdinfile", 9);
STRING_LITERAL(TMP2224, "nim.cfg", 7);
STRING_LITERAL(TMP2225, "nims", 4);
STRING_LITERAL(TMP3895, "config.nims", 11);
STRING_LITERAL(TMP5577, "./", 2);
STRING_LITERAL(TMP5578, "js", 2);
STRING_LITERAL(TMP5582, " ", 1);
STRING_LITERAL(TMP5583, "php", 3);
STRING_LITERAL(TMP5584, "php ", 4);
...
appendString(LOC7, ((NimStringDesc*) &TMP5577));
...
{	{
	...
	LA4: ;
	{
		...
		processcmdline_563203_3526807654(((Tcmdlinepass252008) 0), ((NimStringDesc*) &TMP2193));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_164205_2607990831, ((NimStringDesc*) &TMP2194))) goto LA9;
			LOC11 = (NimStringDesc*)0;
			LOC11 = gprojectname_164205_2607990831; gprojectname_164205_2607990831 = copyStringRC1(((NimStringDesc*) &TMP2195));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = (NimStringDesc*)0;
			LOC12 = gprojectfull_164207_2607990831; gprojectfull_164207_2607990831 = copyStringRC1(((NimStringDesc*) &TMP2195));
		...
		LA9: ;
		{
			...
			pushSafePoint(&TMP2196);
			TMP2196.status = _setjmp(TMP2196.context);
			if (TMP2196.status == 0) {
			...
			if (TMP2196.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_262603_930198375(((NimStringDesc*) &TMP2224));
		scriptfile0 = noschangeFileExt(gprojectfull_164207_2607990831, ((NimStringDesc*) &TMP2225));
		{
			NIM_BOOL LOC25;
			LOC25 = (NIM_BOOL)0;
		...
		LA26: ;
		{
			...
			LOC33 = HEX2F_124665_2125978480(gprojectpath_164206_2607990831, ((NimStringDesc*) &TMP3895));
			LOC34 = (NIM_BOOL)0;
			LOC34 = fileexists_128004_2125978480(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = (NimStringDesc*)0;
			LOC37 = HEX2F_124665_2125978480(gprojectpath_164206_2607990831, ((NimStringDesc*) &TMP3895));
		...
		processcmdline_563203_3526807654(((Tcmdlinepass252008) 1), ((NimStringDesc*) &TMP2193));
		{
			...
			if (!(gerrorcounter_187081_155036129 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_164127_2607990831 &(1U<<((NU)(((Tglobaloption164013) 13))&31U)))!=0)) goto LA55;
				{
					...
					LA63: ;
					{
						...
						LOC67 = noschangeFileExt(gprojectfull_164207_2607990831, ((NimStringDesc*) &TMP5578));
...
appendString(LOC70, ((NimStringDesc*) &TMP5582));
...
appendString(LOC70, arguments_253716_2004575671);
				...
				LA59: ;
				{
					...
					LA77: ;
					{
						...
						LOC81 = noschangeFileExt(gprojectfull_164207_2607990831, ((NimStringDesc*) &TMP5583));
...
appendString(LOC84, ((NimStringDesc*) &TMP5584));
...
appendString(LOC84, arguments_253716_2004575671);
				...
				LA73: ;
				{
					...
					LA88: ;
					{
						...
						LOC91 = noschangeFileExt(gprojectfull_164207_2607990831, ((NimStringDesc*) &TMP2193));
