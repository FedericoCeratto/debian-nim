...
N_NIMCALL(Tllstream178204*, filterstrip_216012)(Tllstream178204* stdin_216014, NimStringDesc* filename, Tnode190813* call) {
	...
	NimStringDesc* line;
	result = 0;
	pattern = strarg_216029(call, ((NimStringDesc*) &TMP1418), ((NI) 1), ((NimStringDesc*) &TMP1419));
	leading = boolarg_216038(call, ((NimStringDesc*) &TMP1422), ((NI) 2), NIM_TRUE);
	trailing = boolarg_216038(call, ((NimStringDesc*) &TMP1423), ((NI) 3), NIM_TRUE);
...
N_NIMCALL(Tllstream178204*, filterreplace_216004)(Tllstream178204* stdin_216006, NimStringDesc* filename, Tnode190813* call) {
	...
	NimStringDesc* line;
	result = 0;
	sub = strarg_216029(call, ((NimStringDesc*) &TMP1424), ((NI) 1), ((NimStringDesc*) &TMP1419));
	{
		if (!((sub ? sub->Sup.len : 0) == ((NI) 0))) goto LA3;
		invalidpragma_216047(call);
	}
	LA3: ;
	by = strarg_216029(call, ((NimStringDesc*) &TMP1425), ((NI) 2), ((NimStringDesc*) &TMP1419));
	result = llstreamopen_178220(((NimStringDesc*) &TMP1419));
	line = rawNewString(((NI) 80));
	{
		while (1) {
