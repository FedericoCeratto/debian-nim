...
N_NIMCALL(Smallchunk30240*, getsmallchunk_36812_1689653243)(Memregion30286* a0);
N_NIMCALL(Bigchunk30242*, getbigchunk_36014_1689653243)(Memregion30286* a0, NI size0);
static N_INLINE(void, listremove_33802_1689653243)(Bigchunk30242** head0, Bigchunk30242* c0);
N_NIMCALL(void, splitchunk_35809_1689653243)(Memregion30286* a0, Bigchunk30242* c0, NI size0);
static N_INLINE(void, updateprevsize_32868_1689653243)(Memregion30286* a0, Bigchunk30242* c0, NI prevsize0);
static N_INLINE(NIM_BOOL, isaccessible_32815_1689653243)(Memregion30286* a0, void* p0);
...
N_NIMCALL(void, incl_31553_1689653243)(Memregion30286* a0, Intset30214* s0, NI key0);
N_NIMCALL(Trunk30210*, intsetput_31505_1689653243)(Memregion30286* a0, Intset30214* t0, NI key0);
...
static N_INLINE(void, listadd_35023_1689653243)(Bigchunk30242** head0, Bigchunk30242* c0);
...
N_NIMCALL(Avlnode30284*, allocavlnode_30627_1689653243)(Memregion30286* a0, NI key0, NI upperbound0);
...
N_NIMCALL(void, dealloc_46822_1689653243)(Memregion30286* allocator0, void* p0);
N_NIMCALL(void, rawdealloc_43817_1689653243)(Memregion30286* a0, void* p0);
...
N_NIMCALL(void, del_31401_1689653243)(Memregion30286* a0, Avlnode30284** t0, NI x0);
...
static N_INLINE(NI, getoccupiedmem_48030_1689653243)(Memregion30286* a0);
...
TNimType NTI30219; /* array[0..7, int] */
...
N_NIMCALL(NIM_BOOL, contains_31532_1689653243)(Intset30214* s0, NI key0) {
	...
	Trunk30210* t0;
	result0 = (NIM_BOOL)0;
	t0 = intsetget_31483_1689653243(s0, (NI)((NU64)(key0) >> (NU64)(((NI) 9))));
	{
		NI u0;
...
static N_INLINE(void, updateprevsize_32868_1689653243)(Memregion30286* a0, Bigchunk30242* c0, NI prevsize0) {
	Basechunk30238* ri0;
	ri0 = ((Basechunk30238*) ((NI)((NU64)(((NI) (c0))) + (NU64)((*c0).Sup.size))));
	{
		NIM_BOOL LOC3;
		LOC3 = (NIM_BOOL)0;
...
N_NIMCALL(void, incl_31553_1689653243)(Memregion30286* a0, Intset30214* s0, NI key0) {
	Trunk30210* t0;
	NI u0;
	t0 = intsetput_31505_1689653243(a0, s0, (NI)((NU64)(key0) >> (NU64)(((NI) 9))));
	u0 = (NI)(key0 & ((NI) 511));
...
N_NIMCALL(void, splitchunk_35809_1689653243)(Memregion30286* a0, Bigchunk30242* c0, NI size0) {
	...
	Basechunk30238* LOC1;
	NI LOC2;
	rest0 = ((Bigchunk30242*) ((NI)((NU64)(((NI) (c0))) + (NU64)(size0))));
...
N_NIMCALL(Bigchunk30242*, requestoschunks_31988_1689653243)(Memregion30286* a0, NI size0) {
	...
	void* LOC1;
	NI nxt0;
	Basechunk30238* next0;
	NI lastsize0;
	NI prv0;
	Basechunk30238* prev0;
...
N_NIMCALL(void, freebigchunk_33003_1689653243)(Memregion30286* a0, Bigchunk30242* c_33007_1689653243) {
	...
	LA5: ;
	{
		...
		le0 = ((Basechunk30238*) ((NI)((NU64)(((NI) (c0))) - (NU64)((*c0).Sup.prevsize))));
		{
			NIM_BOOL LOC19;
			LOC19 = (NIM_BOOL)0;
...
N_NIMCALL(void, rawdealloc_43817_1689653243)(Memregion30286* a0, void* p0) {
	Basechunk30238* c_44001_1689653243;
	c_44001_1689653243 = pageaddr_31981_1689653243(p0);
	{
		...
		if (!LOC3) goto LA4;
		c0 = ((Smallchunk30240*) (c_44001_1689653243));
		s0 = (*c0).Sup.size;
		f0 = ((Freecell30230*) (p0));
		(*f0).zerofield = ((NI) 0);
		(*f0).next = (*c0).freelist;
		...
		LA8: ;
		{
			(*c0).free += s0;
			{
				if (!((*c0).free == (NI)(((NI) 4096) - (NI)(((NI)sizeof(Smallchunk30240)) - ((NI) 8))))) goto LA13;
	...
	{
		Bigchunk30242* c0;
		c0 = ((Bigchunk30242*) (c_44001_1689653243));
		(*a0).deleted = bottom_30321_1689653243;
...
N_NIMCALL(void, dealloc_46822_1689653243)(Memregion30286* allocator0, void* p0) {
	void* x0;
	x0 = ((void*) ((NI)((NU64)(((NI) (p0))) - (NU64)(((NI)sizeof(Freecell30230))))));
...
N_NOINLINE(void, incl_48847_1689653243)(Cellset48117* s0, Cell48105* cell0) {
	...
	Pagedesc48113* t0;
	u0 = ((NI) (cell0));
	t0 = cellsetput_48641_1689653243(s0, (NI)((NU64)(u0) >> (NU64)(((NI) 12))));
...
static N_INLINE(void*, celltousr_52222_1689653243)(Cell48105* cell0) {
	void* result0;
	result0 = (void*)0;
	result0 = ((void*) ((NI)((NU64)(((NI) (cell0))) + (NU64)(((NI)sizeof(Cell48105))))));
	return result0;
}
			...
			res_56809_1689653243 = ((NI) 0);
			{
				while (1) {
					...
					i_56657_1689653243 = res_56809_1689653243;
					{
						...
						{
							if (!((289406976 &((NU64)1<<((NU)((*(*(*n0).sons[(i_56657_1689653243)- 0]).typ).kind)&63U)))!=0)) goto LA12;
							dooperation_52618_1689653243((*((void**) ((NI)((NU64)(d0) + (NU64)((*(*n0).sons[(i_56657_1689653243)- 0]).offset))))), op0);
						}
						goto LA10;
						LA12: ;
						{
							forallchildrenaux_52622_1689653243(((void*) ((NI)((NU64)(d0) + (NU64)((*(*n0).sons[(i_56657_1689653243)- 0]).offset)))), (*(*n0).sons[(i_56657_1689653243)- 0]).typ, op0);
						}
						LA10: ;
					}
					goto LA6;
...
N_NIMCALL(NIM_BOOL, containsorincl_48913_1689653243)(Cellset48117* s0, Cell48105* cell0) {
	...
	result0 = (NIM_BOOL)0;
	u0 = ((NI) (cell0));
	t0 = cellsetget_48259_1689653243((&(*s0)), (NI)((NU64)(u0) >> (NU64)(((NI) 12))));
	{
		if (!!((t0 == NIM_NIL))) goto LA3;
		u0 = (NI)((NU64)((NI)((NU64)(u0) % (NU64)(((NI) 4096)))) / (NU64)(((NI) 8)));
...
N_NIMCALL(void*, interiorallocatedptr_45492_1689653243)(Memregion30286* a0, void* p0) {
	...
	{
		NIM_BOOL LOC3;
		Basechunk30238* c_45497_1689653243;
		LOC3 = (NIM_BOOL)0;
		...
		c_45497_1689653243 = pageaddr_31981_1689653243(p0);
		{
			...
			if (!!(LOC8)) goto LA9;
			{
				...
				if (!LOC13) goto LA14;
				c0 = ((Smallchunk30240*) (c_45497_1689653243));
				offset0 = (NI)((NU64)(((NI) ((NI)(((NI) (p0)) & ((NI) 4095))))) - (NU64)((NI)(((NI)sizeof(Smallchunk30240)) - ((NI) 8))));
				{
					Freecell30230* d0;
					if (!((NU64)(offset0) < (NU64)((*c0).acc))) goto LA18;
					d0 = ((Freecell30230*) ((NI)((NU64)((NI)((NU64)(((NI) ((&(*c0).data)))) + (NU64)(offset0))) - (NU64)((NI)((NU64)(offset0) % (NU64)((*c0).Sup.size))))));
					{
			...
			LA14: ;
			{
				Bigchunk30242* c0;
				NF* d0;
				c0 = ((Bigchunk30242*) (c_45497_1689653243));
				d0 = (&(*c0).data);
				{
					NIM_BOOL LOC27;
					LOC27 = (NIM_BOOL)0;
					LOC27 = (((void*) (d0)) <= p0);
					if (!(LOC27)) goto LA28;
					LOC27 = ((NU64)(((NI) 1)) < (NU64)((*((Freecell30230*) (d0))).zerofield));
					LA28: ;
					if (!LOC27) goto LA29;
					result0 = ((void*) (d0));
				}
	...
	LA4: ;
	{
		...
		q0 = ((NI) (p0));
		{
			...
			avlnode0 = inrange_31281_1689653243((*a0).root, q0);
			{
				void* k0;
				Bigchunk30242* c0;
				Basechunk30238* LOC42;
				if (!!((avlnode0 == NIM_NIL))) goto LA40;
				k0 = ((void*) ((*avlnode0).key));
				LOC42 = (Basechunk30238*)0;
				LOC42 = pageaddr_31981_1689653243(k0);
				c0 = ((Bigchunk30242*) (LOC42));
				{
					if (!((NU64)(((NI) 1)) < (NU64)((*((Freecell30230*) (k0))).zerofield))) goto LA45;
					result0 = k0;
				}
				LA45: ;
			}
	...
	jmp_buf registers0;
	{
		...
		regend0 = (NI)((NU64)(sp0) + (NU64)(((NI)sizeof(jmp_buf))));
		{
			while (1) {
				...
				gcmark_70810_1689653243(gch0, (*((void**) ((NI)((NU64)(sp0) + (NU64)(((NI) 4)))))));
							...
							while (1) {
								...
								i_68228_1689653243 = ((NI) 0);
								{
									while (1) {
										...
										if (!(i_68228_1689653243 <= ((NI) 7))) goto LA9;
										...
										j_68232_1689653243 = ((NI) 0);
										{
											while (1) {
												if (!!((w_68230_1689653243 == ((NI) 0)))) goto LA11;
												{
													...
													s_68218_1689653243 = (NI)((NI)((NU64)((*r_68226_1689653243).key) << (NU64)(((NI) 9))) | (NI)((NU64)((NI)((NU64)(i_68228_1689653243) << (NU64)(((NI) 6)))) + (NU64)(j_68232_1689653243)));
													{
														NIM_BOOL LOC18;
														Basechunk30238* c_68234_1689653243;
														LOC18 = (NIM_BOOL)0;
														LOC18 = contains_31532_1689653243((&(*gch0).region.chunkstarts), s_68218_1689653243);
														if (!LOC18) goto LA19;
														c_68234_1689653243 = ((Basechunk30238*) ((NI)((NU64)(s_68218_1689653243) << (NU64)(((NI) 12)))));
														{
															NIM_BOOL LOC23;
															LOC23 = (NIM_BOOL)0;
															...
															{
																NIM_BOOL LOC28;
																Smallchunk30240* c_68237_1689653243;
																...
																if (!LOC28) goto LA29;
																c_68237_1689653243 = ((Smallchunk30240*) (c_68234_1689653243));
																...
																{
																	while (1) {
																		if (!((NU64)(a_68242_1689653243) < (NU64)(limit_68245_1689653243))) goto LA32;
																		...
																		LA36: ;
																		a_68242_1689653243 = (NI)((NU64)(a_68242_1689653243) + (NU64)(size_68240_1689653243));
																	} LA32: ;
																}
															}
															goto LA26;
															LA29: ;
															{
																Bigchunk30242* c_68248_1689653243;
																c_68248_1689653243 = ((Bigchunk30242*) (c_68234_1689653243));
												...
												w_68230_1689653243 = (NI)((NU64)(w_68230_1689653243) >> (NU64)(((NI) 1)));
											} LA11: ;
										}
...
N_NIMCALL(void*, growobj_64003_1689653243)(void* old0, NI newsize0, Gcheap50618* gch0) {
	...
	zeroMem(((void*) ((NI)((NU64)((NI)((NU64)(((NI) (res0))) + (NU64)(oldsize0))) + (NU64)(((NI)sizeof(Cell48105)))))), ((NI) ((NI)(newsize0 - oldsize0))));
	{
...
N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest0, NI addlen0) {
	...
	LA3: ;
	{
		...
		void* LOC7;
		LOC6 = (NI)0;
		LOC6 = resize_79201_1689653243((NI)((*dest0).Sup.reserved & ((NI) IL64(9223372036854775807))));
...
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s0, NIM_CHAR c0) {
	...
	result0 = s0;
	{
		...
		(*result0).Sup.reserved = resize_79201_1689653243((NI)((*result0).Sup.reserved & ((NI) IL64(9223372036854775807))));
		LOC5 = (void*)0;
		...
		if (!(newlen0 < (*result0).len)) goto LA8;
		{
			...
			res_80490_1689653243 = newlen0;
			{
				while (1) {
					...
					forallchildrenaux_52622_1689653243(((void*) ((NI)((NU64)((NI)((NU64)(((NI) (result0))) + (NU64)(((NI) 16)))) + (NU64)((NI)((NU64)(i_80410_1689653243) * (NU64)(elemsize0)))))), (*LOC13).base, ((Walkop50610) 2));
...
NTI30219.size = sizeof(TY30219);
NTI30219.kind = 16;
NTI30219.base = (&NTI104);
NTI30219.flags = 3;
