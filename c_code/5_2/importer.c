...
STRING_LITERAL(TMP3325, "as", 2);
STRING_LITERAL(TMP3326, " ", 1);
STRING_LITERAL(TMP3327, ".", 1);
STRING_LITERAL(TMP3328, "/", 1);
STRING_LITERAL(TMP3329, "invalid module name: \'$1\'", 25);
STRING_LITERAL(TMP3330, "module alias must be an identifier", 34);
STRING_LITERAL(TMP3331, "A module cannot import itself", 29);
STRING_LITERAL(TMP3332, "importAllSymbols: ", 18);
STRING_LITERAL(TMP3333, "rawImportSymbol", 15);
STRING_LITERAL(TMP3335, "importSymbol: 2", 15);
STRING_LITERAL(TMP3336, "importSymbol: 3", 15);
...
N_NIMCALL(NimStringDesc*, getmodulename_298018)(tnode225816* n) {
	...
	case ((NU8) 22):
	{
		result = nosunixToNativePath((*n).kindU.S3.Strval, ((NimStringDesc*) &TMP3324));
	}
	break;
	case ((NU8) 2):
	{
	...
	case ((NU8) 29):
	{
		NimStringDesc* LOC12;
		{
			...
			if (!(LOC7)) goto LA8;
			LOC9 = 0;
			LOC9 = getident_200472(((NimStringDesc*) &TMP3325));
		...
		result = nsuReplaceStr(LOC12, ((NimStringDesc*) &TMP3326), ((NimStringDesc*) &TMP3324));
	}
	break;
	case ((NU8) 45):
	{
		...
		result = nsuReplaceStr(LOC14, ((NimStringDesc*) &TMP3327), ((NimStringDesc*) &TMP3328));
	}
	break;
	case ((NU8) 78):
	{
	...
	default:
	{
		...
		LOC18 = 0;
		LOC18 = nsuFormatSingleElem(((NimStringDesc*) &TMP3329), LOC17);
		localerror_197955((*n).Info, ((NU16) 4), LOC18);
		result = copyString(((NimStringDesc*) &TMP3324));
	}
	break;
	}
	BeforeRet: ;
...
N_NIMCALL(tsym225846*, myimportmodule_298991)(tcontext290021* c, tnode225816* n) {
	...
	f = checkmodulename_298237(n);
	{
		...
		result = importmoduleas_298892(n, LOC5);
		{
			...
			localerror_197955((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3331));
		}
		LA8: ;
		{
				...
				res_298427 = 0;
				{
					while (1) {
						...
						e = (*(*(*etyp).N).kindU.S6.Sons->data[j_298336]).kindU.S4.Sym;
						{
							...
							internalerror_197987((*s).Info, ((NimStringDesc*) &TMP3333));
						}
						LA27: ;
...
appendString(LOC15, ((NimStringDesc*) &TMP3332));
			...
			e = initidentiter_235147((&it), (*frommod).kindU.S3.Tab, (*s).Name);
			{
				while (1) {
					if (!!((e == NIM_NIL))) goto LA16;
					{
						...
						internalerror_197987((*n).Info, ((NimStringDesc*) &TMP3336));
					}
					LA19: ;
					rawimportsymbol_298249(c, e);
