...
N_NIMCALL(void, tmtotimeinfo_101848)(struct tm* tm, NIM_BOOL local, timeinfo101205* Result) {
	...
	LA4: ;
	{
		LOC1.Tzname = copyString(((NimStringDesc*) &TMP3099));
	}
	LA2: ;
	{
		if (!local) goto LA16;
...
"mNov", 
"mDec"};
static TNimNode* TMP3096[7];
NI TMP3098;
static char* NIM_CONST TMP3097[7] = {
"dMon", 
"dTue", 
"dWed", 
"dThu", 
...
TMP15[TMP3095+6].kind = 1;
TMP15[TMP3095+6].offset = TMP3095;
TMP15[TMP3095+6].name = TMP3094[TMP3095];
TMP3093[TMP3095] = &TMP15[TMP3095+6];
}
TMP15[18].len = 12; TMP15[18].kind = 2; TMP15[18].sons = &TMP3093[0];
...
NTI101008.base = 0;
NTI101008.flags = 3;
for (TMP3098 = 0; TMP3098 < 7; TMP3098++) {
TMP15[TMP3098+21].kind = 1;
TMP15[TMP3098+21].offset = TMP3098;
TMP15[TMP3098+21].name = TMP3097[TMP3098];
TMP3096[TMP3098] = &TMP15[TMP3098+21];
}
TMP15[28].len = 7; TMP15[28].kind = 2; TMP15[28].sons = &TMP3096[0];
...
TMP15[0].len = 11; TMP15[0].kind = 2; TMP15[0].sons = &TMP3092[0];
