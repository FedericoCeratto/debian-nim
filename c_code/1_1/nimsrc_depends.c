...
STRING_LITERAL(TMP4954, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP4955, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP4956, "", 0);
STRING_LITERAL(TMP4957, "dot", 3);
...
N_NIMCALL(void, adddependencyaux_507028)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	addf_163635(&gdotgraph_507023, ((NimStringDesc*) &TMP4954), LOC1, 2);
}
...
N_NIMCALL(void, generatedot_507009)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP4956));
	LOC1[0] = rope_162320(LOC3);
	LOC1[1] = gdotgraph_507023;
	LOC4 = 0;
	LOC4 = HEX25_163235(((NimStringDesc*) &TMP4955), LOC1, 2);
	LOC5 = 0;
	LOC5 = noschangeFileExt(project, ((NimStringDesc*) &TMP4957));
...
TMP1068[0].kind = 1;
TMP1068[0].offset = offsetof(Tgen507016, module);
TMP1068[0].typ = (&NTI191811);
TMP1068[0].name = "module";
NTI507016.node = &TMP1068[0];
NTI507018.size = sizeof(Tgen507016*);
NTI507018.kind = 22;
NTI507018.base = (&NTI507016);
NTI507018.marker = TMP4953;
}
