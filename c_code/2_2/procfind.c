...
STRING_LITERAL(TMP3044, "public implementation \'$1\' has non-public forward declaration i"
"n $2", 67);
...
appendString(LOC1, ((NimStringDesc*) &TMP3047));
	result = LOC1;
	return result;
}
				...
				{
					{
						...
						message = nsuFormatOpenArray(((NimStringDesc*) &TMP3044), LOC17, 2);
