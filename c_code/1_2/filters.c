...
N_NIMCALL(NIM_BOOL, boolarg_259038)(tnode226816* n, NimStringDesc* name, NI pos, NIM_BOOL default_259043) {
	...
	LA3: ;
	{
		...
		LOC6 = ((*x).Kind == ((NU8) 2));
		if (!(LOC6)) goto LA7;
		LOC6 = identeq_201493((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP1359));
		LA7: ;
		if (!LOC6) goto LA8;
		result = NIM_TRUE;
	}
	...
	LA8: ;
	{
		...
		LOC11 = ((*x).Kind == ((NU8) 2));
		if (!(LOC11)) goto LA12;
		LOC11 = identeq_201493((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP1360));
		LA12: ;
		if (!LOC11) goto LA13;
		result = NIM_FALSE;
	}
...
N_NIMCALL(tllstream212204*, filterstrip_259012)(tllstream212204* stdin_259014, NimStringDesc* filename, tnode226816* call) {
	...
	NimStringDesc* line;
	result = 0;
	pattern = strarg_259029(call, ((NimStringDesc*) &TMP1357), 1, ((NimStringDesc*) &TMP1358));
	leading = boolarg_259038(call, ((NimStringDesc*) &TMP1361), 2, NIM_TRUE);
	trailing = boolarg_259038(call, ((NimStringDesc*) &TMP1362), 3, NIM_TRUE);
	result = llstreamopen_212220(((NimStringDesc*) &TMP1358));
...
N_NIMCALL(tllstream212204*, filterreplace_259004)(tllstream212204* stdin_259006, NimStringDesc* filename, tnode226816* call) {
	...
	NimStringDesc* line;
	result = 0;
	sub = strarg_259029(call, ((NimStringDesc*) &TMP1363), 1, ((NimStringDesc*) &TMP1358));
	{
		if (!(sub->Sup.len == 0)) goto LA3;
		invalidpragma_259047(call);
	}
	LA3: ;
	by = strarg_259029(call, ((NimStringDesc*) &TMP1364), 2, ((NimStringDesc*) &TMP1358));
	result = llstreamopen_212220(((NimStringDesc*) &TMP1358));
	line = rawNewString(80);
	{
		while (1) {
