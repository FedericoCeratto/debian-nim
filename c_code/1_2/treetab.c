...
N_NIMCALL(NI, nodetablerawget_288509)(tnodetable226876 t, NI k, tnode226816* key);
N_NIMCALL(NIM_BOOL, treesequivalent_288243)(tnode226816* a, tnode226816* b);
...
N_NIMCALL(void, nodetablerawinsert_288562)(tnodepairseq226874** data, NI k, tnode226816* key, NI val);
	...
	{
		{
			...
			HEX3Atmp_288223 = (NI64)(LOC26 - 1);
			res_288226 = 0;
			{
				while (1) {
					NI LOC29;
					if (!(res_288226 <= HEX3Atmp_288223)) goto LA28;
					i_288202 = res_288226;
					LOC29 = 0;
		...
		{
			{
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					HEX3Atmp_288489 = (NI64)(LOC26 - 1);
					res_288492 = 0;
					{
						while (1) {
							if (!(res_288492 <= HEX3Atmp_288489)) goto LA28;
							i_288459 = res_288492;
							{
								NIM_BOOL LOC31;
								LOC31 = 0;
								LOC31 = treesequivalent_288243((*a).kindU.S6.Sons->data[i_288459], (*b).kindU.S6.Sons->data[i_288459]);
								if (!!(LOC31)) goto LA32;
								goto BeforeRet;
							}
							LA32: ;
	...
	h = (NI)(k & (t.Data->Sup.len-1));
	{
		while (1) {
			if (!!((t.Data->data[h].Key == NIM_NIL))) goto LA2;
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = treesequivalent_288243(t.Data->data[h].Key, key);
				LA6: ;
				if (!LOC5) goto LA7;
				result = h;
				goto BeforeRet;
...
N_NIMCALL(NI, nodetabletestorset_289121)(tnodetable226876* t, tnode226816* key, NI val) {
	...
	index = nodetablerawget_288509((*t), k, key);
	{
		if (!(0 <= index)) goto LA3;
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = (tnodepairseq226874*) newSeq((&NTI226874), (NI64)((*t).Data->Sup.len * 2));
			{
				NI i_289251;
				NI HEX3Atmp_289301;
				NI res_289304;
				...
				res_289304 = 0;
				{
					while (1) {
						...
						i_289251 = res_289304;
						{
							...
							nodetablerawinsert_288562((&n), (*t).Data->data[i_289251].H, (*t).Data->data[i_289251].Key, (*t).Data->data[i_289251].Val);
						}
						LA16: ;
						res_289304 += 1;
					} LA13: ;
		...
		LA9: ;
		nodetablerawinsert_288562((&(*t).Data), k, key, val);
		result = val;
		(*t).Counter += 1;
	}
	LA1: ;
