...
N_NIMCALL(void, TMP2973)(void* p, NI op);
...
N_NIMCALL(void, TMP2974)(void* p, NI op);
...
N_NIMCALL(NimStringDesc*, mnewString)(NI len0);
STRING_LITERAL(TMP2978, "cannot write to stream", 22);
...
N_NIMCALL(NI, fspeekdata_151518_1780494535)(Streamobj150418* s0, void* buffer0, NI buflen0) {
	...
	pushSafePoint(&TMP2977);
	TMP2977.status = setjmp(TMP2977.context);
	if (TMP2977.status == 0) {
		result0 = readbuffer_15754_1689653243((*((Filestreamobj151477*) (s0))).f, buffer0, ((NI) (buflen0)));
		popSafePoint();
	}
	...
	if (TMP2977.status != 0) reraiseException();
	return result0;
}
...
N_NIMCALL(void, fswritedata_151525_1780494535)(Streamobj150418* s0, void* buffer0, NI buflen0) {
	{
		...
		LOC6 = (Ioerror3428*)0;
		LOC6 = neweio_150402_1780494535(((NimStringDesc*) &TMP2978));
