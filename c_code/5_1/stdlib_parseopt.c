...
N_NIMCALL(NimStringDesc*, quote_208317)(NimStringDesc* s);
N_NIMCALL(NI, nsuFindCharSet)(NimStringDesc* s, TY212407 chars, NI start);
N_NIMCALL(NimStringDesc*, rawNewString)(NI space);
N_NIMCALL(NimStringDesc*, rawNewString)(NI cap);
N_NIMCALL(NI, parseword_208230)(NimStringDesc* s, NI i, NimStringDesc** w, TY212407 delim);
...
N_NIMCALL(void, handleshortoption_208604)(Optparser208211* p);
...
static NIM_CONST TY212407 TMP1632 = {
0x00, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY212407 TMP1633 = {
...
static NIM_CONST TY212407 TMP1635 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY212407 TMP1640 = {
...
TNimType NTI208211; /* OptParser */
extern TNimType NTI149; /* string */
extern TNimType NTI108; /* int */
extern TNimType NTI138; /* bool */
TNimType NTI208209; /* CmdLineKind */
...
N_NIMCALL(NimStringDesc*, quote_208317)(NimStringDesc* s) {
	...
	result = 0;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = nsuFindCharSet(s, TMP1632, ((NI) 0));
		LOC3 = (((NI) 0) <= LOC4);
		if (!(LOC3)) goto LA5;
		...
		if (!LOC3) goto LA6;
		{
			...
			i = parseword_208230(s, ((NI) 0), (&result), TMP1633);
			{
...
N_NIMCALL(void, initoptparser_208364)(NimStringDesc* cmdline, Optparser208211* Result) {
	...
	LA3: ;
	{
		unsureAsgnRef((void**) (&(*Result).cmd), copyString(((NimStringDesc*) &TMP1631)));
		{
			NI i_208380;
			NI HEX3Atmp_208383;
			NI res_208386;
			i_208380 = 0;
			HEX3Atmp_208383 = 0;
			HEX3Atmp_208383 = paramcount_136035();
			res_208386 = ((NI) 1);
			{
				while (1) {
					NimStringDesc* LOC9;
					NimStringDesc* LOC10;
					if (!(res_208386 <= HEX3Atmp_208383)) goto LA8;
					i_208380 = res_208386;
					LOC9 = 0;
					LOC9 = paramstr_136013(i_208380);
					LOC10 = 0;
					LOC10 = quote_208317(LOC9);
...
appendString((*Result).cmd, LOC10);
	...
	LA1: ;
	(*Result).kind = ((NU8) 0);
	unsureAsgnRef((void**) (&(*Result).key), copyString(((NimStringDesc*) &TMP1634)));
	unsureAsgnRef((void**) (&(*Result).val), copyString(((NimStringDesc*) &TMP1634)));
}
...
N_NIMCALL(void, handleshortoption_208604)(Optparser208211* p) {
	...
	}
	{
		...
		i = parseword_208230((*p).cmd, i, (&(*p).val), TMP1635);
	}
	LA5: ;
	{
...
{	i = (*p).pos;
	...
	case 45:
	{
		i += ((NI) 1);
		{
			...
			(*p).kind = ((NU8) 2);
			i += ((NI) 1);
			i = parseword_208230((*p).cmd, i, (&(*p).key), TMP1633);
			{
				while (1) {
			...
			}
			{
				...
				(*p).pos = parseword_208230((*p).cmd, i, (&(*p).val), TMP1635);
			}
			goto LA15;
			LA17: ;
			{
	...
	{
		(*p).kind = ((NU8) 1);
		(*p).pos = parseword_208230((*p).cmd, i, (&(*p).key), TMP1635);
	}
	break;
	}
	}BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(Optparser208211* p) {
	...
	result = nsuStrip(LOC1, NIM_TRUE, NIM_TRUE, TMP1640);
	return result;
}
...
NTI208211.size = sizeof(Optparser208211);
NTI208211.kind = 17;
NTI208211.base = (&NTI4011);
TMP1627[0] = &TMP784[1];
TMP784[1].kind = 1;
TMP784[1].offset = offsetof(Optparser208211, cmd);
TMP784[1].typ = (&NTI149);
TMP784[1].name = "cmd";
TMP1627[1] = &TMP784[2];
TMP784[2].kind = 1;
TMP784[2].offset = offsetof(Optparser208211, pos);
TMP784[2].typ = (&NTI108);
TMP784[2].name = "pos";
TMP1627[2] = &TMP784[3];
TMP784[3].kind = 1;
TMP784[3].offset = offsetof(Optparser208211, inshortstate);
TMP784[3].typ = (&NTI138);
TMP784[3].name = "inShortState";
TMP1627[3] = &TMP784[4];
NTI208209.size = sizeof(NU8);
NTI208209.kind = 14;
NTI208209.base = 0;
NTI208209.flags = 3;
for (TMP1630 = 0; TMP1630 < 4; TMP1630++) {
TMP784[TMP1630+5].kind = 1;
TMP784[TMP1630+5].offset = TMP1630;
TMP784[TMP1630+5].name = TMP1629[TMP1630];
TMP1628[TMP1630] = &TMP784[TMP1630+5];
}
TMP784[9].len = 4; TMP784[9].kind = 2; TMP784[9].sons = &TMP1628[0];
NTI208209.node = &TMP784[9];
TMP784[4].kind = 1;
TMP784[4].offset = offsetof(Optparser208211, kind);
TMP784[4].typ = (&NTI208209);
TMP784[4].name = "kind";
TMP1627[4] = &TMP784[10];
TMP784[10].kind = 1;
TMP784[10].offset = offsetof(Optparser208211, key);
TMP784[10].typ = (&NTI149);
TMP784[10].name = "key";
TMP1627[5] = &TMP784[11];
TMP784[11].kind = 1;
TMP784[11].offset = offsetof(Optparser208211, val);
TMP784[11].typ = (&NTI149);
TMP784[11].name = "val";
TMP784[0].len = 6; TMP784[0].kind = 2; TMP784[0].sons = &TMP1627[0];
NTI208211.node = &TMP784[0];
}
