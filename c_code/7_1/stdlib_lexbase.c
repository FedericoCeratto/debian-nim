...
TMP2709[0] = &TMP854[1];
TMP854[1].kind = 1;
TMP854[1].offset = offsetof(baselexer291024, Bufpos);
TMP854[1].typ = (&NTI108);
TMP854[1].name = "bufpos";
TMP2709[1] = &TMP854[2];
TMP854[2].kind = 1;
TMP854[2].offset = offsetof(baselexer291024, Buf);
TMP854[2].typ = (&NTI151);
TMP854[2].name = "buf";
TMP2709[2] = &TMP854[3];
TMP854[3].kind = 1;
TMP854[3].offset = offsetof(baselexer291024, Buflen);
TMP854[3].typ = (&NTI108);
TMP854[3].name = "bufLen";
TMP2709[3] = &TMP854[4];
TMP854[4].kind = 1;
TMP854[4].offset = offsetof(baselexer291024, Input);
TMP854[4].typ = (&NTI134033);
TMP854[4].name = "input";
TMP2709[4] = &TMP854[5];
TMP854[5].kind = 1;
TMP854[5].offset = offsetof(baselexer291024, Linenumber);
TMP854[5].typ = (&NTI108);
TMP854[5].name = "lineNumber";
TMP2709[5] = &TMP854[6];
TMP854[6].kind = 1;
TMP854[6].offset = offsetof(baselexer291024, Sentinel);
TMP854[6].typ = (&NTI108);
TMP854[6].name = "sentinel";
TMP2709[6] = &TMP854[7];
TMP854[7].kind = 1;
TMP854[7].offset = offsetof(baselexer291024, Linestart);
TMP854[7].typ = (&NTI108);
TMP854[7].name = "lineStart";
TMP2709[7] = &TMP854[8];
TMP854[8].kind = 1;
TMP854[8].offset = offsetof(baselexer291024, Fileopened);
TMP854[8].typ = (&NTI138);
TMP854[8].name = "fileOpened";
TMP854[0].len = 8; TMP854[0].kind = 2; TMP854[0].sons = &TMP2709[0];
NTI291024.node = &TMP854[0];
}
