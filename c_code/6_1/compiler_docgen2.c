...
N_NIMCALL(void, TMP5408)(void* p, NI op);
...
N_NIMCALL(Tnode264794*, close_547010_1824627595)(Tpasscontext312002* p0, Tnode264794* n0) {
	...
	usewarning0 = !((((*(*g0).module).flags &(1U<<((NU)(((Tsymflag264184) 12))&31U)))!=0));
	{
		...
		writeoutput_387697_1256521319((*g0).doc, LOC7, ((NimStringDesc*) &TMP5409), usewarning0);
		pushSafePoint(&TMP5410);
		TMP5410.status = _setjmp(TMP5410.context);
		if (TMP5410.status == 0) {
		...
		if (TMP5410.status != 0) reraiseException();
	}
	LA5: ;
	return result0;
}
...
TMP1336[0].len = 2; TMP1336[0].kind = 2; TMP1336[0].sons = &TMP5407[0];
NTI547004.node = &TMP1336[0];
NTI547006.size = sizeof(Tgen547004*);
NTI547006.kind = 22;
NTI547006.base = (&NTI547004);
NTI547006.marker = TMP5408;
}
