...
N_NIMCALL(void, openpasses_287326)(tpasscontext287005** a, tsym226846* module) {
	{
		...
		i_287343 = 0;
		HEX3Atmp_287352 = 0;
		HEX3Atmp_287352 = (NI64)(gpasseslen_287200 - 1);
		res_287355 = 0;
		{
			while (1) {
...
N_NIMCALL(NIM_BOOL, processtoplevelstmt_287483)(tnode226816* n, tpasscontext287005** a) {
	...
	m = n;
	{
		...
		i_287502 = 0;
		HEX3Atmp_287522 = 0;
		HEX3Atmp_287522 = (NI64)(gpasseslen_287200 - 1);
		res_287525 = 0;
		{
			while (1) {
...
N_NIMCALL(void, processimplicits_287643)(TY120608* implicits, NU8 nodekind, tpasscontext287005** a) {
	{
		...
		l_287670 = implicits->Sup.len;
		{
			while (1) {
				...
				importstmt = newnodei_227138(nodekind, gcmdlineinfo_197191);
...
N_NIMCALL(void, closepasses_287436)(tpasscontext287005** a) {
	...
	m = NIM_NIL;
	{
		...
		i_287453 = 0;
		HEX3Atmp_287463 = 0;
		HEX3Atmp_287463 = (NI64)(gpasseslen_287200 - 1);
		res_287466 = 0;
		{
			while (1) {
...
N_NIMCALL(void, openpassescached_287372)(tpasscontext287005** a, tsym226846* module, trodreader277030* rd) {
	{
		...
		i_287390 = 0;
		HEX3Atmp_287416 = 0;
		HEX3Atmp_287416 = (NI64)(gpasseslen_287200 - 1);
		res_287419 = 0;
		{
			while (1) {
...
N_NIMCALL(void, processtoplevelstmtcached_287542)(tnode226816* n, tpasscontext287005** a) {
	...
	m = n;
	{
		...
		i_287560 = 0;
		HEX3Atmp_287569 = 0;
		HEX3Atmp_287569 = (NI64)(gpasseslen_287200 - 1);
		res_287572 = 0;
		{
			while (1) {
...
N_NIMCALL(void, closepassescached_287589)(tpasscontext287005** a) {
	...
	m = NIM_NIL;
	{
		...
		i_287606 = 0;
		HEX3Atmp_287623 = 0;
		HEX3Atmp_287623 = (NI64)(gpasseslen_287200 - 1);
		res_287626 = 0;
		{
			while (1) {
...
N_NIMCALL(void, processmodule_287056)(tsym226846* module, tllstream212204* stream, trodreader277030* rd) {
	...
	LA3: ;
	{
		...
		n = loadinitsection_277077(rd);
		{
			...
			HEX3Atmp_287825 = (NI64)(LOC37 - 1);
			res_287828 = 0;
			{
				while (1) {
					if (!(res_287828 <= HEX3Atmp_287825)) goto LA39;
					i_287802 = res_287828;
