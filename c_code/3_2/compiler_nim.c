...
{	{
	...
	LA4: ;
	{
		...
		scriptfile0 = noschangeFileExt(gprojectfull_164207_2607990831, ((NimStringDesc*) &TMP2224));
		{
			...
			if (!LOC25) goto LA26;
			runnimscript_567203_3062286716(scriptfile0, NIM_FALSE);
			{
		...
		LA26: ;
		{
			...
			runnimscript_567203_3062286716(LOC37, NIM_FALSE);
		}
		goto LA23;
		LA35: ;
		LA23: ;
		...
		maincommand_564610_6460232();
		{
			...
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_187077_155036129 &((NU64)1<<((NU)((((Tmsgkind186002) 289)- 237))&63U)))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
		...
		LA46: ;
		{
			if (!(gerrorcounter_187078_155036129 == ((NI) 0))) goto LA51;
			{
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	msgquit_187153_155036129(((NI8) ((((NI) 0) < gerrorcounter_187078_155036129))));
}
