...
STRING_LITERAL(TMP2706, ".nimfix", 7);
STRING_LITERAL(TMP2714, "\015\012", 2);
STRING_LITERAL(TMP2715, "\012", 1);
...
N_NIMCALL(void, loadfile_294045)(tlineinfo195539 info) {
	...
	LA3: ;
	{
		...
		gsourcefiles_294040->data[i].Lines = (TY120008*) newSeqRC1((&NTI120008), 0);
		...
		gsourcefiles_294040->data[i].Isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2706));
		{
			NimStringDesc* line_294108;
			FILE* f_294146;
			NimStringDesc* res_294148;
			line_294108 = 0;
			f_294146 = open_12817(path, ((NU8) 0), 8000);
			res_294148 = rawNewString(80);
			{
				while (1) {
					...
					NimStringDesc* LOC15;
					LOC14 = 0;
					LOC14 = readline_13089(f_294146, (&res_294148));
					if (!LOC14) goto LA13;
					line_294108 = res_294148;
					gsourcefiles_294040->data[i].Lines = (TY120008*) incrSeq(&(gsourcefiles_294040->data[i].Lines)->Sup, sizeof(NimStringDesc*));
					LOC15 = 0;
		...
		pos = lex.Bufpos;
		{
			while (1) {
				...
				case 13:
				{
					NimStringDesc* LOC21;
					LOC21 = 0;
					LOC21 = gsourcefiles_294040->data[i].Newline; gsourcefiles_294040->data[i].Newline = copyStringRC1(((NimStringDesc*) &TMP2714));
				...
				case 0:
				{
					NimStringDesc* LOC23;
					LOC23 = 0;
					LOC23 = gsourcefiles_294040->data[i].Newline; gsourcefiles_294040->data[i].Newline = copyStringRC1(((NimStringDesc*) &TMP2715));
...
N_NIMCALL(void, replacedeprecated_294247)(tlineinfo195539 info, tident200021* oldsym, tident200021* newsym) {
	...
	last = (NI64)((NI64)(first + LOC17) - 1);
	{
		...
		LOC21 = 0;
		LOC21 = HEX5BHEX5D_84368(line, LOC20);
		LOC22 = 0;
