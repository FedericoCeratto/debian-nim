...
STRING_LITERAL(TMP988, "msgs.nim", 8);
NIM_CONST TY86545 TMP987 = {((NimStringDesc*) &TMP988),
((NI) 868)}
;
...
NIM_CONST TY86545 TMP3748 = {((NimStringDesc*) &TMP988),
((NI) 875)}
;
...
N_NIMCALL(void, suggestwriteln_165069)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_165060.ClEnv? writelnhook_165060.ClPrc(s, writelnhook_165060.ClEnv):((TMP1965)(writelnhook_165060.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, suggestquit_165125)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_165129).Sup.message; (*e_165129).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2665));
	if (LOC1) nimGCunrefNoCycle(LOC1);
