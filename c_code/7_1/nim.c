...
N_NIMCALL(void, handlecmdline_615607)(void);
...
N_NIMCALL(NimStringDesc*, prependcurdir_615401)(NimStringDesc* f);
...
STRING_LITERAL(TMP4890, "js", 2);
STRING_LITERAL(TMP4891, "node ", 5);
...
appendString(LOC7, ((NimStringDesc*) &TMP4889));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_615607)(void) {
	...
	LA4: ;
	{
		processcmdline_609209(((NU8) 0), ((NimStringDesc*) &TMP1888));
		{
			TSafePoint TMP1889;
			TY116604 p;
			NimStringDesc* LOC15;
			NimStringDesc* LOC16;
			if (!!(((gprojectname_168234) && (gprojectname_168234)->Sup.len == 0))) goto LA9;
			pushSafePoint(&TMP1889);
			TMP1889.status = _setjmp(TMP1889.context);
			if (TMP1889.status == 0) {
				asgnRefNoCycle((void**) (&gprojectfull_168236), canonicalizepath_168390(gprojectname_168234));
				popSafePoint();
			}
			else {
				popSafePoint();
				if (isObj(getCurrentException()->Sup.m_type, (&NTI3233))) {
					...
					TMP1889.status = 0;
					LOC14 = 0;
					LOC14 = gprojectfull_168236; gprojectfull_168236 = copyStringRC1(gprojectname_168234);
					if (LOC14) nimGCunrefNoCycle(LOC14);
					popCurrentException();
				}
			}
			if (TMP1889.status != 0) reraiseException();
			memset((void*)(&p), 0, sizeof(p));
			chckNil((void*)(&p));
			memset((void*)(&p), 0, sizeof(p));
			nossplitFile(gprojectfull_168236, (&p));
			LOC15 = 0;
			LOC15 = gprojectpath_168235; gprojectpath_168235 = copyStringRC1(p.Field0);
			if (LOC15) nimGCunrefNoCycle(LOC15);
			LOC16 = 0;
			LOC16 = gprojectname_168234; gprojectname_168234 = copyStringRC1(p.Field1);
			if (LOC16) nimGCunrefNoCycle(LOC16);
		}
		goto LA7;
		LA9: ;
		{
			asgnRefNoCycle((void**) (&gprojectpath_168235), nosgetCurrentDir());
		}
		LA7: ;
		loadconfigs_219811(((NimStringDesc*) &TMP1914));
		initvars_201820();
		processcmdline_609209(((NU8) 1), ((NimStringDesc*) &TMP1888));
		maincommand_613027();
		{
			NimStringDesc* LOC22;
			...
			if (!(gerrorcounter_195306 == 0)) goto LA25;
			{
				if (!((gglobaloptions_168118 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					ex = 0;
					{
						...
						LOC39 = 0;
						LOC39 = prependcurdir_615401(outfile_168124);
					...
					LA37: ;
					{
						...
						NimStringDesc* LOC43;
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_168236, ((NimStringDesc*) &TMP4890));
						LOC42 = 0;
						LOC42 = prependcurdir_615401(LOC41);
						LOC43 = 0;
...
appendString(LOC44, ((NimStringDesc*) &TMP4891));
appendString(LOC44, ex);
appendChar(LOC44, 32);
appendString(LOC44, arguments_209144);
					execexternalprogram_201907(LOC44, ((NimStringDesc*) &TMP1888));
				}
				goto LA31;
				LA33: ;
				{
					...
					binpath = 0;
					{
						...
						binpath = prependcurdir_615401(outfile_168124);
					}
					goto LA46;
					LA48: ;
					{
						NimStringDesc* LOC51;
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_168236, ((NimStringDesc*) &TMP1888));
						binpath = prependcurdir_615401(LOC51);
					}
					LA46: ;
...
appendString(LOC52, arguments_209144);
					execexternalprogram_201907(LOC52, ((NimStringDesc*) &TMP1888));
				}
				LA31: ;
			}
			LA29: ;
