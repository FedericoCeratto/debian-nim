...
N_NIMCALL(tnode225816*, extractrange_262440)(NU8 k, tnode225816* n, NI a, NI b) {
	...
	result = newnodei_228007(k, (*n).Info, (NI32)((NI32)(b - a) + 1));
	{
		...
		i_262457 = 0;
		HEX3Atmp_262487 = 0;
		HEX3Atmp_262487 = (NI32)(b - a);
		res_262490 = 0;
		{
			while (1) {
				if (!(res_262490 <= HEX3Atmp_262487)) goto LA3;
				i_262457 = res_262490;
				asgnRefNoCycle((void**) (&(*result).kindU.S6.Sons->data[i_262457]), (*n).kindU.S6.Sons->data[(NI32)(i_262457 + a)]);
				res_262490 += 1;
			} LA3: ;
		}
	}
