...
STRING_LITERAL(TMP2703, "getSymFromList", 14);
STRING_LITERAL(TMP3183, "lookupInRecord", 14);
STRING_LITERAL(TMP3184, "lookupInRecord(record case branch)", 34);
STRING_LITERAL(TMP3185, "lookupInRecord()", 16);
	...
	result = 0;
	{
		...
		res_236114 = start;
		{
			while (1) {
				...
				LA7: ;
				{
					internalerror_197987((*list).Info, ((NimStringDesc*) &TMP2703));
				}
				LA5: ;
				res_236114 += 1;
			} LA4: ;
...
N_NIMCALL(tsym225846*, lookupinrecord_235236)(tnode225816* n, tident200021* field) {
	...
	{
		{
			...
			internalerror_197987((*n).Info, ((NimStringDesc*) &TMP3183));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_235860 = 1;
			{
				while (1) {
					...
					default:
					{
						internalerror_197987((*n).Info, ((NimStringDesc*) &TMP3184));
					}
					break;
					}
					res_235860 += 1;
	...
	default:
	{
		internalerror_197987((*n).Info, ((NimStringDesc*) &TMP3185));
	}
	break;
	}
	BeforeRet: ;
