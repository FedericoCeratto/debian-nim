...
N_NIMCALL(NI64, decodevbiggestint_233518)(NCSTRING s, NI* pos) {
	...
	result = IL64(0);
	{
		while (1) {
			...
			case 48 ... 57:
			{
				result = (NI64)((NI64)(result * IL64(190)) - ((NI64) ((NI64)(((NI) (((NU8)(s[i_233525])))) - 48))));
			}
			break;
			case 97 ... 122:
			{
				result = (NI64)((NI64)(result * IL64(190)) - ((NI64) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_233525])))) - 97))) + 10))));
			}
			break;
			case 65 ... 90:
			{
				result = (NI64)((NI64)(result * IL64(190)) - ((NI64) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_233525])))) - 65))) + 36))));
			}
			break;
			case 128 ... 255:
			{
				result = (NI64)((NI64)(result * IL64(190)) - ((NI64) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_233525])))) - 128))) + 62))));
			}
			break;
			default:
			{
