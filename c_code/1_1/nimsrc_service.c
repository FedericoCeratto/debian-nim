...
extern TY165057 writelnhook_165060;
...
appendString(LOC1, ((NimStringDesc*) &TMP4995));
	send_519008((*HEX3Aenvp_522438).stdoutsocket522408, LOC1, 2);
}
...
N_NIMCALL(void, serve_522254)(TY522256 action) {
	...
	LA2: ;
	{
		...
		asgnRef((void**) (&writelnhook_165060.ClEnv), LOC21.ClEnv);
		writelnhook_165060.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				NimStringDesc* LOC24;
				...
				action();
				gerrorcounter_165015 = ((NI) 0);
				send_519008((*HEX3Aenv_522447).stdoutsocket522408, ((NimStringDesc*) &TMP4995), 2);
