...
extern TY164057 writelnhook_164060;
...
appendString(LOC1, ((NimStringDesc*) &TMP4993));
	send_518008((*HEX3Aenvp_521438).stdoutsocket521408, LOC1, 2);
}
...
N_NIMCALL(void, serve_521254)(TY521256 action) {
	...
	LA2: ;
	{
		...
		asgnRef((void**) (&writelnhook_164060.ClEnv), LOC21.ClEnv);
		writelnhook_164060.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				NimStringDesc* LOC24;
				...
				action();
				gerrorcounter_164015 = ((NI) 0);
				send_518008((*HEX3Aenv_521447).stdoutsocket521408, ((NimStringDesc*) &TMP4993), 2);
