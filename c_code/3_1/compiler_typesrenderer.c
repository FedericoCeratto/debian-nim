...
N_NIMCALL(void, renderparamtypes_383275)(TY131608** found, Tnode225809* n);
...
STRING_LITERAL(TMP5052, "", 0);
STRING_LITERAL(TMP5053, "*", 1);
STRING_LITERAL(TMP5054, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP5061, "ref.", 4);
STRING_LITERAL(TMP5062, "ptr.", 4);
STRING_LITERAL(TMP5063, "proc(", 5);
STRING_LITERAL(TMP5064, "tuple[", 6);
STRING_LITERAL(TMP5065, "renderParamTypes(found,n) with ", 31);
...
{	result = 0;
	result = copyString(((NimStringDesc*) &TMP5052));
	switch ((*n).kind) {
	case ((NU8) 31):
	{
		{
	...
	{
		{
			if (!!(eqStrings((*(*n).kindU.S5.ident).s, ((NimStringDesc*) &TMP5053)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP5054));
...
appendString(LOC6, ((NimStringDesc*) &TMP5061));
...
appendString(LOC10, ((NimStringDesc*) &TMP5062));
appendString(LOC10, LOC12);
	...
	case ((NU8) 147):
	{
		...
		result = copyString(((NimStringDesc*) &TMP5063));
		{
			NI i_382419;
			NI HEX3Atmp_383202;
			NI LOC15;
...
appendString(result, LOC27);
	...
	case ((NU8) 134):
	{
		result = copyString(((NimStringDesc*) &TMP5064));
		{
			NI i_382819;
			NI HEX3Atmp_383218;
			NI LOC30;
		...
		LA15: ;
		{
			...
			res_383630 = ((NI) 0);
			{
				while (1) {
					...
					i_383438 = res_383630;
					(*found) = (TY131608*) incrSeqV2(&((*found))->Sup, sizeof(NimStringDesc*));
					LOC29 = 0;
...
appendString(LOC31, ((NimStringDesc*) &TMP5065));
...
N_NIMCALL(NimStringDesc*, renderparamtypes_383658)(Tnode225809* n, NimStringDesc* sep) {
	...
	result = 0;
	result = copyString(((NimStringDesc*) &TMP5052));
	found = (TY131608*) newSeq((&NTI131608), 0);
