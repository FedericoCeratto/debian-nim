...
{	result = 0;
	{
		...
		res_198872 = start;
		{
			while (1) {
				...
				LA7: ;
				{
					internalerror_165199((*list).info, ((NimStringDesc*) &TMP2676));
				}
				LA5: ;
				res_198872 += ((NI) 1);
			} LA4: ;
...
{	result = 0;
	...
	{
		{
			...
			internalerror_165199((*n).info, ((NimStringDesc*) &TMP2958));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_198551 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_165199((*n).info, ((NimStringDesc*) &TMP2959));
					}
					break;
					}
					res_198551 += ((NI) 1);
	...
	default:
	{
		internalerror_165199((*n).info, ((NimStringDesc*) &TMP2960));
	}
	break;
	}
	}BeforeRet: ;
