...
{	{
		...
		NI LOC4;
		LOC3 = (NI)0;
		LOC3 = cmp0.ClEnv? cmp0.ClPrc(a0[m0], a0[(NI)(m0 + ((NI) 1))], cmp0.ClEnv):((TMP2920)(cmp0.ClPrc))(a0[m0], a0[(NI)(m0 + ((NI) 1))]);
		LOC4 = (NI)0;
	...
	k0 = lo0;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = (NI)0;
				LOC15 = cmp0.ClEnv? cmp0.ClPrc(b0[i0], a0[j0], cmp0.ClEnv):((TMP2921)(cmp0.ClPrc))(b0[i0], a0[j0]);
				LOC16 = (NI)0;
