...
/* Command for C compiler:
   gcc -c  -w -O3 -fno-strict-aliasing  -I/home/ubuntu/nim-ci/Nim/lib -o /home/ubuntu/nim-ci/Nim/compiler/rnimcache/compiler_itersgen.o /home/ubuntu/nim-ci/Nim/compiler/rnimcache/compiler_itersgen.c */
...
N_NIMCALL(Tnode293798*, itertoprocimpl_481003)(Tcontext344020* c, Tnode293798* n);
...
STRING_LITERAL(TMP1129, "stdlib", 6);
STRING_LITERAL(TMP1130, "system", 6);
STRING_LITERAL(TMP1131, "iterToProc", 10);
STRING_LITERAL(TMP1132, "first argument needs to be an iterator", 38);
STRING_LITERAL(TMP1133, "second argument needs to be a type", 34);
STRING_LITERAL(TMP1134, "third argument needs to be an identifier", 40);
STRING_LITERAL(TMP1135, "type must be a non-generic ref|ptr to object with state field", 61);
...
{	result = 0;
	...
	iter = HEX5BHEX5D_294238(n, ((NI) 1));
	{
		...
		LA4: ;
		if (!LOC3) goto LA5;
		localerror_197085((*iter).info, ((NimStringDesc*) &TMP1132));
		goto BeforeRet;
	}
	LA5: ;
	{
		...
		localerror_197085((*LOC12).info, ((NimStringDesc*) &TMP1133));
		goto BeforeRet;
	}
	LA10: ;
	{
		...
		Tnode293798* LOC18;
		LOC15 = 0;
		LOC15 = HEX5BHEX5D_294238(n, ((NI) 3));
		if (!!(((*LOC15).kind == ((NU8) 2)))) goto LA16;
		LOC18 = 0;
		LOC18 = HEX5BHEX5D_294238(n, ((NI) 3));
		localerror_197085((*LOC18).info, ((NimStringDesc*) &TMP1134));
		goto BeforeRet;
	}
	LA16: ;
	LOC19 = 0;
	LOC19 = HEX5BHEX5D_294238(n, ((NI) 2));
	t = skiptypes_297099((*LOC19).typ, 2304);
	{
		NIM_BOOL LOC22;
		Ttype293836* LOC24;
		Tnode293798* LOC27;
		...
		if (!LOC22) goto LA25;
		LOC27 = 0;
		LOC27 = HEX5BHEX5D_294238(n, ((NI) 2));
		localerror_197085((*LOC27).info, ((NimStringDesc*) &TMP1135));
		goto BeforeRet;
	}
	LA25: ;
	LOC28 = 0;
	LOC28 = getbody_335226((*iter).kindU.S4.sym);
	body = liftitertoproc_440395((*iter).kindU.S4.sym, LOC28, t);
	LOC29 = 0;
	LOC29 = HEX5BHEX5D_294238(n, ((NI) 3));
	prc = newsym_294683(((NU8) 12), (*LOC29).kindU.S5.ident, (*(*iter).kindU.S4.sym).owner, (*(*iter).kindU.S4.sym).info);
	asgnRefNoCycle((void**) (&(*prc).typ), copytype_296470((*(*iter).kindU.S4.sym).typ, prc, NIM_FALSE));
	(*(*prc).typ).flags &= ~(((NU32)1) << ((((NU8) 11)) % (sizeof(NU32)*8)));
	LOC30 = 0;
	LOC30 = getenvparam_436603((*iter).kindU.S4.sym);
	LOC31 = 0;
	LOC31 = newsymnode_295183(LOC30);
	add_294117((*(*prc).typ).n, LOC31);
	rawaddson_297394((*prc).typ, t);
	orig = (*(*iter).kindU.S4.sym).ast;
	LOC32 = 0;
	LOC32 = HEX5BHEX5D_294238(orig, ((NI) 3));
	LOC33 = 0;
	LOC33 = newsymnode_295183(prc);
	LOC34 = 0;
	LOC34 = HEX5BHEX5D_294238(orig, ((NI) 4));
	asgnRefNoCycle((void**) (&(*prc).ast), newprocnode_296040(((NU8) 79), (*n).info, body, LOC32, LOC33, emptynode_294801, emptynode_294801, LOC34, emptynode_294801));
	add_294117((*prc).ast, (*(*(*iter).kindU.S4.sym).ast).kindU.S6.sons->data[((NI) 7)]);
	addinterfacedecl_346560(c, prc);
	}BeforeRet: ;
	return result;
}
NIM_EXTERNC N_NOINLINE(void, compiler_itersgenInit000)(void) {
	registerplugin_479091(((NimStringDesc*) &TMP1129), ((NimStringDesc*) &TMP1130), ((NimStringDesc*) &TMP1131), itertoprocimpl_481003);
}
