...
N_NIMCALL(void, loadconfigs_187607)(NimStringDesc* cfg) {
	...
	LA3: ;
	{
		...
		LOC9 = 0;
		LOC9 = getsystemconfigpath_187590(cfg);
		readconfigfile_187520(LOC9);
	}
	LA7: ;
	{
		NimStringDesc* LOC14;
		...
		LOC14 = 0;
		LOC14 = getuserconfigpath_187578(cfg);
		readconfigfile_187520(LOC14);
	}
	LA12: ;
	{
		...
		if (!!(((gglobaloptions_155128 &(1<<((((NU8) 19))&31)))!=0))) goto LA22;
		{
			...
			dir_187834 = 0;
			{
				...
				current_187851 = copyString(pd);
				{
					...
					dir_187834 = pd;
					LOC33 = 0;
					LOC33 = HEX2F_118492(dir_187834, cfg);
					readconfigfile_187520(LOC33);
				}
				LA31: ;
				{
					while (1) {
						NimStringDesc* LOC41;
						{
							NIM_BOOL LOC38;
							LOC38 = 0;
							LOC38 = nosisRootDir(current_187851);
							if (!LOC38) goto LA39;
							goto LA34;
						}
						LA39: ;
						...
						LOC41 = 0;
						LOC41 = HEX2F_118492(dir_187834, cfg);
						readconfigfile_187520(LOC41);
					}
				} LA34: ;
			}
			goto LA25;
			...
			{
				{
					...
					{
						while (1) {
							if (!(res_187857 <= HEX3Atmp_187855)) goto LA45;
							i_187853 = res_187857;
							{
								NIM_BOOL LOC48;
								NIM_BOOL LOC50;
								NimStringDesc* LOC54;
								LOC48 = 0;
								LOC48 = (((NU8)(pd->data[i_187853])) == ((NU8)(92)) || ((NU8)(pd->data[i_187853])) == ((NU8)(47)));
								if (!(LOC48)) goto LA49;
								LOC50 = 0;
								LOC50 = (i_187853 == ((NI) 0));
								if (LOC50) goto LA51;
								LOC50 = !((((NU8)(pd->data[(NI)(i_187853 - ((NI) 1))])) == ((NU8)(92)) || ((NU8)(pd->data[(NI)(i_187853 - ((NI) 1))])) == ((NU8)(47))));
								LA51: ;
								LOC48 = LOC50;
								LA49: ;
								if (!LOC48) goto LA52;
								...
								LOC54 = 0;
								LOC54 = HEX2F_118492(dir_187834, cfg);
								readconfigfile_187520(LOC54);
							}
							LA52: ;
							res_187857 += ((NI) 1);
						} LA45: ;
				...
				}
				{
					...
					dir_187834 = pd;
					LOC59 = 0;
					LOC59 = HEX2F_118492(dir_187834, cfg);
					readconfigfile_187520(LOC59);
				}
				LA57: ;
			}
			LA25: ;
