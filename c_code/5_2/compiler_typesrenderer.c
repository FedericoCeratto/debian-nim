...
STRING_LITERAL(TMP5057, "", 0);
STRING_LITERAL(TMP5058, "*", 1);
STRING_LITERAL(TMP5059, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP5066, "ref.", 4);
STRING_LITERAL(TMP5067, "ptr.", 4);
STRING_LITERAL(TMP5068, "proc(", 5);
STRING_LITERAL(TMP5069, "tuple[", 6);
STRING_LITERAL(TMP5070, "renderParamTypes(found,n) with ", 31);
...
{	result = 0;
	result = copyString(((NimStringDesc*) &TMP5057));
	switch ((*n).kind) {
	case ((NU8) 31):
	{
		{
	...
	{
		{
			if (!!(eqStrings((*(*n).kindU.S5.ident).s, ((NimStringDesc*) &TMP5058)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP5059));
...
appendString(LOC6, ((NimStringDesc*) &TMP5066));
...
appendString(LOC10, ((NimStringDesc*) &TMP5067));
...
appendString(LOC31, ((NimStringDesc*) &TMP5070));
