...
#include <arpa/inet.h>
#include <setjmp.h>
typedef struct Socketimpl585406 Socketimpl585406;
typedef struct TNimType TNimType;
typedef struct TNimNode TNimNode;
typedef struct NimStringDesc NimStringDesc;
typedef struct TGenericSeq TGenericSeq;
typedef struct Timeouterror585414 Timeouterror585414;
...
typedef NU8 Socketflag585416Set;
typedef NU8 Socketflag585416;
struct  TNimObject  {
TNimType* m_type;
};
struct  Exception  {
...
N_NIMCALL(Socketimpl585406*, newsocket_585674_170061329)(int fd0, Domain579604 domain0, Socktype579606 socktype0, Protocol579608 protocol0, NIM_BOOL buffered0);
...
N_NIMCALL(NI, send_590510_170061329)(Socketimpl585406* socket0, void* data0, NI size0);
N_NIMCALL(NIM_BOOL, isdisconnectionerror_585478_170061329)(Socketflag585416Set flags0, NI32 lasterror0);
N_NIMCALL(void, socketerror_585472_170061329)(Socketimpl585406* socket0, NI err0, NIM_BOOL async0, NI32 lasterror0);
N_NIMCALL(NI32, getsocketerror_586201_170061329)(Socketimpl585406* socket0);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src0);
N_NIMCALL(void, acceptaddr_587009_170061329)(Socketimpl585406* server0, Socketimpl585406** client0, NimStringDesc** address0, Socketflag585416Set flags0);
...
N_NIMCALL(NI, waitfor_589606_170061329)(Socketimpl585406* socket0, NF* waited0, NI timeout0, NI size0, NimStringDesc* funcname0);
...
N_NIMCALL(NI, select_589001_170061329)(Socketimpl585406* readfd0, NI timeout0);
N_NIMCALL(NIM_BOOL, hasdatabuffered_588801_170061329)(Socketimpl585406* s0);
...
N_NIMCALL(NI, recv_589216_170061329)(Socketimpl585406* socket0, void* data0, NI size0);
N_NIMCALL(NI, readintobuf_589023_170061329)(Socketimpl585406* socket0, NI32 flags0);
N_NIMCALL(NI, peekchar_590236_170061329)(Socketimpl585406* socket0, NIM_CHAR* c0);
...
TNimNode* NimDT_585406_isbuffered[3];
...
N_NIMCALL(Socketimpl585406*, newsocket_585674_170061329)(int fd0, Domain579604 domain0, Socktype579606 socktype0, Protocol579608 protocol0, NIM_BOOL buffered0) {
	Socketimpl585406* result0;
	result0 = (Socketimpl585406*)0;
	result0 = (Socketimpl585406*) newObj((&NTI585408), sizeof(Socketimpl585406));
	(*result0).fd = fd0;
...
N_NIMCALL(Socketimpl585406*, newsocket_586009_170061329)(Domain579604 domain0, Socktype579606 socktype0, Protocol579608 protocol0, NIM_BOOL buffered0) {
	Socketimpl585406* result0;
	int fd0;
	result0 = (Socketimpl585406*)0;
...
N_NIMCALL(void, bindaddr_586808_170061329)(Socketimpl585406* socket0, NU16 port0, NimStringDesc* address0) {
	{
...
N_NIMCALL(void, listen_586804_170061329)(Socketimpl585406* socket0, int backlog0) {
	{
		int LOC3;
		NI32 LOC6;
		LOC3 = (int)0;
...
N_NIMCALL(NIM_BOOL, isdisconnectionerror_585478_170061329)(Socketflag585416Set flags0, NI32 lasterror0) {
	...
	result0 = (NIM_BOOL)0;
	LOC1 = (NIM_BOOL)0;
	LOC1 = ((flags0 &(1U<<((NU)(((Socketflag585416) 1))&7U)))!=0);
	if (!(LOC1)) goto LA2;
...
N_NIMCALL(void, send_591002_170061329)(Socketimpl585406* socket0, NimStringDesc* data0, Socketflag585416Set flags0) {
	NI sent0;
{	sent0 = send_590510_170061329(socket0, ((void*) (data0->data)), (data0 ? data0->Sup.len : 0));
	{
		NI32 lasterror0;
		...
		lasterror0 = oslasterror_131619_2125978480();
		{
			NIM_BOOL LOC7;
			LOC7 = (NIM_BOOL)0;
			LOC7 = isdisconnectionerror_585478_170061329(flags0, lasterror0);
			if (!LOC7) goto LA8;
			goto BeforeRet;
		}
		LA8: ;
		socketerror_585472_170061329(socket0, ((NI) -1), NIM_FALSE, lasterror0);
	}
	LA3: ;
	{
		NI32 LOC14;
...
N_NIMCALL(void, acceptaddr_587009_170061329)(Socketimpl585406* server0, Socketimpl585406** client0, NimStringDesc** address0, Socketflag585416Set flags0) {
	...
	sock0 = accept((*server0).fd, ((struct sockaddr*) ((&sockaddress0))), (&addrlen0));
	{
		...
		err0 = oslasterror_131619_2125978480();
		{
			NIM_BOOL LOC7;
			LOC7 = (NIM_BOOL)0;
			LOC7 = isdisconnectionerror_585478_170061329(flags0, err0);
			if (!LOC7) goto LA8;
...
N_NIMCALL(void, accept_587601_170061329)(Socketimpl585406* server0, Socketimpl585406** client0, Socketflag585416Set flags0) {
...
N_NIMCALL(void, T170061329_8)(void* p, NI op) {
	Timeouterror585414* a;
	a = (Timeouterror585414*)p;
...
{	result0 = (NI)0;
	...
	LA15: ;
	{
		...
		NF LOC33;
		{
			Timeouterror585414* e_589813_170061329;
			NimStringDesc* LOC22;
			if (!((NI)(timeout0 - ((NI) (((NF)((*waited0)) * (NF)(1.0000000000000000e+03))))) < ((NI) 1))) goto LA20;
			e_589813_170061329 = (Timeouterror585414*)0;
			e_589813_170061329 = (Timeouterror585414*) newObj((&NTI589814), sizeof(Timeouterror585414));
			(*e_589813_170061329).Sup.Sup.m_type = (&NTI585414);
...
appendString(LOC22, ((NimStringDesc*) &T170061329_10));
		...
		LA25: ;
		{
			Timeouterror585414* e_590006_170061329;
			NimStringDesc* LOC32;
			if (!!((selret0 == ((NI) 1)))) goto LA30;
			e_590006_170061329 = (Timeouterror585414*)0;
			e_590006_170061329 = (Timeouterror585414*) newObj((&NTI589814), sizeof(Timeouterror585414));
			(*e_590006_170061329).Sup.Sup.m_type = (&NTI585414);
...
N_NIMCALL(void, readline_590402_170061329)(Socketimpl585406* socket0, NimStringDesc** line0, NI timeout0, Socketflag585416Set flags0, NI maxlength0) {
	NF waited0;
{	waited0 = 0.0;
		...
		while (1) {
			...
			n0 = recv_589216_170061329(socket0, ((void*) ((&c0))), ((NI) 1));
			{
				...
				lasterror0 = getsocketerror_586201_170061329(socket0);
				{
					NIM_BOOL LOC10;
					LOC10 = (NIM_BOOL)0;
					LOC10 = isdisconnectionerror_585478_170061329(flags0, lasterror0);
					if (!LOC10) goto LA11;
					(*line0) = setLengthStr((*line0), ((NI) 0));
					goto BeforeRet;
				}
				LA11: ;
				socketerror_585472_170061329(socket0, n0, NIM_FALSE, lasterror0);
			}
			goto LA4;
			LA6: ;
			{
			...
			LA4: ;
			{
				...
				LA25: ;
				{
					...
					lasterror0 = getsocketerror_586201_170061329(socket0);
					{
						NIM_BOOL LOC33;
						LOC33 = (NIM_BOOL)0;
						LOC33 = isdisconnectionerror_585478_170061329(flags0, lasterror0);
						if (!LOC33) goto LA34;
						(*line0) = setLengthStr((*line0), ((NI) 0));
						goto BeforeRet;
					}
...
appendString((*line0), ((NimStringDesc*) &T170061329_12));
			...
			{
				NimStringDesc* msg0;
				Valueerror3646* e_590438_170061329;
				NimStringDesc* LOC51;
				if (!(maxlength0 < ((*line0) ? (*line0)->Sup.len : 0))) goto LA49;
				msg0 = copyString(((NimStringDesc*) &T170061329_13));
				e_590438_170061329 = (Valueerror3646*)0;
				e_590438_170061329 = (Valueerror3646*) newObj((&NTI23025), sizeof(Valueerror3646));
				(*e_590438_170061329).Sup.Sup.m_type = (&NTI3646);
				LOC51 = (NimStringDesc*)0;
				LOC51 = (*e_590438_170061329).Sup.message; (*e_590438_170061329).Sup.message = copyStringRC1(msg0);
				if (LOC51) nimGCunrefNoCycle(LOC51);
				raiseException((Exception*)e_590438_170061329, "ValueError");
			}
			LA49: ;
		}
	}
...
N_NIMCALL(void, close_587611_170061329)(Socketimpl585406* socket0) {
...
NTI585406.size = sizeof(Socketimpl585406);
NTI585406.kind = 18;
NTI585406.base = 0;
NTI585406.flags = 3;
T170061329_2[0] = &T170061329_0[1];
T170061329_0[1].kind = 1;
T170061329_0[1].offset = offsetof(Socketimpl585406, fd);
T170061329_0[1].typ = (&NTI7408);
T170061329_0[1].name = "fd";
T170061329_2[1] = &T170061329_0[2];
T170061329_0[2].kind = 3;
T170061329_0[2].offset = offsetof(Socketimpl585406, isbuffered);
T170061329_0[2].typ = (&NTI130);
T170061329_0[2].name = "isBuffered";
T170061329_0[2].sons = &NimDT_585406_isbuffered[0];
T170061329_0[2].len = 2;
T170061329_3[0] = &T170061329_0[4];
NTI585420.size = sizeof(TY585420);
NTI585420.kind = 16;
NTI585420.base = (&NTI136);
NTI585420.flags = 3;
T170061329_0[4].kind = 1;
T170061329_0[4].offset = offsetof(Socketimpl585406, isbufferedU.S1.buffer);
T170061329_0[4].typ = (&NTI585420);
T170061329_0[4].name = "buffer";
T170061329_3[1] = &T170061329_0[5];
T170061329_0[5].kind = 1;
T170061329_0[5].offset = offsetof(Socketimpl585406, isbufferedU.S1.currpos);
T170061329_0[5].typ = (&NTI104);
T170061329_0[5].name = "currPos";
T170061329_3[2] = &T170061329_0[6];
T170061329_0[6].kind = 1;
T170061329_0[6].offset = offsetof(Socketimpl585406, isbufferedU.S1.buflen);
...
NTI585406.node = &T170061329_0[0];
NTI585408.size = sizeof(Socketimpl585406*);
NTI585408.kind = 22;
NTI585408.base = (&NTI585406);
NTI585408.flags = 2;
NTI585408.marker = T170061329_4;
NTI585414.size = sizeof(Timeouterror585414);
NTI585414.kind = 17;
NTI585414.base = (&NTI3624);
T170061329_0[12].len = 0; T170061329_0[12].kind = 2;
NTI585414.node = &T170061329_0[12];
NTI589814.size = sizeof(Timeouterror585414*);
NTI589814.kind = 22;
NTI589814.base = (&NTI585414);
