...
appendString(LOC1, ((NimStringDesc*) &TMP4998));
	send_519208((*HEX3Aenvp_522438).stdoutsocket522408, LOC1, 2);
}
...
N_NIMCALL(void, serve_522254)(TY522256 action) {
	...
	typ = getconfigvar_155334(((NimStringDesc*) &TMP4989));
	...
	LA2: ;
	{
		...
		p = getconfigvar_155334(((NimStringDesc*) &TMP4994));
		{
			NI LOC18;
		...
		LA14: ;
		LOC20 = 0;
		LOC20 = getconfigvar_155334(((NimStringDesc*) &TMP4995));
		...
		writelnhook_165060.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				...
				action();
				gerrorcounter_165015 = ((NI) 0);
				send_519208((*HEX3Aenv_522447).stdoutsocket522408, ((NimStringDesc*) &TMP4998), 2);
...
TMP4984[0] = &TMP1071[1];
TMP1071[1].kind = 1;
TMP1071[1].offset = offsetof(TY522426, HEX3Astate);
TMP1071[1].typ = (&NTI311033);
TMP1071[1].name = ":state";
TMP4984[1] = &TMP1071[2];
TMP1071[2].kind = 1;
TMP1071[2].offset = offsetof(TY522426, stdoutsocket522408);
TMP1071[2].typ = (&NTI514409);
TMP1071[2].name = "stdoutSocket522408";
TMP1071[0].len = 2; TMP1071[0].kind = 2; TMP1071[0].sons = &TMP4984[0];
NTI522426.node = &TMP1071[0];
NTI522448.size = sizeof(TY522426*);
NTI522448.kind = 22;
NTI522448.base = (&NTI522426);
NTI522448.flags = 2;
NTI522448.marker = TMP4988;
}
