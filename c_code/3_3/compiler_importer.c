...
STRING_LITERAL(TMP3797, "invalid path: ", 14);
STRING_LITERAL(TMP3798, "as", 2);
STRING_LITERAL(TMP3799, " ", 1);
STRING_LITERAL(TMP3800, "", 0);
STRING_LITERAL(TMP3801, ".", 1);
STRING_LITERAL(TMP3802, "/", 1);
STRING_LITERAL(TMP3803, "invalid module name: \'$1\'", 25);
STRING_LITERAL(TMP3804, "module alias must be an identifier", 34);
STRING_LITERAL(TMP3805, "A module cannot import itself", 29);
STRING_LITERAL(TMP3806, "importAllSymbols: ", 18);
STRING_LITERAL(TMP3807, "rawImportSymbol", 15);
STRING_LITERAL(TMP3809, "importSymbol: 2", 15);
STRING_LITERAL(TMP3810, "importSymbol: 3", 15);
...
{	result0 = (NimStringDesc*)0;
	...
	{
		TSafePoint TMP3796;
		pushSafePoint(&TMP3796);
		TMP3796.status = _setjmp(TMP3796.context);
		if (TMP3796.status == 0) {
			NimStringDesc* LOC3;
			TY125106 LOC4;
			LOC3 = (NimStringDesc*)0;
			LOC3 = tofullpath_187270_155036129((*n0).info.fileindex);
...
appendString(LOC7, ((NimStringDesc*) &TMP3797));
appendString(LOC7, (*n0).kindU.S3.strval);
		...
		if (TMP3796.status != 0) reraiseException();
	}
	break;
	...
	case ((Tnodekind264020) 30):
	{
		NimStringDesc* LOC18;
		{
			...
			LOC15 = getident_194441_791273810(((NimStringDesc*) &TMP3798));
		...
		result0 = nsuReplaceStr(LOC18, ((NimStringDesc*) &TMP3799), ((NimStringDesc*) &TMP3800));
	}
	break;
	case ((Tnodekind264020) 45):
	{
		...
		result0 = nsuReplaceStr(LOC20, ((NimStringDesc*) &TMP3801), ((NimStringDesc*) &TMP3802));
	}
	break;
	...
	default:
	{
		...
		LOC24 = nsuFormatSingleElem(((NimStringDesc*) &TMP3803), LOC23);
		localerror_191080_155036129((*n0).info, ((Tmsgkind186002) 4), LOC24);
		result0 = copyString(((NimStringDesc*) &TMP3800));
	}
	break;
	}
	}BeforeRet: ;
...
N_NIMCALL(NI32, checkmodulename_319051_2178338529)(Tnode264794* n0) {
	...
	LOC1 = tofullpath_187270_155036129((*n0).info.fileindex);
	...
	LA4: ;
	{
		result0 = fileinfoidx_187016_155036129(fullpath0);
	}
	LA2: ;
	return result0;
}
...
N_NIMCALL(Tsym264826*, importmoduleas_319443_2178338529)(Tnode264794* n0, Tsym264826* realmodule0) {
	...
	LA3: ;
	{
		...
		LA8: ;
		if (!LOC6) goto LA9;
		localerror_191080_155036129((*n0).info, ((Tmsgkind186002) 4), ((NimStringDesc*) &TMP3804));
	}
	goto LA1;
	LA9: ;
	{
...
N_NIMCALL(Tsym264826*, myimportmodule_319474_2178338529)(Tcontext315020* c0, Tnode264794* n0) {
	...
	f0 = checkmodulename_319051_2178338529(n0);
	{
		...
		result0 = importmoduleas_319443_2178338529(n0, LOC5);
		{
			...
			localerror_191080_155036129((*n0).info, ((Tmsgkind186002) 4), ((NimStringDesc*) &TMP3805));
		}
		LA8: ;
		{
...
N_NIMCALL(void, rawimportsymbol_319058_2178338529)(Tcontext315020* c0, Tsym264826* s0) {
				...
				res_319196_2178338529 = ((NI) 0);
				{
					while (1) {
						...
						e0 = (*(*(*etyp0).n).kindU.S6.sons->data[j_319137_2178338529]).kindU.S4.sym;
						{
							...
							internalerror_191100_155036129((*s0).info, ((NimStringDesc*) &TMP3807));
						}
						LA27: ;
	...
	LA13: ;
	{
		...
		LA42: ;
		{
			NIM_BOOL LOC46;
			LOC46 = (NIM_BOOL)0;
			LOC46 = haspattern_269411_850551059(s0);
			if (!LOC46) goto LA47;
			addpattern_315429_893308950(c0, s0);
		}
		LA47: ;
	}
	LA11: ;
...
appendString(LOC15, ((NimStringDesc*) &TMP3806));
	...
	{
		{
			...
			loadstub_305824_1724185294(s0);
		}
		LA8: ;
		{
			if (!!(((21755776 &(1U<<((NU)((*s0).kind)&31U)))!=0))) goto LA12;
			internalerror_191100_155036129((*n0).info, ((NimStringDesc*) &TMP3809));
		}
		LA12: ;
		switch ((*s0).kind) {
			...
			e0 = initidentiter_271091_2984716966((&it0), (*frommod0).kindU.S3.tab, (*s0).name);
			{
				while (1) {
					if (!!((e0 == NIM_NIL))) goto LA16;
					{
						...
						internalerror_191100_155036129((*n0).info, ((NimStringDesc*) &TMP3810));
					}
					LA19: ;
					rawimportsymbol_319058_2178338529(c0, e0);
