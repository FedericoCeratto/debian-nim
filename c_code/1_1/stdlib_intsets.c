...
static TNimNode* TMP977[4];
static TNimNode* TMP978[3];
static TNimNode TMP736[9];
...
TMP977[0] = &TMP736[1];
TMP736[1].kind = 1;
TMP736[1].offset = offsetof(intset223056, Counter);
TMP736[1].typ = (&NTI108);
TMP736[1].name = "counter";
TMP977[1] = &TMP736[2];
TMP736[2].kind = 1;
TMP736[2].offset = offsetof(intset223056, Max);
TMP736[2].typ = (&NTI108);
TMP736[2].name = "max";
TMP977[2] = &TMP736[3];
...
TMP978[0] = &TMP736[5];
TMP736[5].kind = 1;
TMP736[5].offset = offsetof(ttrunk223052, Next);
TMP736[5].typ = (&NTI223050);
TMP736[5].name = "next";
TMP978[1] = &TMP736[6];
TMP736[6].kind = 1;
TMP736[6].offset = offsetof(ttrunk223052, Key);
TMP736[6].typ = (&NTI108);
TMP736[6].name = "key";
TMP978[2] = &TMP736[7];
TMP736[7].kind = 1;
TMP736[7].offset = offsetof(ttrunk223052, Bits);
TMP736[7].typ = (&NTI26220);
TMP736[7].name = "bits";
TMP736[4].len = 3; TMP736[4].kind = 2; TMP736[4].sons = &TMP978[0];
NTI223052.node = &TMP736[4];
NTI223050.size = sizeof(ttrunk223052*);
NTI223050.kind = 22;
NTI223050.base = (&NTI223052);
NTI223050.marker = TMP979;
TMP736[3].kind = 1;
TMP736[3].offset = offsetof(intset223056, Head);
TMP736[3].typ = (&NTI223050);
TMP736[3].name = "head";
TMP977[3] = &TMP736[8];
...
NTI223054.flags = 2;
NTI223054.marker = TMP980;
TMP736[8].kind = 1;
TMP736[8].offset = offsetof(intset223056, Data);
TMP736[8].typ = (&NTI223054);
TMP736[8].name = "data";
TMP736[0].len = 4; TMP736[0].kind = 2; TMP736[0].sons = &TMP977[0];
NTI223056.node = &TMP736[0];
}
