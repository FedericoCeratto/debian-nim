...
{	sent = send_517715(socket, ((void*) (data->data)), (data ? data->Sup.len : 0));
	...
	LA3: ;
	{
		...
		e_518219 = 0;
		e_518219 = (Oserror3433*) newObj((&NTI116812), sizeof(Oserror3433));
		(*e_518219).Sup.Sup.Sup.m_type = (&NTI3433);
		LOC14 = 0;
		LOC14 = (*e_518219).Sup.Sup.message; (*e_518219).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4995));
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_516818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5002));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_516818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5002));
