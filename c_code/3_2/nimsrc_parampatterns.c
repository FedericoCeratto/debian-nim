...
STRING_LITERAL(TMP3123, "parampatterns.nim", 17);
NIM_CONST TY86545 TMP3122 = {((NimStringDesc*) &TMP3123),
((NI) 100)}
;
NIM_CONST TY86545 TMP3124 = {((NimStringDesc*) &TMP3123),
((NI) 107)}
;
		...
		{
			{
				...
				LOC69 = 0;
				LOC69 = HEX24_165306(TMP3122);
				internalerror_165218(LOC69);
			}
			LA67: ;
			{
				NU8 i_268423;
...
N_NIMCALL(Tnode190813*, semnodekindconstraints_268679)(Tnode190813* p) {
	...
	(*result).kindU.S3.strval = addChar((*result).kindU.S3.strval, 1);
	{
		...
		}
		{
			...
			internalerror_165199((*p).info, ((NimStringDesc*) &TMP3125));
		}
		LA12: ;
	}
	goto LA1;
