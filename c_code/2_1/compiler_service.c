...
struct  TY563421  {
NI HEX3Astate;
Socketimpl554404* stdoutsocket563408;
};
...
STRING_LITERAL(TMP2192, "run", 3);
STRING_LITERAL(TMP5526, "server.type", 11);
STRING_LITERAL(TMP5527, "stdin", 5);
STRING_LITERAL(TMP5528, "tcp", 3);
STRING_LITERAL(TMP5529, "quit", 4);
STRING_LITERAL(TMP5531, "server.port", 11);
STRING_LITERAL(TMP5532, "server.address", 14);
STRING_LITERAL(TMP5535, "\015\012", 2);
STRING_LITERAL(TMP5543, "Invalid server.type:", 20);
...
extern TY187114 writelnhook_187117_155036129;
N_NIMCALL(void, TMP1344)() {
...
N_NIMCALL(void, processcmdline_563203_3526807654)(Tcmdlinepass252008 pass0, NimStringDesc* cmd0) {
	...
	argscount0 = ((NI) 0);
	{
		while (1) {
			...
			{
				{
					if (!eqStrings(p0.key, ((NimStringDesc*) &TMP1829))) goto LA7;
					p0.key = copyString(((NimStringDesc*) &TMP1830));
					{
						NIM_BOOL LOC11;
						LOC11 = (NIM_BOOL)0;
	...
	} LA1: ;
	{
		if (!(pass0 == ((Tcmdlinepass252008) 1))) goto LA23;
		{
			...
			LOC27 = !(eqStrings(LOC31, ((NimStringDesc*) &TMP2192)));
			LA30: ;
			if (!LOC27) goto LA32;
...
appendString(LOC1, ((NimStringDesc*) &TMP5535));
	send_559802_170061329((*HEX3Aenvp_563424_3526807654).stdoutsocket563408, LOC1, 2);
}
...
N_NIMCALL(void, serve_563236_3526807654)(TY563238 action0) {
	...
	typ0 = getconfigvar_164288_2607990831(((NimStringDesc*) &TMP5526));
	if (eqStrings(typ0, ((NimStringDesc*) &TMP5527))) goto LA1;
	if (eqStrings(typ0, ((NimStringDesc*) &TMP5528))) goto LA2;
	...
	{
		{
			while (1) {
				...
				{
					if (!eqStrings(line0, ((NimStringDesc*) &TMP5529))) goto LA10;
					exit(((NI) 0));
				}
				LA10: ;
				...
				processcmdline_563203_3526807654(((Tcmdlinepass252008) 1), line0);
				action0();
	...
	LA2: ;
	{
		...
		p0 = getconfigvar_164288_2607990831(((NimStringDesc*) &TMP5531));
		{
			NI LOC18;
		...
		LOC20 = getconfigvar_164288_2607990831(((NimStringDesc*) &TMP5532));
		...
		asgnRefNoCycle((void**) (&(*HEX3Aenv_563426_3526807654).stdoutsocket563408), newsocket_554821_170061329(((Domain548604) 2), ((Socktype548606) 1), ((Protocol548608) 6), NIM_TRUE));
		memset((void*)(&LOC21), 0, sizeof(LOC21));
		LOC21.ClPrc = HEX3Aanonymous_563409_3526807654; LOC21.ClEnv = HEX3Aenv_563426_3526807654;
		asgnRef((void**) (&writelnhook_187117_155036129.ClEnv), LOC21.ClEnv);
		writelnhook_187117_155036129.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				NimStringDesc* LOC24;
				accept_556401_170061329(server0, &(*HEX3Aenv_563426_3526807654).stdoutsocket563408, 2);
				readline_559202_170061329((*HEX3Aenv_563426_3526807654).stdoutsocket563408, (&inp0), ((NI) -1), 2);
				...
				processcmdline_563203_3526807654(((Tcmdlinepass252008) 1), inp0);
				action0();
				gerrorcounter_187081_155036129 = ((NI) 0);
				send_559802_170061329((*HEX3Aenv_563426_3526807654).stdoutsocket563408, ((NimStringDesc*) &TMP5535), 2);
				close_556411_170061329((*HEX3Aenv_563426_3526807654).stdoutsocket563408);
			}
		}
	}
	goto LA4;
	LA3: ;
	{
		printf("%s%s\012", ((NimStringDesc*) &TMP5543)? (((NimStringDesc*) &TMP5543))->data:"nil", typ0? (typ0)->data:"nil");
		fflush(stdout);
		msgquit_187156_155036129(((NI8) 1));
	}
	LA4: ;
}
...
nimRegisterGlobalMarker(TMP1344);
	LOC1 = (NimStringDesc*)0;
	LOC1 = curcaascmd_563201_3526807654; curcaascmd_563201_3526807654 = copyStringRC1(((NimStringDesc*) &TMP1345));
	if (LOC1) nimGCunrefNoCycle(LOC1);
nimRegisterGlobalMarker(TMP1346);
	LOC2 = (NimStringDesc*)0;
	LOC2 = lastcaascmd_563202_3526807654; lastcaascmd_563202_3526807654 = copyStringRC1(((NimStringDesc*) &TMP1345));
	if (LOC2) nimGCunrefNoCycle(LOC2);
}

NIM_EXTERNC N_NOINLINE(void, compiler_serviceDatInit000)(void) {
static TNimNode* TMP5512[2];
...
TMP5512[0] = &TMP1338[1];
TMP1338[1].kind = 1;
TMP1338[1].offset = offsetof(TY563421, HEX3Astate);
TMP1338[1].typ = (&NTI351021);
TMP1338[1].name = ":state";
TMP5512[1] = &TMP1338[2];
TMP1338[2].kind = 1;
TMP1338[2].offset = offsetof(TY563421, stdoutsocket563408);
TMP1338[2].typ = (&NTI554406);
TMP1338[2].name = "stdoutSocket563408";
TMP1338[0].len = 2; TMP1338[0].kind = 2; TMP1338[0].sons = &TMP5512[0];
NTI563421.node = &TMP1338[0];
NTI563420.size = sizeof(TY563421*);
NTI563420.kind = 22;
NTI563420.base = (&NTI563421);
NTI563420.flags = 2;
NTI563420.marker = TMP5525;
}
