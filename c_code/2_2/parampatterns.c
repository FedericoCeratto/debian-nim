...
STRING_LITERAL(TMP3010, "atom", 4);
STRING_LITERAL(TMP3011, "lit", 3);
STRING_LITERAL(TMP3012, "sym", 3);
STRING_LITERAL(TMP3013, "ident", 5);
STRING_LITERAL(TMP3014, "call", 4);
STRING_LITERAL(TMP3015, "alias", 5);
STRING_LITERAL(TMP3016, "noalias", 7);
STRING_LITERAL(TMP3017, "lvalue", 6);
STRING_LITERAL(TMP3018, "local", 5);
STRING_LITERAL(TMP3019, "sideeffect", 10);
STRING_LITERAL(TMP3020, "nosideeffect", 12);
STRING_LITERAL(TMP3022, "compiler/parampatterns.nim", 26);
NIM_CONST TY84745 TMP3021 = {((NimStringDesc*) &TMP3022),
100}
;
NIM_CONST TY84745 TMP3023 = {((NimStringDesc*) &TMP3022),
107}
;
STRING_LITERAL(TMP3024, "parameter pattern too complex", 29);
...
N_NIMCALL(void, compileconstraints_322129)(tnode226816* p, NimStringDesc** result) {
	...
	case ((NU8) 32):
	{
		...
		op = (*(*p).kindU.S6.Sons->data[0]).kindU.S5.Ident;
		{
			...
			if (!(LOC8 == 3)) goto LA9;
			{
				NIM_BOOL LOC13;
				LOC13 = 0;
				LOC13 = eqStrings((*op).S, ((NimStringDesc*) &TMP3007));
				if (LOC13) goto LA14;
				LOC13 = ((*op).Sup.Id == 48);
				LA14: ;
				if (!LOC13) goto LA15;
			...
			LA15: ;
			{
				NIM_BOOL LOC18;
				LOC18 = 0;
				LOC18 = eqStrings((*op).S, ((NimStringDesc*) &TMP3008));
				if (LOC18) goto LA19;
				LOC18 = ((*op).Sup.Id == 2);
				LA19: ;
				if (!LOC18) goto LA20;
		...
		LA9: ;
		{
			...
			if (!(LOC24)) goto LA26;
			LOC27 = 0;
			LOC27 = eqStrings((*op).S, ((NimStringDesc*) &TMP3009));
			if (LOC27) goto LA28;
			LOC27 = ((*op).Sup.Id == 44);
			LA28: ;
			LOC24 = LOC27;
	...
	case ((NU8) 2):
	{
		...
		case 2: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3020))) goto LA50;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3012))) goto LA42;
if (eqStrings(spec, ((NimStringDesc*) &TMP3017))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP3019))) goto LA49;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3013))) goto LA43;
break;
		case 10: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3016))) goto LA46;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3010))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3011))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3014))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3015))) goto LA45;
if (eqStrings(spec, ((NimStringDesc*) &TMP3018))) goto LA48;
break;
		}
		goto LA51;
		LA40: ;
...
N_NIMCALL(tnode226816*, semnodekindconstraints_322527)(tnode226816* p) {
	...
	(*result).kindU.S3.Strval = addChar((*result).kindU.S3.Strval, 1);
	{
		...
		}
		{
			...
			internalerror_198987((*p).Info, ((NimStringDesc*) &TMP3024));
		}
		LA12: ;
	}
	goto LA1;
