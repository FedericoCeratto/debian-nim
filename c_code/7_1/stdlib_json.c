...
N_NIMCALL(void, nl_339305)(NimStringDesc** s, NIM_BOOL ml) {
	{
		if (!ml) goto LA3;
		(*s) = resizeString((*s), 1);
appendString((*s), ((NimStringDesc*) &TMP4767));
	}
	LA3: ;
}
...
static TNimNode* TMP4755[7];
NI TMP4757;
static char* NIM_CONST TMP4756[7] = {
"JNull", 
"JBool", 
"JInt", 
"JFloat", 
...
NTI335038.base = 0;
NTI335038.flags = 3;
for (TMP4757 = 0; TMP4757 < 7; TMP4757++) {
TMP880[TMP4757+1].kind = 1;
TMP880[TMP4757+1].offset = TMP4757;
TMP880[TMP4757+1].name = TMP4756[TMP4757];
TMP4755[TMP4757] = &TMP880[TMP4757+1];
}
TMP880[8].len = 7; TMP880[8].kind = 2; TMP880[8].sons = &TMP4755[0];
NTI335038.node = &TMP880[8];
TMP880[0].kind = 3;
TMP880[0].offset = offsetof(jsonnodeobj335042, Kind);
TMP880[0].typ = (&NTI335038);
TMP880[0].name = "kind";
TMP880[0].sons = &NimDT_335042_kind[0];
TMP880[0].len = 7;
TMP880[9].kind = 1;
TMP880[9].offset = offsetof(jsonnodeobj335042, kindU.S1.Str);
TMP880[9].typ = (&NTI149);
TMP880[9].name = "str";
NimDT_335042_kind[4] = &TMP880[9];
TMP880[10].kind = 1;
TMP880[10].offset = offsetof(jsonnodeobj335042, kindU.S2.Num);
TMP880[10].typ = (&NTI5510);
TMP880[10].name = "num";
NimDT_335042_kind[2] = &TMP880[10];
TMP880[11].kind = 1;
TMP880[11].offset = offsetof(jsonnodeobj335042, kindU.S3.Fnum);
TMP880[11].typ = (&NTI128);
TMP880[11].name = "fnum";
NimDT_335042_kind[3] = &TMP880[11];
TMP880[12].kind = 1;
TMP880[12].offset = offsetof(jsonnodeobj335042, kindU.S4.Bval);
TMP880[12].typ = (&NTI138);
TMP880[12].name = "bval";
NimDT_335042_kind[1] = &TMP880[12];
TMP880[13].len = 0; TMP880[13].kind = 2;
NimDT_335042_kind[0] = &TMP880[13];
...
TMP4758[0] = &TMP880[16];
TMP880[16].kind = 1;
TMP880[16].offset = offsetof(TY335611, Field0);
TMP880[16].typ = (&NTI149);
TMP880[16].name = "Field0";
TMP4758[1] = &TMP880[17];
TMP880[17].kind = 1;
TMP880[17].offset = offsetof(TY335611, Field1);
TMP880[17].typ = (&NTI335040);
TMP880[17].name = "Field1";
TMP880[15].len = 2; TMP880[15].kind = 2; TMP880[15].sons = &TMP4758[0];
NTI335611.node = &TMP880[15];
NTI335057.size = sizeof(TY335057*);
NTI335057.kind = 24;
NTI335057.base = (&NTI335611);
NTI335057.flags = 2;
NTI335057.marker = TMP4759;
TMP880[14].kind = 1;
TMP880[14].offset = offsetof(jsonnodeobj335042, kindU.S6.Fields);
TMP880[14].typ = (&NTI335057);
TMP880[14].name = "fields";
NimDT_335042_kind[5] = &TMP880[14];
NTI335062.size = sizeof(TY335062*);
NTI335062.kind = 24;
NTI335062.base = (&NTI335040);
NTI335062.flags = 2;
NTI335062.marker = TMP4760;
TMP880[18].kind = 1;
TMP880[18].offset = offsetof(jsonnodeobj335042, kindU.S7.Elems);
TMP880[18].typ = (&NTI335062);
TMP880[18].name = "elems";
NimDT_335042_kind[6] = &TMP880[18];
NTI335042.node = &TMP880[0];
NTI335040.size = sizeof(jsonnodeobj335042*);
NTI335040.kind = 22;
NTI335040.base = (&NTI335042);
NTI335040.flags = 2;
NTI335040.marker = TMP4761;
}
