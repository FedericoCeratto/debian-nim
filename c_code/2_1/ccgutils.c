...
STRING_LITERAL(TMP3356, "GetUniqueType", 13);
STRING_LITERAL(TMP3363, "N", 1);
STRING_LITERAL(TMP3364, "HEX", 3);
STRING_LITERAL(TMP3455, "\"", 1);
STRING_LITERAL(TMP3966, "c\"", 2);
STRING_LITERAL(TMP3967, "\\00\"", 4);
...
N_NIMCALL(ttype226852*, getuniquetype_549401)(ttype226852* key) {
	...
	case ((NU8) 58):
	{
		internalerror_199006(((NimStringDesc*) &TMP3356));
	}
	break;
	case ((NU8) 13):
	{
...
N_NIMCALL(NimStringDesc*, mangle_549763)(NimStringDesc* name) {
	...
	case 48 ... 57:
	{
		...
		LOC4 = 0;
		LOC4 = rawNewString(2);
appendString(LOC4, ((NimStringDesc*) &TMP3363));
...
appendString(LOC6, ((NimStringDesc*) &TMP3364));
...
N_NIMCALL(trope178009*, makellvmstring_549816)(NimStringDesc* s) {
	...
	result = 0;
	result = NIM_NIL;
	res = copyString(((NimStringDesc*) &TMP3966));
	{
		NI i_549834;
		NI HEX3Atmp_549847;
		NI res_549850;
...
appendString(res, ((NimStringDesc*) &TMP3967));
	LOC12 = 0;
