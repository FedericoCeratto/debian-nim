...
STRING_LITERAL(TMP2190, "", 0);
STRING_LITERAL(TMP2191, "-", 1);
STRING_LITERAL(TMP2192, "stdinfile", 9);
STRING_LITERAL(TMP2221, "nim.cfg", 7);
STRING_LITERAL(TMP2222, "nims", 4);
...
{	{
	...
	LA4: ;
	{
		...
		processcmdline_562203_3526807654(((Tcmdlinepass251008) 0), ((NimStringDesc*) &TMP2190));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_163205_2607990831, ((NimStringDesc*) &TMP2191))) goto LA9;
			LOC11 = (NimStringDesc*)0;
			LOC11 = gprojectname_163205_2607990831; gprojectname_163205_2607990831 = copyStringRC1(((NimStringDesc*) &TMP2192));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = (NimStringDesc*)0;
			LOC12 = gprojectfull_163207_2607990831; gprojectfull_163207_2607990831 = copyStringRC1(((NimStringDesc*) &TMP2192));
		...
		LA9: ;
		{
			...
			pushSafePoint(&TMP2193);
			TMP2193.status = setjmp(TMP2193.context);
			if (TMP2193.status == 0) {
			...
			if (TMP2193.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_261603_930198375(((NimStringDesc*) &TMP2221));
		scriptfile0 = noschangeFileExt(gprojectfull_163207_2607990831, ((NimStringDesc*) &TMP2222));
		{
			NIM_BOOL LOC25;
			LOC25 = (NIM_BOOL)0;
		...
		processcmdline_562203_3526807654(((Tcmdlinepass251008) 1), ((NimStringDesc*) &TMP2190));
		{
...
appendString(LOC84, arguments_252716_2004575671);
				...
				LA73: ;
				{
					...
					LA88: ;
					{
						...
						LOC91 = noschangeFileExt(gprojectfull_163207_2607990831, ((NimStringDesc*) &TMP2190));
