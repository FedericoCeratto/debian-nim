...
Stringtableobj145212* gcookies_379115;
...
N_NIMCALL(NimStringDesc*, encodeurl_378004)(NimStringDesc* s) {
	...
	result = rawNewString(((NI) ((NI)((s ? s->Sup.len : 0) + (NI)((NU64)((s ? s->Sup.len : 0)) >> (NU64)(((NI) 2)))))));
	{
		...
		i_378018 = 0;
		HEX3Atmp_378028 = 0;
		HEX3Atmp_378028 = (NI)((s ? s->Sup.len : 0) - ((NI) 1));
		res_378031 = ((NI) 0);
		{
			while (1) {
				if (!(res_378031 <= HEX3Atmp_378028)) goto LA3;
				i_378018 = res_378031;
				switch (((NU8)(s->data[i_378018]))) {
				case 97 ... 122:
				case 65 ... 90:
				case 48 ... 57:
				case 95:
				{
					result = addChar(result, s->data[i_378018]);
				}
				break;
				case 32:
				{
				...
				default:
				{
					...
					LOC7 = 0;
					LOC7 = nsuToHex(((NI64) (((NU8)(s->data[i_378018])))), ((NI) 2));
