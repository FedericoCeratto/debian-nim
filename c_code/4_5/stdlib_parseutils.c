...
STRING_LITERAL(TMP1722, "overflow", 8);
	...
	LA1: ;
	{
		...
		(*b0) = IL64(0);
		{
			while (1) {
				...
				TMP1401 = mulInt64((*b0), IL64(10));
				TMP1402 = subInt(((NI) (((NU8)(s0->data[i0])))), ((NI) 48));
				TMP1403 = subInt64((NI64)(TMP1401), ((NI64) ((NI)(TMP1402))));
				(*b0) = (NI64)(TMP1403);
				TMP1404 = addInt(i0, ((NI) 1));
				i0 = (NI)(TMP1404);
				{
					while (1) {
						NI TMP1405;
						if (!((NU8)(s0->data[i0]) == (NU8)(95))) goto LA15;
						TMP1405 = addInt(i0, ((NI) 1));
						i0 = (NI)(TMP1405);
					} LA15: ;
				}
			} LA13: ;
		}
		TMP1406 = mulInt64((*b0), sign0);
		(*b0) = (NI64)(TMP1406);
		TMP1407 = subInt(i0, start0);
		result0 = (NI)(TMP1407);
	}
	LA10: ;
	return result0;
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s0, NI* number0, NI start0) {
	...
	result0 = npuParseBiggestInt(s0, (&res0), start0);
	{
		...
		LOC9 = (*e_97271_1912046442).Sup.Sup.message; (*e_97271_1912046442).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1722));
