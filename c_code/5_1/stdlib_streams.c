...
N_NIMCALL(void, TMP3268)(void* p, NI op);
...
N_NIMCALL(NimStringDesc*, mnewString)(NI len0);
STRING_LITERAL(TMP2982, "cannot write to stream", 22);
STRING_LITERAL(TMP3223, "", 0);
...
N_NIMCALL(NI, fspeekdata_151518_1780494535)(Streamobj150418* s0, void* buffer0, NI buflen0) {
	...
	TMP2981.status = _setjmp(TMP2981.context);
	if (TMP2981.status == 0) {
		result0 = readbuffer_15754_1689653243((*((Filestreamobj151477*) (s0))).f, buffer0, ((NI) (buflen0)));
		popSafePoint();
	}
...
N_NIMCALL(void, fswritedata_151525_1780494535)(Streamobj150418* s0, void* buffer0, NI buflen0) {
	{
		...
		LOC6 = (Ioerror3428*)0;
		LOC6 = neweio_150402_1780494535(((NimStringDesc*) &TMP2982));
...
N_NIMCALL(NimStringDesc*, readline_151361_1780494535)(Streamobj150418* s0) {
	...
	result0 = copyString(((NimStringDesc*) &TMP3223));
	{
		while (1) {
			NIM_CHAR c0;
...
static TNimNode* TMP2976[8];
static TNimNode* TMP3267[2];
