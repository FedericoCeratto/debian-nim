...
appendString(LOC26, tmp);
	setindexterm_311855(d, refname, LOC25, LOC26, ((NimStringDesc*) &TMP2094));
}
...
appendString(LOC8, LOC10);
	...
	setindexterm_311855(d, id, term, (*d).currentsection, ((NimStringDesc*) &TMP2094));
	memset((void*)LOC11, 0, sizeof(LOC11));
	...
	{
		{
			...
			raiseassert_86557(((NimStringDesc*) &TMP2160));
		}
		LA38: ;
	}
	break;
...
N_NIMCALL(void, striptoclevel_312981)(NimStringDesc* s, TY313067* Result) {
	...
	unsureAsgnRef((void**) (&(*Result).Field1), HEX5BHEX5D_85961(s, LOC8));
}
...
N_NIMCALL(NimStringDesc*, generatesymbolindex_312895)(TY314702* symbols) {
	...
	i = ((NI) 0);
	{
		while (1) {
			...
			cleanedkeyword = HEX5BHEX5D_85961(keyword, LOC3);
