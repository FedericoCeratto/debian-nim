...
extern TNimType NTI187093; /* seq[TLineInfo] */
...
N_NIMCALL(Tctx314036*, newctx_314287_984354655)(Tsym264826* module0) {
	...
	(*LOC1).debug = (TY187093*) newSeqRC1((&NTI187093), 0);
	...
	(*LOC1).comesfromheuristic = unknownlineinfo_187090_155036129();
