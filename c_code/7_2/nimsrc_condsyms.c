			...
			res_168233 = ((NI) 0);
			{
				while (1) {
					...
					h_168229 = res_168233;
					{
						...
						{
							if (!!(eqStrings(val_168215, ((NimStringDesc*) &TMP1465)))) goto LA11;
							result += ((NI) 1);
						}
						LA11: ;
					}
...
N_NIMCALL(void, definesymbol_168013)(NimStringDesc* symbol) {
	nstPut(gsymbols_168004, symbol, ((NimStringDesc*) &TMP1513));
}
...
N_NIMCALL(void, undefsymbol_168022)(NimStringDesc* symbol) {
	nstPut(gsymbols_168004, symbol, ((NimStringDesc*) &TMP1465));
}
