...
STRING_LITERAL(TMP1709, "key not found: ", 15);
STRING_LITERAL(TMP1960, "", 0);
...
appendString(LOC6, ((NimStringDesc*) &TMP1709));
...
N_NIMCALL(NimStringDesc*, getordefault_146814_603679043)(Stringtableobj146209* t0, NimStringDesc* key0) {
	...
	LA3: ;
	{
		result0 = copyString(((NimStringDesc*) &TMP1960));
	}
	LA1: ;
	return result0;
}
...
{	result0 = (NimStringDesc*)0;
	...
	LA4: ;
	{
		...
		result0 = getenv_132224_2125978480(key0);
	}
	goto LA6;
	LA8: ;
	{
