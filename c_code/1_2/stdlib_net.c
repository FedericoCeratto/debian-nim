...
#include <string.h>
#include <setjmp.h>
typedef struct Socketimpl581406 Socketimpl581406;
typedef struct TNimType TNimType;
typedef struct TNimNode TNimNode;
typedef struct NimStringDesc NimStringDesc;
typedef struct TGenericSeq TGenericSeq;
typedef struct Addrinfo116053 Addrinfo116053;
typedef struct Timeouterror581414 Timeouterror581414;
...
N_NIMCALL(Socketimpl581406*, newsocket_581674_170061329)(NI fd0, Domain575604 domain0, Socktype575606 socktype0, Protocol575608 protocol0, NIM_BOOL buffered0);
...
N_NIMCALL(NI, send_586110_170061329)(Socketimpl581406* socket0, void* data0, NI size0);
N_NIMCALL(NIM_BOOL, isdisconnectionerror_581478_170061329)(Socketflag581416Set flags0, NI32 lasterror0);
N_NIMCALL(void, socketerror_581472_170061329)(Socketimpl581406* socket0, NI err0, NIM_BOOL async0, NI32 lasterror0);
N_NIMCALL(NI32, getsocketerror_582201_170061329)(Socketimpl581406* socket0);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src0);
N_NIMCALL(void, acceptaddr_583008_170061329)(Socketimpl581406* server0, Socketimpl581406** client0, NimStringDesc** address0, Socketflag581416Set flags0);
...
N_NIMCALL(NI, waitfor_585206_170061329)(Socketimpl581406* socket0, NF* waited0, NI timeout0, NI size0, NimStringDesc* funcname0);
...
N_NIMCALL(NI, select_584601_170061329)(Socketimpl581406* readfd0, NI timeout0);
N_NIMCALL(NIM_BOOL, hasdatabuffered_584401_170061329)(Socketimpl581406* s0);
...
N_NIMCALL(NI, recv_584816_170061329)(Socketimpl581406* socket0, void* data0, NI size0);
N_NIMCALL(NI, readintobuf_584623_170061329)(Socketimpl581406* socket0, NI32 flags0);
N_NIMCALL(NI, peekchar_585836_170061329)(Socketimpl581406* socket0, NIM_CHAR* c0);
...
TNimNode* NimDT_581406_isbuffered[3];
...
TNimType NTI581406; /* SocketImpl */
extern TNimType NTI104; /* int */
extern TNimType NTI130; /* bool */
extern TNimType NTI136; /* char */
TNimType NTI581420; /* array[0..4000, char] */
...
TNimType NTI581414; /* TimeoutError */
...
N_NIMCALL(Socketimpl581406*, newsocket_581674_170061329)(NI fd0, Domain575604 domain0, Socktype575606 socktype0, Protocol575608 protocol0, NIM_BOOL buffered0) {
	Socketimpl581406* result0;
	result0 = (Socketimpl581406*)0;
	result0 = (Socketimpl581406*) newObj((&NTI581408), sizeof(Socketimpl581406));
	(*result0).fd = fd0;
...
N_NIMCALL(Socketimpl581406*, newsocket_582009_170061329)(Domain575604 domain0, Socktype575606 socktype0, Protocol575608 protocol0, NIM_BOOL buffered0) {
	Socketimpl581406* result0;
	NI fd0;
	result0 = (Socketimpl581406*)0;
...
N_NIMCALL(void, bindaddr_582807_170061329)(Socketimpl581406* socket0, NU16 port0, NimStringDesc* address0) {
	{
		SOCKADDR_IN name0;
		int LOC5;
...
N_NIMCALL(void, listen_582803_170061329)(Socketimpl581406* socket0, int backlog0) {
	{
		int LOC3;
		NI32 LOC6;
		LOC3 = (int)0;
...
N_NIMCALL(NIM_BOOL, isdisconnectionerror_581478_170061329)(Socketflag581416Set flags0, NI32 lasterror0) {
	...
	result0 = (NIM_BOOL)0;
	LOC1 = (NIM_BOOL)0;
	LOC1 = ((flags0 &(1U<<((NU)(((Socketflag581416) 1))&7U)))!=0);
	if (!(LOC1)) goto LA2;
...
N_NIMCALL(void, send_586401_170061329)(Socketimpl581406* socket0, NimStringDesc* data0, Socketflag581416Set flags0) {
	NI sent0;
{	sent0 = send_586110_170061329(socket0, ((void*) (data0->data)), (data0 ? data0->Sup.len : 0));
	{
		NI32 lasterror0;
		...
		lasterror0 = oslasterror_127240_2125978480();
		{
			NIM_BOOL LOC7;
			LOC7 = (NIM_BOOL)0;
			LOC7 = isdisconnectionerror_581478_170061329(flags0, lasterror0);
			if (!LOC7) goto LA8;
			goto BeforeRet;
		}
		LA8: ;
		socketerror_581472_170061329(socket0, ((NI) -1), NIM_FALSE, lasterror0);
	}
	LA3: ;
	{
		NI32 LOC14;
...
N_NIMCALL(void, acceptaddr_583008_170061329)(Socketimpl581406* server0, Socketimpl581406** client0, NimStringDesc** address0, Socketflag581416Set flags0) {
	...
	sock0 = Dl_116207((*server0).fd, ((SOCKADDR*) ((&sockaddress0))), (&addrlen0));
	{
		...
		err0 = oslasterror_127240_2125978480();
		{
			NIM_BOOL LOC7;
			LOC7 = (NIM_BOOL)0;
			LOC7 = isdisconnectionerror_581478_170061329(flags0, err0);
			if (!LOC7) goto LA8;
...
N_NIMCALL(void, accept_583601_170061329)(Socketimpl581406* server0, Socketimpl581406** client0, Socketflag581416Set flags0) {
...
N_NIMCALL(void, T170061329_8)(void* p, NI op) {
	Timeouterror581414* a;
	a = (Timeouterror581414*)p;
...
{	result0 = (NI)0;
	...
	LA15: ;
	{
		...
		NF LOC33;
		{
			Timeouterror581414* e_585413_170061329;
			NimStringDesc* LOC22;
			if (!((NI)(timeout0 - ((NI) (((NF)((*waited0)) * (NF)(1.0000000000000000e+03))))) < ((NI) 1))) goto LA20;
			e_585413_170061329 = (Timeouterror581414*)0;
			e_585413_170061329 = (Timeouterror581414*) newObj((&NTI585414), sizeof(Timeouterror581414));
			(*e_585413_170061329).Sup.Sup.m_type = (&NTI581414);
...
appendString(LOC22, ((NimStringDesc*) &T170061329_10));
		...
		LA25: ;
		{
			Timeouterror581414* e_585606_170061329;
			NimStringDesc* LOC32;
			if (!!((selret0 == ((NI) 1)))) goto LA30;
			e_585606_170061329 = (Timeouterror581414*)0;
			e_585606_170061329 = (Timeouterror581414*) newObj((&NTI585414), sizeof(Timeouterror581414));
			(*e_585606_170061329).Sup.Sup.m_type = (&NTI581414);
...
N_NIMCALL(void, readline_586002_170061329)(Socketimpl581406* socket0, NimStringDesc** line0, NI timeout0, Socketflag581416Set flags0, NI maxlength0) {
	NF waited0;
{	waited0 = 0.0;
		...
		while (1) {
			...
			n0 = recv_584816_170061329(socket0, ((void*) ((&c0))), ((NI) 1));
			{
				...
				lasterror0 = getsocketerror_582201_170061329(socket0);
				{
					NIM_BOOL LOC10;
					LOC10 = (NIM_BOOL)0;
					LOC10 = isdisconnectionerror_581478_170061329(flags0, lasterror0);
					if (!LOC10) goto LA11;
					(*line0) = setLengthStr((*line0), ((NI) 0));
					goto BeforeRet;
				}
				LA11: ;
				socketerror_581472_170061329(socket0, n0, NIM_FALSE, lasterror0);
			}
			goto LA4;
			LA6: ;
			{
			...
			LA4: ;
			{
				...
				LA25: ;
				{
					...
					lasterror0 = getsocketerror_582201_170061329(socket0);
					{
						NIM_BOOL LOC33;
						LOC33 = (NIM_BOOL)0;
						LOC33 = isdisconnectionerror_581478_170061329(flags0, lasterror0);
						if (!LOC33) goto LA34;
						(*line0) = setLengthStr((*line0), ((NI) 0));
						goto BeforeRet;
					}
...
appendString((*line0), ((NimStringDesc*) &T170061329_12));
			...
			{
				NimStringDesc* msg0;
				Valueerror3646* e_586038_170061329;
				NimStringDesc* LOC51;
				if (!(maxlength0 < ((*line0) ? (*line0)->Sup.len : 0))) goto LA49;
				msg0 = copyString(((NimStringDesc*) &T170061329_13));
				e_586038_170061329 = (Valueerror3646*)0;
				e_586038_170061329 = (Valueerror3646*) newObj((&NTI23025), sizeof(Valueerror3646));
				(*e_586038_170061329).Sup.Sup.m_type = (&NTI3646);
				LOC51 = (NimStringDesc*)0;
				LOC51 = (*e_586038_170061329).Sup.message; (*e_586038_170061329).Sup.message = copyStringRC1(msg0);
				if (LOC51) nimGCunrefNoCycle(LOC51);
				raiseException((Exception*)e_586038_170061329, "ValueError");
			}
			LA49: ;
		}
	}
...
N_NIMCALL(void, close_583611_170061329)(Socketimpl581406* socket0) {
	TSafePoint T170061329_14;
	pushSafePoint(&T170061329_14);
	T170061329_14.status = setjmp(T170061329_14.context);
...
NTI581406.size = sizeof(Socketimpl581406);
NTI581406.kind = 18;
NTI581406.base = 0;
NTI581406.flags = 3;
T170061329_2[0] = &T170061329_0[1];
T170061329_0[1].kind = 1;
T170061329_0[1].offset = offsetof(Socketimpl581406, fd);
T170061329_0[1].typ = (&NTI104);
T170061329_0[1].name = "fd";
T170061329_2[1] = &T170061329_0[2];
T170061329_0[2].kind = 3;
T170061329_0[2].offset = offsetof(Socketimpl581406, isbuffered);
T170061329_0[2].typ = (&NTI130);
T170061329_0[2].name = "isBuffered";
T170061329_0[2].sons = &NimDT_581406_isbuffered[0];
T170061329_0[2].len = 2;
T170061329_3[0] = &T170061329_0[4];
NTI581420.size = sizeof(TY581420);
NTI581420.kind = 16;
NTI581420.base = (&NTI136);
NTI581420.flags = 3;
T170061329_0[4].kind = 1;
T170061329_0[4].offset = offsetof(Socketimpl581406, isbufferedU.S1.buffer);
T170061329_0[4].typ = (&NTI581420);
T170061329_0[4].name = "buffer";
T170061329_3[1] = &T170061329_0[5];
T170061329_0[5].kind = 1;
T170061329_0[5].offset = offsetof(Socketimpl581406, isbufferedU.S1.currpos);
T170061329_0[5].typ = (&NTI104);
T170061329_0[5].name = "currPos";
T170061329_3[2] = &T170061329_0[6];
T170061329_0[6].kind = 1;
T170061329_0[6].offset = offsetof(Socketimpl581406, isbufferedU.S1.buflen);
...
NTI581406.node = &T170061329_0[0];
NTI581408.size = sizeof(Socketimpl581406*);
NTI581408.kind = 22;
NTI581408.base = (&NTI581406);
NTI581408.flags = 2;
NTI581408.marker = T170061329_4;
NTI581414.size = sizeof(Timeouterror581414);
NTI581414.kind = 17;
NTI581414.base = (&NTI3624);
T170061329_0[12].len = 0; T170061329_0[12].kind = 2;
NTI581414.node = &T170061329_0[12];
NTI585414.size = sizeof(Timeouterror581414*);
NTI585414.kind = 22;
NTI585414.base = (&NTI581414);
