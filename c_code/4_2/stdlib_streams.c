...
STRING_LITERAL(TMP2716, "cannot write to stream", 22);
...
N_NIMCALL(void, fswritedata_135806)(streamobj135035* s, void* buffer, NI buflen) {
	{
		...
		LOC6 = 0;
		LOC6 = neweio_135005(((NimStringDesc*) &TMP2716));
