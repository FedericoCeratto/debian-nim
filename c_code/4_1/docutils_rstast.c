...
static TNimNode* TMP2561[4];
static TNimNode* TMP2562[65];
NI TMP2564;
static char* NIM_CONST TMP2563[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI331005.base = 0;
NTI331005.flags = 3;
for (TMP2564 = 0; TMP2564 < 65; TMP2564++) {
TMP961[TMP2564+2].kind = 1;
TMP961[TMP2564+2].offset = TMP2564;
TMP961[TMP2564+2].name = TMP2563[TMP2564];
TMP2562[TMP2564] = &TMP961[TMP2564+2];
}
TMP961[67].len = 65; TMP961[67].kind = 2; TMP961[67].sons = &TMP2562[0];
