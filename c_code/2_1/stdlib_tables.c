...
N_NIMCALL(void, rawinsert_316198)(Table313409* t, Keyvaluepairseq313412** data, Tindexentry313396 key, TY315702* val, NI hc, NI h);
		...
		res_383307 = ((NI) 0);
		{
			while (1) {
				...
				i_383250 = res_383307;
				{
					...
					NI LOC10;
					LOC7 = 0;
					LOC7 = isfilled_157211(n->data[i_383250].Field0);
					if (!LOC7) goto LA8;
					LOC10 = 0;
...
N_NIMCALL(void, inittable_315724)(NI initialsize, Table313409* Result) {
	(*Result).counter = ((NI) 0);
	unsureAsgnRef((void**) (&(*Result).data), (Keyvaluepairseq313412*) newSeq((&NTI313412), ((NI) (initialsize))));
}
...
N_NIMCALL(void, rawinsert_316198)(Table313409* t, Keyvaluepairseq313412** data, Tindexentry313396 key, TY315702* val, NI hc, NI h) {
	...
	genericSeqAssign((&(*data)->data[h].Field2), val, (&NTI315702));
	(*data)->data[h].Field0 = hc;
}
...
N_NIMCALL(void, enlarge_316109)(Table313409* t) {
	...
	n = 0;
	n = (Keyvaluepairseq313412*) newSeq((&NTI313412), ((NI) ((NI)(((*t).data ? (*t).data->Sup.len : 0) * ((NI) 2)))));
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = LOC1;
...
N_NIMCALL(void, HEX5BHEX5DHEX3D_316072)(Table313409* t, Tindexentry313396 key, TY315702* val) {
	...
	{
		if (!(((NI) 0) <= index)) goto LA3;
		genericSeqAssign((&(*t).data->data[index].Field2), val, (&NTI315702));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(TY315702*, HEX5BHEX5D_315282)(Table313409 t, Tindexentry313396 key) {
	...
	{
		if (!(((NI) 0) <= index)) goto LA3;
		genericSeqAssign((&result), t.data->data[index].Field2, (&NTI315702));
	}
	LA3: ;
	return result;
}
...
TMP55[15].len = 2; TMP55[15].kind = 2; TMP55[15].sons = &TMP4765[0];
...
TMP4915[0] = &TMP55[19];
TMP55[19].kind = 1;
TMP55[19].offset = offsetof(Keyvaluepair313415, Field0);
TMP55[19].typ = (&NTI131021);
TMP55[19].name = "Field0";
TMP4915[1] = &TMP55[20];
TMP55[20].kind = 1;
TMP55[20].offset = offsetof(Keyvaluepair313415, Field1);
TMP55[20].typ = (&NTI313396);
TMP55[20].name = "Field1";
TMP4915[2] = &TMP55[21];
TMP55[21].kind = 1;
TMP55[21].offset = offsetof(Keyvaluepair313415, Field2);
TMP55[21].typ = (&NTI315702);
TMP55[21].name = "Field2";
TMP55[18].len = 3; TMP55[18].kind = 2; TMP55[18].sons = &TMP4915[0];
NTI313415.node = &TMP55[18];
NTI313412.size = sizeof(Keyvaluepairseq313412*);
NTI313412.kind = 24;
NTI313412.base = (&NTI313415);
NTI313412.flags = 2;
NTI313412.marker = TMP4918;
}
