...
N_NIMCALL(tnode226816*, totreeset_285754)(tbitset284012* s, ttype226852* settype, tlineinfo196539 info);
...
N_NIMCALL(void, tobitset_285004)(tnode226816* s, tbitset284012** b) {
	...
	bitsetinit_284021(b, ((NI) (LOC1)));
	{
		...
		HEX3Atmp_285728 = (NI64)(LOC3 - 1);
		res_285731 = 0;
		{
			while (1) {
				if (!(res_285731 <= HEX3Atmp_285728)) goto LA5;
				i_285617 = res_285731;
				{
...
N_NIMCALL(tnode226816*, diffsets_285054)(tnode226816* a, tnode226816* b) {
	...
	result = totreeset_285754(x, (*a).Typ, (*a).Info);
	return result;
}
...
N_NIMCALL(NI64, cardset_285089)(tnode226816* s) {
	...
	result = IL64(0);
	{
		...
		HEX3Atmp_286116 = (NI64)(LOC2 - 1);
		res_286119 = 0;
		{
			while (1) {
				if (!(res_286119 <= HEX3Atmp_286116)) goto LA4;
				i_286023 = res_286119;
				{
					NI64 LOC9;
					NI64 LOC10;
					if (!((*(*s).kindU.S6.Sons->data[i_286023]).Kind == ((NU8) 44))) goto LA7;
					LOC9 = 0;
					LOC9 = getordvalue_264187((*(*s).kindU.S6.Sons->data[i_286023]).kindU.S6.Sons->data[1]);
					LOC10 = 0;
					LOC10 = getordvalue_264187((*(*s).kindU.S6.Sons->data[i_286023]).kindU.S6.Sons->data[0]);
...
N_NIMCALL(tnode226816*, complement_285966)(tnode226816* a) {
	...
	tobitset_285004(a, (&x));
	{
		...
		i_285984 = 0;
		HEX3Atmp_285987 = 0;
		HEX3Atmp_285987 = (x->Sup.len-1);
		res_285990 = 0;
		{
			while (1) {
				if (!(res_285990 <= HEX3Atmp_285987)) goto LA3;
				i_285984 = res_285990;
				x->data[i_285984] = (NI8)((NU8) ~(x->data[i_285984]));
				res_285990 += 1;
			} LA3: ;
		}
	}
