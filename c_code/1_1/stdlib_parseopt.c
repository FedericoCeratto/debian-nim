...
static NIM_CONST TY212607 TMP1576 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY212607 TMP1577 = {
		...
		unsureAsgnRef((void**) (&(*Result).Cmd), copyString(((NimStringDesc*) &TMP1573)));
		{
			...
			res_208052 = 1;
			{
				while (1) {
					...
					LOC9 = 0;
					LOC10 = 0;
					LOC10 = nosparamStr(i_208046);
					LOC11 = 0;
					LOC11 = quoteifcontainswhite_99234(LOC10);
...
N_NIMCALL(void, handleshortoption_208309)(optparser208011* p) {
	...
	}
	{
		...
		i = parseword_208204((*p).Cmd, i, (&(*p).Val), TMP1576);
	}
	LA5: ;
	{
...
N_NIMCALL(void, nponext)(optparser208011* p) {
	...
	case 45:
	{
		i += 1;
		{
			...
			(*p).Kind = ((NU8) 2);
			i += 1;
			i = parseword_208204((*p).Cmd, i, (&(*p).Key), TMP1577);
			{
				while (1) {
			...
			}
			{
				...
				(*p).Pos = parseword_208204((*p).Cmd, i, (&(*p).Val), TMP1576);
			}
			goto LA15;
			LA17: ;
			{
	...
	{
		(*p).Kind = ((NU8) 1);
		(*p).Pos = parseword_208204((*p).Cmd, i, (&(*p).Key), TMP1576);
	}
	break;
	}
	BeforeRet: ;
...
"cmdLongOption", 
"cmdShortOption"};
static TNimNode TMP719[12];
NTI208011.size = sizeof(optparser208011);
NTI208011.kind = 17;
NTI208011.base = (&NTI3211);
TMP1569[0] = &TMP719[1];
TMP719[1].kind = 1;
TMP719[1].offset = offsetof(optparser208011, Cmd);
TMP719[1].typ = (&NTI149);
TMP719[1].name = "cmd";
TMP1569[1] = &TMP719[2];
TMP719[2].kind = 1;
TMP719[2].offset = offsetof(optparser208011, Pos);
TMP719[2].typ = (&NTI108);
TMP719[2].name = "pos";
TMP1569[2] = &TMP719[3];
TMP719[3].kind = 1;
TMP719[3].offset = offsetof(optparser208011, Inshortstate);
TMP719[3].typ = (&NTI138);
TMP719[3].name = "inShortState";
TMP1569[3] = &TMP719[4];
...
TMP719[TMP1572+5].kind = 1;
TMP719[TMP1572+5].offset = TMP1572;
TMP719[TMP1572+5].name = TMP1571[TMP1572];
TMP1570[TMP1572] = &TMP719[TMP1572+5];
}
TMP719[9].len = 4; TMP719[9].kind = 2; TMP719[9].sons = &TMP1570[0];
NTI208009.node = &TMP719[9];
TMP719[4].kind = 1;
TMP719[4].offset = offsetof(optparser208011, Kind);
TMP719[4].typ = (&NTI208009);
TMP719[4].name = "kind";
TMP1569[4] = &TMP719[10];
TMP719[10].kind = 1;
TMP719[10].offset = offsetof(optparser208011, Key);
TMP719[10].typ = (&NTI149);
TMP719[10].name = "key";
TMP1569[5] = &TMP719[11];
TMP719[11].kind = 1;
TMP719[11].offset = offsetof(optparser208011, Val);
TMP719[11].typ = (&NTI149);
TMP719[11].name = "val";
TMP719[0].len = 6; TMP719[0].kind = 2; TMP719[0].sons = &TMP1569[0];
NTI208011.node = &TMP719[0];
}
