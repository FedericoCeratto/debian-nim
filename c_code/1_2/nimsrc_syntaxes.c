...
N_NIMCALL(Tnode191813*, parsepipe_219170)(NimStringDesc* filename, Tllstream179204* inputstream);
...
N_NIMCALL(Tllstream179204*, evalpipe_219722)(Tparsers219035* p, Tnode191813* n, NimStringDesc* filename, Tllstream179204* start);
N_NIMCALL(NIM_BOOL, identeq_168484)(Tident168021* id, NimStringDesc* name);
N_NIMCALL(Tllstream179204*, applyfilter_219689)(Tparsers219035* p, Tnode191813* n, NimStringDesc* filename, Tllstream179204* stdin_219695);
N_NIMCALL(Tident168021*, getcallee_219647)(Tnode191813* n);
N_NIMCALL(NimStringDesc*, rendertree_213058)(Tnode191813* n, NU8 renderflags);
N_NIMCALL(NU8, getfilter_219239)(Tident168021* ident);
N_NIMCALL(NU8, getparser_219447)(Tident168021* ident);
N_NIMCALL(Tllstream179204*, filtertmpl_218009)(Tllstream179204* stdin_218011, NimStringDesc* filename, Tnode191813* call);
...
NIM_CONST TY219026 filternames_219025 = {((NimStringDesc*) &TMP1400),
...
NIM_CONST TY219020 parsernames_219019 = {((NimStringDesc*) &TMP1404),
		...
		res_219429 = ((NI) 0);
		{
			while (1) {
				...
				i_219423 = ((NU8) (res_219429));
				{
					NIM_BOOL LOC6;
					LOC6 = 0;
					LOC6 = identeq_168484(ident, filternames_219025[(i_219423)- 0]);
					if (!LOC6) goto LA7;
					result = i_219423;
					goto BeforeRet;
				}
		...
		res_219629 = ((NI) 0);
		{
			while (1) {
				...
				i_219623 = ((NU8) (res_219629));
				{
					NIM_BOOL LOC6;
					LOC6 = 0;
					LOC6 = identeq_168484(ident, parsernames_219019[(i_219623)- 0]);
					if (!LOC6) goto LA7;
					result = i_219623;
					goto BeforeRet;
				}
...
N_NIMCALL(Tnode191813*, parseall_219063)(Tparsers219035* p) {
	...
	case ((NU8) 3):
	{
		internalerror_166218(((NimStringDesc*) &TMP1438));
		result = emptynode_192807;
	}
	break;
	}
