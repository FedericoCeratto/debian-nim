...
STRING_LITERAL(TMP1394, "true", 4);
STRING_LITERAL(TMP1440, "nimrod", 6);
STRING_LITERAL(TMP1441, "nimhygiene", 10);
STRING_LITERAL(TMP1442, "niminheritable", 14);
STRING_LITERAL(TMP1443, "nimmixin", 8);
STRING_LITERAL(TMP1444, "nimeffects", 10);
STRING_LITERAL(TMP1445, "nimbabel", 8);
STRING_LITERAL(TMP1446, "nimcomputedgoto", 15);
STRING_LITERAL(TMP1447, "nimunion", 8);
STRING_LITERAL(TMP1448, "nimnewshared", 12);
STRING_LITERAL(TMP1449, "nimrequiresnimframe", 19);
STRING_LITERAL(TMP1450, "nimparsebiggestfloatmagic", 25);
STRING_LITERAL(TMP1451, "nimalias", 8);
STRING_LITERAL(TMP1452, "nimlocks", 8);
STRING_LITERAL(TMP1453, "unknown", 7);
STRING_LITERAL(TMP1454, "cpu", 3);
extern NIM_CONST TY174481 cpu_174480;
extern NIM_CONST TY174475 endiantostr_174474;
extern NIM_CONST TY174070 os_174069;
STRING_LITERAL(TMP1457, "x86", 3);
STRING_LITERAL(TMP1458, "itanium", 7);
STRING_LITERAL(TMP1459, "x8664", 5);
STRING_LITERAL(TMP1460, "msdos", 5);
STRING_LITERAL(TMP1461, "mswindows", 9);
STRING_LITERAL(TMP1462, "win32", 5);
STRING_LITERAL(TMP1463, "unix", 4);
STRING_LITERAL(TMP1464, "posix", 5);
STRING_LITERAL(TMP1465, "sunos", 5);
STRING_LITERAL(TMP1466, "bsd", 3);
STRING_LITERAL(TMP1467, "macintosh", 9);
STRING_LITERAL(TMP1468, "RISCOS", 6);
STRING_LITERAL(TMP1469, "hpux", 4);
STRING_LITERAL(TMP1470, "mac", 3);
STRING_LITERAL(TMP1471, "hppa", 4);
STRING_LITERAL(TMP1472, "hp9000", 6);
STRING_LITERAL(TMP1473, "hp9000s300", 10);
STRING_LITERAL(TMP1474, "hp9000s700", 10);
STRING_LITERAL(TMP1475, "hp9000s800", 10);
STRING_LITERAL(TMP1476, "hp9000s820", 10);
STRING_LITERAL(TMP1477, "ELATE", 5);
STRING_LITERAL(TMP1478, "sparcv9", 7);
STRING_LITERAL(TMP1479, "ecmascript", 10);
STRING_LITERAL(TMP1480, "js", 2);
STRING_LITERAL(TMP1481, "nimrodvm", 8);
STRING_LITERAL(TMP1482, "nimffi", 6);
STRING_LITERAL(TMP1483, "nimdoc", 6);
STRING_LITERAL(TMP1484, "cpp", 3);
STRING_LITERAL(TMP1485, "objc", 4);
STRING_LITERAL(TMP1486, "gcc", 3);
STRING_LITERAL(TMP1487, "llvmgcc", 7);
STRING_LITERAL(TMP1488, "clang", 5);
STRING_LITERAL(TMP1489, "lcc", 3);
STRING_LITERAL(TMP1490, "bcc", 3);
STRING_LITERAL(TMP1491, "dmc", 3);
STRING_LITERAL(TMP1492, "wcc", 3);
STRING_LITERAL(TMP1493, "vcc", 3);
STRING_LITERAL(TMP1494, "tcc", 3);
STRING_LITERAL(TMP1495, "pcc", 3);
STRING_LITERAL(TMP1496, "ucc", 3);
STRING_LITERAL(TMP1497, "icl", 3);
STRING_LITERAL(TMP1498, "boehmgc", 7);
STRING_LITERAL(TMP1499, "gcmarkandsweep", 14);
STRING_LITERAL(TMP1500, "gcgenerational", 14);
STRING_LITERAL(TMP1501, "nogc", 4);
STRING_LITERAL(TMP1502, "gcUseBitvectors", 15);
STRING_LITERAL(TMP1503, "endb", 4);
STRING_LITERAL(TMP1504, "profiler", 8);
STRING_LITERAL(TMP1505, "executable", 10);
STRING_LITERAL(TMP1506, "guiapp", 6);
STRING_LITERAL(TMP1507, "consoleapp", 10);
STRING_LITERAL(TMP1508, "library", 7);
STRING_LITERAL(TMP1509, "dll", 3);
STRING_LITERAL(TMP1510, "staticlib", 9);
STRING_LITERAL(TMP1511, "quick", 5);
STRING_LITERAL(TMP1512, "release", 7);
STRING_LITERAL(TMP1513, "debug", 5);
STRING_LITERAL(TMP1514, "useWinAnsi", 10);
STRING_LITERAL(TMP1515, "useFork", 7);
STRING_LITERAL(TMP1516, "useNimRtl", 9);
STRING_LITERAL(TMP1517, "useMalloc", 9);
STRING_LITERAL(TMP1518, "useRealtimeGC", 13);
STRING_LITERAL(TMP1519, "ssl", 3);
STRING_LITERAL(TMP1520, "memProfiler", 11);
STRING_LITERAL(TMP1521, "nodejs", 6);
STRING_LITERAL(TMP1522, "kwin", 4);
STRING_LITERAL(TMP1523, "nimfix", 6);
STRING_LITERAL(TMP1524, "usesysassert", 12);
STRING_LITERAL(TMP1525, "usegcassert", 11);
STRING_LITERAL(TMP1526, "tinyC", 5);
STRING_LITERAL(TMP1527, "useFFI", 6);
STRING_LITERAL(TMP1528, "useStdoutAsStdmsg", 17);
STRING_LITERAL(TMP1529, "createNimRtl", 12);
STRING_LITERAL(TMP1530, "booting", 7);
STRING_LITERAL(TMP1531, "fulldebug", 9);
STRING_LITERAL(TMP1532, "corruption", 10);
STRING_LITERAL(TMP1533, "nimsuperops", 11);
STRING_LITERAL(TMP1534, "noSignalHandler", 15);
STRING_LITERAL(TMP1535, "useGnuReadline", 14);
STRING_LITERAL(TMP1536, "noCaas", 6);
STRING_LITERAL(TMP1537, "noDocGen", 8);
STRING_LITERAL(TMP1538, "noBusyWaiting", 13);
STRING_LITERAL(TMP1539, "nativeStackTrace", 16);
STRING_LITERAL(TMP1540, "useNodeIds", 10);
STRING_LITERAL(TMP1541, "selftest", 8);
STRING_LITERAL(TMP1542, "reportMissedDeadlines", 21);
STRING_LITERAL(TMP1543, "avoidTimeMachine", 16);
STRING_LITERAL(TMP1544, "useClone", 8);
STRING_LITERAL(TMP1545, "ignoreAllocationSize", 20);
STRING_LITERAL(TMP1546, "debugExecProcesses", 18);
STRING_LITERAL(TMP1547, "pcreDll", 7);
STRING_LITERAL(TMP1548, "useLipzipSrc", 12);
STRING_LITERAL(TMP1549, "preventDeadlocks", 16);
STRING_LITERAL(TMP1550, "UNICODE", 7);
STRING_LITERAL(TMP1551, "winUnicode", 10);
STRING_LITERAL(TMP1552, "trackGcHeaders", 14);
STRING_LITERAL(TMP1553, "posixRealtime", 13);
STRING_LITERAL(TMP1554, "nimStdSetjmp", 12);
STRING_LITERAL(TMP1555, "nimRawSetjmp", 12);
STRING_LITERAL(TMP1556, "nimSigSetjmp", 12);
NIM_CONST struct {
  TGenericSeq Sup;
  NimStringDesc* data[100];
} CNSTSEQ1558 = {{100, 100}, {((NimStringDesc*) &TMP1457),
...
NIM_CONST TY119808* additionalsymbols_201142 = ((TY119808*)&CNSTSEQ1558);
STRING_LITERAL(TMP1558, "emulatedthreadvars", 18);
STRING_LITERAL(TMP1690, "false", 5);
...
N_NIMCALL(NIM_BOOL, isdefined_201036)(NimStringDesc* symbol) {
	...
	result = 0;
	{
		...
		result = eqStrings(LOC6, ((NimStringDesc*) &TMP1394));
	}
	LA4: ;
	return result;
}
			...
			res_201123 = 0;
			{
				while (1) {
					...
					h_201119 = res_201123;
					{
						...
						{
							if (!eqStrings(val_201102, ((NimStringDesc*) &TMP1394))) goto LA11;
							result += 1;
						}
						LA11: ;
					}
...
N_NIMCALL(void, definesymbol_201009)(NimStringDesc* symbol) {
	nstPut(gsymbols_201004, symbol, ((NimStringDesc*) &TMP1394));
}

N_NIMCALL(void, declaresymbol_201018)(NimStringDesc* symbol) {
	nstPut(gsymbols_201004, symbol, ((NimStringDesc*) &TMP1453));
}
...
appendString(LOC4, ((NimStringDesc*) &TMP1454));
appendString(LOC4, LOC5);
	...
	case ((NU8) 7):
	{
		definesymbol_201009(((NimStringDesc*) &TMP1465));
		definesymbol_201009(((NimStringDesc*) &TMP1463));
		definesymbol_201009(((NimStringDesc*) &TMP1464));
	}
	break;
	...
	{
		definesymbol_201009(((NimStringDesc*) &TMP1463));
		definesymbol_201009(((NimStringDesc*) &TMP1466));
		definesymbol_201009(((NimStringDesc*) &TMP1464));
	}
	break;
	case ((NU8) 18):
	{
		definesymbol_201009(((NimStringDesc*) &TMP1467));
	}
	break;
	case ((NU8) 19):
	{
...
appendString(LOC25, ((NimStringDesc*) &TMP1454));
appendString(LOC25, LOC26);
	...
	declaresymbol_201018(((NimStringDesc*) &TMP1558));
	{
		if (!((os_174069[(targetos_174589)- 1].Field12 &(1<<((((NU8) 3))&7)))!=0)) goto LA30;
		definesymbol_201009(((NimStringDesc*) &TMP1558));
	}
	LA30: ;
	switch (targetos_174589) {
	case ((NU8) 7):
	...
	case ((NU8) 19):
	{
		definesymbol_201009(((NimStringDesc*) &TMP1555));
	}
	break;
	default:
	{
...
N_NIMCALL(void, undefsymbol_201027)(NimStringDesc* symbol) {
	nstPut(gsymbols_201004, symbol, ((NimStringDesc*) &TMP1690));
}
