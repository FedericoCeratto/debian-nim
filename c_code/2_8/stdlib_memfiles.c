...
N_NIMCALL(Memfile266208, open_266807)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	LA6: ;
	{
		...
		raiseoserror_126009(LOC20, ((NimStringDesc*) &TMP1536));
	}
	LA13: ;
	{
		if (!!((newfilesize == ((NI) -1)))) goto LA23;
		{
			...
			raiseoserror_126009(LOC35, ((NimStringDesc*) &TMP1536));
		}
		LA28: ;
	}
	LA23: ;
	...
	LA38: ;
	{
		...
		LA44: ;
		{
			...
			raiseoserror_126009(LOC52, ((NimStringDesc*) &TMP1536));
		}
		LA41: ;
	}
	LA36: ;
	...
	result.mem = mmap(NIM_NIL, result.size, LOC53, LOC59, result.handle, ((off_t) (offset)));
	{
		...
		raiseoserror_126009(LOC74, ((NimStringDesc*) &TMP1536));
	}
	LA67: ;
	return result;
}
...
N_NIMCALL(void, close_267248)(Memfile266208* f) {
	...
	{
		if (!error) goto LA11;
		raiseoserror_126009(lasterr, ((NimStringDesc*) &TMP1536));
	}
	LA11: ;
}
...
TMP910[0] = &TMP896[1];
TMP896[1].kind = 1;
TMP896[1].offset = offsetof(Memfile266208, mem);
TMP896[1].typ = (&NTI153);
TMP896[1].name = "mem";
TMP910[1] = &TMP896[2];
TMP896[2].kind = 1;
TMP896[2].offset = offsetof(Memfile266208, size);
TMP896[2].typ = (&NTI108);
TMP896[2].name = "size";
TMP910[2] = &TMP896[3];
TMP896[3].kind = 1;
TMP896[3].offset = offsetof(Memfile266208, handle);
TMP896[3].typ = (&NTI8211);
TMP896[3].name = "handle";
TMP896[0].len = 3; TMP896[0].kind = 2; TMP896[0].sons = &TMP910[0];
NTI266208.node = &TMP896[0];
}
