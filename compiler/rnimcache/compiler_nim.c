...
/* Command for C compiler:
   gcc -c  -w -O3 -fno-strict-aliasing  -I/home/ubuntu/nim-ci/Nim/lib -o /home/ubuntu/nim-ci/Nim/compiler/rnimcache/compiler_nim.o /home/ubuntu/nim-ci/Nim/compiler/rnimcache/compiler_nim.c */
...
N_NIMCALL(void, handlecmdline_598601)(void);
...
STRING_LITERAL(TMP2068, "stdinfile", 9);
STRING_LITERAL(TMP2097, "nim.cfg", 7);
STRING_LITERAL(TMP2098, "nims", 4);
STRING_LITERAL(TMP3818, "config.nims", 11);
STRING_LITERAL(TMP5542, "./", 2);
STRING_LITERAL(TMP5543, "js", 2);
STRING_LITERAL(TMP5547, " ", 1);
STRING_LITERAL(TMP5548, "php", 3);
STRING_LITERAL(TMP5549, "php ", 4);
...
appendString(LOC7, ((NimStringDesc*) &TMP5542));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
{	{
		NI LOC3;
		LOC3 = 0;
		LOC3 = paramcount_143026();
		if (!(LOC3 == ((NI) 0))) goto LA4;
		writecommandlineusage_281005();
	}
	goto LA1;
	LA4: ;
	{
		NimStringDesc* scriptfile;
		processcmdline_592203(((NU8) 0), ((NimStringDesc*) &TMP2066));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_170206, ((NimStringDesc*) &TMP2067))) goto LA9;
			LOC11 = 0;
			LOC11 = gprojectname_170206; gprojectname_170206 = copyStringRC1(((NimStringDesc*) &TMP2068));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = 0;
			LOC12 = gprojectfull_170208; gprojectfull_170208 = copyStringRC1(((NimStringDesc*) &TMP2068));
			if (LOC12) nimGCunrefNoCycle(LOC12);
			asgnRefNoCycle((void**) (&gprojectpath_170207), nosgetCurrentDir());
			gprojectisstdin_170209 = NIM_TRUE;
		}
		goto LA7;
		LA9: ;
		{
			...
			NimStringDesc* LOC20;
			NimStringDesc* LOC21;
			if (!!(((gprojectname_170206) && (gprojectname_170206)->Sup.len == 0))) goto LA14;
			pushSafePoint(&TMP2069);
			TMP2069.status = setjmp(TMP2069.context);
			if (TMP2069.status == 0) {
				asgnRefNoCycle((void**) (&gprojectfull_170208), canonicalizepath_170405(gprojectname_170206));
				popSafePoint();
			}
			else {
				popSafePoint();
				if (isObj(getCurrentException()->Sup.m_type, (&NTI3630))) {
					...
					TMP2069.status = 0;
					LOC19 = 0;
					LOC19 = gprojectfull_170208; gprojectfull_170208 = copyStringRC1(gprojectname_170206);
					if (LOC19) nimGCunrefNoCycle(LOC19);
					popCurrentException();
				}
			}
			if (TMP2069.status != 0) reraiseException();
			memset((void*)(&p), 0, sizeof(p));
			chckNil((void*)(&p));
			memset((void*)(&p), 0, sizeof(p));
			nossplitFile(gprojectfull_170208, (&p));
			LOC20 = 0;
			LOC20 = gprojectpath_170207; gprojectpath_170207 = copyStringRC1(p.Field0);
			if (LOC20) nimGCunrefNoCycle(LOC20);
			LOC21 = 0;
			LOC21 = gprojectname_170206; gprojectname_170206 = copyStringRC1(p.Field1);
		...
		LA7: ;
		loadconfigs_291603(((NimStringDesc*) &TMP2097));
		scriptfile = noschangeFileExt(gprojectfull_170208, ((NimStringDesc*) &TMP2098));
		{
			NIM_BOOL LOC25;
			LOC25 = 0;
			LOC25 = fileexists_131604(scriptfile);
			if (!LOC25) goto LA26;
			runnimscript_597220(scriptfile, NIM_FALSE);
			{
				if (!eqStrings(scriptfile, gprojectfull_170208)) goto LA30;
				goto BeforeRet;
			}
			LA30: ;
		}
		...
		LA26: ;
		{
			...
			NimStringDesc* LOC37;
			LOC33 = 0;
			LOC33 = HEX2F_128265(gprojectpath_170207, ((NimStringDesc*) &TMP3818));
			LOC34 = 0;
			LOC34 = fileexists_131604(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = 0;
			LOC37 = HEX2F_128265(gprojectpath_170207, ((NimStringDesc*) &TMP3818));
			runnimscript_597220(LOC37, NIM_FALSE);
		}
		goto LA23;
		LA35: ;
		LA23: ;
		initvars_274834();
		processcmdline_592203(((NU8) 1), ((NimStringDesc*) &TMP2066));
		{
			if (!((command_170212) && (command_170212)->Sup.len == 0)) goto LA40;
			rawmessage_195612(((NU16) 184), command_170212);
		}
		LA40: ;
		maincommand_594610();
		{
			...
			NimStringDesc* LOC48;
			LOC44 = 0;
			LOC44 = ((goptions_170125 &(1U<<((NU)(((NU8) 12))&31U)))!=0);
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_193068 &((NU64)1<<((NU)((((NU16) 289)- 237))&63U)))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
			LOC48 = 0;
			LOC48 = Gcgetstatistics_10421();
			printf("%s\012", LOC48? (LOC48)->data:"nil");
			fflush(stdout);
		}
		LA46: ;
		{
			if (!(gerrorcounter_193069 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_170127 &((NU64)1<<((NU)(((NU8) 13))&63U)))!=0)) goto LA55;
				{
					NimStringDesc* ex;
					NimStringDesc* LOC70;
					NimStringDesc* LOC71;
					if (!(gcmd_170129 == ((NU8) 4))) goto LA59;
					ex = 0;
					{
						NimStringDesc* LOC65;
						if (!(((NI) 0) < (outfile_170133 ? outfile_170133->Sup.len : 0))) goto LA63;
						LOC65 = 0;
						LOC65 = prependcurdir_598401(outfile_170133);
					...
					LA63: ;
					{
						...
						NimStringDesc* LOC69;
						LOC67 = 0;
						LOC67 = noschangeFileExt(gprojectfull_170208, ((NimStringDesc*) &TMP5543));
						LOC68 = 0;
						LOC68 = prependcurdir_598401(LOC67);
						LOC69 = 0;
						LOC69 = completecfilepath_274854(LOC68, NIM_TRUE);
						ex = nospquoteShell(LOC69);
					}
					LA61: ;
					LOC70 = 0;
					LOC71 = 0;
					LOC71 = findnodejs_596003();
					LOC70 = rawNewString(LOC71->Sup.len + ex->Sup.len + arguments_282811->Sup.len + 2);
appendString(LOC70, LOC71);
appendString(LOC70, ((NimStringDesc*) &TMP5547));
appendString(LOC70, ex);
appendChar(LOC70, 32);
appendString(LOC70, arguments_282811);
					execexternalprogram_274881(LOC70, ((NU16) 284));
				}
				goto LA57;
				LA59: ;
				{
					NimStringDesc* ex;
					NimStringDesc* LOC84;
					if (!(gcmd_170129 == ((NU8) 5))) goto LA73;
					ex = 0;
					{
						NimStringDesc* LOC79;
						if (!(((NI) 0) < (outfile_170133 ? outfile_170133->Sup.len : 0))) goto LA77;
						LOC79 = 0;
						LOC79 = prependcurdir_598401(outfile_170133);
						ex = nospquoteShell(LOC79);
					}
					goto LA75;
					LA77: ;
					{
						...
						NimStringDesc* LOC83;
						LOC81 = 0;
						LOC81 = noschangeFileExt(gprojectfull_170208, ((NimStringDesc*) &TMP5548));
						LOC82 = 0;
						LOC82 = prependcurdir_598401(LOC81);
						LOC83 = 0;
						LOC83 = completecfilepath_274854(LOC82, NIM_TRUE);
						ex = nospquoteShell(LOC83);
					}
					LA75: ;
					LOC84 = 0;
					LOC84 = rawNewString(ex->Sup.len + arguments_282811->Sup.len + 5);
appendString(LOC84, ((NimStringDesc*) &TMP5549));
appendString(LOC84, ex);
appendChar(LOC84, 32);
appendString(LOC84, arguments_282811);
					execexternalprogram_274881(LOC84, ((NU16) 284));
				}
				goto LA57;
				LA73: ;
				{
					...
					binpath = 0;
					{
						if (!(((NI) 0) < (outfile_170133 ? outfile_170133->Sup.len : 0))) goto LA88;
						binpath = prependcurdir_598401(outfile_170133);
					}
					goto LA86;
					LA88: ;
					{
						NimStringDesc* LOC91;
						LOC91 = 0;
						LOC91 = noschangeFileExt(gprojectfull_170208, ((NimStringDesc*) &TMP2066));
						binpath = prependcurdir_598401(LOC91);
					}
					LA86: ;
					ex = nospquoteShell(binpath);
					LOC92 = 0;
					LOC92 = rawNewString(ex->Sup.len + arguments_282811->Sup.len + 1);
appendString(LOC92, ex);
appendChar(LOC92, 32);
appendString(LOC92, arguments_282811);
					execexternalprogram_274881(LOC92, ((NU16) 284));
				}
				LA57: ;
			}
			LA55: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	Gcdisablemarkandsweep_10419();
	initdefines_201193();
	handlecmdline_598601();
	msgquit_193142(((NI8) ((((NI) 0) < gerrorcounter_193069))));
}
