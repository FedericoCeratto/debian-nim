...
NIM_CONST TY86545 TMP3125 = {((NimStringDesc*) &TMP3126),
((NI) 100)}
;
NIM_CONST TY86545 TMP3127 = {((NimStringDesc*) &TMP3126),
((NI) 107)}
;
...
N_NIMCALL(Tnode190813*, semnodekindconstraints_268679)(Tnode190813* p) {
	...
	(*result).kindU.S3.strval = addChar((*result).kindU.S3.strval, 1);
	{
		...
		}
		{
			...
			internalerror_165199((*p).info, ((NimStringDesc*) &TMP3128));
		}
		LA12: ;
	}
	goto LA1;
