...
STRING_LITERAL(TMP1824, "", 0);
static NIM_CONST char136Set TMP1825 = {
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1827, "", 0);
static NIM_CONST char136Set TMP1828 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST char136Set TMP1833 = {
...
N_NIMCALL(NimStringDesc*, quote_251287_4065315820)(NimStringDesc* s0) {
	...
	result0 = (NimStringDesc*)0;
	{
		...
		LOC3 = (NIM_BOOL)0;
		LOC4 = (NI)0;
		LOC4 = nsuFindCharSet(s0, TMP1825, ((NI) 0));
		LOC3 = (((NI) 0) <= LOC4);
		if (!(LOC3)) goto LA5;
		...
		if (!LOC3) goto LA6;
		{
			...
			i0 = parseword_251218_4065315820(s0, ((NI) 0), (&result0), TMP1826);
			{
...
N_NIMCALL(void, initoptparser_251325_4065315820)(NimStringDesc* cmdline0, Optparser251205* Result) {
	...
	LA3: ;
	{
		unsureAsgnRef((void**) (&(*Result).cmd), copyString(((NimStringDesc*) &TMP1824)));
		{
...
appendString((*Result).cmd, LOC10);
	...
	unsureAsgnRef((void**) (&(*Result).key), copyString(((NimStringDesc*) &TMP1827)));
	unsureAsgnRef((void**) (&(*Result).val), copyString(((NimStringDesc*) &TMP1827)));
}
...
N_NIMCALL(void, handleshortoption_251401_4065315820)(Optparser251205* p0) {
	...
	}
	{
		...
		i0 = parseword_251218_4065315820((*p0).cmd, i0, (&(*p0).val), TMP1828);
	}
	LA5: ;
	{
...
{	i0 = (*p0).pos;
	...
	case 45:
	{
		i0 += ((NI) 1);
		{
			...
			i0 += ((NI) 1);
			i0 = parseword_251218_4065315820((*p0).cmd, i0, (&(*p0).key), TMP1826);
			{
				while (1) {
			...
			}
			{
				...
				(*p0).pos = parseword_251218_4065315820((*p0).cmd, i0, (&(*p0).val), TMP1828);
			}
			goto LA15;
			LA17: ;
			{
	...
	default:
	{
		...
		(*p0).pos = parseword_251218_4065315820((*p0).cmd, i0, (&(*p0).key), TMP1828);
	}
	break;
	}
	}BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(Optparser251205* p0) {
	...
	result0 = nsuStrip(LOC1, NIM_TRUE, NIM_TRUE, TMP1833);
	return result0;
}
...
static TNimNode* TMP1820[6];
static TNimNode* TMP1821[4];
NI TMP1823;
static char* NIM_CONST TMP1822[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongOption", 
"cmdShortOption"};
...
NTI251203.base = 0;
NTI251203.flags = 3;
for (TMP1823 = 0; TMP1823 < 4; TMP1823++) {
TMP859[TMP1823+5].kind = 1;
TMP859[TMP1823+5].offset = TMP1823;
TMP859[TMP1823+5].name = TMP1822[TMP1823];
TMP1821[TMP1823] = &TMP859[TMP1823+5];
}
TMP859[9].len = 4; TMP859[9].kind = 2; TMP859[9].sons = &TMP1821[0];
...
TMP859[11].name = "val";
TMP859[0].len = 6; TMP859[0].kind = 2; TMP859[0].sons = &TMP1820[0];
