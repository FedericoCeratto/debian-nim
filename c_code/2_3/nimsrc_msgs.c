...
N_NIMCALL(void, suggestwriteln_165066)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_165057.ClEnv? writelnhook_165057.ClPrc(s, writelnhook_165057.ClEnv):((TMP1965)(writelnhook_165057.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, suggestquit_165122)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_165126).Sup.message; (*e_165126).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2665));
	if (LOC1) nimGCunrefNoCycle(LOC1);
