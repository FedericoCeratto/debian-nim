...
N_NIMCALL(Tnode224809*, close_559018)(Tpasscontext276005* p, Tnode224809* n) {
	...
	usewarning = !((((*(*g).module).flags &(1<<((((NU8) 12))&31)))!=0));
	{
		...
		writeoutput_386337((*g).doc, LOC7, ((NimStringDesc*) &TMP5145), usewarning);
		pushSafePoint(&TMP5146);
		TMP5146.status = _setjmp(TMP5146.context);
		if (TMP5146.status == 0) {
...
TMP1148[0].len = 2; TMP1148[0].kind = 2; TMP1148[0].sons = &TMP5143[0];
NTI559010.node = &TMP1148[0];
NTI559012.size = sizeof(Tgen559010*);
NTI559012.kind = 22;
NTI559012.base = (&NTI559010);
NTI559012.marker = TMP5144;
}
