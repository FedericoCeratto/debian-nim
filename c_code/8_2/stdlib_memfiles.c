...
N_NIMCALL(Memfile264208, open_264807)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	LA6: ;
	{
		...
		LA17: ;
		LOC20 = 0;
		LOC20 = oslasterror_125034();
		raiseoserror_125009(LOC20, ((NimStringDesc*) &TMP1534));
	}
	LA13: ;
	{
		if (!!((newfilesize == ((NI) -1)))) goto LA23;
		{
			...
			LA32: ;
			LOC35 = 0;
			LOC35 = oslasterror_125034();
			raiseoserror_125009(LOC35, ((NimStringDesc*) &TMP1534));
		}
		LA28: ;
	}
	LA23: ;
	...
	LA38: ;
	{
		...
		LA44: ;
		{
			...
			LA49: ;
			LOC52 = 0;
			LOC52 = oslasterror_125034();
			raiseoserror_125009(LOC52, ((NimStringDesc*) &TMP1534));
		}
		LA41: ;
	}
	LA36: ;
	...
	LOC59 = 0;
	{
		...
		LOC59 = (NI32)(MAP_PRIVATE | Mappopulate_115516);
	}
	goto LA60;
	LA62: ;
	{
		LOC59 = (NI32)(MAP_SHARED | Mappopulate_115516);
	}
	LA60: ;
	result.mem = mmap(NIM_NIL, result.size, LOC53, LOC59, result.handle, ((off_t) (offset)));
	{
		...
		LA71: ;
		LOC74 = 0;
		LOC74 = oslasterror_125034();
		raiseoserror_125009(LOC74, ((NimStringDesc*) &TMP1534));
	}
	LA67: ;
	return result;
}
...
N_NIMCALL(void, close_265249)(Memfile264208* f) {
	...
	{
		if (!error) goto LA11;
		raiseoserror_125009(lasterr, ((NimStringDesc*) &TMP1534));
	}
	LA11: ;
}
...
static TNimNode TMP894[4];
NTI264208.size = sizeof(Memfile264208);
NTI264208.kind = 18;
NTI264208.base = 0;
NTI264208.flags = 3;
TMP908[0] = &TMP894[1];
TMP894[1].kind = 1;
TMP894[1].offset = offsetof(Memfile264208, mem);
TMP894[1].typ = (&NTI153);
TMP894[1].name = "mem";
TMP908[1] = &TMP894[2];
TMP894[2].kind = 1;
TMP894[2].offset = offsetof(Memfile264208, size);
TMP894[2].typ = (&NTI108);
TMP894[2].name = "size";
TMP908[2] = &TMP894[3];
TMP894[3].kind = 1;
TMP894[3].offset = offsetof(Memfile264208, handle);
TMP894[3].typ = (&NTI8211);
TMP894[3].name = "handle";
TMP894[0].len = 3; TMP894[0].kind = 2; TMP894[0].sons = &TMP908[0];
NTI264208.node = &TMP894[0];
}
