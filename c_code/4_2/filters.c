...
STRING_LITERAL(TMP1350, "startswith", 10);
STRING_LITERAL(TMP1351, "", 0);
STRING_LITERAL(TMP1352, "true", 4);
STRING_LITERAL(TMP1353, "false", 5);
STRING_LITERAL(TMP1354, "leading", 7);
STRING_LITERAL(TMP1355, "trailing", 8);
STRING_LITERAL(TMP1356, "sub", 3);
STRING_LITERAL(TMP1357, "by", 2);
...
N_NIMCALL(NIM_BOOL, boolarg_258038)(tnode225816* n, NimStringDesc* name, NI pos, NIM_BOOL default_258043) {
	...
	LA3: ;
	{
		...
		LOC6 = ((*x).Kind == ((NU8) 2));
		if (!(LOC6)) goto LA7;
		LOC6 = identeq_200493((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP1352));
		LA7: ;
		if (!LOC6) goto LA8;
		result = NIM_TRUE;
	}
	...
	LA8: ;
	{
		...
		LOC11 = ((*x).Kind == ((NU8) 2));
		if (!(LOC11)) goto LA12;
		LOC11 = identeq_200493((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP1353));
		LA12: ;
		if (!LOC11) goto LA13;
		result = NIM_FALSE;
	}
...
N_NIMCALL(tllstream211204*, filterstrip_258012)(tllstream211204* stdin_258014, NimStringDesc* filename, tnode225816* call) {
	...
	NimStringDesc* line;
	result = 0;
	pattern = strarg_258029(call, ((NimStringDesc*) &TMP1350), 1, ((NimStringDesc*) &TMP1351));
	leading = boolarg_258038(call, ((NimStringDesc*) &TMP1354), 2, NIM_TRUE);
	trailing = boolarg_258038(call, ((NimStringDesc*) &TMP1355), 3, NIM_TRUE);
	result = llstreamopen_211220(((NimStringDesc*) &TMP1351));
...
N_NIMCALL(tllstream211204*, filterreplace_258004)(tllstream211204* stdin_258006, NimStringDesc* filename, tnode225816* call) {
	...
	NimStringDesc* line;
	result = 0;
	sub = strarg_258029(call, ((NimStringDesc*) &TMP1356), 1, ((NimStringDesc*) &TMP1351));
	{
		if (!(sub->Sup.len == 0)) goto LA3;
		invalidpragma_258047(call);
	}
	LA3: ;
	by = strarg_258029(call, ((NimStringDesc*) &TMP1357), 2, ((NimStringDesc*) &TMP1351));
	result = llstreamopen_211220(((NimStringDesc*) &TMP1351));
	line = rawNewString(80);
	{
		while (1) {
