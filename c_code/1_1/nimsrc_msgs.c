...
N_NOINLINE(void, raiserecoverableerror_164969)(NimStringDesc* msg);
...
Tlineinfo164338 gcmdlineinfo_164922;
Tlineinfo164338 gcodegenlineinfo_164961;
NU64 gnotes_165014;
NI gerrorcounter_165015;
NI ghintcounter_165016;
NI gwarncounter_165017;
NI gerrormax_165018;
TY165036* msgcontext_165053;
TNimType NTI164338; /* TLineInfo */
extern TNimType NTI112; /* int16 */
extern TNimType NTI114; /* int32 */
TNimType NTI165036; /* seq[TLineInfo] */
Tlineinfo164338 lasterror_165054;
NU8 erroroutputs_165056;
TY165057 writelnhook_165060;
...
TNimType NTI164975; /* ref ERecoverableError */
...
TNimType NTI165130; /* ref ESuggestDone */
N_NIMCALL(void, TMP134)(void* p, NI op) {
	TY164351* a;
	NI LOC1;
	a = (TY164351*)p;
...
N_NIMCALL(void, msgwriteln_165536)(NimStringDesc* s) {
	{
		if (!!(writelnhook_165060.ClPrc == 0)) goto LA3;
		writelnhook_165060.ClEnv? writelnhook_165060.ClPrc(s, writelnhook_165060.ClEnv):((TMP143)(writelnhook_165060.ClPrc))(s);
	}
	goto LA1;
	LA3: ;
	{
		...
		{
			TY165566 LOC12;
			if (!((erroroutputs_165056 &(1<<((((NU8) 1))&7)))!=0)) goto LA10;
	...
	LA6: ;
	{
		{
			TY165566 LOC18;
			if (!((erroroutputs_165056 &(1<<((((NU8) 0))&7)))!=0)) goto LA16;
...
N_NIMCALL(void, writecontext_165800)(Tlineinfo164338 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_165824 = 0;
		HEX3Atmp_165828 = 0;
		HEX3Atmp_165828 = (NI)((msgcontext_165053 ? msgcontext_165053->Sup.len : 0) - ((NI) 1));
		res_165831 = ((NI) 0);
		{
			while (1) {
				...
				i_165824 = res_165831;
				{
					...
					LOC6 = 0;
					LOC7 = 0;
					LOC7 = HEX3DHEX3D_165789(msgcontext_165053->data[i_165824], lastinfo);
					LOC6 = !(LOC7);
					if (!(LOC6)) goto LA8;
					LOC9 = 0;
					LOC9 = HEX3DHEX3D_165789(msgcontext_165053->data[i_165824], info);
					LOC6 = !(LOC9);
					LA8: ;
					if (!LOC6) goto LA10;
					memset((void*)LOC12, 0, sizeof(LOC12));
					LOC12[0] = tomsgfilename_165429(msgcontext_165053->data[i_165824]);
					LOC12[1] = coordtostr_165606(((NI) (msgcontext_165053->data[i_165824].line)));
					LOC12[2] = coordtostr_165606(((NI) ((NI16)(msgcontext_165053->data[i_165824].col + ((NI16) 1)))));
				...
				LA10: ;
				info = msgcontext_165053->data[i_165824];
				res_165831 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NOINLINE(void, raiserecoverableerror_164969)(NimStringDesc* msg) {
	Erecoverableerror164344* e_164974;
	NimStringDesc* LOC1;
	e_164974 = 0;
	e_164974 = (Erecoverableerror164344*) newObj((&NTI164975), sizeof(Erecoverableerror164344));
	(*e_164974).Sup.Sup.Sup.m_type = (&NTI164344);
	LOC1 = 0;
	LOC1 = (*e_164974).Sup.Sup.message; (*e_164974).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_164974, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_165647)(NU16 msg, NU8 eh, NimStringDesc* s) {
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			if (!LOC9) goto LA13;
			{
				...
				if (!(LOC17)) goto LA18;
				LOC17 = writelnhook_165060.ClPrc == 0;
				LA18: ;
				if (!LOC17) goto LA19;
...
appendString(LOC22, ((NimStringDesc*) &TMP428));
	...
	LA5: ;
	{
		...
		LA26: ;
		if (!LOC25) goto LA27;
		gerrorcounter_165015 += ((NI) 1);
		gexitcode_155129 = ((NI8) 1);
		{
			if (!(gerrormax_165018 <= gerrorcounter_165015)) goto LA31;
			{
				NIM_BOOL LOC35;
				NIM_BOOL LOC36;
				LOC35 = 0;
				...
				if (!LOC35) goto LA39;
				{
					...
					if (!(LOC43)) goto LA44;
					LOC43 = writelnhook_165060.ClPrc == 0;
					LA44: ;
					if (!LOC43) goto LA45;
					writestacktrace_16407();
				}
		...
		LA31: ;
		{
			...
			if (!LOC50) goto LA52;
			{
				...
				if (!LOC56) goto LA60;
				{
					...
					if (!(LOC64)) goto LA65;
					LOC64 = writelnhook_165060.ClPrc == 0;
					LA65: ;
					if (!LOC64) goto LA66;
					writestacktrace_16407();
				}
...
appendString(LOC69, ((NimStringDesc*) &TMP428));
		...
		LA52: ;
		{
			...
			raiserecoverableerror_164969(s);
		}
		goto LA29;
		LA71: ;
		LA29: ;
...
{	frmt = 0;
	...
	case ((NU16) 230) ... ((NU16) 260):
	{
		...
		LA6: ;
		{
			if (!!(((gnotes_165014 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
	...
	case ((NU16) 261) ... ((NU16) 277):
	{
		...
		LA16: ;
		{
			if (!!(((gnotes_165014 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
		frmt = copyString(((NimStringDesc*) &TMP426));
		ghintcounter_165016 += ((NI) 1);
	}
	break;
	}
	LOC22 = 0;
		...
		if (TMP972.status == 0) {
			{
				...
				line_166296 = 0;
				HEX3Atmp_166332 = 0;
				HEX3Atmp_166332 = tofullpath_165276(i.fileindex);
...
N_NIMCALL(void, limessage_165997)(Tlineinfo164338 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 230) ... ((NU16) 260):
	{
		...
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_165014 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 261) ... ((NU16) 277):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_165014 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA11: ;
		ignoremsg = LOC10;
...
N_NIMCALL(void, setdirtyfile_165286)(NI32 fileidx, NimStringDesc* filename) {
	NimStringDesc* LOC1;
	LOC1 = 0;
...
N_NIMCALL(void, suggestwriteln_165069)(NimStringDesc* s) {
	{
		if (!((erroroutputs_165056 &(1<<((((NU8) 0))&7)))!=0)) goto LA3;
		{
			TY165566 LOC9;
			if (!writelnhook_165060.ClPrc == 0) goto LA7;
		...
		LA7: ;
		{
			writelnhook_165060.ClEnv? writelnhook_165060.ClPrc(s, writelnhook_165060.ClEnv):((TMP1967)(writelnhook_165060.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, pushinfocontext_165192)(Tlineinfo164338 info) {
	msgcontext_165053 = (TY165036*) incrSeq(&(msgcontext_165053)->Sup, sizeof(Tlineinfo164338));
	msgcontext_165053->data[msgcontext_165053->Sup.len-1] = info;
}

N_NIMCALL(void, popinfocontext_165211)(void) {
	msgcontext_165053 = (TY165036*) setLengthSeq(&(msgcontext_165053)->Sup, sizeof(Tlineinfo164338), ((NI) ((NI)((msgcontext_165053 ? msgcontext_165053->Sup.len : 0) - ((NI) 1)))));
}
N_NIMCALL(void, TMP2666)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_165125)(void) {
	Esuggestdone164346* e_165129;
	NimStringDesc* LOC1;
	e_165129 = 0;
	e_165129 = (Esuggestdone164346*) newObj((&NTI165130), sizeof(Esuggestdone164346));
	(*e_165129).Sup.Sup.m_type = (&NTI164346);
	LOC1 = 0;
	LOC1 = (*e_165129).Sup.message; (*e_165129).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2667));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_165129, "ESuggestDone");
}
...
N_NIMCALL(Tlineinfo164338, getinfocontext_165237)(NI index) {
	...
	NI i;
	memset((void*)(&result), 0, sizeof(result));
	L = (msgcontext_165053 ? msgcontext_165053->Sup.len : 0);
	{
	...
	LA1: ;
	{
		...
		result = unknownlineinfo_165027();
	}
	goto LA6;
	LA8: ;
	{
		result = msgcontext_165053->data[i];
	}
	LA6: ;
	return result;
}
...
N_NIMCALL(NI, getinfocontextlen_165156)(void) {
	NI result;
{	result = 0;
	result = (msgcontext_165053 ? msgcontext_165053->Sup.len : 0);
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setinfocontextlen_165173)(NI L) {
	msgcontext_165053 = (TY165036*) setLengthSeq(&(msgcontext_165053)->Sup, sizeof(Tlineinfo164338), ((NI) (L)));
}
...
NIM_EXTERNC N_NOINLINE(void, nimsrc_msgsInit)(void) {
	...
	gcmdlineinfo_164922 = newlineinfo_164867(((NI32) 0), ((NI) 1), ((NI) 1));
	memset((void*)(&LOC2), 0, sizeof(LOC2));
	...
	gcodegenlineinfo_164961 = newlineinfo_164867(((NI32) 1), ((NI) 1), ((NI) 1));
	gnotes_165014 = IL64(281474927951871);
	gerrorcounter_165015 = ((NI) 0);
	ghintcounter_165016 = ((NI) 0);
	gwarncounter_165017 = ((NI) 0);
	gerrormax_165018 = ((NI) 1);
	if (msgcontext_165053) nimGCunrefNoCycle(msgcontext_165053);
	msgcontext_165053 = (TY165036*) newSeqRC1((&NTI165036), 0);
	lasterror_165054 = unknownlineinfo_165027();
	erroroutputs_165056 = 3;
...
NTI165036.size = sizeof(TY165036*);
NTI165036.kind = 24;
NTI165036.base = (&NTI164338);
NTI165036.flags = 2;
NTI165036.marker = TMP142;
NTI164344.size = sizeof(Erecoverableerror164344);
NTI164344.kind = 17;
NTI164344.base = (&NTI3449);
TMP21[11].len = 0; TMP21[11].kind = 2;
NTI164344.node = &TMP21[11];
NTI164975.size = sizeof(Erecoverableerror164344*);
NTI164975.kind = 22;
NTI164975.base = (&NTI164344);
NTI164975.marker = TMP429;
...
NTI165130.size = sizeof(Esuggestdone164346*);
NTI165130.kind = 22;
NTI165130.base = (&NTI164346);
NTI165130.marker = TMP2666;
}
