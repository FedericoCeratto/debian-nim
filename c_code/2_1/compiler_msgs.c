...
typedef N_CLOSURE_PTR(void, TMP503) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning, void* ClEnv);
typedef NimStringDesc* TY194829[4];
typedef N_CLOSURE_PTR(void, TMP1047) (NimStringDesc* output);
typedef N_CLOSURE_PTR(void, TMP1048) (NimStringDesc* output);
struct  Slice196011  {
NU16 a;
NU16 b;
};
...
typedef N_CLOSURE_PTR(void, TMP2065) (NimStringDesc* output);
...
N_NOINLINE(void, raiserecoverableerror_191369)(NimStringDesc* msg) __attribute__((noreturn));
...
NIM_CONST TY190303 Msgkindtostr_190300 = {((NimStringDesc*) &TMP158),
...
NIM_CONST TY190311 Warningstostr_190309 = {((NimStringDesc*) &TMP439),
...
NIM_CONST TY190317 Hintstostr_190314 = {((NimStringDesc*) &TMP471),
...
STRING_LITERAL(TMP496, "No stack traceback available\012To create a stacktrace, rerun comp"
"ilation with ./koch temp ", 88);
STRING_LITERAL(TMP497, " <file>", 7);
STRING_LITERAL(TMP502, "ropes: invalid format string: ", 30);
STRING_LITERAL(TMP1050, "  ", 2);
STRING_LITERAL(TMP1068, "compiler/msgs.nim", 17);
NIM_CONST TY90959 TMP1067 = {((NimStringDesc*) &TMP1068),
((NI) 1008)}
;
STRING_LITERAL(TMP1901, "Warnings:", 9);
STRING_LITERAL(TMP1902, "  [$1] $2", 9);
STRING_LITERAL(TMP1903, "x", 1);
STRING_LITERAL(TMP1904, " ", 1);
STRING_LITERAL(TMP1963, "Hints:", 6);
...
;
STRING_LITERAL(TMP2776, "suggest done", 12);
STRING_LITERAL(TMP3238, "(", 1);
STRING_LITERAL(TMP3239, ",", 1);
STRING_LITERAL(TMP3240, ")", 1);
NIM_CONST TY90959 TMP4004 = {((NimStringDesc*) &TMP1068),
((NI) 1015)}
;
...
Tlineinfo190352 gcmdlineinfo_191322;
Tlineinfo190352 gcodegenlineinfo_191361;
NU64 gnotes_191398;
NI gerrorcounter_191399;
NI ghintcounter_191400;
NI gwarncounter_191401;
NI gerrormax_191402;
TY191420* msgcontext_191437;
TNimType NTI190352; /* TLineInfo */
extern TNimType NTI112; /* int16 */
extern TNimType NTI114; /* int32 */
TNimType NTI191420; /* seq[TLineInfo] */
Tlineinfo190352 lasterror_191438;
NU8 erroroutputs_191440;
TY191441 writelnhook_191444;
...
TNimType NTI191376; /* ref ERecoverableError */
...
TNimType NTI191515; /* ref ESuggestDone */
N_NIMCALL(void, TMP146)(void* p, NI op) {
	TY190365* a;
	NI LOC1;
	a = (TY190365*)p;
...
static N_INLINE(void, writeline_168405)(FILE* f, NimStringDesc** x, NI xLen0) {
	...
	write_16895(f, ((NimStringDesc*) &TMP434));
}
...
N_NIMCALL(void, writecontext_193266)(Tlineinfo190352 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_193290 = 0;
		HEX3Atmp_193606 = 0;
		HEX3Atmp_193606 = (NI)((msgcontext_191437 ? msgcontext_191437->Sup.len : 0) - ((NI) 1));
		res_193609 = ((NI) 0);
		{
			while (1) {
				...
				i_193290 = res_193609;
				{
					...
					LOC6 = 0;
					LOC7 = 0;
					LOC7 = HEX3DHEX3D_193255(msgcontext_191437->data[i_193290], lastinfo);
					LOC6 = !(LOC7);
					if (!(LOC6)) goto LA8;
					LOC9 = 0;
					LOC9 = HEX3DHEX3D_193255(msgcontext_191437->data[i_193290], info);
					LOC6 = !(LOC9);
					LA8: ;
					if (!LOC6) goto LA10;
					{
						NimStringDesc* s_193309;
						if (!!(writelnhook_191444.ClPrc == 0)) goto LA14;
						s_193309 = copyString(((NimStringDesc*) &TMP149));
						{
							...
							i_193605 = ((NI) 0);
							{
								while (1) {
									...
									LOC20[0] = tomsgfilename_191829(msgcontext_191437->data[i_193290]);
									LOC20[1] = coordtostr_192396(((NI) (msgcontext_191437->data[i_193290].line)));
									LOC20[2] = coordtostr_192396(((NI) ((NI16)(msgcontext_191437->data[i_193290].col + ((NI16) 1)))));
									LOC19[0] = nsuFormatOpenArray(((NimStringDesc*) &TMP156), LOC20, 3);
									LOC19[1] = getmessagestr_192416(((NU16) 189), ((NimStringDesc*) &TMP149));
...
appendString(s_193309, arg_193311);
						...
						writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_193309, writelnhook_191444.ClEnv):((TMP431)(writelnhook_191444.ClPrc))(s_193309);
					}
					goto LA12;
					LA14: ;
					{
						if (!((gglobaloptions_167132 &(1<<((((NU8) 23))&31)))!=0)) goto LA22;
						{
							TY193306 LOC28;
							TY193293 LOC29;
							if (!((erroroutputs_191440 &(1<<((((NU8) 0))&7)))!=0)) goto LA26;
							memset((void*)LOC28, 0, sizeof(LOC28));
							memset((void*)LOC29, 0, sizeof(LOC29));
							LOC29[0] = tomsgfilename_191829(msgcontext_191437->data[i_193290]);
							LOC29[1] = coordtostr_192396(((NI) (msgcontext_191437->data[i_193290].line)));
							LOC29[2] = coordtostr_192396(((NI) ((NI16)(msgcontext_191437->data[i_193290].col + ((NI16) 1)))));
							LOC28[0] = nsuFormatOpenArray(((NimStringDesc*) &TMP156), LOC29, 3);
							LOC28[1] = getmessagestr_192416(((NU16) 189), ((NimStringDesc*) &TMP149));
					...
					{
						{
							if (!((erroroutputs_191440 &(1<<((((NU8) 1))&7)))!=0)) goto LA33;
							{
								TY193293 LOC39;
								NimStringDesc* LOC40;
								NimStringDesc* LOC41;
								...
								LOC39[0] = tomsgfilename_191829(msgcontext_191437->data[i_193290]);
								LOC39[1] = coordtostr_192396(((NI) (msgcontext_191437->data[i_193290].line)));
								LOC39[2] = coordtostr_192396(((NI) ((NI16)(msgcontext_191437->data[i_193290].col + ((NI16) 1)))));
								LOC40 = 0;
								LOC40 = nsuFormatOpenArray(((NimStringDesc*) &TMP156), LOC39, 3);
								write_16895(stderr, LOC40);
								resetattributes_187209(stderr);
								LOC41 = 0;
								LOC41 = getmessagestr_192416(((NU16) 189), ((NimStringDesc*) &TMP149));
								write_16895(stderr, LOC41);
								write_16895(stderr, ((NimStringDesc*) &TMP434));
								resetattributes_187209(stderr);
							}
							goto LA35;
							LA37: ;
							{
								...
								LOC44[0] = tomsgfilename_191829(msgcontext_191437->data[i_193290]);
								LOC44[1] = coordtostr_192396(((NI) (msgcontext_191437->data[i_193290].line)));
								LOC44[2] = coordtostr_192396(((NI) ((NI16)(msgcontext_191437->data[i_193290].col + ((NI16) 1)))));
								LOC43[0] = nsuFormatOpenArray(((NimStringDesc*) &TMP156), LOC44, 3);
								LOC43[1] = getmessagestr_192416(((NU16) 189), ((NimStringDesc*) &TMP149));
				...
				LA10: ;
				info = msgcontext_191437->data[i_193290];
				res_193609 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NOINLINE(void, raiserecoverableerror_191369)(NimStringDesc* msg) {
	Erecoverableerror190358* e_191375;
	NimStringDesc* LOC1;
	e_191375 = 0;
	e_191375 = (Erecoverableerror190358*) newObj((&NTI191376), sizeof(Erecoverableerror190358));
	(*e_191375).Sup.Sup.Sup.m_type = (&NTI190358);
	LOC1 = 0;
	LOC1 = (*e_191375).Sup.Sup.message; (*e_191375).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_191375, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_192437)(NU16 msg, NU8 eh, NimStringDesc* s_192441) {
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			LOC9 = LOC10;
			if (LOC9) goto LA12;
			LOC9 = ((gnotes_191398 &(IL64(1)<<(((((NU16) 288)- 237))&IL64(63))))!=0);
			LA12: ;
			if (!LOC9) goto LA13;
			{
				NIM_BOOL LOC17;
				...
				if (!(LOC17)) goto LA18;
				LOC17 = writelnhook_191444.ClPrc == 0;
				LA18: ;
				if (!LOC17) goto LA19;
			...
			{
				{
					...
					if (!!(writelnhook_191444.ClPrc == 0)) goto LA24;
					s_192512 = copyString(((NimStringDesc*) &TMP149));
					{
...
appendString(LOC30, ((NimStringDesc*) &TMP496));
appendString(LOC30, command_167240);
appendString(LOC30, ((NimStringDesc*) &TMP497));
								LOC29[0] = LOC30;
...
appendString(s_192512, arg_192514);
					...
					writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_192512, writelnhook_191444.ClEnv):((TMP498)(writelnhook_191444.ClPrc))(s_192512);
				}
				goto LA22;
				LA24: ;
				{
					if (!((gglobaloptions_167132 &(1<<((((NU8) 23))&31)))!=0)) goto LA32;
					{
						TY192421 LOC38;
						NimStringDesc* LOC39;
						if (!((erroroutputs_191440 &(1<<((((NU8) 0))&7)))!=0)) goto LA36;
						memset((void*)LOC38, 0, sizeof(LOC38));
						LOC39 = 0;
						LOC39 = rawNewString(command_167240->Sup.len + 95);
appendString(LOC39, ((NimStringDesc*) &TMP496));
appendString(LOC39, command_167240);
appendString(LOC39, ((NimStringDesc*) &TMP497));
						LOC38[0] = LOC39;
				...
				{
					{
						if (!((erroroutputs_191440 &(1<<((((NU8) 1))&7)))!=0)) goto LA43;
						{
							NimStringDesc* LOC49;
...
appendString(LOC49, ((NimStringDesc*) &TMP496));
appendString(LOC49, command_167240);
appendString(LOC49, ((NimStringDesc*) &TMP497));
...
appendString(LOC52, ((NimStringDesc*) &TMP496));
appendString(LOC52, command_167240);
appendString(LOC52, ((NimStringDesc*) &TMP497));
							LOC51[0] = LOC52;
	...
	LA5: ;
	{
		...
		LA56: ;
		if (!LOC55) goto LA57;
		gerrorcounter_191399 += ((NI) 1);
		gexitcode_167133 = ((NI8) 1);
		{
			if (!(gerrormax_191402 <= gerrorcounter_191399)) goto LA61;
			{
				NIM_BOOL LOC65;
				NIM_BOOL LOC66;
				LOC65 = 0;
				...
				LOC65 = LOC66;
				if (LOC65) goto LA68;
				LOC65 = ((gnotes_191398 &(IL64(1)<<(((((NU16) 288)- 237))&IL64(63))))!=0);
				LA68: ;
				if (!LOC65) goto LA69;
				{
					NIM_BOOL LOC73;
					...
					if (!(LOC73)) goto LA74;
					LOC73 = writelnhook_191444.ClPrc == 0;
					LA74: ;
					if (!LOC73) goto LA75;
					writestacktrace_20207();
				}
				...
				{
					{
						...
						if (!!(writelnhook_191444.ClPrc == 0)) goto LA80;
						s_192869 = copyString(((NimStringDesc*) &TMP149));
						{
...
appendString(LOC86, ((NimStringDesc*) &TMP496));
appendString(LOC86, command_167240);
appendString(LOC86, ((NimStringDesc*) &TMP497));
									LOC85[0] = LOC86;
...
appendString(s_192869, arg_192871);
						...
						writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_192869, writelnhook_191444.ClEnv):((TMP499)(writelnhook_191444.ClPrc))(s_192869);
					}
					goto LA78;
					LA80: ;
					{
						if (!((gglobaloptions_167132 &(1<<((((NU8) 23))&31)))!=0)) goto LA88;
						{
							TY192421 LOC94;
							NimStringDesc* LOC95;
							if (!((erroroutputs_191440 &(1<<((((NU8) 0))&7)))!=0)) goto LA92;
							memset((void*)LOC94, 0, sizeof(LOC94));
							LOC95 = 0;
							LOC95 = rawNewString(command_167240->Sup.len + 95);
appendString(LOC95, ((NimStringDesc*) &TMP496));
appendString(LOC95, command_167240);
appendString(LOC95, ((NimStringDesc*) &TMP497));
							LOC94[0] = LOC95;
					...
					{
						{
							if (!((erroroutputs_191440 &(1<<((((NU8) 1))&7)))!=0)) goto LA99;
							{
...
appendString(LOC105, ((NimStringDesc*) &TMP496));
appendString(LOC105, command_167240);
appendString(LOC105, ((NimStringDesc*) &TMP497));
...
appendString(LOC108, ((NimStringDesc*) &TMP496));
appendString(LOC108, command_167240);
appendString(LOC108, ((NimStringDesc*) &TMP497));
								LOC107[0] = LOC108;
		...
		LA61: ;
		{
			...
			if (!LOC110) goto LA112;
			{
				...
				LOC116 = ((gnotes_191398 &(IL64(1)<<(((((NU16) 288)- 237))&IL64(63))))!=0);
				LA119: ;
				if (!LOC116) goto LA120;
				{
					...
					LOC124 = writelnhook_191444.ClPrc == 0;
					LA125: ;
				...
				{
					{
						...
						if (!!(writelnhook_191444.ClPrc == 0)) goto LA131;
						s_193060 = copyString(((NimStringDesc*) &TMP149));
						{
...
appendString(LOC137, ((NimStringDesc*) &TMP496));
appendString(LOC137, command_167240);
appendString(LOC137, ((NimStringDesc*) &TMP497));
									LOC136[0] = LOC137;
...
appendString(s_193060, arg_193062);
						...
						writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_193060, writelnhook_191444.ClEnv):((TMP500)(writelnhook_191444.ClPrc))(s_193060);
					}
					goto LA129;
					LA131: ;
					{
						if (!((gglobaloptions_167132 &(1<<((((NU8) 23))&31)))!=0)) goto LA139;
						{
							...
							if (!((erroroutputs_191440 &(1<<((((NU8) 0))&7)))!=0)) goto LA143;
							memset((void*)LOC145, 0, sizeof(LOC145));
							LOC146 = 0;
							LOC146 = rawNewString(command_167240->Sup.len + 95);
appendString(LOC146, ((NimStringDesc*) &TMP496));
appendString(LOC146, command_167240);
appendString(LOC146, ((NimStringDesc*) &TMP497));
							LOC145[0] = LOC146;
					...
					{
						{
							if (!((erroroutputs_191440 &(1<<((((NU8) 1))&7)))!=0)) goto LA150;
							{
...
appendString(LOC156, ((NimStringDesc*) &TMP496));
appendString(LOC156, command_167240);
appendString(LOC156, ((NimStringDesc*) &TMP497));
...
appendString(LOC159, ((NimStringDesc*) &TMP496));
appendString(LOC159, command_167240);
appendString(LOC159, ((NimStringDesc*) &TMP497));
								LOC158[0] = LOC159;
		...
		LA112: ;
		{
			...
			raiserecoverableerror_191369(s_192441);
		}
		goto LA59;
		LA161: ;
		LA59: ;
...
{	title = 0;
	...
	case ((NU16) 237) ... ((NU16) 267):
	{
		...
		LA6: ;
		{
			if (!!(((gnotes_191398 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
	...
	case ((NU16) 268) ... ((NU16) 290):
	{
		...
		LA16: ;
		{
			if (!!(((gnotes_191398 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
	...
	s_193777 = nsuFormatOpenArray(LOC22, args, argsLen0);
	{
		...
		if (!!(LOC25)) goto LA26;
		{
			if (!!((kind == NIM_NIL))) goto LA30;
			{
				...
				if (!!(writelnhook_191444.ClPrc == 0)) goto LA34;
				s_193795 = copyString(((NimStringDesc*) &TMP149));
				{
...
appendString(s_193795, arg_193797);
				...
				writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_193795, writelnhook_191444.ClEnv):((TMP494)(writelnhook_191444.ClPrc))(s_193795);
			}
			goto LA32;
			LA34: ;
			{
				...
				{
					TY193293 LOC47;
					if (!((erroroutputs_191440 &(1<<((((NU8) 0))&7)))!=0)) goto LA45;
			...
			{
				{
					if (!((erroroutputs_191440 &(1<<((((NU8) 1))&7)))!=0)) goto LA51;
					{
						NimStringDesc* LOC57;
		...
		{
			{
				...
				if (!!(writelnhook_191444.ClPrc == 0)) goto LA63;
				s_194217 = copyString(((NimStringDesc*) &TMP149));
				{
...
appendString(s_194217, arg_194219);
				...
				writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_194217, writelnhook_191444.ClEnv):((TMP495)(writelnhook_191444.ClPrc))(s_194217);
			}
			goto LA61;
			LA63: ;
			{
				...
				{
					TY193306 LOC76;
					if (!((erroroutputs_191440 &(1<<((((NU8) 0))&7)))!=0)) goto LA74;
			...
			{
				{
					if (!((erroroutputs_191440 &(1<<((((NU8) 1))&7)))!=0)) goto LA80;
					{
...
appendString(LOC2, ((NimStringDesc*) &TMP502));
...
N_NIMCALL(void, msgwriteln_191915)(NimStringDesc* s, NU8 flags) {
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = !(writelnhook_191444.ClPrc == 0);
		if (!(LOC3)) goto LA4;
		LOC3 = !(((flags &(1<<((((NU8) 1))&7)))!=0));
		LA4: ;
		if (!LOC3) goto LA5;
		writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s, writelnhook_191444.ClEnv):((TMP1049)(writelnhook_191444.ClPrc))(s);
	}
	goto LA1;
	LA5: ;
	{
		...
		{
			TY192421 LOC16;
			if (!((erroroutputs_191440 &(1<<((((NU8) 0))&7)))!=0)) goto LA14;
	...
	LA10: ;
	{
		{
			TY192421 LOC22;
			if (!((erroroutputs_191440 &(1<<((((NU8) 1))&7)))!=0)) goto LA20;
...
{	result = 0;
	...
	LA3: ;
	{
		...
		LA8: ;
		if (!LOC7) goto LA9;
		pushSafePoint(&TMP1051);
		TMP1051.status = setjmp(TMP1051.context);
		if (TMP1051.status == 0) {
			{
				...
				line_196269 = 0;
				HEX3Atmp_196614 = 0;
				HEX3Atmp_196614 = tofullpath_191665(i.fileindex);
				f_196617 = open_16817(HEX3Atmp_196614, ((NU8) 0), ((NI) 8000));
				res_196619 = rawNewString(((NI) 80));
				{
					while (1) {
						NIM_BOOL LOC15;
						LOC15 = 0;
						LOC15 = readline_16919(f_196617, (&res_196619));
						if (!LOC15) goto LA14;
		...
		if (TMP1051.status != 0) reraiseException();
	}
	LA9: ;
	{
		NimStringDesc* LOC22;
...
N_NIMCALL(void, writesurroundingsrc_194681)(Tlineinfo190352 info) {
	...
	LOC1 = 0;
	LOC2 = 0;
	LOC2 = sourceline_191392(info);
	LOC3 = 0;
	LOC3 = HEX24_177132(LOC2);
	LOC1 = rawNewString(LOC3->Sup.len + 2);
appendString(LOC1, ((NimStringDesc*) &TMP1050));
...
appendString(LOC4, ((NimStringDesc*) &TMP1050));
...
N_NIMCALL(void, limessage_194706)(Tlineinfo190352 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 237) ... ((NU16) 267):
	{
		...
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_191398 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 268) ... ((NU16) 290):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_191398 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0));
		LA11: ;
		ignoremsg = LOC10;
		title = copyString(((NimStringDesc*) &TMP470));
		color = ((NU8) 32);
	...
	s_194813 = getmessagestr_192416(msg, arg);
	{
		...
		if (!LOC15) goto LA18;
		{
			if (!!((kind == NIM_NIL))) goto LA22;
			{
				...
				if (!!(writelnhook_191444.ClPrc == 0)) goto LA26;
				s_194832 = copyString(((NimStringDesc*) &TMP149));
				{
...
appendString(s_194832, arg_194834);
				...
				writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_194832, writelnhook_191444.ClEnv):((TMP1047)(writelnhook_191444.ClPrc))(s_194832);
			}
			goto LA24;
			LA26: ;
			{
				...
				{
					TY194829 LOC39;
					if (!((erroroutputs_191440 &(1<<((((NU8) 0))&7)))!=0)) goto LA37;
					memset((void*)LOC39, 0, sizeof(LOC39));
		...
		{
			{
				...
				if (!!(writelnhook_191444.ClPrc == 0)) goto LA55;
				s_195418 = copyString(((NimStringDesc*) &TMP149));
				{
...
appendString(s_195418, arg_195420);
				...
				writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_195418, writelnhook_191444.ClEnv):((TMP1048)(writelnhook_191444.ClPrc))(s_195418);
			}
			goto LA53;
			LA55: ;
			{
				...
				{
					TY193293 LOC68;
					if (!((erroroutputs_191440 &(1<<((((NU8) 0))&7)))!=0)) goto LA66;
					memset((void*)LOC68, 0, sizeof(LOC68));
			...
			{
				{
					if (!((erroroutputs_191440 &(1<<((((NU8) 1))&7)))!=0)) goto LA72;
					{
		...
		LA20: ;
		{
			...
			if (!(LOC82)) goto LA84;
			LOC82 = ((gnotes_191398 &(IL64(1)<<(((((NU16) 287)- 237))&IL64(63))))!=0);
			LA84: ;
			if (!LOC82) goto LA85;
...
N_NIMCALL(NI32, fileinfoidx_190732)(NimStringDesc* filename, NIM_BOOL* isknownfile) {
	...
	pushSafePoint(&TMP1190);
	TMP1190.status = setjmp(TMP1190.context);
	if (TMP1190.status == 0) {
	...
	if (TMP1190.status != 0) reraiseException();
	{
		NIM_BOOL LOC6;
		NI32* LOC9;
		LOC6 = 0;
...
N_NIMCALL(void, listwarnings_196769)(void) {
	msgwriteln_191915(((NimStringDesc*) &TMP1901), 0);
	{
		NU16 warn_196823;
		NI res_196857;
		warn_196823 = 0;
		res_196857 = ((NI) 237);
		{
			while (1) {
				...
				{
					if (!((gnotes_191398 &(IL64(1)<<(((((NU16) (warn_196823))- 237))&IL64(63))))!=0)) goto LA7;
					LOC4[0] = copyString(((NimStringDesc*) &TMP1903));
				}
				goto LA5;
				LA7: ;
				{
					LOC4[0] = copyString(((NimStringDesc*) &TMP1904));
				}
				LA5: ;
				LOC4[1] = copyString(Warningstostr_190309[((NI)(((NI) (warn_196823)) - ((NI) 237)))- 0]);
				LOC10 = 0;
				LOC10 = nsuFormatOpenArray(((NimStringDesc*) &TMP1902), LOC4, 2);
...
N_NIMCALL(void, listhints_196875)(void) {
	msgwriteln_191915(((NimStringDesc*) &TMP1963), 0);
	{
		NU16 hint_196887;
		NI res_196921;
		hint_196887 = 0;
		res_196921 = ((NI) 268);
		{
			while (1) {
				...
				memset((void*)LOC4, 0, sizeof(LOC4));
				{
					if (!((gnotes_191398 &(IL64(1)<<(((((NU16) (hint_196887))- 237))&IL64(63))))!=0)) goto LA7;
					LOC4[0] = copyString(((NimStringDesc*) &TMP1903));
				}
				goto LA5;
				LA7: ;
...
N_NIMCALL(void, suggestwriteln_191453)(NimStringDesc* s) {
	{
		if (!((erroroutputs_191440 &(1<<((((NU8) 0))&7)))!=0)) goto LA3;
		{
			TY192421 LOC9;
			if (!writelnhook_191444.ClPrc == 0) goto LA7;
		...
		LA7: ;
		{
			writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s, writelnhook_191444.ClEnv):((TMP2065)(writelnhook_191444.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, pushinfocontext_191581)(Tlineinfo190352 info) {
	msgcontext_191437 = (TY191420*) incrSeqV2(&(msgcontext_191437)->Sup, sizeof(Tlineinfo190352));
	msgcontext_191437->data[msgcontext_191437->Sup.len] = info;
	++msgcontext_191437->Sup.len;
}

N_NIMCALL(void, popinfocontext_191600)(void) {
	msgcontext_191437 = (TY191420*) setLengthSeq(&(msgcontext_191437)->Sup, sizeof(Tlineinfo190352), ((NI) ((NI)((msgcontext_191437 ? msgcontext_191437->Sup.len : 0) - ((NI) 1)))));
}
N_NIMCALL(void, TMP2775)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_191509)(void) {
	Esuggestdone190360* e_191514;
	NimStringDesc* LOC1;
	e_191514 = 0;
	e_191514 = (Esuggestdone190360*) newObj((&NTI191515), sizeof(Esuggestdone190360));
	(*e_191514).Sup.Sup.m_type = (&NTI190360);
	LOC1 = 0;
	LOC1 = (*e_191514).Sup.message; (*e_191514).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2776));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_191514, "ESuggestDone");
}
...
N_NIMCALL(Tlineinfo190352, getinfocontext_191626)(NI index) {
	...
	NI i;
	memset((void*)(&result), 0, sizeof(result));
	L = (msgcontext_191437 ? msgcontext_191437->Sup.len : 0);
	{
	...
	LA1: ;
	{
		...
		result = unknownlineinfo_191411();
	}
	goto LA6;
	LA8: ;
	{
		result = msgcontext_191437->data[i];
	}
	LA6: ;
	return result;
}
...
appendString(LOC1, ((NimStringDesc*) &TMP3240));
	result = LOC1;
	return result;
}
...
N_NIMCALL(NI, getinfocontextlen_191545)(void) {
	NI result;
{	result = 0;
	result = (msgcontext_191437 ? msgcontext_191437->Sup.len : 0);
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setinfocontextlen_191562)(NI L) {
	msgcontext_191437 = (TY191420*) setLengthSeq(&(msgcontext_191437)->Sup, sizeof(Tlineinfo190352), ((NI) (L)));
}
...
NIM_EXTERNC N_NOINLINE(void, compiler_msgsInit000)(void) {
	...
	memset((void*)(&LOC1), 0, sizeof(LOC1));
	newfileinfo_190694(((NimStringDesc*) &TMP149), ((NimStringDesc*) &TMP151), (&LOC1));
	fileinfos_190632 = (TY190615*) incrSeqV2(&(fileinfos_190632)->Sup, sizeof(Tfileinfo190350));
	genericAssign((void*)(&fileinfos_190632->data[fileinfos_190632->Sup.len]), (void*)(&LOC1), (&NTI190350));
	++fileinfos_190632->Sup.len;
	gcmdlineinfo_191322 = newlineinfo_191267(((NI32) 0), ((NI) 1), ((NI) 1));
	memset((void*)(&LOC2), 0, sizeof(LOC2));
	newfileinfo_190694(((NimStringDesc*) &TMP149), ((NimStringDesc*) &TMP152), (&LOC2));
	fileinfos_190632 = (TY190615*) incrSeqV2(&(fileinfos_190632)->Sup, sizeof(Tfileinfo190350));
	genericAssign((void*)(&fileinfos_190632->data[fileinfos_190632->Sup.len]), (void*)(&LOC2), (&NTI190350));
	++fileinfos_190632->Sup.len;
	gcodegenlineinfo_191361 = newlineinfo_191267(((NI32) 1), ((NI) 1), ((NI) 1));
	gnotes_191398 = 0;
	LOC3 = 0;
	for (LOC3 = (((NU16) 237)- 237); LOC3 <= (((NU16) 255)- 237); LOC3++) 
gnotes_191398 |=((NU64)(1)<<((LOC3)%(sizeof(NU64)*8)));
	gnotes_191398 |=((NU64)(1)<<(((((NU16) 257)- 237))%(sizeof(NU64)*8)));
	gnotes_191398 |=((NU64)(1)<<(((((NU16) 261)- 237))%(sizeof(NU64)*8)));
	LOC4 = 0;
	for (LOC4 = (((NU16) 263)- 237); LOC4 <= (((NU16) 276)- 237); LOC4++) 
gnotes_191398 |=((NU64)(1)<<((LOC4)%(sizeof(NU64)*8)));
	LOC5 = 0;
	for (LOC5 = (((NU16) 281)- 237); LOC5 <= (((NU16) 283)- 237); LOC5++) 
gnotes_191398 |=((NU64)(1)<<((LOC5)%(sizeof(NU64)*8)));
	gnotes_191398 |=((NU64)(1)<<(((((NU16) 285)- 237))%(sizeof(NU64)*8)));
	gnotes_191398 |=((NU64)(1)<<(((((NU16) 290)- 237))%(sizeof(NU64)*8)));
	gerrorcounter_191399 = ((NI) 0);
	ghintcounter_191400 = ((NI) 0);
	gwarncounter_191401 = ((NI) 0);
	gerrormax_191402 = ((NI) 1);
	if (msgcontext_191437) nimGCunrefNoCycle(msgcontext_191437);
	msgcontext_191437 = (TY191420*) newSeqRC1((&NTI191420), 0);
	lasterror_191438 = unknownlineinfo_191411();
	erroroutputs_191440 = 3;
	memset((void*)(&LOC6), 0, sizeof(LOC6));
	LOC6.ClPrc = ((TMP503) (HEX3Aanonymous_196653)); LOC6.ClEnv = NIM_NIL;
...
static TNimNode* TMP2058[291];
NI TMP2060;
static char* NIM_CONST TMP2059[291] = {
"errUnknown", 
"errIllFormedAstX", 
"errInternal", 
"errCannotOpenFile", 
...
NTI191420.size = sizeof(TY191420*);
NTI191420.kind = 24;
NTI191420.base = (&NTI190352);
NTI191420.flags = 2;
NTI191420.marker = TMP154;
NTI190358.size = sizeof(Erecoverableerror190358);
NTI190358.kind = 17;
NTI190358.base = (&NTI4049);
TMP19[11].len = 0; TMP19[11].kind = 2;
NTI190358.node = &TMP19[11];
NTI191376.size = sizeof(Erecoverableerror190358*);
NTI191376.kind = 22;
NTI191376.base = (&NTI190358);
NTI191376.marker = TMP501;
NTI190005.size = sizeof(NU16);
NTI190005.kind = 14;
NTI190005.base = 0;
NTI190005.flags = 3;
for (TMP2060 = 0; TMP2060 < 291; TMP2060++) {
TMP19[TMP2060+12].kind = 1;
TMP19[TMP2060+12].offset = TMP2060;
TMP19[TMP2060+12].name = TMP2059[TMP2060];
TMP2058[TMP2060] = &TMP19[TMP2060+12];
}
TMP19[303].len = 291; TMP19[303].kind = 2; TMP19[303].sons = &TMP2058[0];
...
NTI191515.size = sizeof(Esuggestdone190360*);
NTI191515.kind = 22;
NTI191515.base = (&NTI190360);
NTI191515.marker = TMP2775;
}
