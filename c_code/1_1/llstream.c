...
STRING_LITERAL(TMP1042, "", 0);
STRING_LITERAL(TMP1043, "\015\012", 2);
STRING_LITERAL(TMP1044, ">>> ", 4);
STRING_LITERAL(TMP1045, "... ", 4);
static NIM_CONST TY212607 TMP1046 = {
0x00, 0x00, 0x00, 0x00, 0x7A, 0xBC, 0x00, 0xF4,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY212607 TMP1345 = {
...
N_NIMCALL(NIM_BOOL, readlinefromstdin_212447)(NimStringDesc* prompt, NimStringDesc** line) {
	...
	{
		if (!!(result)) goto LA3;
		write_12865(stdout, ((NimStringDesc*) &TMP1043));
		exit(0);
	}
	LA3: ;
	return result;
...
static N_INLINE(NIM_BOOL, continueline_212666)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = LOC2;
	if (LOC1) goto LA4;
	LOC1 = endswith_212604(line, TMP1046);
	LA4: ;
	result = LOC1;
	return result;
}
...
N_NIMCALL(NI, llreadfromstdin_212749)(tllstream212204* s, void* buf, NI buflen) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = (*s).S; (*s).S = copyStringRC1(((NimStringDesc*) &TMP1042));
	...
	triples = 0;
	{
		while (1) {
			...
			LOC4 = 0;
			{
				...
				LOC4 = copyString(((NimStringDesc*) &TMP1044));
			}
			goto LA5;
			LA7: ;
			{
...
appendString((*s).S, ((NimStringDesc*) &TMP1043));
			LOC11 = 0;
...
N_NIMCALL(NIM_BOOL, endswithopr_212656)(NimStringDesc* x) {
	NIM_BOOL result;
	result = 0;
	result = endswith_212604(x, TMP1345);
	return result;
}
...
N_NIMCALL(void, llstreamwriteln_212300)(tllstream212204* s, NimStringDesc* data) {
	...
	llstreamwrite_212278(s, ((NimStringDesc*) &TMP1043));
}
...
N_NIMCALL(tllstream212204*, llstreamopenstdin_212245)(void) {
	...
	(*result).Kind = ((NU8) 3);
	LOC1 = 0;
	LOC1 = (*result).S; (*result).S = copyStringRC1(((NimStringDesc*) &TMP1042));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	(*result).Lineoffset = -1;
	return result;
}
...
TMP726[TMP1024+2].kind = 1;
TMP726[TMP1024+2].offset = TMP1024;
TMP726[TMP1024+2].name = TMP1023[TMP1024];
TMP1022[TMP1024] = &TMP726[TMP1024+2];
}
TMP726[6].len = 4; TMP726[6].kind = 2; TMP726[6].sons = &TMP1022[0];
NTI212202.node = &TMP726[6];
TMP726[1].kind = 1;
TMP726[1].offset = offsetof(tllstream212204, Kind);
TMP726[1].typ = (&NTI212202);
TMP726[1].name = "kind";
TMP1021[1] = &TMP726[7];
TMP726[7].kind = 1;
TMP726[7].offset = offsetof(tllstream212204, F);
TMP726[7].typ = (&NTI12404);
TMP726[7].name = "f";
TMP1021[2] = &TMP726[8];
TMP726[8].kind = 1;
TMP726[8].offset = offsetof(tllstream212204, S);
TMP726[8].typ = (&NTI149);
TMP726[8].name = "s";
TMP1021[3] = &TMP726[9];
TMP726[9].kind = 1;
TMP726[9].offset = offsetof(tllstream212204, Rd);
TMP726[9].typ = (&NTI108);
TMP726[9].name = "rd";
TMP1021[4] = &TMP726[10];
TMP726[10].kind = 1;
TMP726[10].offset = offsetof(tllstream212204, Wr);
TMP726[10].typ = (&NTI108);
TMP726[10].name = "wr";
TMP1021[5] = &TMP726[11];
TMP726[11].kind = 1;
TMP726[11].offset = offsetof(tllstream212204, Lineoffset);
TMP726[11].typ = (&NTI108);
TMP726[11].name = "lineOffset";
TMP726[0].len = 6; TMP726[0].kind = 2; TMP726[0].sons = &TMP1021[0];
NTI212204.node = &TMP726[0];
NTI212206.size = sizeof(tllstream212204*);
NTI212206.kind = 22;
NTI212206.base = (&NTI212204);
NTI212206.marker = TMP1025;
}
