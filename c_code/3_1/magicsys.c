...
STRING_LITERAL(TMP2637, "int", 3);
STRING_LITERAL(TMP2638, "int8", 4);
STRING_LITERAL(TMP2639, "int16", 5);
STRING_LITERAL(TMP2640, "int32", 5);
STRING_LITERAL(TMP2641, "int64", 5);
STRING_LITERAL(TMP2642, "uint", 4);
STRING_LITERAL(TMP2643, "uint8", 5);
STRING_LITERAL(TMP2644, "uint16", 6);
STRING_LITERAL(TMP2645, "uint32", 6);
STRING_LITERAL(TMP2646, "uint64", 6);
STRING_LITERAL(TMP2647, "float", 5);
STRING_LITERAL(TMP2648, "float32", 7);
STRING_LITERAL(TMP2649, "float64", 7);
STRING_LITERAL(TMP2650, "float128", 8);
STRING_LITERAL(TMP2651, "bool", 4);
STRING_LITERAL(TMP2652, "char", 4);
STRING_LITERAL(TMP2653, "string", 6);
STRING_LITERAL(TMP2654, "cstring", 7);
STRING_LITERAL(TMP2655, "pointer", 7);
STRING_LITERAL(TMP2656, "request for typekind: ", 22);
STRING_LITERAL(TMP2657, "wanted: ", 8);
STRING_LITERAL(TMP2658, " got: ", 6);
STRING_LITERAL(TMP2659, "type not found: ", 16);
STRING_LITERAL(TMP3250, "invalid int size", 16);
...
N_NIMCALL(ttype225852*, getsystype_282030)(NU8 kind) {
	...
	result = gsystypes_282063[(kind)- 0];
	{
		...
		case ((NU8) 31):
		{
			result = systypefromname_282261(((NimStringDesc*) &TMP2637));
		}
		break;
		case ((NU8) 32):
		{
			result = systypefromname_282261(((NimStringDesc*) &TMP2638));
		}
		break;
		case ((NU8) 33):
		{
...
appendString(LOC26, ((NimStringDesc*) &TMP2656));
...
appendString(LOC31, ((NimStringDesc*) &TMP2657));
appendString(LOC31, reprEnum(kind, (&NTI225258)));
appendString(LOC31, ((NimStringDesc*) &TMP2658));
...
appendString(LOC36, ((NimStringDesc*) &TMP2659));
...
N_NIMCALL(void, setintlittype_282632)(tnode225816* result) {
	...
	default:
	{
		internalerror_197987((*result).Info, ((NimStringDesc*) &TMP3250));
	}
	break;
	}
}
