...
N_NOINLINE(void, raiserecoverableerror_190369)(NimStringDesc* msg) __attribute__((noreturn));
...
Tlineinfo189352 gcmdlineinfo_190322;
Tlineinfo189352 gcodegenlineinfo_190361;
NU64 gnotes_190398;
NI gerrorcounter_190399;
NI ghintcounter_190400;
NI gwarncounter_190401;
NI gerrormax_190402;
TY190420* msgcontext_190437;
TNimType NTI189352; /* TLineInfo */
extern TNimType NTI112; /* int16 */
extern TNimType NTI114; /* int32 */
TNimType NTI190420; /* seq[TLineInfo] */
Tlineinfo189352 lasterror_190438;
NU8 erroroutputs_190440;
TY190441 writelnhook_190444;
...
TNimType NTI190376; /* ref ERecoverableError */
...
TNimType NTI190515; /* ref ESuggestDone */
N_NIMCALL(void, TMP144)(void* p, NI op) {
	TY189365* a;
	NI LOC1;
	a = (TY189365*)p;
...
N_NIMCALL(void, writecontext_192266)(Tlineinfo189352 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_192290 = 0;
		HEX3Atmp_192606 = 0;
		HEX3Atmp_192606 = (NI)((msgcontext_190437 ? msgcontext_190437->Sup.len : 0) - ((NI) 1));
		res_192609 = ((NI) 0);
		{
			while (1) {
				...
				i_192290 = res_192609;
				{
					...
					LOC6 = 0;
					LOC7 = 0;
					LOC7 = HEX3DHEX3D_192255(msgcontext_190437->data[i_192290], lastinfo);
					LOC6 = !(LOC7);
					if (!(LOC6)) goto LA8;
					LOC9 = 0;
					LOC9 = HEX3DHEX3D_192255(msgcontext_190437->data[i_192290], info);
					LOC6 = !(LOC9);
					LA8: ;
					if (!LOC6) goto LA10;
					{
						NimStringDesc* s_192309;
						if (!!(writelnhook_190444.ClPrc == 0)) goto LA14;
						s_192309 = copyString(((NimStringDesc*) &TMP147));
						{
							...
							i_192605 = ((NI) 0);
							{
								while (1) {
									...
									LOC20[0] = tomsgfilename_190829(msgcontext_190437->data[i_192290]);
									LOC20[1] = coordtostr_191396(((NI) (msgcontext_190437->data[i_192290].line)));
									LOC20[2] = coordtostr_191396(((NI) ((NI16)(msgcontext_190437->data[i_192290].col + ((NI16) 1)))));
...
appendString(s_192309, arg_192311);
						...
						writelnhook_190444.ClEnv? writelnhook_190444.ClPrc(s_192309, writelnhook_190444.ClEnv):((TMP429)(writelnhook_190444.ClPrc))(s_192309);
					}
					goto LA12;
					LA14: ;
					{
						if (!((gglobaloptions_166132 &(1<<((((NU8) 23))&31)))!=0)) goto LA22;
						{
							TY192306 LOC28;
							TY192293 LOC29;
							if (!((erroroutputs_190440 &(1<<((((NU8) 0))&7)))!=0)) goto LA26;
							memset((void*)LOC28, 0, sizeof(LOC28));
							memset((void*)LOC29, 0, sizeof(LOC29));
							LOC29[0] = tomsgfilename_190829(msgcontext_190437->data[i_192290]);
							LOC29[1] = coordtostr_191396(((NI) (msgcontext_190437->data[i_192290].line)));
							LOC29[2] = coordtostr_191396(((NI) ((NI16)(msgcontext_190437->data[i_192290].col + ((NI16) 1)))));
					...
					{
						{
							if (!((erroroutputs_190440 &(1<<((((NU8) 1))&7)))!=0)) goto LA33;
							{
								TY192293 LOC39;
								NimStringDesc* LOC40;
								NimStringDesc* LOC41;
								...
								LOC39[0] = tomsgfilename_190829(msgcontext_190437->data[i_192290]);
								LOC39[1] = coordtostr_191396(((NI) (msgcontext_190437->data[i_192290].line)));
								LOC39[2] = coordtostr_191396(((NI) ((NI16)(msgcontext_190437->data[i_192290].col + ((NI16) 1)))));
								LOC40 = 0;
							...
							LA37: ;
							{
								...
								LOC44[0] = tomsgfilename_190829(msgcontext_190437->data[i_192290]);
								LOC44[1] = coordtostr_191396(((NI) (msgcontext_190437->data[i_192290].line)));
								LOC44[2] = coordtostr_191396(((NI) ((NI16)(msgcontext_190437->data[i_192290].col + ((NI16) 1)))));
				...
				LA10: ;
				info = msgcontext_190437->data[i_192290];
				res_192609 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NOINLINE(void, raiserecoverableerror_190369)(NimStringDesc* msg) {
	Erecoverableerror189358* e_190375;
	NimStringDesc* LOC1;
	e_190375 = 0;
	e_190375 = (Erecoverableerror189358*) newObj((&NTI190376), sizeof(Erecoverableerror189358));
	(*e_190375).Sup.Sup.Sup.m_type = (&NTI189358);
	LOC1 = 0;
	LOC1 = (*e_190375).Sup.Sup.message; (*e_190375).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_190375, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_191437)(NU16 msg, NU8 eh, NimStringDesc* s_191441) {
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			LOC9 = LOC10;
			if (LOC9) goto LA12;
			LOC9 = ((gnotes_190398 &(IL64(1)<<(((((NU16) 288)- 237))&IL64(63))))!=0);
			LA12: ;
			if (!LOC9) goto LA13;
			{
				NIM_BOOL LOC17;
				...
				if (!(LOC17)) goto LA18;
				LOC17 = writelnhook_190444.ClPrc == 0;
				LA18: ;
				if (!LOC17) goto LA19;
			...
			{
				{
					...
					if (!!(writelnhook_190444.ClPrc == 0)) goto LA24;
...
appendString(s_191512, arg_191514);
					...
					writelnhook_190444.ClEnv? writelnhook_190444.ClPrc(s_191512, writelnhook_190444.ClEnv):((TMP496)(writelnhook_190444.ClPrc))(s_191512);
				}
				goto LA22;
				LA24: ;
				{
					if (!((gglobaloptions_166132 &(1<<((((NU8) 23))&31)))!=0)) goto LA32;
					{
						TY191421 LOC38;
						NimStringDesc* LOC39;
						if (!((erroroutputs_190440 &(1<<((((NU8) 0))&7)))!=0)) goto LA36;
...
appendString(LOC39, ((NimStringDesc*) &TMP495));
				...
				{
					{
						if (!((erroroutputs_190440 &(1<<((((NU8) 1))&7)))!=0)) goto LA43;
						{
							NimStringDesc* LOC49;
...
appendString(LOC52, ((NimStringDesc*) &TMP495));
	...
	LA5: ;
	{
		...
		LA56: ;
		if (!LOC55) goto LA57;
		gerrorcounter_190399 += ((NI) 1);
		gexitcode_166133 = ((NI8) 1);
		{
			if (!(gerrormax_190402 <= gerrorcounter_190399)) goto LA61;
			{
				NIM_BOOL LOC65;
				NIM_BOOL LOC66;
				LOC65 = 0;
				...
				LOC65 = LOC66;
				if (LOC65) goto LA68;
				LOC65 = ((gnotes_190398 &(IL64(1)<<(((((NU16) 288)- 237))&IL64(63))))!=0);
				LA68: ;
				if (!LOC65) goto LA69;
				{
					NIM_BOOL LOC73;
					...
					if (!(LOC73)) goto LA74;
					LOC73 = writelnhook_190444.ClPrc == 0;
					LA74: ;
					if (!LOC73) goto LA75;
					writestacktrace_20207();
				}
				...
				{
					{
						...
						if (!!(writelnhook_190444.ClPrc == 0)) goto LA80;
...
appendString(s_191869, arg_191871);
						...
						writelnhook_190444.ClEnv? writelnhook_190444.ClPrc(s_191869, writelnhook_190444.ClEnv):((TMP497)(writelnhook_190444.ClPrc))(s_191869);
					}
					goto LA78;
					LA80: ;
					{
						if (!((gglobaloptions_166132 &(1<<((((NU8) 23))&31)))!=0)) goto LA88;
						{
							TY191421 LOC94;
							NimStringDesc* LOC95;
							if (!((erroroutputs_190440 &(1<<((((NU8) 0))&7)))!=0)) goto LA92;
...
appendString(LOC95, ((NimStringDesc*) &TMP495));
					...
					{
						{
							if (!((erroroutputs_190440 &(1<<((((NU8) 1))&7)))!=0)) goto LA99;
							{
...
appendString(LOC108, ((NimStringDesc*) &TMP495));
		...
		LA61: ;
		{
			...
			if (!LOC110) goto LA112;
			{
				...
				LOC116 = ((gnotes_190398 &(IL64(1)<<(((((NU16) 288)- 237))&IL64(63))))!=0);
				LA119: ;
				if (!LOC116) goto LA120;
				{
					...
					LOC124 = writelnhook_190444.ClPrc == 0;
					LA125: ;
				...
				{
					{
						...
						if (!!(writelnhook_190444.ClPrc == 0)) goto LA131;
...
appendString(s_192060, arg_192062);
						...
						writelnhook_190444.ClEnv? writelnhook_190444.ClPrc(s_192060, writelnhook_190444.ClEnv):((TMP498)(writelnhook_190444.ClPrc))(s_192060);
					}
					goto LA129;
					LA131: ;
					{
						if (!((gglobaloptions_166132 &(1<<((((NU8) 23))&31)))!=0)) goto LA139;
						{
							...
							if (!((erroroutputs_190440 &(1<<((((NU8) 0))&7)))!=0)) goto LA143;
...
appendString(LOC146, ((NimStringDesc*) &TMP495));
					...
					{
						{
							if (!((erroroutputs_190440 &(1<<((((NU8) 1))&7)))!=0)) goto LA150;
							{
...
appendString(LOC159, ((NimStringDesc*) &TMP495));
		...
		LA112: ;
		{
			...
			raiserecoverableerror_190369(s_191441);
		}
		goto LA59;
		LA161: ;
		LA59: ;
...
{	title = 0;
	...
	case ((NU16) 237) ... ((NU16) 267):
	{
		...
		LA6: ;
		{
			if (!!(((gnotes_190398 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
	...
	case ((NU16) 268) ... ((NU16) 290):
	{
		...
		LA16: ;
		{
			if (!!(((gnotes_190398 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
	...
	s_192777 = nsuFormatOpenArray(LOC22, args, argsLen0);
	{
		...
		if (!!(LOC25)) goto LA26;
		{
			if (!!((kind == NIM_NIL))) goto LA30;
			{
				...
				if (!!(writelnhook_190444.ClPrc == 0)) goto LA34;
...
appendString(s_192795, arg_192797);
				...
				writelnhook_190444.ClEnv? writelnhook_190444.ClPrc(s_192795, writelnhook_190444.ClEnv):((TMP492)(writelnhook_190444.ClPrc))(s_192795);
			}
			goto LA32;
			LA34: ;
			{
				...
				{
					TY192293 LOC47;
					if (!((erroroutputs_190440 &(1<<((((NU8) 0))&7)))!=0)) goto LA45;
			...
			{
				{
					if (!((erroroutputs_190440 &(1<<((((NU8) 1))&7)))!=0)) goto LA51;
					{
						NimStringDesc* LOC57;
		...
		{
			{
				...
				if (!!(writelnhook_190444.ClPrc == 0)) goto LA63;
...
appendString(s_193217, arg_193219);
				...
				writelnhook_190444.ClEnv? writelnhook_190444.ClPrc(s_193217, writelnhook_190444.ClEnv):((TMP493)(writelnhook_190444.ClPrc))(s_193217);
			}
			goto LA61;
			LA63: ;
			{
				...
				{
					TY192306 LOC76;
					if (!((erroroutputs_190440 &(1<<((((NU8) 0))&7)))!=0)) goto LA74;
			...
			{
				{
					if (!((erroroutputs_190440 &(1<<((((NU8) 1))&7)))!=0)) goto LA80;
					{
...
N_NIMCALL(void, msgwriteln_190915)(NimStringDesc* s, NU8 flags) {
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = !(writelnhook_190444.ClPrc == 0);
		if (!(LOC3)) goto LA4;
		LOC3 = !(((flags &(1<<((((NU8) 1))&7)))!=0));
		LA4: ;
		if (!LOC3) goto LA5;
		writelnhook_190444.ClEnv? writelnhook_190444.ClPrc(s, writelnhook_190444.ClEnv):((TMP1047)(writelnhook_190444.ClPrc))(s);
	}
	goto LA1;
	LA5: ;
	{
		...
		{
			TY191421 LOC16;
			if (!((erroroutputs_190440 &(1<<((((NU8) 0))&7)))!=0)) goto LA14;
	...
	LA10: ;
	{
		{
			TY191421 LOC22;
			if (!((erroroutputs_190440 &(1<<((((NU8) 1))&7)))!=0)) goto LA20;
		...
		if (TMP1049.status == 0) {
			{
				...
				line_195269 = 0;
				HEX3Atmp_195614 = 0;
				HEX3Atmp_195614 = tofullpath_190665(i.fileindex);
...
N_NIMCALL(void, limessage_193706)(Tlineinfo189352 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 237) ... ((NU16) 267):
	{
		...
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_190398 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 268) ... ((NU16) 290):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_190398 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0));
		LA11: ;
		ignoremsg = LOC10;
		title = copyString(((NimStringDesc*) &TMP468));
		color = ((NU8) 32);
	...
	s_193813 = getmessagestr_191416(msg, arg);
	{
		...
		if (!LOC15) goto LA18;
		{
			if (!!((kind == NIM_NIL))) goto LA22;
			{
				...
				if (!!(writelnhook_190444.ClPrc == 0)) goto LA26;
...
appendString(s_193832, arg_193834);
				...
				writelnhook_190444.ClEnv? writelnhook_190444.ClPrc(s_193832, writelnhook_190444.ClEnv):((TMP1045)(writelnhook_190444.ClPrc))(s_193832);
			}
			goto LA24;
			LA26: ;
			{
				...
				{
					TY193829 LOC39;
					if (!((erroroutputs_190440 &(1<<((((NU8) 0))&7)))!=0)) goto LA37;
					memset((void*)LOC39, 0, sizeof(LOC39));
		...
		{
			{
				...
				if (!!(writelnhook_190444.ClPrc == 0)) goto LA55;
...
appendString(s_194418, arg_194420);
				...
				writelnhook_190444.ClEnv? writelnhook_190444.ClPrc(s_194418, writelnhook_190444.ClEnv):((TMP1046)(writelnhook_190444.ClPrc))(s_194418);
			}
			goto LA53;
			LA55: ;
			{
				...
				{
					TY192293 LOC68;
					if (!((erroroutputs_190440 &(1<<((((NU8) 0))&7)))!=0)) goto LA66;
					memset((void*)LOC68, 0, sizeof(LOC68));
			...
			{
				{
					if (!((erroroutputs_190440 &(1<<((((NU8) 1))&7)))!=0)) goto LA72;
					{
		...
		LA20: ;
		{
			...
			if (!(LOC82)) goto LA84;
			LOC82 = ((gnotes_190398 &(IL64(1)<<(((((NU16) 287)- 237))&IL64(63))))!=0);
			LA84: ;
			if (!LOC82) goto LA85;
	...
	msgwriteln_190915(((NimStringDesc*) &TMP1900), 0);
	{
		...
		res_195857 = ((NI) 237);
		{
			while (1) {
				...
				{
					if (!((gnotes_190398 &(IL64(1)<<(((((NU16) (warn_195823))- 237))&IL64(63))))!=0)) goto LA7;
	...
	msgwriteln_190915(((NimStringDesc*) &TMP1962), 0);
	{
		...
		res_195921 = ((NI) 268);
		{
			while (1) {
				...
				memset((void*)LOC4, 0, sizeof(LOC4));
				{
					if (!((gnotes_190398 &(IL64(1)<<(((((NU16) (hint_195887))- 237))&IL64(63))))!=0)) goto LA7;
					LOC4[0] = copyString(((NimStringDesc*) &TMP1902));
				}
				goto LA5;
				LA7: ;
...
N_NIMCALL(void, suggestwriteln_190453)(NimStringDesc* s) {
	{
		if (!((erroroutputs_190440 &(1<<((((NU8) 0))&7)))!=0)) goto LA3;
		{
			TY191421 LOC9;
			if (!writelnhook_190444.ClPrc == 0) goto LA7;
		...
		LA7: ;
		{
			writelnhook_190444.ClEnv? writelnhook_190444.ClPrc(s, writelnhook_190444.ClEnv):((TMP2064)(writelnhook_190444.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, pushinfocontext_190581)(Tlineinfo189352 info) {
	msgcontext_190437 = (TY190420*) incrSeqV2(&(msgcontext_190437)->Sup, sizeof(Tlineinfo189352));
	msgcontext_190437->data[msgcontext_190437->Sup.len] = info;
	++msgcontext_190437->Sup.len;
}

N_NIMCALL(void, popinfocontext_190600)(void) {
	msgcontext_190437 = (TY190420*) setLengthSeq(&(msgcontext_190437)->Sup, sizeof(Tlineinfo189352), ((NI) ((NI)((msgcontext_190437 ? msgcontext_190437->Sup.len : 0) - ((NI) 1)))));
}
N_NIMCALL(void, TMP2774)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_190509)(void) {
	Esuggestdone189360* e_190514;
	NimStringDesc* LOC1;
	e_190514 = 0;
	e_190514 = (Esuggestdone189360*) newObj((&NTI190515), sizeof(Esuggestdone189360));
	(*e_190514).Sup.Sup.m_type = (&NTI189360);
	LOC1 = 0;
	LOC1 = (*e_190514).Sup.message; (*e_190514).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2775));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_190514, "ESuggestDone");
}
...
N_NIMCALL(Tlineinfo189352, getinfocontext_190626)(NI index) {
	...
	NI i;
	memset((void*)(&result), 0, sizeof(result));
	L = (msgcontext_190437 ? msgcontext_190437->Sup.len : 0);
	{
	...
	LA1: ;
	{
		...
		result = unknownlineinfo_190411();
	}
	goto LA6;
	LA8: ;
	{
		result = msgcontext_190437->data[i];
	}
	LA6: ;
	return result;
}
...
N_NIMCALL(NI, getinfocontextlen_190545)(void) {
	NI result;
{	result = 0;
	result = (msgcontext_190437 ? msgcontext_190437->Sup.len : 0);
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setinfocontextlen_190562)(NI L) {
	msgcontext_190437 = (TY190420*) setLengthSeq(&(msgcontext_190437)->Sup, sizeof(Tlineinfo189352), ((NI) (L)));
}
...
NIM_EXTERNC N_NOINLINE(void, compiler_msgsInit000)(void) {
	...
	++fileinfos_189632->Sup.len;
	gcmdlineinfo_190322 = newlineinfo_190267(((NI32) 0), ((NI) 1), ((NI) 1));
	memset((void*)(&LOC2), 0, sizeof(LOC2));
	...
	++fileinfos_189632->Sup.len;
	gcodegenlineinfo_190361 = newlineinfo_190267(((NI32) 1), ((NI) 1), ((NI) 1));
	gnotes_190398 = 0;
	LOC3 = 0;
	for (LOC3 = (((NU16) 237)- 237); LOC3 <= (((NU16) 255)- 237); LOC3++) 
gnotes_190398 |=((NU64)(1)<<((LOC3)%(sizeof(NU64)*8)));
	gnotes_190398 |=((NU64)(1)<<(((((NU16) 257)- 237))%(sizeof(NU64)*8)));
	gnotes_190398 |=((NU64)(1)<<(((((NU16) 261)- 237))%(sizeof(NU64)*8)));
	LOC4 = 0;
	for (LOC4 = (((NU16) 263)- 237); LOC4 <= (((NU16) 276)- 237); LOC4++) 
gnotes_190398 |=((NU64)(1)<<((LOC4)%(sizeof(NU64)*8)));
	LOC5 = 0;
	for (LOC5 = (((NU16) 281)- 237); LOC5 <= (((NU16) 283)- 237); LOC5++) 
gnotes_190398 |=((NU64)(1)<<((LOC5)%(sizeof(NU64)*8)));
	gnotes_190398 |=((NU64)(1)<<(((((NU16) 285)- 237))%(sizeof(NU64)*8)));
	gnotes_190398 |=((NU64)(1)<<(((((NU16) 290)- 237))%(sizeof(NU64)*8)));
	gerrorcounter_190399 = ((NI) 0);
	ghintcounter_190400 = ((NI) 0);
	gwarncounter_190401 = ((NI) 0);
	gerrormax_190402 = ((NI) 1);
	if (msgcontext_190437) nimGCunrefNoCycle(msgcontext_190437);
	msgcontext_190437 = (TY190420*) newSeqRC1((&NTI190420), 0);
	lasterror_190438 = unknownlineinfo_190411();
	erroroutputs_190440 = 3;
...
NTI190420.size = sizeof(TY190420*);
NTI190420.kind = 24;
NTI190420.base = (&NTI189352);
NTI190420.flags = 2;
NTI190420.marker = TMP152;
NTI189358.size = sizeof(Erecoverableerror189358);
NTI189358.kind = 17;
NTI189358.base = (&NTI4049);
TMP19[11].len = 0; TMP19[11].kind = 2;
NTI189358.node = &TMP19[11];
NTI190376.size = sizeof(Erecoverableerror189358*);
NTI190376.kind = 22;
NTI190376.base = (&NTI189358);
NTI190376.marker = TMP499;
...
NTI190515.size = sizeof(Esuggestdone189360*);
NTI190515.kind = 22;
NTI190515.base = (&NTI189360);
NTI190515.marker = TMP2774;
}
