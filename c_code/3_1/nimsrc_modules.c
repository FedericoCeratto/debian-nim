...
STRING_LITERAL(TMP1506, "modules.nim", 11);
NIM_CONST TY86545 TMP1505 = {((NimStringDesc*) &TMP1506),
((NI) 41)}
;
STRING_LITERAL(TMP4262, "", 0);
STRING_LITERAL(TMP4263, "nim", 3);
STRING_LITERAL(TMP4264, "system.nim", 10);
STRING_LITERAL(TMP4975, "stdin", 5);
...
N_NIMCALL(void, wantmainmodule_522922)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_165123(gcmdlineinfo_163922, ((NU16) 186), ((NimStringDesc*) &TMP4262));
	}
	LA3: ;
	LOC5 = 0;
	LOC5 = nosaddFileExt(gprojectfull_154236, ((NimStringDesc*) &TMP4263));
...
N_NIMCALL(void, compilesystemmodule_522901)(void) {
	{
		...
		LOC5 = 0;
		LOC5 = HEX2F_119492(libpath_154233, ((NimStringDesc*) &TMP4264));
...
N_NIMCALL(void, compileproject_522985)(NI32 projectfileidx) {
	...
	LOC1 = 0;
	LOC1 = HEX2F_119492(libpath_154233, ((NimStringDesc*) &TMP4264));
...
N_NIMCALL(Tsym190843*, makestdinmodule_523003)(void) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = fileinfoidx_163854(((NimStringDesc*) &TMP4975));
