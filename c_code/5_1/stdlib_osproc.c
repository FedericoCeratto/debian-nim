...
static NIM_CONST TY211607 TMP1795 = {
...
STRING_LITERAL(TMP1797, "\'\"\'\"\'", 5);
STRING_LITERAL(TMP2861, "/bin/sh", 7);
STRING_LITERAL(TMP2862, "-c", 2);
...
N_NIMCALL(NimStringDesc*, nospquoteShellPosix)(NimStringDesc* s) {
	...
	LA3: ;
	safe = allcharsinset_96479(s, TMP1795);
	{
		if (!safe) goto LA7;
		result = copyString(s);
		goto BeforeRet;
	...
	LA7: ;
	{
		...
		LOC10 = 0;
		LOC11 = 0;
		LOC11 = nsuReplaceStr(s, ((NimStringDesc*) &TMP1796), ((NimStringDesc*) &TMP1797));
		LOC10 = rawNewString(LOC11->Sup.len + 2);
appendString(LOC10, ((NimStringDesc*) &TMP1796));
...
appendString(LOC10, ((NimStringDesc*) &TMP2864));
...
N_NIMCALL(processobj140402*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, stringtableobj131012* env, NU8 options) {
	...
	pushSafePoint(&TMP2863);
	TMP2863.status = _setjmp(TMP2863.context);
	if (TMP2863.status == 0) {
		NCSTRING* sysenv;
		TSafePoint TMP2865;
		{
		...
		if (TMP2865.status == 0) {
			...
			pid = startprocessauxfork_142001((&data));
			{
				...
				LOC43 = 0;
				LOC43 = nsuJoinSep(args, argsLen0, ((NimStringDesc*) &TMP2867));
				printf("%s%s%s\012", (command)->data, (((NimStringDesc*) &TMP2867))->data, (LOC43)->data);
			}
			LA41: ;
			(*result).Id = pid;
			{
	...
	if (TMP2863.status != 0) reraiseException();
	return result;
}
...
N_NIMCALL(processobj140402*, startcmd_140644)(NimStringDesc* command, NU8 options) {
	...
	result = nospstartProcess(command, ((NimStringDesc*) &TMP2868), LOC1, 0, NIM_NIL, (options | 4));
	return result;
}
		...
		m = ((n <= cmdsLen0) ? n : cmdsLen0);
		{
			...
			res_141516 = 0;
			{
				while (1) {
					...
					i_141241 = res_141516;
					{
						if (!!((beforerunevent.ClPrc == TMP4213.ClPrc && beforerunevent.ClEnv == TMP4213.ClEnv))) goto LA10;
						beforerunevent.ClEnv? beforerunevent.ClPrc(i_141241, beforerunevent.ClEnv):((TMP4214)(beforerunevent.ClPrc))(i_141241);
					}
					LA10: ;
					...
					res_141523 = 0;
					{
						while (1) {
							...
							r_141413 = res_141523;
							{
								...
								LA25: ;
								{
									if (!!((beforerunevent.ClPrc == TMP4213.ClPrc && beforerunevent.ClEnv == TMP4213.ClEnv))) goto LA29;
									beforerunevent.ClEnv? beforerunevent.ClPrc(i, beforerunevent.ClEnv):((TMP4215)(beforerunevent.ClPrc))(i);
								}
								LA29: ;
	...
	{
		{
			...
			res_141535 = 0;
			{
				while (1) {
					...
					i_141497 = res_141535;
					{
						if (!!((beforerunevent.ClPrc == TMP4213.ClPrc && beforerunevent.ClEnv == TMP4213.ClEnv))) goto LA49;
						beforerunevent.ClEnv? beforerunevent.ClPrc(i_141497, beforerunevent.ClEnv):((TMP4216)(beforerunevent.ClPrc))(i_141497);
					}
					LA49: ;
