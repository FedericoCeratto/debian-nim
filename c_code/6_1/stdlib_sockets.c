...
N_NIMCALL(void, send_193008)(tsocketimpl182607* socket, NimStringDesc* data) {
	NI sent;
	{
		...
		LOC5 = 0;
		LOC5 = (*e_193014).Sup.message; (*e_193014).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1980));
	...
	LA8: ;
	{
		...
		LOC15 = 0;
		LOC15 = (*e_193203).Sup.Sup.message; (*e_193203).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1981));
