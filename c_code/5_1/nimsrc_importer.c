...
{	result = 0;
	...
	case ((NU8) 30):
	{
		NimStringDesc* LOC12;
		{
			...
			if (!(LOC7)) goto LA8;
			LOC9 = 0;
			LOC9 = getident_167463(((NimStringDesc*) &TMP3460));
...
N_NIMCALL(Tsym190843*, myimportmodule_251708)(Tcontext244023* c, Tnode190813* n) {
	...
	f = checkmodulename_251064(n);
	{
		...
		result = importmoduleas_251671(n, LOC5);
		{
			...
			localerror_165155((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP3466));
		}
		LA8: ;
		{
				...
				res_251216 = ((NI) 0);
				{
					while (1) {
						...
						e = (*(*(*etyp).n).kindU.S6.sons->data[j_251157]).kindU.S4.sym;
						{
							...
							internalerror_165199((*s).info, ((NimStringDesc*) &TMP3468));
						}
						LA27: ;
			...
			e = initidentiter_198147((&it), (*frommod).kindU.S3.tab, (*s).name);
			{
				while (1) {
					if (!!((e == NIM_NIL))) goto LA16;
					{
						...
						internalerror_165199((*n).info, ((NimStringDesc*) &TMP3471));
					}
					LA19: ;
					rawimportsymbol_251077(c, e);
