...
static NIM_CONST TY172642 TMP4340 = {NIM_NIL,NIM_NIL};
	...
	LA19: ;
	{
		...
		if (LOC27) nimGCunrefNoCycle(LOC27);
		{
			...
			i_146479 = ((NI) 0);
			{
				while (1) {
					NimStringDesc* LOC31;
					if (!(i_146479 < argsLen0)) goto LA30;
					arg_146222 = args[i_146479];
					sysargsraw = (TY122008*) incrSeq(&(sysargsraw)->Sup, sizeof(NimStringDesc*));
					LOC31 = 0;
					LOC31 = sysargsraw->data[sysargsraw->Sup.len-1]; sysargsraw->data[sysargsraw->Sup.len-1] = copyStringRC1(arg_146222);
...
N_NIMCALL(NI, nospexecProcesses)(NimStringDesc** cmds, NI cmdsLen0, NU8 options_144793, NI n, TY172642 beforerunevent) {
	...
	options = (options_144793 & ~ 16);
	{
		...
		m = ((n <= cmdsLen0) ? n : cmdsLen0);
		{
			...
			i_145235 = 0;
			HEX3Atmp_145528 = 0;
			HEX3Atmp_145528 = (NI)(m - ((NI) 1));
			res_145531 = ((NI) 0);
			{
				while (1) {
					TY219714 LOC12;
					if (!(res_145531 <= HEX3Atmp_145528)) goto LA7;
					i_145235 = res_145531;
					{
						if (!!((beforerunevent.ClPrc == TMP4340.ClPrc && beforerunevent.ClEnv == TMP4340.ClEnv))) goto LA10;
						beforerunevent.ClEnv? beforerunevent.ClPrc(i_145235, beforerunevent.ClEnv):((TMP4341)(beforerunevent.ClPrc))(i_145235);
					}
					LA10: ;
					memset((void*)LOC12, 0, sizeof(LOC12));
					asgnRef((void**) (&q->data[i_145235]), nospstartProcess(cmds[i_145235], ((NimStringDesc*) &TMP4342), LOC12, 0, NIM_NIL, (options | 4)));
					res_145531 += ((NI) 1);
				} LA7: ;
			}
		}
		i = m;
		{
			while (1) {
				...
				nossleep(((NI) 50));
				{
					...
					r_145413 = 0;
					HEX3Atmp_145537 = 0;
					HEX3Atmp_145537 = (NI)(n - ((NI) 1));
					res_145540 = ((NI) 0);
					{
						while (1) {
							if (!(res_145540 <= HEX3Atmp_145537)) goto LA17;
							r_145413 = res_145540;
							{
								NIM_BOOL LOC20;
								NI LOC23;
								...
								asgnRef((void**) (&q->data[r_145413]), nospstartProcess(cmds[i], ((NimStringDesc*) &TMP4342), LOC32, 0, NIM_NIL, (options | 4)));
								i += ((NI) 1);
								{
		...
		}
		{
			...
			j_145471 = 0;
			HEX3Atmp_145545 = 0;
			HEX3Atmp_145545 = (NI)(m - ((NI) 1));
			res_145548 = ((NI) 0);
			{
				while (1) {
					NI LOC40;
					if (!(res_145548 <= HEX3Atmp_145545)) goto LA39;
					j_145471 = res_145548;
					LOC40 = 0;
					LOC40 = nospwaitForExit(q->data[j_145471], ((NI) -1));
					result = ((LOC40 >= result) ? LOC40 : result);
					{
						if (!!((q->data[j_145471] == NIM_NIL))) goto LA43;
	...
	{
		{
			...
			res_145556 = ((NI) 0);
			{
				while (1) {
					...
					TY219714 LOC53;
					NI LOC54;
					if (!(res_145556 <= HEX3Atmp_145553)) goto LA48;
					i_145498 = res_145556;
					{
						if (!!((beforerunevent.ClPrc == TMP4340.ClPrc && beforerunevent.ClEnv == TMP4340.ClEnv))) goto LA51;
						beforerunevent.ClEnv? beforerunevent.ClPrc(i_145498, beforerunevent.ClEnv):((TMP4344)(beforerunevent.ClPrc))(i_145498);
					}
					LA51: ;
					memset((void*)LOC53, 0, sizeof(LOC53));
					p = nospstartProcess(cmds[i_145498], ((NimStringDesc*) &TMP4342), LOC53, 0, NIM_NIL, (options | 4));
					LOC54 = 0;
