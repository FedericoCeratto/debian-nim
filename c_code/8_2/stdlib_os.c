...
N_NIMCALL(NimStringDesc*, getapplheuristic_123201)(void);
...
N_NIMCALL(void, nossplitPath)(NimStringDesc* path, keyvaluepair130008* Result) {
	...
	seppos = -1;
	{
		...
		i_116331 = 0;
		HEX3Atmp_116347 = 0;
		HEX3Atmp_116347 = (NI64)(path->Sup.len - 1);
...
N_NIMCALL(NI, searchextpos_116551)(NimStringDesc* s) {
	...
	result = -1;
	{
		...
		i_116566 = 0;
		HEX3Atmp_116582 = 0;
		HEX3Atmp_116582 = (NI64)(s->Sup.len - 1);
...
N_NIMCALL(void, nossplitFile)(NimStringDesc* path, TY116604* Result) {
	...
	LA5: ;
	{
		...
		dotpos = path->Sup.len;
		{
			...
			i_116637 = 0;
			HEX3Atmp_116668 = 0;
			HEX3Atmp_116668 = (NI64)(path->Sup.len - 1);
				...
				while (1) {
					...
					i_116637 = res_116671;
					{
						if (!((NU8)(path->data[i_116637]) == (NU8)(46))) goto LA13;
						{
							...
							LOC17 = LOC18;
							if (!(LOC17)) goto LA20;
							LOC17 = !((((NU8)(path->data[(NI64)(i_116637 - 1)])) == ((NU8)(47)) || ((NU8)(path->data[(NI64)(i_116637 - 1)])) == ((NU8)(47))));
							LA20: ;
							if (!LOC17) goto LA21;
							dotpos = i_116637;
						}
...
N_NIMCALL(NimStringDesc*, getenv_119442)(NimStringDesc* key) {
	...
	i = findenvvar_119405(key);
	{
		...
		result = copyStr(environment_118809->data[i], (NI64)(LOC5 + 1));
		goto BeforeRet;
	}
	goto LA1;
	LA3: ;
		...
		if (!LOC3) goto LA5;
		{
			...
			last_123415 = 0;
			{
				while (1) {
					...
					{
						NimStringDesc* x;
						if (!(first_123417 <= (NI64)(last_123415 - 1))) goto LA18;
						p_123403 = copyStrLast(HEX3Atmp_123410, first_123417, (NI64)(last_123415 - 1));
...
N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	...
	result = getenv_119442(((NimStringDesc*) &TMP1075));
	{
		...
		result = getapplheuristic_123201();
	}
	LA3: ;
	return result;
}
...
N_NIMCALL(NI, parentdirpos_116366)(NimStringDesc* path) {
	...
	LA3: ;
	{
		...
		i_116396 = 0;
		HEX3Atmp_116412 = 0;
		HEX3Atmp_116412 = (NI64)(path->Sup.len - q);
...
N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
	...
	omitnext = NIM_FALSE;
	{
		...
		i_121011 = 0;
		HEX3Atmp_121027 = 0;
		HEX3Atmp_121027 = (NI64)(dir->Sup.len - 1);
		res_121030 = 1;
		{
			while (1) {
				...
				i_121011 = res_121030;
				{
					...
					LA10: ;
					{
						NimStringDesc* LOC13;
						LOC13 = 0;
						LOC13 = copyStrLast(dir, 0, (NI64)(i_121011 - 1));
...
N_NIMCALL(NimStringDesc*, expandtilde_124446)(NimStringDesc* path) {
	...
	result = 0;
	{
		...
		LOC11 = 0;
		LOC11 = nosgetHomeDir();
		LOC12 = HEX2EHEX2E_92299(2, (NI64)(path->Sup.len - 1));
		LOC13 = 0;
		LOC13 = HEX5BHEX5D_84170(path, LOC12);
