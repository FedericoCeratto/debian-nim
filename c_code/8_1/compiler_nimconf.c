...
STRING_LITERAL(TMP2199, "@", 1);
STRING_LITERAL(TMP2200, "\')\'", 3);
STRING_LITERAL(TMP2201, "\':\'", 3);
STRING_LITERAL(TMP2202, "@if", 3);
STRING_LITERAL(TMP2203, "@end", 4);
STRING_LITERAL(TMP2205, "putenv", 6);
STRING_LITERAL(TMP2206, "prependenv", 10);
STRING_LITERAL(TMP2207, "appendenv", 9);
STRING_LITERAL(TMP2208, "-", 1);
STRING_LITERAL(TMP2209, "--", 2);
STRING_LITERAL(TMP2210, "", 0);
STRING_LITERAL(TMP2211, "\']\'", 3);
STRING_LITERAL(TMP2212, "%=", 2);
STRING_LITERAL(TMP2213, "&", 1);
STRING_LITERAL(TMP2214, "config", 6);
STRING_LITERAL(TMP2215, "etc", 3);
STRING_LITERAL(TMP2216, "/etc/", 5);
STRING_LITERAL(TMP2218, "nimcfg", 6);
STRING_LITERAL(TMP2219, "nim.cfg", 7);
STRING_LITERAL(TMP2220, "nimrod.cfg", 10);
...
N_NIMCALL(NIM_BOOL, parseatom_261027_930198375)(Tlexer256174* L0, Ttoken256170* tok0) {
	...
	result0 = (NIM_BOOL)0;
	{
		...
		LA7: ;
		{
			lexmessage_256381_689113469((&(*L0)), ((Tmsgkind185002) 24), ((NimStringDesc*) &TMP2200));
		}
		LA5: ;
	}
	goto LA1;
...
N_NIMCALL(NIM_BOOL, evalppif_261096_930198375)(Tlexer256174* L0, Ttoken256170* tok0) {
	...
	LA3: ;
	{
		lexmessage_256381_689113469((&(*L0)), ((Tmsgkind185002) 24), ((NimStringDesc*) &TMP2201));
	}
	LA1: ;
	return result0;
}
		...
		while (1) {
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = eqStrings((*(*tok0).ident).s, ((NimStringDesc*) &TMP2199));
				LA6: ;
				if (!LOC5) goto LA7;
				ppgettok_261003_930198375(L0, tok0);
...
N_NIMCALL(void, parsedirective_261246_930198375)(Tlexer256174* L0, Ttoken256170* tok0) {
	...
	default:
	{
		...
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2205))) goto LA15;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2206))) goto LA16;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2207))) goto LA17;
		goto LA18;
		LA15: ;
		{
			NimStringDesc* key0;
...
N_NIMCALL(void, conftok_261275_930198375)(Tlexer256174* L0, Ttoken256170* tok0) {
	ppgettok_261003_930198375(L0, tok0);
	{
		while (1) {
			...
			if (!(LOC3)) goto LA4;
			LOC3 = eqStrings((*(*tok0).ident).s, ((NimStringDesc*) &TMP2199));
			LA4: ;
			if (!LOC3) goto LA2;
...
N_NIMCALL(void, parseassignment_261319_930198375)(Tlexer256174* L0, Ttoken256170* tok0) {
	...
	Tident193012* LOC22;
	{
		...
		LOC3 = (NIM_BOOL)0;
		LOC4 = (Tident193012*)0;
		LOC4 = getident_193441_791273810(((NimStringDesc*) &TMP2208));
		LOC3 = ((*(*tok0).ident).Sup.id == (*LOC4).Sup.id);
		if (LOC3) goto LA5;
		LOC6 = (Tident193012*)0;
		LOC6 = getident_193441_791273810(((NimStringDesc*) &TMP2209));
	...
	conftok_261275_930198375(L0, tok0);
	val0 = copyString(((NimStringDesc*) &TMP2210));
	{
		while (1) {
			NimStringDesc* LOC11;
...
appendString(val0, LOC16);
		...
		LA19: ;
		{
			lexmessage_256381_689113469((&(*L0)), ((Tmsgkind185002) 24), ((NimStringDesc*) &TMP2211));
		}
		LA17: ;
	...
	LOC22 = getident_193441_791273810(((NimStringDesc*) &TMP2212));
...
appendString(val0, LOC33);
		conftok_261275_930198375(L0, tok0);
		{
			while (1) {
				...
				LOC38 = getident_193441_791273810(((NimStringDesc*) &TMP2213));
...
N_NIMCALL(NimStringDesc*, getsystemconfigpath_261434_930198375)(NimStringDesc* filename0) {
	...
	LOC1[1] = copyString(((NimStringDesc*) &TMP2214));
	...
	result0 = nosjoinPathOpenArray(LOC1, 3);
	{
		...
		LOC7[1] = copyString(((NimStringDesc*) &TMP2215));
...
appendString(LOC13, ((NimStringDesc*) &TMP2216));
...
N_NIMCALL(void, loadconfigs_261603_930198375)(NimStringDesc* cfg0) {
	...
	LA18: ;
	{
		...
		readconfigfile_261382_930198375(LOC60);
		{
			...
			projectconfig0 = noschangeFileExt(gprojectfull_163207_2607990831, ((NimStringDesc*) &TMP2218));
			{
				NIM_BOOL LOC67;
				LOC67 = (NIM_BOOL)0;
				LOC67 = fileexists_128004_2125978480(projectconfig0);
				if (!!(LOC67)) goto LA68;
				projectconfig0 = noschangeFileExt(gprojectfull_163207_2607990831, ((NimStringDesc*) &TMP2219));
			}
			LA68: ;
			{
				NIM_BOOL LOC72;
