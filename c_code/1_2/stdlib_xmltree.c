...
N_NIMCALL(void, addescaped_378039)(NimStringDesc** result, NimStringDesc* s);
...
N_NIMCALL(void, addescaped_378039)(NimStringDesc** result, NimStringDesc* s) {
	{
		...
		c_378045 = 0;
		i_378049 = ((NI) 0);
		L_378051 = (s ? s->Sup.len : 0);
		{
			while (1) {
				if (!(i_378049 < L_378051)) goto LA3;
				c_378045 = s->data[i_378049];
				switch (((NU8)(c_378045))) {
				case 60:
				{
...
appendString((*result), ((NimStringDesc*) &TMP5055));
				...
				default:
				{
					(*result) = addChar((*result), c_378045);
				}
				break;
				}
				i_378049 += ((NI) 1);
