...
N_NIMCALL(NI, nodetablerawget_286509)(tnodetable224876 t, NI k, tnode224816* key);
N_NIMCALL(NIM_BOOL, treesequivalent_286243)(tnode224816* a, tnode224816* b);
...
N_NIMCALL(void, nodetablerawinsert_286562)(tnodepairseq224874** data, NI k, tnode224816* key, NI val);
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = (tnodepairseq224874*) newSeq((&NTI224874), (NI64)((*t).Data->Sup.len * 2));
			{
				NI i_287251;
				NI HEX3Atmp_287301;
				NI res_287304;
