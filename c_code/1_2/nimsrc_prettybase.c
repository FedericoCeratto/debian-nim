...
N_NIMCALL(void, loadfile_249041)(Tlineinfo164338 info) {
	...
	LA3: ;
	{
		...
		gsourcefiles_249036->data[i].lines = (TY123008*) newSeqRC1((&NTI123008), 0);
		path = tofullpath_165273(info.fileindex);
		LOC9 = 0;
		...
		gsourcefiles_249036->data[i].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2682));
		{
			...
			res_249117 = rawNewString(((NI) 80));
			{
				while (1) {
					...
					gsourcefiles_249036->data[i].lines = (TY123008*) incrSeq(&(gsourcefiles_249036->data[i].lines)->Sup, sizeof(NimStringDesc*));
					LOC15 = 0;
		...
		pos = lex.bufpos;
		{
			while (1) {
				...
				case 13:
				{
					NimStringDesc* LOC21;
					LOC21 = 0;
					LOC21 = gsourcefiles_249036->data[i].newline; gsourcefiles_249036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP2690));
				...
				case 0:
				{
					NimStringDesc* LOC23;
					LOC23 = 0;
					LOC23 = gsourcefiles_249036->data[i].newline; gsourcefiles_249036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP2691));
...
{	loadfile_249041(info);
	...
	last = (NI)((NI)(first + LOC17) - ((NI) 1));
	{
		...
		LOC21 = 0;
		LOC21 = HEX5BHEX5D_87567(line, LOC20);
		LOC22 = 0;
