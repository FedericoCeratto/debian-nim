...
N_NOINLINE(void, raiserecoverableerror_189369)(NimStringDesc* msg) __attribute__((noreturn));
...
Tlineinfo188352 gcmdlineinfo_189322;
Tlineinfo188352 gcodegenlineinfo_189361;
NU64 gnotes_189398;
NI gerrorcounter_189399;
NI ghintcounter_189400;
NI gwarncounter_189401;
NI gerrormax_189402;
TY189420* msgcontext_189437;
TNimType NTI188352; /* TLineInfo */
extern TNimType NTI112; /* int16 */
extern TNimType NTI114; /* int32 */
TNimType NTI189420; /* seq[TLineInfo] */
Tlineinfo188352 lasterror_189438;
NU8 erroroutputs_189440;
TY189441 writelnhook_189444;
...
TNimType NTI189376; /* ref ERecoverableError */
...
TNimType NTI189515; /* ref ESuggestDone */
N_NIMCALL(void, TMP144)(void* p, NI op) {
	TY188365* a;
	NI LOC1;
	a = (TY188365*)p;
...
N_NIMCALL(void, writecontext_191266)(Tlineinfo188352 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_191290 = 0;
		HEX3Atmp_191606 = 0;
		HEX3Atmp_191606 = (NI)((msgcontext_189437 ? msgcontext_189437->Sup.len : 0) - ((NI) 1));
		res_191609 = ((NI) 0);
		{
			while (1) {
				...
				i_191290 = res_191609;
				{
					...
					LOC6 = 0;
					LOC7 = 0;
					LOC7 = HEX3DHEX3D_191255(msgcontext_189437->data[i_191290], lastinfo);
					LOC6 = !(LOC7);
					if (!(LOC6)) goto LA8;
					LOC9 = 0;
					LOC9 = HEX3DHEX3D_191255(msgcontext_189437->data[i_191290], info);
					LOC6 = !(LOC9);
					LA8: ;
					if (!LOC6) goto LA10;
					{
						NimStringDesc* s_191309;
						if (!!(writelnhook_189444.ClPrc == 0)) goto LA14;
						s_191309 = copyString(((NimStringDesc*) &TMP147));
						{
							...
							i_191605 = ((NI) 0);
							{
								while (1) {
									...
									LOC20[0] = tomsgfilename_189829(msgcontext_189437->data[i_191290]);
									LOC20[1] = coordtostr_190396(((NI) (msgcontext_189437->data[i_191290].line)));
									LOC20[2] = coordtostr_190396(((NI) ((NI16)(msgcontext_189437->data[i_191290].col + ((NI16) 1)))));
...
appendString(s_191309, arg_191311);
						...
						writelnhook_189444.ClEnv? writelnhook_189444.ClPrc(s_191309, writelnhook_189444.ClEnv):((TMP429)(writelnhook_189444.ClPrc))(s_191309);
					}
					goto LA12;
					LA14: ;
					{
						if (!((gglobaloptions_165132 &(1<<((((NU8) 23))&31)))!=0)) goto LA22;
						{
							TY191306 LOC28;
							TY191293 LOC29;
							if (!((erroroutputs_189440 &(1<<((((NU8) 0))&7)))!=0)) goto LA26;
							memset((void*)LOC28, 0, sizeof(LOC28));
							memset((void*)LOC29, 0, sizeof(LOC29));
							LOC29[0] = tomsgfilename_189829(msgcontext_189437->data[i_191290]);
							LOC29[1] = coordtostr_190396(((NI) (msgcontext_189437->data[i_191290].line)));
							LOC29[2] = coordtostr_190396(((NI) ((NI16)(msgcontext_189437->data[i_191290].col + ((NI16) 1)))));
					...
					{
						{
							if (!((erroroutputs_189440 &(1<<((((NU8) 1))&7)))!=0)) goto LA33;
							{
								TY191293 LOC39;
								NimStringDesc* LOC40;
								NimStringDesc* LOC41;
								...
								LOC39[0] = tomsgfilename_189829(msgcontext_189437->data[i_191290]);
								LOC39[1] = coordtostr_190396(((NI) (msgcontext_189437->data[i_191290].line)));
								LOC39[2] = coordtostr_190396(((NI) ((NI16)(msgcontext_189437->data[i_191290].col + ((NI16) 1)))));
								LOC40 = 0;
							...
							LA37: ;
							{
								...
								LOC44[0] = tomsgfilename_189829(msgcontext_189437->data[i_191290]);
								LOC44[1] = coordtostr_190396(((NI) (msgcontext_189437->data[i_191290].line)));
								LOC44[2] = coordtostr_190396(((NI) ((NI16)(msgcontext_189437->data[i_191290].col + ((NI16) 1)))));
				...
				LA10: ;
				info = msgcontext_189437->data[i_191290];
				res_191609 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NOINLINE(void, raiserecoverableerror_189369)(NimStringDesc* msg) {
	Erecoverableerror188358* e_189375;
	NimStringDesc* LOC1;
	e_189375 = 0;
	e_189375 = (Erecoverableerror188358*) newObj((&NTI189376), sizeof(Erecoverableerror188358));
	(*e_189375).Sup.Sup.Sup.m_type = (&NTI188358);
	LOC1 = 0;
	LOC1 = (*e_189375).Sup.Sup.message; (*e_189375).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_189375, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_190437)(NU16 msg, NU8 eh, NimStringDesc* s_190441) {
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			LOC9 = LOC10;
			if (LOC9) goto LA12;
			LOC9 = ((gnotes_189398 &(IL64(1)<<(((((NU16) 288)- 237))&IL64(63))))!=0);
			LA12: ;
			if (!LOC9) goto LA13;
			{
				NIM_BOOL LOC17;
				...
				if (!(LOC17)) goto LA18;
				LOC17 = writelnhook_189444.ClPrc == 0;
				LA18: ;
				if (!LOC17) goto LA19;
			...
			{
				{
					...
					if (!!(writelnhook_189444.ClPrc == 0)) goto LA24;
...
appendString(s_190512, arg_190514);
					...
					writelnhook_189444.ClEnv? writelnhook_189444.ClPrc(s_190512, writelnhook_189444.ClEnv):((TMP496)(writelnhook_189444.ClPrc))(s_190512);
				}
				goto LA22;
				LA24: ;
				{
					if (!((gglobaloptions_165132 &(1<<((((NU8) 23))&31)))!=0)) goto LA32;
					{
						TY190421 LOC38;
						NimStringDesc* LOC39;
						if (!((erroroutputs_189440 &(1<<((((NU8) 0))&7)))!=0)) goto LA36;
...
appendString(LOC39, ((NimStringDesc*) &TMP495));
				...
				{
					{
						if (!((erroroutputs_189440 &(1<<((((NU8) 1))&7)))!=0)) goto LA43;
						{
							NimStringDesc* LOC49;
...
appendString(LOC52, ((NimStringDesc*) &TMP495));
	...
	LA5: ;
	{
		...
		LA56: ;
		if (!LOC55) goto LA57;
		gerrorcounter_189399 += ((NI) 1);
		gexitcode_165133 = ((NI8) 1);
		{
			if (!(gerrormax_189402 <= gerrorcounter_189399)) goto LA61;
			{
				NIM_BOOL LOC65;
				NIM_BOOL LOC66;
				LOC65 = 0;
				...
				LOC65 = LOC66;
				if (LOC65) goto LA68;
				LOC65 = ((gnotes_189398 &(IL64(1)<<(((((NU16) 288)- 237))&IL64(63))))!=0);
				LA68: ;
				if (!LOC65) goto LA69;
				{
					NIM_BOOL LOC73;
					...
					if (!(LOC73)) goto LA74;
					LOC73 = writelnhook_189444.ClPrc == 0;
					LA74: ;
					if (!LOC73) goto LA75;
					writestacktrace_20207();
				}
				...
				{
					{
						...
						if (!!(writelnhook_189444.ClPrc == 0)) goto LA80;
...
appendString(s_190869, arg_190871);
						...
						writelnhook_189444.ClEnv? writelnhook_189444.ClPrc(s_190869, writelnhook_189444.ClEnv):((TMP497)(writelnhook_189444.ClPrc))(s_190869);
					}
					goto LA78;
					LA80: ;
					{
						if (!((gglobaloptions_165132 &(1<<((((NU8) 23))&31)))!=0)) goto LA88;
						{
							TY190421 LOC94;
							NimStringDesc* LOC95;
							if (!((erroroutputs_189440 &(1<<((((NU8) 0))&7)))!=0)) goto LA92;
...
appendString(LOC95, ((NimStringDesc*) &TMP495));
					...
					{
						{
							if (!((erroroutputs_189440 &(1<<((((NU8) 1))&7)))!=0)) goto LA99;
							{
...
appendString(LOC108, ((NimStringDesc*) &TMP495));
		...
		LA61: ;
		{
			...
			if (!LOC110) goto LA112;
			{
				...
				LOC116 = ((gnotes_189398 &(IL64(1)<<(((((NU16) 288)- 237))&IL64(63))))!=0);
				LA119: ;
				if (!LOC116) goto LA120;
				{
					...
					LOC124 = writelnhook_189444.ClPrc == 0;
					LA125: ;
				...
				{
					{
						...
						if (!!(writelnhook_189444.ClPrc == 0)) goto LA131;
...
appendString(s_191060, arg_191062);
						...
						writelnhook_189444.ClEnv? writelnhook_189444.ClPrc(s_191060, writelnhook_189444.ClEnv):((TMP498)(writelnhook_189444.ClPrc))(s_191060);
					}
					goto LA129;
					LA131: ;
					{
						if (!((gglobaloptions_165132 &(1<<((((NU8) 23))&31)))!=0)) goto LA139;
						{
							...
							if (!((erroroutputs_189440 &(1<<((((NU8) 0))&7)))!=0)) goto LA143;
...
appendString(LOC146, ((NimStringDesc*) &TMP495));
					...
					{
						{
							if (!((erroroutputs_189440 &(1<<((((NU8) 1))&7)))!=0)) goto LA150;
							{
...
appendString(LOC159, ((NimStringDesc*) &TMP495));
		...
		LA112: ;
		{
			...
			raiserecoverableerror_189369(s_190441);
		}
		goto LA59;
		LA161: ;
		LA59: ;
...
{	title = 0;
	...
	case ((NU16) 237) ... ((NU16) 267):
	{
		...
		LA6: ;
		{
			if (!!(((gnotes_189398 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
	...
	case ((NU16) 268) ... ((NU16) 290):
	{
		...
		LA16: ;
		{
			if (!!(((gnotes_189398 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
	...
	s_191777 = nsuFormatOpenArray(LOC22, args, argsLen0);
	{
		...
		if (!!(LOC25)) goto LA26;
		{
			if (!!((kind == NIM_NIL))) goto LA30;
			{
				...
				if (!!(writelnhook_189444.ClPrc == 0)) goto LA34;
...
appendString(s_191795, arg_191797);
				...
				writelnhook_189444.ClEnv? writelnhook_189444.ClPrc(s_191795, writelnhook_189444.ClEnv):((TMP492)(writelnhook_189444.ClPrc))(s_191795);
			}
			goto LA32;
			LA34: ;
			{
				...
				{
					TY191293 LOC47;
					if (!((erroroutputs_189440 &(1<<((((NU8) 0))&7)))!=0)) goto LA45;
			...
			{
				{
					if (!((erroroutputs_189440 &(1<<((((NU8) 1))&7)))!=0)) goto LA51;
					{
						NimStringDesc* LOC57;
		...
		{
			{
				...
				if (!!(writelnhook_189444.ClPrc == 0)) goto LA63;
...
appendString(s_192217, arg_192219);
				...
				writelnhook_189444.ClEnv? writelnhook_189444.ClPrc(s_192217, writelnhook_189444.ClEnv):((TMP493)(writelnhook_189444.ClPrc))(s_192217);
			}
			goto LA61;
			LA63: ;
			{
				...
				{
					TY191306 LOC76;
					if (!((erroroutputs_189440 &(1<<((((NU8) 0))&7)))!=0)) goto LA74;
			...
			{
				{
					if (!((erroroutputs_189440 &(1<<((((NU8) 1))&7)))!=0)) goto LA80;
					{
...
N_NIMCALL(void, msgwriteln_189915)(NimStringDesc* s, NU8 flags) {
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = !(writelnhook_189444.ClPrc == 0);
		if (!(LOC3)) goto LA4;
		LOC3 = !(((flags &(1<<((((NU8) 1))&7)))!=0));
		LA4: ;
		if (!LOC3) goto LA5;
		writelnhook_189444.ClEnv? writelnhook_189444.ClPrc(s, writelnhook_189444.ClEnv):((TMP1047)(writelnhook_189444.ClPrc))(s);
	}
	goto LA1;
	LA5: ;
	{
		...
		{
			TY190421 LOC16;
			if (!((erroroutputs_189440 &(1<<((((NU8) 0))&7)))!=0)) goto LA14;
	...
	LA10: ;
	{
		{
			TY190421 LOC22;
			if (!((erroroutputs_189440 &(1<<((((NU8) 1))&7)))!=0)) goto LA20;
		...
		if (TMP1049.status == 0) {
			{
				...
				line_194269 = 0;
				HEX3Atmp_194614 = 0;
				HEX3Atmp_194614 = tofullpath_189665(i.fileindex);
...
N_NIMCALL(void, limessage_192706)(Tlineinfo188352 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 237) ... ((NU16) 267):
	{
		...
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_189398 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 268) ... ((NU16) 290):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_189398 &(IL64(1)<<(((((NU16) (msg))- 237))&IL64(63))))!=0));
		LA11: ;
		ignoremsg = LOC10;
		title = copyString(((NimStringDesc*) &TMP468));
		color = ((NU8) 32);
	...
	s_192813 = getmessagestr_190416(msg, arg);
	{
		...
		if (!LOC15) goto LA18;
		{
			if (!!((kind == NIM_NIL))) goto LA22;
			{
				...
				if (!!(writelnhook_189444.ClPrc == 0)) goto LA26;
...
appendString(s_192832, arg_192834);
				...
				writelnhook_189444.ClEnv? writelnhook_189444.ClPrc(s_192832, writelnhook_189444.ClEnv):((TMP1045)(writelnhook_189444.ClPrc))(s_192832);
			}
			goto LA24;
			LA26: ;
			{
				...
				{
					TY192829 LOC39;
					if (!((erroroutputs_189440 &(1<<((((NU8) 0))&7)))!=0)) goto LA37;
					memset((void*)LOC39, 0, sizeof(LOC39));
		...
		{
			{
				...
				if (!!(writelnhook_189444.ClPrc == 0)) goto LA55;
...
appendString(s_193418, arg_193420);
				...
				writelnhook_189444.ClEnv? writelnhook_189444.ClPrc(s_193418, writelnhook_189444.ClEnv):((TMP1046)(writelnhook_189444.ClPrc))(s_193418);
			}
			goto LA53;
			LA55: ;
			{
				...
				{
					TY191293 LOC68;
					if (!((erroroutputs_189440 &(1<<((((NU8) 0))&7)))!=0)) goto LA66;
					memset((void*)LOC68, 0, sizeof(LOC68));
			...
			{
				{
					if (!((erroroutputs_189440 &(1<<((((NU8) 1))&7)))!=0)) goto LA72;
					{
		...
		LA20: ;
		{
			...
			if (!(LOC82)) goto LA84;
			LOC82 = ((gnotes_189398 &(IL64(1)<<(((((NU16) 287)- 237))&IL64(63))))!=0);
			LA84: ;
			if (!LOC82) goto LA85;
	...
	msgwriteln_189915(((NimStringDesc*) &TMP1899), 0);
	{
		...
		res_194857 = ((NI) 237);
		{
			while (1) {
				...
				{
					if (!((gnotes_189398 &(IL64(1)<<(((((NU16) (warn_194823))- 237))&IL64(63))))!=0)) goto LA7;
	...
	msgwriteln_189915(((NimStringDesc*) &TMP1961), 0);
	{
		...
		res_194921 = ((NI) 268);
		{
			while (1) {
				...
				memset((void*)LOC4, 0, sizeof(LOC4));
				{
					if (!((gnotes_189398 &(IL64(1)<<(((((NU16) (hint_194887))- 237))&IL64(63))))!=0)) goto LA7;
					LOC4[0] = copyString(((NimStringDesc*) &TMP1901));
				}
				goto LA5;
				LA7: ;
...
N_NIMCALL(void, suggestwriteln_189453)(NimStringDesc* s) {
	{
		if (!((erroroutputs_189440 &(1<<((((NU8) 0))&7)))!=0)) goto LA3;
		{
			TY190421 LOC9;
			if (!writelnhook_189444.ClPrc == 0) goto LA7;
		...
		LA7: ;
		{
			writelnhook_189444.ClEnv? writelnhook_189444.ClPrc(s, writelnhook_189444.ClEnv):((TMP2063)(writelnhook_189444.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, pushinfocontext_189581)(Tlineinfo188352 info) {
	msgcontext_189437 = (TY189420*) incrSeqV2(&(msgcontext_189437)->Sup, sizeof(Tlineinfo188352));
	msgcontext_189437->data[msgcontext_189437->Sup.len] = info;
	++msgcontext_189437->Sup.len;
}

N_NIMCALL(void, popinfocontext_189600)(void) {
	msgcontext_189437 = (TY189420*) setLengthSeq(&(msgcontext_189437)->Sup, sizeof(Tlineinfo188352), ((NI) ((NI)((msgcontext_189437 ? msgcontext_189437->Sup.len : 0) - ((NI) 1)))));
}
N_NIMCALL(void, TMP2773)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_189509)(void) {
	Esuggestdone188360* e_189514;
	NimStringDesc* LOC1;
	e_189514 = 0;
	e_189514 = (Esuggestdone188360*) newObj((&NTI189515), sizeof(Esuggestdone188360));
	(*e_189514).Sup.Sup.m_type = (&NTI188360);
	LOC1 = 0;
	LOC1 = (*e_189514).Sup.message; (*e_189514).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2774));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_189514, "ESuggestDone");
}
...
N_NIMCALL(Tlineinfo188352, getinfocontext_189626)(NI index) {
	...
	NI i;
	memset((void*)(&result), 0, sizeof(result));
	L = (msgcontext_189437 ? msgcontext_189437->Sup.len : 0);
	{
	...
	LA1: ;
	{
		...
		result = unknownlineinfo_189411();
	}
	goto LA6;
	LA8: ;
	{
		result = msgcontext_189437->data[i];
	}
	LA6: ;
	return result;
}
...
N_NIMCALL(NI, getinfocontextlen_189545)(void) {
	NI result;
{	result = 0;
	result = (msgcontext_189437 ? msgcontext_189437->Sup.len : 0);
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setinfocontextlen_189562)(NI L) {
	msgcontext_189437 = (TY189420*) setLengthSeq(&(msgcontext_189437)->Sup, sizeof(Tlineinfo188352), ((NI) (L)));
}
...
NIM_EXTERNC N_NOINLINE(void, compiler_msgsInit000)(void) {
	...
	++fileinfos_188632->Sup.len;
	gcmdlineinfo_189322 = newlineinfo_189267(((NI32) 0), ((NI) 1), ((NI) 1));
	memset((void*)(&LOC2), 0, sizeof(LOC2));
	...
	++fileinfos_188632->Sup.len;
	gcodegenlineinfo_189361 = newlineinfo_189267(((NI32) 1), ((NI) 1), ((NI) 1));
	gnotes_189398 = 0;
	LOC3 = 0;
	for (LOC3 = (((NU16) 237)- 237); LOC3 <= (((NU16) 255)- 237); LOC3++) 
gnotes_189398 |=((NU64)(1)<<((LOC3)%(sizeof(NU64)*8)));
	gnotes_189398 |=((NU64)(1)<<(((((NU16) 257)- 237))%(sizeof(NU64)*8)));
	gnotes_189398 |=((NU64)(1)<<(((((NU16) 261)- 237))%(sizeof(NU64)*8)));
	LOC4 = 0;
	for (LOC4 = (((NU16) 263)- 237); LOC4 <= (((NU16) 276)- 237); LOC4++) 
gnotes_189398 |=((NU64)(1)<<((LOC4)%(sizeof(NU64)*8)));
	LOC5 = 0;
	for (LOC5 = (((NU16) 281)- 237); LOC5 <= (((NU16) 283)- 237); LOC5++) 
gnotes_189398 |=((NU64)(1)<<((LOC5)%(sizeof(NU64)*8)));
	gnotes_189398 |=((NU64)(1)<<(((((NU16) 285)- 237))%(sizeof(NU64)*8)));
	gnotes_189398 |=((NU64)(1)<<(((((NU16) 290)- 237))%(sizeof(NU64)*8)));
	gerrorcounter_189399 = ((NI) 0);
	ghintcounter_189400 = ((NI) 0);
	gwarncounter_189401 = ((NI) 0);
	gerrormax_189402 = ((NI) 1);
	if (msgcontext_189437) nimGCunrefNoCycle(msgcontext_189437);
	msgcontext_189437 = (TY189420*) newSeqRC1((&NTI189420), 0);
	lasterror_189438 = unknownlineinfo_189411();
	erroroutputs_189440 = 3;
...
NTI189420.size = sizeof(TY189420*);
NTI189420.kind = 24;
NTI189420.base = (&NTI188352);
NTI189420.flags = 2;
NTI189420.marker = TMP152;
NTI188358.size = sizeof(Erecoverableerror188358);
NTI188358.kind = 17;
NTI188358.base = (&NTI4049);
TMP19[11].len = 0; TMP19[11].kind = 2;
NTI188358.node = &TMP19[11];
NTI189376.size = sizeof(Erecoverableerror188358*);
NTI189376.kind = 22;
NTI189376.base = (&NTI188358);
NTI189376.marker = TMP499;
...
NTI189515.size = sizeof(Esuggestdone188360*);
NTI189515.kind = 22;
NTI189515.base = (&NTI188360);
NTI189515.marker = TMP2773;
}
