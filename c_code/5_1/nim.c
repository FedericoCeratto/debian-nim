...
STRING_LITERAL(TMP4891, "js", 2);
STRING_LITERAL(TMP4892, "node ", 5);
...
appendString(LOC7, ((NimStringDesc*) &TMP4890));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
			...
			if (!(gerrorcounter_196306 == 0)) goto LA25;
			{
				if (!((gglobaloptions_169118 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					LA37: ;
					{
						...
						NimStringDesc* LOC43;
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP4891));
						LOC42 = 0;
...
appendString(LOC44, ((NimStringDesc*) &TMP4892));
