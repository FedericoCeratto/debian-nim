...
N_NIMCALL(void, tmtotimeinfo_111446_2726502234)(struct tm* tm0, NIM_BOOL local0, Timeinfo110604* Result) {
	...
	LA4: ;
	{
		LOC1.tzname = copyString(((NimStringDesc*) &TMP3566));
	}
	LA2: ;
	{
		if (!local0) goto LA16;
...
static TNimNode* TMP3559[11];
static TNimNode* TMP3560[12];
NI TMP3562;
static char* NIM_CONST TMP3561[12] = {
"mJan", 
"mFeb", 
"mMar", 
"mApr", 
...
"mNov", 
"mDec"};
static TNimNode* TMP3563[7];
NI TMP3565;
static char* NIM_CONST TMP3564[7] = {
"dMon", 
"dTue", 
"dWed", 
"dThu", 
...
NTI110203.base = 0;
NTI110203.flags = 3;
for (TMP3562 = 0; TMP3562 < 12; TMP3562++) {
TMP19[TMP3562+6].kind = 1;
TMP19[TMP3562+6].offset = TMP3562;
TMP19[TMP3562+6].name = TMP3561[TMP3562];
TMP3560[TMP3562] = &TMP19[TMP3562+6];
}
TMP19[18].len = 12; TMP19[18].kind = 2; TMP19[18].sons = &TMP3560[0];
...
NTI110205.base = 0;
NTI110205.flags = 3;
for (TMP3565 = 0; TMP3565 < 7; TMP3565++) {
TMP19[TMP3565+21].kind = 1;
TMP19[TMP3565+21].offset = TMP3565;
TMP19[TMP3565+21].name = TMP3564[TMP3565];
TMP3563[TMP3565] = &TMP19[TMP3565+21];
}
TMP19[28].len = 7; TMP19[28].kind = 2; TMP19[28].sons = &TMP3563[0];
...
TMP19[0].len = 11; TMP19[0].kind = 2; TMP19[0].sons = &TMP3559[0];
