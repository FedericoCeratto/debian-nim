...
STRING_LITERAL(TMP1820, "", 0);
static NIM_CONST char136Set TMP1821 = {
0x00, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST char136Set TMP1822 = {
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST char136Set TMP1831 = {
...
N_NIMCALL(NimStringDesc*, quote_251287_4065315820)(NimStringDesc* s0) {
	...
	result0 = (NimStringDesc*)0;
	{
		...
		LOC3 = (NIM_BOOL)0;
		LOC4 = (NI)0;
		LOC4 = nsuFindCharSet(s0, TMP1821, ((NI) 0));
		LOC3 = (((NI) 0) <= LOC4);
		if (!(LOC3)) goto LA5;
		...
		if (!LOC3) goto LA6;
		{
			...
			i0 = parseword_251218_4065315820(s0, ((NI) 0), (&result0), TMP1822);
			{
...
N_NIMCALL(void, initoptparser_251325_4065315820)(NimStringDesc* cmdline0, Optparser251205* Result) {
	...
	LA3: ;
	{
		unsureAsgnRef((void**) (&(*Result).cmd), copyString(((NimStringDesc*) &TMP1820)));
		{
			...
			HEX3Atmp_251343_4065315820 = paramcount_137826_2125978480();
			res_251346_4065315820 = ((NI) 1);
			{
				while (1) {
					...
					LOC9 = paramstr_137807_2125978480(i_251340_4065315820);
...
appendString((*Result).cmd, LOC10);
	...
	unsureAsgnRef((void**) (&(*Result).key), copyString(((NimStringDesc*) &TMP1825)));
	unsureAsgnRef((void**) (&(*Result).val), copyString(((NimStringDesc*) &TMP1825)));
}
...
N_NIMCALL(void, handleshortoption_251401_4065315820)(Optparser251205* p0) {
	...
	}
	{
		...
		i0 = parseword_251218_4065315820((*p0).cmd, i0, (&(*p0).val), TMP1826);
	}
	LA5: ;
	{
...
{	i0 = (*p0).pos;
	...
	case 45:
	{
		i0 += ((NI) 1);
		{
			...
			i0 += ((NI) 1);
			i0 = parseword_251218_4065315820((*p0).cmd, i0, (&(*p0).key), TMP1822);
			{
				while (1) {
			...
			}
			{
				...
				(*p0).pos = parseword_251218_4065315820((*p0).cmd, i0, (&(*p0).val), TMP1826);
			}
			goto LA15;
			LA17: ;
			{
	...
	default:
	{
		...
		(*p0).pos = parseword_251218_4065315820((*p0).cmd, i0, (&(*p0).key), TMP1826);
	}
	break;
	}
	}BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(Optparser251205* p0) {
	...
	result0 = nsuStrip(LOC1, NIM_TRUE, NIM_TRUE, TMP1831);
	return result0;
}
...
static TNimNode* TMP1816[6];
static TNimNode* TMP1817[4];
NI TMP1819;
static char* NIM_CONST TMP1818[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongOption", 
"cmdShortOption"};
...
NTI251203.base = 0;
NTI251203.flags = 3;
for (TMP1819 = 0; TMP1819 < 4; TMP1819++) {
TMP859[TMP1819+5].kind = 1;
TMP859[TMP1819+5].offset = TMP1819;
TMP859[TMP1819+5].name = TMP1818[TMP1819];
TMP1817[TMP1819] = &TMP859[TMP1819+5];
}
TMP859[9].len = 4; TMP859[9].kind = 2; TMP859[9].sons = &TMP1817[0];
...
TMP859[11].name = "val";
TMP859[0].len = 6; TMP859[0].kind = 2; TMP859[0].sons = &TMP1816[0];
