...
N_NIMCALL(Tnode191813*, maptypetoast_381080)(Ttype191849* t, Tlineinfo164338 info, NIM_BOOL allowrecursion);
N_NIMCALL(Tnode191813*, atomictypex_381066)(NimStringDesc* name, Ttype191849* t, Tlineinfo164338 info);
...
N_NIMCALL(Tnode191813*, maptypetobracket_381088)(NimStringDesc* name, Ttype191849* t, Tlineinfo164338 info);
		...
		res_381133 = ((NI) 0);
		{
			while (1) {
				...
				i_381113 = res_381133;
				{
					...
					void_381126 = atomictypex_381066(((NimStringDesc*) &TMP2842), t, info);
...
N_NIMCALL(Tnode191813*, maptypetoast_381080)(Ttype191849* t, Tlineinfo164338 info, NIM_BOOL allowrecursion) {
	...
	case ((NU8) 0):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2832), t, info);
	}
	break;
	case ((NU8) 1):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2833), t, info);
	}
	break;
	case ((NU8) 2):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2834), t, info);
	}
	break;
	case ((NU8) 5):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2835), t, info);
	}
	break;
	case ((NU8) 6):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2836), t, info);
	}
	break;
	case ((NU8) 7):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2837), t, info);
	}
	break;
	case ((NU8) 3):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2838), t, info);
	}
	break;
	case ((NU8) 4):
	case ((NU8) 16):
	{
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		LOC9 = 0;
		LOC9 = atomictypex_381066(((NimStringDesc*) &TMP2839), t, info);
	...
	{
		{
			...
			result = newnodeit_193807(((NU8) 42), info, t);
			LOC18 = 0;
			LOC18 = atomictypex_381066(((NimStringDesc*) &TMP2840), t, info);
		...
		LA16: ;
		{
			result = atomictypex_381066(((NimStringDesc*) &TMP2841), t, info);
		}
		LA13: ;
	}
	break;
	...
	{
		{
			...
			result = maptypetobracket_381088(((NimStringDesc*) &TMP2843), t, info);
		}
		goto LA31;
		LA33: ;
		{
	...
	case ((NU8) 18):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2844), t, info);
	}
	break;
	case ((NU8) 19):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2845), t, info);
	}
	break;
	case ((NU8) 21):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2846), t, info);
	}
	break;
	case ((NU8) 22):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2847), t, info);
	}
	break;
	case ((NU8) 23):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2848), t, info);
	}
	break;
	case ((NU8) 24):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2849), t, info);
	}
	break;
	case ((NU8) 25):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2850), t, info);
	}
	break;
	case ((NU8) 27):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2851), t, info);
	}
	break;
	case ((NU8) 20):
	{
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		LOC61 = 0;
		LOC61 = atomictypex_381066(((NimStringDesc*) &TMP2852), t, info);
	...
	case ((NU8) 26):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2853), t, info);
	}
	break;
	case ((NU8) 28):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2854), t, info);
	}
	break;
	case ((NU8) 29):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2855), t, info);
	}
	break;
	case ((NU8) 31):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2856), t, info);
	}
	break;
	case ((NU8) 32):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2857), t, info);
	}
	break;
	case ((NU8) 33):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2858), t, info);
	}
	break;
	case ((NU8) 34):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2859), t, info);
	}
	break;
	case ((NU8) 35):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2860), t, info);
	}
	break;
	case ((NU8) 36):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2861), t, info);
	}
	break;
	case ((NU8) 37):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2862), t, info);
	}
	break;
	case ((NU8) 38):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2863), t, info);
	}
	break;
	case ((NU8) 39):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2864), t, info);
	}
	break;
	case ((NU8) 40):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2865), t, info);
	}
	break;
	case ((NU8) 41):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2866), t, info);
	}
	break;
	case ((NU8) 42):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2867), t, info);
	}
	break;
	case ((NU8) 43):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2868), t, info);
	}
	break;
	case ((NU8) 44):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2869), t, info);
	}
	break;
	case ((NU8) 45):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2870), t, info);
	}
	break;
	case ((NU8) 46):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2871), t, info);
	}
	break;
	case ((NU8) 47):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2872), t, info);
	}
	break;
	case ((NU8) 48):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2873), t, info);
	}
	break;
	case ((NU8) 49):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2874), t, info);
	}
	break;
	case ((NU8) 50):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2875), t, info);
	}
	break;
	case ((NU8) 51):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2876), t, info);
	}
	break;
	case ((NU8) 52):
	{
		Tnode191813* LOC89;
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2877), t, info);
		LOC89 = 0;
	...
	case ((NU8) 54):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2878), t, info);
	}
	break;
	case ((NU8) 55):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2879), t, info);
	}
	break;
	case ((NU8) 56):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2880), t, info);
	}
	break;
	case ((NU8) 57):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2881), t, info);
	}
	break;
	case ((NU8) 58):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2882), t, info);
	}
	break;
	case ((NU8) 59):
	case ((NU8) 60):
	case ((NU8) 61):
	{
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		LOC96 = 0;
		LOC96 = atomictypex_381066(((NimStringDesc*) &TMP2883), t, info);
...
N_NIMCALL(NimStringDesc*, opslurp_381040)(NimStringDesc* file, Tlineinfo164338 info, Tsym191843* module) {
	...
	if (TMP2886.status == 0) {
		...
		if (isObj(getCurrentException()->Sup.m_type, (&NTI3431))) {
			TMP2886.status = 0;
			localerror_166155(info, ((NU16) 3), file);
