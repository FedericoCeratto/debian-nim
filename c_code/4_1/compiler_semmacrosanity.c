...
STRING_LITERAL(TMP3431, "ithField", 8);
STRING_LITERAL(TMP3432, "ithField(record case branch)", 28);
STRING_LITERAL(TMP3433, "invalid field at index ", 23);
STRING_LITERAL(TMP3435, "compiler/semmacrosanity.nim", 27);
NIM_CONST TY90959 TMP3434 = {((NimStringDesc*) &TMP3435),
((NI) 47)}
;
STRING_LITERAL(TMP3436, "() must have a tuple type", 25);
STRING_LITERAL(TMP3437, "[] must have some form of array type", 36);
STRING_LITERAL(TMP3438, "{} must have the set type", 25);
STRING_LITERAL(TMP3439, "float literal must have some float type", 39);
STRING_LITERAL(TMP3440, "integer literal must have some int type", 39);
STRING_LITERAL(TMP3441, "string literal must be of some string type", 42);
STRING_LITERAL(TMP3442, "nil literal must be of some pointer type", 40);
	...
	{
		{
			...
			internalerror_195172((*n).info, ((NimStringDesc*) &TMP3431));
		}
		LA13: ;
...
appendString(LOC32, ((NimStringDesc*) &TMP3433));
appendString(LOC32, LOC33);
		...
		LA38: ;
		{
			globalerror_195118((*n).info, ((NimStringDesc*) &TMP3436));
		}
		LA19: ;
	}
	break;
