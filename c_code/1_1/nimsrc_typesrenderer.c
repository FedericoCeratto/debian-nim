...
N_NIMCALL(void, renderparamtypes_340275)(TY123008** found, Tnode191813* n);
...
STRING_LITERAL(TMP4798, "", 0);
STRING_LITERAL(TMP4799, "*", 1);
STRING_LITERAL(TMP4800, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP4807, "ref.", 4);
STRING_LITERAL(TMP4808, "ptr.", 4);
STRING_LITERAL(TMP4809, "proc(", 5);
STRING_LITERAL(TMP4810, "tuple[", 6);
STRING_LITERAL(TMP4811, "renderParamTypes(found,n) with ", 31);
...
{	result = 0;
	result = copyString(((NimStringDesc*) &TMP4798));
	switch ((*n).kind) {
	case ((NU8) 31):
	{
		{
	...
	{
		{
			if (!!(eqStrings((*(*n).kindU.S5.ident).s, ((NimStringDesc*) &TMP4799)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP4800));
...
appendString(LOC10, ((NimStringDesc*) &TMP4808));
...
appendString(LOC31, ((NimStringDesc*) &TMP4811));
