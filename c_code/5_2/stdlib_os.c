...
STRING_LITERAL(TMP1075, "/proc/", 6);
STRING_LITERAL(TMP1076, "/file", 5);
STRING_LITERAL(TMP1078, "invalid index", 13);
STRING_LITERAL(TMP1079, "PATH", 4);
STRING_LITERAL(TMP1683, "HOME", 4);
STRING_LITERAL(TMP1684, "/", 1);
STRING_LITERAL(TMP1912, "/.config/", 9);
...
N_NIMCALL(NimStringDesc*, paramstr_123609)(NI i) {
	...
	LOC7 = 0;
	LOC7 = (*e_123616).Sup.message; (*e_123616).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1078));
...
N_NIMCALL(NimStringDesc*, getapplheuristic_124204)(void) {
	...
	result = paramstr_123609(0);
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			p_124403 = 0;
			HEX3Atmp_124410 = 0;
			HEX3Atmp_124410 = getenv_120442(((NimStringDesc*) &TMP1079));
			last_124415 = 0;
			{
				while (1) {
					NI first_124417;
...
appendString(LOC1, ((NimStringDesc*) &TMP1075));
appendString(LOC1, LOC3);
appendString(LOC1, ((NimStringDesc*) &TMP1076));
	result = getapplaux_124004(LOC1);
	{
...
N_NIMCALL(NimStringDesc*, nosgetHomeDir)(void) {
	...
	LOC1 = 0;
	LOC2 = 0;
	LOC2 = getenv_120442(((NimStringDesc*) &TMP1683));
...
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1912));
	result = LOC1;
	goto BeforeRet;
	BeforeRet: ;
	return result;
...
N_NOINLINE(void, nosraiseOSError)(NimStringDesc* msg) {
	{
		...
		LA7: ;
		{
			NimStringDesc* LOC11;
			LOC11 = 0;
			LOC11 = (*e_114417).Sup.Sup.message; (*e_114417).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1074));
