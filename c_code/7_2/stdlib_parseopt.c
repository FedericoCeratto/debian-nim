...
N_NIMCALL(NimStringDesc*, quote_251287_4065315820)(NimStringDesc* s0) {
	...
	result0 = (NimStringDesc*)0;
	{
		...
		if (!LOC3) goto LA6;
		{
			...
			i0 = parseword_251218_4065315820(s0, ((NI) 0), (&result0), TMP1825);
			{
...
N_NIMCALL(void, handleshortoption_251401_4065315820)(Optparser251205* p0) {
	...
	}
	{
		...
		i0 = parseword_251218_4065315820((*p0).cmd, i0, (&(*p0).val), TMP1827);
	}
	LA5: ;
	{
...
{	i0 = (*p0).pos;
	...
	case 45:
	{
		i0 += ((NI) 1);
		{
			...
			i0 += ((NI) 1);
			i0 = parseword_251218_4065315820((*p0).cmd, i0, (&(*p0).key), TMP1825);
			{
				while (1) {
			...
			}
			{
				...
				(*p0).pos = parseword_251218_4065315820((*p0).cmd, i0, (&(*p0).val), TMP1827);
			}
			goto LA15;
			LA17: ;
			{
	...
	default:
	{
		...
		(*p0).pos = parseword_251218_4065315820((*p0).cmd, i0, (&(*p0).key), TMP1827);
	}
	break;
	}
	}BeforeRet: ;
...
TMP859[TMP1822+5].kind = 1;
TMP859[TMP1822+5].offset = TMP1822;
TMP859[TMP1822+5].name = TMP1821[TMP1822];
TMP1820[TMP1822] = &TMP859[TMP1822+5];
}
TMP859[9].len = 4; TMP859[9].kind = 2; TMP859[9].sons = &TMP1820[0];
...
TMP859[11].name = "val";
TMP859[0].len = 6; TMP859[0].kind = 2; TMP859[0].sons = &TMP1819[0];
