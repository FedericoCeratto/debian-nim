...
STRING_LITERAL(TMP1042, "stdlib", 6);
STRING_LITERAL(TMP1043, "system", 6);
STRING_LITERAL(TMP1044, "locals", 6);
...
N_NIMCALL(Tnode225809*, semlocals_455020)(Tcontext280023* c, Tnode225809* n) {
	...
	result = 0;
	counter = ((NI) 0);
	tupletype = newtypes_280220(((NU8) 18), c);
					...
					s_455099 = inittabiter_233124((&it_455097), HEX3Atmp_455094);
					{
						while (1) {
							...
							it_455039 = s_455099;
							{
								...
								if (!LOC13) goto LA16;
								LOC18 = 0;
								LOC18 = getcurrowner_280257();
								field = newsym_226655(((NU8) 19), (*it_455039).name, LOC18, (*n).info);
								...
								addsonskipintlit_274731(tupletype, (*field).typ);
...
NIM_EXTERNC N_NOINLINE(void, compiler_localsInit000)(void) {
	registerplugin_454124(((NimStringDesc*) &TMP1042), ((NimStringDesc*) &TMP1043), ((NimStringDesc*) &TMP1044), semlocals_455020);
}
