...
N_NIMCALL(void, send_192807)(tsocketimpl182607* socket, NimStringDesc* data) {
	NI sent;
	{
		...
		e_192813 = 0;
		e_192813 = (valueerror3249*) newObj((&NTI21601), sizeof(valueerror3249));
		(*e_192813).Sup.Sup.m_type = (&NTI3249);
		LOC5 = 0;
		LOC5 = (*e_192813).Sup.message; (*e_192813).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1978));
...
appendString(LOC22, ((NimStringDesc*) &TMP4866));
		...
		selret = select_190101((&s), (NI64)(timeout - ((NI) (((NF)((*waited)) * (NF)(1.0000000000000000e+03))))));
		{
			NI32 LOC28;
...
N_NIMCALL(void, readline_191447)(tsocketimpl182607* socket, NimStringDesc** line, NI timeout) {
	...
	(*line) = setLengthStr((*line), 0);
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_190617(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4868));
			...
			LA4: ;
			{
				...
				LOC15 = 0;
				LOC15 = waitfor_190617(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4868));
