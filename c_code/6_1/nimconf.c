...
N_NIMCALL(void, parseassignment_220485)(tlexer215190* l, ttoken215186* tok) {
	...
	NimStringDesc* val;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = getident_200472(((NimStringDesc*) &TMP1903));
		LOC3 = ((*(*tok).Ident).Sup.Id == (*LOC4).Sup.Id);
		if (LOC3) goto LA5;
		LOC6 = 0;
		LOC6 = getident_200472(((NimStringDesc*) &TMP1904));
...
appendString(val, LOC16);
		...
		LA19: ;
		{
			lexmessage_215289((&(*l)), ((NU16) 23), ((NimStringDesc*) &TMP1906));
		}
		LA17: ;
		val = addChar(val, 93);
	}
...
appendString(val, LOC30);
		conftok_220412(l, tok);
		{
			while (1) {
				...
				if (!(LOC33)) goto LA34;
				LOC35 = 0;
				LOC35 = getident_200472(((NimStringDesc*) &TMP1907));
...
N_NIMCALL(void, loadconfigs_220811)(NimStringDesc* cfg) {
	NimStringDesc* pd;
	{
		...
		prefix = getprefixdir_169381();
		{
			...
			LOC9 = 0;
			LOC9 = libpath_169233; libpath_169233 = copyStringRC1(((NimStringDesc*) &TMP1891));
		...
		LA7: ;
		{
			...
			LOC13 = 0;
			LOC13 = libpath_169233; libpath_169233 = copyStringRC1(((NimStringDesc*) &TMP1893));
			if (LOC13) nimGCunrefNoCycle(LOC13);
		}
		goto LA5;
		LA11: ;
		{
			asgnRefNoCycle((void**) (&libpath_169233), nosjoinPath(prefix, ((NimStringDesc*) &TMP1894)));
		}
		LA5: ;
	}
	LA3: ;
	...
	LA32: ;
	{
		...
		readconfigfile_220573(LOC74);
		{
			...
			projectconfig = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP1912));
			{
				NIM_BOOL LOC81;
				LOC81 = 0;
			...
			LA82: ;
			{
				NimStringDesc* LOC85;
				LOC85 = 0;
				LOC85 = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP1913));
