...
N_NIMCALL(void, readkey_457466)(Tbaselexer179024* L, NimStringDesc** result) {
	...
	}
	{
		...
		internalerror_165218(((NimStringDesc*) &TMP4193));
	}
	LA5: ;
...
N_NIMCALL(void, readtypecache_457524)(Tbaselexer179024* L, Tidtable190861* result) {
	{
		...
		internalerror_165218(((NimStringDesc*) &TMP4200));
	}
	LA3: ;
	(*L).bufpos += ((NI) 1);
	{
...
appendString(r, tnl_159626);
			...
			case 0:
			{
				internalerror_165218(((NimStringDesc*) &TMP4270));
				goto LA1;
			}
			break;
			default:
...
appendString(LOC34, k);
			...
			LA18: ;
			{
				internalerror_165218(((NimStringDesc*) &TMP4294));
			}
			LA11: ;
		}
	} LA5: ;
