...
N_NIMCALL(NIM_BOOL, HEX3CHEX2E_206071)(NimStringDesc* a, NimStringDesc* b) {
	...
	result = 0;
	{
		if (!eqStrings(a, ((NimStringDesc*) &TMP1690))) goto LA3;
		result = NIM_FALSE;
		goto BeforeRet;
	}
	LA3: ;
...
N_NIMCALL(void, addpackage_206148)(stringtableobj131012* packages, NimStringDesc* p) {
	...
	LA3: ;
	{
		nstPut(packages, name, ((NimStringDesc*) &TMP1690));
	}
	LA1: ;
}
			...
			if (!!((d_206326 == NIM_NIL))) goto LA8;
			{
				while (1) {
					...
					y_206330 = cstrToNimstr(((NCSTRING) ((*x_206328).d_name)));
					{
						...
						NU8 k_206334;
						LOC18 = 0;
						LOC18 = !(eqStrings(y_206330, ((NimStringDesc*) &TMP1688)));
						if (!(LOC18)) goto LA19;
						LOC18 = !(eqStrings(y_206330, ((NimStringDesc*) &TMP1689)));
						LA19: ;
						if (!LOC18) goto LA20;
						memset((void*)(&s_206332), 0, sizeof(s_206332));
						y_206330 = HEX2F_117299(dir, y_206330);
						{
							int LOC24;
							LOC24 = 0;
				...
				res_206348 = 0;
				{
					while (1) {
						...
						h_206344 = res_206348;
						{
							...
							{
								if (!eqStrings(val_206342, ((NimStringDesc*) &TMP1690))) goto LA55;
