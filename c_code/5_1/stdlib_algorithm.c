...
typedef N_CLOSURE_PTR(NI, TMP2921) (Tsym264826* x_396105_3792311747, Tsym264826* y_396107_3792311747);
typedef N_CLOSURE_PTR(NI, TMP2922) (Tsym264826* x_396105_3792311747, Tsym264826* y_396107_3792311747);
...
typedef N_CLOSURE_PTR(NI, TMP5449) (NimStringDesc* x_356530_3792311747, NimStringDesc* y_356532_3792311747);
typedef N_CLOSURE_PTR(NI, TMP5450) (NimStringDesc* x_356530_3792311747, NimStringDesc* y_356532_3792311747);
typedef struct {
...
typedef N_CLOSURE_PTR(NI, TMP5453) (Indexentry353126 x_354630_3792311747, Indexentry353126 y_354632_3792311747);
typedef N_CLOSURE_PTR(NI, TMP5454) (Indexentry353126 x_354630_3792311747, Indexentry353126 y_354632_3792311747);
struct  TNimObject  {
TNimType* m_type;
};
struct  Tidobj194006  {
...
{	{
		...
		NI LOC4;
		LOC3 = (NI)0;
		LOC3 = cmp0.ClEnv? cmp0.ClPrc(a0[m0], a0[(NI)(m0 + ((NI) 1))], cmp0.ClEnv):((TMP2921)(cmp0.ClPrc))(a0[m0], a0[(NI)(m0 + ((NI) 1))]);
		LOC4 = (NI)0;
	...
	k0 = lo0;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = (NI)0;
				LOC15 = cmp0.ClEnv? cmp0.ClPrc(b0[i0], a0[j0], cmp0.ClEnv):((TMP2922)(cmp0.ClPrc))(b0[i0], a0[j0]);
				LOC16 = (NI)0;
...
{	{
		...
		NI LOC4;
		LOC3 = (NI)0;
		LOC3 = cmp0.ClEnv? cmp0.ClPrc(a0[m0], a0[(NI)(m0 + ((NI) 1))], cmp0.ClEnv):((TMP5453)(cmp0.ClPrc))(a0[m0], a0[(NI)(m0 + ((NI) 1))]);
		LOC4 = (NI)0;
		LOC4 = HEX2A_351008_3792311747(LOC3, order0);
		if (!(LOC4 <= ((NI) 0))) goto LA5;
		goto BeforeRet;
	...
	k0 = lo0;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = (NI)0;
				LOC15 = cmp0.ClEnv? cmp0.ClPrc(b0[i0], a0[j0], cmp0.ClEnv):((TMP5454)(cmp0.ClPrc))(b0[i0], a0[j0]);
				LOC16 = (NI)0;
				LOC16 = HEX2A_351008_3792311747(LOC15, order0);
				if (!(LOC16 <= ((NI) 0))) goto LA17;
