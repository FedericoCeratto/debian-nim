...
N_NIMCALL(void, loadfile_315031_3901077974)(Tlineinfo185336 info0) {
	...
	LA3: ;
	{
		...
		path0 = tofullpath_186273_155036129(info0.fileindex);
		...
		gsourcefiles_315029_3901077974->data[i0].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2971));
		{
		...
		LOC20 = &LOC19->Sup;
		open_214223_1314243012((&lex0), LOC20, ((NI) 8192), TMP2981);
		pos0 = lex0.bufpos;
		{
			while (1) {
				...
				case 13:
				{
					...
					LOC24 = gsourcefiles_315029_3901077974->data[i0].newline; gsourcefiles_315029_3901077974->data[i0].newline = copyStringRC1(((NimStringDesc*) &TMP2982));
				...
				case 0:
				{
					...
					LOC26 = gsourcefiles_315029_3901077974->data[i0].newline; gsourcefiles_315029_3901077974->data[i0].newline = copyStringRC1(((NimStringDesc*) &TMP2983));
