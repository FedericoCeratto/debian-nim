...
N_NIMCALL(void, encodevintaux_233275)(NI x, NimStringDesc** result) {
	...
	idx_233287 = ((NI) (rem_233285));
	{
		...
		d_233281 = ((NimStringDesc*) &TMP1413)->data[idx_233287];
	}
	goto LA6;
	LA8: ;
	{
...
N_NIMCALL(NI64, decodevbiggestint_233518)(NCSTRING s, NI* pos) {
	...
	result = IL64(0);
	{
		while (1) {
			...
			case 48 ... 57:
			{
				result = (NI64)((NI64)(result * IL64(190)) - ((NI64) ((NI32)(((NI) (((NU8)(s[i_233525])))) - 48))));
			}
			break;
			case 97 ... 122:
			{
				result = (NI64)((NI64)(result * IL64(190)) - ((NI64) ((NI32)(((NI) ((NI32)(((NI) (((NU8)(s[i_233525])))) - 97))) + 10))));
			}
			break;
			case 65 ... 90:
			{
				result = (NI64)((NI64)(result * IL64(190)) - ((NI64) ((NI32)(((NI) ((NI32)(((NI) (((NU8)(s[i_233525])))) - 65))) + 36))));
			}
			break;
			case 128 ... 255:
			{
				result = (NI64)((NI64)(result * IL64(190)) - ((NI64) ((NI32)(((NI) ((NI32)(((NI) (((NU8)(s[i_233525])))) - 128))) + 62))));
			}
			break;
			default:
			{
	...
	result = (NI64)((NU64)((NI64)(result * ((NI64) (sign_233527)))) - (NU64)(IL64(5)));
	(*pos) = i_233525;
	return result;
}
...
N_NIMCALL(void, encodevbiggestintaux_233234)(NI64 x, NimStringDesc** result) {
	...
	d_233240 = 0;
	v_233242 = x;
	rem_233244 = (NI64)(v_233242 % IL64(190));
	{
		if (!(((NI) (rem_233244)) < 0)) goto LA3;
		(*result) = addChar((*result), 45);
		v_233242 = -((NI64)(v_233242 / IL64(190)));
	...
	idx_233246 = ((NI) (rem_233244));
	{
		...
		d_233240 = ((NimStringDesc*) &TMP1413)->data[idx_233246];
	}
	goto LA6;
	LA8: ;
	{
...
N_NIMCALL(void, encodevbiggestint_233264)(NI64 x, NimStringDesc** result) {
	encodevbiggestintaux_233234((NI64)((NU64)(x) + (NU64)(IL64(5))), result);
}
