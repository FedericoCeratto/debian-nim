...
N_NIMCALL(void, handlecmdline_584607)(void);
...
N_NIMCALL(NimStringDesc*, prependcurdir_584401)(NimStringDesc* f);
...
STRING_LITERAL(TMP2002, "", 0);
STRING_LITERAL(TMP2003, "-", 1);
STRING_LITERAL(TMP2004, "stdinfile", 9);
STRING_LITERAL(TMP2026, "nim.cfg", 7);
STRING_LITERAL(TMP2027, "nims", 4);
STRING_LITERAL(TMP3707, "config.nims", 11);
STRING_LITERAL(TMP5289, "js", 2);
STRING_LITERAL(TMP5295, " ", 1);
STRING_LITERAL(TMP5296, "exe", 3);
...
{	{
		...
		writecommandlineusage_213020();
	}
	goto LA1;
	LA4: ;
	{
		NimStringDesc* scriptfile;
		processcmdline_577209(((NU8) 0), ((NimStringDesc*) &TMP2002));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_169234, ((NimStringDesc*) &TMP2003))) goto LA9;
			LOC11 = 0;
			LOC11 = gprojectname_169234; gprojectname_169234 = copyStringRC1(((NimStringDesc*) &TMP2004));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = 0;
			LOC12 = gprojectfull_169236; gprojectfull_169236 = copyStringRC1(((NimStringDesc*) &TMP2004));
			if (LOC12) nimGCunrefNoCycle(LOC12);
			asgnRefNoCycle((void**) (&gprojectpath_169235), nosgetCurrentDir());
			gprojectisstdin_169237 = NIM_TRUE;
		}
		goto LA7;
		LA9: ;
		{
			...
			NimStringDesc* LOC20;
			NimStringDesc* LOC21;
			if (!!(((gprojectname_169234) && (gprojectname_169234)->Sup.len == 0))) goto LA14;
			pushSafePoint(&TMP2005);
			TMP2005.status = setjmp(TMP2005.context);
			if (TMP2005.status == 0) {
				asgnRefNoCycle((void**) (&gprojectfull_169236), canonicalizepath_169409(gprojectname_169234));
				popSafePoint();
			}
			else {
				popSafePoint();
				if (isObj(getCurrentException()->Sup.m_type, (&NTI4033))) {
					...
					TMP2005.status = 0;
					LOC19 = 0;
					LOC19 = gprojectfull_169236; gprojectfull_169236 = copyStringRC1(gprojectname_169234);
					if (LOC19) nimGCunrefNoCycle(LOC19);
					popCurrentException();
				}
			}
			if (TMP2005.status != 0) reraiseException();
			memset((void*)(&p), 0, sizeof(p));
			chckNil((void*)(&p));
			memset((void*)(&p), 0, sizeof(p));
			nossplitFile(gprojectfull_169236, (&p));
			LOC20 = 0;
			LOC20 = gprojectpath_169235; gprojectpath_169235 = copyStringRC1(p.Field0);
			if (LOC20) nimGCunrefNoCycle(LOC20);
			LOC21 = 0;
			LOC21 = gprojectname_169234; gprojectname_169234 = copyStringRC1(p.Field1);
		...
		LA7: ;
		loadconfigs_223607(((NimStringDesc*) &TMP2026));
		scriptfile = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP2027));
		{
			NIM_BOOL LOC25;
			LOC25 = 0;
			LOC25 = fileexists_126808(scriptfile);
			if (!LOC25) goto LA26;
			runnimscript_583324(scriptfile);
			{
				if (!eqStrings(scriptfile, gprojectfull_169236)) goto LA30;
				goto BeforeRet;
			}
			LA30: ;
		}
		...
		LA26: ;
		{
			...
			NimStringDesc* LOC37;
			LOC33 = 0;
			LOC33 = HEX2F_121890(gprojectpath_169235, ((NimStringDesc*) &TMP3707));
			LOC34 = 0;
			LOC34 = fileexists_126808(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = 0;
			LOC37 = HEX2F_121890(gprojectpath_169235, ((NimStringDesc*) &TMP3707));
			runnimscript_583324(LOC37);
		}
		goto LA23;
		LA35: ;
		LA23: ;
		initvars_206076();
		processcmdline_577209(((NU8) 1), ((NimStringDesc*) &TMP2002));
		{
			if (!((command_169240) && (command_169240)->Sup.len == 0)) goto LA40;
			rawmessage_196636(((NU16) 184), command_169240);
		}
		LA40: ;
		maincommand_580628();
		{
			...
			NimStringDesc* LOC48;
			LOC44 = 0;
			LOC44 = ((goptions_169130 &(1<<((((NU8) 12))&31)))!=0);
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_193395 &(IL64(1)<<(((((NU16) 289)- 237))&IL64(63))))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
			LOC48 = 0;
		...
		LA46: ;
		{
			if (!(gerrorcounter_193396 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_169132 &(1<<((((NU8) 13))&31)))!=0)) goto LA55;
				{
					NimStringDesc* ex;
					NimStringDesc* LOC70;
					NimStringDesc* LOC71;
					if (!(gcmd_169134 == ((NU8) 4))) goto LA59;
					ex = 0;
					{
						NimStringDesc* LOC65;
						if (!(((NI) 0) < (outfile_169138 ? outfile_169138->Sup.len : 0))) goto LA63;
						LOC65 = 0;
						LOC65 = prependcurdir_584401(outfile_169138);
					...
					LA63: ;
					{
						...
						NimStringDesc* LOC69;
						LOC67 = 0;
						LOC67 = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP5289));
						LOC68 = 0;
						LOC68 = prependcurdir_584401(LOC67);
						LOC69 = 0;
						LOC69 = completecfilepath_206112(LOC68, NIM_TRUE);
						ex = nospquoteShell(LOC69);
					}
					LA61: ;
					LOC70 = 0;
					LOC71 = 0;
					LOC71 = findnodejs_582009();
					LOC70 = rawNewString(LOC71->Sup.len + ex->Sup.len + arguments_214837->Sup.len + 2);
appendString(LOC70, LOC71);
appendString(LOC70, ((NimStringDesc*) &TMP5295));
appendString(LOC70, ex);
appendChar(LOC70, 32);
appendString(LOC70, arguments_214837);
					execexternalprogram_206175(LOC70, ((NU16) 284));
				}
				goto LA57;
				LA59: ;
				{
					...
					binpath = 0;
					{
						if (!(((NI) 0) < (outfile_169138 ? outfile_169138->Sup.len : 0))) goto LA75;
						binpath = prependcurdir_584401(outfile_169138);
					}
					goto LA73;
					LA75: ;
					{
						NimStringDesc* LOC78;
						LOC78 = 0;
						LOC78 = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP5296));
						binpath = prependcurdir_584401(LOC78);
					}
					LA73: ;
					ex = nospquoteShell(binpath);
					LOC79 = 0;
					LOC79 = rawNewString(ex->Sup.len + arguments_214837->Sup.len + 1);
appendString(LOC79, ex);
appendChar(LOC79, 32);
appendString(LOC79, arguments_214837);
					execexternalprogram_206175(LOC79, ((NU16) 284));
				}
				LA57: ;
			}
			LA55: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	initdefines_201254();
	handlecmdline_584607();
	msgquit_193488(((NI8) ((((NI) 0) < gerrorcounter_193396))));
}
