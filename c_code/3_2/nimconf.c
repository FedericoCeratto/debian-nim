...
STRING_LITERAL(TMP1888, "/usr", 4);
STRING_LITERAL(TMP1889, "/usr/lib/nim", 12);
STRING_LITERAL(TMP1890, "/usr/local", 10);
STRING_LITERAL(TMP1891, "/usr/local/lib/nim", 18);
STRING_LITERAL(TMP1892, "lib", 3);
STRING_LITERAL(TMP1893, "@", 1);
STRING_LITERAL(TMP1894, "\')\'", 3);
STRING_LITERAL(TMP1895, "\':\'", 3);
STRING_LITERAL(TMP1896, "@if", 3);
STRING_LITERAL(TMP1897, "@end", 4);
STRING_LITERAL(TMP1898, "putenv", 6);
STRING_LITERAL(TMP1899, "prependenv", 10);
STRING_LITERAL(TMP1900, "appendenv", 9);
STRING_LITERAL(TMP1901, "-", 1);
STRING_LITERAL(TMP1902, "--", 2);
STRING_LITERAL(TMP1903, "", 0);
STRING_LITERAL(TMP1904, "\']\'", 3);
STRING_LITERAL(TMP1905, "&", 1);
STRING_LITERAL(TMP1906, "config", 6);
STRING_LITERAL(TMP1907, "etc", 3);
STRING_LITERAL(TMP1908, "/etc/", 5);
STRING_LITERAL(TMP1910, "nim.cfg", 7);
STRING_LITERAL(TMP1911, "nimrod.cfg", 10);
...
N_NIMCALL(NIM_BOOL, parseatom_220051)(tlexer215190* l, ttoken215186* tok) {
	...
	result = 0;
	{
		...
		LA7: ;
		{
			lexmessage_215289((&(*l)), ((NU16) 23), ((NimStringDesc*) &TMP1894));
		}
		LA5: ;
	}
	goto LA1;
...
N_NIMCALL(NIM_BOOL, evalppif_220149)(tlexer215190* l, ttoken215186* tok) {
	...
	LA3: ;
	{
		lexmessage_215289((&(*l)), ((NU16) 23), ((NimStringDesc*) &TMP1895));
	}
	LA1: ;
	return result;
}
...
N_NIMCALL(void, doelse_220243)(tlexer215190* l, ttoken215186* tok) {
	{
		...
		lexmessage_215289((&(*l)), ((NU16) 23), ((NimStringDesc*) &TMP1896));
	}
	LA3: ;
	ppgettok_220009(l, tok);
	{
		...
		while (1) {
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = eqStrings((*(*tok).Ident).S, ((NimStringDesc*) &TMP1893));
				LA6: ;
				if (!LOC5) goto LA7;
				ppgettok_220009(l, tok);
				LOC9 = 0;
...
N_NIMCALL(void, parsedirective_220369)(tlexer215190* l, ttoken215186* tok) {
	...
	default:
	{
		...
		if (eqStrings(LOC13, ((NimStringDesc*) &TMP1898))) goto LA14;
		if (eqStrings(LOC13, ((NimStringDesc*) &TMP1899))) goto LA15;
		if (eqStrings(LOC13, ((NimStringDesc*) &TMP1900))) goto LA16;
		goto LA17;
		LA14: ;
		{
			NimStringDesc* key;
...
N_NIMCALL(void, conftok_220412)(tlexer215190* l, ttoken215186* tok) {
	ppgettok_220009(l, tok);
	{
		while (1) {
			...
			if (!(LOC3)) goto LA4;
			LOC3 = eqStrings((*(*tok).Ident).S, ((NimStringDesc*) &TMP1893));
			LA4: ;
			if (!LOC3) goto LA2;
...
N_NIMCALL(void, parseassignment_220485)(tlexer215190* l, ttoken215186* tok) {
	...
	NimStringDesc* val;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = getident_200472(((NimStringDesc*) &TMP1901));
		LOC3 = ((*(*tok).Ident).Sup.Id == (*LOC4).Sup.Id);
		if (LOC3) goto LA5;
		LOC6 = 0;
		LOC6 = getident_200472(((NimStringDesc*) &TMP1902));
	...
	conftok_220412(l, tok);
	val = copyString(((NimStringDesc*) &TMP1903));
	{
		while (1) {
			NimStringDesc* LOC11;
...
appendString(val, LOC16);
		...
		LA19: ;
		{
			lexmessage_215289((&(*l)), ((NU16) 23), ((NimStringDesc*) &TMP1904));
		}
		LA17: ;
		val = addChar(val, 93);
	}
...
appendString(val, LOC30);
		conftok_220412(l, tok);
		{
			while (1) {
				...
				if (!(LOC33)) goto LA34;
				LOC35 = 0;
				LOC35 = getident_200472(((NimStringDesc*) &TMP1905));
...
N_NIMCALL(NimStringDesc*, getsystemconfigpath_220652)(NimStringDesc* filename) {
	...
	LOC1[0] = copyString(p);
	LOC1[1] = copyString(((NimStringDesc*) &TMP1906));
	...
	result = nosjoinPathOpenArray(LOC1, 3);
	{
		...
		LOC7[0] = copyString(p);
		LOC7[1] = copyString(((NimStringDesc*) &TMP1907));
...
appendString(LOC13, ((NimStringDesc*) &TMP1908));
...
N_NIMCALL(void, loadconfigs_220811)(NimStringDesc* cfg) {
	NimStringDesc* pd;
	{
		...
		{
			NimStringDesc* LOC9;
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP1888))) goto LA7;
			LOC9 = 0;
			LOC9 = libpath_169233; libpath_169233 = copyStringRC1(((NimStringDesc*) &TMP1889));
		...
		{
			NimStringDesc* LOC13;
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP1890))) goto LA11;
			LOC13 = 0;
			LOC13 = libpath_169233; libpath_169233 = copyStringRC1(((NimStringDesc*) &TMP1891));
			if (LOC13) nimGCunrefNoCycle(LOC13);
		}
		goto LA5;
		LA11: ;
		{
			asgnRefNoCycle((void**) (&libpath_169233), nosjoinPath(prefix, ((NimStringDesc*) &TMP1892)));
		}
		LA5: ;
	}
	LA3: ;
		...
		if (!!(((gglobaloptions_169118 &(1<<((((NU8) 19))&31)))!=0))) goto LA32;
		{
			...
			dir_221044 = 0;
			{
				...
				current_221064 = copyString(pd);
				{
					...
					dir_221044 = pd;
					LOC43 = 0;
					LOC43 = HEX2F_117499(dir_221044, cfg);
				...
				LA41: ;
				{
					while (1) {
						...
						LOC51 = 0;
						LOC51 = HEX2F_117499(dir_221044, cfg);
			...
			LA37: ;
			{
					...
					res_221070 = 0;
					{
						while (1) {
							...
							i_221066 = res_221070;
							{
								...
								LOC64 = 0;
								LOC64 = HEX2F_117499(dir_221044, cfg);
				...
				}
				{
					...
					dir_221044 = pd;
					LOC69 = 0;
					LOC69 = HEX2F_117499(dir_221044, cfg);
	...
	LA32: ;
	{
		...
		LOC74 = 0;
		LOC74 = HEX2F_117499(pd, cfg);
		readconfigfile_220573(LOC74);
		{
			NimStringDesc* projectconfig;
			if (!!((gprojectname_169234->Sup.len == 0))) goto LA77;
			projectconfig = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP1910));
			{
				NIM_BOOL LOC81;
				LOC81 = 0;
			...
			LA82: ;
			{
				NimStringDesc* LOC85;
				LOC85 = 0;
				LOC85 = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP1911));
