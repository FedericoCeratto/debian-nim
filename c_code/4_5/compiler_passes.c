...
N_NIMCALL(void, processimplicits_311470_2355241294)(TY131402* implicits0, Tnodekind263020 nodekind0, Tpasscontext311002** a0) {
	{
		...
		L_311494_2355241294 = (implicits0 ? implicits0->Sup.len : 0);
		{
			while (1) {
				...
				importstmt0 = newnodei_265248_850551059(nodekind0, gcmdlineinfo_186046_155036129);
				str0 = newstrnode_264678_850551059(((Tnodekind263020) 20), module_311485_2355241294);
				(*str0).info = gcmdlineinfo_186046_155036129;
...
{	memset((void*)(&p0), 0, sizeof(p0));
	...
	LA3: ;
	{
		...
		n0 = loadinitsection_302083_1724185294(rd0);
		{
			...
			NI HEX3Atmp_311634_2355241294;
			NI LOC47;
			NI res_311637_2355241294;
			i_311622_2355241294 = (NI)0;
			HEX3Atmp_311634_2355241294 = (NI)0;
			LOC47 = (NI)0;
			LOC47 = sonslen_266351_850551059(n0);
			HEX3Atmp_311634_2355241294 = (NI)(LOC47 - ((NI) 1));
			res_311637_2355241294 = ((NI) 0);
			{
				while (1) {
					if (!(res_311637_2355241294 <= HEX3Atmp_311634_2355241294)) goto LA49;
					i_311622_2355241294 = res_311637_2355241294;
					processtoplevelstmtcached_311394_2355241294((*n0).kindU.S6.sons->data[i_311622_2355241294], a0);
					res_311637_2355241294 += ((NI) 1);
				} LA49: ;
			}
		}
