...
NIM_CONST TY458013 Cfilesectionnames_458012 = {((NimStringDesc*) &TMP4273),
...
NIM_CONST TY458019 Cprocsectionnames_458018 = {((NimStringDesc*) &TMP4291),
...
N_NIMCALL(void, readkey_458466)(Tbaselexer180024* L, NimStringDesc** result) {
	...
	}
	{
		...
		internalerror_166218(((NimStringDesc*) &TMP4194));
	}
	LA5: ;
...
N_NIMCALL(void, readtypecache_458524)(Tbaselexer180024* L, Tidtable191861* result) {
	{
		...
		internalerror_166218(((NimStringDesc*) &TMP4201));
	}
	LA3: ;
	(*L).bufpos += ((NI) 1);
	{
...
appendString(r, tnl_160626);
			...
			case 0:
			{
				internalerror_166218(((NimStringDesc*) &TMP4271));
				goto LA1;
			}
			break;
			default:
...
appendString(LOC34, k);
			...
			LA18: ;
			{
				internalerror_166218(((NimStringDesc*) &TMP4295));
			}
			LA11: ;
		}
	} LA5: ;
