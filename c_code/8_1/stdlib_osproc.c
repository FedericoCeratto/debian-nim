...
N_NIMCALL(void, createstream_142539)(streamobj134035** stream, int* handle, NU8 filemode);
...
static NIM_CONST TY210607 TMP1794 = {
...
static NIM_CONST TY202627 TMP4212 = {NIM_NIL,NIM_NIL};
...
extern TY118808* environment_118809;
...
N_NIMCALL(NCSTRING*, envtocstringarray_140855)(void) {
	...
	counter = 0;
	{
		...
		getenvvarsc_119002();
		{
			...
			i_140895 = 0;
			HEX3Atmp_140897 = 0;
			HEX3Atmp_140897 = (environment_118809->Sup.len-1);
			res_140899 = 0;
			{
				while (1) {
					NI p_140901;
					...
					i_140895 = res_140899;
					p_140901 = nsuFindChar(environment_118809->data[i_140895], 61, 0);
					key_140859 = copyStrLast(environment_118809->data[i_140895], 0, (NI32)(p_140901 - 1));
					val_140860 = copyStr(environment_118809->data[i_140895], (NI32)(p_140901 + 1));
					counter += 1;
					res_140899 += 1;
				} LA4: ;
			}
	...
	i = 0;
	{
		...
		getenvvarsc_119002();
		{
			...
			i_140914 = 0;
			HEX3Atmp_140916 = 0;
			HEX3Atmp_140916 = (environment_118809->Sup.len-1);
			res_140918 = 0;
			{
				while (1) {
					NI p_140920;
					...
					i_140914 = res_140918;
					p_140920 = nsuFindChar(environment_118809->data[i_140914], 61, 0);
					key_140875 = copyStrLast(environment_118809->data[i_140914], 0, (NI32)(p_140920 - 1));
					val_140876 = copyStr(environment_118809->data[i_140914], (NI32)(p_140920 + 1));
					LOC10 = 0;
...
N_NIMCALL(pid_t, startprocessauxfork_141001)(tstartprocessdata140951* data) {
	...
	TMP2865.status = setjmp(TMP2865.context);
	if (TMP2865.status == 0) {
		pid_t volatile pid;
		tstartprocessdata140951 datacopy;
		int LOC12;
		int error;
		NI sizeread;
		int LOC24;
		...
		LOC12 = close((*data).Perrorpipe[(1)- 0]);
		{
			...
			if (!(pid < 0)) goto LA15;
			LOC17 = 0;
			LOC17 = oslasterror_113841();
			raiseoserror_113809(LOC17);
		}
		LA15: ;
		error = 0;
...
N_NIMCALL(processobj139402*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, stringtableobj130012* env, NU8 options) {
	...
	(*result).Exitcode = ((int) -3);
	{
		if (!!(((options &(1<<((((NU8) 4))&7)))!=0))) goto LA3;
		{
			...
			if (!LOC7) goto LA14;
			LOC16 = 0;
			LOC16 = oslasterror_113841();
			raiseoserror_113809(LOC16);
		}
		LA14: ;
	}
	LA3: ;
	...
	sysargsraw = 0;
	{
		...
		sysargsraw = (TY118808*) newSeq((&NTI118808), 3);
	...
	LA19: ;
	{
		...
		sysargsraw = (TY118808*) newSeq((&NTI118808), 1);
		...
		if (LOC27) nimGCunrefNoCycle(LOC27);
		{
			...
			i_141493 = 0;
			{
				while (1) {
					NimStringDesc* LOC31;
					if (!(i_141493 < argsLen0)) goto LA30;
					arg_141230 = args[i_141493];
					sysargsraw = (TY118808*) incrSeq(&(sysargsraw)->Sup, sizeof(NimStringDesc*));
					LOC31 = 0;
	...
	TMP2862.status = setjmp(TMP2862.context);
	if (TMP2862.status == 0) {
		NCSTRING* sysenv;
		TSafePoint TMP2864;
		{
...
N_NIMCALL(streamobj134035*, nospinputStream)(processobj139402* p) {
	...
	result = 0;
	{
		...
		createstream_142539(&(*p).Instream, (&(*p).Inhandle), ((NU8) 1));
	}
	LA3: ;
	result = (*p).Instream;
	goto BeforeRet;
...
N_NIMCALL(streamobj134035*, nospoutputStream)(processobj139402* p) {
	...
	result = 0;
	{
		...
		createstream_142539(&(*p).Outstream, (&(*p).Outhandle), ((NU8) 0));
	}
	LA3: ;
	result = (*p).Outstream;
	goto BeforeRet;
...
N_NIMCALL(NI, nospwaitForExit)(processobj139402* p, NI timeout) {
	...
	LA3: ;
	{
		...
		(*p).Exitcode = ((int) -3);
		LOC10 = 0;
		LOC10 = oslasterror_113841();
		raiseoserror_113809(LOC10);
	}
	LA8: ;
			...
			res_140516 = 0;
			{
				while (1) {
					...
					i_140241 = res_140516;
					{
						...
						beforerunevent.ClEnv? beforerunevent.ClPrc(i_140241, beforerunevent.ClEnv):((TMP4213)(beforerunevent.ClPrc))(i_140241);
					}
					LA10: ;
			...
			res_140535 = 0;
			{
				while (1) {
					...
					i_140497 = res_140535;
					{
						...
						beforerunevent.ClEnv? beforerunevent.ClPrc(i_140497, beforerunevent.ClEnv):((TMP4215)(beforerunevent.ClPrc))(i_140497);
					}
					LA49: ;
