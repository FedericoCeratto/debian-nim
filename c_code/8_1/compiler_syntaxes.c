...
STRING_LITERAL(TMP1667, "none", 4);
STRING_LITERAL(TMP1668, "stdtmpl", 7);
STRING_LITERAL(TMP1669, "replace", 7);
STRING_LITERAL(TMP1670, "strip", 5);
NIM_CONST TY288022 filternames_288019_4241778752 = {((NimStringDesc*) &TMP1667),
((NimStringDesc*) &TMP1668),
((NimStringDesc*) &TMP1669),
((NimStringDesc*) &TMP1670)}
;
STRING_LITERAL(TMP1671, "standard", 8);
STRING_LITERAL(TMP1672, "strongspaces", 12);
STRING_LITERAL(TMP1673, "braces", 6);
STRING_LITERAL(TMP1674, "endx", 4);
NIM_CONST TY288016 parsernames_288013_4241778752 = {((NimStringDesc*) &TMP1671),
((NimStringDesc*) &TMP1672),
((NimStringDesc*) &TMP1673),
((NimStringDesc*) &TMP1674)}
;
STRING_LITERAL(TMP1706, "parser to implement", 19);
...
{	result0 = (Tllstream253204*)0;
	...
	LA3: ;
	{
		...
		LOC7 = LOC8;
		if (!(LOC7)) goto LA10;
		LOC7 = identeq_193450_791273810((*(*n0).kindU.S6.sons->data[((NI) 0)]).kindU.S5.ident, ((NimStringDesc*) &TMP1552));
		LA10: ;
		if (!LOC7) goto LA11;
		{
...
N_NIMCALL(Tnode263794*, parseall_288042_4241778752)(Tparsers288026* p0) {
	...
	case ((Tparserkind288004) 3):
	{
		internalerror_190113_155036129(((NimStringDesc*) &TMP1706));
		result0 = emptynode_264801_850551059;
	}
	break;
	}
