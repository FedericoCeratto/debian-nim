...
typedef NimStringDesc* TY108567[9];
typedef NimStringDesc* TY386905[9];
typedef NIM_CHAR TY108473[2];
struct  Gcstack50216  {
Gcstack50216* prev;
Gcstack50216* next;
void* starts;
...
N_NOINLINE(void, invalidformatstring_108747_4286263276)(void);
...
N_NIMCALL(NI, findnormalized_108730_4286263276)(NimStringDesc* x0, NimStringDesc** inarray0, NI inarray0Len0);
...
N_NIMCALL(void, trimzeros_108464_4286263276)(NimStringDesc** x0);
...
static N_INLINE(NIM_BOOL, contains_108477_1689653243)(NIM_CHAR* a0, NI a0Len0, NIM_CHAR item0);
static N_INLINE(NI, find_108487_1689653243)(NIM_CHAR* a0, NI a0Len0, NIM_CHAR item0);
...
NIM_CONST TY386905 collprefixes_108559_4286263276 = {((NimStringDesc*) &TMP1575),
...
NIM_CONST TY386905 iecprefixes_108556_4286263276 = {((NimStringDesc*) &TMP1575),
...
TNimType NTI108567; /* array[0..8, string] */
...
N_NOINLINE(void, invalidformatstring_108747_4286263276)(void) {
	Valueerror3446* e_108752_4286263276;
	NimStringDesc* LOC1;
	e_108752_4286263276 = (Valueerror3446*)0;
	e_108752_4286263276 = (Valueerror3446*) newObj((&NTI23825), sizeof(Valueerror3446));
	(*e_108752_4286263276).Sup.Sup.m_type = (&NTI3446);
	LOC1 = (NimStringDesc*)0;
	LOC1 = (*e_108752_4286263276).Sup.message; (*e_108752_4286263276).Sup.message = copyStringRC1(((NimStringDesc*) &TMP201));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_108752_4286263276, "ValueError");
}
				...
				{
					{
						...
						invalidformatstring_108747_4286263276();
					}
					LA10: ;
...
appendString((*s0), a0[idx0]);
				...
				case 123:
				{
					...
					x0 = findnormalized_108730_4286263276(LOC32, a0, a0Len0);
					{
						NIM_BOOL LOC35;
						LOC35 = (NIM_BOOL)0;
						LOC35 = (((NI) 0) <= x0);
...
appendString((*s0), a0[(NI)(x0 + ((NI) 1))]);
				...
				case 95:
				{
					...
					x0 = findnormalized_108730_4286263276(LOC43, a0, a0Len0);
					{
						NIM_BOOL LOC46;
						LOC46 = (NIM_BOOL)0;
						LOC46 = (((NI) 0) <= x0);
...
N_NIMCALL(NimStringDesc*, nsuToBin)(NI64 x0, NI len0) {
	...
	result0 = mnewString(((NI) (len0)));
	{
		...
		NI HEX3Atmp_107624_4286263276;
		NI res_107627_4286263276;
		j_107612_4286263276 = (NI)0;
		HEX3Atmp_107624_4286263276 = (NI)0;
		HEX3Atmp_107624_4286263276 = (NI)(((NI) (len0)) - ((NI) 1));
		res_107627_4286263276 = ((NI) (HEX3Atmp_107624_4286263276));
		{
			while (1) {
				if (!(((NI) 0) <= res_107627_4286263276)) goto LA3;
				j_107612_4286263276 = ((NI) (res_107627_4286263276));
...
N_NIMCALL(NimStringDesc*, nsuToOct)(NI64 x0, NI len0) {
	...
	result0 = mnewString(((NI) (len0)));
	{
		...
		NI HEX3Atmp_107424_4286263276;
		NI res_107427_4286263276;
		j_107412_4286263276 = (NI)0;
		HEX3Atmp_107424_4286263276 = (NI)0;
		HEX3Atmp_107424_4286263276 = (NI)(((NI) (len0)) - ((NI) 1));
		res_107427_4286263276 = ((NI) (HEX3Atmp_107424_4286263276));
		{
			while (1) {
				if (!(((NI) 0) <= res_107427_4286263276)) goto LA3;
				j_107412_4286263276 = ((NI) (res_107427_4286263276));
...
appendString(result0, prefix0);
	{
		NIM_CHAR c_107700_4286263276;
		NI i_107712_4286263276;
		NI L_107714_4286263276;
		c_107700_4286263276 = (NIM_CHAR)0;
		i_107712_4286263276 = ((NI) 0);
		L_107714_4286263276 = (s0 ? s0->Sup.len : 0);
		{
			while (1) {
				if (!(i_107712_4286263276 < L_107714_4286263276)) goto LA3;
				c_107700_4286263276 = s0->data[i_107712_4286263276];
				switch (((NU8)(c_107700_4286263276))) {
				case 0 ... 31:
				case 128 ... 255:
				{
					NimStringDesc* LOC5;
...
appendString(result0, ((NimStringDesc*) &TMP2266));
					...
					LOC5 = nsuToHex(((NI64) (((NU8)(c_107700_4286263276)))), ((NI) 2));
...
appendString(result0, ((NimStringDesc*) &TMP2269));
				...
				default:
				{
					result0 = addChar(result0, c_107700_4286263276);
				}
				break;
				}
				i_107712_4286263276 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NIMCALL(NimStringDesc*, nsuformatBiggestFloat)(NF f0, Floatformatmode108202 format0, NI precision0, NIM_CHAR decimalsep0) {
	...
	{
		int i_108436_4286263276;
		int i_108454_4286263276;
		i_108436_4286263276 = (int)0;
		i_108454_4286263276 = ((int) 0);
		{
			while (1) {
				if (!(i_108454_4286263276 < L0)) goto LA8;
				i_108436_4286263276 = i_108454_4286263276;
				{
					if (!(((NU8)(buf0[(i_108436_4286263276)- 0])) == ((NU8)(46)) || ((NU8)(buf0[(i_108436_4286263276)- 0])) == ((NU8)(44)))) goto LA11;
					result0->data[i_108436_4286263276] = decimalsep0;
				}
				goto LA9;
				LA11: ;
				{
					result0->data[i_108436_4286263276] = buf0[(i_108436_4286263276)- 0];
				}
				LA9: ;
				i_108454_4286263276 += ((NI) 1);
			} LA8: ;
		}
	}
	return result0;
...
{	result0 = (NI)0;
	{
		NIM_CHAR i_108521_1689653243;
		NI i_108534_1689653243;
		i_108521_1689653243 = (NIM_CHAR)0;
		i_108534_1689653243 = ((NI) 0);
		{
			while (1) {
				if (!(i_108534_1689653243 < a0Len0)) goto LA3;
				i_108521_1689653243 = a0[i_108534_1689653243];
				{
					if (!((NU8)(i_108521_1689653243) == (NU8)(item0))) goto LA6;
					goto BeforeRet;
				}
				LA6: ;
				result0 += ((NI) 1);
				i_108534_1689653243 += ((NI) 1);
			} LA3: ;
		}
	}
	result0 = ((NI) -1);
...
{	result0 = (NIM_BOOL)0;
	LOC1 = (NI)0;
	LOC1 = find_108487_1689653243(a0, a0Len0, item0);
	result0 = (((NI) 0) <= LOC1);
	goto BeforeRet;
	}BeforeRet: ;
	return result0;
...
N_NIMCALL(void, trimzeros_108464_4286263276)(NimStringDesc** x0) {
	...
	spl0 = (TY134602*)0;
	{
		...
		}
		{
			NIM_BOOL LOC16;
			LOC16 = (NIM_BOOL)0;
			LOC16 = contains_108477_1689653243(TMP5561, 2, (*x0)->data[((*x0) ? ((*x0)->Sup.len-1) : -1)]);
			if (!LOC16) goto LA17;
			(*x0) = setLengthStr((*x0), ((NI) ((NI)(((*x0) ? (*x0)->Sup.len : 0) - ((NI) 1)))));
		}
		LA17: ;
...
N_NIMCALL(NimStringDesc*, formatsize_108549_4286263276)(NI64 bytes0, NIM_CHAR decimalsep0, Binaryprefixmode108546 prefix0, NIM_BOOL includespace0) {
	...
	{
		if (!(prefix0 == ((Binaryprefixmode108546) 1))) goto LA3;
		genericAssign((void*)prefixes0, (void*)collprefixes_108559_4286263276, (&NTI108567));
	}
	goto LA1;
	LA3: ;
	{
		genericAssign((void*)prefixes0, (void*)iecprefixes_108556_4286263276, (&NTI108567));
	}
	LA1: ;
	{
		NI index_108596_4286263276;
		NI i_108606_4286263276;
		index_108596_4286263276 = (NI)0;
		i_108606_4286263276 = ((NI) 1);
		{
			while (1) {
				if (!(i_108606_4286263276 < ((NI) 9))) goto LA8;
				index_108596_4286263276 = i_108606_4286263276;
				lastxb0 = xb0;
				xb0 = (NI64)(bytes0 / (NI64)((NU64)(IL64(1)) << (NU64)(((NI64) ((NI)(index_108596_4286263276 * ((NI) 10)))))));
				matchedindex0 = index_108596_4286263276;
				{
					if (!(xb0 == IL64(0))) goto LA11;
					xb0 = lastxb0;
					matchedindex0 = (NI)(index_108596_4286263276 - ((NI) 1));
					goto LA6;
				}
				LA11: ;
				i_108606_4286263276 += ((NI) 1);
	...
	trimzeros_108464_4286263276((&result0));
	{
...
NTI106508.flags = 3;
NTI108567.size = sizeof(TY108567);
NTI108567.kind = 16;
NTI108567.base = (&NTI138);
NTI108567.flags = 2;
}
