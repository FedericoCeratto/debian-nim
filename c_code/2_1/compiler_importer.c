...
STRING_LITERAL(TMP3615, "", 0);
STRING_LITERAL(TMP3616, "as", 2);
STRING_LITERAL(TMP3617, " ", 1);
STRING_LITERAL(TMP3618, ".", 1);
STRING_LITERAL(TMP3619, "/", 1);
STRING_LITERAL(TMP3620, "invalid module name: \'$1\'", 25);
STRING_LITERAL(TMP3621, "module alias must be an identifier", 34);
STRING_LITERAL(TMP3622, "A module cannot import itself", 29);
STRING_LITERAL(TMP3623, "importAllSymbols: ", 18);
STRING_LITERAL(TMP3624, "rawImportSymbol", 15);
STRING_LITERAL(TMP3626, "importSymbol: 2", 15);
STRING_LITERAL(TMP3627, "importSymbol: 3", 15);
...
{	result = 0;
	...
	case ((NU8) 22):
	{
		result = nosunixToNativePath((*n).kindU.S3.strval, ((NimStringDesc*) &TMP3615));
	}
	break;
	case ((NU8) 2):
	{
	...
	case ((NU8) 30):
	{
		NimStringDesc* LOC12;
		{
			...
			if (!(LOC7)) goto LA8;
			LOC9 = 0;
			LOC9 = getident_198463(((NimStringDesc*) &TMP3616));
		...
		result = nsuReplaceStr(LOC12, ((NimStringDesc*) &TMP3617), ((NimStringDesc*) &TMP3615));
	}
	break;
	case ((NU8) 45):
	{
		...
		result = nsuReplaceStr(LOC14, ((NimStringDesc*) &TMP3618), ((NimStringDesc*) &TMP3619));
	}
	break;
	case ((NU8) 78):
	{
	...
	default:
	{
		...
		LOC18 = 0;
		LOC18 = nsuFormatSingleElem(((NimStringDesc*) &TMP3620), LOC17);
...
N_NIMCALL(Tsym225841*, importmoduleas_288671)(Tnode225809* n, Tsym225841* realmodule) {
	...
	LA3: ;
	{
		...
		LA8: ;
		if (!LOC6) goto LA9;
		localerror_196128((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP3621));
	}
	goto LA1;
	LA9: ;
	{
...
N_NIMCALL(Tsym225841*, myimportmodule_288708)(Tcontext280023* c, Tnode225809* n) {
	...
	f = checkmodulename_288064(n);
	{
		...
		result = importmoduleas_288671(n, LOC5);
		{
			...
			localerror_196128((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP3622));
		}
		LA8: ;
		{
				...
				res_288216 = ((NI) 0);
				{
					while (1) {
						...
						e = (*(*(*etyp).n).kindU.S6.sons->data[j_288157]).kindU.S4.sym;
						{
							...
							internalerror_196172((*s).info, ((NimStringDesc*) &TMP3624));
						}
						LA27: ;
...
appendString(LOC15, ((NimStringDesc*) &TMP3623));
...
N_NIMCALL(void, importsymbol_288241)(Tcontext280023* c, Tnode225809* n, Tsym225841* frommod) {
	...
	LA3: ;
	{
		...
		LA8: ;
		{
			...
			internalerror_196172((*n).info, ((NimStringDesc*) &TMP3626));
		}
		LA12: ;
		switch ((*s).kind) {
		case ((NU8) 12):
			...
			e = initidentiter_233147((&it), (*frommod).kindU.S3.tab, (*s).name);
			{
				while (1) {
					if (!!((e == NIM_NIL))) goto LA16;
					{
						...
						internalerror_196172((*n).info, ((NimStringDesc*) &TMP3627));
					}
					LA19: ;
					rawimportsymbol_288077(c, e);
