...
N_NIMCALL(void, suggestwriteln_190453)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_190444.ClEnv? writelnhook_190444.ClPrc(s, writelnhook_190444.ClEnv):((TMP2063)(writelnhook_190444.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, suggestquit_190509)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_190514).Sup.message; (*e_190514).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2774));
	if (LOC1) nimGCunrefNoCycle(LOC1);
