...
STRING_LITERAL(TMP1961, "..", 2);
STRING_LITERAL(TMP1962, "head", 4);
...
{	result0 = (NIM_BOOL)0;
	{
		if (!eqStrings(a0, ((NimStringDesc*) &TMP1962))) goto LA3;
		result0 = NIM_FALSE;
		goto BeforeRet;
	}
	LA3: ;
...
N_NIMCALL(void, addpackage_249084_1623492514)(Stringtableobj146209* packages0, NimStringDesc* p0) {
	...
	LA3: ;
	{
		nstPut(packages0, name0, ((NimStringDesc*) &TMP1962));
	}
	LA1: ;
}
...
N_NIMCALL(void, addpathrec_249184_1623492514)(NimStringDesc* dir0, Tlineinfo186336 info0) {
	...
	LA3: ;
	{
		...
		d_249238_1623492514 = opendir(dir0->data);
		{
			...
			pushSafePoint(&TMP1959);
			TMP1959.status = _setjmp(TMP1959.context);
			if (TMP1959.status == 0) {
				{
					while (1) {
						{
							...
							y_249242_1623492514 = cstrToNimstr(((NCSTRING) ((*x_249240_1623492514).d_name)));
							{
								...
								if (!(LOC20)) goto LA21;
								LOC20 = !(eqStrings(y_249242_1623492514, ((NimStringDesc*) &TMP1961)));
								LA21: ;
								if (!LOC20) goto LA22;
			...
			if (TMP1959.status != 0) reraiseException();
		}
		LA8: ;
	}
	{
				...
				res_249260_1623492514 = ((NI) 0);
				{
					while (1) {
						...
						h_249256_1623492514 = res_249260_1623492514;
						{
							...
							{
								if (!eqStrings(val_249254_1623492514, ((NimStringDesc*) &TMP1962))) goto LA87;
