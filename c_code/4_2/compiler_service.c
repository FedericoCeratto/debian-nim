...
extern TY190438 writelnhook_190441;
...
N_NIMCALL(void, processcmdline_574209)(NU8 pass, NimStringDesc* cmd) {
	...
	argscount = ((NI) 0);
	{
		while (1) {
			...
			{
				{
					if (!eqStrings(p.key, ((NimStringDesc*) &TMP1636))) goto LA7;
					p.key = copyString(((NimStringDesc*) &TMP1637));
					{
						NIM_BOOL LOC11;
						LOC11 = 0;
	...
	} LA1: ;
	{
		if (!(pass == ((NU8) 1))) goto LA23;
		{
			...
			LOC27 = !(eqStrings(LOC31, ((NimStringDesc*) &TMP1992)));
			LA30: ;
			if (!LOC27) goto LA32;
...
N_NIMCALL(void, serve_574254)(TY574256 action) {
	...
	typ = getconfigvar_166335(((NimStringDesc*) &TMP5254));
	...
	LA2: ;
	{
		...
		p = getconfigvar_166335(((NimStringDesc*) &TMP5259));
		{
			NI LOC18;
		...
		LA14: ;
		LOC20 = 0;
		LOC20 = getconfigvar_166335(((NimStringDesc*) &TMP5260));
		...
		asgnRef((void**) (&writelnhook_190441.ClEnv), LOC21.ClEnv);
		writelnhook_190441.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				NimStringDesc* LOC24;
				...
				action();
				gerrorcounter_190396 = ((NI) 0);
				send_571208((*HEX3Aenv_574447).stdoutsocket574408, ((NimStringDesc*) &TMP5263), 2);
	...
	LA3: ;
	{
		printf("%s%s\012", ((NimStringDesc*) &TMP5271)? (((NimStringDesc*) &TMP5271))->data:"nil", typ? (typ)->data:"nil");
		msgquit_190488(((NI8) 1));
	}
	LA4: ;
}
...
TMP1150[0].len = 2; TMP1150[0].kind = 2; TMP1150[0].sons = &TMP5240[0];
NTI574426.node = &TMP1150[0];
NTI574448.size = sizeof(TY574426*);
NTI574448.kind = 22;
NTI574448.base = (&NTI574426);
NTI574448.flags = 2;
NTI574448.marker = TMP5253;
}
