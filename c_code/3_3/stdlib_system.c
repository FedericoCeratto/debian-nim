...
N_NIMCALL(void, init_48211_1689653243)(Cellseq48120* s0, NI cap0);
...
N_NIMCALL(void, init_48226_1689653243)(Cellset48116* s0);
...
static N_INLINE(void, add_48191_1689653243)(Cellseq48120* s0, Cell48104* c0);
...
N_NIMCALL(void, marks_68401_1689653243)(Gcheap50618* gch0, Cell48104* c0);
N_NOINLINE(void, incl_48847_1689653243)(Cellset48116* s0, Cell48104* cell0);
N_NIMCALL(Pagedesc48112*, cellsetput_48641_1689653243)(Cellset48116* t0, NI key0);
static N_INLINE(NI, nexttry_48253_1689653243)(NI h0, NI maxhash0);
N_NIMCALL(void, cellsetenlarge_48603_1689653243)(Cellset48116* t0);
N_NIMCALL(void, cellsetrawinsert_48278_1689653243)(Cellset48116* t0, Pagedesc48112** data0, Pagedesc48112* desc0);
N_NIMCALL(void, forallchildren_52614_1689653243)(Cell48104* cell0, Walkop50610 op0);
static N_INLINE(void*, celltousr_52222_1689653243)(Cell48104* cell0);
...
N_NIMCALL(NIM_BOOL, containsorincl_48913_1689653243)(Cellset48116* s0, Cell48104* cell0);
N_NIMCALL(Pagedesc48112*, cellsetget_48258_1689653243)(Cellset48116* t0, NI key0);
...
static N_INLINE(NI, getoccupiedmem_48029_1689653243)(Memregion30286* a0);
...
N_NIMCALL(void, preparedealloc_52808_1689653243)(Cell48104* cell0);
N_NIMCALL(void, collectcycles_70211_1689653243)(Gcheap50618* gch0);
N_NIMCALL(void, cellsetreset_56628_1689653243)(Cellset48116* s0);
N_NIMCALL(void, deinit_48234_1689653243)(Cellset48116* s0);
...
N_NIMCALL(NIM_BOOL, contains_48808_1689653243)(Cellset48116* s0, Cell48104* cell0);
N_NIMCALL(void, freecycliccell_67015_1689653243)(Gcheap50618* gch0, Cell48104* c0);
...
static N_INLINE(void, addnewobjtozct_57674_1689653243)(Cell48104* res0, Gcheap50618* gch0);
...
N_NIMCALL(void, initgc_11601_1689653243)(void) {
	...
	init_48211_1689653243((&gch_50658_1689653243.zct), ((NI) 1024));
	init_48211_1689653243((&gch_50658_1689653243.tempstack), ((NI) 1024));
	init_48211_1689653243((&gch_50658_1689653243.decstack), ((NI) 1024));
	init_48226_1689653243((&gch_50658_1689653243.marked));
	init_48211_1689653243((&gch_50658_1689653243.additionalroots), ((NI) 1024));
}
...
N_NIMCALL(void, cellsetrawinsert_48278_1689653243)(Cellset48116* t0, Pagedesc48112** data0, Pagedesc48112* desc0) {
	...
	h0 = (NI)(((NI) ((*desc0).key)) & (*t0).max);
	{
		while (1) {
			...
			h0 = nexttry_48253_1689653243(h0, (*t0).max);
		} LA2: ;
	}
	data0[(h0)- 0] = desc0;
}
		...
		res_48637_1689653243 = ((NI) 0);
		{
			while (1) {
				...
				i_48619_1689653243 = res_48637_1689653243;
				{
					...
					cellsetrawinsert_48278_1689653243((&(*t0)), n0, (*t0).data[(i_48619_1689653243)- 0]);
				}
				LA7: ;
...
N_NIMCALL(Pagedesc48112*, cellsetput_48641_1689653243)(Cellset48116* t0, NI key0) {
	Pagedesc48112* result0;
	NI h0;
	void* LOC19;
{	result0 = (Pagedesc48112*)0;
	...
	LOC19 = (void*)0;
	LOC19 = alloc0_7417_1689653243(((NI) (((NI)sizeof(Pagedesc48112)))));
	result0 = ((Pagedesc48112*) (LOC19));
...
static N_INLINE(void*, celltousr_52222_1689653243)(Cell48104* cell0) {
	void* result0;
	result0 = (void*)0;
	result0 = ((void*) ((NI)((NU64)(((NI) (cell0))) + (NU64)(((NI)sizeof(Cell48104))))));
	return result0;
}
...
N_NIMCALL(NIM_BOOL, containsorincl_48913_1689653243)(Cellset48116* s0, Cell48104* cell0) {
	...
	result0 = (NIM_BOOL)0;
	u0 = ((NI) (cell0));
	t0 = cellsetget_48258_1689653243((&(*s0)), (NI)((NU64)(u0) >> (NU64)(((NI) 12))));
	{
		if (!!((t0 == NIM_NIL))) goto LA3;
		u0 = (NI)((NU64)((NI)((NU64)(u0) % (NU64)(((NI) 4096)))) / (NU64)(((NI) 8)));
...
{	{
	...
	case ((Walkop50610) 3):
	{
		add_48191_1689653243((&gch_50658_1689653243.tempstack), c0);
	}
	break;
	case ((Walkop50610) 0):
	{
...
N_NIMCALL(void, cellsetreset_56628_1689653243)(Cellset48116* s0) {
	deinit_48234_1689653243(s0);
	init_48226_1689653243(s0);
}
													...
													s_68218_1689653243 = (NI)((NI)((NU64)((*r_68226_1689653243).key) << (NU64)(((NI) 9))) | (NI)((NU64)((NI)((NU64)(i_68228_1689653243) << (NU64)(((NI) 6)))) + (NU64)(j_68232_1689653243)));
													{
														...
														c_68234_1689653243 = ((Basechunk30238*) ((NI)((NU64)(s_68218_1689653243) << (NU64)(((NI) 12)))));
														{
																...
																limit_68245_1689653243 = (NI)(a_68242_1689653243 + (*c_68237_1689653243).acc);
																{
																	while (1) {
																		...
																		x_68206_1689653243 = ((void*) (a_68242_1689653243));
																		{
																			...
																			if (!LOC35) goto LA36;
																			c0 = ((Cell48104*) (x_68206_1689653243));
																			{
																				NIM_BOOL LOC40;
																				LOC40 = (NIM_BOOL)0;
															...
															LA29: ;
															{
																...
																{
																	NIM_BOOL LOC46;
																	Cell48104* c_68251_1689653243;
																	LOC46 = (NIM_BOOL)0;
																	LOC46 = iscell_31956_1689653243(x_68206_1689653243);
																	if (!LOC46) goto LA47;
																	c_68251_1689653243 = ((Cell48104*) (x_68206_1689653243));
																	{
																		NIM_BOOL LOC51;
																		LOC51 = (NIM_BOOL)0;
...
N_NIMCALL(void, collectctbody_75609_1689653243)(Gcheap50618* gch0) {
	...
	(*gch0).stat.stackscans += ((NI) 1);
	{
		...
		if (!LOC4) goto LA5;
		{
			...
			LOC9 = (NIM_BOOL)0;
			LOC10 = (NI)0;
			LOC10 = getoccupiedmem_48029_1689653243((&(*gch0).region));
...
{	L0 = (*gch0).zct.len;
	d0 = (*gch0).zct.d;
	{
		...
		LA35: ;
		add_48191_1689653243((&(*gch0).zct), res0);
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(void*, rawnewobj_58201_1689653243)(TNimType* typ0, NI size0, Gcheap50618* gch0) {
	...
	LOC1 = (void*)0;
	LOC1 = rawalloc_37404_1689653243((&(*gch0).region), (NI)(size0 + ((NI)sizeof(Cell48104))));
	res0 = ((Cell48104*) (LOC1));
	(*res0).typ = typ0;
	(*res0).refcount = ((NI) 4);
...
N_NIMCALL(void*, newObjRC1)(TNimType* typ0, NI size0) {
	...
	LOC1 = (void*)0;
	LOC1 = rawalloc_37404_1689653243((&gch_50658_1689653243.region), (NI)(size0 + ((NI)sizeof(Cell48104))));
	res0 = ((Cell48104*) (LOC1));
	(*res0).typ = typ0;
	(*res0).refcount = ((NI) 8);
	result0 = celltousr_52222_1689653243(res0);
...
N_NIMCALL(void*, growobj_64003_1689653243)(void* old0, NI newsize0, Gcheap50618* gch0) {
	...
	LOC1 = (void*)0;
	LOC1 = rawalloc_37404_1689653243((&(*gch0).region), (NI)(newsize0 + ((NI)sizeof(Cell48104))));
	res0 = ((Cell48104*) (LOC1));
	elemsize0 = ((NI) 1);
	{
	...
	memcpy(((void*) (res0)), ((void*) (ol0)), ((NI) ((NI)(oldsize0 + ((NI)sizeof(Cell48104))))));
	zeroMem(((void*) ((NI)((NU64)((NI)((NU64)(((NI) (res0))) + (NU64)(oldsize0))) + (NU64)(((NI)sizeof(Cell48104)))))), ((NI) ((NI)(newsize0 - oldsize0))));
	{
