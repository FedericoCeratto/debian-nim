...
STRING_LITERAL(TMP5256, "server.type", 11);
STRING_LITERAL(TMP5257, "stdin", 5);
STRING_LITERAL(TMP5258, "tcp", 3);
STRING_LITERAL(TMP5259, "quit", 4);
STRING_LITERAL(TMP5261, "server.port", 11);
STRING_LITERAL(TMP5262, "server.address", 14);
STRING_LITERAL(TMP5265, "\015\012", 2);
STRING_LITERAL(TMP5273, "Invalid server.type:", 20);
...
appendString(LOC1, ((NimStringDesc*) &TMP5265));
...
N_NIMCALL(void, serve_574254)(TY574256 action) {
	...
	typ = getconfigvar_166335(((NimStringDesc*) &TMP5256));
	if (eqStrings(typ, ((NimStringDesc*) &TMP5257))) goto LA1;
	if (eqStrings(typ, ((NimStringDesc*) &TMP5258))) goto LA2;
	...
	{
		{
			while (1) {
				...
				{
					if (!eqStrings(line, ((NimStringDesc*) &TMP5259))) goto LA10;
					exit(((NI) 0));
				}
				LA10: ;
				LOC12 = 0;
	...
	LA2: ;
	{
		...
		p = getconfigvar_166335(((NimStringDesc*) &TMP5261));
		{
			NI LOC18;
		...
		LA14: ;
		LOC20 = 0;
		LOC20 = getconfigvar_166335(((NimStringDesc*) &TMP5262));
		...
		writelnhook_190441.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				...
				action();
				gerrorcounter_190396 = ((NI) 0);
				send_571208((*HEX3Aenv_574447).stdoutsocket574408, ((NimStringDesc*) &TMP5265), 2);
	...
	LA3: ;
	{
		printf("%s%s\012", ((NimStringDesc*) &TMP5273)? (((NimStringDesc*) &TMP5273))->data:"nil", typ? (typ)->data:"nil");
...
TMP1150[0].len = 2; TMP1150[0].kind = 2; TMP1150[0].sons = &TMP5242[0];
NTI574426.node = &TMP1150[0];
NTI574448.size = sizeof(TY574426*);
NTI574448.kind = 22;
NTI574448.base = (&NTI574426);
NTI574448.flags = 2;
NTI574448.marker = TMP5255;
}
