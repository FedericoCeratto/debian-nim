...
STRING_LITERAL(TMP1696, "startswith", 10);
STRING_LITERAL(TMP1697, "", 0);
STRING_LITERAL(TMP1698, "true", 4);
STRING_LITERAL(TMP1699, "false", 5);
STRING_LITERAL(TMP1700, "leading", 7);
STRING_LITERAL(TMP1701, "trailing", 8);
static NIM_CONST char136Set TMP1702 = {
0x00, 0x3E, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1703, "sub", 3);
STRING_LITERAL(TMP1704, "by", 2);
...
N_NIMCALL(NIM_BOOL, boolarg_287023_1413030668)(Tnode264794* n0, NimStringDesc* name0, NI pos0, NIM_BOOL default_287028_1413030668) {
	...
	LA3: ;
	{
		...
		if (!(LOC6)) goto LA7;
		LOC6 = identeq_194450_791273810((*x0).kindU.S5.ident, ((NimStringDesc*) &TMP1698));
		LA7: ;
		if (!LOC6) goto LA8;
		result0 = NIM_TRUE;
	}
	...
	LA8: ;
	{
		...
		if (!(LOC11)) goto LA12;
		LOC11 = identeq_194450_791273810((*x0).kindU.S5.ident, ((NimStringDesc*) &TMP1699));
		LA12: ;
		if (!LOC11) goto LA13;
		result0 = NIM_FALSE;
	}
...
N_NIMCALL(Tllstream254204*, filterstrip_287006_1413030668)(Tllstream254204* stdin_287008_1413030668, NimStringDesc* filename0, Tnode264794* call0) {
	...
	pattern0 = strarg_287017_1413030668(call0, ((NimStringDesc*) &TMP1696), ((NI) 1), ((NimStringDesc*) &TMP1697));
	leading0 = boolarg_287023_1413030668(call0, ((NimStringDesc*) &TMP1700), ((NI) 2), NIM_TRUE);
	trailing0 = boolarg_287023_1413030668(call0, ((NimStringDesc*) &TMP1701), ((NI) 3), NIM_TRUE);
	result0 = llstreamopen_254218_597494479(((NimStringDesc*) &TMP1697));
	line0 = rawNewString(((NI) 80));
	{
		while (1) {
			...
			if (!LOC3) goto LA2;
			stripped0 = nsuStrip(line0, leading0, trailing0, TMP1702);
			{
				NIM_BOOL LOC6;
				LOC6 = (NIM_BOOL)0;
...
N_NIMCALL(Tllstream254204*, filterreplace_287001_1413030668)(Tllstream254204* stdin_287003_1413030668, NimStringDesc* filename0, Tnode264794* call0) {
	...
	NimStringDesc* line0;
	result0 = (Tllstream254204*)0;
	sub0 = strarg_287017_1413030668(call0, ((NimStringDesc*) &TMP1703), ((NI) 1), ((NimStringDesc*) &TMP1697));
	{
		if (!((sub0 ? sub0->Sup.len : 0) == ((NI) 0))) goto LA3;
		invalidpragma_287029_1413030668(call0);
	}
	LA3: ;
	by0 = strarg_287017_1413030668(call0, ((NimStringDesc*) &TMP1704), ((NI) 2), ((NimStringDesc*) &TMP1697));
	result0 = llstreamopen_254218_597494479(((NimStringDesc*) &TMP1697));
	line0 = rawNewString(((NI) 80));
	{
		while (1) {
