...
N_NIMCALL(Memfile265208, open_265807)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	LA6: ;
	{
		...
		raiseoserror_126009(LOC20, ((NimStringDesc*) &TMP1535));
	}
	LA13: ;
	{
		if (!!((newfilesize == ((NI) -1)))) goto LA23;
		{
			...
			raiseoserror_126009(LOC35, ((NimStringDesc*) &TMP1535));
		}
		LA28: ;
	}
	LA23: ;
	...
	LA38: ;
	{
		...
		LA44: ;
		{
			...
			raiseoserror_126009(LOC52, ((NimStringDesc*) &TMP1535));
		}
		LA41: ;
	}
	LA36: ;
	...
	result.mem = mmap(NIM_NIL, result.size, LOC53, LOC59, result.handle, ((off_t) (offset)));
	{
		...
		raiseoserror_126009(LOC74, ((NimStringDesc*) &TMP1535));
	}
	LA67: ;
	return result;
}
...
N_NIMCALL(void, close_266249)(Memfile265208* f) {
	...
	{
		if (!error) goto LA11;
		raiseoserror_126009(lasterr, ((NimStringDesc*) &TMP1535));
	}
	LA11: ;
}
