...
STRING_LITERAL(TMP5580, "nodejs", 6);
STRING_LITERAL(TMP5581, "node", 4);
STRING_LITERAL(TMP5582, "iojs", 4);
...
N_NIMCALL(NimStringDesc*, findnodejs_567003_1446018522)(void) {
	...
	result0 = findexe_137001_2125978480(((NimStringDesc*) &TMP5580));
	{
		...
		result0 = findexe_137001_2125978480(((NimStringDesc*) &TMP5581));
	}
	LA3: ;
	{
		if (!((result0) && (result0)->Sup.len == 0)) goto LA7;
		result0 = findexe_137001_2125978480(((NimStringDesc*) &TMP5582));
	}
	LA7: ;
	return result0;
}
