...
STRING_LITERAL(TMP1718, "nim.gid", 7);
STRING_LITERAL(TMP4717, "\012", 1);
...
N_NIMCALL(NimStringDesc*, togid_263435_644355110)(NimStringDesc* f0) {
	...
	result0 = completegeneratedfilepath_165201_2607990831(((NimStringDesc*) &TMP1718), NIM_TRUE);
	return result0;
}
...
N_NIMCALL(void, loadmaxids_263467_644355110)(NimStringDesc* project0) {
	...
	f0 = (FILE*)0;
	{
		...
		LOC4 = (NIM_BOOL)0;
		LOC4 = open_15803_1689653243(&f0, LOC3, ((Filemode12409) 0), ((NI) -1));
		if (!LOC4) goto LA5;
		line0 = rawNewString(((NI) 20));
		{
			...
			NI frontendid0;
			LOC9 = (NIM_BOOL)0;
			LOC9 = readline_15913_1689653243(f0, (&line0));
			if (!LOC9) goto LA10;
			frontendid0 = nsuParseInt(line0);
			{
				...
				NI backendid0;
				LOC14 = (NIM_BOOL)0;
				LOC14 = readline_15913_1689653243(f0, (&line0));
				if (!LOC14) goto LA15;
...
static N_INLINE(void, writeline_165405_1689653243)(FILE* f0, NimStringDesc** x0, NI x0Len0) {
	...
	write_15889_1689653243(f0, ((NimStringDesc*) &TMP4717));
}
...
N_NIMCALL(void, savemaxids_263439_644355110)(NimStringDesc* project0) {
	...
	f0 = open_15817_1689653243(LOC1, ((Filemode12409) 1), ((NI) -1));
