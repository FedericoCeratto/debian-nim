...
{	{
	...
	dispa_311689((*d).target, result, blockstart, ((NimStringDesc*) &TMP2217), LOC6, 0);
	{
		...
		LA13: ;
		{
			...
			{
				while (1) {
					if (!(i_318630 < L_318632)) goto LA17;
			...
			if (!!((d_316692 == NIM_NIL))) goto LA4;
			{
				while (1) {
					...
					y_316696 = cstrToNimstr(((NCSTRING) ((*x_316694).d_name)));
					{
						...
						NU8 k_316700;
						LOC14 = 0;
						LOC14 = !(eqStrings(y_316696, ((NimStringDesc*) &TMP4917)));
						if (!(LOC14)) goto LA15;
						...
						path_314837 = y_316696;
						{
							...
							if (!(LOC35)) goto LA36;
							LOC35 = nsuEndsWith(path_314837, ((NimStringDesc*) &TMP4919));
							LA36: ;
							if (!LOC35) goto LA37;
							fileentries = 0;
...
appendString(LOC86, ((NimStringDesc*) &TMP4920));
appendString(LOC86, LOC88);
	...
	LOC90.ClPrc = ((TMP4923) (cmp_4717)); LOC90.ClEnv = NIM_NIL;
...
N_NIMCALL(void, striptoclevel_312981)(NimStringDesc* s, TY313067* Result) {
	...
	unsureAsgnRef((void**) (&(*Result).Field1), HEX5BHEX5D_85765(s, LOC8));
}
...
N_NIMCALL(NimStringDesc*, generatesymbolindex_312895)(TY314702* symbols) {
	...
	i = ((NI) 0);
	{
		while (1) {
			...
			cleanedkeyword = HEX5BHEX5D_85765(keyword, LOC3);
