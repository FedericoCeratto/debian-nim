...
STRING_LITERAL(TMP1530, "overflow", 8);
	...
	LA1: ;
	{
		...
		(*b) = IL64(0);
		{
			while (1) {
				...
				TMP1225 = mulInt64((*b), IL64(10));
				TMP1226 = subInt(((NI) (((NU8)(s->data[i])))), ((NI) 48));
				TMP1227 = subInt64((NI64)(TMP1225), ((NI64) ((NI)(TMP1226))));
				(*b) = (NI64)(TMP1227);
		...
		TMP1230 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP1230);
		TMP1231 = subInt(i, start);
		result = (NI)(TMP1231);
	}
	LA10: ;
	return result;
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = npuParseBiggestInt(s, (&res), start);
	{
		...
		LOC9 = 0;
		LOC9 = (*e_98455).Sup.Sup.message; (*e_98455).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1530));
