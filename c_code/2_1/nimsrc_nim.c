...
N_NIMCALL(void, handlecmdline_528607)(void) {
	...
	LA4: ;
	{
		...
		LA7: ;
		loadconfigs_187609(((NimStringDesc*) &TMP1900));
		initvars_171876();
		...
		LA20: ;
		{
			if (!(gerrorcounter_165015 == ((NI) 0))) goto LA25;
			{
				...
				{
					NimStringDesc* LOC35;
					if (!eqStrings(gprojectname_155234, ((NimStringDesc*) &TMP5025))) goto LA33;
					LOC35 = 0;
					LOC35 = gprojectfull_155236; gprojectfull_155236 = copyStringRC1(((NimStringDesc*) &TMP5026));
				...
				LA33: ;
				{
					...
					LA42: ;
					{
						...
						NimStringDesc* LOC48;
						LOC46 = 0;
						LOC46 = noschangeFileExt(gprojectfull_155236, ((NimStringDesc*) &TMP5028));
						LOC47 = 0;
