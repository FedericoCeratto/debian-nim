...
N_NIMCALL(void, TMP5480)(void* p, NI op);
...
STRING_LITERAL(TMP5481, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP5482, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP5483, "", 0);
STRING_LITERAL(TMP5484, "dot", 3);
...
N_NIMCALL(void, adddependencyaux_546014_2841479672)(NimStringDesc* importing0, NimStringDesc* imported0) {
	...
	addf_174205_2381377266(&gdotgraph_546012_2841479672, ((NimStringDesc*) &TMP5481), LOC1, 2);
}
...
N_NIMCALL(void, generatedot_546003_2841479672)(NimStringDesc* project0) {
	...
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP5483));
	LOC1[0] = rope_173277_2381377266(LOC3);
	LOC1[1] = gdotgraph_546012_2841479672;
	LOC4 = (Ropeobj173006*)0;
	LOC4 = HEX25_173905_2381377266(((NimStringDesc*) &TMP5482), LOC1, 2);
	LOC5 = (NimStringDesc*)0;
	LOC5 = noschangeFileExt(project0, ((NimStringDesc*) &TMP5484));
