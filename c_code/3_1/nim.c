...
appendString(LOC7, ((NimStringDesc*) &TMP4886));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_616607)(void) {
	...
	LA4: ;
	{
		processcmdline_610209(((NU8) 0), ((NimStringDesc*) &TMP1886));
		{
			TSafePoint TMP1887;
			TY117804 p;
			NimStringDesc* LOC15;
			...
			pushSafePoint(&TMP1887);
			TMP1887.status = _setjmp(TMP1887.context);
			if (TMP1887.status == 0) {
			...
			if (TMP1887.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_220811(((NimStringDesc*) &TMP1912));
		initvars_202820();
		processcmdline_610209(((NU8) 1), ((NimStringDesc*) &TMP1886));
		maincommand_614027();
		{
			NimStringDesc* LOC22;
			...
			if (!(gerrorcounter_196306 == 0)) goto LA25;
			{
				if (!((gglobaloptions_169118 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					LA37: ;
					{
						...
						NimStringDesc* LOC43;
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP4887));
						LOC42 = 0;
...
appendString(LOC44, arguments_210144);
					execexternalprogram_202907(LOC44, ((NimStringDesc*) &TMP1886));
				}
				goto LA31;
				LA33: ;
				{
					...
					LA48: ;
					{
						NimStringDesc* LOC51;
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP1886));
...
appendString(LOC52, arguments_210144);
					execexternalprogram_202907(LOC52, ((NimStringDesc*) &TMP1886));
				}
				LA31: ;
			}
			LA29: ;
