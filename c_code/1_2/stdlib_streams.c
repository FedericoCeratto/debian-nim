...
N_NIMCALL(filestreamobj137742*, newfilestream_137814)(FILE* f);
...
N_NIMCALL(NI, fsreaddata_137797)(streamobj137035* s, void* buffer, NI buflen);
N_NIMCALL(NI, readbuffer_13027)(FILE* f, void* buffer, NI len);
N_NIMCALL(void, fswritedata_137806)(streamobj137035* s, void* buffer, NI buflen);
...
N_NIMCALL(filestreamobj137742*, newfilestream_137814)(FILE* f) {
	...
	(*result).Sup.Readdataimpl = fsreaddata_137797;
	(*result).Sup.Writedataimpl = fswritedata_137806;
