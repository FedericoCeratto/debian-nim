...
STRING_LITERAL(TMP1978, "This function cannot be used on non-blocking sockets.", 53);
STRING_LITERAL(TMP1979, "Could not send all data.", 24);
TNimNode* NimDT_182607_isbuffered[3];
STRING_LITERAL(TMP4863, "", 0);
STRING_LITERAL(TMP4865, "Call to \'", 9);
STRING_LITERAL(TMP4866, "\' timed out.", 12);
STRING_LITERAL(TMP4868, "readLine", 8);
STRING_LITERAL(TMP4869, "\015\012", 2);
...
N_NIMCALL(void, send_192808)(tsocketimpl182607* socket, NimStringDesc* data) {
	NI sent;
	{
		...
		e_192814 = 0;
		e_192814 = (valueerror3249*) newObj((&NTI21601), sizeof(valueerror3249));
		(*e_192814).Sup.Sup.m_type = (&NTI3249);
		LOC5 = 0;
		LOC5 = (*e_192814).Sup.message; (*e_192814).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1978));
	...
	LA8: ;
	{
		...
		e_193003 = 0;
		e_193003 = (oserror3233*) newObj((&NTI115012), sizeof(oserror3233));
		(*e_193003).Sup.Sup.Sup.m_type = (&NTI3233);
		LOC15 = 0;
		LOC15 = (*e_193003).Sup.Sup.message; (*e_193003).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1979));
	...
	LA3: ;
	{
		...
		hints.ai_protocol = toint_183441(((NU8) 6));
		{
			...
			gairesult_184808 = getaddrinfo(address->data, LOC13->data, (&hints), &ailist);
			{
				...
				e_185002 = 0;
				e_185002 = (oserror3233*) newObj((&NTI115012), sizeof(oserror3233));
...
N_NIMCALL(void, acceptaddr_185248)(tsocketimpl182607* server, tsocketimpl182607** client, NimStringDesc** address) {
	...
	sock_185260 = accept((*server).Fd, ((struct sockaddr*) ((&sockaddress_185256))), (&addrlen_185258));
	{
		...
		err_185262 = oslasterror_115041();
		{
			...
			unsureAsgnRef((void**) (&(*address)), copyString(((NimStringDesc*) &TMP4863)));
			goto BeforeRet;
		}
		goto LA5;
		LA9: ;
		{
			raiseoserror_115009(err_185262);
		}
		LA5: ;
	}
	goto LA1;
...
N_NIMCALL(void, accept_186401)(tsocketimpl182607* server, tsocketimpl182607** client) {
	...
	addrdummy = copyString(((NimStringDesc*) &TMP4863));
...
appendString(LOC22, ((NimStringDesc*) &TMP4865));
...
appendString(LOC22, ((NimStringDesc*) &TMP4866));
		...
		selret = select_190107((&s), (NI32)(timeout - ((NI) (((NF)((*waited)) * (NF)(1.0000000000000000e+03))))));
		{
			NI32 LOC28;
			if (!(selret < 0)) goto LA26;
			LOC28 = 0;
			LOC28 = oslasterror_115041();
			raiseoserror_115009(LOC28);
		}
		LA26: ;
		{
...
appendString(LOC33, ((NimStringDesc*) &TMP4865));
...
N_NIMCALL(void, readline_191447)(tsocketimpl182607* socket, NimStringDesc** line, NI timeout) {
	...
	(*line) = setLengthStr((*line), 0);
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_190618(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4868));
			...
			LA4: ;
			{
				...
				LOC15 = 0;
				LOC15 = waitfor_190618(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4868));
...
appendString((*line), ((NimStringDesc*) &TMP4869));
				}
				LA28: ;
				goto BeforeRet;
			}
...
TMP126[3].len = 3; TMP126[3].kind = 2; TMP126[3].sons = &TMP4859[0];
