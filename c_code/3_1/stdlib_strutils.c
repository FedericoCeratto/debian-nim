...
101}
;
STRING_LITERAL(TMP5003, "GB", 2);
STRING_LITERAL(TMP5004, "MB", 2);
STRING_LITERAL(TMP5005, "KB", 2);
STRING_LITERAL(TMP5006, "B", 1);
...
N_NOINLINE(void, invalidformatstring_100760)(void) {
	...
	NimStringDesc* LOC1;
	e_100764 = 0;
	e_100764 = (Valueerror3449*) newObj((&NTI22601), sizeof(Valueerror3449));
...
N_NIMCALL(NF, nsuParseFloat)(NimStringDesc* s) {
	...
	L = npuParseFloat(s, (&result), ((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		e_97544 = 0;
		e_97544 = (Valueerror3449*) newObj((&NTI22601), sizeof(Valueerror3449));
...
N_NIMCALL(NI64, nsuParseBiggestInt)(NimStringDesc* s) {
	...
	L = npuParseBiggestInt(s, (&result), ((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		e_97519 = 0;
		e_97519 = (Valueerror3449*) newObj((&NTI22601), sizeof(Valueerror3449));
...
N_NIMCALL(NI, nsuParseInt)(NimStringDesc* s) {
	...
	L = npuParseInt(s, (&result), ((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		e_97494 = 0;
		e_97494 = (Valueerror3449*) newObj((&NTI22601), sizeof(Valueerror3449));
		...
		last_97189 = ((NI) 0);
		{
			if (!(((NI) 0) < (s ? s->Sup.len : 0))) goto LA4;
			{
				while (1) {
					NI first_97191;
					NimStringDesc* LOC12;
					if (!(last_97189 <= (s ? s->Sup.len : 0))) goto LA7;
					first_97191 = last_97189;
					{
						while (1) {
							NIM_BOOL LOC10;
							LOC10 = 0;
							LOC10 = (last_97189 < (s ? s->Sup.len : 0));
							if (!(LOC10)) goto LA11;
							LOC10 = !(((NU8)(s->data[last_97189]) == (NU8)(sep)));
							LA11: ;
							if (!LOC10) goto LA9;
							last_97189 += ((NI) 1);
						} LA9: ;
					}
					x_97158 = copyStrLast(s, first_97191, (NI)(last_97189 - ((NI) 1)));
					result = (TY122208*) incrSeq(&(result)->Sup, sizeof(NimStringDesc*));
					LOC12 = 0;
					LOC12 = result->data[result->Sup.len-1]; result->data[result->Sup.len-1] = copyStringRC1(x_97158);
...
appendString(LOC5, ((NimStringDesc*) &TMP5003));
		result = LOC5;
	}
	goto LA1;
	LA3: ;
...
appendString(LOC12, ((NimStringDesc*) &TMP5004));
		result = LOC12;
	}
	goto LA1;
	LA10: ;
...
appendString(LOC19, ((NimStringDesc*) &TMP5005));
		result = LOC19;
	}
	goto LA1;
	LA17: ;
...
appendString(LOC24, ((NimStringDesc*) &TMP5006));
		result = LOC24;
	}
	LA1: ;
	return result;
