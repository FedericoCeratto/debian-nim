...
STRING_LITERAL(TMP3629, "ithField", 8);
STRING_LITERAL(TMP3630, "ithField(record case branch)", 28);
STRING_LITERAL(TMP3631, "invalid field at index ", 23);
STRING_LITERAL(TMP3633, "compiler/semmacrosanity.nim", 27);
NIM_CONST TY198019 TMP3632 = {((NimStringDesc*) &TMP3633),
((NI) 51)}
;
STRING_LITERAL(TMP3634, "() must have a tuple type", 25);
STRING_LITERAL(TMP3635, "[] must have some form of array type", 36);
STRING_LITERAL(TMP3636, "{} must have the set type", 25);
STRING_LITERAL(TMP3637, "float literal must have some float type", 39);
STRING_LITERAL(TMP3638, "integer literal must have some int type", 39);
STRING_LITERAL(TMP3639, "string literal must be of some string type", 42);
STRING_LITERAL(TMP3640, "nil literal must be of some pointer type", 40);
	...
	{
		{
			...
			internalerror_191100_155036129((*n0).info, ((NimStringDesc*) &TMP3629));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_445105_658252590 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_191100_155036129((*n0).info, ((NimStringDesc*) &TMP3630));
					}
					break;
					}
					res_445105_658252590 += ((NI) 1);
...
appendString(LOC10, ((NimStringDesc*) &TMP3631));
					...
					{
						{
							...
							LOC17 = HEX24_191183_1689653243(TMP3632);
...
appendString(LOC32, ((NimStringDesc*) &TMP3631));
appendString(LOC32, LOC33);
		...
		LA38: ;
		{
			globalerror_191076_155036129((*n0).info, ((NimStringDesc*) &TMP3634));
		}
		LA19: ;
	}
	break;
	case ((Tnodekind264020) 41):
	{
		...
		LA44: ;
		{
			globalerror_191076_155036129((*n0).info, ((NimStringDesc*) &TMP3635));
		}
		LA42: ;
	}
	break;
