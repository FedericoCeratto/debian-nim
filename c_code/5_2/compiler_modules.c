...
((NI) 41)}
;
STRING_LITERAL(TMP3708, "system.nim", 10);
STRING_LITERAL(TMP4522, "", 0);
STRING_LITERAL(TMP4523, "nim", 3);
STRING_LITERAL(TMP5238, "stdin", 5);
...
N_NIMCALL(void, compilesystemmodule_575910)(void) {
	{
		...
		LOC5 = 0;
		LOC5 = HEX2F_123481(libpath_166233, ((NimStringDesc*) &TMP3708));
...
N_NIMCALL(void, wantmainmodule_575931)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_195096(gcmdlineinfo_190321, ((NU16) 191), ((NimStringDesc*) &TMP4522));
	}
	LA3: ;
	LOC5 = 0;
	LOC5 = nosaddFileExt(gprojectfull_166236, ((NimStringDesc*) &TMP4523));
...
N_NIMCALL(void, compileproject_575994)(NI32 projectfileidx) {
	...
	LOC1 = 0;
	LOC1 = HEX2F_123481(libpath_166233, ((NimStringDesc*) &TMP3708));
...
N_NIMCALL(Tsym224841*, makestdinmodule_576018)(void) {
	Tsym224841* result;
	result = 0;
	result = makemodule_576007(((NimStringDesc*) &TMP5238));
	return result;
}
