...
STRING_LITERAL(TMP1367, "nimrod.gid", 10);
...
N_NIMCALL(NimStringDesc*, togid_225467)(NimStringDesc* f) {
	...
	result = 0;
	result = completegeneratedfilepath_171001(((NimStringDesc*) &TMP1367), NIM_TRUE);
	return result;
}
...
N_NIMCALL(void, idsynchronizationpoint_225458)(NI idrange) {
	gfrontendid_225012 = (NI64)((NI64)((NI64)((NI64)(gfrontendid_225012 / idrange) + 1) * idrange) + 1);
}
...
static N_INLINE(void, writeln_171205)(FILE* f_171209, NimStringDesc** x_171213, NI x_171213Len0) {
	...
	write_12865(f_171209, ((NimStringDesc*) &TMP4138));
}
