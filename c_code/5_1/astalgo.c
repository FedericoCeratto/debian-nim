...
STRING_LITERAL(TMP3187, "lookupInRecord", 14);
STRING_LITERAL(TMP3188, "lookupInRecord(record case branch)", 34);
STRING_LITERAL(TMP3189, "lookupInRecord()", 16);
...
N_NIMCALL(tsym225846*, lookupinrecord_235236)(tnode225816* n, tident200021* field) {
	...
	default:
	{
		internalerror_197987((*n).Info, ((NimStringDesc*) &TMP3189));
	}
	break;
	}
	BeforeRet: ;
