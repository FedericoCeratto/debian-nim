...
N_NIMCALL(void, parseline_218149)(Ttmplparser218020* p) {
	...
	LA7: ;
	{
		...
		case ((NU16) 22):
		{
			...
			{
				(*p).info.col = ((NI16) (j));
				localerror_166155((*p).info, ((NU16) 163), ((NimStringDesc*) &TMP1413));
			}
			LA20: ;
			LOC25 = 0;
				...
				{
					{
						...
						case 123:
						{
							...
							curly = ((NI) 0);
							{
								while (1) {
									...
									case 0:
									{
										localerror_166155((*p).info, ((NU16) 188), ((NimStringDesc*) &TMP1422));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).info.col = ((NI16) (j));
								localerror_166155((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP1410));
							}
							LA80: ;
						}
						break;
