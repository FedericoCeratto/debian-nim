...
N_NIMCALL(void, TMP4819)(void* p, NI op);
...
STRING_LITERAL(TMP4813, "index out of bounds", 19);
STRING_LITERAL(TMP4814, "sequence is nil", 15);
...
{	memset((void*)(&result0), 0, sizeof(result0));
	...
	case ((Tnimkind199803) 16):
	{
		...
		bs0 = (*(*((TNimType*) (x0.rawtypeptr))).base).size;
		{
			...
			LOC6 = (*e_201633_1760177012).Sup.message; (*e_201633_1760177012).Sup.message = copyStringRC1(((NimStringDesc*) &TMP4813));
	...
	case ((Tnimkind199803) 24):
	{
		...
		s0 = (*((void**) (x0.value)));
		{
			...
			LOC12 = (*e_201647_1760177012).Sup.message; (*e_201647_1760177012).Sup.message = copyStringRC1(((NimStringDesc*) &TMP4814));
		...
		bs0 = (*(*((TNimType*) (x0.rawtypeptr))).base).size;
		{
			...
			LOC17 = (*e_201670_1760177012).Sup.message; (*e_201670_1760177012).Sup.message = copyStringRC1(((NimStringDesc*) &TMP4813));
