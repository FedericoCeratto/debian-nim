...
N_NIMCALL(void, tmtotimeinfo_101848)(struct tm* tm, NIM_BOOL local, timeinfo101205* Result) {
	...
	LA4: ;
	{
		LOC1.Tzname = copyString(((NimStringDesc*) &TMP3098));
	}
	LA2: ;
	{
		if (!local) goto LA16;
...
static TNimNode* TMP3092[12];
NI TMP3094;
static char* NIM_CONST TMP3093[12] = {
"mJan", 
"mFeb", 
"mMar", 
"mApr", 
...
"mNov", 
"mDec"};
static TNimNode* TMP3095[7];
NI TMP3097;
static char* NIM_CONST TMP3096[7] = {
"dMon", 
"dTue", 
"dWed", 
"dThu", 
...
NTI101006.base = 0;
NTI101006.flags = 3;
for (TMP3094 = 0; TMP3094 < 12; TMP3094++) {
TMP15[TMP3094+6].kind = 1;
TMP15[TMP3094+6].offset = TMP3094;
TMP15[TMP3094+6].name = TMP3093[TMP3094];
TMP3092[TMP3094] = &TMP15[TMP3094+6];
}
TMP15[18].len = 12; TMP15[18].kind = 2; TMP15[18].sons = &TMP3092[0];
...
NTI101008.base = 0;
NTI101008.flags = 3;
for (TMP3097 = 0; TMP3097 < 7; TMP3097++) {
TMP15[TMP3097+21].kind = 1;
TMP15[TMP3097+21].offset = TMP3097;
TMP15[TMP3097+21].name = TMP3096[TMP3097];
TMP3095[TMP3097] = &TMP15[TMP3097+21];
}
TMP15[28].len = 7; TMP15[28].kind = 2; TMP15[28].sons = &TMP3095[0];
...
TMP15[0].len = 11; TMP15[0].kind = 2; TMP15[0].sons = &TMP3091[0];
