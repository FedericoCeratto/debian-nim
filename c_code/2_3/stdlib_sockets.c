...
appendString(LOC22, ((NimStringDesc*) &TMP4871));
		...
		selret = select_191101((&s), (NI64)(timeout - ((NI) (((NF)((*waited)) * (NF)(1.0000000000000000e+03))))));
		{
			NI32 LOC28;
...
N_NIMCALL(void, readline_192447)(tsocketimpl183607* socket, NimStringDesc** line, NI timeout) {
	...
	(*line) = setLengthStr((*line), 0);
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_191617(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4873));
			...
			LA4: ;
			{
				...
				LOC15 = 0;
				LOC15 = waitfor_191617(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4873));
