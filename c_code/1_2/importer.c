...
STRING_LITERAL(TMP3322, "as", 2);
STRING_LITERAL(TMP3323, " ", 1);
STRING_LITERAL(TMP3324, ".", 1);
STRING_LITERAL(TMP3325, "/", 1);
STRING_LITERAL(TMP3326, "invalid module name: \'$1\'", 25);
STRING_LITERAL(TMP3327, "module alias must be an identifier", 34);
STRING_LITERAL(TMP3328, "A module cannot import itself", 29);
STRING_LITERAL(TMP3329, "importAllSymbols: ", 18);
STRING_LITERAL(TMP3330, "rawImportSymbol", 15);
STRING_LITERAL(TMP3332, "importSymbol: 2", 15);
STRING_LITERAL(TMP3333, "importSymbol: 3", 15);
...
N_NIMCALL(NimStringDesc*, getmodulename_299018)(tnode226816* n) {
	...
	case ((NU8) 22):
	{
		result = nosunixToNativePath((*n).kindU.S3.Strval, ((NimStringDesc*) &TMP3321));
	}
	break;
	case ((NU8) 2):
	{
	...
	case ((NU8) 29):
	{
		NimStringDesc* LOC12;
		{
			...
			if (!(LOC7)) goto LA8;
			LOC9 = 0;
			LOC9 = getident_201472(((NimStringDesc*) &TMP3322));
		...
		result = nsuReplaceStr(LOC12, ((NimStringDesc*) &TMP3323), ((NimStringDesc*) &TMP3321));
	}
	break;
	case ((NU8) 45):
	{
		...
		result = nsuReplaceStr(LOC14, ((NimStringDesc*) &TMP3324), ((NimStringDesc*) &TMP3325));
	}
	break;
	case ((NU8) 78):
	{
	...
	default:
	{
		...
		LOC18 = 0;
		LOC18 = nsuFormatSingleElem(((NimStringDesc*) &TMP3326), LOC17);
		localerror_198955((*n).Info, ((NU16) 4), LOC18);
		result = copyString(((NimStringDesc*) &TMP3321));
	}
	break;
	}
	BeforeRet: ;
...
N_NIMCALL(tsym226846*, importmoduleas_299892)(tnode226816* n, tsym226846* realmodule) {
	...
	LA3: ;
	{
		...
		LA8: ;
		if (!LOC6) goto LA9;
		localerror_198955((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3327));
	}
	goto LA1;
	LA9: ;
	{
...
N_NIMCALL(tsym226846*, myimportmodule_299991)(tcontext291021* c, tnode226816* n) {
	...
	f = checkmodulename_299237(n);
	{
		...
		result = importmoduleas_299892(n, LOC5);
		{
			...
			localerror_198955((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3328));
		}
		LA8: ;
		{
				...
				res_299427 = 0;
				{
					while (1) {
						...
						e = (*(*(*etyp).N).kindU.S6.Sons->data[j_299336]).kindU.S4.Sym;
						{
							...
							internalerror_198987((*s).Info, ((NimStringDesc*) &TMP3330));
						}
						LA27: ;
...
appendString(LOC15, ((NimStringDesc*) &TMP3329));
...
N_NIMCALL(void, importsymbol_299450)(tcontext291021* c, tnode226816* n, tsym226846* frommod) {
	...
	LA3: ;
	{
		...
		LA8: ;
		{
			...
			internalerror_198987((*n).Info, ((NimStringDesc*) &TMP3332));
		}
		LA12: ;
		switch ((*s).Kind) {
		case ((NU8) 12):
			...
			e = initidentiter_236147((&it), (*frommod).kindU.S3.Tab, (*s).Name);
			{
				while (1) {
					if (!!((e == NIM_NIL))) goto LA16;
					{
						...
						internalerror_198987((*n).Info, ((NimStringDesc*) &TMP3333));
					}
					LA19: ;
					rawimportsymbol_299249(c, e);
