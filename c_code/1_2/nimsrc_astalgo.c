...
{	result = 0;
	{
		...
		res_199872 = start;
		{
			while (1) {
				...
				LA7: ;
				{
					internalerror_166199((*list).info, ((NimStringDesc*) &TMP2679));
				}
				LA5: ;
				res_199872 += ((NI) 1);
			} LA4: ;
	...
	{
		{
			...
			internalerror_166199((*n).info, ((NimStringDesc*) &TMP2957));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_199551 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_166199((*n).info, ((NimStringDesc*) &TMP2958));
					}
					break;
					}
					res_199551 += ((NI) 1);
