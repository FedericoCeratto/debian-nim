...
static NIM_CONST TY212407 TMP2797 = {
...
N_NIMCALL(void, loadfile_284044)(Tlineinfo189352 info) {
	...
	LA3: ;
	{
		...
		gsourcefiles_284039->data[i].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2788));
		{
		...
		LOC17 = 0;
		LOC17 = &LOC16->Sup;
		open_282635((&lex), LOC17, ((NI) 8192), TMP2797);
		pos = lex.bufpos;
		{
			while (1) {
				...
				case 13:
				{
					NimStringDesc* LOC21;
					LOC21 = 0;
					LOC21 = gsourcefiles_284039->data[i].newline; gsourcefiles_284039->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP2798));
				...
				case 0:
				{
					NimStringDesc* LOC23;
					LOC23 = 0;
					LOC23 = gsourcefiles_284039->data[i].newline; gsourcefiles_284039->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP2799));
