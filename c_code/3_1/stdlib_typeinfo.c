...
STRING_LITERAL(TMP4811, "index out of bounds", 19);
STRING_LITERAL(TMP4812, "sequence is nil", 15);
...
{	memset((void*)(&result0), 0, sizeof(result0));
	...
	case ((Tnimkind199803) 16):
	{
		...
		bs0 = (*(*((TNimType*) (x0.rawtypeptr))).base).size;
		{
			...
			e_201633_1760177012 = (Indexerror3452*) newObj((&NTI137815), sizeof(Indexerror3452));
			(*e_201633_1760177012).Sup.Sup.m_type = (&NTI3452);
			LOC6 = (NimStringDesc*)0;
			LOC6 = (*e_201633_1760177012).Sup.message; (*e_201633_1760177012).Sup.message = copyStringRC1(((NimStringDesc*) &TMP4811));
	...
	case ((Tnimkind199803) 24):
	{
		...
		s0 = (*((void**) (x0.value)));
		{
			...
			e_201647_1760177012 = (Valueerror3446*) newObj((&NTI24025), sizeof(Valueerror3446));
			(*e_201647_1760177012).Sup.Sup.m_type = (&NTI3446);
			LOC12 = (NimStringDesc*)0;
			LOC12 = (*e_201647_1760177012).Sup.message; (*e_201647_1760177012).Sup.message = copyStringRC1(((NimStringDesc*) &TMP4812));
		...
		bs0 = (*(*((TNimType*) (x0.rawtypeptr))).base).size;
		{
			...
			e_201670_1760177012 = (Indexerror3452*) newObj((&NTI137815), sizeof(Indexerror3452));
			(*e_201670_1760177012).Sup.Sup.m_type = (&NTI3452);
			LOC17 = (NimStringDesc*)0;
			LOC17 = (*e_201670_1760177012).Sup.message; (*e_201670_1760177012).Sup.message = copyStringRC1(((NimStringDesc*) &TMP4811));
