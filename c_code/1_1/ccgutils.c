...
appendString(LOC6, LOC7);
	...
	}
	{
		...
		i_549785 = 0;
		HEX3Atmp_549796 = 0;
		HEX3Atmp_549796 = (NI32)(name->Sup.len - 1);
		res_549799 = 1;
		{
			while (1) {
				NIM_CHAR c;
...
N_NIMCALL(trope178009*, makellvmstring_549816)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP3962));
	{
		...
		i_549834 = 0;
		HEX3Atmp_549847 = 0;
		HEX3Atmp_549847 = (NI32)(s->Sup.len - 1);
		res_549850 = 0;
		{
			while (1) {
				...
				{
					trope178009* LOC8;
					if (!(((NI) ((NI32)((NI32)(i_549834 + 1) % 64))) == 0)) goto LA6;
					LOC8 = 0;
...
N_NIMCALL(NI64, hashstring_549156)(NimStringDesc* s) {
	...
	result = 0;
	{
		...
		b = IL64(0);
		{
			...
			i_549173 = 0;
			HEX3Atmp_549242 = 0;
			HEX3Atmp_549242 = (NI32)(s->Sup.len - 1);
			res_549245 = 0;
			{
				while (1) {
	...
	LA3: ;
	{
		...
		a = ((NI32) 0);
		{
			...
			i_549195 = 0;
			HEX3Atmp_549249 = 0;
			HEX3Atmp_549249 = (NI32)(s->Sup.len - 1);
			res_549252 = 0;
			{
				while (1) {
