...
N_NIMCALL(void, initspecials_203403)(void);
...
NIM_CONST TY203333 specialwords_203332 = {((NimStringDesc*) &TMP449),
...
N_NIMCALL(void, initspecials_203403)(void) {
	{
		...
		res_203476 = ((NU8) 1);
		{
			while (1) {
				NI LOC4;
				tident199021* LOC5;
				if (!(res_203476 <= ((NU8) 254))) goto LA3;
				s_203464 = res_203476;
				LOC4 = 0;
				LOC4 = hashignorestyle_127885(specialwords_203332[(s_203464)- 0]);
				LOC5 = 0;
				LOC5 = getident_199482(specialwords_203332[(s_203464)- 0], LOC4);
				(*LOC5).Sup.Id = ((NI) (s_203464));
				res_203476 += 1;
			} LA3: ;
		}
	}
...
N_NIMCALL(NU8, whichkeyword_203393)(NimStringDesc* id) {
	...
	result = whichkeyword_203382(LOC1);
	return result;
}
...
N_NIMCALL(NI, findstr_203342)(NimStringDesc** a, NI aLen0, NimStringDesc* s) {
	...
	result = 0;
	{
		...
		i_203360 = 0;
		HEX3Atmp_203362 = 0;
		HEX3Atmp_203362 = (aLen0-1);
		res_203365 = 0;
		{
			while (1) {
				if (!(res_203365 <= HEX3Atmp_203362)) goto LA3;
				i_203360 = res_203365;
				{
					NI LOC6;
					LOC6 = 0;
					LOC6 = nsuCmpIgnoreStyle(a[i_203360], s);
					if (!(LOC6 == 0)) goto LA7;
					result = i_203360;
					goto BeforeRet;
				}
