...
N_NIMCALL(void, idtablerawinsert_204439)(Tidpairseq191859** data, Tidobj168015* key, TNimObject* val);
...
N_NIMCALL(NI, idnodetablerawget_205296)(Tidnodetable191867 t, Tidobj168015* key);
N_NIMCALL(void, idnodetablerawinsert_205360)(Tidnodepairseq191865** data, Tidobj168015* key, Tnode191813* val);
...
{	result = 0;
	{
		...
		res_199872 = start;
		{
			while (1) {
				...
				LA7: ;
				{
					internalerror_166199((*list).info, ((NimStringDesc*) &TMP2677));
				}
				LA5: ;
				res_199872 += ((NI) 1);
			} LA4: ;
...
{	result = 0;
	...
	{
		{
			...
			internalerror_166199((*n).info, ((NimStringDesc*) &TMP2959));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_199551 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_166199((*n).info, ((NimStringDesc*) &TMP2960));
					}
					break;
					}
					res_199551 += ((NI) 1);
	...
	default:
	{
		internalerror_166199((*n).info, ((NimStringDesc*) &TMP2961));
	}
	break;
	}
	}BeforeRet: ;
