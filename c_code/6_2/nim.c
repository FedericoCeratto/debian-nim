...
N_NIMCALL(void, handlecmdline_616607)(void) {
	...
	LA4: ;
	{
		processcmdline_610209(((NU8) 0), ((NimStringDesc*) &TMP1888));
		{
			TSafePoint TMP1889;
			TY117604 p;
			NimStringDesc* LOC15;
		...
		LA7: ;
		loadconfigs_220811(((NimStringDesc*) &TMP1914));
		initvars_202820();
		processcmdline_610209(((NU8) 1), ((NimStringDesc*) &TMP1888));
		maincommand_614027();
		{
			NimStringDesc* LOC22;
...
appendString(LOC44, arguments_210144);
					execexternalprogram_202907(LOC44, ((NimStringDesc*) &TMP1888));
				}
				goto LA31;
				LA33: ;
				{
					...
					LA48: ;
					{
						NimStringDesc* LOC51;
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP1888));
...
appendString(LOC52, arguments_210144);
					execexternalprogram_202907(LOC52, ((NimStringDesc*) &TMP1888));
				}
				LA31: ;
			}
			LA29: ;
