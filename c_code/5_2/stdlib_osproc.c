...
N_NIMCALL(void, createstream_146443)(Streamobj138027** stream, int* handle, NU8 filemode);
...
static NIM_CONST TY171642 TMP4339 = {NIM_NIL,NIM_NIL};
...
{	result = 0;
	{
		...
		createstream_146443(&(*p).instream, (&(*p).inhandle), ((NU8) 1));
	}
	LA3: ;
	result = (*p).instream;
	goto BeforeRet;
...
{	result = 0;
	{
		...
		createstream_146443(&(*p).outstream, (&(*p).outhandle), ((NU8) 0));
	}
	LA3: ;
	result = (*p).outstream;
	goto BeforeRet;
			...
			res_144556 = ((NI) 0);
			{
				while (1) {
					...
					i_144498 = res_144556;
					{
						...
						beforerunevent.ClEnv? beforerunevent.ClPrc(i_144498, beforerunevent.ClEnv):((TMP4343)(beforerunevent.ClPrc))(i_144498);
					}
					LA51: ;
					memset((void*)LOC53, 0, sizeof(LOC53));
					p = nospstartProcess(cmds[i_144498], ((NimStringDesc*) &TMP4341), LOC53, 0, NIM_NIL, (options | 4));
					LOC54 = 0;
