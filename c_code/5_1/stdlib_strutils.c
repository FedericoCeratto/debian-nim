...
101}
;
STRING_LITERAL(TMP4876, "GB", 2);
STRING_LITERAL(TMP4877, "MB", 2);
STRING_LITERAL(TMP4878, "KB", 2);
STRING_LITERAL(TMP4879, "B", 1);
...
appendString(LOC5, ((NimStringDesc*) &TMP4876));
		result = LOC5;
	}
	goto LA1;
	LA3: ;
...
appendString(LOC12, ((NimStringDesc*) &TMP4877));
		result = LOC12;
	}
	goto LA1;
	LA10: ;
...
appendString(LOC19, ((NimStringDesc*) &TMP4878));
		result = LOC19;
	}
	goto LA1;
	LA17: ;
...
appendString(LOC24, ((NimStringDesc*) &TMP4879));
		result = LOC24;
	}
	LA1: ;
	return result;
