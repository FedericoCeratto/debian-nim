...
N_NIMCALL(void, merge_415680)(tsym225846** a_415688, NI a_415688Len0, tsym225846** b_415696, NI b_415696Len0, NI lo_415700, NI m_415702, NI hi_415704, TY415638 cmp_415712, NU8 order_415715) {
	...
	NI k;
	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp_415712.ClEnv? cmp_415712.ClPrc(a_415688[m_415702], a_415688[(NI32)(m_415702 + 1)], cmp_415712.ClEnv):((TMP2631)(cmp_415712.ClPrc))(a_415688[m_415702], a_415688[(NI32)(m_415702 + 1)]);
		LOC4 = 0;
...
N_NIMCALL(void, merge_362613)(NimStringDesc** a_362621, NI a_362621Len0, NimStringDesc** b_362629, NI b_362629Len0, NI lo_362633, NI m_362635, NI hi_362637, TY362571 cmp_362645, NU8 order_362648) {
	...
	NI k;
	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp_362645.ClEnv? cmp_362645.ClPrc(a_362621[m_362635], a_362621[(NI32)(m_362635 + 1)], cmp_362645.ClEnv):((TMP4789)(cmp_362645.ClPrc))(a_362621[m_362635], a_362621[(NI32)(m_362635 + 1)]);
		LOC4 = 0;
...
N_NIMCALL(void, sort_362552)(NimStringDesc** a_362560, NI a_362560Len0, TY362571 cmp_362570, NU8 order_362573) {
	...
	n = a_362560Len0;
	b = 0;
	b = (TY120008*) newSeq((&NTI120008), (NI32)(n / 2));
	s = 1;
	{
		while (1) {
			NI m;
...
N_NIMCALL(void, merge_360614)(tindexentry359264* a_360622, NI a_360622Len0, tindexentry359264* b_360630, NI b_360630Len0, NI lo_360634, NI m_360636, NI hi_360638, TY360572 cmp_360646, NU8 order_360649) {
	...
	NI k;
	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp_360646.ClEnv? cmp_360646.ClPrc(a_360622[m_360636], a_360622[(NI32)(m_360636 + 1)], cmp_360646.ClEnv):((TMP4793)(cmp_360646.ClPrc))(a_360622[m_360636], a_360622[(NI32)(m_360636 + 1)]);
		LOC4 = 0;
...
N_NIMCALL(void, merge_419186)(tentry418478* a_419194, NI a_419194Len0, tentry418478* b_419202, NI b_419202Len0, NI lo_419206, NI m_419208, NI hi_419210, TY419144 cmp_419218, NU8 order_419221) {
	...
	NI k;
	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp_419218.ClEnv? cmp_419218.ClPrc(a_419194[m_419208], a_419194[(NI32)(m_419208 + 1)], cmp_419218.ClEnv):((TMP4850)(cmp_419218.ClPrc))(a_419194[m_419208], a_419194[(NI32)(m_419208 + 1)]);
		LOC4 = 0;
