		...
		res_381133 = ((NI) 0);
		{
			while (1) {
				...
				i_381113 = res_381133;
				{
					...
					void_381126 = atomictypex_381066(((NimStringDesc*) &TMP2844), t, info);
...
N_NIMCALL(Tnode191813*, maptypetoast_381080)(Ttype191849* t, Tlineinfo164338 info, NIM_BOOL allowrecursion) {
	...
	case ((NU8) 7):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2839), t, info);
	}
	break;
	case ((NU8) 3):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2840), t, info);
	}
	break;
	case ((NU8) 4):
	case ((NU8) 16):
	{
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		LOC9 = 0;
		LOC9 = atomictypex_381066(((NimStringDesc*) &TMP2841), t, info);
	...
	{
		{
			...
			result = newnodeit_193807(((NU8) 42), info, t);
			LOC18 = 0;
			LOC18 = atomictypex_381066(((NimStringDesc*) &TMP2842), t, info);
		...
		LA16: ;
		{
			result = atomictypex_381066(((NimStringDesc*) &TMP2843), t, info);
		}
		LA13: ;
	}
	break;
	...
	case ((NU8) 25):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2852), t, info);
	}
	break;
	case ((NU8) 27):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2853), t, info);
	}
	break;
	case ((NU8) 20):
	{
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		LOC61 = 0;
		LOC61 = atomictypex_381066(((NimStringDesc*) &TMP2854), t, info);
	...
	case ((NU8) 44):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2871), t, info);
	}
	break;
	case ((NU8) 45):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2872), t, info);
	}
	break;
	case ((NU8) 46):
	{
	...
	case ((NU8) 48):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2875), t, info);
	}
	break;
	case ((NU8) 49):
	{
	...
	case ((NU8) 50):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2877), t, info);
	}
	break;
	case ((NU8) 51):
	{
	...
	case ((NU8) 56):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2882), t, info);
	}
	break;
	case ((NU8) 57):
	{
		result = maptypetobracket_381088(((NimStringDesc*) &TMP2883), t, info);
	}
	break;
	case ((NU8) 58):
	{
		result = atomictypex_381066(((NimStringDesc*) &TMP2884), t, info);
	}
	break;
	case ((NU8) 59):
	case ((NU8) 60):
	case ((NU8) 61):
	{
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		LOC96 = 0;
		LOC96 = atomictypex_381066(((NimStringDesc*) &TMP2885), t, info);
