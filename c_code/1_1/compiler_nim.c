...
{	{
	...
	LA4: ;
	{
		...
		scriptfile = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP2027));
		{
			...
			if (!LOC25) goto LA26;
			runnimscript_583323(scriptfile);
			{
		...
		maincommand_580628();
		{
			...
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_193398 &(IL64(1)<<(((((NU16) 289)- 237))&IL64(63))))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
			LOC48 = 0;
		...
		LA46: ;
		{
			if (!(gerrorcounter_193399 == ((NI) 0))) goto LA51;
			{
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	msgquit_193491(((NI8) ((((NI) 0) < gerrorcounter_193399))));
}
