...
STRING_LITERAL(TMP3039, "public implementation \'$1\' has non-public forward declaration i"
"n $2", 67);
...
appendString(LOC1, ((NimStringDesc*) &TMP3040));
				...
				{
					{
						...
						message = nsuFormatOpenArray(((NimStringDesc*) &TMP3039), LOC17, 2);
