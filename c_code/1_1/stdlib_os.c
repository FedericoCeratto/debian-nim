...
N_NIMCALL(NI64, rdfiletime_105604)(Tfiletime104248 f);
...
STRING_LITERAL(TMP5025, "exe", 3);
STRING_LITERAL(TMP5026, "PATH", 4);
...
N_NIMCALL(NimStringDesc*, nosexpandFilename)(NimStringDesc* filename) {
	...
	result = 0;
	unused = 0;
	res = newwidecstring_80621("", ((NI) 1536));
	LOC1 = 0;
...
appendString(LOC7, val);
	...
	LA1: ;
	k = newwidecstring_80805(key);
	v = newwidecstring_80805(val);
	{
		NI32 LOC11;
		NI32 LOC14;
		LOC11 = 0;
...
N_NIMCALL(NimStringDesc*, expandtilde_129411)(NimStringDesc* path) {
	...
	result = 0;
	{
		...
		LOC13 = 0;
		LOC13 = HEX5BHEX5D_87567(path, LOC12);
...
N_NIMCALL(NimStringDesc*, findexe_129417)(NimStringDesc* exe) {
	...
	NimStringDesc* path;
{	result = 0;
	result = nosaddFileExt(exe, ((NimStringDesc*) &TMP5025));
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
	...
	LA4: ;
	path = getenv_123843(((NimStringDesc*) &TMP5026));
	{
