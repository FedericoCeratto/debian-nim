...
typedef struct slice197873 slice197873;
...
typedef NimStringDesc* TY195486[276];
struct  TNimObject  {
TNimType* m_type;
};
struct  Exception  {
...
N_NIMCALL(void, HEX3Aanonymous_198195)(NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
...
N_NIMCALL(void, limessage_197774)(tlineinfo195539 info, NU16 msg, NimStringDesc* arg, NU8 eh);
static N_INLINE(NIM_BOOL, contains_197884)(slice197873 s_197890, NU16 value_197893);
static N_INLINE(slice197873, HEX2EHEX2E_197864)(NU16 a_197868, NU16 b_197870);
...
N_NIMCALL(NimStringDesc*, canonicalizepath_169390)(NimStringDesc* path);
...
N_NIMCALL(void, TMP2698)(void* p, NI op);
...
NIM_CONST TY195486 msgkindtostr_195485 = {((NimStringDesc*) &TMP154),
...
876}
;
STRING_LITERAL(TMP1983, "\015\012", 2);
STRING_LITERAL(TMP2699, "suggest done", 12);
...
N_NIMCALL(NimStringDesc*, msgkindtostring_197378)(NU16 kind) {
	NimStringDesc* result;
	result = 0;
	result = copyString(msgkindtostr_195485[(kind)- 0]);
	return result;
}
...
static N_INLINE(NIM_BOOL, contains_197884)(slice197873 s_197890, NU16 value_197893) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = (s_197890.A <= value_197893);
	if (!(LOC1)) goto LA2;
	LOC1 = (value_197893 <= s_197890.B);
	LA2: ;
	result = LOC1;
	return result;
}
...
N_NIMCALL(trope177009*, sourceline_196274)(tlineinfo195539 i) {
	...
	LA3: ;
	{
		...
		if (TMP1038.status == 0) {
			{
				NimStringDesc* line_198100;
				NimStringDesc* HEX3Atmp_198156;
				FILE* f_198159;
				NimStringDesc* res_198161;
				line_198100 = 0;
				HEX3Atmp_198156 = 0;
				HEX3Atmp_198156 = tofullpath_197037(i.Fileindex);
				f_198159 = open_12617(HEX3Atmp_198156, ((NU8) 0), 8000);
				res_198161 = rawNewString(80);
				{
					while (1) {
						NIM_BOOL LOC15;
						LOC15 = 0;
						LOC15 = readline_12889(f_198159, (&res_198161));
						if (!LOC15) goto LA14;
						line_198100 = res_198161;
						addsourceline_198042(i.Fileindex, line_198100);
					} LA14: ;
				}
				fclose(f_198159);
			}
...
N_NIMCALL(void, limessage_197774)(tlineinfo195539 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	s = nsuFormatOpenArray(frmt, LOC12, 4);
	{
		...
		msgwriteln_197236(s);
		{
			...
			if (!(LOC19)) goto LA20;
			LOC21 = HEX2EHEX2E_197864(((NU16) 0), ((NU16) 229));
			LOC19 = contains_197884(LOC21, msg);
			LA20: ;
			if (!LOC19) goto LA22;
...
N_NIMCALL(void, message_197976)(tlineinfo195539 info, NU16 msg, NimStringDesc* arg) {
	limessage_197774(info, msg, arg, ((NU8) 0));
}
...
N_NIMCALL(void, internalerror_197987)(tlineinfo195539 info, NimStringDesc* errmsg) {
	...
	LA3: ;
	writecontext_197590(info);
	limessage_197774(info, ((NU16) 2), errmsg, ((NU8) 1));
	BeforeRet: ;
}
...
N_NIMCALL(NI32, fileinfoidx_195747)(NimStringDesc* filename) {
	...
	if (TMP1072.status == 0) {
		canon = canonicalizepath_169390(filename);
		shallow_85424((&canon));
		popSafePoint();
	}
	else {
...
appendString(LOC12, ((NimStringDesc*) &TMP1983));
...
N_NIMCALL(void, globalerror_197934)(tlineinfo195539 info, NU16 msg, NimStringDesc* arg) {
	limessage_197774(info, msg, arg, ((NU8) 2));
}
...
N_NIMCALL(void, clearbufferedmsgs_196449)(void) {
	genericSeqAssign((&bufferedmsgs_196438), NIM_NIL, (&NTI119808));
}
N_NIMCALL(void, TMP2698)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_196846)(void) {
	...
	LA3: ;
	{
		...
		LOC8 = 0;
		LOC8 = (*e_196850).Sup.message; (*e_196850).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2699));
...
N_NIMCALL(void, globalerror_197945)(tlineinfo195539 info, NimStringDesc* arg) {
	limessage_197774(info, ((NU16) 4), arg, ((NU8) 2));
}
...
N_NIMCALL(NimStringDesc*, formatmsg_197757)(tlineinfo195539 info, NU16 msg, NimStringDesc* arg) {
	...
	LOC4[0] = tomsgfilename_197061(info);
	LOC4[1] = coordtostr_197368(((NI) (info.Line)));
	LOC4[2] = coordtostr_197368(((NI) (info.Col)));
	LOC4[3] = getmessagestr_197388(msg, arg);
	result = nsuFormatOpenArray(frmt, LOC4, 4);
	return result;
}

N_NIMCALL(void, localerror_197966)(tlineinfo195539 info, NimStringDesc* arg) {
	limessage_197774(info, ((NU16) 4), arg, ((NU8) 0));
}

N_NIMCALL(void, fatal_197923)(tlineinfo195539 info, NU16 msg, NimStringDesc* arg) {
	limessage_197774(info, msg, arg, ((NU8) 1));
}
...
NIM_EXTERNC N_NOINLINE(void, HEX00_msgsInit)(void) {
	...
	gnotes_196302 = IL64(70368695418879);
	...
	LOC3.ClPrc = ((TMP433) (HEX3Aanonymous_198195)); LOC3.ClEnv = NIM_NIL;
...
static TNimNode* TMP1975[276];
NI TMP1977;
static char* NIM_CONST TMP1976[276] = {
"errUnknown", 
"errIllFormedAstX", 
"errInternal", 
"errCannotOpenFile", 
...
NTI196250.marker = TMP430;
NTI195205.size = sizeof(NU16);
NTI195205.kind = 14;
NTI195205.base = 0;
NTI195205.flags = 3;
for (TMP1977 = 0; TMP1977 < 276; TMP1977++) {
TMP19[TMP1977+11].kind = 1;
TMP19[TMP1977+11].offset = TMP1977;
TMP19[TMP1977+11].name = TMP1976[TMP1977];
TMP1975[TMP1977] = &TMP19[TMP1977+11];
}
TMP19[287].len = 276; TMP19[287].kind = 2; TMP19[287].sons = &TMP1975[0];
NTI195205.node = &TMP19[287];
