...
N_NIMCALL(NI, nimParseBiggestFloat)(NimStringDesc* s, NF* number, NI start);
N_NIMCALL(NI, rawparseint_100514)(NimStringDesc* s, NI64* b, NI start);
...
STRING_LITERAL(TMP1537, "overflow", 8);
	...
	LA1: ;
	{
		...
		(*b) = IL64(0);
		{
			while (1) {
				...
				TMP1232 = mulInt64((*b), IL64(10));
				TMP1233 = subInt(((NI) (((NU8)(s->data[i])))), ((NI) 48));
				TMP1234 = subInt64((NI64)(TMP1232), ((NI64) ((NI)(TMP1233))));
				(*b) = (NI64)(TMP1234);
				TMP1235 = addInt(i, ((NI) 1));
				i = (NI)(TMP1235);
				{
					while (1) {
						NI TMP1236;
						if (!((NU8)(s->data[i]) == (NU8)(95))) goto LA15;
						TMP1236 = addInt(i, ((NI) 1));
						i = (NI)(TMP1236);
					} LA15: ;
				}
			} LA13: ;
		}
		TMP1237 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP1237);
		TMP1238 = subInt(i, start);
		result = (NI)(TMP1238);
	}
	LA10: ;
	return result;
...
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* s, NI64* number, NI start) {
	...
	result = 0;
	res = 0;
	result = rawparseint_100514(s, (&res), start);
	(*number) = res;
	return result;
}
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = npuParseBiggestInt(s, (&res), start);
	{
		...
		if (!LOC3) goto LA7;
		e_100655 = 0;
		e_100655 = (Overflowerror4043*) newObj((&NTI25317), sizeof(Overflowerror4043));
		(*e_100655).Sup.Sup.Sup.m_type = (&NTI4043);
		LOC9 = 0;
		LOC9 = (*e_100655).Sup.Sup.message; (*e_100655).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1537));
		if (LOC9) nimGCunrefNoCycle(LOC9);
		raiseException((Exception*)e_100655, "OverflowError");
	}
	goto LA1;
	LA7: ;
	{
