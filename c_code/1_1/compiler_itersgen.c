...
{	result0 = (Tnode265794*)0;
	...
	t0 = skiptypes_269113_850551059((*LOC19).typ, 2304);
	{
		...
		Tnode265794* LOC27;
		LOC22 = (NIM_BOOL)0;
		LOC22 = !(((*t0).kind == ((Ttypekind265244) 22) || (*t0).kind == ((Ttypekind265244) 21)));
		if (LOC22) goto LA23;
		LOC24 = (Ttype265832*)0;
	...
	LA25: ;
	LOC28 = (Tnode265794*)0;
	LOC28 = getbody_306828_1724185294((*iter0).kindU.S4.sym);
	body0 = liftitertoproc_410195_2538784801((*iter0).kindU.S4.sym, LOC28, t0);
	LOC29 = (Tnode265794*)0;
	LOC29 = HEX5BHEX5D_266238_850551059(n0, ((NI) 3));
	prc0 = newsym_266684_850551059(((Tsymkind265435) 12), (*LOC29).kindU.S5.ident, (*(*iter0).kindU.S4.sym).owner, (*(*iter0).kindU.S4.sym).info);
