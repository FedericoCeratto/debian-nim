...
N_NIMCALL(NIM_BOOL, readlinefromstdin_210447)(NimStringDesc* prompt, NimStringDesc** line) {
	...
	{
		if (!!(result)) goto LA3;
		write_12865(stdout, ((NimStringDesc*) &TMP1029));
		exit(0);
	}
	LA3: ;
	return result;
...
static N_INLINE(NIM_BOOL, continueline_210666)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = LOC2;
	if (LOC1) goto LA4;
	LOC1 = endswith_210604(line, TMP1032);
	LA4: ;
	result = LOC1;
	return result;
}
...
N_NIMCALL(NIM_BOOL, endswithopr_210656)(NimStringDesc* x) {
	NIM_BOOL result;
	result = 0;
	result = endswith_210604(x, TMP1337);
	return result;
}
...
N_NIMCALL(void, llstreamwriteln_210300)(tllstream210204* s, NimStringDesc* data) {
	...
	llstreamwrite_210278(s, ((NimStringDesc*) &TMP1029));
}
...
NTI210202.node = &TMP713[6];
TMP713[1].kind = 1;
TMP713[1].offset = offsetof(tllstream210204, Kind);
TMP713[1].typ = (&NTI210202);
TMP713[1].name = "kind";
TMP1008[1] = &TMP713[7];
TMP713[7].kind = 1;
TMP713[7].offset = offsetof(tllstream210204, F);
TMP713[7].typ = (&NTI12404);
TMP713[7].name = "f";
TMP1008[2] = &TMP713[8];
TMP713[8].kind = 1;
TMP713[8].offset = offsetof(tllstream210204, S);
TMP713[8].typ = (&NTI149);
TMP713[8].name = "s";
TMP1008[3] = &TMP713[9];
TMP713[9].kind = 1;
TMP713[9].offset = offsetof(tllstream210204, Rd);
TMP713[9].typ = (&NTI108);
TMP713[9].name = "rd";
TMP1008[4] = &TMP713[10];
TMP713[10].kind = 1;
TMP713[10].offset = offsetof(tllstream210204, Wr);
TMP713[10].typ = (&NTI108);
TMP713[10].name = "wr";
TMP1008[5] = &TMP713[11];
TMP713[11].kind = 1;
TMP713[11].offset = offsetof(tllstream210204, Lineoffset);
TMP713[11].typ = (&NTI108);
TMP713[11].name = "lineOffset";
TMP713[0].len = 6; TMP713[0].kind = 2; TMP713[0].sons = &TMP1008[0];
NTI210204.node = &TMP713[0];
NTI210206.size = sizeof(tllstream210204*);
NTI210206.kind = 22;
NTI210206.base = (&NTI210204);
NTI210206.marker = TMP1012;
}
