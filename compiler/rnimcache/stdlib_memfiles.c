...
/* Command for C compiler:
   gcc -c  -w -O3 -fno-strict-aliasing  -I/home/ubuntu/nim-ci/Nim/lib -o /home/ubuntu/nim-ci/Nim/compiler/rnimcache/stdlib_memfiles.o /home/ubuntu/nim-ci/Nim/compiler/rnimcache/stdlib_memfiles.c */
...
N_NIMCALL(Memfile330202, open_330801)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	LA6: ;
	{
		...
		LA17: ;
		LOC20 = 0;
		LOC20 = oslasterror_130619();
		raiseoserror_130603(LOC20, ((NimStringDesc*) &TMP1595));
	}
	LA13: ;
	{
		if (!!((newfilesize == ((NI) -1)))) goto LA23;
		{
			...
			LA32: ;
			LOC35 = 0;
			LOC35 = oslasterror_130619();
			raiseoserror_130603(LOC35, ((NimStringDesc*) &TMP1595));
		}
		LA28: ;
	}
	LA23: ;
	...
	LA38: ;
	{
		...
		LA44: ;
		{
			...
			raiseoserror_130603(LOC52, ((NimStringDesc*) &TMP1595));
		}
		LA41: ;
	}
	LA36: ;
	...
	result.mem = mmap(NIM_NIL, result.size, LOC53, LOC59, result.handle, ((off_t) (offset)));
	{
		...
		LA71: ;
		LOC74 = 0;
		LOC74 = oslasterror_130619();
		raiseoserror_130603(LOC74, ((NimStringDesc*) &TMP1595));
	}
	LA67: ;
	return result;
}
...
N_NIMCALL(void, close_331243)(Memfile330202* f) {
	...
	{
		if (!error) goto LA11;
		raiseoserror_130603(lasterr, ((NimStringDesc*) &TMP1595));
	}
	LA11: ;
}
...
static TNimNode* TMP933[3];
static TNimNode TMP918[4];
...
TMP933[0] = &TMP918[1];
TMP918[1].kind = 1;
TMP918[1].offset = offsetof(Memfile330202, mem);
TMP918[1].typ = (&NTI142);
TMP918[1].name = "mem";
TMP933[1] = &TMP918[2];
TMP918[2].kind = 1;
TMP918[2].offset = offsetof(Memfile330202, size);
TMP918[2].typ = (&NTI104);
TMP918[2].name = "size";
TMP933[2] = &TMP918[3];
TMP918[3].kind = 1;
TMP918[3].offset = offsetof(Memfile330202, handle);
TMP918[3].typ = (&NTI7408);
TMP918[3].name = "handle";
TMP918[0].len = 3; TMP918[0].kind = 2; TMP918[0].sons = &TMP933[0];
NTI330202.node = &TMP918[0];
}
