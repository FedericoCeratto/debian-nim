...
N_NIMCALL(void, replacedeprecated_249208)(Tlineinfo164338 info, Tident168021* oldsym, Tident168021* newsym);
N_NIMCALL(void, loadfile_249041)(Tlineinfo164338 info);
...
N_NIMCALL(void, loadfile_249041)(Tlineinfo164338 info) {
	...
	i = info.fileindex;
	{
		...
		gsourcefiles_249036 = (TY249019*) setLengthSeq(&(gsourcefiles_249036)->Sup, sizeof(Tsourcefile249008), ((NI) ((NI32)(i + ((NI32) 1)))));
	}
	LA3: ;
	{
		NimStringDesc* path;
		...
		gsourcefiles_249036->data[i].lines = (TY122008*) newSeqRC1((&NTI122008), 0);
		...
		gsourcefiles_249036->data[i].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2680));
		{
			...
			res_249117 = rawNewString(((NI) 80));
			{
				while (1) {
					...
					gsourcefiles_249036->data[i].lines = (TY122008*) incrSeq(&(gsourcefiles_249036->data[i].lines)->Sup, sizeof(NimStringDesc*));
					LOC15 = 0;
		...
		pos = lex.bufpos;
		{
			while (1) {
				...
				case 13:
				{
					NimStringDesc* LOC21;
					LOC21 = 0;
					LOC21 = gsourcefiles_249036->data[i].newline; gsourcefiles_249036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP2688));
				...
				case 0:
				{
					NimStringDesc* LOC23;
					LOC23 = 0;
					LOC23 = gsourcefiles_249036->data[i].newline; gsourcefiles_249036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP2689));
...
{	loadfile_249041(info);
	line = gsourcefiles_249036->data[info.fileindex].lines->data[(NI16)(info.line - ((NI16) 1))];
	...
	last = (NI)((NI)(first + LOC17) - ((NI) 1));
	{
		...
		LOC21 = 0;
		LOC21 = HEX5BHEX5D_85966(line, LOC20);
		LOC22 = 0;
...
appendString(LOC25, LOC27);
		x = LOC25;
		asgnRefNoCycle((void**) (&gsourcefiles_249036->data[info.fileindex].lines->data[(NI16)(info.line - ((NI16) 1))]), x);
