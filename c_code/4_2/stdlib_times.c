...
N_NIMCALL(void, gettzname_108570)(Keyvaluepair145208* Result);
...
N_NIMCALL(void, tmtotimeinfo_109048)(struct tm* tm, NIM_BOOL local, Timeinfo108410* Result) {
	...
	LA4: ;
	{
		LOC1.tzname = copyString(((NimStringDesc*) &TMP3365));
	}
	LA2: ;
	{
		if (!local) goto LA16;
...
static TNimNode* TMP3358[11];
static TNimNode* TMP3359[12];
NI TMP3361;
static char* NIM_CONST TMP3360[12] = {
"mJan", 
"mFeb", 
"mMar", 
"mApr", 
...
"mNov", 
"mDec"};
static TNimNode* TMP3362[7];
NI TMP3364;
static char* NIM_CONST TMP3363[7] = {
"dMon", 
"dTue", 
"dWed", 
"dThu", 
...
NTI108206.base = 0;
NTI108206.flags = 3;
for (TMP3361 = 0; TMP3361 < 12; TMP3361++) {
TMP15[TMP3361+6].kind = 1;
TMP15[TMP3361+6].offset = TMP3361;
TMP15[TMP3361+6].name = TMP3360[TMP3361];
TMP3359[TMP3361] = &TMP15[TMP3361+6];
}
TMP15[18].len = 12; TMP15[18].kind = 2; TMP15[18].sons = &TMP3359[0];
...
NTI108208.base = 0;
NTI108208.flags = 3;
for (TMP3364 = 0; TMP3364 < 7; TMP3364++) {
TMP15[TMP3364+21].kind = 1;
TMP15[TMP3364+21].offset = TMP3364;
TMP15[TMP3364+21].name = TMP3363[TMP3364];
TMP3362[TMP3364] = &TMP15[TMP3364+21];
}
TMP15[28].len = 7; TMP15[28].kind = 2; TMP15[28].sons = &TMP3362[0];
...
TMP15[0].len = 11; TMP15[0].kind = 2; TMP15[0].sons = &TMP3358[0];
