...
N_NIMCALL(void, tmtotimeinfo_101848)(struct tm* tm, NIM_BOOL local, timeinfo101205* Result) {
	...
	LA4: ;
	{
		LOC1.Tzname = copyString(((NimStringDesc*) &TMP3094));
	}
	LA2: ;
	{
		if (!local) goto LA16;
...
"mNov", 
"mDec"};
static TNimNode* TMP3091[7];
NI TMP3093;
static char* NIM_CONST TMP3092[7] = {
"dMon", 
"dTue", 
"dWed", 
"dThu", 
...
TMP15[TMP3090+6].kind = 1;
TMP15[TMP3090+6].offset = TMP3090;
TMP15[TMP3090+6].name = TMP3089[TMP3090];
TMP3088[TMP3090] = &TMP15[TMP3090+6];
}
TMP15[18].len = 12; TMP15[18].kind = 2; TMP15[18].sons = &TMP3088[0];
...
NTI101008.base = 0;
NTI101008.flags = 3;
for (TMP3093 = 0; TMP3093 < 7; TMP3093++) {
TMP15[TMP3093+21].kind = 1;
TMP15[TMP3093+21].offset = TMP3093;
TMP15[TMP3093+21].name = TMP3092[TMP3093];
TMP3091[TMP3093] = &TMP15[TMP3093+21];
}
TMP15[28].len = 7; TMP15[28].kind = 2; TMP15[28].sons = &TMP3091[0];
...
TMP15[0].len = 11; TMP15[0].kind = 2; TMP15[0].sons = &TMP3087[0];
