...
N_NIMCALL(void, renderparamtypes_399467)(TY120008** found, tnode225816* n);
...
STRING_LITERAL(TMP4659, "", 0);
STRING_LITERAL(TMP4660, "*", 1);
STRING_LITERAL(TMP4661, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP4668, "ref.", 4);
STRING_LITERAL(TMP4669, "ptr.", 4);
STRING_LITERAL(TMP4670, "proc(", 5);
STRING_LITERAL(TMP4671, "tuple[", 6);
STRING_LITERAL(TMP4672, "renderParamTypes(found,n) with ", 31);
...
N_NIMCALL(NimStringDesc*, renderplainsymbolname_397013)(tnode225816* n) {
	...
	result = 0;
	result = copyString(((NimStringDesc*) &TMP4659));
	switch ((*n).Kind) {
	case ((NU8) 31):
	{
		{
	...
	{
		{
			if (!!(eqStrings((*(*n).kindU.S5.Ident).S, ((NimStringDesc*) &TMP4660)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP4661));
...
appendString(LOC10, ((NimStringDesc*) &TMP4669));
appendString(LOC10, LOC12);
	...
	case ((NU8) 146):
	{
		...
		result = copyString(((NimStringDesc*) &TMP4670));
		{
			NI i_398422;
			NI HEX3Atmp_399402;
			NI LOC15;
...
appendString(result, LOC27);
	...
	case ((NU8) 134):
	{
		result = copyString(((NimStringDesc*) &TMP4671));
		{
			NI i_399022;
			NI HEX3Atmp_399414;
			NI LOC30;
...
appendString(LOC31, ((NimStringDesc*) &TMP4672));
