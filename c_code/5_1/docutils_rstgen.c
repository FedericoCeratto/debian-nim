...
typedef N_CLOSURE_PTR(NI, TMP4928) (Tindexentry312396 x_314527, Tindexentry312396 y_314529, void* ClEnv);
typedef N_CLOSURE_PTR(NI, TMP4938) (Tindexentry312396 x_313683, Tindexentry312396 y_313685, void* ClEnv);
struct TY313067 {
NI Field0;
NimStringDesc* Field1;
};
				...
				while (1) {
					{
						...
						y_316697 = cstrToNimstr(((NCSTRING) ((*x_316695).d_name)));
						{
							...
							if (!(LOC15)) goto LA16;
							LOC15 = !(eqStrings(y_316697, ((NimStringDesc*) &TMP4919)));
							LA16: ;
							if (!LOC15) goto LA17;
							...
							k_316701 = ((NU8) 0);
							{
								...
								path_314837 = y_316697;
								{
									...
									if (!(LOC33)) goto LA34;
									LOC33 = nsuEndsWith(path_314837, ((NimStringDesc*) &TMP4920));
									LA34: ;
									if (!LOC33) goto LA35;
									fileentries = 0;
...
appendString(LOC84, LOC86);
							...
							path_314837 = y_316697;
							{
								...
								LOC104 = nsuEndsWith(path_314837, ((NimStringDesc*) &TMP4920));
								LA105: ;
...
N_NIMCALL(NimStringDesc*, generatedocumentationjumps_314392)(Table312409 docs) {
	...
	memset((void*)(&LOC14), 0, sizeof(LOC14));
	LOC14.ClPrc = ((TMP4928) (cmp_312430)); LOC14.ClEnv = NIM_NIL;
...
N_NIMCALL(NimStringDesc*, generatedocumentationindex_313431)(Table312409 docs) {
	...
	memset((void*)(&LOC14), 0, sizeof(LOC14));
	LOC14.ClPrc = ((TMP4938) (cmp_312430)); LOC14.ClEnv = NIM_NIL;
	sort_313687(titles->data, titles->Sup.len, LOC14, ((NU8) 1));
	{
