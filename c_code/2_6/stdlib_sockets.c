...
N_NIMCALL(void, TMP4869)(void* p, NI op);
...
STRING_LITERAL(TMP1982, "This function cannot be used on non-blocking sockets.", 53);
STRING_LITERAL(TMP1983, "Could not send all data.", 24);
TNimNode* NimDT_183607_isbuffered[3];
STRING_LITERAL(TMP4868, "", 0);
STRING_LITERAL(TMP4870, "Call to \'", 9);
STRING_LITERAL(TMP4871, "\' timed out.", 12);
STRING_LITERAL(TMP4873, "readLine", 8);
STRING_LITERAL(TMP4874, "\015\012", 2);
...
N_NIMCALL(void, send_194008)(tsocketimpl183607* socket, NimStringDesc* data) {
	NI sent;
	{
		...
		e_194014 = 0;
		e_194014 = (valueerror3249*) newObj((&NTI21401), sizeof(valueerror3249));
		(*e_194014).Sup.Sup.m_type = (&NTI3249);
		LOC5 = 0;
		LOC5 = (*e_194014).Sup.message; (*e_194014).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1982));
	...
	LA8: ;
	{
		...
		e_194203 = 0;
		e_194203 = (oserror3233*) newObj((&NTI114812), sizeof(oserror3233));
		(*e_194203).Sup.Sup.Sup.m_type = (&NTI3233);
		LOC15 = 0;
		LOC15 = (*e_194203).Sup.Sup.message; (*e_194203).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1983));
	...
	LA3: ;
	{
		...
		hints.ai_protocol = toint_184441(((NU8) 6));
		{
			...
			gairesult_185808 = getaddrinfo(address->data, LOC13->data, (&hints), &ailist);
			{
				...
				e_186002 = 0;
				e_186002 = (oserror3233*) newObj((&NTI114812), sizeof(oserror3233));
...
N_NIMCALL(void, acceptaddr_186248)(tsocketimpl183607* server, tsocketimpl183607** client, NimStringDesc** address) {
	...
	sock_186260 = accept((*server).Fd, ((struct sockaddr*) ((&sockaddress_186256))), (&addrlen_186258));
	{
		...
		err_186262 = oslasterror_114841();
		{
			...
			unsureAsgnRef((void**) (&(*address)), copyString(((NimStringDesc*) &TMP4868)));
			goto BeforeRet;
		}
		goto LA5;
		LA9: ;
		{
			raiseoserror_114809(err_186262);
		}
		LA5: ;
	}
	goto LA1;
...
N_NIMCALL(void, accept_187401)(tsocketimpl183607* server, tsocketimpl183607** client) {
	...
	addrdummy = copyString(((NimStringDesc*) &TMP4868));
...
appendString(LOC22, ((NimStringDesc*) &TMP4870));
...
appendString(LOC22, ((NimStringDesc*) &TMP4871));
		...
		selret = select_191107((&s), (NI32)(timeout - ((NI) (((NF)((*waited)) * (NF)(1.0000000000000000e+03))))));
		{
			NI32 LOC28;
...
appendString(LOC33, ((NimStringDesc*) &TMP4870));
appendString(LOC33, funcname);
appendString(LOC33, ((NimStringDesc*) &TMP4871));
...
N_NIMCALL(void, readline_192447)(tsocketimpl183607* socket, NimStringDesc** line, NI timeout) {
	...
	(*line) = setLengthStr((*line), 0);
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_191618(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4873));
			...
			LA4: ;
			{
				...
				LOC15 = 0;
				LOC15 = waitfor_191618(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4873));
...
appendString((*line), ((NimStringDesc*) &TMP4874));
				}
				LA28: ;
				goto BeforeRet;
			}
...
static TNimNode* TMP4863[3];
static TNimNode* TMP4864[3];
...
TMP128[3].len = 3; TMP128[3].kind = 2; TMP128[3].sons = &TMP4864[0];
