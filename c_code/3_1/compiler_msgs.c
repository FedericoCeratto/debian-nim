...
appendString(s_193309, arg_193311);
						...
						writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_193309, writelnhook_191444.ClEnv):((TMP429)(writelnhook_191444.ClPrc))(s_193309);
					}
					goto LA12;
					LA14: ;
					{
...
appendString(s_192512, arg_192514);
					...
					writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_192512, writelnhook_191444.ClEnv):((TMP496)(writelnhook_191444.ClPrc))(s_192512);
				}
				goto LA22;
				LA24: ;
				{
...
appendString(s_192869, arg_192871);
						...
						writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_192869, writelnhook_191444.ClEnv):((TMP497)(writelnhook_191444.ClPrc))(s_192869);
					}
					goto LA78;
					LA80: ;
					{
...
appendString(s_193060, arg_193062);
						...
						writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_193060, writelnhook_191444.ClEnv):((TMP498)(writelnhook_191444.ClPrc))(s_193060);
					}
					goto LA129;
					LA131: ;
					{
...
appendString(s_193795, arg_193797);
				...
				writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_193795, writelnhook_191444.ClEnv):((TMP492)(writelnhook_191444.ClPrc))(s_193795);
			}
			goto LA32;
			LA34: ;
			{
...
appendString(s_194217, arg_194219);
				...
				writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_194217, writelnhook_191444.ClEnv):((TMP493)(writelnhook_191444.ClPrc))(s_194217);
			}
			goto LA61;
			LA63: ;
			{
...
N_NIMCALL(void, msgwriteln_191915)(NimStringDesc* s, NU8 flags) {
	{
		...
		LA4: ;
		if (!LOC3) goto LA5;
		writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s, writelnhook_191444.ClEnv):((TMP1047)(writelnhook_191444.ClPrc))(s);
	}
	goto LA1;
	LA5: ;
	{
...
appendString(s_194832, arg_194834);
				...
				writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_194832, writelnhook_191444.ClEnv):((TMP1045)(writelnhook_191444.ClPrc))(s_194832);
			}
			goto LA24;
			LA26: ;
			{
...
appendString(s_195418, arg_195420);
				...
				writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s_195418, writelnhook_191444.ClEnv):((TMP1046)(writelnhook_191444.ClPrc))(s_195418);
			}
			goto LA53;
			LA55: ;
			{
...
N_NIMCALL(void, suggestwriteln_191453)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_191444.ClEnv? writelnhook_191444.ClPrc(s, writelnhook_191444.ClEnv):((TMP2061)(writelnhook_191444.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, suggestquit_191509)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_191514).Sup.message; (*e_191514).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2772));
	if (LOC1) nimGCunrefNoCycle(LOC1);
