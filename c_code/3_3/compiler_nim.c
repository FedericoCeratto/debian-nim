...
{	{
	...
	LA4: ;
	{
		...
		scriptfile = noschangeFileExt(gprojectfull_167236, ((NimStringDesc*) &TMP2021));
		{
			...
			if (!LOC25) goto LA26;
			runnimscript_581328(scriptfile);
			{
		...
		maincommand_578628();
		{
			...
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_191395 &(IL64(1)<<(((((NU16) 289)- 237))&IL64(63))))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
			LOC48 = 0;
		...
		LA46: ;
		{
			if (!(gerrorcounter_191396 == ((NI) 0))) goto LA51;
			{
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	msgquit_191488(((NI8) ((((NI) 0) < gerrorcounter_191396))));
}
