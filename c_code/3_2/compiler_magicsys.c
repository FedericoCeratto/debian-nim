...
N_NIMCALL(Tsym264826*, getsyssym_309041_3937434831)(NimStringDesc* name0) {
	...
	result0 = strtableget_271070_2984716966((*systemmodule_309007_3937434831).kindU.S3.tab, LOC1);
	{
		...
		result0 = newsym_265683_850551059(((Tsymkind264435) 0), LOC6, systemmodule_309007_3937434831, (*systemmodule_309007_3937434831).info);
...
N_NIMCALL(void, addsonskipintlit_309680_3937434831)(Ttype264832* father0, Ttype264832* son0) {
	...
	LA3: ;
	s0 = skipintlit_309653_3937434831(son0);
...
{	result0 = (Tsym264826*)0;
	...
	LA17: ;
	rawmessage_189612_155036129(((Tmsgkind186002) 68), name0);
	result0 = newsym_265683_850551059(((Tsymkind264435) 0), id0, systemmodule_309007_3937434831, (*systemmodule_309007_3937434831).info);
	asgnRefNoCycle((void**) (&(*result0).typ), newtype_267107_850551059(((Ttypekind264244) 50), systemmodule_309007_3937434831));
	}BeforeRet: ;
	return result0;
}
