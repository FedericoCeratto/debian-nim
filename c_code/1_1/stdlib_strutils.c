...
101}
;
STRING_LITERAL(TMP5005, "GB", 2);
STRING_LITERAL(TMP5006, "MB", 2);
STRING_LITERAL(TMP5007, "KB", 2);
STRING_LITERAL(TMP5008, "B", 1);
...
N_NOINLINE(void, invalidformatstring_101759)(void) {
	...
	NimStringDesc* LOC1;
	e_101763 = 0;
	e_101763 = (Valueerror3449*) newObj((&NTI22401), sizeof(Valueerror3449));
...
N_NIMCALL(NF, nsuParseFloat)(NimStringDesc* s) {
	...
	L = npuParseFloat(s, (&result), ((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		e_98544 = 0;
		e_98544 = (Valueerror3449*) newObj((&NTI22401), sizeof(Valueerror3449));
...
N_NIMCALL(NI64, nsuParseBiggestInt)(NimStringDesc* s) {
	...
	L = npuParseBiggestInt(s, (&result), ((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		e_98519 = 0;
		e_98519 = (Valueerror3449*) newObj((&NTI22401), sizeof(Valueerror3449));
...
N_NIMCALL(NI, nsuParseInt)(NimStringDesc* s) {
	...
	L = npuParseInt(s, (&result), ((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		e_98494 = 0;
		e_98494 = (Valueerror3449*) newObj((&NTI22401), sizeof(Valueerror3449));
		...
		last_98189 = ((NI) 0);
		{
			if (!(((NI) 0) < (s ? s->Sup.len : 0))) goto LA4;
			{
				while (1) {
					NI first_98191;
					NimStringDesc* LOC12;
					if (!(last_98189 <= (s ? s->Sup.len : 0))) goto LA7;
					first_98191 = last_98189;
					{
						while (1) {
							NIM_BOOL LOC10;
							LOC10 = 0;
							LOC10 = (last_98189 < (s ? s->Sup.len : 0));
							if (!(LOC10)) goto LA11;
							LOC10 = !(((NU8)(s->data[last_98189]) == (NU8)(sep)));
							LA11: ;
							if (!LOC10) goto LA9;
							last_98189 += ((NI) 1);
						} LA9: ;
					}
					x_98158 = copyStrLast(s, first_98191, (NI)(last_98189 - ((NI) 1)));
					result = (TY123008*) incrSeq(&(result)->Sup, sizeof(NimStringDesc*));
					LOC12 = 0;
					LOC12 = result->data[result->Sup.len-1]; result->data[result->Sup.len-1] = copyStringRC1(x_98158);
...
appendString(LOC5, ((NimStringDesc*) &TMP5005));
		result = LOC5;
	}
	goto LA1;
	LA3: ;
...
appendString(LOC12, ((NimStringDesc*) &TMP5006));
		result = LOC12;
	}
	goto LA1;
	LA10: ;
...
appendString(LOC19, ((NimStringDesc*) &TMP5007));
		result = LOC19;
	}
	goto LA1;
	LA17: ;
...
appendString(LOC24, ((NimStringDesc*) &TMP5008));
		result = LOC24;
	}
	LA1: ;
	return result;
