...
N_NIMCALL(NI, llreadfromstdin_211528)(Tllstream211204* s, void* buf, NI buflen);
...
N_NIMCALL(NIM_BOOL, readlinefromstdin_211319)(NimStringDesc* prompt, NimStringDesc** line);
N_NIMCALL(void, write_16895)(FILE* f, NimStringDesc* s);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src);
N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen);
N_NIMCALL(NI, counttriples_211483)(NimStringDesc* s);
static N_INLINE(NIM_BOOL, continueline_211460)(NimStringDesc* line, NIM_BOOL intriplestring);
N_NIMCALL(NIM_BOOL, endswith_211404)(NimStringDesc* x, TY211407 s);
...
N_NIMCALL(NIM_BOOL, readlinefromstdin_211319)(NimStringDesc* prompt, NimStringDesc** line) {
	...
	{
		if (!!(result)) goto LA3;
		write_16895(stdout, ((NimStringDesc*) &TMP1200));
		exit(((NI) 0));
	}
	LA3: ;
	return result;
...
static N_INLINE(NIM_BOOL, continueline_211460)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = LOC2;
	if (LOC1) goto LA4;
	LOC1 = endswith_211404(line, TMP1203);
	LA4: ;
	result = LOC1;
	return result;
}
...
N_NIMCALL(NI, llreadfromstdin_211528)(Tllstream211204* s, void* buf, NI buflen) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = (*s).s; (*s).s = copyStringRC1(((NimStringDesc*) &TMP1199));
	...
	triples = ((NI) 0);
	{
		while (1) {
			...
			LOC4 = 0;
			{
				...
				LOC4 = copyString(((NimStringDesc*) &TMP1201));
			}
			goto LA5;
			LA7: ;
			{
			...
			LA5: ;
			LOC10 = 0;
			LOC10 = readlinefromstdin_211319(LOC4, (&line));
			if (!LOC10) goto LA3;
			(*s).s = resizeString((*s).s, line->Sup.len + 0);
appendString((*s).s, line);
			(*s).s = resizeString((*s).s, 1);
appendString((*s).s, ((NimStringDesc*) &TMP1200));
			LOC11 = 0;
			LOC11 = counttriples_211483(line);
			triples += LOC11;
			{
				NIM_BOOL LOC14;
				LOC14 = 0;
				LOC14 = continueline_211460(line, (((NI) ((NI)(triples & ((NI) 1)))) == ((NI) 1)));
				if (!!(LOC14)) goto LA15;
				goto LA2;
			}
			LA15: ;
...
N_NIMCALL(NI, llstreamread_211584)(Tllstream211204* s, void* buf, NI buflen) {
	NI result;
	result = 0;
	switch ((*s).kind) {
	case ((NU8) 0):
	...
	case ((NU8) 3):
	{
		result = llreadfromstdin_211528(s, buf, buflen);
	}
	break;
	}
	return result;
...
N_NIMCALL(NIM_BOOL, endswithopr_211450)(NimStringDesc* x) {
	NIM_BOOL result;
	result = 0;
	result = endswith_211404(x, TMP1496);
	return result;
}
...
N_NIMCALL(void, llstreamwriteln_211686)(Tllstream211204* s, NimStringDesc* data) {
	llstreamwrite_211665(s, data);
	llstreamwrite_211665(s, ((NimStringDesc*) &TMP1200));
}
...
N_NIMCALL(Tllstream211204*, llstreamopenstdin_211293)(void) {
	...
	(*result).kind = ((NU8) 3);
	LOC1 = 0;
	LOC1 = (*result).s; (*result).s = copyStringRC1(((NimStringDesc*) &TMP1199));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
NTI211202.node = &TMP791[6];
TMP791[1].kind = 1;
TMP791[1].offset = offsetof(Tllstream211204, kind);
TMP791[1].typ = (&NTI211202);
TMP791[1].name = "kind";
TMP1173[1] = &TMP791[7];
TMP791[7].kind = 1;
TMP791[7].offset = offsetof(Tllstream211204, f);
TMP791[7].typ = (&NTI16404);
TMP791[7].name = "f";
TMP1173[2] = &TMP791[8];
TMP791[8].kind = 1;
TMP791[8].offset = offsetof(Tllstream211204, s);
TMP791[8].typ = (&NTI149);
TMP791[8].name = "s";
TMP1173[3] = &TMP791[9];
TMP791[9].kind = 1;
TMP791[9].offset = offsetof(Tllstream211204, rd);
TMP791[9].typ = (&NTI108);
TMP791[9].name = "rd";
TMP1173[4] = &TMP791[10];
TMP791[10].kind = 1;
TMP791[10].offset = offsetof(Tllstream211204, wr);
TMP791[10].typ = (&NTI108);
TMP791[10].name = "wr";
TMP1173[5] = &TMP791[11];
TMP791[11].kind = 1;
TMP791[11].offset = offsetof(Tllstream211204, lineoffset);
TMP791[11].typ = (&NTI108);
TMP791[11].name = "lineOffset";
TMP791[0].len = 6; TMP791[0].kind = 2; TMP791[0].sons = &TMP1173[0];
NTI211204.node = &TMP791[0];
NTI211206.size = sizeof(Tllstream211204*);
NTI211206.kind = 22;
NTI211206.base = (&NTI211204);
NTI211206.marker = TMP1177;
NTI211407.size = sizeof(TY211407);
NTI211407.kind = 19;
NTI211407.base = (&NTI147);
NTI211407.flags = 3;
TMP791[12].len = 0; TMP791[12].kind = 0;
NTI211407.node = &TMP791[12];
}
