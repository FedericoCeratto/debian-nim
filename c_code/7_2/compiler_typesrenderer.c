...
STRING_LITERAL(TMP5320, "", 0);
STRING_LITERAL(TMP5321, "*", 1);
STRING_LITERAL(TMP5322, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP5329, "ref.", 4);
STRING_LITERAL(TMP5330, "ptr.", 4);
STRING_LITERAL(TMP5331, "proc(", 5);
STRING_LITERAL(TMP5332, "tuple[", 6);
STRING_LITERAL(TMP5333, "renderParamTypes(found,n) with ", 31);
...
{	result0 = (NimStringDesc*)0;
	result0 = copyString(((NimStringDesc*) &TMP5320));
	switch ((*n0).kind) {
	...
	{
		{
			if (!!(eqStrings((*(*n0).kindU.S5.ident).s, ((NimStringDesc*) &TMP5321)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP5322));
...
appendString(LOC6, ((NimStringDesc*) &TMP5329));
...
appendString(LOC10, ((NimStringDesc*) &TMP5330));
...
appendString(LOC31, ((NimStringDesc*) &TMP5333));
