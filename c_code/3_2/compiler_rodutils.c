...
STRING_LITERAL(TMP4103, "NAN", 3);
STRING_LITERAL(TMP4104, "0.0", 3);
STRING_LITERAL(TMP4105, "INF", 3);
STRING_LITERAL(TMP4106, "-INF", 4);
...
N_NIMCALL(NI, decodevint_270264_3471544153)(NCSTRING s0, NI* pos0) {
	...
	result0 = (NI)((NU64)((NI)(result0 * sign_270273_3471544153)) - (NU64)(((NI) 5)));
...
N_NIMCALL(void, encodevintaux_270190_3471544153)(NI x0, NimStringDesc** result0) {
	...
	rem_270200_3471544153 = (NI)(v_270198_3471544153 % ((NI) 190));
	{
		...
		v_270198_3471544153 = ((NI64)-((NI)(v_270198_3471544153 / ((NI) 190))));
		rem_270200_3471544153 = ((NI64)-(((NI) (rem_270200_3471544153))));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(void, encodevint_270211_3471544153)(NI x0, NimStringDesc** result0) {
	encodevintaux_270190_3471544153((NI)((NU64)(x0) + (NU64)(((NI) 5))), result0);
}
...
N_NIMCALL(NimStringDesc*, tostrmaxprecision_270009_3471544153)(NF f0) {
	...
	{
		if (!!((f0 == f0))) goto LA3;
		result0 = copyString(((NimStringDesc*) &TMP4103));
	}
	goto LA1;
	LA3: ;
	{
