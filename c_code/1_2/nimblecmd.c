...
N_NIMCALL(void, addpathrec_206273)(NimStringDesc* dir, tlineinfo196539 info);
...
N_NIMCALL(void, addpackage_206148)(stringtableobj133012* packages, NimStringDesc* p);
...
N_NIMCALL(void, addpath_206012)(NimStringDesc* path, tlineinfo196539 info) {
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = contains_129224((&searchpaths_170122), path);
		if (!!(LOC3)) goto LA4;
		prependstr_129424((&searchpaths_170122), path);
	}
	LA4: ;
}
...
N_NIMCALL(NIM_BOOL, HEX3CHEX2E_206071)(NimStringDesc* a, NimStringDesc* b) {
	...
	result = 0;
	{
		if (!eqStrings(a, ((NimStringDesc*) &TMP1698))) goto LA3;
		result = NIM_FALSE;
		goto BeforeRet;
	}
	LA3: ;
...
N_NIMCALL(void, addpackage_206148)(stringtableobj133012* packages, NimStringDesc* p) {
	...
	LA3: ;
	{
		nstPut(packages, name, ((NimStringDesc*) &TMP1698));
	}
	LA1: ;
}
...
N_NIMCALL(void, addnimblepath_206196)(NimStringDesc* p, tlineinfo196539 info) {
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = contains_129224((&searchpaths_170122), p);
		if (!!(LOC3)) goto LA4;
		{
			if (!(1 <= gverbosity_170127)) goto LA8;
			message_198976(info, ((NU16) 271), p);
		}
		LA8: ;
		prependstr_129424((&lazypaths_170123), p);
	}
	LA4: ;
}
...
N_NIMCALL(void, addpathrec_206273)(NimStringDesc* dir, tlineinfo196539 info) {
	...
	{
		NU8 k_206305;
		NimStringDesc* p_206306;
		twin32finddata104019 f_206320;
		NI h_206322;
		NimStringDesc* LOC6;
		k_206305 = 0;
		p_206306 = 0;
		memset((void*)(&f_206320), 0, sizeof(f_206320));
		LOC6 = 0;
		LOC6 = HEX2F_116499(dir, ((NimStringDesc*) &TMP1697));
		h_206322 = findfirstfile_113416(LOC6, (&f_206320));
		{
			if (!!((h_206322 == -1))) goto LA9;
			{
				while (1) {
					NU8 k_206324;
					k_206324 = ((NU8) 0);
					{
						...
						NimStringDesc* LOC27;
						LOC15 = 0;
						LOC15 = skipfinddata_113436((&f_206320));
						if (!!(LOC15)) goto LA16;
						{
							if (!!(((NI32)(f_206320.Dwfileattributes & ((NI32) 16)) == ((NI32) 0)))) goto LA20;
							k_206324 = ((NU8) 2);
						}
						LA20: ;
						{
							if (!!(((NI32)(f_206320.Dwfileattributes & ((NI32) 1024)) == ((NI32) 0)))) goto LA24;
							k_206324 = (k_206324 + 1);
						}
						LA24: ;
						k_206305 = k_206324;
						LOC26 = 0;
						LOC26 = HEX24_79195(((NI16*) ((&f_206320.Cfilename[(0)- 0]))));
						LOC27 = 0;
						LOC27 = nosextractFilename(LOC26);
						p_206306 = HEX2F_116499(dir, LOC27);
						{
							NIM_BOOL LOC30;
							LOC30 = 0;
							LOC30 = (k_206305 == ((NU8) 2));
							if (!(LOC30)) goto LA31;
							LOC30 = !(((NU8)(p_206306->data[pos]) == (NU8)(46)));
							LA31: ;
							if (!LOC30) goto LA32;
							addpackage_206148(packages, p_206306);
						}
						LA32: ;
					}
					LA16: ;
					{
						NI32 LOC36;
						LOC36 = 0;
						LOC36 = Dl_104044(h_206322, (&f_206320));
	...
	{
		NimStringDesc* p_206316;
		p_206316 = 0;
		{
			NimStringDesc* key_206331;
			NimStringDesc* val_206333;
			key_206331 = 0;
			val_206333 = 0;
			{
				NI h_206335;
				...
				h_206335 = 0;
				HEX3Atmp_206337 = 0;
				HEX3Atmp_206337 = ((*packages).Data->Sup.len-1);
				res_206339 = 0;
				{
					while (1) {
						if (!(res_206339 <= HEX3Atmp_206337)) goto LA43;
						h_206335 = res_206339;
						{
							NimStringDesc* res_206341;
							if (!!((*packages).Data->data[h_206335].Field0 == 0)) goto LA46;
							key_206331 = (*packages).Data->data[h_206335].Field0;
							val_206333 = (*packages).Data->data[h_206335].Field1;
							{
								if (!eqStrings(val_206333, ((NimStringDesc*) &TMP1698))) goto LA50;
								res_206341 = key_206331;
							}
							goto LA48;
							LA50: ;
							{
								NimStringDesc* LOC53;
								LOC53 = 0;
								LOC53 = rawNewString(key_206331->Sup.len + val_206333->Sup.len + 1);
appendString(LOC53, key_206331);
appendChar(LOC53, 45);
appendString(LOC53, val_206333);
								res_206341 = LOC53;
							}
							LA48: ;
							p_206316 = res_206341;
							addnimblepath_206196(p_206316, info);
						}
						LA46: ;
						res_206339 += 1;
					} LA43: ;
