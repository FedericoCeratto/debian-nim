...
STRING_LITERAL(TMP1714, "key not found: ", 15);
STRING_LITERAL(TMP1963, "", 0);
STRING_LITERAL(TMP2208, "format string: key not found: ", 30);
...
appendString(LOC6, ((NimStringDesc*) &TMP1714));
...
appendString(LOC1, ((NimStringDesc*) &TMP2208));
