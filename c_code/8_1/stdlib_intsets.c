...
TMP964[0] = &TMP723[1];
TMP723[1].kind = 1;
TMP723[1].offset = offsetof(intset221056, Counter);
TMP723[1].typ = (&NTI108);
TMP723[1].name = "counter";
TMP964[1] = &TMP723[2];
TMP723[2].kind = 1;
TMP723[2].offset = offsetof(intset221056, Max);
TMP723[2].typ = (&NTI108);
TMP723[2].name = "max";
TMP964[2] = &TMP723[3];
...
TMP965[0] = &TMP723[5];
TMP723[5].kind = 1;
TMP723[5].offset = offsetof(ttrunk221052, Next);
TMP723[5].typ = (&NTI221050);
TMP723[5].name = "next";
TMP965[1] = &TMP723[6];
TMP723[6].kind = 1;
TMP723[6].offset = offsetof(ttrunk221052, Key);
TMP723[6].typ = (&NTI108);
TMP723[6].name = "key";
TMP965[2] = &TMP723[7];
TMP723[7].kind = 1;
TMP723[7].offset = offsetof(ttrunk221052, Bits);
TMP723[7].typ = (&NTI26420);
TMP723[7].name = "bits";
TMP723[4].len = 3; TMP723[4].kind = 2; TMP723[4].sons = &TMP965[0];
NTI221052.node = &TMP723[4];
NTI221050.size = sizeof(ttrunk221052*);
NTI221050.kind = 22;
NTI221050.base = (&NTI221052);
NTI221050.marker = TMP966;
TMP723[3].kind = 1;
TMP723[3].offset = offsetof(intset221056, Head);
TMP723[3].typ = (&NTI221050);
TMP723[3].name = "head";
TMP964[3] = &TMP723[8];
...
NTI221054.flags = 2;
NTI221054.marker = TMP967;
TMP723[8].kind = 1;
TMP723[8].offset = offsetof(intset221056, Data);
TMP723[8].typ = (&NTI221054);
TMP723[8].name = "data";
TMP723[0].len = 4; TMP723[0].kind = 2; TMP723[0].sons = &TMP964[0];
NTI221056.node = &TMP723[0];
}
