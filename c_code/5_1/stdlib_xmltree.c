...
N_NIMCALL(void, addescaped_375039)(NimStringDesc** result, NimStringDesc* s);
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src);
N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen);
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
STRING_LITERAL(TMP5051, "&lt;", 4);
STRING_LITERAL(TMP5052, "&gt;", 4);
STRING_LITERAL(TMP5053, "&amp;", 5);
STRING_LITERAL(TMP5054, "&quot;", 6);
...
N_NIMCALL(void, addescaped_375039)(NimStringDesc** result, NimStringDesc* s) {
	{
		...
		c_375045 = 0;
		i_375049 = ((NI) 0);
		L_375051 = (s ? s->Sup.len : 0);
		{
			while (1) {
				if (!(i_375049 < L_375051)) goto LA3;
				c_375045 = s->data[i_375049];
				switch (((NU8)(c_375045))) {
				case 60:
				{
...
appendString((*result), ((NimStringDesc*) &TMP5056));
				...
				default:
				{
					(*result) = addChar((*result), c_375045);
				}
				break;
				}
				i_375049 += ((NI) 1);
