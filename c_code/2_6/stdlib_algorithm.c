...
typedef N_CLOSURE_PTR(NI, TMP2732) (Tsym225841* x_396105, Tsym225841* y_396107);
typedef N_CLOSURE_PTR(NI, TMP2733) (Tsym225841* x_396105, Tsym225841* y_396107);
...
typedef N_CLOSURE_PTR(NI, TMP5181) (NimStringDesc* x_352162, NimStringDesc* y_352164);
typedef N_CLOSURE_PTR(NI, TMP5182) (NimStringDesc* x_352162, NimStringDesc* y_352164);
typedef struct {
...
typedef N_CLOSURE_PTR(NI, TMP5185) (Indexentry348397 x_350084, Indexentry348397 y_350086);
typedef N_CLOSURE_PTR(NI, TMP5186) (Indexentry348397 x_350084, Indexentry348397 y_350086);
struct  TNimObject  {
TNimType* m_type;
};
struct  Tidobj198015  {
...
{	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI)(m + ((NI) 1))], cmp.ClEnv):((TMP2732)(cmp.ClPrc))(a[m], a[(NI)(m + ((NI) 1))]);
		LOC4 = 0;
	...
	k = lo;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = 0;
				LOC15 = cmp.ClEnv? cmp.ClPrc(b[i], a[j], cmp.ClEnv):((TMP2733)(cmp.ClPrc))(b[i], a[j]);
				LOC16 = 0;
...
{	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI)(m + ((NI) 1))], cmp.ClEnv):((TMP5181)(cmp.ClPrc))(a[m], a[(NI)(m + ((NI) 1))]);
		LOC4 = 0;
		LOC4 = HEX2A_346020(LOC3, order);
		if (!(LOC4 <= ((NI) 0))) goto LA5;
		goto BeforeRet;
	...
	k = lo;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = 0;
				LOC15 = cmp.ClEnv? cmp.ClPrc(b[i], a[j], cmp.ClEnv):((TMP5182)(cmp.ClPrc))(b[i], a[j]);
				LOC16 = 0;
				LOC16 = HEX2A_346020(LOC15, order);
				if (!(LOC16 <= ((NI) 0))) goto LA17;
				unsureAsgnRef((void**) (&a[k]), b[i]);
...
{	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI)(m + ((NI) 1))], cmp.ClEnv):((TMP5185)(cmp.ClPrc))(a[m], a[(NI)(m + ((NI) 1))]);
		LOC4 = 0;
		LOC4 = HEX2A_346020(LOC3, order);
		if (!(LOC4 <= ((NI) 0))) goto LA5;
		goto BeforeRet;
	...
	k = lo;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = 0;
				LOC15 = cmp.ClEnv? cmp.ClPrc(b[i], a[j], cmp.ClEnv):((TMP5186)(cmp.ClPrc))(b[i], a[j]);
				LOC16 = 0;
				LOC16 = HEX2A_346020(LOC15, order);
				if (!(LOC16 <= ((NI) 0))) goto LA17;
