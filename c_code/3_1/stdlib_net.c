...
N_NIMCALL(void, send_518008)(Socketimpl513407* socket, NimStringDesc* data, NU8 flags) {
	NI sent;
{	sent = send_517716(socket, ((void*) (data->data)), (data ? data->Sup.len : 0));
	...
	LA3: ;
	{
		Oserror3433* e_518019;
		NimStringDesc* LOC14;
		if (!!((sent == (data ? data->Sup.len : 0)))) goto LA12;
		e_518019 = 0;
		e_518019 = (Oserror3433*) newObj((&NTI117012), sizeof(Oserror3433));
		(*e_518019).Sup.Sup.Sup.m_type = (&NTI3433);
		LOC14 = 0;
		LOC14 = (*e_518019).Sup.Sup.message; (*e_518019).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4992));
		if (LOC14) nimGCunrefNoCycle(LOC14);
		raiseException((Exception*)e_518019, "OSError");
	}
	LA12: ;
	}BeforeRet: ;
}
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_516819(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP4999));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_516819(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP4999));
