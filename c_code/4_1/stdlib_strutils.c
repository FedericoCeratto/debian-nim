...
STRING_LITERAL(TMP1218, "0123456789ABCDEF", 16);
	...
	result = mnewString(len);
	{
		...
		res_95595 = HEX3Atmp_95592;
		{
			while (1) {
				...
				j_95588 = res_95595;
				result->data[j_95588] = ((NimStringDesc*) &TMP1218)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(x) >> (NU64)(shift)))) & ((NI32) 15))];
...
N_NIMCALL(NimStringDesc*, quoteifcontainswhite_97234)(NimStringDesc* s) {
	...
	result = 0;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = nsuFindCharSet(s, TMP1567, 0);
		LOC3 = (0 <= LOC4);
		if (!(LOC3)) goto LA5;
