...
STRING_LITERAL(TMP1892, "/usr", 4);
STRING_LITERAL(TMP1893, "/usr/lib/nim", 12);
STRING_LITERAL(TMP1894, "/usr/local", 10);
STRING_LITERAL(TMP1895, "/usr/local/lib/nim", 18);
STRING_LITERAL(TMP1896, "lib", 3);
STRING_LITERAL(TMP1897, "@", 1);
STRING_LITERAL(TMP1898, "\')\'", 3);
STRING_LITERAL(TMP1899, "\':\'", 3);
STRING_LITERAL(TMP1900, "@if", 3);
STRING_LITERAL(TMP1901, "@end", 4);
STRING_LITERAL(TMP1902, "putenv", 6);
STRING_LITERAL(TMP1903, "prependenv", 10);
STRING_LITERAL(TMP1904, "appendenv", 9);
STRING_LITERAL(TMP1905, "-", 1);
STRING_LITERAL(TMP1906, "--", 2);
STRING_LITERAL(TMP1907, "", 0);
STRING_LITERAL(TMP1908, "\']\'", 3);
STRING_LITERAL(TMP1909, "&", 1);
STRING_LITERAL(TMP1910, "config", 6);
STRING_LITERAL(TMP1911, "etc", 3);
STRING_LITERAL(TMP1912, "/etc/", 5);
STRING_LITERAL(TMP1914, "nim.cfg", 7);
STRING_LITERAL(TMP1915, "nimrod.cfg", 10);
...
N_NIMCALL(NIM_BOOL, parseatom_221051)(tlexer216190* l, ttoken216186* tok) {
	...
	result = 0;
	{
		...
		LA7: ;
		{
			lexmessage_216289((&(*l)), ((NU16) 23), ((NimStringDesc*) &TMP1898));
		}
		LA5: ;
	}
	goto LA1;
...
N_NIMCALL(NIM_BOOL, evalppif_221149)(tlexer216190* l, ttoken216186* tok) {
	...
	LA3: ;
	{
		lexmessage_216289((&(*l)), ((NU16) 23), ((NimStringDesc*) &TMP1899));
	}
	LA1: ;
	return result;
}
...
N_NIMCALL(void, doelse_221243)(tlexer216190* l, ttoken216186* tok) {
	{
		...
		lexmessage_216289((&(*l)), ((NU16) 23), ((NimStringDesc*) &TMP1900));
	}
	LA3: ;
	ppgettok_221009(l, tok);
	{
		...
		while (1) {
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = eqStrings((*(*tok).Ident).S, ((NimStringDesc*) &TMP1897));
				LA6: ;
				if (!LOC5) goto LA7;
				ppgettok_221009(l, tok);
				LOC9 = 0;
			...
			LA7: ;
			{
				...
				lexmessage_216289((&(*l)), ((NU16) 23), ((NimStringDesc*) &TMP1901));
			}
			goto LA3;
			LA36: ;
			{
...
N_NIMCALL(void, parsedirective_221369)(tlexer216190* l, ttoken216186* tok) {
	...
	default:
	{
		...
		if (eqStrings(LOC13, ((NimStringDesc*) &TMP1902))) goto LA14;
		if (eqStrings(LOC13, ((NimStringDesc*) &TMP1903))) goto LA15;
		if (eqStrings(LOC13, ((NimStringDesc*) &TMP1904))) goto LA16;
		goto LA17;
		LA14: ;
		{
			NimStringDesc* key;
...
N_NIMCALL(void, conftok_221412)(tlexer216190* l, ttoken216186* tok) {
	ppgettok_221009(l, tok);
	{
		while (1) {
			...
			if (!(LOC3)) goto LA4;
			LOC3 = eqStrings((*(*tok).Ident).S, ((NimStringDesc*) &TMP1897));
			LA4: ;
			if (!LOC3) goto LA2;
...
N_NIMCALL(void, parseassignment_221485)(tlexer216190* l, ttoken216186* tok) {
	...
	NimStringDesc* val;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = getident_201472(((NimStringDesc*) &TMP1905));
		LOC3 = ((*(*tok).Ident).Sup.Id == (*LOC4).Sup.Id);
		if (LOC3) goto LA5;
		LOC6 = 0;
		LOC6 = getident_201472(((NimStringDesc*) &TMP1906));
	...
	conftok_221412(l, tok);
	val = copyString(((NimStringDesc*) &TMP1907));
	{
		while (1) {
			NimStringDesc* LOC11;
...
appendString(val, LOC16);
		...
		LA19: ;
		{
			lexmessage_216289((&(*l)), ((NU16) 23), ((NimStringDesc*) &TMP1908));
		}
		LA17: ;
		val = addChar(val, 93);
	}
...
appendString(val, LOC30);
		conftok_221412(l, tok);
		{
			while (1) {
				...
				if (!(LOC33)) goto LA34;
				LOC35 = 0;
				LOC35 = getident_201472(((NimStringDesc*) &TMP1909));
...
N_NIMCALL(NimStringDesc*, getsystemconfigpath_221652)(NimStringDesc* filename) {
	...
	LOC1[0] = copyString(p);
	LOC1[1] = copyString(((NimStringDesc*) &TMP1910));
	...
	result = nosjoinPathOpenArray(LOC1, 3);
	{
		...
		LOC7[0] = copyString(p);
		LOC7[1] = copyString(((NimStringDesc*) &TMP1911));
...
appendString(LOC13, ((NimStringDesc*) &TMP1912));
...
N_NIMCALL(void, loadconfigs_221811)(NimStringDesc* cfg) {
	NimStringDesc* pd;
	{
		...
		{
			NimStringDesc* LOC9;
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP1892))) goto LA7;
			LOC9 = 0;
			LOC9 = libpath_170233; libpath_170233 = copyStringRC1(((NimStringDesc*) &TMP1893));
		...
		{
			NimStringDesc* LOC13;
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP1894))) goto LA11;
			LOC13 = 0;
			LOC13 = libpath_170233; libpath_170233 = copyStringRC1(((NimStringDesc*) &TMP1895));
			if (LOC13) nimGCunrefNoCycle(LOC13);
		}
		goto LA5;
		LA11: ;
		{
			asgnRefNoCycle((void**) (&libpath_170233), nosjoinPath(prefix, ((NimStringDesc*) &TMP1896)));
		}
		LA5: ;
	}
	LA3: ;
	...
	LA22: ;
	{
		if (!(0 < gprojectpath_170235->Sup.len)) goto LA27;
		...
		if (!!(((gglobaloptions_170118 &(1<<((((NU8) 19))&31)))!=0))) goto LA32;
		{
			...
			dir_222044 = 0;
			{
				...
				current_222064 = copyString(pd);
				{
					...
					dir_222044 = pd;
					LOC43 = 0;
					LOC43 = HEX2F_117299(dir_222044, cfg);
				...
				LA41: ;
				{
					while (1) {
						NimStringDesc* LOC51;
						{
							NIM_BOOL LOC48;
							LOC48 = 0;
							LOC48 = nosisRootDir(current_222064);
							if (!LOC48) goto LA49;
							goto LA44;
						}
						LA49: ;
						...
						LOC51 = 0;
						LOC51 = HEX2F_117299(dir_222044, cfg);
			...
			{
				{
					...
					{
						while (1) {
							if (!(res_222070 <= HEX3Atmp_222068)) goto LA55;
							i_222066 = res_222070;
							{
								NIM_BOOL LOC58;
								NIM_BOOL LOC60;
								NimStringDesc* LOC64;
								LOC58 = 0;
								LOC58 = (((NU8)(pd->data[i_222066])) == ((NU8)(47)) || ((NU8)(pd->data[i_222066])) == ((NU8)(47)));
								if (!(LOC58)) goto LA59;
								LOC60 = 0;
								LOC60 = (i_222066 == 0);
								if (LOC60) goto LA61;
								LOC60 = !((((NU8)(pd->data[(NI64)(i_222066 - 1)])) == ((NU8)(47)) || ((NU8)(pd->data[(NI64)(i_222066 - 1)])) == ((NU8)(47))));
								LA61: ;
								LOC58 = LOC60;
								LA59: ;
								if (!LOC58) goto LA62;
								...
								LOC64 = 0;
								LOC64 = HEX2F_117299(dir_222044, cfg);
				...
				}
				{
					...
					dir_222044 = pd;
					LOC69 = 0;
					LOC69 = HEX2F_117299(dir_222044, cfg);
	...
	LA32: ;
	{
		...
		readconfigfile_221573(LOC74);
		{
			...
			if (!!((gprojectname_170234->Sup.len == 0))) goto LA77;
			projectconfig = noschangeFileExt(gprojectfull_170236, ((NimStringDesc*) &TMP1914));
			{
				NIM_BOOL LOC81;
				LOC81 = 0;
			...
			LA82: ;
			{
				NimStringDesc* LOC85;
				LOC85 = 0;
				LOC85 = noschangeFileExt(gprojectfull_170236, ((NimStringDesc*) &TMP1915));
