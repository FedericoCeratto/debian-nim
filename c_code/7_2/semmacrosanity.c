...
N_NIMCALL(tsym224846*, ithfield_481012)(tnode224816* n, NI field) {
	...
	{
		{
			...
			HEX3Atmp_481188 = (NI64)(LOC3 - 1);
			res_481191 = 0;
			{
				while (1) {
					if (!(res_481191 <= HEX3Atmp_481188)) goto LA5;
					i_481029 = res_481191;
					result = ithfield_481012((*n).kindU.S6.Sons->data[i_481029], (NI64)(field - i_481029));
					{
	...
	case ((NU8) 138):
	{
		...
		LA13: ;
		result = ithfield_481012((*n).kindU.S6.Sons->data[0], (NI64)(field - 1));
		{
			...
			res_481197 = 1;
			{
				while (1) {
					...
					case ((NU8) 88):
					{
						...
						result = ithfield_481012(LOC24, (NI64)(field - 1));
						{
