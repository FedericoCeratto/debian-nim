...
N_NIMCALL(NI, send_588511_170061329)(Socketimpl583406* socket0, void* data0, NI size0);
...
N_NIMCALL(NI, waitfor_587607_170061329)(Socketimpl583406* socket0, NF* waited0, NI timeout0, NI size0, NimStringDesc* funcname0);
...
N_NIMCALL(void, send_589002_170061329)(Socketimpl583406* socket0, NimStringDesc* data0, Socketflag583416Set flags0) {
	NI sent0;
{	sent0 = send_588511_170061329(socket0, ((void*) (data0->data)), (data0 ? data0->Sup.len : 0));
	{
		NI32 lasterror0;
...
appendString((*line0), ((NimStringDesc*) &T170061329_12));
			...
			(*line0) = addChar((*line0), c0);
			{
				...
				e_588438_170061329 = (Valueerror3646*) newObj((&NTI23425), sizeof(Valueerror3646));
