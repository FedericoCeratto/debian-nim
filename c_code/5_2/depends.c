...
N_NIMCALL(void, TMP4826)(void* p, NI op);
...
STRING_LITERAL(TMP4827, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP4828, "digraph $1 {$n$2}$n", 19);
...
N_NIMCALL(void, adddependencyaux_608028)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_177115(&gdotgraph_608023, ((NimStringDesc*) &TMP4827), LOC1, 2);
}
...
N_NIMCALL(void, generatedot_608009)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP4829));
	LOC1[0] = torope_177076(LOC3);
	LOC1[1] = gdotgraph_608023;
	LOC4 = 0;
	LOC4 = ropef_177107(((NimStringDesc*) &TMP4828), LOC1, 2);
	LOC5 = 0;
	LOC5 = noschangeFileExt(project, ((NimStringDesc*) &TMP4830));
