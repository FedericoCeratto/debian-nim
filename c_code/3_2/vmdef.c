...
N_NIMCALL(tctx289048*, newctx_289279)(tsym225846* module) {
	...
	LOC3 = 0;
	LOC3 = (*LOC1).Errorflag; (*LOC1).Errorflag = copyStringRC1(((NimStringDesc*) &TMP2722));
...
static TNimNode* TMP1947[18];
static TNimNode* TMP1949[4];
static TNimNode* TMP1950[2];
static TNimNode* TMP1953[2];
static TNimNode* TMP1954[9];
NI TMP1956;
static char* NIM_CONST TMP1955[9] = {
"slotEmpty", 
"slotFixedVar", 
"slotFixedLet", 
"slotTempUnknown", 
...
NI TMP1960;
static char* NIM_CONST TMP1959[5] = {
"emRepl", 
"emConst", 
"emOptimize", 
"emStaticExpr", 
"emStaticStmt"};
static TNimNode* TMP1961[3];
NI TMP1963;
static char* NIM_CONST TMP1962[3] = {
"allowCast", 
"allowFFI", 
"allowInfiniteLoops"};
static TNimNode* TMP1964[2];
static TNimNode* TMP1965[2];
static TNimNode* TMP2850[155];
NI TMP2852;
static char* NIM_CONST TMP2851[155] = {
"opcEof", 
"opcRet", 
"opcYldYoid", 
"opcYldVal", 
...
NTI289038.base = 0;
NTI289038.flags = 3;
for (TMP1956 = 0; TMP1956 < 9; TMP1956++) {
TMP850[TMP1956+20].kind = 1;
TMP850[TMP1956+20].offset = TMP1956;
TMP850[TMP1956+20].name = TMP1955[TMP1956];
TMP1954[TMP1956] = &TMP850[TMP1956+20];
}
TMP850[29].len = 9; TMP850[29].kind = 2; TMP850[29].sons = &TMP1954[0];
NTI289038.node = &TMP850[29];
TMP850[19].kind = 1;
TMP850[19].offset = offsetof(TY289237, Field1);
TMP850[19].typ = (&NTI289038);
TMP850[19].name = "Field1";
TMP850[17].len = 2; TMP850[17].kind = 2; TMP850[17].sons = &TMP1953[0];
...
TMP1947[10] = &TMP850[32];
TMP850[32].kind = 1;
TMP850[32].offset = offsetof(tctx289048, Callsite);
TMP850[32].typ = (&NTI225808);
TMP850[32].name = "callsite";
TMP1947[11] = &TMP850[33];
NTI289032.size = sizeof(NU8);
NTI289032.kind = 14;
NTI289032.base = 0;
NTI289032.flags = 3;
for (TMP1960 = 0; TMP1960 < 5; TMP1960++) {
TMP850[TMP1960+34].kind = 1;
TMP850[TMP1960+34].offset = TMP1960;
TMP850[TMP1960+34].name = TMP1959[TMP1960];
TMP1958[TMP1960] = &TMP850[TMP1960+34];
}
TMP850[39].len = 5; TMP850[39].kind = 2; TMP850[39].sons = &TMP1958[0];
NTI289032.node = &TMP850[39];
TMP850[33].kind = 1;
TMP850[33].offset = offsetof(tctx289048, Mode);
TMP850[33].typ = (&NTI289032);
TMP850[33].name = "mode";
TMP1947[12] = &TMP850[40];
NTI289034.size = sizeof(NU8);
NTI289034.kind = 14;
NTI289034.base = 0;
NTI289034.flags = 3;
for (TMP1963 = 0; TMP1963 < 3; TMP1963++) {
TMP850[TMP1963+41].kind = 1;
TMP850[TMP1963+41].offset = TMP1963;
TMP850[TMP1963+41].name = TMP1962[TMP1963];
TMP1961[TMP1963] = &TMP850[TMP1963+41];
}
TMP850[44].len = 3; TMP850[44].kind = 2; TMP850[44].sons = &TMP1961[0];
