...
NIM_CONST TY84945 TMP3019 = {((NimStringDesc*) &TMP3020),
100}
;
NIM_CONST TY84945 TMP3021 = {((NimStringDesc*) &TMP3020),
107}
;
...
N_NIMCALL(tnode225816*, semnodekindconstraints_321527)(tnode225816* p) {
	...
	(*result).kindU.S3.Strval = addChar((*result).kindU.S3.Strval, 1);
	{
		...
		}
		{
			...
			internalerror_197987((*p).Info, ((NimStringDesc*) &TMP3022));
		}
		LA12: ;
	}
	goto LA1;
