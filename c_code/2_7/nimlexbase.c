...
TMP1009[0] = &TMP713[1];
TMP713[1].kind = 1;
TMP713[1].offset = offsetof(tbaselexer214024, Bufpos);
TMP713[1].typ = (&NTI108);
TMP713[1].name = "bufpos";
TMP1009[1] = &TMP713[2];
TMP713[2].kind = 1;
TMP713[2].offset = offsetof(tbaselexer214024, Buf);
TMP713[2].typ = (&NTI151);
TMP713[2].name = "buf";
TMP1009[2] = &TMP713[3];
TMP713[3].kind = 1;
TMP713[3].offset = offsetof(tbaselexer214024, Buflen);
TMP713[3].typ = (&NTI108);
TMP713[3].name = "bufLen";
TMP1009[3] = &TMP713[4];
TMP713[4].kind = 1;
TMP713[4].offset = offsetof(tbaselexer214024, Stream);
TMP713[4].typ = (&NTI212206);
TMP713[4].name = "stream";
TMP1009[4] = &TMP713[5];
TMP713[5].kind = 1;
TMP713[5].offset = offsetof(tbaselexer214024, Linenumber);
TMP713[5].typ = (&NTI108);
TMP713[5].name = "lineNumber";
TMP1009[5] = &TMP713[6];
TMP713[6].kind = 1;
TMP713[6].offset = offsetof(tbaselexer214024, Sentinel);
TMP713[6].typ = (&NTI108);
TMP713[6].name = "sentinel";
TMP1009[6] = &TMP713[7];
TMP713[7].kind = 1;
TMP713[7].offset = offsetof(tbaselexer214024, Linestart);
TMP713[7].typ = (&NTI108);
TMP713[7].name = "lineStart";
TMP713[0].len = 7; TMP713[0].kind = 2; TMP713[0].sons = &TMP1009[0];
NTI214024.node = &TMP713[0];
}
