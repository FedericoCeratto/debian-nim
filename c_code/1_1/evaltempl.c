...
STRING_LITERAL(TMP2845, "compiler/evaltempl.nim", 22);
NIM_CONST TY86345 TMP2844 = {((NimStringDesc*) &TMP2845),
39}
;
...
N_NIMCALL(tnode226816*, evaltemplateargs_456217)(tnode226816* n, tsym226846* s) {
	...
	{
		if (!(f < a)) goto LA5;
		globalerror_198934((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP2843));
	}
	LA5: ;
		...
		res_456313 = 1;
		{
			while (1) {
				...
				LA10: ;
				{
					...
					LA18: ;
					if (!LOC17) goto LA19;
					localerror_198955((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP2843));
				}
				LA19: ;
	...
	case ((NU8) 3):
	{
		...
		s = (*templ).kindU.S4.Sym;
		{
			...
			LA8: ;
			{
				...
				LA36: ;
				LOC41 = 0;
				LOC41 = newsymnode_228755(x, LOC35);
...
N_NIMCALL(tnode226816*, evaltemplate_456334)(tnode226816* n, tsym226846* tmpl, tsym226846* gensymowner) {
	...
	evaltemplatecounter_456330 += 1;
	{
		...
		globalerror_198934((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP2843));
		result = n;
	}
	LA3: ;
	...
	body = getbody_280270(tmpl);
	{
		NIM_BOOL LOC7;
		LOC7 = 0;
		LOC7 = isatom_233962(body);
		if (!LOC7) goto LA8;
