...
STRING_LITERAL(TMP1355, "*.nimble", 8);
STRING_LITERAL(TMP1356, "*.babel", 7);
STRING_LITERAL(TMP1357, "nimcache", 8);
STRING_LITERAL(TMP1359, "\012", 1);
STRING_LITERAL(TMP1360, "cannot create directory: ", 25);
STRING_LITERAL(TMP1390, "nim", 3);
STRING_LITERAL(TMP1880, "lib", 3);
static NIM_CONST TY211607 TMP1881 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1882, "true", 4);
...
TY120008* commandargs_169261;
extern TNimType NTI120008; /* seq[string] */
NIM_BOOL gkeepcomments_169262;
TY120008* implicitimports_169284;
TY120008* implicitincludes_169306;
			...
			current_169890 = copyString(path);
			{
				while (1) {
					...
					parents += 1;
					{
						...
						file_169844 = 0;
						HEX3Atmp_169861 = 0;
						HEX3Atmp_169861 = HEX2F_117499(d_169831, ((NimStringDesc*) &TMP1355));
					...
					}
					{
						...
						file_169845 = 0;
						HEX3Atmp_169875 = 0;
						HEX3Atmp_169875 = HEX2F_117499(d_169831, ((NimStringDesc*) &TMP1356));
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_169429)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_117499(LOC6, ((NimStringDesc*) &TMP1357));
	}
	LA1: ;
	return result;
}
...
static N_INLINE(void, writeln_170205)(FILE* f_170209, NimStringDesc** x_170213, NI x_170213Len0) {
	...
	write_13065(f_170209, ((NimStringDesc*) &TMP1359));
}
...
N_NIMCALL(NimStringDesc*, completegeneratedfilepath_170001)(NimStringDesc* f, NIM_BOOL createsubdir) {
	...
	subdir = getgeneratedpath_169429();
	{
		...
		pushSafePoint(&TMP1358);
		TMP1358.status = _setjmp(TMP1358.context);
		if (TMP1358.status == 0) {
			noscreateDir(subdir);
			popSafePoint();
		}
...
appendString(LOC10, ((NimStringDesc*) &TMP1360));
appendString(LOC10, subdir);
		...
		if (TMP1358.status != 0) reraiseException();
	}
	LA4: ;
...
N_NIMCALL(NimStringDesc*, findmodule_170366)(NimStringDesc* modulename, NimStringDesc* currentmodule) {
	...
	TY117804 LOC1;
	result = 0;
	m = nosaddFileExt(modulename, ((NimStringDesc*) &TMP1390));
	memset((void*)(&LOC1), 0, sizeof(LOC1));
...
N_NIMCALL(NimStringDesc*, canondynlibname_170468)(NimStringDesc* s) {
	...
	result = 0;
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = nsuStartsWith(s, ((NimStringDesc*) &TMP1880));
		if (!LOC3) goto LA4;
		start = 3;
	}
	goto LA1;
	...
	LA1: ;
	ende = nsuFindCharSet(s, TMP1881, 0);
	{
		if (!(0 <= ende)) goto LA9;
...
N_NIMCALL(void, incldynliboverride_170481)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_169232, LOC1, ((NimStringDesc*) &TMP1882));
}
