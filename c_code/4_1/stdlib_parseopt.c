...
STRING_LITERAL(TMP1823, "", 0);
static NIM_CONST char136Set TMP1824 = {
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST char136Set TMP1832 = {
...
N_NIMCALL(NimStringDesc*, quote_250287_4065315820)(NimStringDesc* s0) {
	...
	result0 = (NimStringDesc*)0;
	{
		...
		LOC3 = (NIM_BOOL)0;
		LOC4 = (NI)0;
		LOC4 = nsuFindCharSet(s0, TMP1824, ((NI) 0));
		LOC3 = (((NI) 0) <= LOC4);
		if (!(LOC3)) goto LA5;
		...
		if (!LOC3) goto LA6;
		{
			...
			i0 = parseword_250218_4065315820(s0, ((NI) 0), (&result0), TMP1825);
			{
...
N_NIMCALL(void, initoptparser_250325_4065315820)(NimStringDesc* cmdline0, Optparser250205* Result) {
	...
	LA3: ;
	{
		unsureAsgnRef((void**) (&(*Result).cmd), copyString(((NimStringDesc*) &TMP1823)));
		{
...
appendString((*Result).cmd, LOC10);
	...
	unsureAsgnRef((void**) (&(*Result).key), copyString(((NimStringDesc*) &TMP1826)));
	unsureAsgnRef((void**) (&(*Result).val), copyString(((NimStringDesc*) &TMP1826)));
}
...
N_NIMCALL(void, handleshortoption_250401_4065315820)(Optparser250205* p0) {
	...
	}
	{
		...
		i0 = parseword_250218_4065315820((*p0).cmd, i0, (&(*p0).val), TMP1827);
	}
	LA5: ;
	{
...
{	i0 = (*p0).pos;
	...
	case 45:
	{
		i0 += ((NI) 1);
		{
			...
			i0 += ((NI) 1);
			i0 = parseword_250218_4065315820((*p0).cmd, i0, (&(*p0).key), TMP1825);
			{
				while (1) {
			...
			}
			{
				...
				(*p0).pos = parseword_250218_4065315820((*p0).cmd, i0, (&(*p0).val), TMP1827);
			}
			goto LA15;
			LA17: ;
			{
	...
	default:
	{
		...
		(*p0).pos = parseword_250218_4065315820((*p0).cmd, i0, (&(*p0).key), TMP1827);
	}
	break;
	}
	}BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(Optparser250205* p0) {
	...
	result0 = nsuStrip(LOC1, NIM_TRUE, NIM_TRUE, TMP1832);
	return result0;
}
...
static TNimNode* TMP1819[6];
static TNimNode* TMP1820[4];
NI TMP1822;
static char* NIM_CONST TMP1821[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongOption", 
"cmdShortOption"};
...
NTI250203.base = 0;
NTI250203.flags = 3;
for (TMP1822 = 0; TMP1822 < 4; TMP1822++) {
TMP857[TMP1822+5].kind = 1;
TMP857[TMP1822+5].offset = TMP1822;
TMP857[TMP1822+5].name = TMP1821[TMP1822];
TMP1820[TMP1822] = &TMP857[TMP1822+5];
}
TMP857[9].len = 4; TMP857[9].kind = 2; TMP857[9].sons = &TMP1820[0];
...
TMP857[11].name = "val";
TMP857[0].len = 6; TMP857[0].kind = 2; TMP857[0].sons = &TMP1819[0];
