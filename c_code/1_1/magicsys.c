...
STRING_LITERAL(TMP2642, "int", 3);
STRING_LITERAL(TMP2643, "int8", 4);
STRING_LITERAL(TMP2644, "int16", 5);
STRING_LITERAL(TMP2645, "int32", 5);
STRING_LITERAL(TMP2646, "int64", 5);
STRING_LITERAL(TMP2647, "uint", 4);
STRING_LITERAL(TMP2648, "uint8", 5);
STRING_LITERAL(TMP2649, "uint16", 6);
STRING_LITERAL(TMP2650, "uint32", 6);
STRING_LITERAL(TMP2651, "uint64", 6);
STRING_LITERAL(TMP2652, "float", 5);
STRING_LITERAL(TMP2653, "float32", 7);
STRING_LITERAL(TMP2654, "float64", 7);
STRING_LITERAL(TMP2655, "float128", 8);
STRING_LITERAL(TMP2656, "bool", 4);
STRING_LITERAL(TMP2657, "char", 4);
STRING_LITERAL(TMP2658, "string", 6);
STRING_LITERAL(TMP2659, "cstring", 7);
STRING_LITERAL(TMP2660, "pointer", 7);
STRING_LITERAL(TMP2661, "request for typekind: ", 22);
STRING_LITERAL(TMP2662, "wanted: ", 8);
STRING_LITERAL(TMP2663, " got: ", 6);
STRING_LITERAL(TMP2664, "type not found: ", 16);
STRING_LITERAL(TMP3251, "invalid int size", 16);
...
N_NIMCALL(ttype226852*, getsystype_283030)(NU8 kind) {
	...
	result = gsystypes_283063[(kind)- 0];
	{
		...
		case ((NU8) 26):
		{
			result = systypefromname_283261(((NimStringDesc*) &TMP2660));
		}
		break;
		case ((NU8) 5):
		{
...
appendString(LOC26, ((NimStringDesc*) &TMP2661));
...
appendString(LOC31, ((NimStringDesc*) &TMP2663));
...
appendString(LOC36, ((NimStringDesc*) &TMP2664));
...
N_NIMCALL(tsym226846*, getcompilerproc_283036)(NimStringDesc* name) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = hashignorestyle_130885(name);
...
N_NIMCALL(void, setintlittype_283632)(tnode226816* result) {
	...
	default:
	{
		internalerror_198987((*result).Info, ((NimStringDesc*) &TMP3251));
	}
	break;
	}
}
