...
N_NIMCALL(NI, nodetablerawget_277210)(Tnodetable224871 t, NI k, Tnode224809* key);
N_NIMCALL(NIM_BOOL, treesequivalent_277111)(Tnode224809* a, Tnode224809* b);
...
N_NIMCALL(void, nodetablerawinsert_277258)(Tnodepairseq224869** data, NI k, Tnode224809* key, NI val);
	...
	{
		{
			...
			HEX3Atmp_277089 = (NI)(LOC30 - ((NI) 1));
			res_277092 = ((NI) 0);
			{
				while (1) {
					NI LOC33;
					if (!(res_277092 <= HEX3Atmp_277089)) goto LA32;
					i_277081 = res_277092;
					LOC33 = 0;
		...
		{
			{
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					HEX3Atmp_277188 = (NI)(LOC26 - ((NI) 1));
					res_277191 = ((NI) 0);
					{
						while (1) {
							if (!(res_277191 <= HEX3Atmp_277188)) goto LA28;
							i_277184 = res_277191;
							{
								NIM_BOOL LOC31;
								LOC31 = 0;
								LOC31 = treesequivalent_277111((*a).kindU.S6.sons->data[i_277184], (*b).kindU.S6.sons->data[i_277184]);
								if (!!(LOC31)) goto LA32;
								goto BeforeRet;
							}
							LA32: ;
	...
	h = (NI)(k & (t.data ? (t.data->Sup.len-1) : -1));
	{
		while (1) {
			if (!!((t.data->data[h].key == NIM_NIL))) goto LA2;
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = treesequivalent_277111(t.data->data[h].key, key);
				LA6: ;
				if (!LOC5) goto LA7;
				result = h;
				goto BeforeRet;
...
N_NIMCALL(NI, nodetabletestorset_277698)(Tnodetable224871* t, Tnode224809* key, NI val) {
	...
	index = nodetablerawget_277210((*t), k, key);
	{
	...
	LA3: ;
	{
				...
				res_277879 = ((NI) 0);
				{
					while (1) {
						...
						i_277839 = res_277879;
						{
							...
							nodetablerawinsert_277258((&n), (*t).data->data[i_277839].h, (*t).data->data[i_277839].key, (*t).data->data[i_277839].val);
						}
						LA16: ;
						res_277879 += ((NI) 1);
					} LA13: ;
		...
		LA9: ;
		nodetablerawinsert_277258((&(*t).data), k, key, val);
		result = val;
		(*t).counter += ((NI) 1);
	}
	LA1: ;
