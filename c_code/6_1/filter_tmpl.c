...
static NIM_CONST TY211607 TMP1340 = {
...
N_NIMCALL(void, parseline_259174)(ttmplparser259020* p) {
	...
	LA7: ;
	{
		...
		case ((NU8) 21):
		{
			...
			{
				(*p).Info.Col = ((NI16) (j));
				localerror_197955((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP1338));
			}
			LA20: ;
			LOC25 = 0;
	...
	LA10: ;
	{
				...
				{
					{
						...
						case 123:
						{
							...
							curly = 0;
							{
								while (1) {
									...
									case 0:
									{
										localerror_197955((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP1347));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).Info.Col = ((NI16) (j));
								localerror_197955((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP1335));
							}
							LA80: ;
						}
						break;
		...
		llstreamwrite_211278((*p).Outp, ((NimStringDesc*) &TMP1348));
	}
	LA3: ;
}
...
N_NIMCALL(tllstream211204*, filtertmpl_259009)(tllstream211204* stdin_259011, NimStringDesc* filename, tnode225816* call) {
	...
	p.Outp = llstreamopen_211220(((NimStringDesc*) &TMP1327));
	p.Inp = stdin_259011;
	p.Subschar = chararg_258020(call, ((NimStringDesc*) &TMP1328), 1, 36);
	p.Nimdirective = chararg_258020(call, ((NimStringDesc*) &TMP1329), 2, 35);
	p.Emit = strarg_258029(call, ((NimStringDesc*) &TMP1330), 3, ((NimStringDesc*) &TMP1331));
	p.Conc = strarg_258029(call, ((NimStringDesc*) &TMP1332), 4, ((NimStringDesc*) &TMP1333));
	p.Tostr = strarg_258029(call, ((NimStringDesc*) &TMP1334), 5, ((NimStringDesc*) &TMP1335));
