...
N_NIMCALL(tsym226846*, ithfield_483012)(tnode226816* n, NI field) {
	...
	{
		{
			...
			HEX3Atmp_483188 = (NI64)(LOC3 - 1);
			res_483191 = 0;
			{
				while (1) {
					if (!(res_483191 <= HEX3Atmp_483188)) goto LA5;
					i_483029 = res_483191;
					result = ithfield_483012((*n).kindU.S6.Sons->data[i_483029], (NI64)(field - i_483029));
					{
	...
	case ((NU8) 138):
	{
		...
		LA13: ;
		result = ithfield_483012((*n).kindU.S6.Sons->data[0], (NI64)(field - 1));
		{
			...
			res_483197 = 1;
			{
				while (1) {
					...
					case ((NU8) 88):
					{
						...
						result = ithfield_483012(LOC24, (NI64)(field - 1));
						{
