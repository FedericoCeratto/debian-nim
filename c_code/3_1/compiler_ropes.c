...
typedef N_CLOSURE_PTR(void, TMP3932) (Ropeserror173010 err0, NimStringDesc* msg0, NIM_BOOL usewarning0);
typedef N_CLOSURE_PTR(void, TMP3933) (Ropeserror173010 err0, NimStringDesc* msg0, NIM_BOOL usewarning0);
typedef N_CLOSURE_PTR(void, TMP3934) (Ropeserror173010 err0, NimStringDesc* msg0, NIM_BOOL usewarning0);
typedef N_CLOSURE_PTR(void, TMP3935) (Ropeserror173010 err0, NimStringDesc* msg0, NIM_BOOL usewarning0);
typedef NU8 Filemode12409;
typedef N_CLOSURE_PTR(void, TMP4769) (Ropeserror173010 err0, NimStringDesc* msg0, NIM_BOOL usewarning0);
	...
	num0 = ((NI) 0);
	{
		while (1) {
			...
			if (!(i0 < length0)) goto LA2;
			{
				...
				case 36:
				{
					add_173487_2381377266(&result0, ((NimStringDesc*) &TMP3931));
					i0 += ((NI) 1);
				}
				break;
				case 35:
				...
				case 48 ... 57:
				{
					...
					num0 = j0;
					{
						...
						errorhandler_173024_2381377266.ClEnv? errorhandler_173024_2381377266.ClPrc(((Ropeserror173010) 1), LOC20, NIM_FALSE, errorhandler_173024_2381377266.ClEnv):((TMP3932)(errorhandler_173024_2381377266.ClPrc))(((Ropeserror173010) 1), LOC20, NIM_FALSE);
					}
					goto LA16;
					LA18: ;
					{
				...
				case 123:
				{
					...
					LA27: ;
					{
						...
						errorhandler_173024_2381377266.ClEnv? errorhandler_173024_2381377266.ClPrc(((Ropeserror173010) 1), LOC30, NIM_FALSE, errorhandler_173024_2381377266.ClEnv):((TMP3933)(errorhandler_173024_2381377266.ClPrc))(((Ropeserror173010) 1), LOC30, NIM_FALSE);
					}
					LA25: ;
					{
						NimStringDesc* LOC35;
						...
						errorhandler_173024_2381377266.ClEnv? errorhandler_173024_2381377266.ClPrc(((Ropeserror173010) 1), LOC35, NIM_FALSE, errorhandler_173024_2381377266.ClEnv):((TMP3934)(errorhandler_173024_2381377266.ClPrc))(((Ropeserror173010) 1), LOC35, NIM_FALSE);
					}
					goto LA31;
					LA33: ;
					{
				...
				default:
				{
					...
					errorhandler_173024_2381377266.ClEnv? errorhandler_173024_2381377266.ClPrc(((Ropeserror173010) 1), LOC40, NIM_FALSE, errorhandler_173024_2381377266.ClEnv):((TMP3935)(errorhandler_173024_2381377266.ClPrc))(((Ropeserror173010) 1), LOC40, NIM_FALSE);
				}
				break;
				}
			}
		...
		s_173826_2381377266 = (NimStringDesc*)0;
		{
			...
			asgnRefNoCycle((void**) (&stack_173833_2381377266->data[0]), LOC6[0]);
			{
				while (1) {
					...
					write_15889_1689653243(f0, s_173826_2381377266);
				} LA8: ;
			}
		}
		LA4: ;
...
N_NIMCALL(void, writerope_173836_2381377266)(Ropeobj173006* head0, NimStringDesc* filename0, NIM_BOOL usewarning0) {
	...
	LA4: ;
	{
		errorhandler_173024_2381377266.ClEnv? errorhandler_173024_2381377266.ClPrc(((Ropeserror173010) 0), filename0, usewarning0, errorhandler_173024_2381377266.ClEnv):((TMP4769)(errorhandler_173024_2381377266.ClPrc))(((Ropeserror173010) 0), filename0, usewarning0);
	}
	LA1: ;
}
...
{	result0 = (NIM_BOOL)0;
					...
					slen0 = (s_174431_2381377266 ? s_174431_2381377266->Sup.len : 0);
					{
						while (1) {
							...
							if (!(spos0 < slen0)) goto LA12;
							{
								...
								bpos0 = ((NI) 0);
								blen0 = readbuffer_15954_1689653243(f0, ((void*) ((&buf0[(((NI) 0))- 0]))), ((NI) 1024));
								{
	...
	LOC26 = (NI)0;
	LOC26 = readbuffer_15954_1689653243(f0, ((void*) ((&buf0[(((NI) 0))- 0]))), ((NI) 1));
	result0 = (LOC26 == ((NI) 0));
	}BeforeRet: ;
	return result0;
}
...
N_NIMCALL(NIM_BOOL, equalsfile_174483_2381377266)(Ropeobj173006* r0, NimStringDesc* filename0) {
	...
	result0 = (NIM_BOOL)0;
	f0 = (FILE*)0;
	result0 = open_15803_1689653243(&f0, filename0, ((Filemode12409) 0), ((NI) -1));
	{
		if (!result0) goto LA3;
