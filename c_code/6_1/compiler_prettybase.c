...
STRING_LITERAL(TMP2972, ".nimfix", 7);
static NIM_CONST char136Set TMP2982 = {
0x00, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2983, "\015\012", 2);
STRING_LITERAL(TMP2984, "\012", 1);
...
N_NIMCALL(void, loadfile_316031_3901077974)(Tlineinfo186336 info0) {
	...
	LA3: ;
	{
		...
		gsourcefiles_316029_3901077974->data[i0].lines = (TY131402*) newSeqRC1((&NTI131402), 0);
		...
		gsourcefiles_316029_3901077974->data[i0].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2972));
		{
			NimStringDesc* line_316078_3901077974;
			FILE* f_316105_3901077974;
			TSafePoint TMP2973;
			line_316078_3901077974 = (NimStringDesc*)0;
			f_316105_3901077974 = open_15617_1689653243(path0, ((Filemode12409) 0), ((NI) 8000));
			pushSafePoint(&TMP2973);
			TMP2973.status = _setjmp(TMP2973.context);
			if (TMP2973.status == 0) {
				...
				res_316107_3901077974 = rawNewString(((NI) 80));
				{
					while (1) {
						...
						NimStringDesc* LOC16;
						LOC15 = (NIM_BOOL)0;
						LOC15 = readline_15713_1689653243(f_316105_3901077974, (&res_316107_3901077974));
						if (!LOC15) goto LA14;
						line_316078_3901077974 = res_316107_3901077974;
						gsourcefiles_316029_3901077974->data[i0].lines = (TY131402*) incrSeqV2(&(gsourcefiles_316029_3901077974->data[i0].lines)->Sup, sizeof(NimStringDesc*));
			...
			if (TMP2973.status != 0) reraiseException();
		}
		...
		LOC20 = &LOC19->Sup;
		open_215223_1314243012((&lex0), LOC20, ((NI) 8192), TMP2982);
		pos0 = lex0.bufpos;
		{
			while (1) {
				...
				case 13:
				{
					...
					LOC24 = gsourcefiles_316029_3901077974->data[i0].newline; gsourcefiles_316029_3901077974->data[i0].newline = copyStringRC1(((NimStringDesc*) &TMP2983));
				...
				case 0:
				{
					...
					LOC26 = gsourcefiles_316029_3901077974->data[i0].newline; gsourcefiles_316029_3901077974->data[i0].newline = copyStringRC1(((NimStringDesc*) &TMP2984));
