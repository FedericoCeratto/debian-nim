...
STRING_LITERAL(TMP1889, "run", 3);
STRING_LITERAL(TMP4858, "server.type", 11);
STRING_LITERAL(TMP4859, "stdin", 5);
STRING_LITERAL(TMP4860, "tcp", 3);
STRING_LITERAL(TMP4862, "quit", 4);
STRING_LITERAL(TMP4866, "server.port", 11);
STRING_LITERAL(TMP4867, "server.address", 14);
STRING_LITERAL(TMP4875, "\015\012", 2);
STRING_LITERAL(TMP4876, "Invalid server.type:", 20);
...
N_NIMCALL(void, processcmdline_611209)(NU8 pass, NimStringDesc* cmd) {
	...
	} LA1: ;
	{
		if (!(pass == ((NU8) 1))) goto LA13;
		{
			...
			LOC17 = !(eqStrings(LOC21, ((NimStringDesc*) &TMP1889)));
			LA20: ;
			if (!LOC17) goto LA22;
...
N_NIMCALL(void, serve_611259)(TY611261 action) {
	NimStringDesc* typ;
	typ = getconfigvar_170350(((NimStringDesc*) &TMP4858));
	if (eqStrings(typ, ((NimStringDesc*) &TMP4859))) goto LA1;
	if (eqStrings(typ, ((NimStringDesc*) &TMP4860))) goto LA2;
	...
	{
		{
			while (1) {
				...
				{
					if (!eqStrings(line, ((NimStringDesc*) &TMP4862))) goto LA10;
					exit(0);
				}
				LA10: ;
				LOC12 = 0;
				...
				printf("%s\012", (((NimStringDesc*) &TMP993))->data);
				fflush(stdout);
			}
		}
	}
	...
	LA2: ;
	{
		...
		LA16: ;
		p = getconfigvar_170350(((NimStringDesc*) &TMP4866));
		{
			NI LOC23;
		...
		LA19: ;
		LOC25 = 0;
		LOC25 = getconfigvar_170350(((NimStringDesc*) &TMP4867));
		...
		stdoutsocket_197318 = (tsocketimpl183607*) newObjRC1((&NTI183609), sizeof(tsocketimpl183607));
		{
			while (1) {
				...
				gdirtyoriginalidx_170135 = ((NI32) 0);
				gerrorcounter_197306 = 0;
				send_194008(stdoutsocket_197318, ((NimStringDesc*) &TMP4875));
	...
	LA3: ;
	{
		printf("%s%s\012", (((NimStringDesc*) &TMP4876))->data, (typ)->data);
		exit(1);
	}
	LA4: ;
}
NIM_EXTERNC N_NOINLINE(void, HEX00_serviceInit)(void) {
	...
	NimStringDesc* LOC2;
	LOC1 = 0;
	LOC1 = curcaascmd_611204; curcaascmd_611204 = copyStringRC1(((NimStringDesc*) &TMP993));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	LOC2 = 0;
	LOC2 = lastcaascmd_611205; lastcaascmd_611205 = copyStringRC1(((NimStringDesc*) &TMP993));
