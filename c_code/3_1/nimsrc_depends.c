...
N_NIMCALL(void, TMP4951)(void* p, NI op);
...
STRING_LITERAL(TMP4952, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP4953, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP4954, "", 0);
STRING_LITERAL(TMP4955, "dot", 3);
...
N_NIMCALL(void, adddependencyaux_506028)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	addf_162635(&gdotgraph_506023, ((NimStringDesc*) &TMP4952), LOC1, 2);
}
...
N_NIMCALL(void, generatedot_506009)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP4954));
	LOC1[0] = rope_161320(LOC3);
	LOC1[1] = gdotgraph_506023;
	LOC4 = 0;
	LOC4 = HEX25_162235(((NimStringDesc*) &TMP4953), LOC1, 2);
	LOC5 = 0;
	LOC5 = noschangeFileExt(project, ((NimStringDesc*) &TMP4955));
