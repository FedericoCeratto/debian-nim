...
typedef N_CLOSURE_PTR(void, TMP3358) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
typedef N_CLOSURE_PTR(void, TMP3359) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
	...
	num = 0;
	{
		while (1) {
			...
			if (!(i <= (NI64)(length - 1))) goto LA2;
			{
				...
				case 36:
				{
					app_178060(&result, ((NimStringDesc*) &TMP3357));
					i += 1;
				}
				break;
				case 35:
				...
				case 48 ... 57:
				{
					...
					num = j;
					{
						...
						LOC22 = 0;
						LOC22 = nimIntToStr(j);
						errorhandler_178143.ClEnv? errorhandler_178143.ClPrc(((NU8) 1), LOC22, NIM_FALSE, errorhandler_178143.ClEnv):((TMP3358)(errorhandler_178143.ClPrc))(((NU8) 1), LOC22, NIM_FALSE);
					}
					goto LA18;
					LA20: ;
					{
				...
				default:
				{
					...
					errorhandler_178143.ClEnv? errorhandler_178143.ClPrc(((NU8) 1), LOC27, NIM_FALSE, errorhandler_178143.ClEnv):((TMP3359)(errorhandler_178143.ClPrc))(((NU8) 1), LOC27, NIM_FALSE);
				}
				break;
				}
			}
