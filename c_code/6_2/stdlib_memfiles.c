...
N_NIMCALL(Memfile265208, open_265807)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	LA6: ;
	{
		...
		LA17: ;
		LOC20 = 0;
		LOC20 = oslasterror_126034();
		raiseoserror_126009(LOC20, ((NimStringDesc*) &TMP1534));
	}
	LA13: ;
	{
		if (!!((newfilesize == ((NI) -1)))) goto LA23;
		{
			...
			LA32: ;
			LOC35 = 0;
			LOC35 = oslasterror_126034();
			raiseoserror_126009(LOC35, ((NimStringDesc*) &TMP1534));
		}
		LA28: ;
	}
	LA23: ;
	...
	LA38: ;
	{
		...
		LA44: ;
		{
			...
			raiseoserror_126009(LOC52, ((NimStringDesc*) &TMP1534));
		}
		LA41: ;
	}
	LA36: ;
	...
	LOC59 = 0;
	{
		...
		LOC59 = (NI32)(MAP_PRIVATE | Mappopulate_115538);
	}
	goto LA60;
	LA62: ;
	{
		LOC59 = (NI32)(MAP_SHARED | Mappopulate_115538);
	}
	LA60: ;
	result.mem = mmap(NIM_NIL, result.size, LOC53, LOC59, result.handle, ((off_t) (offset)));
	{
		...
		LA71: ;
		LOC74 = 0;
		LOC74 = oslasterror_126034();
		raiseoserror_126009(LOC74, ((NimStringDesc*) &TMP1534));
	}
	LA67: ;
	return result;
}
...
N_NIMCALL(void, close_266249)(Memfile265208* f) {
	...
	{
		if (!error) goto LA11;
		raiseoserror_126009(lasterr, ((NimStringDesc*) &TMP1534));
	}
	LA11: ;
}
...
NTI265208.size = sizeof(Memfile265208);
NTI265208.kind = 18;
NTI265208.base = 0;
NTI265208.flags = 3;
TMP908[0] = &TMP894[1];
TMP894[1].kind = 1;
TMP894[1].offset = offsetof(Memfile265208, mem);
TMP894[1].typ = (&NTI153);
TMP894[1].name = "mem";
TMP908[1] = &TMP894[2];
TMP894[2].kind = 1;
TMP894[2].offset = offsetof(Memfile265208, size);
TMP894[2].typ = (&NTI108);
TMP894[2].name = "size";
TMP908[2] = &TMP894[3];
TMP894[3].kind = 1;
TMP894[3].offset = offsetof(Memfile265208, handle);
TMP894[3].typ = (&NTI8211);
TMP894[3].name = "handle";
TMP894[0].len = 3; TMP894[0].kind = 2; TMP894[0].sons = &TMP908[0];
NTI265208.node = &TMP894[0];
}
