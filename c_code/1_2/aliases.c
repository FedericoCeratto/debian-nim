...
STRING_LITERAL(TMP3071, "isPartOfAux(record case branch)", 31);
STRING_LITERAL(TMP3072, "isPartOfAux()", 13);
...
N_NIMCALL(NU8, ispartofaux_479029)(tnode226816* n, ttype226852* b, intset223056* marker) {
		...
		LA13: ;
		{
			...
			res_479298 = 1;
			{
				while (1) {
					...
					default:
					{
						internalerror_199006(((NimStringDesc*) &TMP3071));
					}
					break;
					}
					res_479298 += 1;
	...
	default:
	{
		internalerror_198987((*n).Info, ((NimStringDesc*) &TMP3072));
	}
	break;
	}
	BeforeRet: ;
