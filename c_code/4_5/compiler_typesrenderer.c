...
N_NIMCALL(void, renderparamtypes_383233_117375469)(TY131402** found0, Tnode263794* n0);
N_NIMCALL(NimStringDesc*, rendertype_381209_117375469)(Tnode263794* n0);
...
STRING_LITERAL(TMP5319, "", 0);
STRING_LITERAL(TMP5320, "*", 1);
STRING_LITERAL(TMP5321, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP5328, "ref.", 4);
STRING_LITERAL(TMP5329, "ptr.", 4);
STRING_LITERAL(TMP5330, "proc(", 5);
STRING_LITERAL(TMP5331, "tuple[", 6);
STRING_LITERAL(TMP5332, "renderParamTypes(found,n) with ", 31);
...
{	result0 = (NimStringDesc*)0;
	result0 = copyString(((NimStringDesc*) &TMP5319));
	switch ((*n0).kind) {
	case ((Tnodekind263020) 31):
	{
		{
			NI i_381026_117375469;
			NI HEX3Atmp_381202_117375469;
			NI LOC3;
			NI res_381205_117375469;
			i_381026_117375469 = (NI)0;
			HEX3Atmp_381202_117375469 = (NI)0;
			LOC3 = (NI)0;
			LOC3 = len_264080_850551059(n0);
			HEX3Atmp_381202_117375469 = (LOC3 - 1);
			res_381205_117375469 = ((NI) 0);
			{
				while (1) {
					NI LOC6;
					Tnode263794* LOC7;
					if (!(res_381205_117375469 <= HEX3Atmp_381202_117375469)) goto LA5;
					i_381026_117375469 = res_381205_117375469;
					LOC6 = (NI)0;
					LOC6 = len_264080_850551059(n0);
					LOC7 = (Tnode263794*)0;
					LOC7 = HEX5BHEX5D_264238_850551059(n0, (LOC6 - 1));
					result0 = renderplainsymbolname_381004_117375469(LOC7);
					{
						if (!(((NI) 0) < (result0 ? result0->Sup.len : 0))) goto LA10;
						goto BeforeRet;
					}
					LA10: ;
					res_381205_117375469 += ((NI) 1);
				} LA5: ;
			}
		}
	}
	...
	{
		{
			if (!!(eqStrings((*(*n0).kindU.S5.ident).s, ((NimStringDesc*) &TMP5320)))) goto LA15;
	...
	{
		result0 = renderdefinitionname_282115_382274130((*n0).kindU.S4.sym, NIM_TRUE);
	}
	break;
	case ((Tnodekind263020) 43):
	{
		Tnode263794* LOC19;
		LOC19 = (Tnode263794*)0;
		LOC19 = HEX5BHEX5D_264238_850551059(n0, ((NI) 0));
		result0 = renderplainsymbolname_381004_117375469(LOC19);
	}
	break;
	case ((Tnodekind263020) 53):
	{
		...
		LOC22 = (Tnode263794*)0;
		LOC22 = HEX5BHEX5D_264238_850551059(n0, (LOC21 - 1));
		result0 = renderplainsymbolname_381004_117375469(LOC22);
	}
	break;
	default:
	{
		...
		LOC24 = rawNewString(reprEnum((NI)(*n0).kind, (&NTI263020))->Sup.len + 29);
appendString(LOC24, ((NimStringDesc*) &TMP5321));
appendString(LOC24, reprEnum((NI)(*n0).kind, (&NTI263020)));
		internalerror_190100_155036129((*n0).info, LOC24);
	}
	break;
	}
	}BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, rendertype_381209_117375469)(Tnode263794* n0) {
	...
	case ((Tnodekind263020) 3):
	{
		result0 = typetostring_290017_3876443242((*(*n0).kindU.S4.sym).typ, ((Tprefereddesc290011) 0));
	}
	break;
	case ((Tnodekind263020) 143):
	{
		Tnode263794* LOC4;
		LOC4 = (Tnode263794*)0;
		LOC4 = HEX5BHEX5D_264238_850551059(n0, ((NI) 0));
		result0 = rendertype_381209_117375469(LOC4);
	}
	break;
	case ((Tnodekind263020) 141):
	{
		...
		LOC8 = rendertype_381209_117375469(LOC7);
		LOC6 = rawNewString(LOC8->Sup.len + 4);
appendString(LOC6, ((NimStringDesc*) &TMP5328));
appendString(LOC6, LOC8);
	...
	case ((Tnodekind263020) 142):
	{
		...
		LOC12 = rendertype_381209_117375469(LOC11);
		LOC10 = rawNewString(LOC12->Sup.len + 4);
appendString(LOC10, ((NimStringDesc*) &TMP5329));
appendString(LOC10, LOC12);
	...
	{
		Tnode263794* params0;
		params0 = HEX5BHEX5D_264238_850551059(n0, ((NI) 0));
		result0 = copyString(((NimStringDesc*) &TMP5330));
		{
			NI i_382418_117375469;
			NI HEX3Atmp_383202_117375469;
			NI LOC15;
			NI res_383205_117375469;
			i_382418_117375469 = (NI)0;
			HEX3Atmp_383202_117375469 = (NI)0;
			LOC15 = (NI)0;
			LOC15 = len_264080_850551059(params0);
			HEX3Atmp_383202_117375469 = (LOC15 - 1);
			res_383205_117375469 = ((NI) 1);
			{
				while (1) {
					...
					Tnode263794* LOC19;
					NimStringDesc* LOC20;
					if (!(res_383205_117375469 <= HEX3Atmp_383202_117375469)) goto LA17;
					i_382418_117375469 = res_383205_117375469;
					LOC18 = (NimStringDesc*)0;
					LOC19 = (Tnode263794*)0;
					LOC19 = HEX5BHEX5D_264238_850551059(params0, i_382418_117375469);
					LOC20 = (NimStringDesc*)0;
					LOC20 = rendertype_381209_117375469(LOC19);
...
appendString(result0, LOC18);
	...
	case ((Tnodekind263020) 35):
	{
		...
		Tnode263794* LOC23;
		LOC22 = (NI)0;
		LOC22 = len_264080_850551059(n0);
		typepos0 = (NI)(LOC22 - ((NI) 2));
		LOC23 = (Tnode263794*)0;
		LOC23 = HEX5BHEX5D_264238_850551059(n0, typepos0);
		typestr0 = rendertype_381209_117375469(LOC23);
		result0 = copyString(typestr0);
		{
			NI i_382620_117375469;
			NI HEX3Atmp_383210_117375469;
			NI res_383213_117375469;
			i_382620_117375469 = (NI)0;
			HEX3Atmp_383210_117375469 = (NI)0;
			HEX3Atmp_383210_117375469 = (typepos0 - 1);
			res_383213_117375469 = ((NI) 1);
			{
				while (1) {
					NimStringDesc* LOC27;
					if (!(res_383213_117375469 <= HEX3Atmp_383210_117375469)) goto LA26;
					i_382620_117375469 = res_383213_117375469;
...
appendString(result0, LOC27);
	...
	{
		result0 = copyString(((NimStringDesc*) &TMP5331));
		{
			NI i_382818_117375469;
			NI HEX3Atmp_383218_117375469;
			NI LOC30;
			NI res_383221_117375469;
			i_382818_117375469 = (NI)0;
			HEX3Atmp_383218_117375469 = (NI)0;
			LOC30 = (NI)0;
			LOC30 = len_264080_850551059(n0);
			HEX3Atmp_383218_117375469 = (LOC30 - 1);
			res_383221_117375469 = ((NI) 0);
			{
				while (1) {
					NimStringDesc* LOC33;
					Tnode263794* LOC34;
					NimStringDesc* LOC35;
					if (!(res_383221_117375469 <= HEX3Atmp_383218_117375469)) goto LA32;
					i_382818_117375469 = res_383221_117375469;
					LOC33 = (NimStringDesc*)0;
					LOC34 = (Tnode263794*)0;
					LOC34 = HEX5BHEX5D_264238_850551059(n0, i_382818_117375469);
					LOC35 = (NimStringDesc*)0;
					LOC35 = rendertype_381209_117375469(LOC34);
...
appendString(result0, LOC33);
	...
	case ((Tnodekind263020) 42):
	{
		...
		LOC38 = (Tnode263794*)0;
		LOC38 = HEX5BHEX5D_264238_850551059(n0, ((NI) 0));
		LOC39 = (NimStringDesc*)0;
		LOC39 = rendertype_381209_117375469(LOC38);
		LOC37 = rawNewString(LOC39->Sup.len + 1);
appendString(LOC37, LOC39);
appendChar(LOC37, 91);
		result0 = LOC37;
		{
			NI i_383018_117375469;
			NI HEX3Atmp_383226_117375469;
			NI LOC41;
			NI res_383229_117375469;
			i_383018_117375469 = (NI)0;
			HEX3Atmp_383226_117375469 = (NI)0;
			LOC41 = (NI)0;
			LOC41 = len_264080_850551059(n0);
			HEX3Atmp_383226_117375469 = (LOC41 - 1);
			res_383229_117375469 = ((NI) 1);
			{
				while (1) {
					NimStringDesc* LOC44;
					Tnode263794* LOC45;
					NimStringDesc* LOC46;
					if (!(res_383229_117375469 <= HEX3Atmp_383226_117375469)) goto LA43;
					i_383018_117375469 = res_383229_117375469;
					LOC44 = (NimStringDesc*)0;
					LOC45 = (Tnode263794*)0;
					LOC45 = HEX5BHEX5D_264238_850551059(n0, i_383018_117375469);
					LOC46 = (NimStringDesc*)0;
					LOC46 = rendertype_381209_117375469(LOC45);
...
{	switch ((*n0).kind) {
	...
	{
		{
			NI i_383256_117375469;
			NI HEX3Atmp_383456_117375469;
			NI LOC3;
			NI res_383459_117375469;
			i_383256_117375469 = (NI)0;
			HEX3Atmp_383456_117375469 = (NI)0;
			LOC3 = (NI)0;
			LOC3 = len_264080_850551059(n0);
			HEX3Atmp_383456_117375469 = (LOC3 - 1);
			res_383459_117375469 = ((NI) 1);
			{
				while (1) {
					Tnode263794* LOC6;
					if (!(res_383459_117375469 <= HEX3Atmp_383456_117375469)) goto LA5;
					i_383256_117375469 = res_383459_117375469;
					LOC6 = (Tnode263794*)0;
					LOC6 = HEX5BHEX5D_264238_850551059(n0, i_383256_117375469);
					renderparamtypes_383233_117375469(found0, LOC6);
					res_383459_117375469 += ((NI) 1);
				} LA5: ;
			}
		}
	...
	case ((Tnodekind263020) 35):
	{
		...
		LOC9 = (Tnode263794*)0;
		LOC9 = HEX5BHEX5D_264238_850551059(n0, typepos0);
		typestr0 = rendertype_381209_117375469(LOC9);
		{
			NIM_BOOL LOC12;
			Tnode263794* LOC14;
			Ttype263832* typ0;
			...
			if (!(LOC12)) goto LA13;
			LOC14 = (Tnode263794*)0;
			LOC14 = HEX5BHEX5D_264238_850551059(n0, (NI)(typepos0 + ((NI) 1)));
			LOC12 = !(((*LOC14).kind == ((Tnodekind263020) 1)));
			LA13: ;
			if (!LOC12) goto LA15;
			LOC17 = (Tnode263794*)0;
			LOC17 = HEX5BHEX5D_264238_850551059(n0, (NI)(typepos0 + ((NI) 1)));
			typ0 = (*LOC17).typ;
			{
				if (!!(typ0 == 0)) goto LA20;
				typestr0 = typetostring_290017_3876443242(typ0, ((Tprefereddesc290011) 2));
			}
			LA20: ;
			{
		...
		LA15: ;
		{
			NI i_383437_117375469;
			NI HEX3Atmp_383464_117375469;
			NI res_383467_117375469;
			i_383437_117375469 = (NI)0;
			HEX3Atmp_383464_117375469 = (NI)0;
			HEX3Atmp_383464_117375469 = (typepos0 - 1);
			res_383467_117375469 = ((NI) 0);
			{
				while (1) {
					NimStringDesc* LOC29;
					if (!(res_383467_117375469 <= HEX3Atmp_383464_117375469)) goto LA28;
					i_383437_117375469 = res_383467_117375469;
	...
	default:
	{
		...
		LOC31 = rawNewString(reprEnum((NI)(*n0).kind, (&NTI263020))->Sup.len + 31);
appendString(LOC31, ((NimStringDesc*) &TMP5332));
appendString(LOC31, reprEnum((NI)(*n0).kind, (&NTI263020)));
		internalerror_190100_155036129((*n0).info, LOC31);
	}
	break;
	}
	}BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, renderparamtypes_383471_117375469)(Tnode263794* n0, NimStringDesc* sep0) {
	...
	renderparamtypes_383233_117375469((&found0), n0);
	{
