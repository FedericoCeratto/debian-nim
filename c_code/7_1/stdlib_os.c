...
{	result = 0;
	...
	LOC7 = 0;
	LOC7 = (*e_125815).Sup.message; (*e_125815).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1144));
...
{	result = 0;
	result = paramstr_125809(((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			p_126602 = 0;
			HEX3Atmp_126609 = 0;
			HEX3Atmp_126609 = getenv_122644(((NimStringDesc*) &TMP1145));
			last_126614 = ((NI) 0);
			{
				while (1) {
					NI first_126616;
...
N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	NimStringDesc* result;
	result = 0;
	result = getenv_122644(((NimStringDesc*) &TMP1142));
	{
...
{	result = 0;
	LOC1 = 0;
	LOC2 = 0;
	LOC2 = getenv_122644(((NimStringDesc*) &TMP1654));
...
N_NOINLINE(void, nosraiseOSError)(NimStringDesc* msg) {
	{
		...
		LA7: ;
		{
			NimStringDesc* LOC11;
			LOC11 = 0;
			LOC11 = (*e_116416).Sup.Sup.message; (*e_116416).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1141));
...
N_NIMCALL(NimStringDesc*, expandtilde_127610)(NimStringDesc* path) {
	...
	result = 0;
	{
		...
		LOC13 = 0;
		LOC13 = HEX5BHEX5D_85761(path, LOC12);
...
{	result = 0;
	...
	LA4: ;
	path = getenv_122644(((NimStringDesc*) &TMP1145));
	{
