...
N_NIMCALL(void, intsetenlarge_223614)(intset223056* t) {
	...
	n = (ttrunkseq223054*) newSeq((&NTI223054), (NI64)((*t).Max + 1));
	{
		NI i_223648;
		NI res_223686;
		i_223648 = 0;
...
N_NIMCALL(ttrunk223052*, intsetput_223703)(intset223056* t, NI key) {
	...
	}
	{
		NIM_BOOL LOC9;
		LOC9 = 0;
		LOC9 = mustrehash_223073((NI64)((*t).Max + 1), (*t).Counter);
		if (!LOC9) goto LA10;
...
N_NIMCALL(void, incl_223869)(intset223056* s, NI key) {
	ttrunk223052* t;
	NI u;
	t = intsetput_223703(s, (NI)((NU64)(key) >> (NU64)(9)));
	u = (NI)(key & 511);
...
N_NIMCALL(NIM_BOOL, containsorincl_223916)(intset223056* s, NI key) {
	...
	ttrunk223052* t;
	result = 0;
	t = intsetget_223220((&(*s)), (NI)((NU64)(key) >> (NU64)(9)));
	{
		NI u;
