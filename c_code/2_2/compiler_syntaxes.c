...
STRING_LITERAL(TMP1670, "none", 4);
STRING_LITERAL(TMP1671, "stdtmpl", 7);
STRING_LITERAL(TMP1672, "replace", 7);
STRING_LITERAL(TMP1673, "strip", 5);
NIM_CONST TY289022 filternames_289019_4241778752 = {((NimStringDesc*) &TMP1670),
((NimStringDesc*) &TMP1671),
((NimStringDesc*) &TMP1672),
((NimStringDesc*) &TMP1673)}
;
STRING_LITERAL(TMP1674, "standard", 8);
STRING_LITERAL(TMP1675, "strongspaces", 12);
STRING_LITERAL(TMP1676, "braces", 6);
STRING_LITERAL(TMP1677, "endx", 4);
NIM_CONST TY289016 parsernames_289013_4241778752 = {((NimStringDesc*) &TMP1674),
((NimStringDesc*) &TMP1675),
((NimStringDesc*) &TMP1676),
((NimStringDesc*) &TMP1677)}
;
STRING_LITERAL(TMP1709, "parser to implement", 19);
...
{	result0 = (Tllstream254204*)0;
	...
	LA3: ;
	{
		...
		LOC7 = LOC8;
		if (!(LOC7)) goto LA10;
		LOC7 = identeq_194450_791273810((*(*n0).kindU.S6.sons->data[((NI) 0)]).kindU.S5.ident, ((NimStringDesc*) &TMP1555));
		LA10: ;
		if (!LOC7) goto LA11;
		{
...
N_NIMCALL(Tnode264794*, parseall_289042_4241778752)(Tparsers289026* p0) {
	...
	case ((Tparserkind289004) 3):
	{
		internalerror_191113_155036129(((NimStringDesc*) &TMP1709));
		result0 = emptynode_265801_850551059;
	}
	break;
	}
