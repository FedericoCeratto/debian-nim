...
STRING_LITERAL(TMP2973, ".nimfix", 7);
static NIM_CONST char136Set TMP2983 = {
0x00, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2984, "\015\012", 2);
STRING_LITERAL(TMP2985, "\012", 1);
...
N_NIMCALL(void, loadfile_316031_3901077974)(Tlineinfo186336 info0) {
	...
	LA3: ;
	{
		...
		gsourcefiles_316029_3901077974->data[i0].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2973));
		{
			...
			pushSafePoint(&TMP2974);
			TMP2974.status = _setjmp(TMP2974.context);
			if (TMP2974.status == 0) {
			...
			if (TMP2974.status != 0) reraiseException();
		}
		...
		LOC20 = &LOC19->Sup;
		open_215223_1314243012((&lex0), LOC20, ((NI) 8192), TMP2983);
		pos0 = lex0.bufpos;
		{
			while (1) {
				...
				case 13:
				{
					...
					LOC24 = gsourcefiles_316029_3901077974->data[i0].newline; gsourcefiles_316029_3901077974->data[i0].newline = copyStringRC1(((NimStringDesc*) &TMP2984));
				...
				case 0:
				{
					...
					LOC26 = gsourcefiles_316029_3901077974->data[i0].newline; gsourcefiles_316029_3901077974->data[i0].newline = copyStringRC1(((NimStringDesc*) &TMP2985));
