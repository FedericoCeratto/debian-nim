...
STRING_LITERAL(TMP3524, "isPartOfAux(record case branch)", 31);
STRING_LITERAL(TMP3525, "isPartOfAux()", 13);
...
{	result0 = (Tanalysisresult442004)0;
		...
		LA13: ;
		{
			...
			res_442248_788060399 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_191113_155036129(((NimStringDesc*) &TMP3524));
					}
					break;
					}
					res_442248_788060399 += ((NI) 1);
	...
	default:
	{
		internalerror_191100_155036129((*n0).info, ((NimStringDesc*) &TMP3525));
	}
	break;
	}
	}BeforeRet: ;
