...
static TNimNode TMP724[8];
NTI214024.size = sizeof(tbaselexer214024);
NTI214024.kind = 17;
NTI214024.base = (&NTI3211);
TMP1020[0] = &TMP724[1];
TMP724[1].kind = 1;
TMP724[1].offset = offsetof(tbaselexer214024, Bufpos);
TMP724[1].typ = (&NTI108);
TMP724[1].name = "bufpos";
TMP1020[1] = &TMP724[2];
TMP724[2].kind = 1;
TMP724[2].offset = offsetof(tbaselexer214024, Buf);
TMP724[2].typ = (&NTI151);
TMP724[2].name = "buf";
TMP1020[2] = &TMP724[3];
TMP724[3].kind = 1;
TMP724[3].offset = offsetof(tbaselexer214024, Buflen);
TMP724[3].typ = (&NTI108);
TMP724[3].name = "bufLen";
TMP1020[3] = &TMP724[4];
TMP724[4].kind = 1;
TMP724[4].offset = offsetof(tbaselexer214024, Stream);
TMP724[4].typ = (&NTI212206);
TMP724[4].name = "stream";
TMP1020[4] = &TMP724[5];
TMP724[5].kind = 1;
TMP724[5].offset = offsetof(tbaselexer214024, Linenumber);
TMP724[5].typ = (&NTI108);
TMP724[5].name = "lineNumber";
TMP1020[5] = &TMP724[6];
TMP724[6].kind = 1;
TMP724[6].offset = offsetof(tbaselexer214024, Sentinel);
TMP724[6].typ = (&NTI108);
TMP724[6].name = "sentinel";
TMP1020[6] = &TMP724[7];
TMP724[7].kind = 1;
TMP724[7].offset = offsetof(tbaselexer214024, Linestart);
TMP724[7].typ = (&NTI108);
TMP724[7].name = "lineStart";
TMP724[0].len = 7; TMP724[0].kind = 2; TMP724[0].sons = &TMP1020[0];
NTI214024.node = &TMP724[0];
}
