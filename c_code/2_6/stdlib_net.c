...
N_NIMCALL(NI32, getsocketerror_515001)(Socketimpl514407* socket) {
	...
	LA3: ;
	{
		...
		LOC9 = 0;
		LOC9 = (*e_515008).Sup.Sup.message; (*e_515008).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4996));
...
{	sent = send_518716(socket, ((void*) (data->data)), (data ? data->Sup.len : 0));
	...
	LA3: ;
	{
		...
		LOC14 = 0;
		LOC14 = (*e_519219).Sup.Sup.message; (*e_519219).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4997));
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_517819(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5004));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_517819(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5004));
...
N_NIMCALL(void, close_516417)(Socketimpl514407* socket) {
	...
	TMP5006.status = setjmp(TMP5006.context);
	if (TMP5006.status == 0) {
		popSafePoint();
	}
	else {
...
TMP1073[3].len = 3; TMP1073[3].kind = 2; TMP1073[3].sons = &TMP4986[0];
