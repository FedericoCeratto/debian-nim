...
TMP831[0] = &TMP815[1];
TMP815[1].kind = 1;
TMP815[1].offset = offsetof(memfile275208, Mem);
TMP815[1].typ = (&NTI153);
TMP815[1].name = "mem";
TMP831[1] = &TMP815[2];
TMP815[2].kind = 1;
TMP815[2].offset = offsetof(memfile275208, Size);
TMP815[2].typ = (&NTI108);
TMP815[2].name = "size";
TMP831[2] = &TMP815[3];
TMP815[3].kind = 1;
TMP815[3].offset = offsetof(memfile275208, Handle);
TMP815[3].typ = (&NTI5611);
TMP815[3].name = "handle";
TMP815[0].len = 3; TMP815[0].kind = 2; TMP815[0].sons = &TMP831[0];
NTI275208.node = &TMP815[0];
}
