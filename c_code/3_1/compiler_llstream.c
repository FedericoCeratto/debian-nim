...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST char136Set TMP1684 = {
...
N_NIMCALL(Tllstream254204*, llstreamopen_254242_597494479)(NimStringDesc* filename0, Filemode12409 mode0) {
	...
	(*result0).kind = ((Tllstreamkind254202) 2);
	{
		NIM_BOOL LOC3;
		LOC3 = (NIM_BOOL)0;
		LOC3 = open_15803_1689653243(&(*result0).f, filename0, mode0, ((NI) -1));
		if (!!(LOC3)) goto LA4;
		result0 = NIM_NIL;
	}
	LA4: ;
...
N_NIMCALL(NIM_BOOL, llstreamreadline_254550_597494479)(Tllstream254204* s0, NimStringDesc** line0) {
	...
	{
		result0 = readline_15913_1689653243((*s0).f, line0);
	}
	break;
	case ((Tllstreamkind254202) 3):
	{
		result0 = readline_15913_1689653243(stdin, line0);
	}
	break;
	}
	return result0;
...
N_NIMCALL(NIM_BOOL, readlinefromstdin_254281_597494479)(NimStringDesc* prompt0, NimStringDesc** line0) {
	NIM_BOOL result0;
	result0 = (NIM_BOOL)0;
	write_15889_1689653243(stdout, prompt0);
	result0 = readline_15913_1689653243(stdin, line0);
	{
		if (!!(result0)) goto LA3;
		write_15889_1689653243(stdout, ((NimStringDesc*) &TMP1380));
		exit(((NI) 0));
	}
	LA3: ;
	return result0;
...
N_NIMCALL(NI, llstreamread_254530_597494479)(Tllstream254204* s0, void* buf0, NI buflen0) {
	...
	case ((Tllstreamkind254202) 2):
	{
		result0 = readbuffer_15954_1689653243((*s0).f, buf0, ((NI) (buflen0)));
	}
	break;
	case ((Tllstreamkind254202) 3):
	{
...
appendString((*s0).s, data0);
	...
	case ((Tllstreamkind254202) 2):
	{
		write_15889_1689653243((*s0).f, data0);
	}
	break;
	}
}
...
N_NIMCALL(NIM_BOOL, endswithopr_254432_597494479)(NimStringDesc* x0) {
	NIM_BOOL result0;
	result0 = (NIM_BOOL)0;
	result0 = endswith_254401_597494479(x0, TMP1684);
	return result0;
}
...
N_NIMCALL(void, llstreamwrite_254612_597494479)(Tllstream254204* s0, NIM_CHAR data0) {
	...
	case ((Tllstreamkind254202) 2):
	{
		...
		c0 = data0;
		LOC4 = (NI)0;
		LOC4 = writebuffer_15976_1689653243((*s0).f, ((void*) ((&c0))), ((NI) 1));
	}
	break;
	}
}
