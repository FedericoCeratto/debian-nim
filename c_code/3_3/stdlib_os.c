				...
				while (1) {
					...
					i_117837 = res_117871;
					{
						if (!((NU8)(path->data[i_117837]) == (NU8)(46))) goto LA13;
						{
							...
							LOC17 = LOC18;
							if (!(LOC17)) goto LA20;
							LOC17 = !((((NU8)(path->data[(NI64)(i_117837 - 1)])) == ((NU8)(47)) || ((NU8)(path->data[(NI64)(i_117837 - 1)])) == ((NU8)(47))));
							LA20: ;
							if (!LOC17) goto LA21;
							dotpos = i_117837;
						}
...
N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
	...
	omitnext = NIM_FALSE;
	{
		...
		i_122211 = 0;
		HEX3Atmp_122227 = 0;
		HEX3Atmp_122227 = (NI64)(dir->Sup.len - 1);
		res_122230 = 1;
		{
			while (1) {
				...
				i_122211 = res_122230;
				{
					...
					LA10: ;
					{
						NimStringDesc* LOC13;
						LOC13 = 0;
						LOC13 = copyStrLast(dir, 0, (NI64)(i_122211 - 1));
...
N_NIMCALL(NimStringDesc*, getenv_120642)(NimStringDesc* key) {
	...
	i = findenvvar_120605(key);
	{
		...
		result = copyStr(environment_120009->data[i], (NI64)(LOC5 + 1));
		goto BeforeRet;
	}
	goto LA1;
	LA3: ;
