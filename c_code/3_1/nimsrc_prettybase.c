...
N_NIMCALL(void, loadfile_248041)(Tlineinfo163338 info) {
	...
	LA3: ;
	{
		...
		gsourcefiles_248036->data[i].lines = (TY122208*) newSeqRC1((&NTI122208), 0);
		...
		gsourcefiles_248036->data[i].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2676));
		{
			...
			res_248117 = rawNewString(((NI) 80));
			{
				while (1) {
					...
					gsourcefiles_248036->data[i].lines = (TY122208*) incrSeq(&(gsourcefiles_248036->data[i].lines)->Sup, sizeof(NimStringDesc*));
					LOC15 = 0;
		...
		pos = lex.bufpos;
		{
			while (1) {
				...
				case 13:
				{
					NimStringDesc* LOC21;
					LOC21 = 0;
					LOC21 = gsourcefiles_248036->data[i].newline; gsourcefiles_248036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP2684));
				...
				case 0:
				{
					NimStringDesc* LOC23;
					LOC23 = 0;
					LOC23 = gsourcefiles_248036->data[i].newline; gsourcefiles_248036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP2685));
...
{	loadfile_248041(info);
	...
	last = (NI)((NI)(first + LOC17) - ((NI) 1));
	{
		...
		LOC21 = 0;
		LOC21 = HEX5BHEX5D_85963(line, LOC20);
		LOC22 = 0;
