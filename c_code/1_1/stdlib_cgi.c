...
stringtableobj133012* gcookies_397172;
...
N_NIMCALL(NimStringDesc*, encodeurl_396004)(NimStringDesc* s) {
	...
	result = rawNewString((NI32)(s->Sup.len + (NI)((NU32)(s->Sup.len) >> (NU32)(2))));
	{
		...
		i_396018 = 0;
		HEX3Atmp_396028 = 0;
		HEX3Atmp_396028 = (NI32)(s->Sup.len - 1);
		res_396031 = 0;
		{
			while (1) {
				if (!(res_396031 <= HEX3Atmp_396028)) goto LA3;
				i_396018 = res_396031;
				switch (((NU8)(s->data[i_396018]))) {
				case 97 ... 122:
				case 65 ... 90:
				case 48 ... 57:
				case 95:
				{
					result = addChar(result, s->data[i_396018]);
				}
				break;
				case 32:
				{
				...
				default:
				{
					...
					LOC7 = 0;
					LOC7 = nsuToHex(((NI64) (((NU8)(s->data[i_396018])))), 2);
