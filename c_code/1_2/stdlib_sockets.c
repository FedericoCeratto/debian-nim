...
N_NIMCALL(NI, select_191011)(TY192015** readfds, NI timeout);
...
N_NIMCALL(void, createfdset_190416)(tfdset104664* fd, TY192015* s, NI* m);
...
N_NIMCALL(NI, readintobuf_191040)(tsocketimpl183607* socket, NI32 flags);
...
N_NIMCALL(void, send_193807)(tsocketimpl183607* socket, NimStringDesc* data) {
	NI sent;
	{
		valueerror3249* e_193813;
		NimStringDesc* LOC5;
		if (!(*socket).Nonblocking) goto LA3;
		e_193813 = 0;
		e_193813 = (valueerror3249*) newObj((&NTI21401), sizeof(valueerror3249));
		(*e_193813).Sup.Sup.m_type = (&NTI3249);
		LOC5 = 0;
		LOC5 = (*e_193813).Sup.message; (*e_193813).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1984));
		if (LOC5) nimGCunrefNoCycle(LOC5);
		raiseException((Exception*)e_193813, "ValueError");
	}
	LA3: ;
...
appendString(LOC22, ((NimStringDesc*) &TMP4867));
		...
		selret = select_191011((&s), (NI64)(timeout - ((NI) (((NF)((*waited)) * (NF)(1.0000000000000000e+03))))));
		{
			NI32 LOC28;
...
N_NIMCALL(NI, recv_191302)(tsocketimpl183607* socket, void* data, NI size) {
	...
	LA3: ;
	{
		...
		if (!(*socket).Isbuffered) goto LA7;
		{
			...
			res = readintobuf_191040(socket, ((NI32) 0));
			{
				if (!(res <= 0)) goto LA15;
				{
...
N_NIMCALL(void, readline_192447)(tsocketimpl183607* socket, NimStringDesc** line, NI timeout) {
	...
	(*line) = setLengthStr((*line), 0);
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_191617(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4869));
			...
			LA4: ;
			{
				...
				LOC15 = 0;
				LOC15 = waitfor_191617(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4869));
