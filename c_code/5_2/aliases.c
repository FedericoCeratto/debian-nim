...
STRING_LITERAL(TMP3074, "isPartOfAux(record case branch)", 31);
STRING_LITERAL(TMP3075, "isPartOfAux()", 13);
...
N_NIMCALL(NU8, ispartofaux_478029)(tnode225816* n, ttype225852* b, intset222056* marker) {
		...
		LA13: ;
		{
			...
			res_478298 = 1;
			{
				while (1) {
					...
					default:
					{
						internalerror_198006(((NimStringDesc*) &TMP3074));
					}
					break;
					}
					res_478298 += 1;
	...
	default:
	{
		internalerror_197987((*n).Info, ((NimStringDesc*) &TMP3075));
	}
	break;
	}
	BeforeRet: ;
