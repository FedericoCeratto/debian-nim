...
N_NIMCALL(Tnode191813*, totreeset_241353)(Tbitset240012* s, Ttype191849* settype, Tlineinfo164338 info);
...
{	result = 0;
	{
		...
		internalerror_166199((*s).info, ((NimStringDesc*) &TMP2809));
		result = NIM_FALSE;
		goto BeforeRet;
	}
	LA3: ;
		...
		res_241636 = ((NI) 0);
		{
			while (1) {
				...
				i_241608 = res_241636;
				{
					...
					LOC9 = 0;
					LOC9 = getordvalue_221178((*(*s).kindU.S6.sons->data[i_241608]).kindU.S6.sons->data[((NI) 1)]);
					LOC10 = 0;
					LOC10 = getordvalue_221178((*(*s).kindU.S6.sons->data[i_241608]).kindU.S6.sons->data[((NI) 0)]);
