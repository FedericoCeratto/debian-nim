...
STRING_LITERAL(TMP3799, "invalid path: ", 14);
STRING_LITERAL(TMP3800, "as", 2);
STRING_LITERAL(TMP3801, " ", 1);
STRING_LITERAL(TMP3802, "", 0);
STRING_LITERAL(TMP3803, ".", 1);
STRING_LITERAL(TMP3804, "/", 1);
STRING_LITERAL(TMP3805, "invalid module name: \'$1\'", 25);
STRING_LITERAL(TMP3806, "module alias must be an identifier", 34);
STRING_LITERAL(TMP3807, "A module cannot import itself", 29);
STRING_LITERAL(TMP3808, "importAllSymbols: ", 18);
STRING_LITERAL(TMP3809, "rawImportSymbol", 15);
STRING_LITERAL(TMP3811, "importSymbol: 2", 15);
STRING_LITERAL(TMP3812, "importSymbol: 3", 15);
...
{	result0 = (NimStringDesc*)0;
	...
	{
		TSafePoint TMP3798;
		pushSafePoint(&TMP3798);
		TMP3798.status = _setjmp(TMP3798.context);
		if (TMP3798.status == 0) {
			NimStringDesc* LOC3;
			TY124906 LOC4;
...
appendString(LOC7, ((NimStringDesc*) &TMP3799));
appendString(LOC7, (*n0).kindU.S3.strval);
		...
		if (TMP3798.status != 0) reraiseException();
	}
	break;
	...
	case ((Tnodekind264020) 30):
	{
		NimStringDesc* LOC18;
		{
			...
			LOC15 = getident_194441_791273810(((NimStringDesc*) &TMP3800));
		...
		result0 = nsuReplaceStr(LOC18, ((NimStringDesc*) &TMP3801), ((NimStringDesc*) &TMP3802));
	}
	break;
	case ((Tnodekind264020) 45):
	{
		...
		result0 = nsuReplaceStr(LOC20, ((NimStringDesc*) &TMP3803), ((NimStringDesc*) &TMP3804));
	}
	break;
	...
	default:
	{
		...
		LOC24 = nsuFormatSingleElem(((NimStringDesc*) &TMP3805), LOC23);
		localerror_191080_155036129((*n0).info, ((Tmsgkind186002) 4), LOC24);
		result0 = copyString(((NimStringDesc*) &TMP3802));
	}
	break;
	}
	}BeforeRet: ;
...
N_NIMCALL(Tsym264826*, importmoduleas_319443_2178338529)(Tnode264794* n0, Tsym264826* realmodule0) {
	...
	LA3: ;
	{
		...
		LA8: ;
		if (!LOC6) goto LA9;
		localerror_191080_155036129((*n0).info, ((Tmsgkind186002) 4), ((NimStringDesc*) &TMP3806));
	}
	goto LA1;
	LA9: ;
	{
				...
				res_319196_2178338529 = ((NI) 0);
				{
					while (1) {
						...
						e0 = (*(*(*etyp0).n).kindU.S6.sons->data[j_319137_2178338529]).kindU.S4.sym;
						{
							...
							internalerror_191100_155036129((*s0).info, ((NimStringDesc*) &TMP3809));
						}
						LA27: ;
...
appendString(LOC15, ((NimStringDesc*) &TMP3808));
...
N_NIMCALL(void, importsymbol_319200_2178338529)(Tcontext315020* c0, Tnode264794* n0, Tsym264826* frommod0) {
	...
	LA3: ;
	{
		...
		LA8: ;
		{
			...
			internalerror_191100_155036129((*n0).info, ((NimStringDesc*) &TMP3811));
		}
		LA12: ;
		switch ((*s0).kind) {
