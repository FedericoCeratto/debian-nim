...
NIM_CONST TY218026 filternames_218025 = {((NimStringDesc*) &TMP1388),
...
NIM_CONST TY218020 parsernames_218019 = {((NimStringDesc*) &TMP1392),
...
N_NIMCALL(Tnode190813*, parseall_218063)(Tparsers218035* p) {
	...
	case ((NU8) 3):
	{
		internalerror_165218(((NimStringDesc*) &TMP1426));
		result = emptynode_191807;
	}
	break;
	}
