...
44}
;
STRING_LITERAL(TMP4138, "", 0);
STRING_LITERAL(TMP4139, "nim", 3);
STRING_LITERAL(TMP4140, "system.nim", 10);
STRING_LITERAL(TMP4850, "stdin", 5);
...
N_NIMCALL(void, wantmainmodule_612014)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_197923(gcmdlineinfo_196192, ((NU16) 186), ((NimStringDesc*) &TMP4138));
	}
	LA3: ;
	LOC5 = 0;
	LOC5 = nosaddFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP4139));
...
N_NIMCALL(void, compilesystemmodule_611988)(void) {
	{
		...
		LOC5 = 0;
		LOC5 = HEX2F_117299(libpath_169233, ((NimStringDesc*) &TMP4140));
...
N_NIMCALL(void, compileproject_612077)(NI32 projectfileidx) {
	...
	LOC1 = 0;
	LOC1 = HEX2F_117299(libpath_169233, ((NimStringDesc*) &TMP4140));
...
N_NIMCALL(tsym225846*, makestdinmodule_612097)(void) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = fileinfoidx_195747(((NimStringDesc*) &TMP4850));
