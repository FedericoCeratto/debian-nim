...
N_NIMCALL(void, readtypecache_457524)(Tbaselexer179024* L, Tidtable190861* result);
...
N_NIMCALL(void, readintset_457574)(Tbaselexer179024* L, Intset187056* result);
...
STRING_LITERAL(TMP4189, "ccgmerge: \':\' expected", 22);
STRING_LITERAL(TMP4190, "NIM_merge_INFO", 14);
STRING_LITERAL(TMP4191, "typeCache", 9);
STRING_LITERAL(TMP4192, "declared", 8);
STRING_LITERAL(TMP4193, "typeInfo", 8);
STRING_LITERAL(TMP4194, "labels", 6);
STRING_LITERAL(TMP4195, "hasframe", 8);
STRING_LITERAL(TMP4196, "ccgmerge: \'{\' expected", 22);
STRING_LITERAL(TMP4197, "ccgmerge: unknown key: ", 23);
STRING_LITERAL(TMP4266, "ccgmerge: expected: /*\011NIM_merge_END:*/", 39);
STRING_LITERAL(TMP4267, "/*\011NIM_merge_END:*/", 19);
STRING_LITERAL(TMP4268, "", 0);
STRING_LITERAL(TMP4269, "NIM_merge_HEADERS", 17);
STRING_LITERAL(TMP4270, "NIM_merge_FORWARD_TYPES", 23);
STRING_LITERAL(TMP4271, "NIM_merge_TYPES", 15);
STRING_LITERAL(TMP4272, "NIM_merge_SEQ_TYPES", 19);
STRING_LITERAL(TMP4273, "NIM_merge_FIELD_INFO", 20);
STRING_LITERAL(TMP4274, "NIM_merge_TYPE_INFO", 19);
STRING_LITERAL(TMP4275, "NIM_merge_PROC_HEADERS", 22);
STRING_LITERAL(TMP4276, "NIM_merge_DATA", 14);
STRING_LITERAL(TMP4277, "NIM_merge_VARS", 14);
STRING_LITERAL(TMP4278, "NIM_merge_PROCS", 15);
STRING_LITERAL(TMP4279, "NIM_merge_INIT_PROC", 19);
STRING_LITERAL(TMP4280, "NIM_merge_TYPE_INIT1", 20);
STRING_LITERAL(TMP4281, "NIM_merge_TYPE_INIT2", 20);
STRING_LITERAL(TMP4282, "NIM_merge_TYPE_INIT3", 20);
STRING_LITERAL(TMP4283, "NIM_merge_DEBUG_INIT", 20);
STRING_LITERAL(TMP4284, "NIM_merge_DYNLIB_INIT", 21);
STRING_LITERAL(TMP4285, "NIM_merge_DYNLIB_DEINIT", 23);
NIM_CONST TY457013 Cfilesectionnames_457012 = {((NimStringDesc*) &TMP4268),
...
;
STRING_LITERAL(TMP4286, "NIM_merge_PROC_LOCALS", 21);
STRING_LITERAL(TMP4287, "NIM_merge_PROC_INIT", 19);
STRING_LITERAL(TMP4288, "NIM_merge_PROC_BODY", 19);
NIM_CONST TY457019 Cprocsectionnames_457018 = {((NimStringDesc*) &TMP4286),
((NimStringDesc*) &TMP4287),
((NimStringDesc*) &TMP4288)}
;
STRING_LITERAL(TMP4289, "ccgmerge: unknown section: ", 27);
STRING_LITERAL(TMP4290, "ccgmerge: \'*/\' expected", 23);
STRING_LITERAL(TMP4294, "/*\011", 3);
STRING_LITERAL(TMP4295, ":*/", 3);
STRING_LITERAL(TMP4303, "/*\011NIM_merge_INFO:", 18);
STRING_LITERAL(TMP4304, "typeCache:{", 11);
STRING_LITERAL(TMP4305, "declared:{", 10);
STRING_LITERAL(TMP4306, "typeInfo:{", 10);
STRING_LITERAL(TMP4307, "labels:", 7);
STRING_LITERAL(TMP4308, " hasframe:", 10);
STRING_LITERAL(TMP4309, "*/", 2);
...
N_NIMCALL(void, readkey_457466)(Tbaselexer179024* L, NimStringDesc** result) {
	...
	}
	{
		...
		internalerror_165218(((NimStringDesc*) &TMP4189));
	}
	LA5: ;
...
N_NIMCALL(void, readtypecache_457524)(Tbaselexer179024* L, Tidtable190861* result) {
	{
		...
		internalerror_165218(((NimStringDesc*) &TMP4196));
	}
	LA3: ;
	(*L).bufpos += ((NI) 1);
	{
...
N_NIMCALL(void, processmergeinfo_457613)(Tbaselexer179024* L, Tcgen456038* m) {
	...
	k = rawNewString(((NI) 9));
	{
		while (1) {
			...
			LA7: ;
			readkey_457466(L, (&k));
			if (eqStrings(k, ((NimStringDesc*) &TMP4191))) goto LA9;
			if (eqStrings(k, ((NimStringDesc*) &TMP4192))) goto LA10;
			if (eqStrings(k, ((NimStringDesc*) &TMP4193))) goto LA11;
			if (eqStrings(k, ((NimStringDesc*) &TMP4194))) goto LA12;
...
appendString(LOC24, ((NimStringDesc*) &TMP4197));
...
{	s_457821 = llstreamopen_178256(cfilename, ((NU8) 0));
	...
	k = rawNewString(((NI) 23));
	{
		while (1) {
			...
			readkey_457466((&L), (&k));
			{
				if (!eqStrings(k, ((NimStringDesc*) &TMP4190))) goto LA13;
...
N_NIMCALL(NIM_BOOL, atendmark_457397)(NCSTRING buf, NI pos) {
	...
	s = ((NI) 0);
	{
		while (1) {
			...
			LOC3 = (s < ((NI) 19));
			if (!(LOC3)) goto LA4;
			LOC3 = ((NU8)(buf[(NI)(pos + s)]) == (NU8)(((NimStringDesc*) &TMP4267)->data[s]));
			LA4: ;
			if (!LOC3) goto LA2;
			s += ((NI) 1);
		} LA2: ;
...
appendString(r, tnl_159626);
			...
			case 0:
			{
				internalerror_165218(((NimStringDesc*) &TMP4266));
				goto LA1;
			}
			break;
			default:
...
appendString(LOC34, ((NimStringDesc*) &TMP4289));
appendString(LOC34, k);
			...
			LA18: ;
			{
				internalerror_165218(((NimStringDesc*) &TMP4290));
			}
			LA11: ;
		}
	} LA5: ;
...
N_NIMCALL(Ropeobj161009*, gensectionstart_457106)(NU8 ps) {
	...
	result = 0;
	{
		...
		add_161545(&result, ((NimStringDesc*) &TMP4294));
...
{	result = 0;
	...
	LA3: ;
	s = copyString(((NimStringDesc*) &TMP4303));
	s = resizeString(s, tnl_159626->Sup.len + 0);
appendString(s, tnl_159626);
	s = resizeString(s, 11);
appendString(s, ((NimStringDesc*) &TMP4304));
