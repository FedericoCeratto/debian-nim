...
N_NIMCALL(tnode225816*, evaltemplateargs_455217)(tnode225816* n, tsym225846* s) {
	...
	{
		if (!(f < a)) goto LA5;
		globalerror_197934((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP2840));
	}
	LA5: ;
		...
		res_455313 = 1;
		{
			while (1) {
				...
				LA10: ;
				{
					...
					LA18: ;
					if (!LOC17) goto LA19;
					localerror_197955((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP2840));
				}
				LA19: ;
...
N_NIMCALL(tnode225816*, evaltemplate_455334)(tnode225816* n, tsym225846* tmpl, tsym225846* gensymowner) {
	...
	evaltemplatecounter_455330 += 1;
	{
		...
		globalerror_197934((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP2840));
		result = n;
	}
	LA3: ;
