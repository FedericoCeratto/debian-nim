...
STRING_LITERAL(TMP2207, "stdinfile", 9);
STRING_LITERAL(TMP2232, "nim.cfg", 7);
STRING_LITERAL(TMP2233, "nims", 4);
STRING_LITERAL(TMP3897, "config.nims", 11);
STRING_LITERAL(TMP5578, "js", 2);
STRING_LITERAL(TMP5582, " ", 1);
STRING_LITERAL(TMP5583, "php", 3);
STRING_LITERAL(TMP5584, "php ", 4);
STRING_LITERAL(TMP5585, "exe", 3);
...
{	{
		...
		writecommandlineusage_253005_2004575671();
	}
	goto LA1;
	LA4: ;
	{
		NimStringDesc* scriptfile0;
		processcmdline_563203_3526807654(((Tcmdlinepass253008) 0), ((NimStringDesc*) &TMP2205));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_166205_2607990831, ((NimStringDesc*) &TMP2206))) goto LA9;
			LOC11 = (NimStringDesc*)0;
			LOC11 = gprojectname_166205_2607990831; gprojectname_166205_2607990831 = copyStringRC1(((NimStringDesc*) &TMP2207));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = (NimStringDesc*)0;
			LOC12 = gprojectfull_166207_2607990831; gprojectfull_166207_2607990831 = copyStringRC1(((NimStringDesc*) &TMP2207));
			if (LOC12) nimGCunrefNoCycle(LOC12);
			asgnRefNoCycle((void**) (&gprojectpath_166206_2607990831), nosgetCurrentDir());
			gprojectisstdin_166208_2607990831 = NIM_TRUE;
		}
		goto LA7;
		LA9: ;
		{
			...
			NimStringDesc* LOC20;
			NimStringDesc* LOC21;
			if (!!(((gprojectname_166205_2607990831) && (gprojectname_166205_2607990831)->Sup.len == 0))) goto LA14;
			pushSafePoint(&TMP2208);
			TMP2208.status = setjmp(TMP2208.context);
			if (TMP2208.status == 0) {
				asgnRefNoCycle((void**) (&gprojectfull_166207_2607990831), canonicalizepath_166405_2607990831(gprojectname_166205_2607990831));
				popSafePoint();
			}
			else {
				popSafePoint();
				if (isObj(getCurrentException()->Sup.m_type, (&NTI3430))) {
					...
					LOC19 = gprojectfull_166207_2607990831; gprojectfull_166207_2607990831 = copyStringRC1(gprojectname_166205_2607990831);
					if (LOC19) nimGCunrefNoCycle(LOC19);
					popCurrentException();
				}
			}
			if (TMP2208.status != 0) reraiseException();
			memset((void*)(&p0), 0, sizeof(p0));
			chckNil((void*)(&p0));
			memset((void*)(&p0), 0, sizeof(p0));
			nossplitFile(gprojectfull_166207_2607990831, (&p0));
			LOC20 = (NimStringDesc*)0;
			LOC20 = gprojectpath_166206_2607990831; gprojectpath_166206_2607990831 = copyStringRC1(p0.Field0);
			if (LOC20) nimGCunrefNoCycle(LOC20);
			LOC21 = (NimStringDesc*)0;
			LOC21 = gprojectname_166205_2607990831; gprojectname_166205_2607990831 = copyStringRC1(p0.Field1);
		...
		LA7: ;
		loadconfigs_263601_930198375(((NimStringDesc*) &TMP2232));
		scriptfile0 = noschangeFileExt(gprojectfull_166207_2607990831, ((NimStringDesc*) &TMP2233));
		{
			NIM_BOOL LOC25;
			LOC25 = (NIM_BOOL)0;
			...
			{
				if (!eqStrings(scriptfile0, gprojectfull_166207_2607990831)) goto LA30;
				goto BeforeRet;
			}
			LA30: ;
		}
		...
		LA26: ;
		{
			...
			LOC33 = HEX2F_124074_2125978480(gprojectpath_166206_2607990831, ((NimStringDesc*) &TMP3897));
			LOC34 = (NIM_BOOL)0;
			LOC34 = fileexists_129002_2125978480(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = (NimStringDesc*)0;
			LOC37 = HEX2F_124074_2125978480(gprojectpath_166206_2607990831, ((NimStringDesc*) &TMP3897));
		...
		processcmdline_563203_3526807654(((Tcmdlinepass253008) 1), ((NimStringDesc*) &TMP2205));
		{
			if (!((command_166211_2607990831) && (command_166211_2607990831)->Sup.len == 0)) goto LA40;
			rawmessage_190612_155036129(((Tmsgkind187002) 184), command_166211_2607990831);
		}
		LA40: ;
		maincommand_565610_6460232();
		{
			...
			NimStringDesc* LOC48;
			LOC44 = (NIM_BOOL)0;
			LOC44 = ((goptions_166125_2607990831 &(1U<<((NU)(((Toption166009) 12))&31U)))!=0);
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_188077_155036129 &((NU64)1<<((NU)((((Tmsgkind187002) 289)- 237))&63U)))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
		...
		LA46: ;
		{
			if (!(gerrorcounter_188078_155036129 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_166127_2607990831 &(1U<<((NU)(((Tglobaloption166013) 13))&31U)))!=0)) goto LA55;
				{
					NimStringDesc* ex0;
					NimStringDesc* LOC70;
					NimStringDesc* LOC71;
					if (!(gcmd_166129_2607990831 == ((Tcommands166017) 4))) goto LA59;
					ex0 = (NimStringDesc*)0;
					{
						NimStringDesc* LOC65;
						if (!(((NI) 0) < (outfile_166133_2607990831 ? outfile_166133_2607990831->Sup.len : 0))) goto LA63;
						LOC65 = (NimStringDesc*)0;
						LOC65 = prependcurdir_569401_957294627(outfile_166133_2607990831);
					...
					LA63: ;
					{
						...
						LOC67 = noschangeFileExt(gprojectfull_166207_2607990831, ((NimStringDesc*) &TMP5578));
						LOC68 = (NimStringDesc*)0;
						LOC68 = prependcurdir_569401_957294627(LOC67);
						LOC69 = (NimStringDesc*)0;
						LOC69 = completecfilepath_247854_2528170400(LOC68, NIM_TRUE);
					...
					LOC70 = rawNewString(LOC71->Sup.len + ex0->Sup.len + arguments_254716_2004575671->Sup.len + 2);
appendString(LOC70, LOC71);
appendString(LOC70, ((NimStringDesc*) &TMP5582));
appendString(LOC70, ex0);
appendChar(LOC70, 32);
appendString(LOC70, arguments_254716_2004575671);
					execexternalprogram_247881_2528170400(LOC70, ((Tmsgkind187002) 284));
				}
				goto LA57;
				LA59: ;
				{
					NimStringDesc* ex0;
					NimStringDesc* LOC84;
					if (!(gcmd_166129_2607990831 == ((Tcommands166017) 5))) goto LA73;
					ex0 = (NimStringDesc*)0;
					{
						NimStringDesc* LOC79;
						if (!(((NI) 0) < (outfile_166133_2607990831 ? outfile_166133_2607990831->Sup.len : 0))) goto LA77;
						LOC79 = (NimStringDesc*)0;
						LOC79 = prependcurdir_569401_957294627(outfile_166133_2607990831);
					...
					LA77: ;
					{
						...
						LOC81 = noschangeFileExt(gprojectfull_166207_2607990831, ((NimStringDesc*) &TMP5583));
						LOC82 = (NimStringDesc*)0;
						LOC82 = prependcurdir_569401_957294627(LOC81);
						LOC83 = (NimStringDesc*)0;
						LOC83 = completecfilepath_247854_2528170400(LOC82, NIM_TRUE);
						ex0 = nospquoteShell(LOC83);
					}
					LA75: ;
					LOC84 = (NimStringDesc*)0;
					LOC84 = rawNewString(ex0->Sup.len + arguments_254716_2004575671->Sup.len + 5);
appendString(LOC84, ((NimStringDesc*) &TMP5584));
appendString(LOC84, ex0);
appendChar(LOC84, 32);
appendString(LOC84, arguments_254716_2004575671);
					execexternalprogram_247881_2528170400(LOC84, ((Tmsgkind187002) 284));
				}
				goto LA57;
				LA73: ;
				{
					...
					{
						if (!(((NI) 0) < (outfile_166133_2607990831 ? outfile_166133_2607990831->Sup.len : 0))) goto LA88;
						binpath0 = prependcurdir_569401_957294627(outfile_166133_2607990831);
					}
					goto LA86;
					LA88: ;
					{
						...
						LOC91 = noschangeFileExt(gprojectfull_166207_2607990831, ((NimStringDesc*) &TMP5585));
						binpath0 = prependcurdir_569401_957294627(LOC91);
					}
					LA86: ;
					ex0 = nospquoteShell(binpath0);
					LOC92 = (NimStringDesc*)0;
					LOC92 = rawNewString(ex0->Sup.len + arguments_254716_2004575671->Sup.len + 1);
appendString(LOC92, ex0);
appendChar(LOC92, 32);
appendString(LOC92, arguments_254716_2004575671);
					execexternalprogram_247881_2528170400(LOC92, ((Tmsgkind187002) 284));
				}
				LA57: ;
			}
			LA55: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	msgquit_188153_155036129(((NI8) ((((NI) 0) < gerrorcounter_188078_155036129))));
}
