...
N_NIMCALL(Tnode265794*, semlocals_450005_4183469335)(Tcontext316020* c0, Tnode265794* n0);
...
STRING_LITERAL(TMP1175, "stdlib", 6);
STRING_LITERAL(TMP1176, "system", 6);
STRING_LITERAL(TMP1177, "locals", 6);
...
N_NIMCALL(Tnode265794*, semlocals_450005_4183469335)(Tcontext316020* c0, Tnode265794* n0) {
	Tnode265794* result0;
	NI counter0;
	Ttype265832* tupletype0;
	result0 = (Tnode265794*)0;
	counter0 = ((NI) 0);
	tupletype0 = newtypes_316195_893308950(((Ttypekind265244) 18), c0);
	result0 = newnodeit_267801_850551059(((Tnodekind265020) 37), (*n0).info, tupletype0);
	asgnRefNoCycle((void**) (&(*tupletype0).n), newnodei_267248_850551059(((Tnodekind265020) 138), (*n0).info));
	{
		Tscope265820* scope_450012_4183469335;
		Tscope265820* HEX3Atmp_450085_4183469335;
		Tscope265820* current_450088_4183469335;
		scope_450012_4183469335 = (Tscope265820*)0;
		HEX3Atmp_450085_4183469335 = (Tscope265820*)0;
		HEX3Atmp_450085_4183469335 = (*c0).currentscope;
		current_450088_4183469335 = HEX3Atmp_450085_4183469335;
		{
			while (1) {
				if (!!((current_450088_4183469335 == NIM_NIL))) goto LA3;
				scope_450012_4183469335 = current_450088_4183469335;
				{
					if (!(scope_450012_4183469335 == (*c0).toplevelscope)) goto LA6;
					goto LA1;
				}
				LA6: ;
				{
					Tsym265826* it_450024_4183469335;
					Tstrtable265798 HEX3Atmp_450079_4183469335;
					Ttabiter272075 it_450082_4183469335;
					Tsym265826* s_450084_4183469335;
					it_450024_4183469335 = (Tsym265826*)0;
					memset((void*)(&HEX3Atmp_450079_4183469335), 0, sizeof(HEX3Atmp_450079_4183469335));
					HEX3Atmp_450079_4183469335.counter = (*scope_450012_4183469335).symbols.counter;
					HEX3Atmp_450079_4183469335.data = (*scope_450012_4183469335).symbols.data;
					memset((void*)(&it_450082_4183469335), 0, sizeof(it_450082_4183469335));
					s_450084_4183469335 = inittabiter_272077_2984716966((&it_450082_4183469335), HEX3Atmp_450079_4183469335);
					{
						while (1) {
							if (!!((s_450084_4183469335 == NIM_NIL))) goto LA10;
							it_450024_4183469335 = s_450084_4183469335;
							{
								NIM_BOOL LOC13;
								Ttype265832* LOC15;
								Tsym265826* field0;
								...
								Tnode265794* a0;
								LOC13 = (NIM_BOOL)0;
								LOC13 = ((1051400 &(1U<<((NU)((*it_450024_4183469335).kind)&31U)))!=0);
								if (!(LOC13)) goto LA14;
								LOC15 = (Ttype265832*)0;
								LOC15 = skiptypes_269113_850551059((*it_450024_4183469335).typ, 8390656);
								LOC13 = !(((*LOC15).kind == ((Ttypekind265244) 48) || (*LOC15).kind == ((Ttypekind265244) 27) || (*LOC15).kind == ((Ttypekind265244) 8) || (*LOC15).kind == ((Ttypekind265244) 59) || (*LOC15).kind == ((Ttypekind265244) 6) || (*LOC15).kind == ((Ttypekind265244) 7) || (*LOC15).kind == ((Ttypekind265244) 3)));
								LA14: ;
								if (!LOC13) goto LA16;
								LOC18 = (Tsym265826*)0;
								LOC18 = getcurrowner_316220_893308950();
								field0 = newsym_266684_850551059(((Tsymkind265435) 18), (*it_450024_4183469335).name, LOC18, (*n0).info);
								asgnRefNoCycle((void**) (&(*field0).typ), skiptypes_269113_850551059((*it_450024_4183469335).typ, 8390656));
								(*field0).position = counter0;
								counter0 += ((NI) 1);
								LOC19 = (Tnode265794*)0;
								LOC19 = newsymnode_267234_850551059(field0);
								addson_267807_850551059((*tupletype0).n, LOC19);
								addsonskipintlit_310678_3937434831(tupletype0, (*field0).typ);
								a0 = newsymnode_267241_850551059(it_450024_4183469335, (*result0).info);
								{
									Ttype265832* LOC22;
									LOC22 = (Ttype265832*)0;
									LOC22 = skiptypes_269113_850551059((*it_450024_4183469335).typ, 2048);
									if (!((*LOC22).kind == ((Ttypekind265244) 23))) goto LA23;
									a0 = newderef_403006_2218250499(a0);
								}
								LA23: ;
								add_266135_850551059(result0, a0);
							}
							LA16: ;
							s_450084_4183469335 = nextiter_272082_2984716966((&it_450082_4183469335), HEX3Atmp_450079_4183469335);
						} LA10: ;
					}
				}
				current_450088_4183469335 = (*current_450088_4183469335).parent;
			} LA3: ;
		}
	} LA1: ;
	return result0;
...
NIM_EXTERNC N_NOINLINE(void, compiler_localsInit000)(void) {
	registerplugin_449102_1104897005(((NimStringDesc*) &TMP1175), ((NimStringDesc*) &TMP1176), ((NimStringDesc*) &TMP1177), semlocals_450005_4183469335);
}
