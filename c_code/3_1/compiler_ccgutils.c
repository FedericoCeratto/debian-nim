...
STRING_LITERAL(TMP3739, "N", 1);
STRING_LITERAL(TMP3740, "HEX", 3);
STRING_LITERAL(TMP3748, "metatype not eliminated", 23);
...
N_NIMCALL(NimStringDesc*, mangle_507910)(NimStringDesc* name) {
	...
	case 48 ... 57:
	{
		...
		LOC3 = 0;
		LOC3 = rawNewString(2);
appendString(LOC3, ((NimStringDesc*) &TMP3739));
...
appendString(LOC5, ((NimStringDesc*) &TMP3740));
...
appendString(LOC15, ((NimStringDesc*) &TMP3740));
	...
	{
		{
			...
			internalerror_196172((*(*key).sym).info, ((NimStringDesc*) &TMP3748));
		}
		goto LA12;
		LA14: ;
		{
			internalerror_196191(((NimStringDesc*) &TMP3748));
		}
		LA12: ;
	}
	break;
...
N_NIMCALL(NimStringDesc*, makesinglelinecstring_507883)(NimStringDesc* s) {
	NimStringDesc* result;
	result = 0;
	result = copyString(((NimStringDesc*) &TMP3838));
	{
		NIM_CHAR c_507888;
		NI i_507892;
		NI L_507894;
