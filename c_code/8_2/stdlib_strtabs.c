...
STRING_LITERAL(TMP1710, "key not found: ", 15);
STRING_LITERAL(TMP1959, "", 0);
STRING_LITERAL(TMP2204, "format string: key not found: ", 30);
...
appendString(LOC6, ((NimStringDesc*) &TMP1710));
...
N_NIMCALL(NimStringDesc*, getordefault_146814_603679043)(Stringtableobj146209* t0, NimStringDesc* key0) {
	...
	LA3: ;
	{
		result0 = copyString(((NimStringDesc*) &TMP1959));
	}
	LA1: ;
	return result0;
}
...
appendString(LOC1, ((NimStringDesc*) &TMP2204));
