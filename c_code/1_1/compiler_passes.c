...
N_NIMCALL(void, processimplicits_313470_2355241294)(TY134602* implicits0, Tnodekind265020 nodekind0, Tpasscontext313002** a0) {
	{
		...
		L_313494_2355241294 = (implicits0 ? implicits0->Sup.len : 0);
		{
			while (1) {
				...
				importstmt0 = newnodei_267248_850551059(nodekind0, gcmdlineinfo_188046_155036129);
				str0 = newstrnode_266678_850551059(((Tnodekind265020) 20), module_313485_2355241294);
				(*str0).info = gcmdlineinfo_188046_155036129;
...
{	memset((void*)(&p0), 0, sizeof(p0));
	...
	LA3: ;
	{
		...
		n0 = loadinitsection_304083_1724185294(rd0);
		{
			...
			NI HEX3Atmp_313634_2355241294;
			NI LOC47;
			NI res_313637_2355241294;
			i_313622_2355241294 = (NI)0;
			HEX3Atmp_313634_2355241294 = (NI)0;
			LOC47 = (NI)0;
			LOC47 = sonslen_268351_850551059(n0);
			HEX3Atmp_313634_2355241294 = (NI)(LOC47 - ((NI) 1));
			res_313637_2355241294 = ((NI) 0);
			{
				while (1) {
					if (!(res_313637_2355241294 <= HEX3Atmp_313634_2355241294)) goto LA49;
					i_313622_2355241294 = res_313637_2355241294;
					processtoplevelstmtcached_313394_2355241294((*n0).kindU.S6.sons->data[i_313622_2355241294], a0);
					res_313637_2355241294 += ((NI) 1);
				} LA49: ;
			}
		}
