...
STRING_LITERAL(TMP3744, "N", 1);
STRING_LITERAL(TMP3745, "HEX", 3);
STRING_LITERAL(TMP3753, "metatype not eliminated", 23);
...
N_NIMCALL(NimStringDesc*, mangle_506910)(NimStringDesc* name) {
	...
	case 48 ... 57:
	{
		...
		LOC3 = 0;
		LOC3 = rawNewString(2);
appendString(LOC3, ((NimStringDesc*) &TMP3744));
...
appendString(LOC5, ((NimStringDesc*) &TMP3745));
...
appendString(LOC15, ((NimStringDesc*) &TMP3745));
	...
	{
		{
			...
			internalerror_195172((*(*key).sym).info, ((NimStringDesc*) &TMP3753));
		}
		goto LA12;
		LA14: ;
		{
...
N_NIMCALL(NimStringDesc*, makesinglelinecstring_506883)(NimStringDesc* s) {
	NimStringDesc* result;
	result = 0;
	result = copyString(((NimStringDesc*) &TMP3843));
	{
		NIM_CHAR c_506888;
		NI i_506892;
		NI L_506894;
