...
typedef struct Slice166076 Slice166076;
...
N_NIMCALL(void, newfileinfo_164495)(NimStringDesc* fullpath, NimStringDesc* projpath, Tfileinfo164336* Result);
...
N_NIMCALL(void, HEX3Aanonymous_166371)(NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
N_NIMCALL(void, internalerror_166218)(NimStringDesc* errmsg);
N_NIMCALL(void, writecontext_165800)(Tlineinfo164338 lastinfo);
...
N_NIMCALL(NimStringDesc*, coordtostr_165606)(NI coord);
N_NIMCALL(NimStringDesc*, nimIntToStr)(NI x);
N_NIMCALL(NimStringDesc*, getmessagestr_165626)(NU16 msg, NimStringDesc* arg);
...
N_NIMCALL(NIM_BOOL, ignoremsgbecauseofidetools_165850)(NU16 msg);
N_NIMCALL(void, handleerror_165647)(NU16 msg, NU8 eh, NimStringDesc* s);
N_NIMCALL(NIM_BOOL, stacktraceavailable_17930)(void);
N_NIMCALL(void, writestacktrace_16407)(void);
N_NOINLINE(void, raiserecoverableerror_164966)(NimStringDesc* msg);
...
N_NIMCALL(void, limessage_165997)(Tlineinfo164338 info, NU16 msg, NimStringDesc* arg, NU8 eh);
static N_INLINE(NIM_BOOL, contains_166086)(Slice166076 s, NU16 value);
static N_INLINE(Slice166076, HEX2EHEX2E_166067)(NU16 a, NU16 b);
N_NIMCALL(void, writesurroundingsrc_165972)(Tlineinfo164338 info);
...
N_NIMCALL(void, addsourceline_166254)(NI32 fileidx, NimStringDesc* line);
...
N_NIMCALL(NI32, fileinfoidx_164533)(NimStringDesc* filename, NIM_BOOL* isknownfile);
...
STRING_LITERAL(TMP989, "msgs.nim", 8);
NIM_CONST TY88145 TMP988 = {((NimStringDesc*) &TMP989),
((NI) 868)}
;
...
NIM_CONST TY88145 TMP3746 = {((NimStringDesc*) &TMP989),
((NI) 875)}
;
Table164376 filenametoindextbl_164414;
extern TNimType NTI164376; /* Table */
TY164415* fileinfos_164432;
...
NI32 systemfileidx_164433;
extern NimStringDesc* tnl_160626;
extern NU32 gglobaloptions_155128;
Tlineinfo164338 gcmdlineinfo_164921;
Tlineinfo164338 gcodegenlineinfo_164959;
NU64 gnotes_165011;
NI gerrorcounter_165012;
NI ghintcounter_165013;
NI gwarncounter_165014;
NI gerrormax_165015;
TY165033* msgcontext_165050;
TNimType NTI164338; /* TLineInfo */
extern TNimType NTI112; /* int16 */
extern TNimType NTI114; /* int32 */
TNimType NTI165033; /* seq[TLineInfo] */
Tlineinfo164338 lasterror_165051;
NU8 erroroutputs_165053;
TY165054 writelnhook_165057;
...
TNimType NTI164972; /* ref ERecoverableError */
...
TNimType NTI165127; /* ref ESuggestDone */
N_NIMCALL(void, TMP134)(void* p, NI op) {
	TY164351* a;
	NI LOC1;
	a = (TY164351*)p;
...
N_NIMCALL(Ropeobj162009*, makecstring_164449)(NimStringDesc* s) {
	...
	result = 0;
	result = NIM_NIL;
	res = rawNewString(((NI) ((NI)(((NI) (((NF)(((double) ((s ? s->Sup.len : 0)))) * (NF)(1.1000000000000001e+000)))) + ((NI) 1)))));
...
appendString(res, ((NimStringDesc*) &TMP138));
	{
		...
		i_164468 = 0;
		HEX3Atmp_164473 = 0;
		HEX3Atmp_164473 = (NI)((s ? s->Sup.len : 0) - ((NI) 1));
		res_164476 = ((NI) 0);
		{
			while (1) {
				NimStringDesc* LOC8;
				if (!(res_164476 <= HEX3Atmp_164473)) goto LA3;
				i_164468 = res_164476;
				{
					if (!(((NI) ((NI)((NI)(i_164468 + ((NI) 1)) % ((NI) 64)))) == ((NI) 0))) goto LA6;
					res = addChar(res, 34);
...
appendString(res, tnl_160626);
				...
				LA6: ;
				LOC8 = 0;
				LOC8 = tocchar_164439(s->data[i_164468]);
...
N_NIMCALL(void, newfileinfo_164495)(NimStringDesc* fullpath, NimStringDesc* projpath, Tfileinfo164336* Result) {
	...
	unsureAsgnRef((void**) (&(*Result).quotedname), makecstring_164449(filename));
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
...
N_NIMCALL(void, msgwriteln_165536)(NimStringDesc* s) {
	{
		if (!!(writelnhook_165057.ClPrc == 0)) goto LA3;
		writelnhook_165057.ClEnv? writelnhook_165057.ClPrc(s, writelnhook_165057.ClEnv):((TMP143)(writelnhook_165057.ClPrc))(s);
	}
	goto LA1;
	LA3: ;
	{
		...
		{
			TY165566 LOC12;
			if (!((erroroutputs_165053 &(1<<((((NU8) 1))&7)))!=0)) goto LA10;
	...
	LA6: ;
	{
		{
			TY165566 LOC18;
			if (!((erroroutputs_165053 &(1<<((((NU8) 0))&7)))!=0)) goto LA16;
...
N_NIMCALL(NimStringDesc*, tomsgfilename_165429)(Tlineinfo164338 info) {
	...
	LA3: ;
	{
		...
		result = copyString(fileinfos_164432->data[info.fileindex].fullpath);
	}
	goto LA1;
	LA6: ;
	{
		result = copyString(fileinfos_164432->data[info.fileindex].projpath);
	}
	LA1: ;
	return result;
}
...
N_NIMCALL(NimStringDesc*, getmessagestr_165626)(NU16 msg, NimStringDesc* arg) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = msgkindtostring_165616(msg);
...
N_NIMCALL(void, writecontext_165800)(Tlineinfo164338 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_165824 = 0;
		HEX3Atmp_165828 = 0;
		HEX3Atmp_165828 = (NI)((msgcontext_165050 ? msgcontext_165050->Sup.len : 0) - ((NI) 1));
		res_165831 = ((NI) 0);
		{
			while (1) {
				if (!(res_165831 <= HEX3Atmp_165828)) goto LA3;
				i_165824 = res_165831;
				{
					NIM_BOOL LOC6;
					NIM_BOOL LOC7;
					...
					LOC6 = 0;
					LOC7 = 0;
					LOC7 = HEX3DHEX3D_165789(msgcontext_165050->data[i_165824], lastinfo);
					LOC6 = !(LOC7);
					if (!(LOC6)) goto LA8;
					LOC9 = 0;
					LOC9 = HEX3DHEX3D_165789(msgcontext_165050->data[i_165824], info);
					LOC6 = !(LOC9);
					LA8: ;
					if (!LOC6) goto LA10;
					memset((void*)LOC12, 0, sizeof(LOC12));
					LOC12[0] = tomsgfilename_165429(msgcontext_165050->data[i_165824]);
					LOC12[1] = coordtostr_165606(((NI) (msgcontext_165050->data[i_165824].line)));
					LOC12[2] = coordtostr_165606(((NI) ((NI16)(msgcontext_165050->data[i_165824].col + ((NI16) 1)))));
					LOC12[3] = getmessagestr_165626(((NU16) 184), ((NimStringDesc*) &TMP137));
					LOC13 = 0;
					LOC13 = nsuFormatOpenArray(((NimStringDesc*) &TMP148), LOC12, 4);
					msgwriteln_165536(LOC13);
				}
				LA10: ;
				info = msgcontext_165050->data[i_165824];
				res_165831 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NOINLINE(void, raiserecoverableerror_164966)(NimStringDesc* msg) {
	Erecoverableerror164344* e_164971;
	NimStringDesc* LOC1;
	e_164971 = 0;
	e_164971 = (Erecoverableerror164344*) newObj((&NTI164972), sizeof(Erecoverableerror164344));
	(*e_164971).Sup.Sup.Sup.m_type = (&NTI164344);
	LOC1 = 0;
	LOC1 = (*e_164971).Sup.Sup.message; (*e_164971).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_164971, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_165647)(NU16 msg, NU8 eh, NimStringDesc* s) {
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			if (!LOC9) goto LA13;
			{
				...
				if (!(LOC17)) goto LA18;
				LOC17 = writelnhook_165057.ClPrc == 0;
				LA18: ;
				if (!LOC17) goto LA19;
...
appendString(LOC22, ((NimStringDesc*) &TMP428));
	...
	LA5: ;
	{
		...
		LA26: ;
		if (!LOC25) goto LA27;
		gerrorcounter_165012 += ((NI) 1);
		gexitcode_155129 = ((NI8) 1);
		{
			if (!(gerrormax_165015 <= gerrorcounter_165012)) goto LA31;
			{
				NIM_BOOL LOC35;
				NIM_BOOL LOC36;
				LOC35 = 0;
				...
				if (!LOC35) goto LA39;
				{
					...
					if (!(LOC43)) goto LA44;
					LOC43 = writelnhook_165057.ClPrc == 0;
					LA44: ;
					if (!LOC43) goto LA45;
					writestacktrace_16407();
				}
		...
		LA31: ;
		{
			...
			if (!LOC50) goto LA52;
			{
				...
				if (!LOC56) goto LA60;
				{
					...
					if (!(LOC64)) goto LA65;
					LOC64 = writelnhook_165057.ClPrc == 0;
					LA65: ;
					if (!LOC64) goto LA66;
					writestacktrace_16407();
				}
...
appendString(LOC69, ((NimStringDesc*) &TMP428));
		...
		LA52: ;
		{
			...
			raiserecoverableerror_164966(s);
		}
		goto LA29;
		LA71: ;
		LA29: ;
...
{	frmt = 0;
	...
	case ((NU16) 230) ... ((NU16) 260):
	{
		...
		LA6: ;
		{
			if (!!(((gnotes_165011 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
		LOC12 = unknownlineinfo_165024();
		writecontext_165800(LOC12);
		frmt = copyString(((NimStringDesc*) &TMP425));
		gwarncounter_165014 += ((NI) 1);
	}
	break;
	case ((NU16) 261) ... ((NU16) 277):
	{
		...
		LA16: ;
		{
			if (!!(((gnotes_165011 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
		frmt = copyString(((NimStringDesc*) &TMP426));
		ghintcounter_165013 += ((NI) 1);
	}
	break;
	}
	LOC22 = 0;
	LOC22 = msgkindtostring_165616(msg);
	LOC23 = 0;
	...
	s = nsuFormatSingleElem(frmt, LOC23);
	{
		NIM_BOOL LOC26;
		LOC26 = 0;
		LOC26 = ignoremsgbecauseofidetools_165850(msg);
		if (!!(LOC26)) goto LA27;
		msgwriteln_165536(s);
	}
	LA27: ;
	handleerror_165647(msg, ((NU8) 1), s);
	}BeforeRet: ;
}
...
{	{
	...
	LA3: ;
	LOC5 = unknownlineinfo_165024();
	writecontext_165800(LOC5);
	rawmessage_165960(((NU16) 2), errmsg);
	}BeforeRet: ;
}
...
N_NIMCALL(NimStringDesc*, tofullpath_165273)(NI32 fileidx) {
	...
	LA3: ;
	{
		result = copyString(fileinfos_164432->data[fileidx].fullpath);
	}
	LA1: ;
	return result;
}
...
N_NIMCALL(void, addsourceline_166254)(NI32 fileidx, NimStringDesc* line) {
	...
	fileinfos_164432->data[fileidx].lines = (TY164351*) incrSeq(&(fileinfos_164432->data[fileidx].lines)->Sup, sizeof(Ropeobj162009*));
	asgnRefNoCycle((void**) (&fileinfos_164432->data[fileidx].lines->data[fileinfos_164432->data[fileidx].lines->Sup.len-1]), LOC1);
}
...
{	result = 0;
	...
	LA3: ;
	{
		...
		if (!(LOC7)) goto LA8;
		LOC7 = ((fileinfos_164432->data[i.fileindex].lines ? fileinfos_164432->data[i.fileindex].lines->Sup.len : 0) == ((NI) 0));
		LA8: ;
		if (!LOC7) goto LA9;
		...
		if (TMP972.status == 0) {
			{
				NimStringDesc* line_166296;
				NimStringDesc* HEX3Atmp_166332;
				FILE* f_166335;
				NimStringDesc* res_166337;
				line_166296 = 0;
				HEX3Atmp_166332 = 0;
				HEX3Atmp_166332 = tofullpath_165273(i.fileindex);
				f_166335 = open_13217(HEX3Atmp_166332, ((NU8) 0), ((NI) 8000));
				res_166337 = rawNewString(((NI) 80));
				{
					while (1) {
						NIM_BOOL LOC15;
						LOC15 = 0;
						LOC15 = readline_13481(f_166335, (&res_166337));
						if (!LOC15) goto LA14;
						line_166296 = res_166337;
						addsourceline_166254(i.fileindex, line_166296);
					} LA14: ;
				}
				fclose(f_166335);
			}
	...
	{
		NimStringDesc* LOC22;
		if (!!((((NI) (i.fileindex)) < (fileinfos_164432 ? fileinfos_164432->Sup.len : 0)))) goto LA20;
		LOC22 = 0;
		LOC22 = HEX24_166306(TMP988);
		internalerror_166218(LOC22);
	}
	LA20: ;
	{
		if (!((fileinfos_164432->data[i.fileindex].lines ? fileinfos_164432->data[i.fileindex].lines->Sup.len : 0) < ((NI) (i.line)))) goto LA25;
		result = NIM_NIL;
		goto BeforeRet;
	}
	LA25: ;
	result = fileinfos_164432->data[i.fileindex].lines->data[(NI16)(i.line - ((NI16) 1))];
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, limessage_165997)(Tlineinfo164338 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 0) ... ((NU16) 229):
	{
		writecontext_165800(info);
		frmt = copyString(((NimStringDesc*) &TMP968));
		lasterror_165051 = info;
	}
	break;
	case ((NU16) 230) ... ((NU16) 260):
	{
		...
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_165011 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 261) ... ((NU16) 277):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_165011 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA11: ;
		ignoremsg = LOC10;
	...
	LOC12[1] = coordtostr_165606(((NI) (info.line)));
	LOC12[2] = coordtostr_165606(((NI) ((NI16)(info.col + ((NI16) 1)))));
	LOC12[3] = getmessagestr_165626(msg, arg);
	s = nsuFormatOpenArray(frmt, LOC12, 4);
	{
		...
		if (!(LOC15)) goto LA16;
		LOC17 = 0;
		LOC17 = ignoremsgbecauseofidetools_165850(msg);
		LOC15 = !(LOC17);
		LA16: ;
		if (!LOC15) goto LA18;
		msgwriteln_165536(s);
		{
			...
			if (!(LOC22)) goto LA23;
			LOC24 = HEX2EHEX2E_166067(((NU16) 0), ((NU16) 229));
			LOC22 = contains_166086(LOC24, msg);
			LA23: ;
			if (!LOC22) goto LA25;
			writesurroundingsrc_165972(info);
		}
		LA25: ;
	}
	LA18: ;
	handleerror_165647(msg, eh, s);
}
...
{	{
	...
	LA3: ;
	writecontext_165800(info);
	limessage_165997(info, ((NU16) 2), errmsg, ((NU8) 1));
	}BeforeRet: ;
}
...
N_NIMCALL(NimStringDesc*, tofullpathconsiderdirty_165407)(NI32 fileidx) {
	...
	LA3: ;
	{
		if (!!(fileinfos_164432->data[fileidx].dirtyfile == 0)) goto LA6;
		result = copyString(fileinfos_164432->data[fileidx].dirtyfile);
	}
	goto LA1;
	LA6: ;
	{
...
N_NIMCALL(void, message_166188)(Tlineinfo164338 info, NU16 msg, NimStringDesc* arg) {
	limessage_165997(info, msg, arg, ((NU8) 0));
}
...
N_NIMCALL(NI32, fileinfoidx_164533)(NimStringDesc* filename, NIM_BOOL* isknownfile) {
	...
	if (TMP1153.status == 0) {
		canon = canonicalizepath_155374(filename);
		shallow_88824((&canon));
		popSafePoint();
	}
	else {
	...
	if (TMP1153.status != 0) reraiseException();
	{
		NIM_BOOL LOC6;
		LOC6 = 0;
		LOC6 = haskey_164543(filenametoindextbl_164414, canon);
		if (!LOC6) goto LA7;
		result = HEX5BHEX5D_164586(filenametoindextbl_164414, canon);
	}
	goto LA4;
	LA7: ;
	{
		...
		result = ((NI32) ((fileinfos_164432 ? fileinfos_164432->Sup.len : 0)));
		LOC10 = 0;
		{
		...
		newfileinfo_164495(canon, LOC10, (&LOC16));
		fileinfos_164432 = (TY164415*) incrSeq(&(fileinfos_164432)->Sup, sizeof(Tfileinfo164336));
		genericAssign((void*)(&fileinfos_164432->data[fileinfos_164432->Sup.len-1]), (void*)(&LOC16), (&NTI164336));
		HEX5BHEX5DHEX3D_164635((&filenametoindextbl_164414), canon, result);
	}
	LA4: ;
	return result;
}
...
N_NIMCALL(NI32, fileinfoidx_164853)(NimStringDesc* filename) {
	...
	result = 0;
	dummy = 0;
	result = fileinfoidx_164533(filename, (&dummy));
	return result;
}
...
N_NIMCALL(NimStringDesc*, tofilename_165263)(NI32 fileidx) {
	...
	LA3: ;
	{
		result = copyString(fileinfos_164432->data[fileidx].projpath);
	}
	LA1: ;
	return result;
}
...
N_NIMCALL(void, localerror_166166)(Tlineinfo164338 info, NimStringDesc* arg) {
	limessage_165997(info, ((NU16) 4), arg, ((NU8) 0));
}
...
N_NIMCALL(void, setdirtyfile_165283)(NI32 fileidx, NimStringDesc* filename) {
	NimStringDesc* LOC1;
	LOC1 = 0;
	LOC1 = fileinfos_164432->data[fileidx].dirtyfile; fileinfos_164432->data[fileidx].dirtyfile = copyStringRC1(filename);
	if (LOC1) nimGCunrefNoCycle(LOC1);
}

N_NIMCALL(void, suggestwriteln_165066)(NimStringDesc* s) {
	{
		if (!((erroroutputs_165053 &(1<<((((NU8) 0))&7)))!=0)) goto LA3;
		{
			TY165566 LOC9;
			if (!writelnhook_165057.ClPrc == 0) goto LA7;
		...
		LA7: ;
		{
			writelnhook_165057.ClEnv? writelnhook_165057.ClPrc(s, writelnhook_165057.ClEnv):((TMP1967)(writelnhook_165057.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, globalerror_166134)(Tlineinfo164338 info, NU16 msg, NimStringDesc* arg) {
	limessage_165997(info, msg, arg, ((NU8) 2));
}

N_NIMCALL(void, pushinfocontext_165189)(Tlineinfo164338 info) {
	msgcontext_165050 = (TY165033*) incrSeq(&(msgcontext_165050)->Sup, sizeof(Tlineinfo164338));
	msgcontext_165050->data[msgcontext_165050->Sup.len-1] = info;
}

N_NIMCALL(void, popinfocontext_165208)(void) {
	msgcontext_165050 = (TY165033*) setLengthSeq(&(msgcontext_165050)->Sup, sizeof(Tlineinfo164338), ((NI) ((NI)((msgcontext_165050 ? msgcontext_165050->Sup.len : 0) - ((NI) 1)))));
}
N_NIMCALL(void, TMP2666)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_165122)(void) {
	Esuggestdone164346* e_165126;
	NimStringDesc* LOC1;
	e_165126 = 0;
	e_165126 = (Esuggestdone164346*) newObj((&NTI165127), sizeof(Esuggestdone164346));
	(*e_165126).Sup.Sup.m_type = (&NTI164346);
	LOC1 = 0;
	LOC1 = (*e_165126).Sup.message; (*e_165126).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2667));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_165126, "ESuggestDone");
}

N_NIMCALL(void, globalerror_166145)(Tlineinfo164338 info, NimStringDesc* arg) {
	limessage_165997(info, ((NU16) 4), arg, ((NU8) 2));
}
...
N_NIMCALL(NimStringDesc*, formatmsg_165982)(Tlineinfo164338 info, NU16 msg, NimStringDesc* arg) {
	...
	LOC4[1] = coordtostr_165606(((NI) (info.line)));
	LOC4[2] = coordtostr_165606(((NI) ((NI16)(info.col + ((NI16) 1)))));
	LOC4[3] = getmessagestr_165626(msg, arg);
	result = nsuFormatOpenArray(frmt, LOC4, 4);
	return result;
}

N_NIMCALL(void, fatal_166123)(Tlineinfo164338 info, NU16 msg, NimStringDesc* arg) {
	limessage_165997(info, msg, arg, ((NU8) 1));
}
...
N_NIMCALL(Tlineinfo164338, getinfocontext_165234)(NI index) {
	...
	NI i;
	memset((void*)(&result), 0, sizeof(result));
	L = (msgcontext_165050 ? msgcontext_165050->Sup.len : 0);
	{
	...
	LA1: ;
	{
		...
		result = unknownlineinfo_165024();
	}
	goto LA6;
	LA8: ;
	{
		result = msgcontext_165050->data[i];
	}
	LA6: ;
	return result;
}
...
N_NIMCALL(NI, getinfocontextlen_165153)(void) {
	NI result;
{	result = 0;
	result = (msgcontext_165050 ? msgcontext_165050->Sup.len : 0);
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setinfocontextlen_165170)(NI L) {
	msgcontext_165050 = (TY165033*) setLengthSeq(&(msgcontext_165050)->Sup, sizeof(Tlineinfo164338), ((NI) (L)));
}
...
N_NIMCALL(Ropeobj162009*, quotedfilename_166354)(Tlineinfo164338 i) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = HEX24_166306(TMP3746);
		internalerror_166218(LOC5);
	}
	LA3: ;
	result = fileinfos_164432->data[i.fileindex].quotedname;
	return result;
}
...
NIM_EXTERNC N_NOINLINE(void, nimsrc_msgsInit)(void) {
	...
	if (fileinfos_164432) nimGCunrefNoCycle(fileinfos_164432);
	fileinfos_164432 = (TY164415*) newSeqRC1((&NTI164415), 0);
	memset((void*)(&LOC1), 0, sizeof(LOC1));
	newfileinfo_164495(((NimStringDesc*) &TMP137), ((NimStringDesc*) &TMP139), (&LOC1));
	fileinfos_164432 = (TY164415*) incrSeq(&(fileinfos_164432)->Sup, sizeof(Tfileinfo164336));
	genericAssign((void*)(&fileinfos_164432->data[fileinfos_164432->Sup.len-1]), (void*)(&LOC1), (&NTI164336));
	gcmdlineinfo_164921 = newlineinfo_164866(((NI32) 0), ((NI) 1), ((NI) 1));
	memset((void*)(&LOC2), 0, sizeof(LOC2));
	newfileinfo_164495(((NimStringDesc*) &TMP137), ((NimStringDesc*) &TMP140), (&LOC2));
	fileinfos_164432 = (TY164415*) incrSeq(&(fileinfos_164432)->Sup, sizeof(Tfileinfo164336));
	genericAssign((void*)(&fileinfos_164432->data[fileinfos_164432->Sup.len-1]), (void*)(&LOC2), (&NTI164336));
	gcodegenlineinfo_164959 = newlineinfo_164866(((NI32) 1), ((NI) 1), ((NI) 1));
	gnotes_165011 = IL64(281474927951871);
	gerrorcounter_165012 = ((NI) 0);
	ghintcounter_165013 = ((NI) 0);
	gwarncounter_165014 = ((NI) 0);
	gerrormax_165015 = ((NI) 1);
	if (msgcontext_165050) nimGCunrefNoCycle(msgcontext_165050);
	msgcontext_165050 = (TY165033*) newSeqRC1((&NTI165033), 0);
	lasterror_165051 = unknownlineinfo_165024();
	erroroutputs_165053 = 3;
	memset((void*)(&LOC3), 0, sizeof(LOC3));
	LOC3.ClPrc = ((TMP431) (HEX3Aanonymous_166371)); LOC3.ClEnv = NIM_NIL;
...
NTI165033.size = sizeof(TY165033*);
NTI165033.kind = 24;
NTI165033.base = (&NTI164338);
NTI165033.flags = 2;
NTI165033.marker = TMP142;
NTI164344.size = sizeof(Erecoverableerror164344);
NTI164344.kind = 17;
NTI164344.base = (&NTI3449);
TMP21[11].len = 0; TMP21[11].kind = 2;
NTI164344.node = &TMP21[11];
NTI164972.size = sizeof(Erecoverableerror164344*);
NTI164972.kind = 22;
NTI164972.base = (&NTI164344);
NTI164972.marker = TMP429;
...
NTI165127.size = sizeof(Esuggestdone164346*);
NTI165127.kind = 22;
NTI165127.base = (&NTI164346);
NTI165127.marker = TMP2666;
}
