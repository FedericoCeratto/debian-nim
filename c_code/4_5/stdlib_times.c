...
N_NIMCALL(void, tmtotimeinfo_101848)(struct tm* tm, NIM_BOOL local, timeinfo101205* Result) {
	...
	LA4: ;
	{
		LOC1.Tzname = copyString(((NimStringDesc*) &TMP3097));
	}
	LA2: ;
	{
		if (!local) goto LA16;
...
static TNimNode* TMP3091[12];
NI TMP3093;
static char* NIM_CONST TMP3092[12] = {
"mJan", 
"mFeb", 
"mMar", 
"mApr", 
...
"mNov", 
"mDec"};
static TNimNode* TMP3094[7];
NI TMP3096;
static char* NIM_CONST TMP3095[7] = {
"dMon", 
"dTue", 
"dWed", 
"dThu", 
...
NTI101006.base = 0;
NTI101006.flags = 3;
for (TMP3093 = 0; TMP3093 < 12; TMP3093++) {
TMP15[TMP3093+6].kind = 1;
TMP15[TMP3093+6].offset = TMP3093;
TMP15[TMP3093+6].name = TMP3092[TMP3093];
TMP3091[TMP3093] = &TMP15[TMP3093+6];
}
TMP15[18].len = 12; TMP15[18].kind = 2; TMP15[18].sons = &TMP3091[0];
...
NTI101008.base = 0;
NTI101008.flags = 3;
for (TMP3096 = 0; TMP3096 < 7; TMP3096++) {
TMP15[TMP3096+21].kind = 1;
TMP15[TMP3096+21].offset = TMP3096;
TMP15[TMP3096+21].name = TMP3095[TMP3096];
TMP3094[TMP3096] = &TMP15[TMP3096+21];
}
TMP15[28].len = 7; TMP15[28].kind = 2; TMP15[28].sons = &TMP3094[0];
...
TMP15[0].len = 11; TMP15[0].kind = 2; TMP15[0].sons = &TMP3090[0];
