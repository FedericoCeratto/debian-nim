...
N_NIMCALL(void, strtableenlarge_241628)(tstrtable226820* t) {
	...
	tsymseq226818* LOC8;
	n = 0;
	n = (tsymseq226818*) newSeq((&NTI226818), (NI32)((*t).Data->Sup.len * 2));
	{
		NI i_241672;
		NI HEX3Atmp_241708;
		NI res_241711;
	...
	unsureAsgnRef((void**) (&(*x).Data), (tiipairseq236272*) newSeq((&NTI236272), 8));
	{
		...
		res_244231 = 0;
		{
			while (1) {
				...
				i_244227 = res_244231;
				(*x).Data->data[i_244227].Key = (-2147483647 -1);
				res_244231 += 1;
			} LA3: ;
		}
	}
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = 0;
			n = (tiipairseq236272*) newSeq((&NTI236272), (NI32)((*t).Data->Sup.len * 2));
			{
				NI i_244852;
				NI HEX3Atmp_244897;
				NI res_244900;
				...
				res_244900 = 0;
				{
					while (1) {
						...
						i_244852 = res_244900;
						n->data[i_244852].Key = (-2147483647 -1);
						res_244900 += 1;
					} LA13: ;
				}
			}
			{
				...
				res_244906 = 0;
				{
					while (1) {
						...
						i_244865 = res_244906;
						{
							if (!!(((*t).Data->data[i_244865].Key == (-2147483647 -1)))) goto LA19;
	...
	{
		{
			...
			LOC8 = mustrehash_236249((*t).Data->Sup.len, (*t).Counter);
			if (!LOC8) goto LA9;
			n = (tidpairseq226862*) newSeq((&NTI226862), (NI32)((*t).Data->Sup.len * 2));
			{
				NI i_243251;
				NI HEX3Atmp_243432;
				NI res_243435;
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = 0;
			n = (tidnodepairseq226868*) newSeq((&NTI226868), (NI32)((*t).Data->Sup.len * 2));
			{
				NI i_244052;
				NI HEX3Atmp_244101;
				NI res_244104;
