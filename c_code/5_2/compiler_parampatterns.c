...
NIM_CONST TY90959 TMP3268 = {((NimStringDesc*) &TMP3269),
((NI) 100)}
;
NIM_CONST TY90959 TMP3270 = {((NimStringDesc*) &TMP3269),
((NI) 107)}
;
...
N_NIMCALL(Tnode224809*, semnodekindconstraints_304679)(Tnode224809* p) {
	...
	(*result).kindU.S3.strval = addChar((*result).kindU.S3.strval, 1);
	{
		...
		}
		{
			...
			internalerror_195172((*p).info, ((NimStringDesc*) &TMP3271));
		}
		LA12: ;
	}
	goto LA1;
