...
{	{
	...
	LA4: ;
	{
		...
		processcmdline_574209(((NU8) 0), ((NimStringDesc*) &TMP1992));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_166234, ((NimStringDesc*) &TMP1993))) goto LA9;
			LOC11 = 0;
			LOC11 = gprojectname_166234; gprojectname_166234 = copyStringRC1(((NimStringDesc*) &TMP1994));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = 0;
			LOC12 = gprojectfull_166236; gprojectfull_166236 = copyStringRC1(((NimStringDesc*) &TMP1994));
		...
		LA7: ;
		loadconfigs_220609(((NimStringDesc*) &TMP2022));
		scriptfile = noschangeFileExt(gprojectfull_166236, ((NimStringDesc*) &TMP2023));
		{
			NIM_BOOL LOC25;
			LOC25 = 0;
			LOC25 = fileexists_127010(scriptfile);
			if (!LOC25) goto LA26;
			runnimscript_580328(scriptfile);
			{
		...
		LA26: ;
		{
			...
			NimStringDesc* LOC37;
			LOC33 = 0;
			LOC33 = HEX2F_123481(gprojectpath_166235, ((NimStringDesc*) &TMP3708));
			LOC34 = 0;
			LOC34 = fileexists_127010(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = 0;
			LOC37 = HEX2F_123481(gprojectpath_166235, ((NimStringDesc*) &TMP3708));
			runnimscript_580328(LOC37);
		}
		goto LA23;
		LA35: ;
		LA23: ;
		initvars_203076();
		processcmdline_574209(((NU8) 1), ((NimStringDesc*) &TMP1992));
		{
			...
			if (!(gerrorcounter_190396 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_166132 &(1<<((((NU8) 13))&31)))!=0)) goto LA55;
				{
					...
					LA63: ;
					{
						...
						NimStringDesc* LOC69;
						LOC67 = 0;
						LOC67 = noschangeFileExt(gprojectfull_166236, ((NimStringDesc*) &TMP5292));
						LOC68 = 0;
...
appendString(LOC70, arguments_211837);
				...
				LA59: ;
				{
					...
					LA75: ;
					{
						NimStringDesc* LOC78;
						LOC78 = 0;
						LOC78 = noschangeFileExt(gprojectfull_166236, ((NimStringDesc*) &TMP1992));
