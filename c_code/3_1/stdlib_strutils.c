...
STRING_LITERAL(TMP1213, "0123456789ABCDEF", 16);
STRING_LITERAL(TMP1215, "", 0);
static NIM_CONST TY211607 TMP1562 = {
0x00, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2103, "\\x", 2);
...
101}
;
STRING_LITERAL(TMP4872, "GB", 2);
STRING_LITERAL(TMP4873, "MB", 2);
STRING_LITERAL(TMP4874, "KB", 2);
STRING_LITERAL(TMP4875, "B", 1);
	...
	result = mnewString(len);
	{
		...
		res_95595 = HEX3Atmp_95592;
		{
			while (1) {
				...
				j_95588 = res_95595;
				result->data[j_95588] = ((NimStringDesc*) &TMP1213)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(x) >> (NU64)(shift)))) & ((NI32) 15))];
...
N_NIMCALL(NI, nsuParseInt)(NimStringDesc* s) {
	...
	l = npuParseInt(s, (&result), 0);
	{
		...
		if (!LOC3) goto LA5;
		e_95657 = 0;
		e_95657 = (valueerror3249*) newObj((&NTI21601), sizeof(valueerror3249));
...
N_NIMCALL(NimStringDesc*, quoteifcontainswhite_97234)(NimStringDesc* s) {
	...
	result = 0;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = nsuFindCharSet(s, TMP1562, 0);
		LOC3 = (0 <= LOC4);
		if (!(LOC3)) goto LA5;
...
appendString(LOC5, ((NimStringDesc*) &TMP4872));
		result = LOC5;
	}
	goto LA1;
	LA3: ;
...
appendString(LOC12, ((NimStringDesc*) &TMP4873));
		result = LOC12;
	}
	goto LA1;
	LA10: ;
...
appendString(LOC19, ((NimStringDesc*) &TMP4874));
		result = LOC19;
	}
	goto LA1;
	LA17: ;
...
appendString(LOC24, ((NimStringDesc*) &TMP4875));
		result = LOC24;
	}
	LA1: ;
	return result;
