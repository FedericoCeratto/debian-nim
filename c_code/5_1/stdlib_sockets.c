...
STRING_LITERAL(TMP1981, "This function cannot be used on non-blocking sockets.", 53);
STRING_LITERAL(TMP1982, "Could not send all data.", 24);
TNimNode* NimDT_182607_isbuffered[3];
STRING_LITERAL(TMP4867, "", 0);
STRING_LITERAL(TMP4869, "Call to \'", 9);
STRING_LITERAL(TMP4870, "\' timed out.", 12);
STRING_LITERAL(TMP4872, "readLine", 8);
...
N_NIMCALL(void, send_193008)(tsocketimpl182607* socket, NimStringDesc* data) {
	NI sent;
	{
		...
		e_193014 = 0;
		e_193014 = (valueerror3249*) newObj((&NTI21401), sizeof(valueerror3249));
		(*e_193014).Sup.Sup.m_type = (&NTI3249);
		LOC5 = 0;
		LOC5 = (*e_193014).Sup.message; (*e_193014).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1981));
	...
	LA8: ;
	{
		...
		e_193203 = 0;
		e_193203 = (oserror3233*) newObj((&NTI114812), sizeof(oserror3233));
		(*e_193203).Sup.Sup.Sup.m_type = (&NTI3233);
		LOC15 = 0;
		LOC15 = (*e_193203).Sup.Sup.message; (*e_193203).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1982));
...
N_NIMCALL(void, acceptaddr_185248)(tsocketimpl182607* server, tsocketimpl182607** client, NimStringDesc** address) {
	...
	sock_185260 = accept((*server).Fd, ((struct sockaddr*) ((&sockaddress_185256))), (&addrlen_185258));
	{
		...
		err_185262 = oslasterror_114841();
		{
			...
			unsureAsgnRef((void**) (&(*address)), copyString(((NimStringDesc*) &TMP4867)));
			goto BeforeRet;
		}
		goto LA5;
		LA9: ;
...
N_NIMCALL(void, accept_186401)(tsocketimpl182607* server, tsocketimpl182607** client) {
	...
	addrdummy = copyString(((NimStringDesc*) &TMP4867));
...
N_NIMCALL(void, readline_191447)(tsocketimpl182607* socket, NimStringDesc** line, NI timeout) {
	...
	(*line) = setLengthStr((*line), 0);
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_190618(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4872));
			...
			LA4: ;
			{
				...
				LOC15 = 0;
				LOC15 = waitfor_190618(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4872));
...
appendString((*line), ((NimStringDesc*) &TMP4873));
				}
				LA28: ;
				goto BeforeRet;
			}
...
TMP126[3].len = 3; TMP126[3].kind = 2; TMP126[3].sons = &TMP4863[0];
