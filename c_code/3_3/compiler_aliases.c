...
STRING_LITERAL(TMP3322, "isPartOfAux(record case branch)", 31);
STRING_LITERAL(TMP3323, "isPartOfAux()", 13);
...
{	result = 0;
		...
		LA13: ;
		{
			...
			res_447249 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_196191(((NimStringDesc*) &TMP3322));
					}
					break;
					}
					res_447249 += ((NI) 1);
	...
	default:
	{
		internalerror_196172((*n).info, ((NimStringDesc*) &TMP3323));
	}
	break;
	}
	}BeforeRet: ;
