...
N_NIMCALL(NI, rawget_144618)(Stringtableobj144212* t, NimStringDesc* key);
N_NIMCALL(NI, myhash_144377)(Stringtableobj144212* t, NimStringDesc* key);
...
N_NIMCALL(NIM_BOOL, mycmp_144390)(Stringtableobj144212* t, NimStringDesc* a, NimStringDesc* b);
...
static N_INLINE(NI, nexttry_144607)(NI h, NI maxhash);
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src);
N_NIMCALL(NimStringDesc*, rawNewString)(NI space);
static N_INLINE(void, asgnRefNoCycle)(void** dest, void* src);
N_NIMCALL(void, raiseException)(Exception* e, NCSTRING ename);
N_NIMCALL(NimStringDesc*, copyStringRC1)(NimStringDesc* src);
N_NIMCALL(NIM_BOOL, mustrehash_144402)(NI length, NI counter);
N_NIMCALL(void, enlarge_145065)(Stringtableobj144212* t);
N_NIMCALL(void*, newSeq)(TNimType* typ, NI len);
N_NIMCALL(void, rawinsert_145043)(Stringtableobj144212* t, Keyvaluepairseq144210** data, NimStringDesc* key, NimStringDesc* val);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_NIMCALL(NimStringDesc*, getvalue_145185)(Stringtableobj144212* t, NU8 flags, NimStringDesc* key);
...
N_NIMCALL(void, raiseformatexception_145165)(NimStringDesc* s);
N_NIMCALL(NimStringDesc*, copyStrLast)(NimStringDesc* s, NI start_81016, NI last);
N_NIMCALL(NimStringDesc*, copyStrLast)(NimStringDesc* s, NI first, NI last);
N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen);
STRING_LITERAL(TMP1521, "key not found: ", 15);
STRING_LITERAL(TMP1763, "", 0);
STRING_LITERAL(TMP2005, "format string: key not found: ", 30);
extern TNimType NTI4011; /* RootObj */
TNimType NTI144212; /* StringTableObj */
extern TNimType NTI108; /* int */
TNimType NTI144208; /* KeyValuePair */
extern TNimType NTI149; /* string */
TNimType NTI144210; /* KeyValuePairSeq */
TNimType NTI144206; /* StringTableMode */
TNimType NTI144214; /* StringTableRef */
...
N_NIMCALL(void, TMP44)(void* p, NI op) {
	Keyvaluepairseq144210* a;
	NI LOC1;
	a = (Keyvaluepairseq144210*)p;
	LOC1 = 0;
...
N_NIMCALL(void, TMP48)(void* p, NI op) {
	Stringtableobj144212* a;
	a = (Stringtableobj144212*)p;
...
N_NIMCALL(Stringtableobj144212*, nstnewStringTable)(NU8 mode) {
	...
	result = 0;
	result = (Stringtableobj144212*) newObj((&NTI144214), sizeof(Stringtableobj144212));
	(*result).Sup.m_type = (&NTI144212);
	(*result).mode = mode;
	(*result).counter = ((NI) 0);
	if ((*result).data) nimGCunrefNoCycle((*result).data);
	(*result).data = (Keyvaluepairseq144210*) newSeqRC1((&NTI144210), ((NI) 64));
	return result;
}
...
N_NIMCALL(NI, myhash_144377)(Stringtableobj144212* t, NimStringDesc* key) {
	...
	case ((NU8) 0):
	{
		result = hash_141848(key);
	}
	break;
	case ((NU8) 1):
	{
		result = hashignorecase_142136(key);
	}
	break;
	case ((NU8) 2):
	{
		result = hashignorestyle_141945(key);
	}
	break;
	}
	return result;
	...
	h = (NI)(LOC1 & ((*t).data ? ((*t).data->Sup.len-1) : -1));
	{
		while (1) {
			if (!!((*t).data->data[h].Field0 == 0)) goto LA3;
			{
				NIM_BOOL LOC6;
				LOC6 = 0;
				LOC6 = mycmp_144390(t, (*t).data->data[h].Field0, key);
				if (!LOC6) goto LA7;
				result = h;
				goto BeforeRet;
			}
			LA7: ;
			h = nexttry_144607(h, ((*t).data ? ((*t).data->Sup.len-1) : -1));
		} LA3: ;
	}
	result = ((NI) -1);
	}BeforeRet: ;
...
N_NIMCALL(NimStringDesc**, nstTake)(Stringtableobj144212* t, NimStringDesc* key) {
	...
	NI index_144659;
	result = 0;
	index_144659 = rawget_144618(t, key);
	{
		if (!(((NI) 0) <= index_144659)) goto LA3;
		result = (&(*t).data->data[index_144659].Field1);
	}
	goto LA1;
	LA3: ;
	{
		Keyerror4051* e_144803;
		NimStringDesc* LOC6;
		e_144803 = 0;
		e_144803 = (Keyerror4051*) newObj((&NTI189004), sizeof(Keyerror4051));
		(*e_144803).Sup.Sup.Sup.m_type = (&NTI4051);
		LOC6 = 0;
		LOC6 = rawNewString(key->Sup.len + 15);
appendString(LOC6, ((NimStringDesc*) &TMP1521));
appendString(LOC6, key);
		asgnRefNoCycle((void**) (&(*e_144803).Sup.Sup.message), LOC6);
		raiseException((Exception*)e_144803, "KeyError");
	}
	LA1: ;
	return result;
}
...
N_NIMCALL(void, enlarge_145065)(Stringtableobj144212* t) {
	Keyvaluepairseq144210* n;
	Keyvaluepairseq144210* LOC8;
	n = 0;
	n = (Keyvaluepairseq144210*) newSeq((&NTI144210), ((NI) ((NI)(((*t).data ? (*t).data->Sup.len : 0) * ((NI) 2)))));
	{
		NI i_145099;
		NI HEX3Atmp_145113;
		NI res_145116;
		i_145099 = 0;
		HEX3Atmp_145113 = 0;
		HEX3Atmp_145113 = ((*t).data ? ((*t).data->Sup.len-1) : -1);
		res_145116 = ((NI) 0);
		{
			while (1) {
				if (!(res_145116 <= HEX3Atmp_145113)) goto LA3;
				i_145099 = res_145116;
				{
					if (!!((*t).data->data[i_145099].Field0 == 0)) goto LA6;
					rawinsert_145043(t, (&n), (*t).data->data[i_145099].Field0, (*t).data->data[i_145099].Field1);
				}
				LA6: ;
				res_145116 += ((NI) 1);
			} LA3: ;
	...
	{
		{
			NIM_BOOL LOC9;
			LOC9 = 0;
			LOC9 = mustrehash_144402(((*t).data ? (*t).data->Sup.len : 0), (*t).counter);
			if (!LOC9) goto LA10;
			enlarge_145065(t);
		}
		LA10: ;
		rawinsert_145043(t, (&(*t).data), key, val);
		(*t).counter += ((NI) 1);
	}
	LA1: ;
}
...
appendString(LOC1, ((NimStringDesc*) &TMP2005));
appendString(LOC1, s);
...
{	result = 0;
	{
		...
		if (!LOC3) goto LA4;
		result = getordefault_145020(t, key);
		goto BeforeRet;
	}
	LA4: ;
	{
		if (!((flags &(1<<((((NU8) 0))&7)))!=0)) goto LA8;
		result = getenv_130044(key);
	}
	goto LA6;
	LA8: ;
	{
...
appendString(LOC19, key);
		...
		LA17: ;
		{
			...
			raiseformatexception_145165(key);
		}
		goto LA15;
		LA21: ;
		LA15: ;
		...
		while (1) {
			if (!(i < (f ? f->Sup.len : 0))) goto LA2;
			{
				...
				case 123:
				{
					...
					LOC14 = 0;
					LOC14 = getvalue_145185(t, flags, LOC13);
...
appendString(result, LOC14);
				...
				case 95:
				{
					...
					LOC21 = 0;
					LOC21 = getvalue_145185(t, flags, LOC20);
...
NTI144212.size = sizeof(Stringtableobj144212);
NTI144212.kind = 17;
NTI144212.base = (&NTI4011);
TMP42[0] = &TMP25[1];
TMP25[1].kind = 1;
TMP25[1].offset = offsetof(Stringtableobj144212, counter);
TMP25[1].typ = (&NTI108);
TMP25[1].name = "counter";
TMP42[1] = &TMP25[2];
NTI144208.size = sizeof(Keyvaluepair144208);
NTI144208.kind = 18;
NTI144208.base = 0;
NTI144208.flags = 2;
TMP43[0] = &TMP25[4];
TMP25[4].kind = 1;
TMP25[4].offset = offsetof(Keyvaluepair144208, Field0);
TMP25[4].typ = (&NTI149);
TMP25[4].name = "Field0";
TMP43[1] = &TMP25[5];
TMP25[5].kind = 1;
TMP25[5].offset = offsetof(Keyvaluepair144208, Field1);
TMP25[5].typ = (&NTI149);
TMP25[5].name = "Field1";
TMP25[3].len = 2; TMP25[3].kind = 2; TMP25[3].sons = &TMP43[0];
NTI144208.node = &TMP25[3];
NTI144210.size = sizeof(Keyvaluepairseq144210*);
NTI144210.kind = 24;
NTI144210.base = (&NTI144208);
NTI144210.flags = 2;
NTI144210.marker = TMP44;
TMP25[2].kind = 1;
TMP25[2].offset = offsetof(Stringtableobj144212, data);
TMP25[2].typ = (&NTI144210);
TMP25[2].name = "data";
TMP42[2] = &TMP25[6];
NTI144206.size = sizeof(NU8);
NTI144206.kind = 14;
NTI144206.base = 0;
NTI144206.flags = 3;
...
NTI144206.node = &TMP25[10];
TMP25[6].kind = 1;
TMP25[6].offset = offsetof(Stringtableobj144212, mode);
TMP25[6].typ = (&NTI144206);
TMP25[6].name = "mode";
TMP25[0].len = 3; TMP25[0].kind = 2; TMP25[0].sons = &TMP42[0];
NTI144212.node = &TMP25[0];
NTI144214.size = sizeof(Stringtableobj144212*);
NTI144214.kind = 22;
NTI144214.base = (&NTI144212);
NTI144214.marker = TMP48;
}
