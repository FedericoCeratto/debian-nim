	...
	num = ((NI) 0);
	{
		while (1) {
			...
			if (!(i < length)) goto LA2;
			{
				...
				case 36:
				{
					add_161545(&result, ((NimStringDesc*) &TMP3493));
					i += ((NI) 1);
				}
				break;
				case 35:
				...
				case 48 ... 57:
				{
					...
					num = j;
					{
						...
						LOC20 = 0;
						LOC20 = nimIntToStr(j);
						errorhandler_161028.ClEnv? errorhandler_161028.ClPrc(((NU8) 1), LOC20, NIM_FALSE, errorhandler_161028.ClEnv):((TMP3494)(errorhandler_161028.ClPrc))(((NU8) 1), LOC20, NIM_FALSE);
					}
					goto LA16;
					LA18: ;
					{
				...
				case 123:
				{
					...
					LA27: ;
					{
						...
						errorhandler_161028.ClEnv? errorhandler_161028.ClPrc(((NU8) 1), LOC30, NIM_FALSE, errorhandler_161028.ClEnv):((TMP3495)(errorhandler_161028.ClPrc))(((NU8) 1), LOC30, NIM_FALSE);
					}
					LA25: ;
					{
						NimStringDesc* LOC35;
						...
						LOC35 = 0;
						LOC35 = nimIntToStr(j);
						errorhandler_161028.ClEnv? errorhandler_161028.ClPrc(((NU8) 1), LOC35, NIM_FALSE, errorhandler_161028.ClEnv):((TMP3496)(errorhandler_161028.ClPrc))(((NU8) 1), LOC35, NIM_FALSE);
					}
					goto LA31;
					LA33: ;
					{
				...
				default:
				{
					...
					errorhandler_161028.ClEnv? errorhandler_161028.ClPrc(((NU8) 1), LOC40, NIM_FALSE, errorhandler_161028.ClEnv):((TMP3497)(errorhandler_161028.ClPrc))(((NU8) 1), LOC40, NIM_FALSE);
				}
				break;
				}
			}
