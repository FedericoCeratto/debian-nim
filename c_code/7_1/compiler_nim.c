...
N_NIMCALL(void, handlecmdline_580607)(void);
...
N_NIMCALL(NimStringDesc*, prependcurdir_580401)(NimStringDesc* f);
...
N_NIMCALL(NimStringDesc*, findnodejs_578009)(void);
...
STRING_LITERAL(TMP1994, "stdinfile", 9);
STRING_LITERAL(TMP2022, "nim.cfg", 7);
STRING_LITERAL(TMP2023, "nims", 4);
STRING_LITERAL(TMP3708, "config.nims", 11);
STRING_LITERAL(TMP5291, "./", 2);
STRING_LITERAL(TMP5292, "js", 2);
...
appendString(LOC7, ((NimStringDesc*) &TMP5291));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
{	{
	...
	LA4: ;
	{
		...
		processcmdline_573209(((NU8) 0), ((NimStringDesc*) &TMP1992));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_165234, ((NimStringDesc*) &TMP1993))) goto LA9;
			LOC11 = 0;
			LOC11 = gprojectname_165234; gprojectname_165234 = copyStringRC1(((NimStringDesc*) &TMP1994));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = 0;
			LOC12 = gprojectfull_165236; gprojectfull_165236 = copyStringRC1(((NimStringDesc*) &TMP1994));
			if (LOC12) nimGCunrefNoCycle(LOC12);
			asgnRefNoCycle((void**) (&gprojectpath_165235), nosgetCurrentDir());
			gprojectisstdin_165237 = NIM_TRUE;
		}
		goto LA7;
		LA9: ;
		{
			...
			NimStringDesc* LOC20;
			NimStringDesc* LOC21;
			if (!!(((gprojectname_165234) && (gprojectname_165234)->Sup.len == 0))) goto LA14;
			pushSafePoint(&TMP1995);
			TMP1995.status = _setjmp(TMP1995.context);
			if (TMP1995.status == 0) {
				asgnRefNoCycle((void**) (&gprojectfull_165236), canonicalizepath_165409(gprojectname_165234));
				popSafePoint();
			}
			else {
				popSafePoint();
				if (isObj(getCurrentException()->Sup.m_type, (&NTI4033))) {
					...
					TMP1995.status = 0;
					LOC19 = 0;
					LOC19 = gprojectfull_165236; gprojectfull_165236 = copyStringRC1(gprojectname_165234);
					if (LOC19) nimGCunrefNoCycle(LOC19);
					popCurrentException();
				}
			}
			if (TMP1995.status != 0) reraiseException();
			memset((void*)(&p), 0, sizeof(p));
			chckNil((void*)(&p));
			memset((void*)(&p), 0, sizeof(p));
			nossplitFile(gprojectfull_165236, (&p));
			LOC20 = 0;
			LOC20 = gprojectpath_165235; gprojectpath_165235 = copyStringRC1(p.Field0);
			if (LOC20) nimGCunrefNoCycle(LOC20);
			LOC21 = 0;
			LOC21 = gprojectname_165234; gprojectname_165234 = copyStringRC1(p.Field1);
		...
		LA7: ;
		loadconfigs_219609(((NimStringDesc*) &TMP2022));
		scriptfile = noschangeFileExt(gprojectfull_165236, ((NimStringDesc*) &TMP2023));
		{
			NIM_BOOL LOC25;
			LOC25 = 0;
			LOC25 = fileexists_126010(scriptfile);
			if (!LOC25) goto LA26;
			runnimscript_579327(scriptfile);
			{
				if (!eqStrings(scriptfile, gprojectfull_165236)) goto LA30;
				goto BeforeRet;
			}
			LA30: ;
		}
		...
		LA26: ;
		{
			...
			NimStringDesc* LOC37;
			LOC33 = 0;
			LOC33 = HEX2F_122481(gprojectpath_165235, ((NimStringDesc*) &TMP3708));
			LOC34 = 0;
			LOC34 = fileexists_126010(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = 0;
			LOC37 = HEX2F_122481(gprojectpath_165235, ((NimStringDesc*) &TMP3708));
			runnimscript_579327(LOC37);
		}
		goto LA23;
		LA35: ;
		LA23: ;
		initvars_202076();
		processcmdline_573209(((NU8) 1), ((NimStringDesc*) &TMP1992));
		{
			if (!((command_165240) && (command_165240)->Sup.len == 0)) goto LA40;
			rawmessage_192636(((NU16) 184), command_165240);
		}
		LA40: ;
		maincommand_576628();
		{
			...
			NimStringDesc* LOC48;
			LOC44 = 0;
			LOC44 = ((goptions_165130 &(1<<((((NU8) 12))&31)))!=0);
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_189398 &(IL64(1)<<(((((NU16) 289)- 237))&IL64(63))))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
			LOC48 = 0;
		...
		LA46: ;
		{
			if (!(gerrorcounter_189399 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_165132 &(1<<((((NU8) 13))&31)))!=0)) goto LA55;
				{
					NimStringDesc* ex;
					NimStringDesc* LOC70;
					NimStringDesc* LOC71;
					if (!(gcmd_165134 == ((NU8) 4))) goto LA59;
					ex = 0;
					{
						NimStringDesc* LOC65;
						if (!(((NI) 0) < (outfile_165138 ? outfile_165138->Sup.len : 0))) goto LA63;
						LOC65 = 0;
						LOC65 = prependcurdir_580401(outfile_165138);
					...
					LA63: ;
					{
						...
						NimStringDesc* LOC69;
						LOC67 = 0;
						LOC67 = noschangeFileExt(gprojectfull_165236, ((NimStringDesc*) &TMP5292));
						LOC68 = 0;
						LOC68 = prependcurdir_580401(LOC67);
						LOC69 = 0;
						LOC69 = completecfilepath_202112(LOC68, NIM_TRUE);
						ex = nospquoteShell(LOC69);
					}
					LA61: ;
					LOC70 = 0;
					LOC71 = 0;
					LOC71 = findnodejs_578009();
					LOC70 = rawNewString(LOC71->Sup.len + ex->Sup.len + arguments_210837->Sup.len + 2);
appendString(LOC70, LOC71);
appendString(LOC70, ((NimStringDesc*) &TMP5296));
appendString(LOC70, ex);
appendChar(LOC70, 32);
appendString(LOC70, arguments_210837);
					execexternalprogram_202175(LOC70, ((NU16) 284));
				}
				goto LA57;
				LA59: ;
				{
					...
					binpath = 0;
					{
						if (!(((NI) 0) < (outfile_165138 ? outfile_165138->Sup.len : 0))) goto LA75;
						binpath = prependcurdir_580401(outfile_165138);
					}
					goto LA73;
					LA75: ;
					{
						NimStringDesc* LOC78;
						LOC78 = 0;
						LOC78 = noschangeFileExt(gprojectfull_165236, ((NimStringDesc*) &TMP1992));
						binpath = prependcurdir_580401(LOC78);
					}
					LA73: ;
					ex = nospquoteShell(binpath);
					LOC79 = 0;
					LOC79 = rawNewString(ex->Sup.len + arguments_210837->Sup.len + 1);
appendString(LOC79, ex);
appendChar(LOC79, 32);
appendString(LOC79, arguments_210837);
					execexternalprogram_202175(LOC79, ((NU16) 284));
				}
				LA57: ;
			}
			LA55: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	initdefines_197254();
	handlecmdline_580607();
	msgquit_189491(((NI8) ((((NI) 0) < gerrorcounter_189399))));
}
