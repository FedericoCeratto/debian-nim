...
NIM_CONST TY84945 TMP1048 = {((NimStringDesc*) &TMP1049),
876}
;
STRING_LITERAL(TMP1980, "\015\012", 2);
STRING_LITERAL(TMP2696, "suggest done", 12);
NIM_CONST TY84945 TMP3610 = {((NimStringDesc*) &TMP1049),
883}
;
...
static N_INLINE(void, writeln_170205)(FILE* f_170209, NimStringDesc** x_170213, NI x_170213Len0) {
	...
	write_13065(f_170209, ((NimStringDesc*) &TMP150));
}
		...
		if (TMP1038.status == 0) {
			{
				...
				f_198159 = open_12817(HEX3Atmp_198156, ((NU8) 0), 8000);
				res_198161 = rawNewString(80);
				{
					while (1) {
						NIM_BOOL LOC15;
						LOC15 = 0;
						LOC15 = readline_13089(f_198159, (&res_198161));
						if (!LOC15) goto LA14;
...
appendString(LOC12, ((NimStringDesc*) &TMP1980));
...
N_NIMCALL(void, clearbufferedmsgs_196449)(void) {
	genericSeqAssign((&bufferedmsgs_196438), NIM_NIL, (&NTI120008));
}
N_NIMCALL(void, TMP2695)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_196846)(void) {
	...
	LA3: ;
	{
		...
		LOC8 = 0;
		LOC8 = (*e_196850).Sup.message; (*e_196850).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2696));
...
static TNimNode* TMP1972[276];
NI TMP1974;
static char* NIM_CONST TMP1973[276] = {
"errUnknown", 
"errIllFormedAstX", 
"errInternal", 
"errCannotOpenFile", 
...
NTI195205.base = 0;
NTI195205.flags = 3;
for (TMP1974 = 0; TMP1974 < 276; TMP1974++) {
TMP19[TMP1974+11].kind = 1;
TMP19[TMP1974+11].offset = TMP1974;
TMP19[TMP1974+11].name = TMP1973[TMP1974];
TMP1972[TMP1974] = &TMP19[TMP1974+11];
}
TMP19[287].len = 276; TMP19[287].kind = 2; TMP19[287].sons = &TMP1972[0];
