...
STRING_LITERAL(TMP3893, "config.nims", 11);
...
{	{
		...
		writecommandlineusage_251005_2004575671();
	}
	goto LA1;
	LA4: ;
	{
		NimStringDesc* scriptfile0;
		processcmdline_562203_3526807654(((Tcmdlinepass251008) 0), ((NimStringDesc*) &TMP2192));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_163205_2607990831, ((NimStringDesc*) &TMP2193))) goto LA9;
			LOC11 = (NimStringDesc*)0;
			LOC11 = gprojectname_163205_2607990831; gprojectname_163205_2607990831 = copyStringRC1(((NimStringDesc*) &TMP2194));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = (NimStringDesc*)0;
			LOC12 = gprojectfull_163207_2607990831; gprojectfull_163207_2607990831 = copyStringRC1(((NimStringDesc*) &TMP2194));
			if (LOC12) nimGCunrefNoCycle(LOC12);
			asgnRefNoCycle((void**) (&gprojectpath_163206_2607990831), nosgetCurrentDir());
			gprojectisstdin_163208_2607990831 = NIM_TRUE;
		}
		goto LA7;
		LA9: ;
		{
			...
			NimStringDesc* LOC20;
			NimStringDesc* LOC21;
			if (!!(((gprojectname_163205_2607990831) && (gprojectname_163205_2607990831)->Sup.len == 0))) goto LA14;
			pushSafePoint(&TMP2195);
			TMP2195.status = _setjmp(TMP2195.context);
			if (TMP2195.status == 0) {
				asgnRefNoCycle((void**) (&gprojectfull_163207_2607990831), canonicalizepath_163405_2607990831(gprojectname_163205_2607990831));
				popSafePoint();
			}
			else {
				popSafePoint();
				if (isObj(getCurrentException()->Sup.m_type, (&NTI3430))) {
					...
					LOC19 = gprojectfull_163207_2607990831; gprojectfull_163207_2607990831 = copyStringRC1(gprojectname_163205_2607990831);
			...
			chckNil((void*)(&p0));
			memset((void*)(&p0), 0, sizeof(p0));
			nossplitFile(gprojectfull_163207_2607990831, (&p0));
			LOC20 = (NimStringDesc*)0;
			LOC20 = gprojectpath_163206_2607990831; gprojectpath_163206_2607990831 = copyStringRC1(p0.Field0);
			if (LOC20) nimGCunrefNoCycle(LOC20);
			LOC21 = (NimStringDesc*)0;
			LOC21 = gprojectname_163205_2607990831; gprojectname_163205_2607990831 = copyStringRC1(p0.Field1);
		...
		LA7: ;
		loadconfigs_261603_930198375(((NimStringDesc*) &TMP2223));
		scriptfile0 = noschangeFileExt(gprojectfull_163207_2607990831, ((NimStringDesc*) &TMP2224));
		{
			NIM_BOOL LOC25;
			LOC25 = (NIM_BOOL)0;
			...
			{
				if (!eqStrings(scriptfile0, gprojectfull_163207_2607990831)) goto LA30;
				goto BeforeRet;
			}
			LA30: ;
		}
		...
		LA26: ;
		{
			...
			LOC33 = HEX2F_124665_2125978480(gprojectpath_163206_2607990831, ((NimStringDesc*) &TMP3893));
			LOC34 = (NIM_BOOL)0;
			LOC34 = fileexists_128004_2125978480(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = (NimStringDesc*)0;
			LOC37 = HEX2F_124665_2125978480(gprojectpath_163206_2607990831, ((NimStringDesc*) &TMP3893));
		...
		processcmdline_562203_3526807654(((Tcmdlinepass251008) 1), ((NimStringDesc*) &TMP2192));
		{
			if (!((command_163211_2607990831) && (command_163211_2607990831)->Sup.len == 0)) goto LA40;
			rawmessage_188612_155036129(((Tmsgkind185002) 184), command_163211_2607990831);
		}
		LA40: ;
		maincommand_564610_6460232();
		{
			...
			NimStringDesc* LOC48;
			LOC44 = (NIM_BOOL)0;
			LOC44 = ((goptions_163125_2607990831 &(1U<<((NU)(((Toption163009) 12))&31U)))!=0);
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_186077_155036129 &((NU64)1<<((NU)((((Tmsgkind185002) 289)- 237))&63U)))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
		...
		LA46: ;
		{
			if (!(gerrorcounter_186078_155036129 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_163127_2607990831 &(1U<<((NU)(((Tglobaloption163013) 13))&31U)))!=0)) goto LA55;
				{
					NimStringDesc* ex0;
					NimStringDesc* LOC70;
					NimStringDesc* LOC71;
					if (!(gcmd_163129_2607990831 == ((Tcommands163017) 4))) goto LA59;
					ex0 = (NimStringDesc*)0;
					{
						NimStringDesc* LOC65;
						if (!(((NI) 0) < (outfile_163133_2607990831 ? outfile_163133_2607990831->Sup.len : 0))) goto LA63;
						LOC65 = (NimStringDesc*)0;
						LOC65 = prependcurdir_568401_957294627(outfile_163133_2607990831);
					...
					LA63: ;
					{
						...
						LOC67 = noschangeFileExt(gprojectfull_163207_2607990831, ((NimStringDesc*) &TMP5575));
						LOC68 = (NimStringDesc*)0;
						LOC68 = prependcurdir_568401_957294627(LOC67);
						LOC69 = (NimStringDesc*)0;
						LOC69 = completecfilepath_245854_2528170400(LOC68, NIM_TRUE);
					...
					LOC70 = rawNewString(LOC71->Sup.len + ex0->Sup.len + arguments_252716_2004575671->Sup.len + 2);
appendString(LOC70, LOC71);
appendString(LOC70, ((NimStringDesc*) &TMP5579));
appendString(LOC70, ex0);
appendChar(LOC70, 32);
appendString(LOC70, arguments_252716_2004575671);
					execexternalprogram_245881_2528170400(LOC70, ((Tmsgkind185002) 284));
				}
				goto LA57;
				LA59: ;
				{
					NimStringDesc* ex0;
					NimStringDesc* LOC84;
					if (!(gcmd_163129_2607990831 == ((Tcommands163017) 5))) goto LA73;
					ex0 = (NimStringDesc*)0;
					{
						NimStringDesc* LOC79;
						if (!(((NI) 0) < (outfile_163133_2607990831 ? outfile_163133_2607990831->Sup.len : 0))) goto LA77;
						LOC79 = (NimStringDesc*)0;
						LOC79 = prependcurdir_568401_957294627(outfile_163133_2607990831);
					...
					LA77: ;
					{
						...
						LOC81 = noschangeFileExt(gprojectfull_163207_2607990831, ((NimStringDesc*) &TMP5580));
						LOC82 = (NimStringDesc*)0;
						LOC82 = prependcurdir_568401_957294627(LOC81);
						LOC83 = (NimStringDesc*)0;
						LOC83 = completecfilepath_245854_2528170400(LOC82, NIM_TRUE);
						ex0 = nospquoteShell(LOC83);
					}
					LA75: ;
					LOC84 = (NimStringDesc*)0;
					LOC84 = rawNewString(ex0->Sup.len + arguments_252716_2004575671->Sup.len + 5);
appendString(LOC84, ((NimStringDesc*) &TMP5581));
appendString(LOC84, ex0);
appendChar(LOC84, 32);
appendString(LOC84, arguments_252716_2004575671);
					execexternalprogram_245881_2528170400(LOC84, ((Tmsgkind185002) 284));
				}
				goto LA57;
				LA73: ;
				{
					...
					{
						if (!(((NI) 0) < (outfile_163133_2607990831 ? outfile_163133_2607990831->Sup.len : 0))) goto LA88;
						binpath0 = prependcurdir_568401_957294627(outfile_163133_2607990831);
					}
					goto LA86;
					LA88: ;
					{
						...
						LOC91 = noschangeFileExt(gprojectfull_163207_2607990831, ((NimStringDesc*) &TMP2192));
						binpath0 = prependcurdir_568401_957294627(LOC91);
					}
					LA86: ;
					ex0 = nospquoteShell(binpath0);
					LOC92 = (NimStringDesc*)0;
					LOC92 = rawNewString(ex0->Sup.len + arguments_252716_2004575671->Sup.len + 1);
appendString(LOC92, ex0);
appendChar(LOC92, 32);
appendString(LOC92, arguments_252716_2004575671);
					execexternalprogram_245881_2528170400(LOC92, ((Tmsgkind185002) 284));
				}
				LA57: ;
			}
			LA55: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	msgquit_186153_155036129(((NI8) ((((NI) 0) < gerrorcounter_186078_155036129))));
}
