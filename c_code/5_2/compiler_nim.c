...
STRING_LITERAL(TMP3709, "config.nims", 11);
STRING_LITERAL(TMP5292, "./", 2);
STRING_LITERAL(TMP5293, "js", 2);
...
appendString(LOC7, ((NimStringDesc*) &TMP5292));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
{	{
	...
	LA4: ;
	{
		...
		LA26: ;
		{
			...
			NimStringDesc* LOC37;
			LOC33 = 0;
			LOC33 = HEX2F_123481(gprojectpath_166235, ((NimStringDesc*) &TMP3709));
			LOC34 = 0;
			LOC34 = fileexists_127010(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = 0;
			LOC37 = HEX2F_123481(gprojectpath_166235, ((NimStringDesc*) &TMP3709));
			...
			if (!(gerrorcounter_190396 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_166132 &(1<<((((NU8) 13))&31)))!=0)) goto LA55;
				{
					...
					LA63: ;
					{
						...
						NimStringDesc* LOC69;
						LOC67 = 0;
						LOC67 = noschangeFileExt(gprojectfull_166236, ((NimStringDesc*) &TMP5293));
						LOC68 = 0;
...
appendString(LOC70, ((NimStringDesc*) &TMP5297));
