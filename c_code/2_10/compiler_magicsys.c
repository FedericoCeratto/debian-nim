...
STRING_LITERAL(TMP3437, "symbol conflicts with other .exportNims symbol at: ", 51);
STRING_LITERAL(TMP3726, "invalid int size", 16);
...
appendString(LOC6, ((NimStringDesc*) &TMP3437));
...
N_NIMCALL(void, setintlittype_309719_3937434831)(Tnode264794* result0) {
	...
	default:
	{
		internalerror_191100_155036129((*result0).info, ((NimStringDesc*) &TMP3726));
	}
	break;
	}
}
