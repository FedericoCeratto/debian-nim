...
STRING_LITERAL(TMP4060, "ccgmerge: \':\' expected", 22);
STRING_LITERAL(TMP4061, "NIM_merge_INFO", 14);
STRING_LITERAL(TMP4062, "typeCache", 9);
STRING_LITERAL(TMP4063, "declared", 8);
STRING_LITERAL(TMP4064, "typeInfo", 8);
STRING_LITERAL(TMP4065, "labels", 6);
STRING_LITERAL(TMP4066, "hasframe", 8);
STRING_LITERAL(TMP4067, "ccgmerge: \'{\' expected", 22);
STRING_LITERAL(TMP4068, "ccgmerge: unkown key: ", 22);
STRING_LITERAL(TMP4139, "ccgmerge: expected: /*\011NIM_merge_END:*/", 39);
STRING_LITERAL(TMP4140, "/*\011NIM_merge_END:*/", 19);
STRING_LITERAL(TMP4141, "", 0);
STRING_LITERAL(TMP4142, "NIM_merge_HEADERS", 17);
STRING_LITERAL(TMP4143, "NIM_merge_FORWARD_TYPES", 23);
STRING_LITERAL(TMP4144, "NIM_merge_TYPES", 15);
STRING_LITERAL(TMP4145, "NIM_merge_SEQ_TYPES", 19);
STRING_LITERAL(TMP4146, "NIM_merge_FIELD_INFO", 20);
STRING_LITERAL(TMP4147, "NIM_merge_TYPE_INFO", 19);
STRING_LITERAL(TMP4148, "NIM_merge_PROC_HEADERS", 22);
STRING_LITERAL(TMP4149, "NIM_merge_DATA", 14);
STRING_LITERAL(TMP4150, "NIM_merge_VARS", 14);
STRING_LITERAL(TMP4151, "NIM_merge_PROCS", 15);
STRING_LITERAL(TMP4152, "NIM_merge_INIT_PROC", 19);
STRING_LITERAL(TMP4153, "NIM_merge_TYPE_INIT1", 20);
STRING_LITERAL(TMP4154, "NIM_merge_TYPE_INIT2", 20);
STRING_LITERAL(TMP4155, "NIM_merge_TYPE_INIT3", 20);
STRING_LITERAL(TMP4156, "NIM_merge_DEBUG_INIT", 20);
STRING_LITERAL(TMP4157, "NIM_merge_DYNLIB_INIT", 21);
STRING_LITERAL(TMP4158, "NIM_merge_DYNLIB_DEINIT", 23);
NIM_CONST TY551013 cfilesectionnames_551012 = {((NimStringDesc*) &TMP4141),
...
;
STRING_LITERAL(TMP4159, "NIM_merge_PROC_LOCALS", 21);
STRING_LITERAL(TMP4160, "NIM_merge_PROC_INIT", 19);
STRING_LITERAL(TMP4161, "NIM_merge_PROC_BODY", 19);
NIM_CONST TY551019 cprocsectionnames_551018 = {((NimStringDesc*) &TMP4159),
((NimStringDesc*) &TMP4160),
((NimStringDesc*) &TMP4161)}
;
STRING_LITERAL(TMP4162, "ccgmerge: unknown section: ", 27);
STRING_LITERAL(TMP4163, "ccgmerge: \'*/\' expected", 23);
STRING_LITERAL(TMP4168, "/*\011", 3);
STRING_LITERAL(TMP4169, ":*/", 3);
STRING_LITERAL(TMP4179, "/*\011NIM_merge_INFO:", 18);
STRING_LITERAL(TMP4180, "typeCache:{", 11);
STRING_LITERAL(TMP4181, "declared:{", 10);
STRING_LITERAL(TMP4182, "typeInfo:{", 10);
STRING_LITERAL(TMP4183, "labels:", 7);
STRING_LITERAL(TMP4184, " hasframe:", 10);
...
N_NIMCALL(void, readkey_551535)(tbaselexer214024* l, NimStringDesc** result) {
	...
	}
	{
		...
		internalerror_199006(((NimStringDesc*) &TMP4060));
	}
	LA5: ;
	(*l).Bufpos = (NI64)(pos + 1);
}
...
N_NIMCALL(void, readtypecache_551607)(tbaselexer214024* l, tidtable226864* result) {
	{
		...
		internalerror_199006(((NimStringDesc*) &TMP4067));
	}
	LA3: ;
	(*l).Bufpos += 1;
	{
...
N_NIMCALL(void, processmergeinfo_551711)(tbaselexer214024* l, tcgen550035* m) {
	...
	k = rawNewString(9);
	{
		while (1) {
			...
			LA7: ;
			readkey_551535(l, (&k));
			if (eqStrings(k, ((NimStringDesc*) &TMP4062))) goto LA9;
			if (eqStrings(k, ((NimStringDesc*) &TMP4063))) goto LA10;
			if (eqStrings(k, ((NimStringDesc*) &TMP4064))) goto LA11;
			if (eqStrings(k, ((NimStringDesc*) &TMP4065))) goto LA12;
			if (eqStrings(k, ((NimStringDesc*) &TMP4066))) goto LA13;
			goto LA14;
			LA9: ;
			{
...
appendString(LOC24, ((NimStringDesc*) &TMP4068));
...
N_NIMCALL(void, readmergeinfo_551815)(NimStringDesc* cfilename, tcgen550035* m) {
	...
	k = rawNewString(23);
	{
		while (1) {
			...
			readkey_551535((&l), (&k));
			{
				if (!eqStrings(k, ((NimStringDesc*) &TMP4061))) goto LA13;
...
N_NIMCALL(NIM_BOOL, atendmark_551456)(NCSTRING buf, NI pos) {
	...
	s = 0;
	{
		while (1) {
			...
			LOC3 = (s < 19);
			if (!(LOC3)) goto LA4;
			LOC3 = ((NU8)(buf[(NI64)(pos + s)]) == (NU8)(((NimStringDesc*) &TMP4140)->data[s]));
			LA4: ;
			if (!LOC3) goto LA2;
			s += 1;
		} LA2: ;
...
appendString(r, tnl_175613);
			...
			case 0:
			{
				internalerror_199006(((NimStringDesc*) &TMP4139));
				goto LA1;
			}
			break;
			default:
...
appendString(LOC34, ((NimStringDesc*) &TMP4162));
appendString(LOC34, k);
			...
			LA18: ;
			{
				internalerror_199006(((NimStringDesc*) &TMP4163));
			}
			LA11: ;
		}
	} LA5: ;
...
N_NIMCALL(trope178009*, gensectionstart_551126)(NU8 ps) {
	...
	result = 0;
	{
		...
		app_178060(&result, ((NimStringDesc*) &TMP4168));
		app_178060(&result, cprocsectionnames_551018[(ps)- 0]);
		app_178060(&result, ((NimStringDesc*) &TMP4169));
...
appendString(LOC5, ((NimStringDesc*) &TMP4140));
...
N_NIMCALL(trope178009*, genmergeinfo_551329)(tcgen550035* m) {
	...
	LA3: ;
	s = copyString(((NimStringDesc*) &TMP4179));
	s = resizeString(s, tnl_175613->Sup.len + 0);
appendString(s, tnl_175613);
	s = resizeString(s, 11);
