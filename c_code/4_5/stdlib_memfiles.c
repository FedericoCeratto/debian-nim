...
STRING_LITERAL(TMP1727, "", 0);
TNimType NTI300202; /* MemFile */
...
N_NIMCALL(Memfile300202, open_300801_947767598)(NimStringDesc* filename0, Filemode12409 mode0, NI mappedsize0, NI offset0, NI newfilesize0) {
	...
	LA6: ;
	{
		...
		raiseoserror_127003_2125978480(LOC20, ((NimStringDesc*) &TMP1727));
	}
	LA13: ;
	{
		if (!!((newfilesize0 == ((NI) -1)))) goto LA23;
		{
			...
			LA32: ;
			LOC35 = (NI32)0;
			LOC35 = oslasterror_127019_2125978480();
			raiseoserror_127003_2125978480(LOC35, ((NimStringDesc*) &TMP1727));
		}
		LA28: ;
	}
	LA23: ;
	...
	LA38: ;
	{
		...
		LA44: ;
		{
			...
			raiseoserror_127003_2125978480(LOC52, ((NimStringDesc*) &TMP1727));
		}
		LA41: ;
	}
	LA36: ;
	...
	result0.mem = mmap(NIM_NIL, result0.size, LOC53, LOC59, result0.handle, ((off_t) (offset0)));
	{
		...
		LA71: ;
		LOC74 = (NI32)0;
		LOC74 = oslasterror_127019_2125978480();
		raiseoserror_127003_2125978480(LOC74, ((NimStringDesc*) &TMP1727));
	}
	LA67: ;
	return result0;
}
...
N_NIMCALL(void, close_301242_947767598)(Memfile300202* f0) {
	...
	lasterr0 = (NI32)0;
	{
		...
		error0 = !((LOC5 == ((NI32) 0)));
		lasterr0 = oslasterror_127019_2125978480();
		LOC6 = (NIM_BOOL)0;
		LOC7 = (int)0;
	...
	{
		if (!error0) goto LA11;
		raiseoserror_127003_2125978480(lasterr0, ((NimStringDesc*) &TMP1727));
	}
	LA11: ;
}
...
static TNimNode TMP971[4];
NTI300202.size = sizeof(Memfile300202);
NTI300202.kind = 18;
NTI300202.base = 0;
NTI300202.flags = 3;
TMP992[0] = &TMP971[1];
TMP971[1].kind = 1;
TMP971[1].offset = offsetof(Memfile300202, mem);
TMP971[1].typ = (&NTI142);
TMP971[1].name = "mem";
TMP992[1] = &TMP971[2];
TMP971[2].kind = 1;
TMP971[2].offset = offsetof(Memfile300202, size);
TMP971[2].typ = (&NTI104);
TMP971[2].name = "size";
TMP992[2] = &TMP971[3];
TMP971[3].kind = 1;
TMP971[3].offset = offsetof(Memfile300202, handle);
TMP971[3].typ = (&NTI7208);
TMP971[3].name = "handle";
TMP971[0].len = 3; TMP971[0].kind = 2; TMP971[0].sons = &TMP992[0];
NTI300202.node = &TMP971[0];
}
