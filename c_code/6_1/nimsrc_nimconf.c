...
N_NIMCALL(void, parseassignment_186439)(Tlexer181185* L, Ttoken181181* tok) {
	...
	Tident167021* LOC22;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = getident_167463(((NimStringDesc*) &TMP1885));
		LOC3 = ((*(*tok).ident).Sup.id == (*LOC4).Sup.id);
		if (LOC3) goto LA5;
		LOC6 = 0;
		LOC6 = getident_167463(((NimStringDesc*) &TMP1886));
...
appendString(val, LOC16);
		...
		LA19: ;
		{
			lexmessage_181483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP1888));
		}
		LA17: ;
		val = addChar(val, 93);
	}
	LA14: ;
	LOC22 = 0;
	LOC22 = getident_167463(((NimStringDesc*) &TMP1889));
...
appendString(val, LOC33);
		conftok_186377(L, tok);
		{
			while (1) {
				...
				if (!(LOC36)) goto LA37;
				LOC38 = 0;
				LOC38 = getident_167463(((NimStringDesc*) &TMP1890));
...
N_NIMCALL(void, loadconfigs_186609)(NimStringDesc* cfg) {
	NimStringDesc* pd;
	{
		...
		prefix = getprefixdir_154365();
		{
			...
			LOC9 = 0;
			LOC9 = libpath_154233; libpath_154233 = copyStringRC1(((NimStringDesc*) &TMP1872));
		...
		LA7: ;
		{
			...
			LOC13 = 0;
			LOC13 = libpath_154233; libpath_154233 = copyStringRC1(((NimStringDesc*) &TMP1874));
			if (LOC13) nimGCunrefNoCycle(LOC13);
		}
		goto LA5;
		LA11: ;
		{
			asgnRefNoCycle((void**) (&libpath_154233), nosjoinPath(prefix, ((NimStringDesc*) &TMP1875)));
		}
		LA5: ;
	}
	LA3: ;
		...
		if (!!(((gglobaloptions_154128 &(1<<((((NU8) 19))&31)))!=0))) goto LA32;
		{
			...
			dir_186834 = 0;
			{
				...
				current_186851 = copyString(pd);
				{
					...
					dir_186834 = pd;
					LOC43 = 0;
					LOC43 = HEX2F_119292(dir_186834, cfg);
				...
				LA41: ;
				{
					while (1) {
						...
						LOC51 = 0;
						LOC51 = HEX2F_119292(dir_186834, cfg);
			...
			LA37: ;
			{
					...
					res_186857 = ((NI) 0);
					{
						while (1) {
							...
							i_186853 = res_186857;
							{
								...
								LOC64 = 0;
								LOC64 = HEX2F_119292(dir_186834, cfg);
				...
				}
				{
					...
					dir_186834 = pd;
					LOC69 = 0;
					LOC69 = HEX2F_119292(dir_186834, cfg);
