...
STRING_LITERAL(TMP1556, "false", 5);
extern NIM_CONST TY173514 Cpu_173500;
extern NIM_CONST TY173084 Os_173070;
STRING_LITERAL(TMP1557, "x86", 3);
STRING_LITERAL(TMP1558, "itanium", 7);
STRING_LITERAL(TMP1559, "x8664", 5);
STRING_LITERAL(TMP1560, "posix", 5);
STRING_LITERAL(TMP1561, "unix", 4);
STRING_LITERAL(TMP1562, "bsd", 3);
STRING_LITERAL(TMP1563, "emulatedthreadvars", 18);
STRING_LITERAL(TMP1564, "msdos", 5);
STRING_LITERAL(TMP1565, "mswindows", 9);
STRING_LITERAL(TMP1566, "win32", 5);
STRING_LITERAL(TMP1567, "macintosh", 9);
STRING_LITERAL(TMP1568, "sunos", 5);
STRING_LITERAL(TMP1569, "littleendian", 12);
STRING_LITERAL(TMP1570, "bigendian", 9);
STRING_LITERAL(TMP1571, "cpu8", 4);
STRING_LITERAL(TMP1572, "cpu16", 5);
STRING_LITERAL(TMP1573, "cpu32", 5);
STRING_LITERAL(TMP1574, "cpu64", 5);
STRING_LITERAL(TMP1575, "nimrawsetjmp", 12);
STRING_LITERAL(TMP1604, "true", 4);
STRING_LITERAL(TMP1605, "nimrod", 6);
STRING_LITERAL(TMP1606, "nimhygiene", 10);
STRING_LITERAL(TMP1607, "niminheritable", 14);
STRING_LITERAL(TMP1608, "nimmixin", 8);
STRING_LITERAL(TMP1609, "nimeffects", 10);
STRING_LITERAL(TMP1610, "nimbabel", 8);
STRING_LITERAL(TMP1611, "nimcomputedgoto", 15);
STRING_LITERAL(TMP1612, "nimunion", 8);
STRING_LITERAL(TMP1613, "nimnewshared", 12);
STRING_LITERAL(TMP1614, "nimrequiresnimframe", 19);
STRING_LITERAL(TMP1615, "nimparsebiggestfloatmagic", 25);
STRING_LITERAL(TMP1616, "nimalias", 8);
STRING_LITERAL(TMP1617, "nimlocks", 8);
STRING_LITERAL(TMP1618, "nimnode", 7);
STRING_LITERAL(TMP1619, "nimnomagic64", 12);
STRING_LITERAL(TMP1620, "nimvarargstyped", 15);
STRING_LITERAL(TMP1621, "nimtypedescfixed", 16);
STRING_LITERAL(TMP1622, "nimKnowsNimvm", 13);
STRING_LITERAL(TMP1623, "nimArrIdx", 9);
...
N_NIMCALL(NIM_BOOL, isdefined_198031)(NimStringDesc* symbol) {
	...
	result = 0;
	{
		...
		result = !(eqStrings((*LOC6), ((NimStringDesc*) &TMP1556)));
	}
	goto LA1;
	LA4: ;
	{
...
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1575))) goto LA33;
break;
		case 2: 
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1573))) goto LA31;
break;
		case 3: 
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1564))) goto LA23;
break;
		case 6: 
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1562))) goto LA21;
break;
		case 13: 
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1568))) goto LA26;
break;
		case 15: 
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1557))) goto LA17;
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1558))) goto LA18;
break;
		case 19: 
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1561))) goto LA20;
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1563))) goto LA22;
break;
		case 20: 
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1570))) goto LA28;
break;
		case 22: 
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1571))) goto LA29;
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1572))) goto LA30;
break;
		case 23: 
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1559))) goto LA19;
break;
		case 25: 
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1574))) goto LA32;
break;
		case 27: 
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1569))) goto LA27;
break;
		case 30: 
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1560))) goto LA20;
if (eqStrings(LOC16, ((NimStringDesc*) &TMP1567))) goto LA25;
break;
		}
		goto LA34;
		LA17: ;
			...
			res_198233 = ((NI) 0);
			{
				while (1) {
					...
					h_198229 = res_198233;
					{
						...
						{
							if (!!(eqStrings(val_198215, ((NimStringDesc*) &TMP1556)))) goto LA11;
							result += ((NI) 1);
						}
						LA11: ;
					}
...
N_NIMCALL(void, definesymbol_198013)(NimStringDesc* symbol) {
	nstPut(gsymbols_198004, symbol, ((NimStringDesc*) &TMP1604));
}
...
N_NIMCALL(void, initdefines_198254)(void) {
	...
	definesymbol_198013(((NimStringDesc*) &TMP1623));
}

N_NIMCALL(void, undefsymbol_198022)(NimStringDesc* symbol) {
	nstPut(gsymbols_198004, symbol, ((NimStringDesc*) &TMP1556));
}
