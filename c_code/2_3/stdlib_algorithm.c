...
typedef N_CLOSURE_PTR(NI, TMP2621) (Tsym191843* x_352582, Tsym191843* y_352584);
typedef N_CLOSURE_PTR(NI, TMP2622) (Tsym191843* x_352582, Tsym191843* y_352584);
...
typedef N_CLOSURE_PTR(NI, TMP4923) (NimStringDesc* x_316365, NimStringDesc* y_316367);
...
typedef N_CLOSURE_PTR(NI, TMP4927) (Tindexentry313396* x_314751, Tindexentry313396* y_314753);
typedef N_CLOSURE_PTR(NI, TMP4928) (Tindexentry313396* x_314751, Tindexentry313396* y_314753);
struct  TNimObject  {
TNimType* m_type;
};
struct  Tidobj168015  {
