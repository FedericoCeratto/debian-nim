...
STRING_LITERAL(TMP1366, "nimrod.gid", 10);
STRING_LITERAL(TMP4137, "\012", 1);
...
N_NIMCALL(NimStringDesc*, togid_224467)(NimStringDesc* f) {
	...
	result = 0;
	result = completegeneratedfilepath_170001(((NimStringDesc*) &TMP1366), NIM_TRUE);
	return result;
}
...
static N_INLINE(void, writeln_170205)(FILE* f_170209, NimStringDesc** x_170213, NI x_170213Len0) {
	...
	write_12865(f_170209, ((NimStringDesc*) &TMP4137));
}
