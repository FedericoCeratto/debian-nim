...
N_NIMCALL(void, skiputf8bom_213416)(Tbaselexer212024* L);
N_NIMCALL(NI, fillbaselexer_212827)(Tbaselexer212024* L, NI pos);
...
N_NIMCALL(void, fillbuffer_212097)(Tbaselexer212024* L) {
	...
	LA3: ;
	LOC5 = 0;
	LOC5 = llstreamread_211584((*L).stream, ((void*) ((&(*L).buf[tocopy]))), (NI)((NI)((*L).sentinel + ((NI) 1)) * ((NI) 1)));
		...
		s -= ((NI) 1);
		{
			while (1) {
				...
				LA19: ;
				{
					...
					LOC23 = 0;
					LOC23 = llstreamread_211584((*L).stream, ((void*) ((&(*L).buf[oldbuflen]))), (NI)(oldbuflen * ((NI) 1)));
...
N_NIMCALL(NI, handlecr_212066)(Tbaselexer212024* L, NI pos) {
	...
	result = 0;
	(*L).linenumber += ((NI) 1);
	result = fillbaselexer_212827(L, pos);
	{
		if (!((NU8)((*L).buf[result]) == (NU8)(10))) goto LA3;
		result = fillbaselexer_212827(L, result);
	}
	LA3: ;
	return result;
}
...
NTI212024.kind = 17;
NTI212024.base = (&NTI4011);
TMP1172[0] = &TMP789[1];
TMP789[1].kind = 1;
TMP789[1].offset = offsetof(Tbaselexer212024, bufpos);
TMP789[1].typ = (&NTI108);
TMP789[1].name = "bufpos";
TMP1172[1] = &TMP789[2];
TMP789[2].kind = 1;
TMP789[2].offset = offsetof(Tbaselexer212024, buf);
TMP789[2].typ = (&NTI151);
TMP789[2].name = "buf";
TMP1172[2] = &TMP789[3];
TMP789[3].kind = 1;
TMP789[3].offset = offsetof(Tbaselexer212024, buflen);
TMP789[3].typ = (&NTI108);
TMP789[3].name = "bufLen";
TMP1172[3] = &TMP789[4];
TMP789[4].kind = 1;
TMP789[4].offset = offsetof(Tbaselexer212024, stream);
TMP789[4].typ = (&NTI211206);
TMP789[4].name = "stream";
TMP1172[4] = &TMP789[5];
TMP789[5].kind = 1;
TMP789[5].offset = offsetof(Tbaselexer212024, linenumber);
TMP789[5].typ = (&NTI108);
TMP789[5].name = "lineNumber";
TMP1172[5] = &TMP789[6];
TMP789[6].kind = 1;
TMP789[6].offset = offsetof(Tbaselexer212024, sentinel);
TMP789[6].typ = (&NTI108);
TMP789[6].name = "sentinel";
TMP1172[6] = &TMP789[7];
TMP789[7].kind = 1;
TMP789[7].offset = offsetof(Tbaselexer212024, linestart);
TMP789[7].typ = (&NTI108);
TMP789[7].name = "lineStart";
TMP789[0].len = 7; TMP789[0].kind = 2; TMP789[0].sons = &TMP1172[0];
NTI212024.node = &TMP789[0];
}
