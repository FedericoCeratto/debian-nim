...
{	{
		...
		NI LOC4;
		LOC3 = (NI)0;
		LOC3 = cmp0.ClEnv? cmp0.ClPrc(a0[m0], a0[(NI)(m0 + ((NI) 1))], cmp0.ClEnv):((TMP5448)(cmp0.ClPrc))(a0[m0], a0[(NI)(m0 + ((NI) 1))]);
		LOC4 = (NI)0;
		LOC4 = HEX2A_351008_3792311747(LOC3, order0);
		if (!(LOC4 <= ((NI) 0))) goto LA5;
		goto BeforeRet;
	...
	k0 = lo0;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = (NI)0;
				LOC15 = cmp0.ClEnv? cmp0.ClPrc(b0[i0], a0[j0], cmp0.ClEnv):((TMP5449)(cmp0.ClPrc))(b0[i0], a0[j0]);
				LOC16 = (NI)0;
				LOC16 = HEX2A_351008_3792311747(LOC15, order0);
				if (!(LOC16 <= ((NI) 0))) goto LA17;
				unsureAsgnRef((void**) (&a0[k0]), b0[i0]);
...
{	{
		...
		NI LOC4;
		LOC3 = (NI)0;
		LOC3 = cmp0.ClEnv? cmp0.ClPrc((&a0[m0]), (&a0[(NI)(m0 + ((NI) 1))]), cmp0.ClEnv):((TMP5452)(cmp0.ClPrc))((&a0[m0]), (&a0[(NI)(m0 + ((NI) 1))]));
		LOC4 = (NI)0;
		LOC4 = HEX2A_351008_3792311747(LOC3, order0);
		if (!(LOC4 <= ((NI) 0))) goto LA5;
		goto BeforeRet;
	...
	k0 = lo0;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = (NI)0;
				LOC15 = cmp0.ClEnv? cmp0.ClPrc((&b0[i0]), (&a0[j0]), cmp0.ClEnv):((TMP5453)(cmp0.ClPrc))((&b0[i0]), (&a0[j0]));
				LOC16 = (NI)0;
				LOC16 = HEX2A_351008_3792311747(LOC15, order0);
				if (!(LOC16 <= ((NI) 0))) goto LA17;
