...
static NIM_CONST TY178407 TMP1413 = {
...
N_NIMCALL(void, newline_217047)(Ttmplparser217020* p) {
	...
	(*p).emitpar = ((NI) 0);
	{
		...
		llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP1409));
	}
	LA4: ;
	{
		NimStringDesc* LOC10;
...
N_NIMCALL(void, parseline_217149)(Ttmplparser217020* p) {
	...
	LA7: ;
	{
		...
		case ((NU16) 22):
		{
			...
			{
				(*p).info.col = ((NI16) (j));
				localerror_165155((*p).info, ((NU16) 163), ((NimStringDesc*) &TMP1411));
			}
			LA20: ;
			LOC25 = 0;
		...
		case ((NU16) 62):
		{
			...
			llstreamwrite_178665((*p).outp, LOC34);
			{
				NIM_BOOL LOC37;
				LOC37 = 0;
				LOC37 = contains_99373((*p).x, TMP1413);
				if (!!(LOC37)) goto LA38;
				(*p).indent += ((NI) 2);
			}
			LA38: ;
				...
				{
					{
						...
						case 123:
						{
							...
							curly = ((NI) 0);
							{
								while (1) {
									...
									case 0:
									{
										localerror_165155((*p).info, ((NU16) 188), ((NimStringDesc*) &TMP1420));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).info.col = ((NI16) (j));
								localerror_165155((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP1408));
							}
							LA80: ;
						}
						break;
...
N_NIMCALL(Tllstream178204*, filtertmpl_217009)(Tllstream178204* stdin_217011, NimStringDesc* filename, Tnode190813* call) {
	...
	p.outp = llstreamopen_178220(((NimStringDesc*) &TMP1400));
	p.inp = stdin_217011;
