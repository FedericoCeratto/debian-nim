...
{	sent = send_518716(socket, ((void*) (data->data)), (data ? data->Sup.len : 0));
	...
	LA3: ;
	{
		...
		e_519019 = 0;
		e_519019 = (Oserror3433*) newObj((&NTI114433), sizeof(Oserror3433));
		(*e_519019).Sup.Sup.Sup.m_type = (&NTI3433);
		LOC14 = 0;
		LOC14 = (*e_519019).Sup.Sup.message; (*e_519019).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4994));
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_517819(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5001));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_517819(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5001));
