...
STRING_LITERAL(TMP4892, "js", 2);
STRING_LITERAL(TMP4893, "node ", 5);
...
appendString(LOC7, ((NimStringDesc*) &TMP4891));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_617607)(void) {
	...
	LA4: ;
	{
		processcmdline_611209(((NU8) 0), ((NimStringDesc*) &TMP1890));
		{
			TSafePoint TMP1891;
			TY117604 p;
			NimStringDesc* LOC15;
			...
			pushSafePoint(&TMP1891);
			TMP1891.status = setjmp(TMP1891.context);
			if (TMP1891.status == 0) {
			...
			if (TMP1891.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_221811(((NimStringDesc*) &TMP1916));
		initvars_203820();
		processcmdline_611209(((NU8) 1), ((NimStringDesc*) &TMP1890));
		maincommand_615027();
		{
			NimStringDesc* LOC22;
			...
			if (!(gerrorcounter_197306 == 0)) goto LA25;
			{
				if (!((gglobaloptions_170118 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					LA37: ;
					{
						...
						NimStringDesc* LOC43;
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_170236, ((NimStringDesc*) &TMP4892));
						LOC42 = 0;
...
appendString(LOC44, ((NimStringDesc*) &TMP4893));
appendString(LOC44, ex);
appendChar(LOC44, 32);
appendString(LOC44, arguments_211144);
					execexternalprogram_203907(LOC44, ((NimStringDesc*) &TMP1890));
				}
				goto LA31;
				LA33: ;
				{
					...
					LA48: ;
					{
						NimStringDesc* LOC51;
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_170236, ((NimStringDesc*) &TMP1890));
...
appendString(LOC52, arguments_211144);
					execexternalprogram_203907(LOC52, ((NimStringDesc*) &TMP1890));
				}
				LA31: ;
			}
			LA29: ;
