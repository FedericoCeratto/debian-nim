...
NIM_CONST TY550013 cfilesectionnames_550012 = {((NimStringDesc*) &TMP4143),
...
NIM_CONST TY550019 cprocsectionnames_550018 = {((NimStringDesc*) &TMP4161),
...
N_NIMCALL(void, readkey_550535)(tbaselexer213024* l, NimStringDesc** result) {
	...
	}
	{
		...
		internalerror_198006(((NimStringDesc*) &TMP4062));
	}
	LA5: ;
	(*l).Bufpos = (NI64)(pos + 1);
}
...
N_NIMCALL(void, readtypecache_550607)(tbaselexer213024* l, tidtable225864* result) {
	{
		...
		internalerror_198006(((NimStringDesc*) &TMP4069));
	}
	LA3: ;
	(*l).Bufpos += 1;
	{
...
appendString(r, tnl_174613);
			...
			case 0:
			{
				internalerror_198006(((NimStringDesc*) &TMP4141));
				goto LA1;
			}
			break;
			default:
...
appendString(LOC34, k);
			...
			LA18: ;
			{
				internalerror_198006(((NimStringDesc*) &TMP4165));
			}
			LA11: ;
		}
	} LA5: ;
...
N_NIMCALL(trope177009*, gensectionstart_550126)(NU8 ps) {
	...
	result = 0;
	{
		...
		app_177060(&result, ((NimStringDesc*) &TMP4170));
						...
						j_550301 = 0;
						{
							while (1) {
								if (!!((w_550299 == 0))) goto LA7;
								{
									...
									x_550277 = (NI)((NI)((NU64)((*r_550295).Key) << (NU64)(9)) | (NI)((NU64)((NI)((NU64)(i_550297) << (NU64)(6))) + (NU64)(j_550301)));
									{
										if (!(i == 10)) goto LA14;
										i = 0;
										(*s) = resizeString((*s), tnl_174613->Sup.len + 0);
appendString((*s), tnl_174613);
								...
								LA10: ;
								j_550301 += 1;
								w_550299 = (NI)((NU64)(w_550299) >> (NU64)(1));
							} LA7: ;
						}
						i_550297 += 1;
					} LA5: ;
