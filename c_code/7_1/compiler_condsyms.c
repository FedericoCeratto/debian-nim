...
Stringtableobj144212* gsymbols_197004;
...
N_NIMCALL(NIM_BOOL, isdefined_197031)(NimStringDesc* symbol) {
	...
	result = 0;
	{
		...
		NimStringDesc** LOC6;
		LOC3 = 0;
		LOC3 = nsthasKey(gsymbols_197004, symbol);
		if (!LOC3) goto LA4;
		LOC6 = 0;
		LOC6 = nstTake(gsymbols_197004, symbol);
	...
	LA4: ;
	{
		NI LOC8;
		LOC8 = 0;
		LOC8 = nsuCmpIgnoreStyle(symbol, Cpu_172500[(targetcpu_172628)- 1].Field0);
	...
	LA9: ;
	{
		NI LOC12;
		LOC12 = 0;
		LOC12 = nsuCmpIgnoreStyle(symbol, Os_172070[(targetos_172630)- 1].Field0);
...
break;
		...
		LA17: ;
		{
			result = (targetcpu_172628 == ((NU8) 1));
		}
		goto LA35;
		LA18: ;
		{
			result = (targetcpu_172628 == ((NU8) 9));
		}
		goto LA35;
		LA19: ;
		{
			result = (targetcpu_172628 == ((NU8) 10));
		}
		goto LA35;
		LA20: ;
		{
			result = ((3768304 &(1<<((targetos_172630)&31)))!=0);
		}
		goto LA35;
		LA21: ;
		{
			result = ((3584 &(1<<((targetos_172630)&31)))!=0);
		}
		goto LA35;
		LA22: ;
		{
			result = ((Os_172070[(targetos_172630)- 1].Field12 &(1<<((((NU8) 3))&7)))!=0);
		}
		goto LA35;
		LA23: ;
		{
			result = (targetos_172630 == ((NU8) 1));
		}
		goto LA35;
		LA24: ;
		{
			result = (targetos_172630 == ((NU8) 2));
		}
		goto LA35;
		LA25: ;
		{
			result = ((786432 &(1<<((targetos_172630)&31)))!=0);
		}
		goto LA35;
		LA26: ;
		{
			result = (targetos_172630 == ((NU8) 7));
		}
		goto LA35;
		LA27: ;
		{
			result = (Cpu_172500[(targetcpu_172628)- 1].Field2 == ((NU8) 0));
		}
		goto LA35;
		LA28: ;
		{
			result = (Cpu_172500[(targetcpu_172628)- 1].Field2 == ((NU8) 1));
		}
		goto LA35;
		LA29: ;
		{
			result = (Cpu_172500[(targetcpu_172628)- 1].Field4 == ((NI) 8));
		}
		goto LA35;
		LA30: ;
		{
			result = (Cpu_172500[(targetcpu_172628)- 1].Field4 == ((NI) 16));
		}
		goto LA35;
		LA31: ;
		{
			result = (Cpu_172500[(targetcpu_172628)- 1].Field4 == ((NI) 32));
		}
		goto LA35;
		LA32: ;
		{
			result = (Cpu_172500[(targetcpu_172628)- 1].Field4 == ((NI) 64));
		}
		goto LA35;
		LA33: ;
		{
			result = ((528000 &(1<<((targetos_172630)&31)))!=0);
		}
		goto LA35;
		LA34: ;
		{
...
N_NIMCALL(NIM_BOOL, isdefined_197167)(Tident196021* symbol) {
	NIM_BOOL result;
	result = 0;
	result = isdefined_197031((*symbol).s);
	return result;
}
...
N_NIMCALL(NI, countdefinedsymbols_197211)(void) {
	...
	result = ((NI) 0);
	{
		NimStringDesc* key_197214;
		NimStringDesc* val_197215;
		key_197214 = 0;
		val_197215 = 0;
		{
			NI h_197229;
			...
			h_197229 = 0;
			HEX3Atmp_197231 = 0;
			HEX3Atmp_197231 = ((*gsymbols_197004).data ? ((*gsymbols_197004).data->Sup.len-1) : -1);
			res_197233 = ((NI) 0);
			{
				while (1) {
					if (!(res_197233 <= HEX3Atmp_197231)) goto LA4;
					h_197229 = res_197233;
					{
						if (!!((*gsymbols_197004).data->data[h_197229].Field0 == 0)) goto LA7;
						key_197214 = (*gsymbols_197004).data->data[h_197229].Field0;
						val_197215 = (*gsymbols_197004).data->data[h_197229].Field1;
						{
							if (!!(eqStrings(val_197215, ((NimStringDesc*) &TMP1555)))) goto LA11;
							result += ((NI) 1);
						}
						LA11: ;
					}
...
N_NIMCALL(void, definesymbol_197013)(NimStringDesc* symbol) {
	nstPut(gsymbols_197004, symbol, ((NimStringDesc*) &TMP1603));
}

N_NIMCALL(void, initdefines_197254)(void) {
	asgnRef((void**) (&gsymbols_197004), nstnewStringTable(((NU8) 2)));
	definesymbol_197013(((NimStringDesc*) &TMP1604));
	definesymbol_197013(((NimStringDesc*) &TMP1605));
	definesymbol_197013(((NimStringDesc*) &TMP1606));
	definesymbol_197013(((NimStringDesc*) &TMP1607));
	definesymbol_197013(((NimStringDesc*) &TMP1608));
	definesymbol_197013(((NimStringDesc*) &TMP1609));
	definesymbol_197013(((NimStringDesc*) &TMP1610));
	definesymbol_197013(((NimStringDesc*) &TMP1611));
	definesymbol_197013(((NimStringDesc*) &TMP1612));
	definesymbol_197013(((NimStringDesc*) &TMP1613));
	definesymbol_197013(((NimStringDesc*) &TMP1614));
	definesymbol_197013(((NimStringDesc*) &TMP1615));
	definesymbol_197013(((NimStringDesc*) &TMP1616));
	definesymbol_197013(((NimStringDesc*) &TMP1617));
	definesymbol_197013(((NimStringDesc*) &TMP1618));
	definesymbol_197013(((NimStringDesc*) &TMP1619));
	definesymbol_197013(((NimStringDesc*) &TMP1620));
	definesymbol_197013(((NimStringDesc*) &TMP1621));
	definesymbol_197013(((NimStringDesc*) &TMP1622));
}

N_NIMCALL(void, undefsymbol_197022)(NimStringDesc* symbol) {
	nstPut(gsymbols_197004, symbol, ((NimStringDesc*) &TMP1555));
}
