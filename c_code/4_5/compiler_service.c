...
N_NIMCALL(void, send_589003_170061329)(Socketimpl583406* socket0, NimStringDesc* data0, Socketflag583416Set flags0);
	...
	LA2: ;
	{
		...
		writelnhook_192110_155036129.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				...
				readline_588402_170061329((*HEX3Aenv_592426_3526807654).stdoutsocket592408, (&inp0), ((NI) -1), 2, ((NI) 1000000));
