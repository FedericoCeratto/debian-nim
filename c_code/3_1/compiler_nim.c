...
N_NIMCALL(void, handlecmdline_568601_957294627)(void);
...
N_NIMCALL(NimStringDesc*, prependcurdir_568401_957294627)(NimStringDesc* f0);
...
STRING_LITERAL(TMP2191, "", 0);
STRING_LITERAL(TMP2192, "-", 1);
STRING_LITERAL(TMP2193, "stdinfile", 9);
STRING_LITERAL(TMP2223, "nim.cfg", 7);
STRING_LITERAL(TMP2224, "nims", 4);
STRING_LITERAL(TMP3892, "config.nims", 11);
STRING_LITERAL(TMP5574, "./", 2);
STRING_LITERAL(TMP5575, "js", 2);
STRING_LITERAL(TMP5579, " ", 1);
STRING_LITERAL(TMP5580, "php", 3);
STRING_LITERAL(TMP5581, "php ", 4);
...
appendString(LOC7, ((NimStringDesc*) &TMP5574));
...
{	{
		NI LOC3;
		LOC3 = (NI)0;
		LOC3 = paramcount_137826_2125978480();
	...
	LA4: ;
	{
		...
		processcmdline_562203_3526807654(((Tcmdlinepass252008) 0), ((NimStringDesc*) &TMP2191));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_164205_2607990831, ((NimStringDesc*) &TMP2192))) goto LA9;
			LOC11 = (NimStringDesc*)0;
			LOC11 = gprojectname_164205_2607990831; gprojectname_164205_2607990831 = copyStringRC1(((NimStringDesc*) &TMP2193));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = (NimStringDesc*)0;
			LOC12 = gprojectfull_164207_2607990831; gprojectfull_164207_2607990831 = copyStringRC1(((NimStringDesc*) &TMP2193));
		...
		LA9: ;
		{
			...
			pushSafePoint(&TMP2194);
			TMP2194.status = _setjmp(TMP2194.context);
			if (TMP2194.status == 0) {
			...
			if (TMP2194.status != 0) reraiseException();
		...
		scriptfile0 = noschangeFileExt(gprojectfull_164207_2607990831, ((NimStringDesc*) &TMP2224));
		{
			NIM_BOOL LOC25;
			LOC25 = (NIM_BOOL)0;
			LOC25 = fileexists_128204_2125978480(scriptfile0);
			if (!LOC25) goto LA26;
			runnimscript_567202_3062286716(scriptfile0, NIM_FALSE);
			{
		...
		LA26: ;
		{
			...
			LOC33 = HEX2F_124865_2125978480(gprojectpath_164206_2607990831, ((NimStringDesc*) &TMP3892));
			LOC34 = (NIM_BOOL)0;
			LOC34 = fileexists_128204_2125978480(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = (NimStringDesc*)0;
			LOC37 = HEX2F_124865_2125978480(gprojectpath_164206_2607990831, ((NimStringDesc*) &TMP3892));
			runnimscript_567202_3062286716(LOC37, NIM_FALSE);
		}
		goto LA23;
		LA35: ;
		LA23: ;
		initvars_246834_2528170400();
		processcmdline_562203_3526807654(((Tcmdlinepass252008) 1), ((NimStringDesc*) &TMP2191));
		{
			...
			if (!(gerrorcounter_187081_155036129 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_164127_2607990831 &(1U<<((NU)(((Tglobaloption164013) 13))&31U)))!=0)) goto LA55;
				{
					...
					ex0 = (NimStringDesc*)0;
					{
						...
						LOC65 = prependcurdir_568401_957294627(outfile_164133_2607990831);
					...
					LA63: ;
					{
						...
						LOC67 = noschangeFileExt(gprojectfull_164207_2607990831, ((NimStringDesc*) &TMP5575));
						LOC68 = (NimStringDesc*)0;
						LOC68 = prependcurdir_568401_957294627(LOC67);
...
appendString(LOC70, arguments_253716_2004575671);
				...
				LA59: ;
				{
					...
					ex0 = (NimStringDesc*)0;
					{
						...
						LOC79 = prependcurdir_568401_957294627(outfile_164133_2607990831);
					...
					LA77: ;
					{
						...
						LOC81 = noschangeFileExt(gprojectfull_164207_2607990831, ((NimStringDesc*) &TMP5580));
						LOC82 = (NimStringDesc*)0;
						LOC82 = prependcurdir_568401_957294627(LOC81);
...
appendString(LOC84, ((NimStringDesc*) &TMP5581));
...
appendString(LOC84, arguments_253716_2004575671);
				...
				LA73: ;
				{
					...
					binpath0 = (NimStringDesc*)0;
					{
						...
						binpath0 = prependcurdir_568401_957294627(outfile_164133_2607990831);
					}
					goto LA86;
					LA88: ;
					{
						...
						LOC91 = noschangeFileExt(gprojectfull_164207_2607990831, ((NimStringDesc*) &TMP2191));
						binpath0 = prependcurdir_568401_957294627(LOC91);
					}
					LA86: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	handlecmdline_568601_957294627();
