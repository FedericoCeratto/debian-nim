...
N_NIMCALL(NI, nodetablerawget_287508)(tnodetable225876 t, NI k, tnode225816* key);
N_NIMCALL(NIM_BOOL, treesequivalent_287242)(tnode225816* a, tnode225816* b);
...
N_NIMCALL(void, nodetablerawinsert_287561)(tnodepairseq225874** data, NI k, tnode225816* key, NI val);
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = (tnodepairseq225874*) newSeq((&NTI225874), (NI32)((*t).Data->Sup.len * 2));
			{
				NI i_288251;
				NI HEX3Atmp_288301;
				NI res_288304;
