...
STRING_LITERAL(TMP3140, "compiler/evaltempl.nim", 22);
NIM_CONST TY198019 TMP3139 = {((NimStringDesc*) &TMP3140),
((NI) 45)}
;
...
N_NIMCALL(Tnode264794*, evaltemplateargs_426216_885920397)(Tnode264794* n0, Tsym264826* s0, NIM_BOOL fromhlo0) {
	...
	LA15: ;
	{
		...
		globalerror_191071_155036129((*n0).info, ((Tmsgkind186002) 137), ((NimStringDesc*) &TMP3138));
	}
	LA19: ;
		...
		res_426318_885920397 = HEX3Atmp_426315_885920397;
		{
			while (1) {
				...
				default_426275_885920397 = (*(*(*(*(*s0).typ).n).kindU.S6.sons->data[i_426270_885920397]).kindU.S4.sym).ast;
				{
					...
					LA30: ;
					if (!LOC29) goto LA31;
					localerror_191080_155036129((*n0).info, ((Tmsgkind186002) 137), ((NimStringDesc*) &TMP3138));
		...
		s0 = (*templ0).kindU.S4.sym;
		{
			...
			LA30: ;
			{
				...
				Tnode264794* LOC64;
				{
					...
					LOC49 = HEX24_191183_1689653243(TMP3139);
...
N_NIMCALL(Tnode264794*, evaltemplate_426330_885920397)(Tnode264794* n0, Tsym264826* tmpl0, Tsym264826* gensymowner0, NIM_BOOL fromhlo0) {
	...
	evaltemplatecounter_426329_885920397 += ((NI) 1);
	{
		...
		globalerror_191071_155036129((*n0).info, ((Tmsgkind186002) 188), ((NimStringDesc*) &TMP3138));
		result0 = n0;
	}
	LA3: ;
