...
N_NIMCALL(void, TMP856)(void* p, NI op);
...
N_NIMCALL(void, TMP1753)(void* p, NI op);
...
TMP23[2].name = "next";
TMP23[0].len = 2; TMP23[0].kind = 2; TMP23[0].sons = &TMP855[0];
...
TMP23[3].len = 3; TMP23[3].kind = 2; TMP23[3].sons = &TMP1131[0];
