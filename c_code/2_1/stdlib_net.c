...
N_NIMCALL(NI, send_590511_170061329)(Socketimpl585406* socket0, void* data0, NI size0);
...
N_NIMCALL(NI, waitfor_589607_170061329)(Socketimpl585406* socket0, NF* waited0, NI timeout0, NI size0, NimStringDesc* funcname0);
...
N_NIMCALL(void, send_591002_170061329)(Socketimpl585406* socket0, NimStringDesc* data0, Socketflag585416Set flags0) {
	NI sent0;
{	sent0 = send_590511_170061329(socket0, ((void*) (data0->data)), (data0 ? data0->Sup.len : 0));
	{
		NI32 lasterror0;
