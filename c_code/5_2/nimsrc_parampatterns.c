...
STRING_LITERAL(TMP3127, "parampatterns.nim", 17);
NIM_CONST TY86345 TMP3126 = {((NimStringDesc*) &TMP3127),
((NI) 100)}
;
NIM_CONST TY86345 TMP3128 = {((NimStringDesc*) &TMP3127),
((NI) 107)}
;
...
N_NIMCALL(Tnode190813*, semnodekindconstraints_268679)(Tnode190813* p) {
	...
	(*result).kindU.S3.strval = addChar((*result).kindU.S3.strval, 1);
	{
		...
		}
		{
			...
			internalerror_165199((*p).info, ((NimStringDesc*) &TMP3129));
		}
		LA12: ;
	}
	goto LA1;
