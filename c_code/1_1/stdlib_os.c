...
N_NIMCALL(void, nossplitPath)(NimStringDesc* path, keyvaluepair133008* Result) {
	...
	seppos = -1;
	{
		...
		i_116531 = 0;
		HEX3Atmp_116547 = 0;
		HEX3Atmp_116547 = (NI32)(path->Sup.len - 1);
...
N_NIMCALL(NI, searchextpos_116751)(NimStringDesc* s) {
	...
	result = -1;
	{
		...
		i_116766 = 0;
		HEX3Atmp_116782 = 0;
		HEX3Atmp_116782 = (NI32)(s->Sup.len - 1);
...
N_NIMCALL(void, nossplitFile)(NimStringDesc* path, TY116804* Result) {
	...
	LA5: ;
	{
		...
		dotpos = path->Sup.len;
		{
			...
			i_116837 = 0;
			HEX3Atmp_116868 = 0;
			HEX3Atmp_116868 = (NI32)(path->Sup.len - 1);
				...
				while (1) {
					...
					i_116837 = res_116871;
					{
						if (!((NU8)(path->data[i_116837]) == (NU8)(46))) goto LA13;
						{
							...
							LOC17 = LOC18;
							if (!(LOC17)) goto LA20;
							LOC17 = !((((NU8)(path->data[(NI32)(i_116837 - 1)])) == ((NU8)(92)) || ((NU8)(path->data[(NI32)(i_116837 - 1)])) == ((NU8)(47))));
							LA20: ;
							if (!LOC17) goto LA21;
							dotpos = i_116837;
						}
...
N_NIMCALL(NI, parentdirpos_116566)(NimStringDesc* path) {
	...
	LA3: ;
	{
		...
		i_116596 = 0;
		HEX3Atmp_116612 = 0;
		HEX3Atmp_116612 = (NI32)(path->Sup.len - q);
					...
					case 92:
					{
						...
						}
						{
							if (!((NU8)(c->data[j]) == (NU8)(34))) goto LA23;
							{
								...
								k_124025 = 0;
								HEX3Atmp_124110 = 0;
								HEX3Atmp_124110 = (NI32)((NI32)(j - i) / 2);
								res_124113 = 1;
								{
									while (1) {
...
N_NIMCALL(NI, nosparamCount)(void) {
	...
	LA3: ;
	result = (NI32)(ownargv_125009->Sup.len - 1);
	return result;
}
...
N_NIMCALL(NimStringDesc*, getenv_121241)(NimStringDesc* key) {
	...
	i = findenvvar_121204(key);
	{
		...
		result = copyStr(environment_120609->data[i], (NI32)(LOC5 + 1));
		goto BeforeRet;
	}
	goto LA1;
	LA3: ;
...
N_NIMCALL(NimStringDesc*, expandtilde_126847)(NimStringDesc* path) {
	...
	result = 0;
	{
		...
		LOC11 = 0;
		LOC11 = nosgetHomeDir();
		LOC12 = HEX2EHEX2E_94498(2, (NI32)(path->Sup.len - 1));
		LOC13 = 0;
