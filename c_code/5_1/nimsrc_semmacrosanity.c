	...
	{
		{
			...
			internalerror_165199((*n).info, ((NimStringDesc*) &TMP3285));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_402106 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_165199((*n).info, ((NimStringDesc*) &TMP3286));
					}
					break;
					}
					res_402106 += ((NI) 1);
...
appendString(LOC29, LOC30);
	...
	case ((NU8) 16) ... ((NU8) 19):
	{
		...
		LA65: ;
		{
			globalerror_165145((*n).info, ((NimStringDesc*) &TMP3291));
		}
		LA63: ;
	}
	break;
	case ((NU8) 5) ... ((NU8) 15):
	{
		...
		LA71: ;
		{
			globalerror_165145((*n).info, ((NimStringDesc*) &TMP3292));
		}
		LA69: ;
	}
	break;
	case ((NU8) 20) ... ((NU8) 22):
	{
		...
		LA77: ;
		{
			globalerror_165145((*n).info, ((NimStringDesc*) &TMP3293));
		}
		LA75: ;
	}
	break;
	case ((NU8) 23):
	{
		...
		LA83: ;
		{
			globalerror_165145((*n).info, ((NimStringDesc*) &TMP3294));
		}
		LA81: ;
	}
	break;
