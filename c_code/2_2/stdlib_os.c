...
N_NIMCALL(NimStringDesc*, getapplaux_124004)(NimStringDesc* procpath);
...
STRING_LITERAL(TMP1076, "unknown OS error", 16);
STRING_LITERAL(TMP1077, "/proc/self/exe", 14);
STRING_LITERAL(TMP1079, "invalid index", 13);
STRING_LITERAL(TMP1080, "PATH", 4);
STRING_LITERAL(TMP1684, "HOME", 4);
STRING_LITERAL(TMP1685, "/", 1);
STRING_LITERAL(TMP1913, "/.config/", 9);
...
N_NIMCALL(void, raiseoserror_114809)(NI32 errorcode) {
	...
	asgnRefNoCycle((void**) (&(*e).Sup.Sup.message), oserrormsg_114620(errorcode));
	{
		...
		LOC5 = 0;
		LOC5 = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1076));
...
N_NIMCALL(NimStringDesc*, paramstr_123609)(NI i) {
	...
	LA5: ;
	e_123616 = 0;
	e_123616 = (indexerror3255*) newObj((&NTI123617), sizeof(indexerror3255));
	(*e_123616).Sup.Sup.m_type = (&NTI3255);
	LOC7 = 0;
	LOC7 = (*e_123616).Sup.message; (*e_123616).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1079));
...
N_NIMCALL(NimStringDesc*, getapplheuristic_124204)(void) {
	...
	result = paramstr_123609(0);
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			p_124403 = 0;
			HEX3Atmp_124410 = 0;
			HEX3Atmp_124410 = getenv_120442(((NimStringDesc*) &TMP1080));
			last_124415 = 0;
			{
				while (1) {
					NI first_124417;
...
N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	NimStringDesc* result;
	result = 0;
	result = getapplaux_124004(((NimStringDesc*) &TMP1077));
	{
...
N_NIMCALL(NI, parentdirpos_117366)(NimStringDesc* path) {
	...
	LA3: ;
	{
		...
		{
			while (1) {
				if (!(0 <= res_117415)) goto LA7;
				i_117396 = res_117415;
				{
					if (!(((NU8)(path->data[i_117396])) == ((NU8)(47)) || ((NU8)(path->data[i_117396])) == ((NU8)(47)))) goto LA10;
					result = i_117396;
					goto BeforeRet;
				}
				LA10: ;
...
N_NIMCALL(NimStringDesc*, nosgetHomeDir)(void) {
	...
	LOC1 = 0;
	LOC2 = 0;
	LOC2 = getenv_120442(((NimStringDesc*) &TMP1684));
	LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1685));
	result = LOC1;
	goto BeforeRet;
	BeforeRet: ;
	return result;
...
N_NOINLINE(void, nosraiseOSError)(NimStringDesc* msg) {
	{
		NimStringDesc* m;
		oserror3233* e_114417;
		if (!(msg->Sup.len == 0)) goto LA3;
		m = nososErrorMsg();
		e_114417 = 0;
		e_114417 = (oserror3233*) newObj((&NTI114812), sizeof(oserror3233));
		(*e_114417).Sup.Sup.Sup.m_type = (&NTI3233);
		{
			NimStringDesc* LOC9;
		...
		LA7: ;
		{
			NimStringDesc* LOC11;
			LOC11 = 0;
			LOC11 = (*e_114417).Sup.Sup.message; (*e_114417).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1076));
	...
	LA3: ;
	{
		oserror3233* e_114438;
		NimStringDesc* LOC13;
		e_114438 = 0;
		e_114438 = (oserror3233*) newObj((&NTI114812), sizeof(oserror3233));
		(*e_114438).Sup.Sup.Sup.m_type = (&NTI3233);
		LOC13 = 0;
...
N_NIMCALL(NimStringDesc*, expandtilde_125446)(NimStringDesc* path) {
	...
	result = 0;
	{
		...
		LOC13 = 0;
		LOC13 = HEX5BHEX5D_84171(path, LOC12);
