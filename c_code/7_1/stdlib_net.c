...
N_NIMCALL(void, TMP5522)(void* p, NI op);
...
STRING_LITERAL(TMP5528, "", 0);
STRING_LITERAL(TMP5531, "No valid socket error code available", 36);
STRING_LITERAL(TMP5532, "Could not send all data.", 24);
STRING_LITERAL(TMP5535, "Call to \'", 9);
STRING_LITERAL(TMP5536, "\' timed out.", 12);
STRING_LITERAL(TMP5538, "readLine", 8);
STRING_LITERAL(TMP5539, "\015\012", 2);
...
N_NIMCALL(Socketimpl554404*, newsocket_554821_170061329)(Domain548604 domain0, Socktype548606 socktype0, Protocol548608 protocol0, NIM_BOOL buffered0) {
	...
	fd0 = newnativesocket_549001_466562973(domain0, socktype0, protocol0);
	{
		...
		raiseoserror_127003_2125978480(LOC5, ((NimStringDesc*) &TMP5528));
	}
	LA3: ;
...
N_NIMCALL(void, bindaddr_555608_170061329)(Socketimpl554404* socket0, NU16 port0, NimStringDesc* address0) {
	{
		...
		name0.sin_addr.s_addr = ntohl_549806_466562973(INADDR_ANY);
		{
			...
			raiseoserror_127003_2125978480(LOC10, ((NimStringDesc*) &TMP5528));
		}
		LA8: ;
	}
	goto LA1;
	LA3: ;
	{
		...
		ailist0 = getaddrinfo_549402_466562973(address0, port0, (*socket0).domain, ((Socktype548606) 1), ((Protocol548608) 6));
		{
			...
			raiseoserror_127003_2125978480(LOC17, ((NimStringDesc*) &TMP5528));
		}
		LA15: ;
		dealloc_549802_466562973(ailist0);
	}
...
N_NIMCALL(void, listen_555604_170061329)(Socketimpl554404* socket0, int backlog0) {
	{
		...
		raiseoserror_127003_2125978480(LOC6, ((NimStringDesc*) &TMP5528));
	}
	LA4: ;
}
...
N_NIMCALL(NI32, getsocketerror_555001_170061329)(Socketimpl554404* socket0) {
	...
	LA3: ;
	{
		...
		raiseoserror_127003_2125978480(result0, ((NimStringDesc*) &TMP5531));
	}
	LA7: ;
	return result0;
}
...
{	{
		...
		LA7: ;
		{
			...
			LA20: ;
			{
				raiseoserror_127003_2125978480(laste0, ((NimStringDesc*) &TMP5528));
			}
			LA16: ;
		}
		goto LA12;
...
{	sent0 = send_559282_170061329(socket0, ((void*) (data0->data)), (data0 ? data0->Sup.len : 0));
	...
	LA3: ;
	{
		...
		raiseoserror_127003_2125978480(LOC14, ((NimStringDesc*) &TMP5532));
	}
	LA12: ;
	}BeforeRet: ;
}
...
N_NIMCALL(void, acceptaddr_555809_170061329)(Socketimpl554404* server0, Socketimpl554404** client0, NimStringDesc** address0, Socketflag554414Set flags0) {
	...
	sock0 = accept((*server0).fd, ((struct sockaddr*) ((&sockaddress0))), (&addrlen0));
	{
		...
		LA8: ;
		raiseoserror_127003_2125978480(err0, ((NimStringDesc*) &TMP5528));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(void, accept_556401_170061329)(Socketimpl554404* server0, Socketimpl554404** client0, Socketflag554414Set flags0) {
	...
	addrdummy0 = copyString(((NimStringDesc*) &TMP5528));
...
appendString(LOC22, ((NimStringDesc*) &TMP5535));
...
appendString(LOC22, ((NimStringDesc*) &TMP5536));
		...
		selret0 = select_557801_170061329(socket0, (NI)(timeout0 - ((NI) (((NF)((*waited0)) * (NF)(1.0000000000000000e+03))))));
		{
			...
			raiseoserror_127003_2125978480(LOC27, ((NimStringDesc*) &TMP5528));
		}
		LA25: ;
		{
...
appendString(LOC32, ((NimStringDesc*) &TMP5535));
...
{	waited0 = 0.0;
	(*line0) = setLengthStr((*line0), ((NI) 0));
	{
		while (1) {
			...
			c0 = (NIM_CHAR)0;
			LOC3 = (NI)0;
			LOC3 = waitfor_558407_170061329(socket0, (&waited0), timeout0, ((NI) 1), ((NimStringDesc*) &TMP5538));
			...
			LA4: ;
			{
				...
				LOC20 = (NI)0;
				LOC20 = waitfor_558407_170061329(socket0, (&waited0), timeout0, ((NI) 1), ((NimStringDesc*) &TMP5538));
...
appendString((*line0), ((NimStringDesc*) &TMP5539));
				}
				LA38: ;
				goto BeforeRet;
			}
...
N_NIMCALL(void, close_556411_170061329)(Socketimpl554404* socket0) {
	TSafePoint TMP5540;
	pushSafePoint(&TMP5540);
	TMP5540.status = _setjmp(TMP5540.context);
	if (TMP5540.status == 0) {
		popSafePoint();
	}
	else {
...
TMP1340[3].len = 3; TMP1340[3].kind = 2; TMP1340[3].sons = &TMP5512[0];
