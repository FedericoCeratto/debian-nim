...
N_NIMCALL(void, serve_521254)(TY521256 action) {
	...
	typ = getconfigvar_154334(((NimStringDesc*) &TMP4988));
	...
	LA2: ;
	{
		...
		p = getconfigvar_154334(((NimStringDesc*) &TMP4993));
		{
			NI LOC18;
		...
		LA14: ;
		LOC20 = 0;
		LOC20 = getconfigvar_154334(((NimStringDesc*) &TMP4994));
		...
		writelnhook_164060.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				...
				action();
				gerrorcounter_164015 = ((NI) 0);
				send_518208((*HEX3Aenv_521447).stdoutsocket521408, ((NimStringDesc*) &TMP4997), 2);
