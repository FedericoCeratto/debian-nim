...
N_NIMCALL(NIM_BOOL, boolarg_287023_1413030668)(Tnode264794* n0, NimStringDesc* name0, NI pos0, NIM_BOOL default_287028_1413030668) {
	...
	LA3: ;
	{
		...
		if (!(LOC6)) goto LA7;
		LOC6 = identeq_194450_791273810((*x0).kindU.S5.ident, ((NimStringDesc*) &TMP1701));
		LA7: ;
		if (!LOC6) goto LA8;
		result0 = NIM_TRUE;
	}
	...
	LA8: ;
	{
		...
		if (!(LOC11)) goto LA12;
		LOC11 = identeq_194450_791273810((*x0).kindU.S5.ident, ((NimStringDesc*) &TMP1702));
		LA12: ;
		if (!LOC11) goto LA13;
		result0 = NIM_FALSE;
	}
...
N_NIMCALL(Tllstream254204*, filterstrip_287006_1413030668)(Tllstream254204* stdin_287008_1413030668, NimStringDesc* filename0, Tnode264794* call0) {
	...
	pattern0 = strarg_287017_1413030668(call0, ((NimStringDesc*) &TMP1699), ((NI) 1), ((NimStringDesc*) &TMP1700));
	leading0 = boolarg_287023_1413030668(call0, ((NimStringDesc*) &TMP1703), ((NI) 2), NIM_TRUE);
	trailing0 = boolarg_287023_1413030668(call0, ((NimStringDesc*) &TMP1704), ((NI) 3), NIM_TRUE);
	result0 = llstreamopen_254218_597494479(((NimStringDesc*) &TMP1700));
...
N_NIMCALL(Tllstream254204*, filterreplace_287001_1413030668)(Tllstream254204* stdin_287003_1413030668, NimStringDesc* filename0, Tnode264794* call0) {
	...
	NimStringDesc* line0;
	result0 = (Tllstream254204*)0;
	sub0 = strarg_287017_1413030668(call0, ((NimStringDesc*) &TMP1706), ((NI) 1), ((NimStringDesc*) &TMP1700));
	{
		if (!((sub0 ? sub0->Sup.len : 0) == ((NI) 0))) goto LA3;
		invalidpragma_287029_1413030668(call0);
	}
	LA3: ;
	by0 = strarg_287017_1413030668(call0, ((NimStringDesc*) &TMP1707), ((NI) 2), ((NimStringDesc*) &TMP1700));
	result0 = llstreamopen_254218_597494479(((NimStringDesc*) &TMP1700));
	line0 = rawNewString(((NI) 80));
	{
		while (1) {
