...
STRING_LITERAL(TMP3009, "atom", 4);
STRING_LITERAL(TMP3010, "lit", 3);
STRING_LITERAL(TMP3011, "sym", 3);
STRING_LITERAL(TMP3012, "ident", 5);
STRING_LITERAL(TMP3013, "call", 4);
STRING_LITERAL(TMP3014, "alias", 5);
STRING_LITERAL(TMP3015, "noalias", 7);
STRING_LITERAL(TMP3016, "lvalue", 6);
STRING_LITERAL(TMP3017, "local", 5);
STRING_LITERAL(TMP3018, "sideeffect", 10);
STRING_LITERAL(TMP3019, "nosideeffect", 12);
STRING_LITERAL(TMP3021, "compiler/parampatterns.nim", 26);
NIM_CONST TY84745 TMP3020 = {((NimStringDesc*) &TMP3021),
100}
;
NIM_CONST TY84745 TMP3022 = {((NimStringDesc*) &TMP3021),
107}
;
STRING_LITERAL(TMP3023, "parameter pattern too complex", 29);
...
N_NIMCALL(void, compileconstraints_321129)(tnode225816* p, NimStringDesc** result) {
	...
	case ((NU8) 32):
	{
		...
		op = (*(*p).kindU.S6.Sons->data[0]).kindU.S5.Ident;
		{
			...
			if (!(LOC8 == 3)) goto LA9;
			{
				NIM_BOOL LOC13;
				LOC13 = 0;
				LOC13 = eqStrings((*op).S, ((NimStringDesc*) &TMP3006));
				if (LOC13) goto LA14;
				LOC13 = ((*op).Sup.Id == 48);
				LA14: ;
				if (!LOC13) goto LA15;
			...
			LA15: ;
			{
				NIM_BOOL LOC18;
				LOC18 = 0;
				LOC18 = eqStrings((*op).S, ((NimStringDesc*) &TMP3007));
				if (LOC18) goto LA19;
				LOC18 = ((*op).Sup.Id == 2);
				LA19: ;
				if (!LOC18) goto LA20;
		...
		LA9: ;
		{
			...
			if (!(LOC24)) goto LA26;
			LOC27 = 0;
			LOC27 = eqStrings((*op).S, ((NimStringDesc*) &TMP3008));
			if (LOC27) goto LA28;
			LOC27 = ((*op).Sup.Id == 44);
			LA28: ;
			LOC24 = LOC27;
	...
	case ((NU8) 2):
	{
		...
		case 1: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3019))) goto LA50;
break;
		case 3: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3015))) goto LA46;
if (eqStrings(spec, ((NimStringDesc*) &TMP3016))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP3018))) goto LA49;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3011))) goto LA42;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3012))) goto LA43;
if (eqStrings(spec, ((NimStringDesc*) &TMP3017))) goto LA48;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3009))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3010))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3013))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3014))) goto LA45;
break;
		}
		goto LA51;
		LA40: ;
...
N_NIMCALL(tnode225816*, semnodekindconstraints_321527)(tnode225816* p) {
	...
	(*result).kindU.S3.Strval = addChar((*result).kindU.S3.Strval, 1);
	{
		...
		}
		{
			...
			internalerror_197987((*p).Info, ((NimStringDesc*) &TMP3023));
		}
		LA12: ;
	}
	goto LA1;
