...
N_NIMCALL(void, handlecmdline_616607)(void);
...
N_NIMCALL(NimStringDesc*, prependcurdir_616401)(NimStringDesc* f);
...
STRING_LITERAL(TMP1915, "nim.cfg", 7);
...
N_NIMCALL(void, handlecmdline_616607)(void) {
	...
	LA4: ;
	{
		processcmdline_610209(((NU8) 0), ((NimStringDesc*) &TMP1889));
		{
			TSafePoint TMP1890;
			TY117604 p;
			NimStringDesc* LOC15;
			...
			pushSafePoint(&TMP1890);
			TMP1890.status = _setjmp(TMP1890.context);
			if (TMP1890.status == 0) {
				asgnRefNoCycle((void**) (&gprojectfull_169236), canonicalizepath_169390(gprojectname_169234));
				popSafePoint();
			}
			else {
				popSafePoint();
			...
			if (TMP1890.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_220811(((NimStringDesc*) &TMP1915));
		initvars_202820();
		processcmdline_610209(((NU8) 1), ((NimStringDesc*) &TMP1889));
		maincommand_614027();
		{
			NimStringDesc* LOC22;
			...
			if (!(gerrorcounter_196306 == 0)) goto LA25;
			{
				if (!((gglobaloptions_169118 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					ex = 0;
					{
						...
						LOC39 = 0;
						LOC39 = prependcurdir_616401(outfile_169124);
					...
					LA37: ;
					{
						...
						NimStringDesc* LOC43;
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP4890));
						LOC42 = 0;
						LOC42 = prependcurdir_616401(LOC41);
						LOC43 = 0;
...
appendString(LOC44, arguments_210144);
					execexternalprogram_202907(LOC44, ((NimStringDesc*) &TMP1889));
				}
				goto LA31;
				LA33: ;
				{
					...
					binpath = 0;
					{
						...
						binpath = prependcurdir_616401(outfile_169124);
					}
					goto LA46;
					LA48: ;
					{
						NimStringDesc* LOC51;
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP1889));
						binpath = prependcurdir_616401(LOC51);
					}
					LA46: ;
...
appendString(LOC52, arguments_210144);
					execexternalprogram_202907(LOC52, ((NimStringDesc*) &TMP1889));
				}
				LA31: ;
			}
			LA29: ;
