...
N_NIMCALL(void, parseline_218149)(Ttmplparser218020* p) {
	...
	LA7: ;
	{
		...
		case ((NU16) 22):
		{
			...
			{
				(*p).info.col = ((NI16) (j));
				localerror_166155((*p).info, ((NU16) 163), ((NimStringDesc*) &TMP1419));
			}
			LA20: ;
			LOC25 = 0;
				...
				{
					{
						...
						case 123:
						{
							...
							curly = ((NI) 0);
							{
								while (1) {
									...
									case 0:
									{
										localerror_166155((*p).info, ((NU16) 188), ((NimStringDesc*) &TMP1428));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).info.col = ((NI16) (j));
								localerror_166155((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP1416));
							}
							LA80: ;
						}
						break;
...
N_NIMCALL(Tllstream179204*, filtertmpl_218009)(Tllstream179204* stdin_218011, NimStringDesc* filename, Tnode191813* call) {
	...
	p.info = newlineinfo_164878(filename, ((NI) 0), ((NI) 0));
	p.outp = llstreamopen_179220(((NimStringDesc*) &TMP1408));
	p.inp = stdin_218011;
	p.subschar = chararg_217020(call, ((NimStringDesc*) &TMP1409), ((NI) 1), 36);
	p.nimdirective = chararg_217020(call, ((NimStringDesc*) &TMP1410), ((NI) 2), 35);
	p.emit = strarg_217029(call, ((NimStringDesc*) &TMP1411), ((NI) 3), ((NimStringDesc*) &TMP1412));
	p.conc = strarg_217029(call, ((NimStringDesc*) &TMP1413), ((NI) 4), ((NimStringDesc*) &TMP1414));
	p.tostr = strarg_217029(call, ((NimStringDesc*) &TMP1415), ((NI) 5), ((NimStringDesc*) &TMP1416));
