...
N_NIMCALL(void, parseline_217149)(Ttmplparser217020* p) {
	...
	LA7: ;
	{
		...
		case ((NU16) 22):
		{
			...
			{
				(*p).info.col = ((NI16) (j));
				localerror_165155((*p).info, ((NU16) 163), ((NimStringDesc*) &TMP1407));
			}
			LA20: ;
			LOC25 = 0;
				...
				{
					{
						...
						case 123:
						{
							...
							curly = ((NI) 0);
							{
								while (1) {
									...
									case 0:
									{
										localerror_165155((*p).info, ((NU16) 188), ((NimStringDesc*) &TMP1416));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).info.col = ((NI16) (j));
								localerror_165155((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP1404));
							}
							LA80: ;
						}
						break;
...
N_NIMCALL(Tllstream178204*, filtertmpl_217009)(Tllstream178204* stdin_217011, NimStringDesc* filename, Tnode190813* call) {
	...
	p.info = newlineinfo_163878(filename, ((NI) 0), ((NI) 0));
	p.outp = llstreamopen_178220(((NimStringDesc*) &TMP1396));
	p.inp = stdin_217011;
	p.subschar = chararg_216020(call, ((NimStringDesc*) &TMP1397), ((NI) 1), 36);
	p.nimdirective = chararg_216020(call, ((NimStringDesc*) &TMP1398), ((NI) 2), 35);
	p.emit = strarg_216029(call, ((NimStringDesc*) &TMP1399), ((NI) 3), ((NimStringDesc*) &TMP1400));
	p.conc = strarg_216029(call, ((NimStringDesc*) &TMP1401), ((NI) 4), ((NimStringDesc*) &TMP1402));
	p.tostr = strarg_216029(call, ((NimStringDesc*) &TMP1403), ((NI) 5), ((NimStringDesc*) &TMP1404));
